...
void sSetConfigMode(void)
{
	...
	bOvtmpRestartIDTemp = bOvtmpRestartID;
 	...
 	bOuputVoltID = (INT16U)(swGetEEOutputVolt()-cVac110v+cVac5v)/100;// +5V 兼容127V
...
//									}
								...
								else if(bOPModeIDTemp == OP_MODE_3P3_ID)
								{
									bOPModeIDTemp=OP_MODE_SINGLE_ID;
									wAdjustValue -=4;
								}
...
void  sSaveConfiguration(void) 
{
    ...
    wVlaueTemp = (INT16U)(bOuputVoltID*100+cVac110v);
    ...
    {
        if((wVlaueTemp == cVac120v)||(wVlaueTemp == cVac110v)||(wVlaueTemp == cVac127v))
        {
