...
//					sTxChar('M');
		...
		if(bDataPtr>0)
		{
			...
			else if((bDataBuffer[0]=='I')&&(bDataBuffer[1]=='V')&&(bDataBuffer[2]=='E')
				&&(bDataBuffer[3]=='M')&&(bDataBuffer[4]=='I')&&(bDataBuffer[5]=='A')
				&&(bDataBuffer[6]=='P')&&(bDataBuffer[7]=='2')&&(bDataBuffer[8]=='4'))
			{
				AnswerBack(bSTEP,dwPackCnt);
			}
			else if((bDataBuffer[0]=='I')&&(bDataBuffer[1]=='V')&&(bDataBuffer[2]=='E')
				&&(bDataBuffer[3]=='M')&&(bDataBuffer[4]=='I')&&(bDataBuffer[5]=='A')
				&&(bDataBuffer[6]=='P')&&(bDataBuffer[7]=='2')&&(bDataBuffer[8]=='3'))
			{
				//AnswerBack(bSTEP,dwPackCnt);
				sTxChar('(');
				sTxChar('A');
				...
				&&(bDataBuffer[3]=='M')&&(bDataBuffer[4]=='I')&&(bDataBuffer[5]=='A')
				&&(bDataBuffer[6]=='P')&&(bDataBuffer[7]=='2')&&(bDataBuffer[8]=='2'))
			{
				//AnswerBack(bSTEP,dwPackCnt);
				sTxChar('(');
				sTxChar('A');
				...
				&&(bDataBuffer[3]=='M')&&(bDataBuffer[4]=='I')&&(bDataBuffer[5]=='A')
				&&(bDataBuffer[6]=='P')&&(bDataBuffer[7]=='2')&&(bDataBuffer[8]=='1'))
			{
				//AnswerBack(bSTEP,dwPackCnt);
				sTxChar('(');
				sTxChar('A');
