...
void sInitGpio(void)
{
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO4 = 1;		// Disable pullup on	// DCDC 推挽
	...
	GpioDataRegs.GPACLEAR.bit.GPIO6 = 0;	// Load output latch to low
	...
	// SW.ESC 		按键返回
	GpioCtrlRegs.GPHPUD.bit.GPIO228 = 0; 	// Enable pullup on
	GpioCtrlRegs.GPHQSEL1.bit.GPIO228 = 3;	// Asynch input
	GpioCtrlRegs.GPHGMUX1.bit.GPIO228 = 3;
	GpioCtrlRegs.GPHMUX1.bit.GPIO228 = 0;	// GPIO228 = GPIO
	// SW.UP 		按键上翻页
	GpioCtrlRegs.GPHPUD.bit.GPIO226 = 0; 	// Enable pullup on
	GpioCtrlRegs.GPHQSEL1.bit.GPIO226 = 3;	// Asynch input
	GpioCtrlRegs.GPHGMUX1.bit.GPIO226 = 3;
	GpioCtrlRegs.GPHMUX1.bit.GPIO226 = 0;	// GPIO226 = GPIO
	// SW.DN 		按键下翻页
	GpioCtrlRegs.GPHPUD.bit.GPIO242 = 0; 	// Enable pullup on
	GpioCtrlRegs.GPHQSEL2.bit.GPIO242 = 3;	// Asynch input
	GpioCtrlRegs.GPHGMUX2.bit.GPIO242 = 3;
	GpioCtrlRegs.GPHMUX2.bit.GPIO242 = 0;	// GPIO242 = GPIO
	// SW.ENT 		按键确认
	GpioCtrlRegs.GPAPUD.bit.GPIO12 = 0;	  	// Disable pullup on GPIO12
	GpioDataRegs.GPACLEAR.bit.GPIO12 = 1;  	// Load output latch to high
	GpioCtrlRegs.GPADIR.bit.GPIO12 = 0;	  	// GPIO12 = input
	GpioCtrlRegs.GPAMUX1.bit.GPIO12 = 0;   	// GPIO12 = GPIO

//	GpioCtrlRegs.GPHPUD.bit.GPIO228 = 0;	  	// Disable pullup on GPIO12
//	GpioDataRegs.GPHCLEAR.bit.GPIO228  = 1;  	// Load output latch to high
//	GpioCtrlRegs.GPHDIR.bit.GPIO228  = 0;	  	// GPIO228 = input
//	GpioCtrlRegs.GPHMUX1.bit.GPIO228  = 0;   	// GPIO228 = GPIO
	...
	// EEP WP
//	GpioCtrlRegs.GPBPUD.bit.GPIO43 = 1;		// Enable pullup on		  
//	GpioDataRegs.GPBSET.bit.GPIO43 = 1;		// Load output latch to High
...
//	GpioCtrlRegs.GPBMUX1.bit.GPIO43 = 0;	// GPIO43 = I/O
	...
	// RLY -- GRIDN RLY
//	GpioCtrlRegs.GPAPUD.bit.GPIO23 = 1;		// Disable pullup on
//	GpioDataRegs.GPACLEAR.bit.GPIO23 = 0;	// Load output latch to low
//	GpioCtrlRegs.GPADIR.bit.GPIO23 = 1;		// GPIO23 = output
//	GpioCtrlRegs.GPAMUX2.bit.GPIO23 = 0;	// GPIO23 = GPIO
	...
	// OPI.OVER		输出过流信号
	GpioCtrlRegs.GPBPUD.bit.GPIO41 = 1;		// Disable pullup on
	GpioDataRegs.GPBCLEAR.bit.GPIO41 = 0;	// Load output latch to low	// 是上拉还是下拉，要看电路
	...
	GpioDataRegs.GPACLEAR.bit.GPIO7 = 0;	// Load output latch to low
	GpioCtrlRegs.GPADIR.bit.GPIO7 = 0;		// GPIO7 = input
	GpioCtrlRegs.GPAMUX1.bit.GPIO7 = 0;		// GPIO7 = GPIO
	// SPS.SD	 	辅助电源关
	GpioCtrlRegs.GPBPUD.bit.GPIO44 = 1; 	// Disable pullup on
	GpioDataRegs.GPBCLEAR.bit.GPIO44 = 0;	// Load output latch to low
	...
	GpioDataRegs.GPACLEAR.bit.GPIO8 = 0;	// Load output latch to low
	...
	// SCIA	RX			
	GpioCtrlRegs.GPAPUD.bit.GPIO28 = 0;		// Enable pullup on		// 485
	...
	// SCIB RX
	GpioCtrlRegs.GPAPUD.bit.GPIO15 = 0; 	// Enable pullup on		// MPPT
	...
	// SCIC RX IVCM1012_V3
	GpioCtrlRegs.GPAPUD.bit.GPIO21 = 0;		// Enable pullup on	// RS232
...
//	GpioCtrlRegs.GPHQSEL1.bit.GPIO226 = 3;	// Asynch input
//	GpioCtrlRegs.GPHGMUX1.bit.GPIO226 = 3;
//	GpioCtrlRegs.GPHMUX1.bit.GPIO226 = 2;	// GPIO226 = SCIRXDC		// 14
//	// SCIC TX
//	GpioCtrlRegs.GPHPUD.bit.GPIO224 = 0; 	// Enable pullup on
//	GpioCtrlRegs.GPHGMUX1.bit.GPIO224 = 3;
//	GpioCtrlRegs.GPHMUX1.bit.GPIO224 = 2;	// GPIO224 = SCITXDC		// 14
	
 	// ECAP	-- 市电过零信号		IVCM1012_V2
	...
	// for test
	// TDO --> GPIO37
//	GpioCtrlRegs.GPBPUD.bit.GPIO37 = 1; 	// Disable pullup on
//	GpioDataRegs.GPBCLEAR.bit.GPIO37 = 0;	// Load output latch to low
//	GpioCtrlRegs.GPBDIR.bit.GPIO37 = 1; 	// GPIO11 = output
//	GpioCtrlRegs.GPBMUX1.bit.GPIO37 = 0;	// GPIO11 = GPIO
//	// TDI --> GPIO35
//	GpioCtrlRegs.GPBPUD.bit.GPIO35 = 1; 	// Disable pullup on
//	GpioDataRegs.GPBCLEAR.bit.GPIO35 = 0;	// Load output latch to low
//	GpioCtrlRegs.GPBDIR.bit.GPIO35 = 1; 	// GPIO11 = output
//	GpioCtrlRegs.GPBMUX1.bit.GPIO35 = 0;	// GPIO11 = GPIO
	
	EDIS;

	// multiplexing GPIO --> ADC
	GPIO_setPinConfig(GPIO_224_GPIO224);			// GPIO224 -- > A2
    GPIO_setAnalogMode(224, GPIO_ANALOG_ENABLED);

	/*GPIO_setPinConfig(GPIO_242_GPIO242);			// GPIO242 -- > A3
    GPIO_setAnalogMode(242, GPIO_ANALOG_ENABLED);

    GPIO_setPinConfig(GPIO_228_GPIO228);			// GPIO228 -- > A6
    GPIO_setAnalogMode(228, GPIO_ANALOG_ENABLED);

	GPIO_setPinConfig(GPIO_227_GPIO227);			// GPIO227 -- > A9
    GPIO_setAnalogMode(227, GPIO_ANALOG_ENABLED);

	GPIO_setPinConfig(GPIO_230_GPIO230);			// GPIO230 -- > A10
    GPIO_setAnalogMode(230, GPIO_ANALOG_ENABLED);*/

	// Initialize GPIO and configure GPIO pins for SCIC
//	GPIO_setPinConfig(GPIO_226_SCIC_RX);
//	GPIO_setPinConfig(GPIO_224_SCIC_TX);
...
void sInitEPWM(void)
{
	...
	// EPWM7 -- Used to trigger ADCA sampling
...
//
//    EPwm7Regs.CMPA.bit.CMPA = 0x0800;  		 	// Set compare A value to 2048 counts
//    EPwm7Regs.TBPRD = 0x1000;           			// Set period to 4096 counts
//
//    EPwm7Regs.TBCTL.bit.CTRMODE = 3;    			// Freeze counter
	...
	EPwm1Regs.DBFED.all = 144;//192;// =1.5us						450// =3.744us
	EPwm1Regs.DBRED.all = 144;//192;// =1.5us						450// =3.744us
	// 逆变死区
...
//	EPwm1Regs.DBCTL.bit.OUT_MODE = DB_FULL_ENABLE;
	...
	EPwm2Regs.DBFED.all = 144;//192;// =1.5us	450;//192;// =1.6us
	EPwm2Regs.DBRED.all = 144;//192;// =1.5us	450;//192;// =1.6us
...
//	EPwm3Regs.AQSFRC.bit.RLDCSF = 3;
	...
	EPwm3Regs.TBPRD = cDCDCPeriod; 					// Period = 5200 TBCLK counts
...
//	EPwm3Regs.TBCTL.bit.SYNCOSEL = TB_SYNC_DISABLE; // Disable EPWMxSYNCO signal	// F2800137里面已经去掉了这个位
	...
	EPwm3Regs.DBCTL.bit.OUT_MODE = DB_DISABLE; 		// disable DB first,enable it  when control start	// 中心对称互补发波，死区也不使能
	EPwm3Regs.DBCTL.bit.POLSEL = DB_ACTV_HIC; 		// Active Hi complementary 
	EPwm3Regs.DBFED.all = 450;//95;//72;//270;
	EPwm3Regs.DBRED.all = 450;//95;//72;//270;
