...
INVERTER_MODULE	void	sRInvDCCurrCntl(INT16S wInvDCCurrRef, INT16U wCurrKp, INT16U wCurrKi);
INVERTER_MODULE	void	sRInvDCCurrChk(INT16S wLimitValue, INT16U wFilter);
INVERTER_MODULE	void	sClrInvDCCurrCntlPara(void);
INVERTER_MODULE	void	sInvVoltHighChk(INT8U ubFilter);
INVERTER_MODULE	void	sInvVoltLowChk(INT8U ubFilter);
INVERTER_MODULE void	sOPCurrHighChk(INT8U ubFilter);	// OP¹ýÁ÷
...
INVERTER_MODULE INT16S	swGetRInvDCINew(void);
...
INVERTER_MODULE void	sSetRInvDCVNew(INT16S wVolt);
INVERTER_MODULE void	sSetRInvDCINew(INT16S wCurr);
