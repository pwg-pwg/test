...
//#define cCtrlIVCM1012LV_II			8	// OP电流采样增大
#define cCtrlIVCM2024LV_II			9	// OP电流采样增大



// DSP软件版本
#define MACHINE_VERSION				105			// for test,此版本必须发ECN进版
...
#define cCtrlV204					204			// IVCM3024PRO进版
#define cCtrlV205					205			// 未启用
#define cDspCtrlVersion				MACHINE_VERSION	// 当前编译版本

// 临时版本
#define cCtrlV00					0			// 初始版本
#define cCtrlV01					1 			// V104 增加SOC相关逻辑
#define cCtrlV02					2 			// V104 LLC改为过零关
#define cCtrlV03					3 
#define cCtrlV04					4
#define cCtrlV05					5			// 
#define cCtrlV06					6			// 
...
#define MACHINE_SUB_TYPE_1012LV     0x1100  	// 设备子类 IVCM1012
#define MACHINE_SUB_TYPE_2024LV     0x1202  	// 设备子类 IVCM2024
#define MACHINE_SUB_TYPE_3024LV     0x1204  	// 设备子类 IVCM3024
...
#define cTransformerRatio230         230		// 推挽变比 0.1倍
#define cTransformerRatio165         165		// 推挽变比 0.1倍
#define cTransformerRatio120         120		// 推挽变比 0.1倍
#define cTransformerRatio082         82			// 推挽变比 0.1倍
