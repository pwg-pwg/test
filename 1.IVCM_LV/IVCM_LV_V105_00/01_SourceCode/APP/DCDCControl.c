...
INT16U g_wPDCDCPWM_OPEN_Test = 32;
INT16U g_wPDCDCPWM_OPEN_Test_2 = 33;
INT16U g_wPDCDCPWM_OPEN_Test_3 = 38;
...
void	sDCDCControl(void)
{
	...
	if(++g_wLoopCnt >= 4)
	{
		...
		{
			/*if(swGetAgingStatus() && g_uwFBInvCtrlSts == cFBInvCtrlBus)
			{
