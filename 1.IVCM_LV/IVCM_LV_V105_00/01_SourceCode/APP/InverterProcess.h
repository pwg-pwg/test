...
INVERTER_PROCESS INT16U uwGetPDCDCPWMSoftDutyFirst(void);
INVERTER_PROCESS INT16U uwGetPDCDCPWMSoftDutySecond(void);
INVERTER_PROCESS INT16U uwGetPDCDCPWMSoftDutyThird(void);
