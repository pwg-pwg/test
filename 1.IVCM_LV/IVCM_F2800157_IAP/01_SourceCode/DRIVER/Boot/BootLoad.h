...
#define	FLASH_ADDR_END			0x00099FFF	// Flash结束地址

#define FLASH_APP_BOOT_ADDR		0x00082002
#define FLASH_BOOT_FLAG			0x4635504E	// "F5PN"
#define	FLASH_APP_ADDR_BEGIN	0x00082000	// APP跳转指令地址
#define FLASH_FLG_ADDR_START	0x00082000	// 标志与跳转指令区间
#define FLASH_FLG_ADDR_END		0x00082010	
#define	FLASH_APP_ADDR_START	0x00082000	// APP实际存储起始地址
#define	FLASH_APP_ADDR_END		0x00099FFF
