...
******************************************************************************/
const INT16U cEepromDaultTable[cEepromTotalLength/2] =
{
	0		,// 0	输出模式
	0		,// 1	风机运行模式
	0xFFFF		,// 2	预留2
...
//    if(sbGetEepromMaxChgCurr() > cIdc350A)
//    {
...
//            && sbGetEepromMaxSolarChgCurr() != 50 && sbGetEepromMaxSolarChgCurr() != 60
//            && sbGetEepromMaxSolarChgCurr() != 70 && sbGetEepromMaxSolarChgCurr() != 80
//            && sbGetEepromMaxSolarChgCurr() != 90 && sbGetEepromMaxSolarChgCurr() != 100
//            && sbGetEepromMaxSolarChgCurr() != 110 && sbGetEepromMaxSolarChgCurr() != 120
//            && sbGetEepromMaxSolarChgCurr() != 130 && sbGetEepromMaxSolarChgCurr() != 140
//            && sbGetEepromMaxSolarChgCurr() != 150 && sbGetEepromMaxSolarChgCurr() != 160
//            && sbGetEepromMaxSolarChgCurr() != 170 && sbGetEepromMaxSolarChgCurr() != 180
//            && sbGetEepromMaxSolarChgCurr() != 190 && sbGetEepromMaxSolarChgCurr() != 200)
//        {
//            sSetEepromMaxSolarChgCurr(60);
//            bUserChangeFlag = 1;
//        }
//    }
//    else
...
//        if(sbGetEepromMaxSolarChgCurr() != 10 && sbGetEepromMaxSolarChgCurr() != 20
//            && sbGetEepromMaxSolarChgCurr() != 30 && sbGetEepromMaxSolarChgCurr() != 40
//            && sbGetEepromMaxSolarChgCurr() != 50)
//        {
//            sSetEepromMaxSolarChgCurr(50);
//            bUserChangeFlag = 1;
//        }
//    }
...
//    if(sbGetEepromMaxChgCurr() > cIdc350A )//cIdc200A
//    {
//        sSetEepromMaxChgCurr(cIdc60A);
//        bUserChangeFlag = 1;
//    }
...
INT8U *sGetDefaultTable(void)
{
    return((INT8U *)cEepromDaultTable);
}
