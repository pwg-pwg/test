...
Return Value:
	...
	false:	0
*******************************************************************************/
INT8U   sbOverLevelChk(INT16S wCompareData, INT16S wHighLever, INT16U bFilter, INT16U *pbCounter)
{
...
Return Value:
	...
	false:	0
*******************************************************************************/
INT8U   sbUnderLevelChk(INT16S wCompareData, INT16S wLowLever, INT16U bFilter, INT16U *pbCounter)
{
