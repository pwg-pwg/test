...
//	wTxtTempDerateBack15KVA = (INT16S)cTxtTempDerateBack15KVA + (2300 - swGetEepromOutputVolt())/2;
	...
	wInvTempDerate12KVA = (INT16S)cInvTempDerate12KVA + (2300 - swGetEepromOutputVolt())/5;     
	wInvTempDerateBack12KVA = (INT16S)cInvTempDerateBack12KVA + (2300 - swGetEepromOutputVolt())/5;
