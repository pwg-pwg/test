...
void AcBatVoltCheck()
{
	...
	wBatVoltAvg = (INT16S)((INT32U)swGetBatAvgVoltNew() * wTxRatio >> 8);
	wGridVoltPeak = (INT16S)(((INT32U)swGetRLineVolt() * 362) >> 8);
	wGenVoltPeak = (INT16S)(((INT32U)swGetGenVolt() * 362) >> 8);
	if((wBatVoltAvg > (INT16S)(((INT32U)wGridVoltPeak * 54)>>6))&&\
		(wBatVoltAvg > (INT16S)(((INT32U)wGenVoltPeak * 54)>>6)))//0.85倍
	{
