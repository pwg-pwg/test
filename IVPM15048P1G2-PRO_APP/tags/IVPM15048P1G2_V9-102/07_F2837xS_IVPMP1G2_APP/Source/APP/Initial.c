...
void sModelIdentify(void)
{
    ...
    for(;;)
    {
        ...
        else if((1433 <= wADResult) && (wADResult < 1980))  //10048:1.25V(1.05-1.45V)
        {
...
void sUpsParaInit(void)
{
     ...
     else if(g_wVAType == cb15KVAModel)
    {
        ...
        //pDefaultTable1 = sGetDefaultTable1();       // 10048:
        //pDefaultTable2 = sGet48V230DefaultTable2(); // 10048:Default PWM SCC Version
        pEeDefaultTable = sGet15KDefaultTable();
	...
	else//12K
	{
        ...
        //Watt/VA Rated
        wWattRated = c12KWattMaxPower;                  // 10048:
        wVARated   = c12KVAMaxPower;                 // 10048:
