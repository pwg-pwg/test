...
//    EPwm7Regs.ETSEL.bit.SOCAEN = 1;     // Enable SOCA
    ...
    EPwm8Regs.TBPRD = cLLC_PWM_PERIOD;           // Period = 1200 TBCLK counts
	...
	EPwm8Regs.CMPB.all = cLLC_PWM_PERIOD;
    ...
    EPwm9Regs.TBPRD = cLLC_PWM_PERIOD;           // Period = 1200 TBCLK counts
	...
	EPwm9Regs.CMPB.bit.CMPB = cLLC_PWM_PERIOD;
...
void sUpsParaInit(void)
{
    if(g_wVAType == cb1000VAModel)
    {
        ...
        wWattRated = cWattMaxPower;                  // 15048:
        wVARated   = cVAMaxPower;                 // 15048:
