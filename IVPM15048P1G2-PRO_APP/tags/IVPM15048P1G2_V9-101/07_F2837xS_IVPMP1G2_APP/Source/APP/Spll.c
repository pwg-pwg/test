...
{
    return((INT16S)(SogiLineVolt.fOsgAcAlpha[0]*100));
}
INT16S Spll_GetBelta()
{
    return((INT16S)(SogiLineVolt.fOsgAcBelta[0]*100));
}
INT16S SOGI_GetAcIn()//
{
    return((INT16S)SogiLineVolt.fOsgAc[0]);
}
INT16S SOGI_GetAcOut()
{
    return((INT16S)(SogiLineVolt.fOsgAcBelta[0]));
}
INT16S SOGI_GetAcQIn()
{
    return((INT16S)(SogiLineVolt.fFreq));
}
INT16S SOGI_GetAcQOut()
{
    return((INT16S)(SogiLineVolt.fTheta));
}
