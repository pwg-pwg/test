...
#define NTC_DISCONNECT_POINT          -10
#define NTC_DISCONNECT_RECOVER_POINT  -8
...
PROTECTION_MODULE void sTemperatureInvChk(INT8U bFilter);
PROTECTION_MODULE void sTemperatureTxtChk(INT8U bFilter);
PROTECTION_MODULE void sTemperaturePvChk(INT8U bFilter);
PROTECTION_MODULE void sTemperatureInternalChk(INT8U bFilter);
...
PROTECTION_MODULE  void  sTmpOverForFanChk(INT8U bFilter);
...
PROTECTION_MODULE void  sInvTempChk(INT8U bFilter);
PROTECTION_MODULE INT8U  sbGetInvTempStatus(void);
PROTECTION_MODULE void  sNtcDisConnectChk(INT8U bFilter);
PROTECTION_MODULE INT8U   sbGetTxtOverTempDerate(void);
PROTECTION_MODULE INT8U sbGetInvOverTempDerate(void);
PROTECTION_MODULE  void  sAvrTempDeratingChk(INT8U bFilter);
PROTECTION_MODULE  void  sAvrPvTempDeratingChk(INT8U bFilter);
PROTECTION_MODULE  INT16S  sAvrInvTempDeratingChk(INT8U bFilter);
