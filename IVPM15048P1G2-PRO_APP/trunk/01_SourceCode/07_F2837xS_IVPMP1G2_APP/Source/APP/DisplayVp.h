...
* Macros                                                                        *
********************************************************************************/
#ifdef  __DISPLAY_VP_C__
#define DISPLAY_VP
#else
#define DISPLAY_VP extern
#endif
...
********************************************************************************/
DISPLAY_VP INT8U g_bInputType;
DISPLAY_VP INT8U g_bOutputType;
DISPLAY_VP void sSetInputVRange(INT8U bInputType,INT8U bAvrModel,INT8U bOutputType);
DISPLAY_VP void sSetEeprom2SaveFlag(INT8U bBoolean); 
DISPLAY_VP void sDisplayHwInit(void);
