...
BusBatProt_PUBLIC INT16U g_uwAFCIStatus;
//BusBatProt_PUBLIC INT16U g_uwAFCISelfCheckOK;
//BusBatProt_PUBLIC INT16U g_uwArcFaultFlag;
//BusBatProt_PUBLIC INT16U g_uwArcFaultClearFlag;
