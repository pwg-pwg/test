...
Library_PUBLIC  INT8U   swOverLevelChk(INT16S wCompareData, INT16S wHighLever, INT8U bFilter, INT16U *pbCounter);
Library_PUBLIC  INT8U   swUnderLevelChk(INT16S wCompareData, INT16S wLowLever, INT8U bFilter, INT16U *pbCounter);
