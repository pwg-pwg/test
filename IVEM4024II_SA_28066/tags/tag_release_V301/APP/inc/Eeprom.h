...
struct EepromStruct2
{
	...
	INT16U  wEEAFCIEn;
//	INT16U  wEEClearARCFault;	不需要保存在EEPROM中
	INT16S  dwReserver1;
...
//AFCI
EEPROM_PUBLIC void sSetEEAFCIEn(INT16S wValue);
EEPROM_PUBLIC INT16S swGetEEAFCIEn(void);
EEPROM_PUBLIC void sSetEEClearARCFault(INT16S wValue);
EEPROM_PUBLIC INT16S swGetEEClearARCFault(void);
