...
void sQ1Command(INT8U sciid)
{
    ...
    wSciLength += 2;
//    g_ubUserDataBuf0[sciid][wSciLength++] = cChar_Space;
//    sNumToASCII(g_uwLineUnderFreqLevel1, 5, 0, &g_ubUserDataBuf0[sciid][wSciLength]);
//    wSciLength += 5;
//    g_ubUserDataBuf0[sciid][wSciLength++] = cChar_Space;
//    sNumToASCII(g_uwLineUnderFreqBackLevel1, 5, 0, &g_ubUserDataBuf0[sciid][wSciLength]);
//    wSciLength += 5;
