...
#define cLLC_MosStarTempPoint           468//525     //52.5C
#define cLLC_MosEndTempPoint            935    //105C =>93.5
#define cLLC_MosTempRange               468//410     //52.5C  =>41.0
...
INT16S swGetLLC_MosTj(void)
{
    ...
    if(abs(g_wBatCurrAvg) <= cBatCurrReal20A)       { uwNTCTempDelta = cNTCTempDelta18; }// I_BAT < (17*7), ΔTH = 21
    else if(abs(g_wBatCurrAvg) >= cBatCurrReal50A)  { uwNTCTempDelta = cNTCTempDelta29; }// I_BAT > (25*7), ΔTH = 28
    else                                              { uwNTCTempDelta = (INT16U)((INT32U)(abs(g_wBatCurrAvg)) / 3 ) + 114; }// y = 0.2666x + 147, ΔTH = 取线性
