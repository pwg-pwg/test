...
void sSciEEDefaultWrite2(void)      
{
    ...
    pDefaultTable=(INT8U *)&gc_strEepromDaultTable2 + 2;
    sEEDefaultWrite((INT8U *)uEepromCfg2.wEepromCfg2 + 2,pDefaultTable,bEepromDefaultIndex,cEepromTotalLength2/2 - 1 - 2);
}
...
void sEEpromDataRangeChk(void)
{
    ...
    {
        sSetEEOutputVolt(gc_strEepromDaultTable2.wEEOutputVolt);//220V
        bUserChangeFlag = 1;
    }
    ...
    {
        sSetEEBatEqEn(gc_strEepromDaultTable2.wEEAFCIEn);
        bUserChangeFlag = 1;
    }	
