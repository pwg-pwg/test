   ...
   wSumChk = 0;
	...
	while(1)
	{
		...
		if(bDataPtr>0)
		{
			...
			else if((g_ubDataBuff[0]=='I')&&(g_ubDataBuff[1]=='V')&&(g_ubDataBuff[2]=='E')
				&&(g_ubDataBuff[3]=='M')&&(g_ubDataBuff[4]=='I')&&(g_ubDataBuff[5]=='A')
				&&(g_ubDataBuff[6]=='P')&&(g_ubDataBuff[7]=='1')&&(g_ubDataBuff[8]=='4'))
			{
				AnswerBack(bSTEP,dwPackCnt);
			}
			else if((g_ubDataBuff[0]=='I')&&(g_ubDataBuff[1]=='V')&&(g_ubDataBuff[2]=='E')
				&&(g_ubDataBuff[3]=='M')&&(g_ubDataBuff[4]=='I')&&(g_ubDataBuff[5]=='A')
				&&(g_ubDataBuff[6]=='P')&&(g_ubDataBuff[7]=='1')&&(g_ubDataBuff[8]=='3'))
			{
				//AnswerBack(bSTEP,dwPackCnt);
				sTxChar('(');
				sTxChar('A');
				...
				&&(g_ubDataBuff[3]=='M')&&(g_ubDataBuff[4]=='I')&&(g_ubDataBuff[5]=='A')
				&&(g_ubDataBuff[6]=='P')&&(g_ubDataBuff[7]=='1')&&(g_ubDataBuff[8]=='2'))
			{
				//AnswerBack(bSTEP,dwPackCnt);
				sTxChar('(');
				sTxChar('A');
				...
				&&(g_ubDataBuff[3]=='M')&&(g_ubDataBuff[4]=='I')&&(g_ubDataBuff[5]=='A')
				&&(g_ubDataBuff[6]=='P')&&(g_ubDataBuff[7]=='1')&&(g_ubDataBuff[8]=='1'))
			{
				//AnswerBack(bSTEP,dwPackCnt);
				sTxChar('(');
				sTxChar('A');
...
void sInitSCI19200(void)
{
	...
	ScibRegs.SCILBAUD = 0x3C;		   //19200
//	ScibRegs.SCIHBAUD = 0x00;	 
//	ScibRegs.SCILBAUD = 0xF3;		   //9600
//	ScicRegs.SCIHBAUD = 0x03;	 
//	ScicRegs.SCILBAUD = 0xD0;		   //2400
