...
_PRG_key4  .word 0x2020  ; PSWD bits 79-64   
_PRG_key5  .word 0x1204  ; PSWD bits 95-80   
_PRG_key6  .word 0x1430  ; PSWD bits 111-96   
_PRG_key7  .word 0x0000  ; PSWD bits 127-112   
