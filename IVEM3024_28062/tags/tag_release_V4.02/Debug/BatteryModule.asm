...
;	C:\Work\Software\CCS5.4\ccsv5\tools\compiler\c2000_6.1.3\bin\opt2000.exe C:\\Users\\Daily\\AppData\\Local\\Temp\\029723 C:\\Users\\Daily\\AppData\\Local\\Temp\\029725 
;	C:\Work\Software\CCS5.4\ccsv5\tools\compiler\c2000_6.1.3\bin\ac2000.exe -@C:\\Users\\Daily\\AppData\\Local\\Temp\\0297213 
	.sect	".text"
...
;*** 105	-----------------------    y$5 = (wPDCDCCurr+wNDCDCCurr)*14;
...
;*** 98	-----------------------    g_wDCDCCurr = (wPDCDCCurr+wNDCDCCurr)*14;
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
;*** 64	-----------------------    y$17 = g_wBatUnderVolt+10;
;*** 64	-----------------------    g_wBatLowVolt = y$17;
;*** 65	-----------------------    g_wBatLowBackVolt = g_wBatUnderVolt+20;
...
$C$L6:    
;***	-----------------------g5:
;*** 313	-----------------------    if ( g_wBatWeakBackVolt > 300 ) goto g7;
	.dwpsn	file "../MODULE/BatteryModule/BatteryModule.C",line 313,column 3,is_stmt
        CMP       @_g_wBatWeakBackVolt,#300 ; [CPU_] |313| 
        B         $C$L7,GT              ; [CPU_] |313| 
        ; branchcc occurs ; [] |313| 
...
;*** 185	-----------------------    if ( g_uwWorkMode == 5u || g_uwWorkMode == 2u || g_uwLoadOnSts == 0u ) goto g12;
	...
	.dwpsn	file "../MODULE/BatteryModule/BatteryModule.C",line 185,column 2,is_stmt
        ...
        BF        $C$L19,EQ             ; [CPU_] |185| 
        ; branchcc occurs ; [] |185| 
;*** 191	-----------------------    g_wBatUnderBackVolt = C$1 = g_wBatFloatVolt-2;
...
$C$L24:    
;***	-----------------------g22:
;*** 230	-----------------------    if ( sbOverLevelChk(g_uwBatVoltAvg, (unsigned)g_wBatUnderVolt+4u, 30000u, &s_uwBatDangerChkCnt) == 0u && g_wBatChgStage != 2 && g_fBMSSOCFull == 0u ) goto g24;
...
$C$L35:    
;***	-----------------------g4:
;*** 357	-----------------------    if ( !sbOverLevelChk(g_uwBatVoltAvg, uwBatOpenLevel+20u, uwFilter, &s_uwBatChkCnt) ) goto g6;
