...
;* Date/Time created: Wed Jun 01 14:00:17 2022                 *
;***************************************************************
...
;**************************************************************
	...
	.field	1251,16			; _g_wInvVoltCurrLimit @ 0
...
;	C:\Work\Software\CCS5.4\ccsv5\tools\compiler\c2000_6.1.3\bin\opt2000.exe C:\\Users\\Daily\\AppData\\Local\\Temp\\036563 C:\\Users\\Daily\\AppData\\Local\\Temp\\036565 
;	C:\Work\Software\CCS5.4\ccsv5\tools\compiler\c2000_6.1.3\bin\ac2000.exe -@C:\\Users\\Daily\\AppData\\Local\\Temp\\0365613 
	.sect	".text"
	.global	_swGetVref
...
$C$DW$265	.dwtag  DW_TAG_variable, DW_AT_name("$O$U188")
	.dwattr $C$DW$265, DW_AT_TI_symbol_name("$O$U188")
	.dwattr $C$DW$265, DW_AT_type(*$C$DW$T$10)
	.dwattr $C$DW$265, DW_AT_location[DW_OP_reg0]
;* AL    assigned to $O$U188
$C$DW$266	.dwtag  DW_TAG_variable, DW_AT_name("$O$U188")
	.dwattr $C$DW$266, DW_AT_TI_symbol_name("$O$U188")
...
;*** 307	-----------------------    if ( !(*(&GpioDataRegs+1)&0x800u) ) goto g14;
        ...
        ; branchcc occurs ; [] |307| 
;*** 309	-----------------------    gi_wROPShareCurrCntl = C$10 = (int)((((long)gi_wROPShareCurrSample*91L>>3)+5L)/10L);
...
;***  	-----------------------    return;
	...
	.dwpsn	file "../MODULE/InverterCntl/InvCntModule.C",line 825,column 2,is_stmt
        MOVB      @_g_wFBKCurrentForward,#60,UNC ; [CPU_] |825| 
...
$C$DW$302	.dwtag  DW_TAG_variable, DW_AT_name("$O$U193")
	.dwattr $C$DW$302, DW_AT_TI_symbol_name("$O$U193")
	.dwattr $C$DW$302, DW_AT_type(*$C$DW$T$10)
	.dwattr $C$DW$302, DW_AT_location[DW_OP_reg12]
;* AR5   assigned to $O$U196
$C$DW$303	.dwtag  DW_TAG_variable, DW_AT_name("$O$U196")
	.dwattr $C$DW$303, DW_AT_TI_symbol_name("$O$U196")
...
$C$L46:    
;***	-----------------------g25:
;*** 959	-----------------------    g_wFBR_Is_P = C$8 = -(int)((long)gi_wRInvCurrSample*835L>>8);
...
;*** 974	-----------------------    if ( y$56 > 4086 ) goto g28;
	...
	.dwpsn	file "../MODULE/InverterCntl/InvCntModule.C",line 959,column 2,is_stmt
        MPY       ACC,@_gi_wRInvCurrSample,#835 ; [CPU_] |959| 
        MOVW      DP,#_g_wFBR_Is_P      ; [CPU_U] 
        SFR       ACC,8                 ; [CPU_] |959| 
        NEG       AL                    ; [CPU_] |959| 
        MOV       T,AL                  ; [CPU_] |959| 
...
;*** 979	-----------------------    U$193 = g_wPwmPeriod-10;
;*** 979	-----------------------    if ( C$5 <= U$193 ) goto g31;
        MOVW      DP,#_g_wPwmPeriod     ; [CPU_U] 
...
;***	-----------------------g31:
;*** 980	-----------------------    U$196 = -U$193;
;*** 980	-----------------------    if ( g_wFBR_Duty >= U$196 ) goto g33;
        MOV       AL,AR4                ; [CPU_] 
        MOVW      DP,#_g_wFBR_Duty      ; [CPU_U] 
...
$C$L51:    
;***	-----------------------g35:
;*** 987	-----------------------    if ( g_wFBPWM >= U$196 ) goto g37;
        MOV       AL,AR5                ; [CPU_] 
...
;***************************************************************
_sBuckSoftProc:
;*** 776	-----------------------    wTemp = g_uwBatVoltAvg*14u+100u;
