...
const STRCOMParsingGroup gc_strCOMParsingTable[] = 
{
	...
	{2,	"QD",			sQDCommand 			},
	{1,	"T",			sTestCommand		},
	{10,	"IVEMIAP31\r",	sJMPToIAPReflash	},
};
...
const pFunc1	GetDataSubArray[100]=
{
	...
	swGetRInvDCVoltReal,	swReturnNull,				swReturnNull,							// 44
	swGetVm_P,				swGetImo_P1,				swGetR_Is_P1,							// 47
	swGetBoost_PWM,			swGetVerr_P1,				(pFunc1)suwGetBoost1CtrlSts,			// 50
	swGetRInvCurr1Real,		swGetRInvCurr2Real,			swReturnNull,							// 53
	swReturnNull,			swReturnNull,				swReturnNull,							// 56
	swReturnNull,			swReturnNull,				swReturnNull,							// 59
	swReturnNull,			swReturnNull,				swGetRLineVoltTest,						// 62
	swGetVref,				swGetKpwm,					swGetInvVoltError,						// 65
	swGetRInvVoltCntl,		swGetRInvCurrCntl,			swGetRLoadCurrCntl,						// 68
	swGetVBeforeSaturation,	swGetLoopOutput,			swGetVoltLimit,							// 71
	swGetInvBusVoltRef,		swGetPDCDCPWM,				swGetBusVoltErr,						// 74
	swGetBusVmo,			swReturnNull,				swGetPDCDCImo,							// 77
	swReturnNull,			swGetRSinPointer,			(pFunc1)swGetSinePeriodCntNew,			// 80
	(pFunc1)swGetLinePeriodCntNew,swGetFBPWM,			swGetInvStep,							// 83
	swReturnNull,			swReturnNull,				swReturnNull,							// 86
	swGetFBR_Is_P,			swGetFBImo_P,				swGetFBVm_P,							// 89
	swGetRInvDCVoltCtrl,	swReturnNull,				swReturnNull,							// 92
	swReturnNull,			swReturnNull,				swReturnNull,							// 95
	swReturnNull,			swGetRFBVm_P,				swGetRFBPWM,							// 98
	swReturnNull																				// 99
};
...
void sQ1Command(INT8U sciid)
{
	...
	sNumToASCII(gi_wPLLPointerMax, 4, 0, &g_ubUserDataBuf0[sciid][wSciLength]);
	wSciLength += 4;
	g_ubUserDataBuf0[sciid][wSciLength++] = cChar_Space;
