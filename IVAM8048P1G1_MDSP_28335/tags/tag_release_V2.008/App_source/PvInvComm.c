...
*/
    ...
    // {
        ...
        if((4825 == uiSciSetDataBag[eATE_SN3]) && (4500 >= uiSciSetDataBag[eATE_SN4]) && (bMachineModel == eModel_IVAM6048))
	...
	uiMasterAnalogData[eEM2SRealData_PeriodSample] = stValue.ui20msPeriodSamplePoint;
}
/******************************************************************************
Function Name       :
-------------------------------------------------------------------------------
