...
typedef enum
{
    ...
    eCtDircCheckEn          = 0x0008,   // Bit3: CT方向检测使能
    eAteBatAbnChKDisEnBit   = 0x0010,   // Bit4: ATE禁止电池异常检测使能
    eAteForceChargeDisEnBit = 0x0020    // Bit5: ATE禁止强充使能
} eCmdBitMask;	
...
{                                     //枚举地址   监控地址
    ...
    eSetFaultSeletEn                   , // 361   8809   故障设置使能
...
typedef union
{
    ...
    struct
    {
        ...
        Uint16  bFanLockFault              :1;     // 23 风机堵转故障
        Uint16  bMdlIdentifyFail           :1;     // 24 机型识别失败(机型不匹配)
        ...
        Uint16  bSafeInvRelayFault         :1;     // 74 逆变继电器故障
...
MonitorProtocol_PUBLIC ValRangeStr stValRange;
...
MonitorProtocol_PUBLIC void GetDataRange(Uint16 uiDataId, ValRangeStr *pValRange);
MonitorProtocol_PUBLIC void SetSpecialParamsDefaultValue(Uint16 *pSciSetDataBag);
