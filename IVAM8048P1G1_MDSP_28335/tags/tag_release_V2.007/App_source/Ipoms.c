...
//        uiSciSetDataBag[eSetRsvd423] = sSysPara[eSetDataID15]; // 15 母线电压给定
        ...
        // uiSciSetDataBag[eSetRsvd362] = sSysPara[eSetDataID21]; // 21 有效值环Kp
        // uiSciSetDataBag[eSetRsvd363] = sSysPara[eSetDataID22]; // 22 有效值环Ki
...
//        sSysPara[eSetDataID15] = uiSciSetDataBag[eSetRsvd423]; // 15 母线电压给定
        ...
        // sSysPara[eSetDataID21] = uiSciSetDataBag[eSetRsvd362]; // 21 有效值环Kp
        // sSysPara[eSetDataID22] = uiSciSetDataBag[eSetRsvd363]; // 22 有效值环Ki
