...
// 硬件采样系数
#define cBatVoltHwGain          fModelParam[eBatVoltHwGain     ]
#define cBusVoltHwGain          fModelParam[eBusVoltHwGain     ]
#define cInvVoltHwGainV000      fModelParam[eInvVoltHwGainV000 ]
#define cOutVoltHwGainV000      fModelParam[eOutVoltHwGainV000 ]
#define cGridVoltHwGainV000     fModelParam[eGridVoltHwGainV000]
#define cGenVoltHwGainV000      fModelParam[eGenVoltHwGainV000 ]

#define cInvCurrHwGain          fModelParam[eInvCurrHwGain     ]
#define cOutCurrHwGain          fModelParam[eOutCurrHwGain     ]
#define cGridCurrHwGain         fModelParam[eGridCurrHwGain    ]
#define cGenCurrHwGain          fModelParam[eGenCurrHwGain     ]
#define cCTCurrHwGain           fModelParam[eCTCurrHwGain      ]
#define cCTRatioRate            fModelParam[eCTRatioRate       ]

#define cDcDcCurrHwGain         fModelParam[eDcDcCurrHwGain    ]
#define cLLCCurrHwGain          fModelParam[eLLCCurrHwGain     ]

#define cInvDCVoltHwGain        fModelParam[eInvDCVoltHwGain   ]
#define cInvDCCurrHwGain        fModelParam[eInvDCCurrHwGain   ]

#define cNEVoltHwGainV000       fModelParam[eNEVoltHwGainV000  ]
#define cGfciHwGain             fModelParam[eGfciHwGain        ]
