...
#define     cGridRlyOpenDlyTime            3         //3ms Base 1ms
...
#define     cGenRlyCloseDlyTime            20        //10ms Base 1ms
#define     cGenRlyOpenDlyTime             2         //2ms Base 1ms

// 继电器闭合(断开)+弹跳时间
#define     cGridRlyCloseDeltaTime         fModelParam[eGridRlyCloseDeltaTime]  
#define     cGridRlyCloseDlyTime1		   fModelParam[eGridRlyCloseDlyTime1 ]   
#define     cGridRlyCloseDlyTime2		   (float)(cGridRlyCloseDlyTime1+cGridRlyCloseDeltaTime)

#define     cGridRlyOpenDlyTime1           fModelParam[eGridRlyOpenDlyTime1  ]   
#define     cGridRlyOpenDlyTime2           fModelParam[eGridRlyOpenDlyTime2  ] 

//逆变继电器
#define     cInvRlyCloseDeltaTime          fModelParam[eInvRlyCloseDeltaTime ]   
#define     cInvRlyCloseDlyTime1           fModelParam[eInvRlyCloseDlyTime1  ]   
#define     cInvRlyCloseDlyTime2           (float)(cInvRlyCloseDlyTime1+cInvRlyCloseDeltaTime)   

#define     cInvRlyOpenDlyTime1            fModelParam[eInvRlyOpenDlyTime1   ]   
#define     cInvRlyOpenDlyTime2            fModelParam[eInvRlyOpenDlyTime2   ]  
...
//继电器统一控制
#define     cGridRlyOnAll            0x0F         // 市电继电器有4个
#define     cGridRlyOffAll           0x00         //
#define     cInvRlyOnAll             0x03         // 逆变继电器有2个
#define     cInvRlyOffAll            0x00         //
#define     cGenRlyOnAll             0x03         // 发电机继电器有2个
#define     cGenRlyOffAll            0x00         //
//-----------------------------------------------------------------------------
...
typedef union
{
    ...
    {
        // word1
        Uint16  GridLNRlyOn        :4;  // 网侧主从继电器闭合指令
        Uint16  InvLNRlyOn         :2;  // 逆变侧继电器闭合指令
        Uint16  GenLNRlyOn         :2;  // Gen侧继电器闭合指令
        Uint16  RlyOnRsvd          :8;  // 
        // word2
        Uint16  RlySta             :16;
        // word3
    ...
    struct
    {
        ...
        Uint16  InvNRlySta         :2;  // 逆变N相从继电器状态 --> 与L线同一个状态
        Uint16  GenRlySta          :2;
        Uint16  GenNRlySta         :2;
...
typedef union
{
    ...
    struct
    {
        Uint16  GridLNRlyReadyOn        :4;  // 网侧主从继电器闭合指令
        Uint16  InvLNRlyReadyOn         :2;  // 逆变侧继电器闭合指令
        Uint16  GenLNRlyReadyOn         :2;  // Gen侧继电器闭合指令
        Uint16  RlyReadyOnRsvd          :8;
    }Sum;
