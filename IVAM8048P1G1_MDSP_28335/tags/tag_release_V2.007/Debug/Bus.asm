...
;* Date/Time created: Sat May 23 17:23:05 2026                 *
;***************************************************************
...
;	D:\Ti\ccs1250\ccs\tools\compiler\c2000_6.1.3.LTS\bin\opt2000.exe C:\\Users\\Lin\\AppData\\Local\\Temp\\086242 C:\\Users\\Lin\\AppData\\Local\\Temp\\086244 
;	D:\Ti\ccs1250\ccs\tools\compiler\c2000_6.1.3.LTS\bin\ac2000.exe -@C:\\Users\\Lin\\AppData\\Local\\Temp\\0862412 
	.sect	".text"
...
$C$L38:    
	.dwpsn	file "../App_source/Bus.c",line 365,column 5,is_stmt
        ...
        BF        $C$L39,NTC            ; [CPU_] |365| 
        ; branchcc occurs ; [] |365| 
	.dwpsn	file "../App_source/Bus.c",line 367,column 9,is_stmt
        MOV32     R1H,@_g_SystemInfo+30 ; [CPU_] |367| 
        MOV32     R0H,R4H               ; [CPU_] |367| 
        MINF32    R0H,R1H               ; [CPU_] |367| 
        MOV32     @_g_SystemInfo+30,R0H ; [CPU_] |367| 
$C$L39:    
	.dwpsn	file "../App_source/Bus.c",line 370,column 5,is_stmt
        MOVIZ     R0H,#16302            ; [CPU_] |370| 
        MOV32     R1H,@_g_SystemInfo+30 ; [CPU_] |370| 
        MOVXI     R0H,#26214            ; [CPU_] |370| 
        CMPF32    R1H,R0H               ; [CPU_] |370| 
        MOVST0    ZF, NF                ; [CPU_] |370| 
        B         $C$L40,LEQ            ; [CPU_] |370| 
        ; branchcc occurs ; [] |370| 
        MOVIZ     R0H,#16302            ; [CPU_] |370| 
        MOVXI     R0H,#26214            ; [CPU_] |370| 
        B         $C$L41,UNC            ; [CPU_] |370| 
        ; branch occurs ; [] |370| 
$C$L40:    
        MOVIZ     R0H,#16230            ; [CPU_] |370| 
        MOVXI     R0H,#26214            ; [CPU_] |370| 
        MAXF32    R0H,R1H               ; [CPU_] |370| 
$C$L41:    
        MOV32     @_g_SystemInfo+30,R0H ; [CPU_] |370| 
	.dwpsn	file "../App_source/Bus.c",line 371,column 5,is_stmt
        MOVW      DP,#_fModelParam+44   ; [CPU_U] 
        MOV32     R1H,@_fModelParam+44  ; [CPU_] |371| 
        MPYF32    R0H,R1H,R0H           ; [CPU_] |371| 
        NOP       ; [CPU_] 
        MPYF32    R0H,R0H,#16896        ; [CPU_] |371| 
        NOP       ; [CPU_] 
        F32TOUI16 R0H,R0H               ; [CPU_] |371| 
        NOP       ; [CPU_] 
        MOVW      DP,#_g_SystemInfo+64  ; [CPU_U] 
        MOV32     ACC,R0H               ; [CPU_] |371| 
        MOV       @_g_SystemInfo+64,AL  ; [CPU_] |371| 
	.dwpsn	file "../App_source/Bus.c",line 385,column 5,is_stmt
        MOVW      DP,#_g_ComInfo        ; [CPU_U] 
        AND       AL,@_g_ComInfo,#0x0600 ; [CPU_] |385| 
        LSR       AL,9                  ; [CPU_] |385| 
        CMPB      AL,#2                 ; [CPU_] |385| 
        BF        $C$L43,EQ             ; [CPU_] |385| 
        ; branchcc occurs ; [] |385| 
	.dwpsn	file "../App_source/Bus.c",line 388,column 9,is_stmt
        MOV       AL,@_g_ComInfo+1      ; [CPU_] |388| 
        ANDB      AL,#0x06              ; [CPU_] |388| 
        BF        $C$L42,NEQ            ; [CPU_] |388| 
        ; branchcc occurs ; [] |388| 
	.dwpsn	file "../App_source/Bus.c",line 394,column 13,is_stmt
        MOVW      DP,#_g_DcDcVar+28     ; [CPU_U] 
        MOVL      ACC,@_g_DcDcVar+28    ; [CPU_] |394| 
        MOVW      DP,#_g_InvVar+52      ; [CPU_U] 
        MOVL      @_g_InvVar+52,ACC     ; [CPU_] |394| 
	.dwpsn	file "../App_source/Bus.c",line 396,column 13,is_stmt
        MOVIZ     R0H,#16256            ; [CPU_] |396| 
$C$DW$39	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$39, DW_AT_low_pc(0x00)
	.dwattr $C$DW$39, DW_AT_name("FS$$DIV")
	.dwattr $C$DW$39, DW_AT_TI_call
        LCR       #FS$$DIV              ; [CPU_] |396| 
        ; call occurs [#FS$$DIV] ; [] |396| 
        MPYF32    R0H,R0H,#16752        ; [CPU_] |396| 
        NOP       ; [CPU_] 
        SUBF32    R4H,R4H,R0H           ; [CPU_] |396| 
	.dwpsn	file "../App_source/Bus.c",line 397,column 13,is_stmt
        MOVW      DP,#_g_SystemInfo+4   ; [CPU_U] 
        TBIT      @_g_SystemInfo+4,#1   ; [CPU_] |397| 
        BF        $C$L44,NTC            ; [CPU_] |397| 
        ; branchcc occurs ; [] |397| 
	.dwpsn	file "../App_source/Bus.c",line 399,column 17,is_stmt
        MOVW      DP,#_g_InvVar+52      ; [CPU_U] 
        MOV32     R0H,@_g_InvVar+52     ; [CPU_] |399| 
        MINF32    R4H,R0H               ; [CPU_] |399| 
        MOV32     @_g_InvVar+52,R4H     ; [CPU_] |399| 
        B         $C$L44,UNC            ; [CPU_] |399| 
        ; branch occurs ; [] |399| 
$C$L42:    
	.dwpsn	file "../App_source/Bus.c",line 390,column 13,is_stmt
        MOVIZ     R0H,#16266            ; [CPU_] |390| 
        MOVW      DP,#_g_InvVar+52      ; [CPU_U] 
        MOVXI     R0H,#15729            ; [CPU_] |390| 
        MOV32     @_g_InvVar+52,R0H     ; [CPU_] |390| 
	.dwpsn	file "../App_source/Bus.c",line 391,column 9,is_stmt
        B         $C$L44,UNC            ; [CPU_] |391| 
        ; branch occurs ; [] |391| 
$C$L43:    
	.dwpsn	file "../App_source/Bus.c",line 406,column 9,is_stmt
        MOVW      DP,#_g_DcDcVar+28     ; [CPU_U] 
        MOVL      ACC,@_g_DcDcVar+28    ; [CPU_] |406| 
        MOVW      DP,#_g_InvVar+52      ; [CPU_U] 
        MOVL      @_g_InvVar+52,ACC     ; [CPU_] |406| 
$C$L44:    
	.dwpsn	file "../App_source/Bus.c",line 409,column 1,is_stmt
        SUBB      SP,#2                 ; [CPU_U] 
	.dwcfi	cfa_offset, -6
        MOV32     R5H,*--SP             ; [CPU_] 
...
$C$DW$40	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$21, DW_AT_TI_end_line(0x199)
