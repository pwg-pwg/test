...
// 内部过温降载
#define InnerTempDerateStart        fModelParam[eInnerTempDerateStart ]
#define InnerTempDerateStop         fModelParam[eInnerTempDerateStop  ]
#define InnerTemp_Protect           fModelParam[eInnerTemp_Protect    ]
#define InnerTemp_Protect_Res       fModelParam[eInnerTemp_Protect_Res]

#define InnerTempInvPowerStop       fModelParam[eInnerTempInvPowerStop]
#define InnerTempBatPowerStop       fModelParam[eInnerTempBatPowerStop]
#define InnerTempBatCurrStop        fModelParam[eInnerTempBatCurrStop ]
...
// LLC-IGBT-HS 散热器过温降载
#define LLCHSTempDerateStart        fModelParam[eLLCHSTempDerateStart ]
#define LLCHSTempDerateStop         fModelParam[eLLCHSTempDerateStop  ]
#define LLCHSTemp_Protect           fModelParam[eLLCHSTemp_Protect    ]
#define LLCHSTemp_Protect_Res       fModelParam[eLLCHSTemp_Protect_Res]

#define LLCHSTempInvPowerStop       fModelParam[eLLCHSTempInvPowerStop]
#define LLCHSTempPvPowerStop        fModelParam[eLLCHSTempPvPowerStop ] 
#define LLCHSTempBatPowerStop       fModelParam[eLLCHSTempBatPowerStop]
#define LLCHSTempBatCurrStop        fModelParam[eLLCHSTempBatCurrStop ]
...
// Pv降载
#define LlcTempPvPowerStop          fModelParam[eLlcTempPvPowerStop  ]
#define InvTempPvPowerStop          fModelParam[eInvTempPvPowerStop  ]
#define InnerTempPvPowerStop        fModelParam[eInnerTempPvPowerStop]
#define LLCTxTempPvPowerStop        fModelParam[eLLCTxTempPvPowerStop]

#define DeratePowerRatio            0.6640625f  // 8500/12800
...
POWERDERATING_PUBLIC float  fPowerDerateByCurr; 
