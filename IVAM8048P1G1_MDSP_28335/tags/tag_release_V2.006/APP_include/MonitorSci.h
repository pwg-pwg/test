...
#define     IntTime                 260//208     //中断时间 us
#define     BaudRate                9600    //波特率
#define     LOSPCPCLK               ((float)37.5)    //SCI对应的低速外设时钟MHz
...
#define 	SCI_HBAUD_BAUD_38400	(Uint16)(LOSPCPCLK*125000/38400-1)		//LSPCLK/(BaudRate*8)-1
#define 	SCI_HBAUD_HBAUD_38400	((SCI_HBAUD_BAUD_38400 & 0xFF00)>>8)
#define 	SCI_HBAUD_LBAUD_38400	(SCI_HBAUD_BAUD_38400 & 0x00FF)
//-----------------------------------------------------------------------------
...
MonitorSci_PUBLIC void MonitorSci_System_PeripheralInit_38400(void);
#if DSP28_SCIC
MonitorSci_PUBLIC void MonitorSci_Debug_PeripheralInit(void);
#endif
