...
#define	cSettingMaxChgCurr		    fModelParam[eMaxChgCurr   ]   //10K 210A  12K 250A
#define cBatChgCurrMax				fModelParam[eMaxChgCurr   ]   //10K 210A  12K 250A
#define cBatDischgCurrMax			fModelParam[eMaxDischgCurr]   //10K 210A  12K 250A
...
enum
{
    eBatManage_DisCharge,     //0 放电
    eBatManage_VoltCharge,    //1 恒充均充
    eBatManage_FlotCharg,     //2 浮充阶段
    eBatManage_End
};
