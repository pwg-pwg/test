...
void GridSTD_UPS(void)
{
    ...
    // 过压时间
    uiSciSetDataBag[eSetGrid1OVTime ] = 20;//单位是10ms，放在20ms任务里面去；0.5=10*0.05（10是单位换算为ms，0.05是1/20）
    uiSciSetDataBag[eSetGrid2OVTime ] = 20;
    uiSciSetDataBag[eSetGrid3OVTime ] = 20;
    // 欠压时间
    uiSciSetDataBag[eSetGrid1UVTime ] = 20;
    uiSciSetDataBag[eSetGrid2UVTime ] = 20;
    uiSciSetDataBag[eSetGrid3UVTime ] = 20;
    // 过压点
    ...
    // 过频时间
    uiSciSetDataBag[eSetGrid1OFTime ] = 20;
    uiSciSetDataBag[eSetGrid2OFTime ] = 20;
    uiSciSetDataBag[eSetGrid3OFTime ] = 20;
    // 欠频时间
    uiSciSetDataBag[eSetGrid1UFTime ] = 20;
    uiSciSetDataBag[eSetGrid2UFTime ] = 20;
    uiSciSetDataBag[eSetGrid3UFTime ] = 20;
    // 过频点
...
void GridSTD_APL(void)
{
    ...
    uiSciSetDataBag[eSet10minOVPValue] = 110;
    // 过压时间
    uiSciSetDataBag[eSetGrid1OVTime ] = 20;
    uiSciSetDataBag[eSetGrid2OVTime ] = 20;
    uiSciSetDataBag[eSetGrid3OVTime ] = 20;
    // 欠压时间
    uiSciSetDataBag[eSetGrid1UVTime ] = 20;
