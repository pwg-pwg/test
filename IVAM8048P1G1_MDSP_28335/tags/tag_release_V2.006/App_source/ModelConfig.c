...
static const float g_ModelParamTable[eParamCount][eModelCount] = {
	...
	{  46.0f    ,   61.0f    },  // eIInvOffgridHardwareLimit
	{  41.0f    ,   54.6f    },  // eIInvOffgridHardwareLimit2
...
//  新继电器	
    {  0.34f	,	 1.5f	 },  // eGridRlyCloseDeltaTime
    {  7.32f	,    10.4f   },  // eGridRlyCloseDlyTime1
    {  1.6f	    ,    1.5f    },  // eGridRlyOpenDlyTime1
    {  2.0f	    ,    1.9f    },  // eGridRlyOpenDlyTime2

    {  0.34f	,	 1.0f	 },  // eInvRlyCloseDeltaTime
    {  5.70f	,    6.56f   },  // eInvRlyCloseDlyTime1
    {  1.1f	    ,    0.5f    },  // eInvRlyOpenDlyTime1
    {  1.5f	    ,    0.9f    },  // eInvRlyOpenDlyTime2
...
void GetMachineInfo(void)
{
    ...
    for(uiRetryCount = 0; uiRetryCount < 3; uiRetryCount++)
    {
		...
		if(bMachineModel != eModelUnknown)
		{
		    memset(uiIntSciRxDataBuff, 0, uiReceiveBuffLength);
		    break;
		}
