...
void CanInModDeal_ParaFrameInit(void)
{
	...
	if(bMachineModel == eModelIVAM6048 || bMachineModel == eModelUnknown)  //eModelUnknown暂定
	{
		bSelfFrameFlagData_RatePower = 6;					// 6KW
	}
	else if(bMachineModel == eModelIVAM8048)
	{
	    bSelfFrameFlagData_RatePower = 8;					// 6KW
	}
}
...
//    bSelfFrameFlagData_ToConstVolt  = strBatChgState.unFlag.bit.bToContVolt;
    ...
    uiSelfFrameAnalogData_CurrRmsA = (int16)(stValue.fRmsScale.IInvA * 1000);//(int16)(fInvActivePowerFilt * 1000);//
