...
;* Date/Time created: Wed Jul 08 10:34:21 2026                 *
;***************************************************************
...
;	D:\Ti\ccs1250\ccs\tools\compiler\c2000_6.1.3.LTS\bin\opt2000.exe C:\\Users\\Lin\\AppData\\Local\\Temp\\353802 C:\\Users\\Lin\\AppData\\Local\\Temp\\353804 
;	D:\Ti\ccs1250\ccs\tools\compiler\c2000_6.1.3.LTS\bin\ac2000.exe -@C:\\Users\\Lin\\AppData\\Local\\Temp\\3538012 
	.sect	".text"
	.global	_MemCopy
...
;* AR4   assigned to _DestAddr
$C$DW$7	.dwtag  DW_TAG_variable, DW_AT_name("DestAddr")
	.dwattr $C$DW$7, DW_AT_TI_symbol_name("_DestAddr")
	.dwattr $C$DW$7, DW_AT_type(*$C$DW$T$20)
	.dwattr $C$DW$7, DW_AT_location[DW_OP_reg12]
        MOVL      XAR7,XAR4             ; [CPU_] |33| 
        MOVL      XAR4,*-SP[4]          ; [CPU_] |33| 
	.dwpsn	file "../DSP_source/DSP2833x_MemCopy.c",line 34,column 11,is_stmt
        MOVL      ACC,XAR5              ; [CPU_] 
        CMPL      ACC,XAR7              ; [CPU_] |34| 
        B         $C$L2,LOS             ; [CPU_] |34| 
        ; branchcc occurs ; [] |34| 
$C$L1:    
$C$DW$L$_MemCopy$2$B:
...
$C$DW$9	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$9, DW_AT_name("D:\CCS_Code\IVAM8048\6 Formal Version\MDSP_2008 SDSP_1212\IVAM8048M_V2.008\IVAM8048M_V2.008\IVAM8048M\Debug\DSP2833x_MemCopy.asm:$C$L1:1:1783478061")
	.dwattr $C$DW$9, DW_AT_TI_begin_file("../DSP_source/DSP2833x_MemCopy.c")
	.dwattr $C$DW$9, DW_AT_TI_begin_line(0x22)
	.dwattr $C$DW$9, DW_AT_TI_end_line(0x25)
$C$DW$10	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$10, DW_AT_low_pc($C$DW$L$_MemCopy$2$B)
	.dwattr $C$DW$10, DW_AT_high_pc($C$DW$L$_MemCopy$2$E)
	.dwendtag $C$DW$9
