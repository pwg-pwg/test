...
;	D:\ti\ccs1040\ccs\tools\compiler\c2000_6.1.3.LTS\bin\ac2000.exe -@C:\\Users\\Ivan\\AppData\\Local\\Temp\\1101612 
	.sect	".text"
	.global	_InitPieCtrl
...
;----------------------------------------------------------------------
;  66 | PieCtrlRegs.PIECTRL.bit.ENPIE = 1;                                     
;  68 |     // Enables PIE to drive a pulse into the CPU                       
;----------------------------------------------------------------------
        MOVW      DP,#_PieCtrlRegs      ; [CPU_U] 
        OR        @_PieCtrlRegs,#0x0001 ; [CPU_] |66| 
	.dwpsn	file "../DSP_source/DSP2833x_PieCtrl.c",line 69,column 2,is_stmt
;----------------------------------------------------------------------
;  69 | PieCtrlRegs.PIEACK.all = 0xFFFF;                                       
;  71 | // Enable Interrupts at the CPU level                                  
;----------------------------------------------------------------------
