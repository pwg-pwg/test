...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../DSP_source/DSP2833x_MemCopy.c")
...
;	D:\ti\ccs1040\ccs\tools\compiler\c2000_6.1.3.LTS\bin\ac2000.exe -@C:\\Users\\Ivan\\AppData\\Local\\Temp\\1694812 
	.sect	".text"
	.global	_MemCopy
...
$C$DW$1	.dwtag  DW_TAG_subprogram, DW_AT_name("MemCopy")
	...
	.dwattr $C$DW$1, DW_AT_TI_begin_file("../DSP_source/DSP2833x_MemCopy.c")
	.dwattr $C$DW$1, DW_AT_TI_begin_line(0x20)
	.dwattr $C$DW$1, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$1, DW_AT_TI_max_frame_size(-6)
	.dwpsn	file "../DSP_source/DSP2833x_MemCopy.c",line 33,column 1,is_stmt,address _MemCopy
...
;----------------------------------------------------------------------
;  32 | void MemCopy(Uint16 *SourceAddr, Uint16* SourceEndAddr, Uint16* DestAdd
;     | r)                                                                     
;----------------------------------------------------------------------
...
_MemCopy:
	...
	.dwcfi	save_reg_to_reg, 78, 26
        ADDB      SP,#4                 ; [CPU_U] 
	.dwcfi	cfa_offset, -6
$C$DW$5	.dwtag  DW_TAG_variable, DW_AT_name("SourceAddr")
	.dwattr $C$DW$5, DW_AT_TI_symbol_name("_SourceAddr")
	.dwattr $C$DW$5, DW_AT_type(*$C$DW$T$20)
	.dwattr $C$DW$5, DW_AT_location[DW_OP_breg20 -2]
$C$DW$6	.dwtag  DW_TAG_variable, DW_AT_name("SourceEndAddr")
	.dwattr $C$DW$6, DW_AT_TI_symbol_name("_SourceEndAddr")
	.dwattr $C$DW$6, DW_AT_type(*$C$DW$T$20)
	.dwattr $C$DW$6, DW_AT_location[DW_OP_breg20 -4]
        MOVL      *-SP[4],XAR5          ; [CPU_] |33| 
        MOVL      *-SP[2],XAR4          ; [CPU_] |33| 
	.dwpsn	file "../DSP_source/DSP2833x_MemCopy.c",line 34,column 11,is_stmt
;----------------------------------------------------------------------
;  34 | while(SourceAddr < SourceEndAddr)                                      
;----------------------------------------------------------------------
        MOVL      XAR6,*-SP[2]          ; [CPU_] |34| 
        MOVL      ACC,*-SP[4]           ; [CPU_] |34| 
        CMPL      ACC,XAR6              ; [CPU_] |34| 
        B         $C$L2,LOS             ; [CPU_] |34| 
        ; branchcc occurs ; [] |34| 
$C$L1:    
$C$DW$L$_MemCopy$2$B:
	.dwpsn	file "../DSP_source/DSP2833x_MemCopy.c",line 36,column 8,is_stmt
;----------------------------------------------------------------------
;  36 | *DestAddr++ = *SourceAddr++;                                           
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[2]          ; [CPU_] |36| 
        MOV       AL,*XAR4++            ; [CPU_] |36| 
        MOVL      *-SP[2],XAR4          ; [CPU_] |36| 
        MOVL      XAR4,*-SP[8]          ; [CPU_] |36| 
        MOVL      XAR6,XAR4             ; [CPU_] |36| 
        ADDB      XAR6,#1               ; [CPU_U] |36| 
        MOVL      *-SP[8],XAR6          ; [CPU_] |36| 
        MOV       *+XAR4[0],AL          ; [CPU_] |36| 
	.dwpsn	file "../DSP_source/DSP2833x_MemCopy.c",line 34,column 11,is_stmt
        MOVL      XAR6,*-SP[2]          ; [CPU_] |34| 
        MOVL      ACC,*-SP[4]           ; [CPU_] |34| 
        CMPL      ACC,XAR6              ; [CPU_] |34| 
        ...
        ; branchcc occurs ; [] |34| 
$C$DW$L$_MemCopy$2$E:
	.dwpsn	file "../DSP_source/DSP2833x_MemCopy.c",line 38,column 5,is_stmt
;----------------------------------------------------------------------
;  38 | return;                                                                
;----------------------------------------------------------------------
$C$L2:    
	.dwpsn	file "../DSP_source/DSP2833x_MemCopy.c",line 39,column 1,is_stmt
        SUBB      SP,#4                 ; [CPU_U] 
	.dwcfi	cfa_offset, -2
...
$C$DW$8	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$8, DW_AT_name("E:\Code\v10.4\IVGM15048\Test\IVGM15048M_V001_DcDcClose_1031+Inv_1109ok\Debug\DSP2833x_MemCopy.asm:$C$L1:1:1699952986")
	.dwattr $C$DW$8, DW_AT_TI_begin_file("../DSP_source/DSP2833x_MemCopy.c")
	.dwattr $C$DW$8, DW_AT_TI_begin_line(0x22)
	.dwattr $C$DW$8, DW_AT_TI_end_line(0x25)
$C$DW$9	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$9, DW_AT_low_pc($C$DW$L$_MemCopy$2$B)
	.dwattr $C$DW$9, DW_AT_high_pc($C$DW$L$_MemCopy$2$E)
	.dwendtag $C$DW$8

	.dwattr $C$DW$1, DW_AT_TI_end_file("../DSP_source/DSP2833x_MemCopy.c")
