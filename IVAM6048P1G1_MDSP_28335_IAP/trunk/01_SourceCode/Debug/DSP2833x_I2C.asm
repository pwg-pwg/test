...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../DSP_source/DSP2833x_I2C.c")
...
;	D:\ti\ccs1040\ccs\tools\compiler\c2000_6.1.3.LTS\bin\ac2000.exe -@C:\\Users\\Ivan\\AppData\\Local\\Temp\\0828412 
	.sect	".text"
	.global	_InitI2C

$C$DW$2	.dwtag  DW_TAG_subprogram, DW_AT_name("InitI2C")
	.dwattr $C$DW$2, DW_AT_low_pc(_InitI2C)
	.dwattr $C$DW$2, DW_AT_high_pc(0x00)
	.dwattr $C$DW$2, DW_AT_TI_symbol_name("_InitI2C")
	.dwattr $C$DW$2, DW_AT_external
	.dwattr $C$DW$2, DW_AT_TI_begin_file("../DSP_source/DSP2833x_I2C.c")
	.dwattr $C$DW$2, DW_AT_TI_begin_line(0x14)
	.dwattr $C$DW$2, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$2, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../DSP_source/DSP2833x_I2C.c",line 21,column 1,is_stmt,address _InitI2C

	.dwfde $C$DW$CIE, _InitI2C
;----------------------------------------------------------------------
;  20 | void InitI2C(void)                                                     
;----------------------------------------------------------------------

;***************************************************************
;* FNAME: _InitI2C                      FR SIZE:   0           *
;*                                                             *
...
;----------------------------------------------------------------------
	...
	.dwpsn	file "../DSP_source/DSP2833x_I2C.c",line 25,column 1,is_stmt
$C$DW$3	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$3, DW_AT_low_pc(0x00)
	.dwattr $C$DW$3, DW_AT_TI_return
        LRETR     ; [CPU_] 
        ; return occurs ; [] 
	.dwattr $C$DW$2, DW_AT_TI_end_file("../DSP_source/DSP2833x_I2C.c")
...
$C$DW$4	.dwtag  DW_TAG_subprogram, DW_AT_name("InitI2CGpio")
	.dwattr $C$DW$4, DW_AT_low_pc(_InitI2CGpio)
	.dwattr $C$DW$4, DW_AT_high_pc(0x00)
	.dwattr $C$DW$4, DW_AT_TI_symbol_name("_InitI2CGpio")
	.dwattr $C$DW$4, DW_AT_external
	.dwattr $C$DW$4, DW_AT_TI_begin_file("../DSP_source/DSP2833x_I2C.c")
	.dwattr $C$DW$4, DW_AT_TI_begin_line(0x29)
	.dwattr $C$DW$4, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$4, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../DSP_source/DSP2833x_I2C.c",line 42,column 1,is_stmt,address _InitI2CGpio

	.dwfde $C$DW$CIE, _InitI2CGpio
;----------------------------------------------------------------------
;  41 | void InitI2CGpio()                                                     
;----------------------------------------------------------------------

;***************************************************************
;* FNAME: _InitI2CGpio                  FR SIZE:   0           *
;*                                                             *
;* FUNCTION ENVIRONMENT                                        *
;*                                                             *
;* FUNCTION PROPERTIES                                         *
...
_InitI2CGpio:
	...
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
	.dwpsn	file "../DSP_source/DSP2833x_I2C.c",line 44,column 4,is_stmt
;----------------------------------------------------------------------
;  44 | EALLOW;                                                                
...
;----------------------------------------------------------------------
 EALLOW
	.dwpsn	file "../DSP_source/DSP2833x_I2C.c",line 50,column 2,is_stmt
;----------------------------------------------------------------------
;  50 | GpioCtrlRegs.GPBPUD.bit.GPIO32 = 0;    // Enable pull-up for GPIO32 (SD
;     | AA)                                                                    
;----------------------------------------------------------------------
        MOVW      DP,#_GpioCtrlRegs+28  ; [CPU_U] 
        AND       @_GpioCtrlRegs+28,#0xfffe ; [CPU_] |50| 
	.dwpsn	file "../DSP_source/DSP2833x_I2C.c",line 51,column 2,is_stmt
;----------------------------------------------------------------------
;  51 | GpioCtrlRegs.GPBPUD.bit.GPIO33 = 0;        // Enable pull-up for GPIO33
;     |  (SCLA)                                                                
;  54 | // This will select asynch (no qualification) for the selected pins.   
;  55 | // Comment out other unwanted lines.                                   
;----------------------------------------------------------------------
        AND       @_GpioCtrlRegs+28,#0xfffd ; [CPU_] |51| 
	.dwpsn	file "../DSP_source/DSP2833x_I2C.c",line 57,column 2,is_stmt
;----------------------------------------------------------------------
;  57 | GpioCtrlRegs.GPBQSEL1.bit.GPIO32 = 3;  // Asynch input GPIO32 (SDAA)   
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+18,#0x0003 ; [CPU_] |57| 
	.dwpsn	file "../DSP_source/DSP2833x_I2C.c",line 58,column 5,is_stmt
;----------------------------------------------------------------------
;  58 | GpioCtrlRegs.GPBQSEL1.bit.GPIO33 = 3;  // Asynch input GPIO33 (SCLA)   
;  61 | // This specifies which of the possible GPIO pins will be I2C functiona
;     | l pins.                                                                
;  62 | // Comment out other unwanted lines.                                   
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+18,#0x000c ; [CPU_] |58| 
	.dwpsn	file "../DSP_source/DSP2833x_I2C.c",line 64,column 2,is_stmt
;----------------------------------------------------------------------
;  64 | GpioCtrlRegs.GPBMUX1.bit.GPIO32 = 1;   // Configure GPIO32 for SDAA ope
;     | ration                                                                 
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+22,#0xfffc ; [CPU_] |64| 
        ORB       AL,#0x01              ; [CPU_] |64| 
        MOV       @_GpioCtrlRegs+22,AL  ; [CPU_] |64| 
	.dwpsn	file "../DSP_source/DSP2833x_I2C.c",line 65,column 2,is_stmt
;----------------------------------------------------------------------
;  65 | GpioCtrlRegs.GPBMUX1.bit.GPIO33 = 1;   // Configure GPIO33 for SCLA ope
;     | ration                                                                 
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+22,#0xfff3 ; [CPU_] |65| 
        ORB       AL,#0x04              ; [CPU_] |65| 
        MOV       @_GpioCtrlRegs+22,AL  ; [CPU_] |65| 
	.dwpsn	file "../DSP_source/DSP2833x_I2C.c",line 67,column 5,is_stmt
;----------------------------------------------------------------------
;  67 | EDIS;                                                                  
;----------------------------------------------------------------------
 EDIS
	.dwpsn	file "../DSP_source/DSP2833x_I2C.c",line 68,column 1,is_stmt
        SPM       #0                    ; [CPU_] 
$C$DW$5	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$5, DW_AT_TI_return
        LRETR     ; [CPU_] 
        ; return occurs ; [] 
	.dwattr $C$DW$4, DW_AT_TI_end_file("../DSP_source/DSP2833x_I2C.c")
