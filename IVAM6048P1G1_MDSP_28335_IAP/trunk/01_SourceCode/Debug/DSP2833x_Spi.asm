...
;	D:\ti\ccs1040\ccs\tools\compiler\c2000_6.1.3.LTS\bin\ac2000.exe -@C:\\Users\\Ivan\\AppData\\Local\\Temp\\0320812 
	.sect	".text"
	.global	_InitSpi
...
$C$DW$4	.dwtag  DW_TAG_subprogram, DW_AT_name("InitSpiGpio")
	...
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 46,column 1,is_stmt,address _InitSpiGpio
...
_InitSpiGpio:
	...
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 48,column 4,is_stmt
;----------------------------------------------------------------------
;  48 | InitSpiaGpio();                                                        
;----------------------------------------------------------------------
$C$DW$5	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$5, DW_AT_TI_call
        LCR       #_InitSpiaGpio        ; [CPU_] |48| 
        ; call occurs [#_InitSpiaGpio] ; [] |48| 
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 49,column 1,is_stmt
...
$C$DW$7	.dwtag  DW_TAG_subprogram, DW_AT_name("InitSpiaGpio")
	.dwattr $C$DW$7, DW_AT_low_pc(_InitSpiaGpio)
	.dwattr $C$DW$7, DW_AT_high_pc(0x00)
	.dwattr $C$DW$7, DW_AT_TI_symbol_name("_InitSpiaGpio")
	.dwattr $C$DW$7, DW_AT_external
	.dwattr $C$DW$7, DW_AT_TI_begin_file("../DSP_source/DSP2833x_Spi.c")
	.dwattr $C$DW$7, DW_AT_TI_begin_line(0x33)
	.dwattr $C$DW$7, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$7, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 52,column 1,is_stmt,address _InitSpiaGpio

	.dwfde $C$DW$CIE, _InitSpiaGpio
;----------------------------------------------------------------------
;  51 | void InitSpiaGpio()                                                    
;----------------------------------------------------------------------
...
_InitSpiaGpio:
	...
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 54,column 4,is_stmt
;----------------------------------------------------------------------
;  54 | EALLOW;                                                                
;  56 | // Pull-ups can be enabled or disabled by the user.                    
;  57 | // This will enable the pullups for the specified pins.                
;  58 | // Comment out other unwanted lines.                                   
;----------------------------------------------------------------------
 EALLOW
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 60,column 5,is_stmt
;----------------------------------------------------------------------
;  60 | GpioCtrlRegs.GPAPUD.bit.GPIO16 = 0;   // Enable pull-up on GPIO16 (SPIS
;     | IMOA)                                                                  
;----------------------------------------------------------------------
        MOVW      DP,#_GpioCtrlRegs+13  ; [CPU_U] 
        AND       @_GpioCtrlRegs+13,#0xfffe ; [CPU_] |60| 
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 61,column 5,is_stmt
;----------------------------------------------------------------------
;  61 | GpioCtrlRegs.GPAPUD.bit.GPIO17 = 0;   // Enable pull-up on GPIO17 (SPIS
;     | OMIA)                                                                  
;----------------------------------------------------------------------
        AND       @_GpioCtrlRegs+13,#0xfffd ; [CPU_] |61| 
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 62,column 5,is_stmt
;----------------------------------------------------------------------
;  62 | GpioCtrlRegs.GPAPUD.bit.GPIO18 = 0;   // Enable pull-up on GPIO18 (SPIC
;     | LKA)                                                                   
;----------------------------------------------------------------------
        AND       @_GpioCtrlRegs+13,#0xfffb ; [CPU_] |62| 
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 63,column 5,is_stmt
;----------------------------------------------------------------------
;  63 | GpioCtrlRegs.GPAPUD.bit.GPIO19 = 0;   // Enable pull-up on GPIO19 (SPIS
;     | TEA)                                                                   
;  66 | //    GpioCtrlRegs.GPBPUD.bit.GPIO54 = 0;   // Enable pull-up on GPIO54
;     |  (SPISIMOA)                                                            
;  67 | //    GpioCtrlRegs.GPBPUD.bit.GPIO55 = 0;   // Enable pull-up on GPIO55
;     |  (SPISOMIA)                                                            
;  68 | //    GpioCtrlRegs.GPBPUD.bit.GPIO56 = 0;   // Enable pull-up on GPIO56
;     |  (SPICLKA)                                                             
;  69 | //    GpioCtrlRegs.GPBPUD.bit.GPIO57 = 0;   // Enable pull-up on GPIO57
;     |  (SPISTEA)                                                             
;  72 | // This will select asynch (no qualification) for the selected pins.   
;  73 | // Comment out other unwanted lines.                                   
;----------------------------------------------------------------------
        AND       @_GpioCtrlRegs+13,#0xfff7 ; [CPU_] |63| 
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 75,column 5,is_stmt
;----------------------------------------------------------------------
;  75 | GpioCtrlRegs.GPAQSEL2.bit.GPIO16 = 3; // Asynch input GPIO16 (SPISIMOA)
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+4,#0x0003 ; [CPU_] |75| 
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 76,column 5,is_stmt
;----------------------------------------------------------------------
;  76 | GpioCtrlRegs.GPAQSEL2.bit.GPIO17 = 3; // Asynch input GPIO17 (SPISOMIA)
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+4,#0x000c ; [CPU_] |76| 
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 77,column 5,is_stmt
;----------------------------------------------------------------------
;  77 | GpioCtrlRegs.GPAQSEL2.bit.GPIO18 = 3; // Asynch input GPIO18 (SPICLKA) 
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+4,#0x0030 ; [CPU_] |77| 
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 78,column 5,is_stmt
;----------------------------------------------------------------------
;  78 | GpioCtrlRegs.GPAQSEL2.bit.GPIO19 = 3; // Asynch input GPIO19 (SPISTEA) 
;  80 | //    GpioCtrlRegs.GPBQSEL2.bit.GPIO54 = 3; // Asynch input GPIO16 (SPI
;     | SIMOA)                                                                 
;  81 | //    GpioCtrlRegs.GPBQSEL2.bit.GPIO55 = 3; // Asynch input GPIO17 (SPI
;     | SOMIA)                                                                 
;  82 | //    GpioCtrlRegs.GPBQSEL2.bit.GPIO56 = 3; // Asynch input GPIO18 (SPI
;     | CLKA)                                                                  
;  83 | //    GpioCtrlRegs.GPBQSEL2.bit.GPIO57 = 3; // Asynch input GPIO19 (SPI
;     | STEA)                                                                  
;  87 | // This specifies which of the possible GPIO pins will be SPI functiona
;     | l pins.                                                                
;  88 | // Comment out other unwanted lines.                                   
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+4,#0x00c0 ; [CPU_] |78| 
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 90,column 5,is_stmt
;----------------------------------------------------------------------
;  90 | GpioCtrlRegs.GPAMUX2.bit.GPIO16 = 1; // Configure GPIO16 as SPISIMOA   
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+8,#0xfffc ; [CPU_] |90| 
        ORB       AL,#0x01              ; [CPU_] |90| 
        MOV       @_GpioCtrlRegs+8,AL   ; [CPU_] |90| 
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 91,column 5,is_stmt
;----------------------------------------------------------------------
;  91 | GpioCtrlRegs.GPAMUX2.bit.GPIO17 = 1; // Configure GPIO17 as SPISOMIA   
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+8,#0xfff3 ; [CPU_] |91| 
        ORB       AL,#0x04              ; [CPU_] |91| 
        MOV       @_GpioCtrlRegs+8,AL   ; [CPU_] |91| 
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 92,column 5,is_stmt
;----------------------------------------------------------------------
;  92 | GpioCtrlRegs.GPAMUX2.bit.GPIO18 = 1; // Configure GPIO18 as SPICLKA    
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+8,#0xffcf ; [CPU_] |92| 
        ORB       AL,#0x10              ; [CPU_] |92| 
        MOV       @_GpioCtrlRegs+8,AL   ; [CPU_] |92| 
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 93,column 5,is_stmt
;----------------------------------------------------------------------
;  93 | GpioCtrlRegs.GPAMUX2.bit.GPIO19 = 1; // Configure GPIO19 as SPISTEA    
;  95 | //    GpioCtrlRegs.GPBMUX2.bit.GPIO54 = 1; // Configure GPIO54 as SPISI
;     | MOA                                                                    
;  96 | //    GpioCtrlRegs.GPBMUX2.bit.GPIO55 = 1; // Configure GPIO55 as SPISO
;     | MIA                                                                    
;  97 | //    GpioCtrlRegs.GPBMUX2.bit.GPIO56 = 1; // Configure GPIO56 as SPICL
;     | KA                                                                     
;  98 | //    GpioCtrlRegs.GPBMUX2.bit.GPIO57 = 1; // Configure GPIO57 as SPIST
;     | EA                                                                     
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+8,#0xff3f ; [CPU_] |93| 
        ORB       AL,#0x40              ; [CPU_] |93| 
        MOV       @_GpioCtrlRegs+8,AL   ; [CPU_] |93| 
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 100,column 5,is_stmt
;----------------------------------------------------------------------
; 100 | EDIS;                                                                  
;----------------------------------------------------------------------
 EDIS
	.dwpsn	file "../DSP_source/DSP2833x_Spi.c",line 101,column 1,is_stmt
        SPM       #0                    ; [CPU_] 
$C$DW$8	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$8, DW_AT_TI_return
        LRETR     ; [CPU_] 
        ; return occurs ; [] 
	.dwattr $C$DW$7, DW_AT_TI_end_file("../DSP_source/DSP2833x_Spi.c")
...
$C$DW$9	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$9, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
...
$C$DW$10	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$10, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x02)
...
$C$DW$11	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$11, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x02)
...
$C$DW$12	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$12, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x02)
...
$C$DW$13	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$13, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x02)
...
$C$DW$14	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$14, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x02)
...
$C$DW$15	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$15, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x02)
...
$C$DW$16	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$16, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x02)
...
$C$DW$17	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$17, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
...
$C$DW$18	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$18, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x02)
...
$C$DW$19	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$19, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x02)
...
$C$DW$20	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$20, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x02)
...
$C$DW$21	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$21, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x02)
...
$C$DW$22	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$22, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x02)
...
$C$DW$23	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$23, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x02)
...
$C$DW$24	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$24, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x02)
...
$C$DW$27	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$27, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
...
$C$DW$28	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$28, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x02)
...
$C$DW$29	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$29, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x02)
...
$C$DW$30	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$30, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x02)
...
$C$DW$31	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$31, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x02)
...
$C$DW$32	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$32, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x02)
...
$C$DW$33	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$33, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x02)
...
$C$DW$34	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$34, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x02)
...
$C$DW$37	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$37, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x02)
...
$C$DW$38	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$38, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x02)
...
$C$DW$39	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$39, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x02)
...
$C$DW$40	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$40, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x02)
...
$C$DW$41	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$41, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x02)
...
$C$DW$42	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$42, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x02)
...
$C$DW$47	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$47, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x08)
...
$C$DW$48	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$48, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x08)
...
$C$DW$59	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$59, DW_AT_bit_offset(0x07), DW_AT_bit_size(0x01)
...
$C$DW$60	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$60, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x01)
...
$C$DW$61	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$61, DW_AT_bit_offset(0x05), DW_AT_bit_size(0x01)
...
$C$DW$63	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$63, DW_AT_bit_offset(0x03), DW_AT_bit_size(0x01)
...
$C$DW$64	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$64, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x01)
...
$C$DW$65	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$65, DW_AT_bit_offset(0x01), DW_AT_bit_size(0x01)
...
$C$DW$66	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$66, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x01)
...
$C$DW$86	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$86, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x02)
...
$C$DW$87	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$87, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x02)
...
$C$DW$89	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$89, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x02)
...
$C$DW$90	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$90, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x02)
...
$C$DW$97	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$97, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x02)
...
$C$DW$98	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$98, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x02)
...
$C$DW$99	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$99, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x02)
...
$C$DW$100	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$100, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x02)
...
$C$DW$123	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$123, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x08)
...
$C$DW$129	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$129, DW_AT_bit_offset(0x0d), DW_AT_bit_size(0x01)
...
$C$DW$130	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$130, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x01)
...
$C$DW$131	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$131, DW_AT_bit_offset(0x0b), DW_AT_bit_size(0x01)
...
$C$DW$132	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$132, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x01)
...
$C$DW$134	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$134, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x01)
...
$C$DW$135	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$135, DW_AT_bit_offset(0x07), DW_AT_bit_size(0x01)
...
$C$DW$137	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$137, DW_AT_bit_offset(0x05), DW_AT_bit_size(0x01)
...
$C$DW$144	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$144, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x01)
...
$C$DW$146	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$146, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x01)
...
$C$DW$148	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$148, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x01)
...
$C$DW$149	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$149, DW_AT_bit_offset(0x09), DW_AT_bit_size(0x01)
...
$C$DW$150	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$150, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x01)
...
$C$DW$151	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$151, DW_AT_bit_offset(0x07), DW_AT_bit_size(0x01)
...
$C$DW$152	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$152, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x01)
...
$C$DW$153	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$153, DW_AT_bit_offset(0x05), DW_AT_bit_size(0x01)
...
$C$DW$154	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$154, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x01)
...
$C$DW$155	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$155, DW_AT_bit_offset(0x03), DW_AT_bit_size(0x01)
...
$C$DW$156	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$156, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x01)
...
$C$DW$157	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$157, DW_AT_bit_offset(0x01), DW_AT_bit_size(0x01)
...
$C$DW$158	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$158, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x01)
...
$C$DW$161	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$161, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
...
$C$DW$162	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$162, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x02)
...
$C$DW$163	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$163, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x02)
...
$C$DW$164	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$164, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x02)
...
$C$DW$165	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$165, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x02)
...
$C$DW$166	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$166, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x02)
...
$C$DW$167	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$167, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x02)
...
$C$DW$214	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$214, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x08)
...
$C$DW$239	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("AL")
	.dwattr $C$DW$239, DW_AT_location[DW_OP_reg0]
$C$DW$240	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("AH")
	.dwattr $C$DW$240, DW_AT_location[DW_OP_reg1]
$C$DW$241	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("PL")
	.dwattr $C$DW$241, DW_AT_location[DW_OP_reg2]
$C$DW$242	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("PH")
	.dwattr $C$DW$242, DW_AT_location[DW_OP_reg3]
$C$DW$243	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("T")
	.dwattr $C$DW$243, DW_AT_location[DW_OP_reg22]
$C$DW$244	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("IER")
	.dwattr $C$DW$244, DW_AT_location[DW_OP_regx 0x25]
$C$DW$245	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("IFR")
	.dwattr $C$DW$245, DW_AT_location[DW_OP_regx 0x24]
$C$DW$246	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("ST0")
	.dwattr $C$DW$246, DW_AT_location[DW_OP_reg23]
$C$DW$247	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("SXM")
	.dwattr $C$DW$247, DW_AT_location[DW_OP_reg30]
$C$DW$248	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("PM")
	.dwattr $C$DW$248, DW_AT_location[DW_OP_reg31]
$C$DW$249	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("OVM")
	.dwattr $C$DW$249, DW_AT_location[DW_OP_regx 0x20]
$C$DW$250	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("V")
...
$C$DW$252	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("PAGE0")
...
$C$DW$254	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("AMODE")
	.dwattr $C$DW$254, DW_AT_location[DW_OP_regx 0x22]
$C$DW$255	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("PSEUDOH")
	.dwattr $C$DW$255, DW_AT_location[DW_OP_regx 0x4c]
$C$DW$256	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("XT")
	.dwattr $C$DW$256, DW_AT_location[DW_OP_reg21]
$C$DW$257	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("SP")
	.dwattr $C$DW$257, DW_AT_location[DW_OP_reg20]
$C$DW$258	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("FP")
	.dwattr $C$DW$258, DW_AT_location[DW_OP_reg28]
$C$DW$259	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("DP")
	.dwattr $C$DW$259, DW_AT_location[DW_OP_reg29]
$C$DW$260	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("PC")
	.dwattr $C$DW$260, DW_AT_location[DW_OP_reg25]
$C$DW$261	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("VOL")
	.dwattr $C$DW$261, DW_AT_location[DW_OP_regx 0x4d]
$C$DW$262	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("AR0")
	.dwattr $C$DW$262, DW_AT_location[DW_OP_reg4]
$C$DW$263	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("AR1")
	.dwattr $C$DW$263, DW_AT_location[DW_OP_reg6]
$C$DW$264	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("AR2")
...
$C$DW$267	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("AR5")
...
$C$DW$272	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("XAR0")
...
$C$DW$274	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("XAR2")
	.dwattr $C$DW$274, DW_AT_location[DW_OP_reg9]
$C$DW$275	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("XAR3")
	.dwattr $C$DW$275, DW_AT_location[DW_OP_reg11]
$C$DW$276	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("XAR4")
	.dwattr $C$DW$276, DW_AT_location[DW_OP_reg13]
$C$DW$277	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("XAR5")
	.dwattr $C$DW$277, DW_AT_location[DW_OP_reg15]
$C$DW$278	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("R0HL")
	.dwattr $C$DW$278, DW_AT_location[DW_OP_regx 0x2b]
$C$DW$279	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("R0H")
	.dwattr $C$DW$279, DW_AT_location[DW_OP_regx 0x2c]
$C$DW$280	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("R1HL")
	.dwattr $C$DW$280, DW_AT_location[DW_OP_regx 0x2f]
$C$DW$281	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("R1H")
	.dwattr $C$DW$281, DW_AT_location[DW_OP_regx 0x30]
$C$DW$282	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("R2HL")
	.dwattr $C$DW$282, DW_AT_location[DW_OP_regx 0x33]
$C$DW$283	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("R2H")
	.dwattr $C$DW$283, DW_AT_location[DW_OP_regx 0x34]
$C$DW$284	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("R3HL")
	.dwattr $C$DW$284, DW_AT_location[DW_OP_regx 0x37]
$C$DW$285	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("R3H")
	.dwattr $C$DW$285, DW_AT_location[DW_OP_regx 0x38]
$C$DW$286	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("R4HL")
	.dwattr $C$DW$286, DW_AT_location[DW_OP_regx 0x3b]
$C$DW$287	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("R4H")
	.dwattr $C$DW$287, DW_AT_location[DW_OP_regx 0x3c]
$C$DW$288	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("R5HL")
	.dwattr $C$DW$288, DW_AT_location[DW_OP_regx 0x3f]
$C$DW$289	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("R5H")
	.dwattr $C$DW$289, DW_AT_location[DW_OP_regx 0x40]
$C$DW$290	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("R6HL")
	.dwattr $C$DW$290, DW_AT_location[DW_OP_regx 0x43]
$C$DW$291	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("R6H")
	.dwattr $C$DW$291, DW_AT_location[DW_OP_regx 0x44]
$C$DW$292	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("R7HL")
	.dwattr $C$DW$292, DW_AT_location[DW_OP_regx 0x47]
$C$DW$293	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("R7H")
	.dwattr $C$DW$293, DW_AT_location[DW_OP_regx 0x48]
$C$DW$294	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("RBL")
	.dwattr $C$DW$294, DW_AT_location[DW_OP_regx 0x49]
$C$DW$295	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("RB")
	.dwattr $C$DW$295, DW_AT_location[DW_OP_regx 0x4a]
$C$DW$296	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("STFL")
	.dwattr $C$DW$296, DW_AT_location[DW_OP_regx 0x27]
$C$DW$297	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("STF")
	.dwattr $C$DW$297, DW_AT_location[DW_OP_regx 0x28]
$C$DW$298	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("FPUHAZ")
	.dwattr $C$DW$298, DW_AT_location[DW_OP_reg27]
$C$DW$299	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("CIE_RETA")
