...
;* Date/Time created: Wed Oct 18 19:53:58 2023                 *
;***************************************************************
	.compiler_opts --float_support=fpu32 --hll_source=on --mem_model:code=flat --mem_model:data=large --object_format=coff --silicon_version=28 --symdebug:dwarf 
FP	.set	XAR2

$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../App_source/Invstart.c")
	.dwattr $C$DW$CU, DW_AT_producer("TMS320C2000 C/C++ Codegen PC v6.1.3 Copyright (c) 1996-2012 Texas Instruments Incorporated")
	.dwattr $C$DW$CU, DW_AT_TI_version(0x01)
	.dwattr $C$DW$CU, DW_AT_comp_dir("E:\Code\v10.4\IVGM15048\Test\IVGM15048M_V001-Pll\Debug")
;	D:\ti\ccs1040\ccs\tools\compiler\c2000_6.1.3.LTS\bin\ac2000.exe -@C:\\Users\\Ivan\\AppData\\Local\\Temp\\2144012 
	.sect	".text"
	.global	_INVSTART_20MsDone

$C$DW$1	.dwtag  DW_TAG_subprogram, DW_AT_name("INVSTART_20MsDone")
	.dwattr $C$DW$1, DW_AT_low_pc(_INVSTART_20MsDone)
	.dwattr $C$DW$1, DW_AT_high_pc(0x00)
	.dwattr $C$DW$1, DW_AT_TI_symbol_name("_INVSTART_20MsDone")
	.dwattr $C$DW$1, DW_AT_external
	.dwattr $C$DW$1, DW_AT_TI_begin_file("../App_source/Invstart.c")
	.dwattr $C$DW$1, DW_AT_TI_begin_line(0x18)
	.dwattr $C$DW$1, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$1, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../App_source/Invstart.c",line 25,column 1,is_stmt,address _INVSTART_20MsDone

	.dwfde $C$DW$CIE, _INVSTART_20MsDone
;----------------------------------------------------------------------
;  24 | void INVSTART_20MsDone()                                               
;----------------------------------------------------------------------

;***************************************************************
;* FNAME: _INVSTART_20MsDone            FR SIZE:   0           *
;*                                                             *
...
_INVSTART_20MsDone:
	...
	.dwpsn	file "../App_source/Invstart.c",line 27,column 1,is_stmt
$C$DW$2	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$2, DW_AT_low_pc(0x00)
	.dwattr $C$DW$2, DW_AT_TI_return
        LRETR     ; [CPU_] 
        ; return occurs ; [] 
	.dwattr $C$DW$1, DW_AT_TI_end_file("../App_source/Invstart.c")
	...
	.sect	".text"
	.global	_INVSTART_Data_Init

$C$DW$3	.dwtag  DW_TAG_subprogram, DW_AT_name("INVSTART_Data_Init")
	.dwattr $C$DW$3, DW_AT_low_pc(_INVSTART_Data_Init)
	.dwattr $C$DW$3, DW_AT_high_pc(0x00)
	.dwattr $C$DW$3, DW_AT_TI_symbol_name("_INVSTART_Data_Init")
	.dwattr $C$DW$3, DW_AT_external
	.dwattr $C$DW$3, DW_AT_TI_begin_file("../App_source/Invstart.c")
	.dwattr $C$DW$3, DW_AT_TI_begin_line(0x27)
	.dwattr $C$DW$3, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$3, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../App_source/Invstart.c",line 40,column 1,is_stmt,address _INVSTART_Data_Init

	.dwfde $C$DW$CIE, _INVSTART_Data_Init
;----------------------------------------------------------------------
;  39 | void INVSTART_Data_Init()                                              
;----------------------------------------------------------------------

;***************************************************************
;* FNAME: _INVSTART_Data_Init           FR SIZE:   0           *
;*                                                             *
;* FUNCTION ENVIRONMENT                                        *
;*                                                             *
;* FUNCTION PROPERTIES                                         *
...
_INVSTART_Data_Init:
	...
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
	.dwpsn	file "../App_source/Invstart.c",line 42,column 1,is_stmt
$C$DW$4	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$4, DW_AT_low_pc(0x00)
	.dwattr $C$DW$4, DW_AT_TI_return
        LRETR     ; [CPU_] 
        ; return occurs ; [] 
	.dwattr $C$DW$3, DW_AT_TI_end_file("../App_source/Invstart.c")
