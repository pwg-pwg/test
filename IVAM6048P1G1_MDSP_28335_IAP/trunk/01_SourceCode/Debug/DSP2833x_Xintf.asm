...
;	D:\ti\ccs1040\ccs\tools\compiler\c2000_6.1.3.LTS\bin\ac2000.exe -@C:\\Users\\Ivan\\AppData\\Local\\Temp\\1119612 
	.sect	".text"
	.global	_InitXintf
...
_InitXintf:
;----------------------------------------------------------------------
;  33 | // This shows how to write to the XINTF registers.  The                
;  34 | // values used here are the default state after reset.                 
;  35 | // Different hardware will require a different configuration.          
;  37 | // For an example of an XINTF configuration used with the              
;  38 | // F28335 eZdsp, refer to the examples/run_from_xintf project.         
;  40 | // Any changes to XINTF timing should only be made by code             
;  41 | // running outside of the XINTF.                                       
;  43 | // All Zones---------------------------------                          
;  44 | // Timing for all zones based on XTIMCLK = 1/2 SYSCLKOUT               
;----------------------------------------------------------------------
	.dwcfi	cfa_offset, -2
...
;  70 | // Zone will sample XREADY signal                                      
;  71 | //XintfRegs.XTIMING0.bit.USEREADY = 1;                                 
;  72 | //XintfRegs.XTIMING0.bit.READYMODE = 1;  // sample asynchronous        
;----------------------------------------------------------------------
        OR        @_XintfRegs+1,#0x0040 ; [CPU_] |68| 
	.dwpsn	file "../DSP_source/DSP2833x_Xintf.c",line 73,column 5,is_stmt
;----------------------------------------------------------------------
;  73 | XintfRegs.XTIMING0.bit.USEREADY = 0;  // modify 20140310               
;----------------------------------------------------------------------
        AND       @_XintfRegs,#0xbfff   ; [CPU_] |73| 
	.dwpsn	file "../DSP_source/DSP2833x_Xintf.c",line 74,column 5,is_stmt
;----------------------------------------------------------------------
;  74 | XintfRegs.XTIMING0.bit.READYMODE = 0;                                  
...
;----------------------------------------------------------------------
; 152 | GpioCtrlRegs.GPBMUX2.bit.GPIO48 = 3;  // XD31                          
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; 193 | GpioCtrlRegs.GPCMUX1.bit.GPIO64 = 3;  // XD15                          
;----------------------------------------------------------------------
