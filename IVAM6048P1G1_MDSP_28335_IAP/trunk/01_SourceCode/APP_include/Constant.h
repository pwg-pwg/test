...
#define cDSPVersion     ((Uint16)1001)	//
#define cVerDate        ((Uint16)40809)	//IAP
#define cMachineMode    ((Uint16)8048)    // 机器型号
...
// 模拟量额定值
#define cPhase2                  (float)2.0  //single bridge
#define cKEffy                   (float)0.95
#define cKEffyDiv                (float)(1.0/KEffy)
#define cPowerRated              (float)8000.0
#define cKPowerRated             (float)(1.0/cPowerRated)
#define cSinglePRated            (float)(cPowerRated/cPhase2)  // 单相额定功率
#define cVBatRated               (float)50.0
#define cVBusRated               (float)400.0 // (float)700.0
#define cVInvRated               (float)110.0
#define cIBatRated               (float)160.0   // 电池电流没有采样
#define cILlcRated               (float)20.0   //(float)25.0    // 这个频率太高 采不到
#define cIBusRated               (float)25.0 // (float)25.0    // 电感电流 平衡电路电感电流
#define cVNERated                (float)110.0   // 这个不确定
...
#define cTransformerRatio			9  // LLC变比

// Inv 
#define cPWMCntlPeriod50Hz          3906    //52us 19.2k
#define cPWMCntlPeriod60Hz          3857    //52us 19.445k

#define cInvSoftDuty                (0.06)

// LLC Freq 29k
#define cLLCPwmPeriod           2586    //25K 75000/3000=25k
#define cLLCDutyMax              1190    //46% cLLCPwmPeriod * Duty

#define cLLCDuty0001        3   //0.1%
#define cLLCDuty001         26  //1%
#define cLLCDuty002         52  //2%
#define cLLCDuty003         78  //3%
#define cLLCDuty006         155 //6%
#define cLLCDuty008         207 //8%
#define cLLCDuty010         259 //10%
#define cLLCDuty015         388 //15%
#define cLLCDuty020         517 //20%
#define cLLCDuty030         776 //30%

#define cLLCDutySoftStep1Lmt    cLLCDuty003  // Step1 Limit
...
// BusBlcPwm  频率 38.4K
#define cBusBlcPWMPeriod            1953    //26us 38.4k

#define cBusBlcDuty001              20     //1%*cBusBlcPWMPeriod
#define cBusBlcDuty002              39     //2%*cBusBlcPWMPeriod
#define cBusBlcDuty004              78     //4%*cBusBlcPWMPeriod
#define cBusBlcDuty010              195    //10%*cBusBlcPWMPeriod
#define cBusBlcDuty046              898    //46%*cBusBlcPWMPeriod
#define cBusBlcDuty050              976    //50%*cBusBlcPWMPeriod
#define cBusBlcDuty070              1367   //70%*cBusBlcPWMPeriod
#define cBusBlcDuty075              1464   //75%*cBusBlcPWMPeriod
#define cBusBlcDuty080              1562   //80%*cBusBlcPWMPeriod
#define cBusBlcDuty087              1700   //87%*cBusBlcPWMPeriod

#define cBusBlcDutyMin              cBusBlcDuty010
#define cBusBlcDutyMax              cBusBlcDuty050  // 最大和最小加起来必须小于100

#define cBusBlcSoftDutyLmt          cBusBlcDuty010  // 硬件驱动吃掉太多us 先用10%

// BuckBoost 频率19.2k
#define cBuckBoostPWMPeriod         3906    //19.2k

#define Dead_Time                   270    //Td*EPWMCLK 270/150M = 1.8us

#define cBuckBoostDuty005           195    // 5%*cBusBlcPWMPeriod
#define cBuckBoostDuty030           1171   // 30%*cBusBlcPWMPeriod
#define cBuckBoostDuty050           1953   // 50%*cBusBlcPWMPeriod
#define cBuckBoostDuty090           3515   // 90%*cBusBlcPWMPeriod

#define cBuckBoostDutyMin           cBusBlcDuty010
#define cBuckBoostDutyMax           cBuckBoostDuty090

#define cFanSpeedPeriod             3750    //20K
...
#define mInvPWMDisable()        {EALLOW;\
                                ...
                                EDIS;}
// A
#define mEnPosInvAPwmHigh()     EPwm1Regs.AQCSFRC.bit.CSFA = 2
#define mEnNegInvAPwmHigh()     EPwm2Regs.AQCSFRC.bit.CSFA = 2
#define mEnPosInvAPwmLow()      EPwm1Regs.AQCSFRC.bit.CSFA = 1
#define mEnNegInvAPwmLow()      EPwm2Regs.AQCSFRC.bit.CSFA = 1
#define mDisPosInvAPwmLow()     EPwm1Regs.AQCSFRC.bit.CSFA = 0
#define mDisNegInvAPwmLow()     EPwm2Regs.AQCSFRC.bit.CSFA = 0

// B
#define mEnPosInvBPwmHigh()     EPwm3Regs.AQCSFRC.bit.CSFA = 2
#define mEnNegInvBPwmHigh()     EPwm4Regs.AQCSFRC.bit.CSFA = 2
#define mEnPosInvBPwmLow()      EPwm3Regs.AQCSFRC.bit.CSFA = 1
#define mEnNegInvBPwmLow()      EPwm4Regs.AQCSFRC.bit.CSFA = 1
#define mDisPosInvBPwmLow()     EPwm3Regs.AQCSFRC.bit.CSFA = 0
#define mDisNegInvBPwmLow()     EPwm4Regs.AQCSFRC.bit.CSFA = 0
...
#define  mInvAPosPwm           EPwm1Regs.CMPA.half.CMPA
#define  mInvANegPwm           EPwm2Regs.CMPA.half.CMPA
#define  mInvBPosPwm           EPwm3Regs.CMPA.half.CMPA
#define  mInvBNegPwm           EPwm4Regs.CMPA.half.CMPA


#define  mLLCHighPwmUp         EPwm5Regs.CMPA.half.CMPA
#define  mLLCHighPwmDn         EPwm5Regs.CMPB
#define  mLLCLowPwmUp          EPwm6Regs.CMPA.half.CMPA
#define  mLLCLowPwmDn          EPwm6Regs.CMPB
