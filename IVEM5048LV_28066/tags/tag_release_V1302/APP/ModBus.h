...
/* ModBus Comms Register Map Define */
#define REALDATA_REG_BASE_ADDR	0x1100				// 瀹炴椂鏁版嵁瀵勫瓨鍣ㄨ捣濮嬪湴鍧�
#define REALDATA_REG_BASE_LEN	cRealTimeDataLen	// 瀹炴椂鏁版嵁瀵勫瓨鍣ㄩ暱搴?

#define REALBMSDATA_REG_BASE_ADDR  0x11FE                   // 实时数据BMS寄存器起始地址
#define REALBMSDATA_REG_BASE_LEN   cRealTimeBMSDataLen      // 实时数据BMS寄存器长度

#define SETTING_REG_BASE_ADDR	0x2100				// EEPROM鏁版嵁瀵勫瓨鍣ㄨ捣濮嬪湴鍧�
#define SETTING_REG_BASE_LEN	E1_Len+E2_Len		// EEPROM鏁版嵁瀵勫瓨鍣ㄩ暱搴?

#define GD_REG_BASE_ADDR        0x21AD                      // 电池包地址(GD设置)
#define GD_REG_BASE_LEN         GDAddr_Len                  // 数据长度

#define ATE_REG_BASE_ADDR		0x3100				// ATE鏁版嵁瀵勫瓨鍣ㄨ捣濮嬪湴鍧�
#define ATE_REG_BASE_LEN		ATE_Len				// ATE鏁版嵁瀵勫瓨鍣ㄩ暱搴?

#define FAULT_REG_BASE_ADDR		0x4100				// 鏁呴殰鏁版嵁瀵勫瓨鍣ㄨ捣濮嬪湴鍧�
#define FAULT_REG_BASE_LEN		cFaultDataLen		// 鏁呴殰鏁版嵁瀵勫瓨鍣ㄩ暱搴?
...
#define INFO_REG_BASE_ADDR		0xF800				// 绯荤粺淇℃伅鏁版嵁璧峰鍦板潃
#define INFO_REG_LEN			cInfoDataLen		// 绯荤粺淇℃伅鏁版嵁闀垮害
