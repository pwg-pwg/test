...
#define liBBIOVER     		GpioDataRegs.GPBDAT.bit.GPIO51
#define liLLCIOver     		GpioDataRegs.GPBDAT.bit.GPIO52
...
#define hoADCSWITCH2     	GpioDataRegs.GPADAT.bit.GPIO7		
#define hoADCSWITCH2On 		GpioDataRegs.GPASET.bit.GPIO7 = 1
#define hoADCSWITCH2Off 	GpioDataRegs.GPACLEAR.bit.GPIO7 = 1
