...
void sEEpromDataRangeChk(void)
{
	...
	{
		sSetEEOutputVolt(gc_strEepromDaultTable2.wEEOutputVolt);
		bUserChangeFlag = 1;
	}
	...
	if(swGetEEParallelEn() > 6/*4*/ || swGetEEParallelEn() < 0)
	{
