...
void sWarningUpdate(void)
{
	...
	if(!fBMSConnectFlg && g_uwBatType == cBatSocType && g_uwWorkMode > cPowerOnMode && g_ubBMSFirstCommDone)
	{
...
//	{
//	    uniWarningCode.BIT.uwWaringLineAbnormal = subGetLineLossStatus();
//	}
//	else
//	{
//	    uniWarningCode.BIT.uwWaringLineAbnormal = false;
//	}
