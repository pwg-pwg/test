...
;* Date/Time created: Mon Mar 09 10:30:34 2026                 *
;***************************************************************
...
;	D:\Application\WorkSoftware\TI\CCC7\ccsv7\tools\compiler\c2000_6.1.3.LTS\bin\ac2000.exe -@C:\\Users\\zy\\AppData\\Local\\Temp\\2784012 
	.sect	".text"
	.global	_InvertUint8
...
$C$DW$226	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$226, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM5048 LV\IVEM5048LV\IVEM5048LV_28066_V13.00\IVEM LV 5048\Debug\ModBus.asm:$C$L1:1:1773023434")
...
$C$DW$238	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$238, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM5048 LV\IVEM5048LV\IVEM5048LV_28066_V13.00\IVEM LV 5048\Debug\ModBus.asm:$C$L4:1:1773023434")
...
$C$DW$251	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$251, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM5048 LV\IVEM5048LV\IVEM5048LV_28066_V13.00\IVEM LV 5048\Debug\ModBus.asm:$C$L7:1:1773023434")
...
$C$DW$266	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$266, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM5048 LV\IVEM5048LV\IVEM5048LV_28066_V13.00\IVEM LV 5048\Debug\ModBus.asm:$C$L11:1:1773023434")
...
$C$DW$338	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$338, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM5048 LV\IVEM5048LV\IVEM5048LV_28066_V13.00\IVEM LV 5048\Debug\ModBus.asm:$C$L62:1:1773023434")
...
$C$DW$359	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$359, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM5048 LV\IVEM5048LV\IVEM5048LV_28066_V13.00\IVEM LV 5048\Debug\ModBus.asm:$C$L67:1:1773023434")
...
$C$DW$387	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$387, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM5048 LV\IVEM5048LV\IVEM5048LV_28066_V13.00\IVEM LV 5048\Debug\ModBus.asm:$C$L75:1:1773023434")
...
;     |  200) \                                                                
; 1700 |         && ((INT16S)WrData >= 900) && ((INT16S)WrData <= 1400))        
;----------------------------------------------------------------------
$C$DW$531	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$531, DW_AT_TI_call
        ...
        CMP       AL,#900               ; [CPU_] |1699| 
        B         $C$L221,LT            ; [CPU_] |1699| 
        ; branchcc occurs ; [] |1699| 
        CMP       AL,#1400              ; [CPU_] |1699| 
        B         $C$L221,GT            ; [CPU_] |1699| 
        ; branchcc occurs ; [] |1699| 
        MOVW      DP,#_g_uwRLineVolt    ; [CPU_U] 
        SETC      SXM                   ; [CPU_] 
...
;----------------------------------------------------------------------
; 2169 | uRealTimeData.Stru.wAlarmMsg[0] = (INT16U)(uniWarningCode.uwWarningInfo
;     |  >> 16);                                                               
;----------------------------------------------------------------------
        MOVL      ACC,@_uniWarningCode  ; [CPU_] |2169| 
        MOVW      DP,#_uRealTimeData+6  ; [CPU_U] 
        MOVH      @_uRealTimeData+6,ACC << 0 ; [CPU_] |2169| 
        MOVW      DP,#_uniWarningCode   ; [CPU_U] 
	.dwpsn	file "../APP/ModBus.c",line 2170,column 2,is_stmt
;----------------------------------------------------------------------
; 2170 | uRealTimeData.Stru.wAlarmMsg[1] = (INT16U)(uniWarningCode.uwWarningInfo
;     |  & 0x0000FFFF);                                                        
;----------------------------------------------------------------------
...
; 2196 | uRealTimeData.Stru.wRInvWatt = (INT16S)(g_dwRInvWatt);                 
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; 2202 | uRealTimeData.Stru.wROpWatt = (INT16S)g_dwOPWatt;                      
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; 2211 | uRealTimeData.Stru.wRLoadWatt = (INT16S)g_dwOPWatt;                    
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; 2222 | uRealTimeData.Stru.wTxtTempC = g_wConvertLTemp/10;                     
;----------------------------------------------------------------------
	...
	.dwpsn	file "../APP/ModBus.c",line 2222,column 2,is_stmt
        MOV       AL,@_g_wConvertLTemp  ; [CPU_] |2222| 
...
;----------------------------------------------------------------------
; 2224 | uRealTimeData.Stru.wBatTempC = g_wConvertLTemp/10;                     
;----------------------------------------------------------------------
	...
	.dwpsn	file "../APP/ModBus.c",line 2223,column 2,is_stmt
        ...
        MOVW      DP,#_g_wConvertLTemp  ; [CPU_U] 
	.dwpsn	file "../APP/ModBus.c",line 2224,column 2,is_stmt
        MOV       AL,@_g_wConvertLTemp  ; [CPU_] |2224| 
...
;     | _wVAType;                                                              
;----------------------------------------------------------------------
        MOV       @_uInfoData+1,#5128   ; [CPU_] |2308| 
...
;----------------------------------------------------------------------
        MOV       @_uInfoData+11,#1300  ; [CPU_] |2319| 
