...
;* Date/Time created: Mon Mar 09 10:23:30 2026                 *
;***************************************************************
...
;	D:\Application\WorkSoftware\TI\CCC7\ccsv7\tools\compiler\c2000_6.1.3.LTS\bin\opt2000.exe C:\\Users\\zy\\AppData\\Local\\Temp\\360882 C:\\Users\\zy\\AppData\\Local\\Temp\\360884 
;	D:\Application\WorkSoftware\TI\CCC7\ccsv7\tools\compiler\c2000_6.1.3.LTS\bin\ac2000.exe -@C:\\Users\\zy\\AppData\\Local\\Temp\\3608812 
	.sect	".text"
...
$C$DW$25	.dwtag  DW_TAG_variable, DW_AT_name("relaytype")
	...
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 21,column 2,is_stmt
        CMPB      AL,#0                 ; [CPU_] |21| 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 19,column 1,is_stmt
        MOVZ      AR6,AH                ; [CPU_] |19| 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 21,column 2,is_stmt
        BF        $C$L3,EQ              ; [CPU_] |21| 
        ; branchcc occurs ; [] |21| 
...
;*** 41	-----------------------    wRlyActionPointerTemp = ((((unsigned)gi_wPLLCtrlPointer+C$1+2u)/(unsigned)gi_wPLLPointThreeSix+1u)*gi_wPLLPointThreeSix-C$1)%(unsigned)gi_wPLLPointerMax;
	...
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 41,column 3,is_stmt
        ...
        MPYXU     P,T,AR6               ; [CPU_] |41| 
        MOV       ACC,@_g_wPwmPeriod    ; [CPU_] |41| 
        SPM       #0                    ; [CPU_] 
        MOVL      XAR6,ACC              ; [CPU_] |41| 
...
;*** 33	-----------------------    wRlyActionPointerTemp = ((unsigned)gi_wPLLPointerMax-(unsigned)((unsigned long)pointer*4500uL/(unsigned long)g_wPwmPeriod)%(unsigned)gi_wPLLPointerMax)%(unsigned)gi_wPLLPointerMax;
	...
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 33,column 3,is_stmt
        ...
        SETC      SXM                   ; [CPU_] 
        MOVW      DP,#_g_wPwmPeriod     ; [CPU_U] 
        MPYXU     P,T,AR6               ; [CPU_] |33| 
        MOV       ACC,@_g_wPwmPeriod    ; [CPU_] |33| 
        SPM       #0                    ; [CPU_] 
        MOVL      XAR6,ACC              ; [CPU_] |33| 
...
;*** 25	-----------------------    wRlyActionPointerTemp = ((unsigned)gi_wPLLCtrlPointer+(unsigned)((unsigned long)pointer*4500uL/(unsigned long)g_wPwmPeriod)+1u)%(unsigned)gi_wPLLPointerMax;
	...
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 25,column 3,is_stmt
        ...
        SETC      SXM                   ; [CPU_] 
        MOVW      DP,#_g_wPwmPeriod     ; [CPU_U] 
        MPYXU     P,T,AR6               ; [CPU_] |25| 
        MOV       ACC,@_g_wPwmPeriod    ; [CPU_] |25| 
        SPM       #0                    ; [CPU_] 
        MOVL      XAR6,ACC              ; [CPU_] |25| 
        MOVW      DP,#_gi_wPLLCtrlPointer ; [CPU_U] 
        MOVB      ACC,#0                ; [CPU_] |25| 
        RPT       #31
...
$C$DW$40	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$40, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM5048 LV\IVEM5048LV\IVEM5048LV_28066_V13.00\IVEM LV 5048\Debug\RlyDriver.asm:$C$L8:1:1773023010")
