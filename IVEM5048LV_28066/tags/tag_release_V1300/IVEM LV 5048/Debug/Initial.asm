...
;* Date/Time created: Mon Mar 09 10:30:22 2026                 *
;***************************************************************
...
;	D:\Application\WorkSoftware\TI\CCC7\ccsv7\tools\compiler\c2000_6.1.3.LTS\bin\opt2000.exe C:\\Users\\zy\\AppData\\Local\\Temp\\334962 C:\\Users\\zy\\AppData\\Local\\Temp\\334964 
;	D:\Application\WorkSoftware\TI\CCC7\ccsv7\tools\compiler\c2000_6.1.3.LTS\bin\ac2000.exe -@C:\\Users\\zy\\AppData\\Local\\Temp\\3349612 
	.sect	".text"
...
$C$DW$102	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$102, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM5048 LV\IVEM5048LV\IVEM5048LV_28066_V13.00\IVEM LV 5048\Debug\Initial.asm:$C$L3:1:1773023422")
...
$C$DW$104	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitPieCtrl")
	...
	.dwattr $C$DW$104, DW_AT_TI_begin_line(0x380)
	.dwattr $C$DW$104, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$104, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 897,column 1,is_stmt,address _sInitPieCtrl
...
_sInitPieCtrl:
;*** 899	-----------------------    asm(" setc INTM");
;*** 902	-----------------------    *&PieCtrlRegs &= 0xfffeu;
;*** 905	-----------------------    PieCtrlRegs.PIEIER1.all = 0u;
;*** 906	-----------------------    PieCtrlRegs.PIEIER2.all = 0u;
;*** 907	-----------------------    PieCtrlRegs.PIEIER3.all = 0u;
;*** 908	-----------------------    PieCtrlRegs.PIEIER4.all = 0u;
;*** 909	-----------------------    PieCtrlRegs.PIEIER5.all = 0u;
;*** 910	-----------------------    PieCtrlRegs.PIEIER6.all = 0u;
;*** 911	-----------------------    PieCtrlRegs.PIEIER7.all = 0u;
;*** 912	-----------------------    PieCtrlRegs.PIEIER8.all = 0u;
;*** 913	-----------------------    PieCtrlRegs.PIEIER9.all = 0u;
;*** 914	-----------------------    PieCtrlRegs.PIEIER10.all = 0u;
;*** 915	-----------------------    PieCtrlRegs.PIEIER11.all = 0u;
;*** 916	-----------------------    PieCtrlRegs.PIEIER12.all = 0u;
;*** 919	-----------------------    PieCtrlRegs.PIEIFR1.all = 0u;
;*** 920	-----------------------    PieCtrlRegs.PIEIFR2.all = 0u;
;*** 921	-----------------------    PieCtrlRegs.PIEIFR3.all = 0u;
;*** 922	-----------------------    PieCtrlRegs.PIEIFR4.all = 0u;
;*** 923	-----------------------    PieCtrlRegs.PIEIFR5.all = 0u;
;*** 924	-----------------------    PieCtrlRegs.PIEIFR6.all = 0u;
;*** 925	-----------------------    PieCtrlRegs.PIEIFR7.all = 0u;
;*** 926	-----------------------    PieCtrlRegs.PIEIFR8.all = 0u;
;*** 927	-----------------------    PieCtrlRegs.PIEIFR9.all = 0u;
;*** 928	-----------------------    PieCtrlRegs.PIEIFR10.all = 0u;
;*** 929	-----------------------    PieCtrlRegs.PIEIFR11.all = 0u;
;*** 930	-----------------------    PieCtrlRegs.PIEIFR12.all = 0u;
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$105	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$104, DW_AT_TI_end_line(0x3a3)
...
$C$DW$106	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitPieVectTable")
	...
	.dwattr $C$DW$106, DW_AT_TI_begin_line(0x3ac)
	.dwattr $C$DW$106, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$106, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 941,column 1,is_stmt,address _sInitPieVectTable
...
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
;*** 943	-----------------------    Source = &PieVectTableInit;
;*** 944	-----------------------    Dest = &PieVectTable;
;***  	-----------------------    L$1 = 127;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$108	.dwtag  DW_TAG_variable, DW_AT_name("Dest")
 ...
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 943,column 10,is_stmt
        MOVL      XAR5,#_PieVectTableInit ; [CPU_U] |943| 
	.dwpsn	file "../APP/Initial.c",line 944,column 10,is_stmt
        MOVL      XAR4,#_PieVectTable   ; [CPU_U] |944| 
        MOVB      XAR6,#127             ; [CPU_] 
$C$L5:    
$C$DW$L$_sInitPieVectTable$2$B:
;***	-----------------------g2:
;*** 948	-----------------------    *Dest++ = *Source++;
;*** 947	-----------------------    if ( (L$1 = L$1-1) != (-1) ) goto g2;
	.dwpsn	file "../APP/Initial.c",line 948,column 3,is_stmt
        MOVL      ACC,*XAR5++           ; [CPU_] |948| 
        MOVL      *XAR4++,ACC           ; [CPU_] |948| 
	.dwpsn	file "../APP/Initial.c",line 947,column 11,is_stmt
        BANZ      $C$L5,AR6--           ; [CPU_] |947| 
        ; branchcc occurs ; [] |947| 
...
;***  	-----------------------    return;
 EDIS
	...
	.dwpsn	file "../APP/Initial.c",line 952,column 2,is_stmt
        OR        @_PieCtrlRegs,#0x0001 ; [CPU_] |952| 
...
$C$DW$110	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$110, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM5048 LV\IVEM5048LV\IVEM5048LV_28066_V13.00\IVEM LV 5048\Debug\Initial.asm:$C$L5:1:1773023422")
	.dwattr $C$DW$110, DW_AT_TI_begin_file("../APP/Initial.c")
	.dwattr $C$DW$110, DW_AT_TI_begin_line(0x3b3)
	.dwattr $C$DW$110, DW_AT_TI_end_line(0x3b4)
$C$DW$111	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$106, DW_AT_TI_end_line(0x3ba)
...
$C$DW$112	.dwtag  DW_TAG_subprogram, DW_AT_name("MemCopy")
	...
	.dwattr $C$DW$112, DW_AT_TI_begin_line(0x5a7)
	.dwattr $C$DW$112, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$112, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 1448,column 1,is_stmt,address _MemCopy
...
;***************************************************************
_MemCopy:
;** 1449	-----------------------    if ( SourceAddr >= SourceEndAddr ) goto g4;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$119	.dwtag  DW_TAG_variable, DW_AT_name("$O$L1")
	...
	.dwattr $C$DW$119, DW_AT_location[DW_OP_reg14]
        MOVL      ACC,XAR5              ; [CPU_] |1448| 
        MOVL      XAR6,*-SP[4]          ; [CPU_] |1448| 
	.dwpsn	file "../APP/Initial.c",line 1449,column 11,is_stmt
        CMPL      ACC,XAR4              ; [CPU_] |1449| 
        B         $C$L7,LOS             ; [CPU_] |1449| 
...
$C$DW$L$_MemCopy$3$B:
;***	-----------------------g3:
;** 1451	-----------------------    *DestAddr++ = *SourceAddr++;
;** 1449	-----------------------    if ( (L$1 = L$1-1L) != (-1L) ) goto g3;
;***	-----------------------g4:
;***  	-----------------------    return;
	.dwpsn	file "../APP/Initial.c",line 1451,column 8,is_stmt
        MOV       AL,*XAR4++            ; [CPU_] |1451| 
	.dwpsn	file "../APP/Initial.c",line 1449,column 11,is_stmt
        SUBB      XAR5,#1               ; [CPU_U] |1449| 
	.dwpsn	file "../APP/Initial.c",line 1451,column 8,is_stmt
        MOV       *XAR6++,AL            ; [CPU_] |1451| 
	.dwpsn	file "../APP/Initial.c",line 1449,column 11,is_stmt
        MOVB      ACC,#0                ; [CPU_] |1449| 
        SUBB      ACC,#1                ; [CPU_] |1449| 
        CMPL      ACC,XAR5              ; [CPU_] |1449| 
        BF        $C$L6,NEQ             ; [CPU_] |1449| 
        ; branchcc occurs ; [] |1449| 
$C$DW$L$_MemCopy$3$E:
$C$L7:    
...
$C$DW$121	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$121, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM5048 LV\IVEM5048LV\IVEM5048LV_28066_V13.00\IVEM LV 5048\Debug\Initial.asm:$C$L6:1:1773023422")
	.dwattr $C$DW$121, DW_AT_TI_begin_file("../APP/Initial.c")
	.dwattr $C$DW$121, DW_AT_TI_begin_line(0x5a9)
	.dwattr $C$DW$121, DW_AT_TI_end_line(0x5ac)
$C$DW$122	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$112, DW_AT_TI_end_line(0x5ae)
...
$C$DW$126	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitEPWM")
	...
	.dwattr $C$DW$126, DW_AT_TI_begin_line(0x3c1)
	.dwattr $C$DW$126, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$126, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 962,column 1,is_stmt,address _sInitEPWM
...
_sInitEPWM:
;*** 963	-----------------------    asm(" EALLOW");
;*** 964	-----------------------    *(&SysCtrlRegs+12L) &= 0xfffbu;
;*** 965	-----------------------    asm(" EDIS");
;*** 968	-----------------------    asm(" EALLOW");
;*** 969	-----------------------    *(&EPwm1Regs+20L) = *((C$8 = &EPwm1Regs)+20L)&0xfffeu|2u;
;*** 970	-----------------------    *(&EPwm1Regs+20L) = *(&EPwm1Regs+20L)&0xfffbu|0x8u;
;*** 971	-----------------------    *((volatile struct AQSFRC_BITS *)C$8+13L) |= 0xc0u;
;*** 972	-----------------------    asm(" EDIS");
;*** 973	-----------------------    EPwm1Regs.TBPRD = 2344u;
;*** 974	-----------------------    EPwm1Regs.TBPHS.half.TBPHS = 0u;
;*** 975	-----------------------    EPwm1Regs.TBCTR = 0u;
;*** 976	-----------------------    *(volatile unsigned *)C$8 &= 0xe3ffu;
;*** 977	-----------------------    *(volatile unsigned *)C$8 &= 0xfc7fu;
;*** 978	-----------------------    *(volatile unsigned *)C$8 = *(volatile unsigned *)C$8&0xfffeu|2u;
;*** 979	-----------------------    *(volatile unsigned *)C$8 &= 0xfffbu;
;*** 980	-----------------------    *(volatile unsigned *)C$8 &= 0xfff7u;
;*** 982	-----------------------    *(volatile unsigned *)C$8 |= 0x30u;
;*** 984	-----------------------    *((volatile struct CMPCTL_BITS *)C$8+7L) &= 0xffefu;
;*** 985	-----------------------    *(&EPwm1Regs+7L) &= 0xfffcu;
;*** 986	-----------------------    *(&EPwm1Regs+7L) &= 0xffbfu;
;*** 987	-----------------------    *(&EPwm1Regs+7L) &= 0xfff3u;
;*** 988	-----------------------    EPwm1Regs.AQCTLA.all = 1365u;
;*** 989	-----------------------    EPwm1Regs.AQCTLB.all = 1365u;
;*** 990	-----------------------    EPwm1Regs.CMPA.half.CMPA = 0xffffu;
;*** 991	-----------------------    EPwm1Regs.CMPB = 0xffffu;
;*** 993	-----------------------    *((volatile struct DBCTL_BITS *)C$8+15L) &= 0xfffcu;
;*** 994	-----------------------    *(&EPwm1Regs+15L) = *(&EPwm1Regs+15L)&0xfffbu|0x8u;
;*** 995	-----------------------    EPwm1Regs.DBFED = 153u;
;*** 996	-----------------------    EPwm1Regs.DBRED = 153u;
;*** 998	-----------------------    *((volatile struct ETPS_BITS *)C$8+26L) &= 0xfff3u;
;*** 999	-----------------------    *(&EPwm1Regs+26L) = *(&EPwm1Regs+26L)&0xfffcu|1u;
;** 1000	-----------------------    *((volatile struct ETSEL_BITS *)C$8+25L) |= 0x8u;
;** 1002	-----------------------    *(&EPwm1Regs+25L) = *(&EPwm1Regs+25L)&0xfff8u|2u;
;** 1004	-----------------------    *((volatile struct ETCLR_BITS *)C$8+28L) |= 1u;
;** 1006	-----------------------    *(&EPwm1Regs+25L) |= 0x800u;
;** 1007	-----------------------    *(&EPwm1Regs+25L) = *(&EPwm1Regs+25L)&0xf8ffu|0x200u;
;** 1008	-----------------------    *(&EPwm1Regs+26L) = *(&EPwm1Regs+26L)&0xf7ffu|0x400u;
;** 1009	-----------------------    *(&EPwm1Regs+26L) = *(&EPwm1Regs+26L)&0xfdffu|0x100u;
;** 1010	-----------------------    *(&EPwm1Regs+25L) |= 0x8000u;
;** 1011	-----------------------    *(&EPwm1Regs+25L) = *(&EPwm1Regs+25L)&0x8fffu|0x2000u;
;** 1012	-----------------------    *(&EPwm1Regs+26L) = *(&EPwm1Regs+26L)&0x3fffu|0x4000u;
;** 1013	-----------------------    *(&EPwm1Regs+26L) = *(&EPwm1Regs+26L)&0xdfffu|0x1000u;
;** 1016	-----------------------    asm(" EALLOW");
;** 1017	-----------------------    *(&EPwm2Regs+20L) = *((C$7 = &EPwm2Regs)+20L)&0xfffeu|2u;
;** 1018	-----------------------    *(&EPwm2Regs+20L) = *(&EPwm2Regs+20L)&0xfffbu|0x8u;
;** 1019	-----------------------    *((volatile struct AQSFRC_BITS *)C$7+13L) |= 0xc0u;
;** 1020	-----------------------    asm(" EDIS");
;** 1021	-----------------------    EPwm2Regs.TBPRD = 2344u;
;** 1022	-----------------------    EPwm2Regs.TBPHS.half.TBPHS = 0u;
;** 1023	-----------------------    EPwm2Regs.TBCTR = 0u;
;** 1024	-----------------------    *(volatile unsigned *)C$7 &= 0xe3ffu;
;** 1025	-----------------------    *(volatile unsigned *)C$7 &= 0xfc7fu;
;** 1026	-----------------------    *(volatile unsigned *)C$7 = *(volatile unsigned *)C$7&0xfffeu|2u;
;** 1027	-----------------------    *(volatile unsigned *)C$7 &= 0xfffbu;
;** 1028	-----------------------    *(volatile unsigned *)C$7 &= 0xfff7u;
;** 1030	-----------------------    *(volatile unsigned *)C$7 |= 0x30u;
;** 1032	-----------------------    *((volatile struct CMPCTL_BITS *)C$7+7L) &= 0xffefu;
;** 1033	-----------------------    *(&EPwm2Regs+7L) &= 0xfffcu;
;** 1034	-----------------------    *(&EPwm2Regs+7L) &= 0xffbfu;
;** 1035	-----------------------    *(&EPwm2Regs+7L) &= 0xfff3u;
;** 1036	-----------------------    EPwm2Regs.AQCTLA.all = 1365u;
;** 1037	-----------------------    EPwm2Regs.AQCTLB.all = 1365u;
;** 1038	-----------------------    EPwm2Regs.CMPA.half.CMPA = 0xffffu;
;** 1039	-----------------------    EPwm2Regs.CMPB = 0xffffu;
;** 1041	-----------------------    *((volatile struct DBCTL_BITS *)C$7+15L) &= 0xfffcu;
;** 1042	-----------------------    *(&EPwm2Regs+15L) = *(&EPwm2Regs+15L)&0xfffbu|0x8u;
;** 1043	-----------------------    EPwm2Regs.DBFED = 153u;
;** 1044	-----------------------    EPwm2Regs.DBRED = 153u;
;** 1046	-----------------------    *((volatile struct ETPS_BITS *)C$7+26L) &= 0xfff3u;
;** 1047	-----------------------    *(&EPwm2Regs+26L) = *(&EPwm2Regs+26L)&0xfffcu|1u;
;** 1048	-----------------------    *((volatile struct ETSEL_BITS *)C$7+25L) |= 0x8u;
;** 1049	-----------------------    *(&EPwm2Regs+25L) = *(&EPwm2Regs+25L)&0xfff8u|1u;
;** 1051	-----------------------    *((volatile struct ETCLR_BITS *)C$7+28L) |= 1u;
;** 1053	-----------------------    *(&EPwm2Regs+25L) |= 0x800u;
;** 1054	-----------------------    *(&EPwm2Regs+25L) = *(&EPwm2Regs+25L)&0xf9ffu|0x100u;
;** 1055	-----------------------    *(&EPwm2Regs+26L) = *(&EPwm2Regs+26L)&0xf7ffu|0x400u;
;** 1056	-----------------------    *(&EPwm2Regs+26L) = *(&EPwm2Regs+26L)&0xfdffu|0x100u;
;** 1057	-----------------------    *(&EPwm2Regs+25L) |= 0x8000u;
;** 1058	-----------------------    *(&EPwm2Regs+25L) = *(&EPwm2Regs+25L)&0x9fffu|0x1000u;
;** 1059	-----------------------    *(&EPwm2Regs+26L) = *(&EPwm2Regs+26L)&0x3fffu|0x4000u;
;** 1060	-----------------------    *(&EPwm2Regs+26L) = *(&EPwm2Regs+26L)&0xdfffu|0x1000u;
;** 1062	-----------------------    asm(" EALLOW");
;** 1063	-----------------------    *(&EPwm3Regs+20L) = *((C$6 = &EPwm3Regs)+20L)&0xfffeu|2u;
;** 1064	-----------------------    asm(" EDIS");
;** 1066	-----------------------    EPwm3Regs.TBPRD = 2344u;
;** 1068	-----------------------    EPwm3Regs.TBPHS.half.TBPHS = 0u;
;** 1069	-----------------------    EPwm3Regs.TBCTR = 0u;
;** 1070	-----------------------    *(volatile unsigned *)C$6 &= 0xe3ffu;
;** 1071	-----------------------    *(volatile unsigned *)C$6 &= 0xfc7fu;
;** 1072	-----------------------    *(volatile unsigned *)C$6 = *(volatile unsigned *)C$6&0xfffeu|2u;
;** 1073	-----------------------    *(volatile unsigned *)C$6 &= 0xfffbu;
;** 1074	-----------------------    *(volatile unsigned *)C$6 &= 0xfff7u;
;** 1075	-----------------------    *(volatile unsigned *)C$6 |= 0x30u;
;** 1077	-----------------------    *((volatile struct CMPCTL_BITS *)C$6+7L) &= 0xffefu;
;** 1078	-----------------------    *(&EPwm3Regs+7L) &= 0xfffcu;
;** 1079	-----------------------    *(&EPwm3Regs+7L) &= 0xffbfu;
;** 1080	-----------------------    *(&EPwm3Regs+7L) &= 0xfff3u;
;** 1082	-----------------------    EPwm3Regs.AQCTLA.all = 1365u;
;** 1083	-----------------------    EPwm3Regs.AQCTLB.all = 1365u;
;** 1084	-----------------------    EPwm3Regs.CMPA.half.CMPA = 0xffffu;
;** 1085	-----------------------    *((volatile struct DBCTL_BITS *)C$6+15L) &= 0xfffcu;
;** 1089	-----------------------    *((volatile struct ETSEL_BITS *)C$6+25L) &= 0xfff7u;
;** 1091	-----------------------    *((volatile struct ETCLR_BITS *)C$6+28L) |= 1u;
;** 1097	-----------------------    EPwm4Regs.TBPRD = 4499u;
;** 1099	-----------------------    EPwm4Regs.TBPHS.half.TBPHS = 0u;
;** 1100	-----------------------    EPwm4Regs.TBCTR = 0u;
;** 1101	-----------------------    *(C$5 = &EPwm4Regs) &= 0xe3ffu;
;** 1102	-----------------------    *C$5 &= 0xfc7fu;
;** 1103	-----------------------    *C$5 &= 0xfffcu;
;** 1104	-----------------------    *C$5 &= 0xfffbu;
;** 1105	-----------------------    *C$5 &= 0xfff7u;
;** 1107	-----------------------    *C$5 |= 0x30u;
;** 1110	-----------------------    *((volatile struct CMPCTL_BITS *)C$5+7L) &= 0xffefu;
;** 1111	-----------------------    *(&EPwm4Regs+7L) &= 0xffbfu;
;** 1112	-----------------------    *(&EPwm4Regs+7L) &= 0xfffcu;
;** 1113	-----------------------    *(&EPwm4Regs+7L) &= 0xfff3u;
;** 1116	-----------------------    EPwm4Regs.AQCTLA.all = 0u;
;** 1117	-----------------------    *(&EPwm4Regs+11L) = *((volatile struct AQCTL_BITS *)C$5+11L)&0xffefu|0x20u;
;** 1118	-----------------------    *(&EPwm4Regs+11L) = *(&EPwm4Regs+11L)&0xfffcu|1u;
;** 1119	-----------------------    *((volatile struct DBCTL_BITS *)C$5+15L) &= 0xfffcu;
;** 1124	-----------------------    *((volatile struct ETPS_BITS *)C$5+26L) &= 0xfff3u;
;** 1125	-----------------------    *(&EPwm4Regs+26L) = *(&EPwm4Regs+26L)&0xfffcu|1u;
;** 1126	-----------------------    *((volatile struct ETSEL_BITS *)C$5+25L) &= 0xfff7u;
;** 1127	-----------------------    *(&EPwm4Regs+25L) = *(&EPwm4Regs+25L)&0xfff8u|2u;
;** 1128	-----------------------    *((volatile struct ETCLR_BITS *)C$5+28L) |= 1u;
;** 1131	-----------------------    asm(" EALLOW");
;** 1132	-----------------------    *(&EPwm5Regs+20L) = *((C$4 = &EPwm5Regs)+20L)&0xfffeu|2u;
;** 1133	-----------------------    *(&EPwm5Regs+20L) |= 0xcu;
;** 1134	-----------------------    *((volatile struct AQSFRC_BITS *)C$4+13L) &= 0xff3fu;
;** 1135	-----------------------    asm(" EDIS");
;** 1136	-----------------------    EPwm5Regs.TBPRD = 2344u;
;** 1137	-----------------------    EPwm5Regs.TBPHS.half.TBPHS = 0u;
;** 1138	-----------------------    EPwm5Regs.TBCTR = 0u;
;** 1139	-----------------------    *(volatile unsigned *)C$4 &= 0xe3ffu;
;** 1140	-----------------------    *(volatile unsigned *)C$4 &= 0xfc7fu;
;** 1141	-----------------------    *(volatile unsigned *)C$4 = *(volatile unsigned *)C$4&0xfffeu|2u;
;** 1142	-----------------------    *(volatile unsigned *)C$4 &= 0xfffbu;
;** 1143	-----------------------    *(volatile unsigned *)C$4 &= 0xfff7u;
;** 1144	-----------------------    *(volatile unsigned *)C$4 |= 0x30u;
;** 1146	-----------------------    *((volatile struct CMPCTL_BITS *)C$4+7L) &= 0xffefu;
;** 1147	-----------------------    *(&EPwm5Regs+7L) &= 0xfffcu;
;** 1148	-----------------------    *(&EPwm5Regs+7L) &= 0xffbfu;
;** 1149	-----------------------    *(&EPwm5Regs+7L) &= 0xfff3u;
;** 1151	-----------------------    EPwm5Regs.AQCTLA.all = 1365u;
;** 1152	-----------------------    EPwm5Regs.AQCTLB.all = 1365u;
;** 1153	-----------------------    EPwm5Regs.CMPA.half.CMPA = 0xffffu;
;** 1154	-----------------------    EPwm5Regs.CMPB = 0xffffu;
;** 1155	-----------------------    *((volatile struct DBCTL_BITS *)C$4+15L) &= 0xfffcu;
;** 1156	-----------------------    *(&EPwm5Regs+15L) = *(&EPwm5Regs+15L)&0xfffbu|0x8u;
;** 1157	-----------------------    EPwm5Regs.DBFED = 333u;
;** 1158	-----------------------    EPwm5Regs.DBRED = 333u;
;** 1160	-----------------------    *((volatile struct ETPS_BITS *)C$4+26L) &= 0xfff3u;
;** 1162	-----------------------    *(&EPwm5Regs+26L) = *(&EPwm5Regs+26L)&0xfffcu|1u;
;** 1163	-----------------------    *((volatile struct ETSEL_BITS *)C$4+25L) &= 0xfff7u;
;** 1165	-----------------------    *(&EPwm5Regs+25L) = *(&EPwm5Regs+25L)&0xfff8u|1u;
;** 1166	-----------------------    *((volatile struct ETCLR_BITS *)C$4+28L) |= 1u;
;** 1173	-----------------------    EPwm6Regs.TBPRD = 0xafc7u;
;** 1175	-----------------------    EPwm6Regs.TBPHS.half.TBPHS = 0u;
;** 1176	-----------------------    EPwm6Regs.TBCTR = 0u;
;** 1177	-----------------------    *(C$3 = &EPwm6Regs) &= 0xe3ffu;
;** 1178	-----------------------    *C$3 &= 0xfc7fu;
;** 1179	-----------------------    *C$3 &= 0xfffcu;
;** 1180	-----------------------    *C$3 &= 0xfffbu;
;** 1181	-----------------------    *C$3 &= 0xfff7u;
;** 1183	-----------------------    *C$3 |= 0x30u;
;** 1186	-----------------------    *((volatile struct CMPCTL_BITS *)C$3+7L) &= 0xffefu;
;** 1187	-----------------------    *(&EPwm6Regs+7L) &= 0xffbfu;
;** 1188	-----------------------    *(&EPwm6Regs+7L) &= 0xfffcu;
;** 1189	-----------------------    *(&EPwm6Regs+7L) &= 0xfff3u;
;** 1192	-----------------------    EPwm6Regs.AQCTLA.all = 1365u;
;** 1193	-----------------------    EPwm6Regs.AQCTLB.all = 1365u;
;** 1194	-----------------------    EPwm6Regs.CMPA.half.CMPA = 0xffffu;
;** 1195	-----------------------    EPwm6Regs.CMPB = 0xafc7u;
;** 1196	-----------------------    *((volatile struct DBCTL_BITS *)C$3+15L) &= 0xfffcu;
;** 1198	-----------------------    *((volatile struct ETPS_BITS *)C$3+26L) &= 0xfff3u;
;** 1199	-----------------------    *(&EPwm6Regs+26L) = *(&EPwm6Regs+26L)&0xfffcu|1u;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$134	.dwtag  DW_TAG_variable, DW_AT_name("$O$C8")
 ...
 EDIS
	...
	.dwpsn	file "../APP/Initial.c",line 1180,column 2,is_stmt
        AND       *+XAR4[0],#0xfffb     ; [CPU_] |1180| 
	.dwpsn	file "../APP/Initial.c",line 1181,column 2,is_stmt
        AND       *+XAR4[0],#0xfff7     ; [CPU_] |1181| 
	.dwpsn	file "../APP/Initial.c",line 1183,column 2,is_stmt
        OR        *+XAR4[0],#0x0030     ; [CPU_] |1183| 
	.dwpsn	file "../APP/Initial.c",line 1186,column 2,is_stmt
        AND       *+XAR4[7],#0xffef     ; [CPU_] |1186| 
	.dwpsn	file "../APP/Initial.c",line 1187,column 2,is_stmt
        AND       @_EPwm6Regs+7,#0xffbf ; [CPU_] |1187| 
	.dwpsn	file "../APP/Initial.c",line 1188,column 2,is_stmt
        AND       @_EPwm6Regs+7,#0xfffc ; [CPU_] |1188| 
	.dwpsn	file "../APP/Initial.c",line 1189,column 2,is_stmt
        AND       @_EPwm6Regs+7,#0xfff3 ; [CPU_] |1189| 
	.dwpsn	file "../APP/Initial.c",line 1192,column 2,is_stmt
        MOV       @_EPwm6Regs+11,#1365  ; [CPU_] |1192| 
	.dwpsn	file "../APP/Initial.c",line 1193,column 2,is_stmt
        MOV       @_EPwm6Regs+12,#1365  ; [CPU_] |1193| 
	.dwpsn	file "../APP/Initial.c",line 1194,column 2,is_stmt
        MOV       @_EPwm6Regs+9,#65535  ; [CPU_] |1194| 
	.dwpsn	file "../APP/Initial.c",line 1195,column 2,is_stmt
        MOV       @_EPwm6Regs+10,#44999 ; [CPU_] |1195| 
	.dwpsn	file "../APP/Initial.c",line 1196,column 2,is_stmt
        AND       *+XAR5[0],#0xfffc     ; [CPU_] |1196| 
	.dwpsn	file "../APP/Initial.c",line 1198,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1198| 
        ADDB      XAR5,#26              ; [CPU_U] |1198| 
        AND       *+XAR5[0],#0xfff3     ; [CPU_] |1198| 
	.dwpsn	file "../APP/Initial.c",line 1199,column 2,is_stmt
        AND       AL,@_EPwm6Regs+26,#0xfffc ; [CPU_] |1199| 
;** 1200	-----------------------    *((volatile struct ETSEL_BITS *)C$3+25L) |= 0x8u;
;** 1201	-----------------------    *(&EPwm6Regs+25L) = *(&EPwm6Regs+25L)&0xfff8u|2u;
;** 1202	-----------------------    *((volatile struct ETCLR_BITS *)C$3+28L) |= 1u;
;** 1211	-----------------------    asm(" EALLOW");
;** 1212	-----------------------    *(&EPwm7Regs+20L) = *((C$2 = &EPwm7Regs)+20L)&0xfffeu|2u;
;** 1213	-----------------------    *(&EPwm7Regs+20L) = *(&EPwm7Regs+20L)&0xfffbu|0x8u;
;** 1214	-----------------------    *((volatile struct AQSFRC_BITS *)C$2+13L) &= 0xff3fu;
;** 1215	-----------------------    asm(" EDIS");
;** 1216	-----------------------    EPwm7Regs.TBPRD = 2344u;
;** 1217	-----------------------    EPwm7Regs.TBPHS.half.TBPHS = 0u;
;** 1218	-----------------------    EPwm7Regs.TBCTR = 0u;
;** 1219	-----------------------    *(volatile unsigned *)C$2 &= 0xe3ffu;
;** 1220	-----------------------    *(volatile unsigned *)C$2 &= 0xfc7fu;
;** 1221	-----------------------    *(volatile unsigned *)C$2 = *(volatile unsigned *)C$2&0xfffeu|2u;
;** 1222	-----------------------    *(volatile unsigned *)C$2 &= 0xfffbu;
;** 1223	-----------------------    *(volatile unsigned *)C$2 &= 0xfff7u;
;** 1224	-----------------------    *(volatile unsigned *)C$2 |= 0x30u;
;** 1226	-----------------------    *((volatile struct CMPCTL_BITS *)C$2+7L) &= 0xffefu;
;** 1227	-----------------------    *(&EPwm7Regs+7L) &= 0xfffcu;
;** 1228	-----------------------    *(&EPwm7Regs+7L) &= 0xffbfu;
;** 1229	-----------------------    *(&EPwm7Regs+7L) &= 0xfff3u;
;** 1231	-----------------------    EPwm7Regs.AQCTLA.all = 1365u;
;** 1232	-----------------------    EPwm7Regs.AQCTLB.all = 1365u;
;** 1233	-----------------------    EPwm7Regs.CMPA.half.CMPA = 0xffffu;
;** 1234	-----------------------    EPwm7Regs.CMPB = 0xffffu;
;** 1235	-----------------------    *((volatile struct DBCTL_BITS *)C$2+15L) &= 0xfffcu;
;** 1236	-----------------------    *(&EPwm7Regs+15L) = *(&EPwm7Regs+15L)&0xfffbu|0x8u;
;** 1237	-----------------------    EPwm7Regs.DBFED = 333u;
;** 1238	-----------------------    EPwm7Regs.DBRED = 333u;
;** 1240	-----------------------    *((volatile struct ETPS_BITS *)C$2+26L) &= 0xfff3u;
;** 1242	-----------------------    *(&EPwm7Regs+26L) = *(&EPwm7Regs+26L)&0xfffcu|1u;
;** 1243	-----------------------    *((volatile struct ETSEL_BITS *)C$2+25L) &= 0xfff7u;
;** 1245	-----------------------    *(&EPwm7Regs+25L) = *(&EPwm7Regs+25L)&0xfff8u|1u;
;** 1246	-----------------------    *((volatile struct ETCLR_BITS *)C$2+28L) |= 1u;
;** 1249	-----------------------    asm(" EALLOW");
;** 1250	-----------------------    *(&EPwm8Regs+20L) = *((C$1 = &EPwm8Regs)+20L)&0xfffeu|2u;
;** 1251	-----------------------    *(&EPwm8Regs+20L) = *(&EPwm8Regs+20L)&0xfffbu|0x8u;
;** 1252	-----------------------    *((volatile struct AQSFRC_BITS *)C$1+13L) &= 0xff3fu;
;** 1254	-----------------------    asm(" EDIS");
;** 1255	-----------------------    EPwm8Regs.TBPRD = 1047u;
;** 1256	-----------------------    EPwm8Regs.TBPHS.half.TBPHS = 0u;
;** 1257	-----------------------    EPwm8Regs.TBCTR = 0u;
;** 1258	-----------------------    *(volatile unsigned *)C$1 &= 0xe3ffu;
;** 1259	-----------------------    *(volatile unsigned *)C$1 &= 0xfc7fu;
;** 1260	-----------------------    *(volatile unsigned *)C$1 = *(volatile unsigned *)C$1&0xfffeu|2u;
;** 1261	-----------------------    *(volatile unsigned *)C$1 &= 0xfffbu;
;** 1262	-----------------------    *(volatile unsigned *)C$1 &= 0xfff7u;
;** 1263	-----------------------    *(volatile unsigned *)C$1 |= 0x30u;
;** 1265	-----------------------    *((volatile struct CMPCTL_BITS *)C$1+7L) &= 0xffefu;
;** 1266	-----------------------    *(&EPwm8Regs+7L) &= 0xfffcu;
;** 1267	-----------------------    *(&EPwm8Regs+7L) &= 0xffbfu;
;** 1268	-----------------------    *(&EPwm8Regs+7L) = *(&EPwm8Regs+7L)&0xfff7u|4u;
;** 1270	-----------------------    EPwm8Regs.AQCTLA.all = 1365u;
;** 1271	-----------------------    EPwm8Regs.AQCTLB.all = 1365u;
;** 1272	-----------------------    EPwm8Regs.CMPA.half.CMPA = 0xffffu;
;** 1273	-----------------------    EPwm8Regs.CMPB = 0xffffu;
;** 1274	-----------------------    *((volatile struct DBCTL_BITS *)C$1+15L) &= 0xfffcu;
;** 1275	-----------------------    *(&EPwm8Regs+15L) = *(&EPwm8Regs+15L)&0xfffbu|0x8u;
;** 1276	-----------------------    EPwm8Regs.DBFED = 333u;
;** 1277	-----------------------    EPwm8Regs.DBRED = 333u;
;** 1279	-----------------------    *((volatile struct ETPS_BITS *)C$1+26L) &= 0xfff3u;
;** 1281	-----------------------    *(&EPwm8Regs+26L) = *(&EPwm8Regs+26L)&0xfffcu|1u;
;** 1282	-----------------------    *((volatile struct ETSEL_BITS *)C$1+25L) &= 0xfff7u;
;** 1284	-----------------------    *(&EPwm8Regs+25L) = *(&EPwm8Regs+25L)&0xfff8u|1u;
;** 1285	-----------------------    *((volatile struct ETCLR_BITS *)C$1+28L) |= 1u;
;** 1287	-----------------------    EPwm8Regs.AQCTLA.all = 0u;
;** 1288	-----------------------    *(&EPwm8Regs+11L) = *((volatile struct AQCTL_BITS *)C$1+11L)&0xffdfu|0x10u;
;** 1289	-----------------------    *(&EPwm8Regs+11L) = *(&EPwm8Regs+11L)&0xff7fu|0x40u;
;** 1290	-----------------------    EPwm8Regs.CMPA.half.CMPA = 1047u;
;** 1291	-----------------------    EPwm8Regs.AQCTLB.all = 0u;
;** 1292	-----------------------    *(&EPwm8Regs+12L) = *((volatile struct AQCTL_BITS *)C$1+12L)&0xfdffu|0x100u;
;** 1293	-----------------------    *(&EPwm8Regs+12L) = *(&EPwm8Regs+12L)&0xf7ffu|0x400u;
;** 1294	-----------------------    EPwm8Regs.CMPB = 0u;
;** 1296	-----------------------    asm(" EALLOW");
;** 1297	-----------------------    *(&SysCtrlRegs+12L) |= 4u;
;** 1298	-----------------------    asm(" EDIS");
;***  	-----------------------    return;
        ORB       AL,#0x01              ; [CPU_] |1199| 
	.dwpsn	file "../APP/Initial.c",line 1200,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1200| 
	.dwpsn	file "../APP/Initial.c",line 1199,column 2,is_stmt
        MOV       @_EPwm6Regs+26,AL     ; [CPU_] |1199| 
	.dwpsn	file "../APP/Initial.c",line 1202,column 2,is_stmt
        ADDB      XAR4,#28              ; [CPU_U] |1202| 
	.dwpsn	file "../APP/Initial.c",line 1200,column 2,is_stmt
        ADDB      XAR5,#25              ; [CPU_U] |1200| 
        OR        *+XAR5[0],#0x0008     ; [CPU_] |1200| 
	.dwpsn	file "../APP/Initial.c",line 1201,column 2,is_stmt
        AND       AL,@_EPwm6Regs+25,#0xfff8 ; [CPU_] |1201| 
        ORB       AL,#0x02              ; [CPU_] |1201| 
        MOV       @_EPwm6Regs+25,AL     ; [CPU_] |1201| 
	.dwpsn	file "../APP/Initial.c",line 1202,column 2,is_stmt
        OR        *+XAR4[0],#0x0001     ; [CPU_] |1202| 
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 1212,column 2,is_stmt
        MOVB      XAR0,#20              ; [CPU_] |1212| 
        MOVL      XAR4,#_EPwm7Regs      ; [CPU_U] |1212| 
        MOVW      DP,#_EPwm7Regs+20     ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 1214,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1214| 
	.dwpsn	file "../APP/Initial.c",line 1212,column 2,is_stmt
        AND       AL,*+XAR4[AR0],#0xfffe ; [CPU_] |1212| 
	.dwpsn	file "../APP/Initial.c",line 1214,column 2,is_stmt
        ADDB      XAR5,#13              ; [CPU_U] |1214| 
	.dwpsn	file "../APP/Initial.c",line 1212,column 2,is_stmt
        ORB       AL,#0x02              ; [CPU_] |1212| 
        MOV       @_EPwm7Regs+20,AL     ; [CPU_] |1212| 
	.dwpsn	file "../APP/Initial.c",line 1213,column 2,is_stmt
        AND       AL,@_EPwm7Regs+20,#0xfffb ; [CPU_] |1213| 
        ORB       AL,#0x08              ; [CPU_] |1213| 
        MOV       @_EPwm7Regs+20,AL     ; [CPU_] |1213| 
	.dwpsn	file "../APP/Initial.c",line 1214,column 2,is_stmt
        AND       *+XAR5[0],#0xff3f     ; [CPU_] |1214| 
 EDIS
	.dwpsn	file "../APP/Initial.c",line 1235,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1235| 
	.dwpsn	file "../APP/Initial.c",line 1216,column 2,is_stmt
        MOV       @_EPwm7Regs+5,#2344   ; [CPU_] |1216| 
	.dwpsn	file "../APP/Initial.c",line 1235,column 2,is_stmt
        ADDB      XAR5,#15              ; [CPU_U] |1235| 
	.dwpsn	file "../APP/Initial.c",line 1217,column 2,is_stmt
        MOV       @_EPwm7Regs+3,#0      ; [CPU_] |1217| 
	.dwpsn	file "../APP/Initial.c",line 1218,column 2,is_stmt
        MOV       @_EPwm7Regs+4,#0      ; [CPU_] |1218| 
	.dwpsn	file "../APP/Initial.c",line 1219,column 2,is_stmt
        AND       *+XAR4[0],#0xe3ff     ; [CPU_] |1219| 
	.dwpsn	file "../APP/Initial.c",line 1220,column 2,is_stmt
        AND       *+XAR4[0],#0xfc7f     ; [CPU_] |1220| 
	.dwpsn	file "../APP/Initial.c",line 1221,column 2,is_stmt
        AND       AL,*+XAR4[0],#0xfffe  ; [CPU_] |1221| 
        ORB       AL,#0x02              ; [CPU_] |1221| 
        MOV       *+XAR4[0],AL          ; [CPU_] |1221| 
	.dwpsn	file "../APP/Initial.c",line 1222,column 2,is_stmt
        AND       *+XAR4[0],#0xfffb     ; [CPU_] |1222| 
	.dwpsn	file "../APP/Initial.c",line 1223,column 2,is_stmt
        AND       *+XAR4[0],#0xfff7     ; [CPU_] |1223| 
	.dwpsn	file "../APP/Initial.c",line 1224,column 2,is_stmt
        OR        *+XAR4[0],#0x0030     ; [CPU_] |1224| 
	.dwpsn	file "../APP/Initial.c",line 1226,column 2,is_stmt
        AND       *+XAR4[7],#0xffef     ; [CPU_] |1226| 
	.dwpsn	file "../APP/Initial.c",line 1227,column 2,is_stmt
        AND       @_EPwm7Regs+7,#0xfffc ; [CPU_] |1227| 
	.dwpsn	file "../APP/Initial.c",line 1228,column 2,is_stmt
        AND       @_EPwm7Regs+7,#0xffbf ; [CPU_] |1228| 
	.dwpsn	file "../APP/Initial.c",line 1229,column 2,is_stmt
        AND       @_EPwm7Regs+7,#0xfff3 ; [CPU_] |1229| 
	.dwpsn	file "../APP/Initial.c",line 1231,column 2,is_stmt
        MOV       @_EPwm7Regs+11,#1365  ; [CPU_] |1231| 
	.dwpsn	file "../APP/Initial.c",line 1232,column 2,is_stmt
        MOV       @_EPwm7Regs+12,#1365  ; [CPU_] |1232| 
	.dwpsn	file "../APP/Initial.c",line 1233,column 2,is_stmt
        MOV       @_EPwm7Regs+9,#65535  ; [CPU_] |1233| 
	.dwpsn	file "../APP/Initial.c",line 1234,column 2,is_stmt
        MOV       @_EPwm7Regs+10,#65535 ; [CPU_] |1234| 
	.dwpsn	file "../APP/Initial.c",line 1235,column 2,is_stmt
        AND       *+XAR5[0],#0xfffc     ; [CPU_] |1235| 
	.dwpsn	file "../APP/Initial.c",line 1240,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1240| 
        ADDB      XAR5,#26              ; [CPU_U] |1240| 
	.dwpsn	file "../APP/Initial.c",line 1236,column 2,is_stmt
        AND       AL,@_EPwm7Regs+15,#0xfffb ; [CPU_] |1236| 
        ORB       AL,#0x08              ; [CPU_] |1236| 
        MOV       @_EPwm7Regs+15,AL     ; [CPU_] |1236| 
	.dwpsn	file "../APP/Initial.c",line 1237,column 2,is_stmt
        MOV       @_EPwm7Regs+17,#333   ; [CPU_] |1237| 
	.dwpsn	file "../APP/Initial.c",line 1238,column 2,is_stmt
        MOV       @_EPwm7Regs+16,#333   ; [CPU_] |1238| 
	.dwpsn	file "../APP/Initial.c",line 1240,column 2,is_stmt
        AND       *+XAR5[0],#0xfff3     ; [CPU_] |1240| 
	.dwpsn	file "../APP/Initial.c",line 1243,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1243| 
        ADDB      XAR5,#25              ; [CPU_U] |1243| 
	.dwpsn	file "../APP/Initial.c",line 1246,column 2,is_stmt
        ADDB      XAR4,#28              ; [CPU_U] |1246| 
	.dwpsn	file "../APP/Initial.c",line 1242,column 2,is_stmt
        AND       AL,@_EPwm7Regs+26,#0xfffc ; [CPU_] |1242| 
        ORB       AL,#0x01              ; [CPU_] |1242| 
        MOV       @_EPwm7Regs+26,AL     ; [CPU_] |1242| 
	.dwpsn	file "../APP/Initial.c",line 1243,column 2,is_stmt
        AND       *+XAR5[0],#0xfff7     ; [CPU_] |1243| 
	.dwpsn	file "../APP/Initial.c",line 1245,column 2,is_stmt
        AND       AL,@_EPwm7Regs+25,#0xfff8 ; [CPU_] |1245| 
        ORB       AL,#0x01              ; [CPU_] |1245| 
        MOV       @_EPwm7Regs+25,AL     ; [CPU_] |1245| 
	.dwpsn	file "../APP/Initial.c",line 1246,column 2,is_stmt
        OR        *+XAR4[0],#0x0001     ; [CPU_] |1246| 
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 1250,column 2,is_stmt
        MOVL      XAR5,#_EPwm8Regs      ; [CPU_U] |1250| 
        MOVB      XAR0,#20              ; [CPU_] |1250| 
	.dwpsn	file "../APP/Initial.c",line 1252,column 2,is_stmt
        MOVL      XAR4,XAR5             ; [CPU_] |1252| 
        MOVW      DP,#_EPwm8Regs+20     ; [CPU_U] 
        ADDB      XAR4,#13              ; [CPU_U] |1252| 
	.dwpsn	file "../APP/Initial.c",line 1250,column 2,is_stmt
        AND       AL,*+XAR5[AR0],#0xfffe ; [CPU_] |1250| 
        ORB       AL,#0x02              ; [CPU_] |1250| 
        MOV       @_EPwm8Regs+20,AL     ; [CPU_] |1250| 
	.dwpsn	file "../APP/Initial.c",line 1251,column 2,is_stmt
        AND       AL,@_EPwm8Regs+20,#0xfffb ; [CPU_] |1251| 
        ORB       AL,#0x08              ; [CPU_] |1251| 
        MOV       @_EPwm8Regs+20,AL     ; [CPU_] |1251| 
	.dwpsn	file "../APP/Initial.c",line 1252,column 2,is_stmt
        AND       *+XAR4[0],#0xff3f     ; [CPU_] |1252| 
 EDIS
	.dwpsn	file "../APP/Initial.c",line 1274,column 2,is_stmt
        MOVL      XAR4,XAR5             ; [CPU_] |1274| 
        ADDB      XAR4,#15              ; [CPU_U] |1274| 
	.dwpsn	file "../APP/Initial.c",line 1288,column 2,is_stmt
        MOVB      XAR0,#11              ; [CPU_] |1288| 
	.dwpsn	file "../APP/Initial.c",line 1255,column 2,is_stmt
        MOV       @_EPwm8Regs+5,#1047   ; [CPU_] |1255| 
	.dwpsn	file "../APP/Initial.c",line 1256,column 2,is_stmt
        MOV       @_EPwm8Regs+3,#0      ; [CPU_] |1256| 
	.dwpsn	file "../APP/Initial.c",line 1257,column 2,is_stmt
        MOV       @_EPwm8Regs+4,#0      ; [CPU_] |1257| 
	.dwpsn	file "../APP/Initial.c",line 1258,column 2,is_stmt
        AND       *+XAR5[0],#0xe3ff     ; [CPU_] |1258| 
	.dwpsn	file "../APP/Initial.c",line 1259,column 2,is_stmt
        AND       *+XAR5[0],#0xfc7f     ; [CPU_] |1259| 
	.dwpsn	file "../APP/Initial.c",line 1260,column 2,is_stmt
        AND       AL,*+XAR5[0],#0xfffe  ; [CPU_] |1260| 
        ORB       AL,#0x02              ; [CPU_] |1260| 
        MOV       *+XAR5[0],AL          ; [CPU_] |1260| 
	.dwpsn	file "../APP/Initial.c",line 1261,column 2,is_stmt
        AND       *+XAR5[0],#0xfffb     ; [CPU_] |1261| 
...
$C$DW$135	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$126, DW_AT_TI_end_line(0x514)
...
$C$DW$136	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitECAP")
	...
	.dwattr $C$DW$136, DW_AT_TI_begin_line(0x51a)
	.dwattr $C$DW$136, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$136, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 1307,column 1,is_stmt,address _sInitECAP
...
;***************************************************************
_sInitECAP:
;** 1308	-----------------------    ECap1Regs.ECEINT.all = 0u;
;** 1309	-----------------------    ECap1Regs.ECCLR.all = 0xffffu;
;** 1310	-----------------------    *((C$2 = &ECap1Regs)+20L) &= 0xfeffu;
;** 1311	-----------------------    *((volatile struct ECCTL2_BITS *)C$2+21L) &= 0xffefu;
;** 1312	-----------------------    *(&ECap1Regs+21L) &= 0xfdffu;
;** 1313	-----------------------    *(&ECap1Regs+21L) |= 1u;
;** 1314	-----------------------    *(&ECap1Regs+21L) |= 0xc0u;
;** 1315	-----------------------    *(&ECap1Regs+21L) &= 0xffdfu;
;** 1316	-----------------------    *(&ECap1Regs+21L) &= 0xfff9u;
;** 1317	-----------------------    *(&ECap1Regs+20L) |= 1u;
;** 1318	-----------------------    *(&ECap1Regs+20L) &= 0xfffdu;
;** 1319	-----------------------    *(&ECap1Regs+20L) &= 0xc1ffu;
;** 1321	-----------------------    ECap2Regs.ECEINT.all = 0u;
;** 1322	-----------------------    ECap2Regs.ECCLR.all = 0xffffu;
;** 1323	-----------------------    *((C$1 = &ECap2Regs)+20L) &= 0xfeffu;
;** 1324	-----------------------    *((volatile struct ECCTL2_BITS *)C$1+21L) &= 0xffefu;
;** 1325	-----------------------    *(&ECap2Regs+21L) &= 0xfdffu;
;** 1326	-----------------------    *(&ECap2Regs+21L) |= 1u;
;** 1327	-----------------------    *(&ECap2Regs+21L) |= 0xc0u;
;** 1328	-----------------------    *(&ECap2Regs+21L) &= 0xffdfu;
;** 1329	-----------------------    *(&ECap2Regs+21L) &= 0xfff9u;
;** 1330	-----------------------    *(&ECap2Regs+20L) |= 1u;
;** 1331	-----------------------    *(&ECap2Regs+20L) &= 0xfffdu;
;** 1332	-----------------------    *(&ECap2Regs+20L) &= 0xc1ffu;
;** 1362	-----------------------    *(&ECap1Regs+21L) |= 0x8u;
;** 1363	-----------------------    *(&ECap1Regs+20L) |= 0x100u;
;** 1364	-----------------------    *((volatile struct ECEINT_BITS *)C$2+22L) |= 2u;
;** 1366	-----------------------    *(&ECap2Regs+21L) |= 0x8u;
;** 1367	-----------------------    *(&ECap2Regs+20L) |= 0x100u;
;** 1368	-----------------------    *((volatile struct ECEINT_BITS *)C$1+22L) |= 2u;
;** 1375	-----------------------    *(&ECap1Regs+21L) |= 0x10u;
;** 1376	-----------------------    *(&ECap2Regs+21L) |= 0x10u;
;** 1377	-----------------------    *(&ECap3Regs+21L) |= 0x10u;
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$139	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$136, DW_AT_TI_end_line(0x56c)
...
$C$DW$140	.dwtag  DW_TAG_subprogram, DW_AT_name("DelayUs")
	...
	.dwattr $C$DW$140, DW_AT_TI_begin_line(0x59e)
	.dwattr $C$DW$140, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$140, DW_AT_TI_max_frame_size(-4)
	.dwpsn	file "../APP/Initial.c",line 1439,column 1,is_stmt,address _DelayUs
...
$C$DW$143	.dwtag  DW_TAG_variable, DW_AT_name("Usec")
	...
	.dwattr $C$DW$143, DW_AT_location[DW_OP_breg20 -1]
        MOV       *-SP[1],AL            ; [CPU_] |1439| 
	.dwpsn	file "../APP/Initial.c",line 1440,column 5,is_stmt
        DEC       *-SP[1]               ; [CPU_] |1440| 
        B         $C$L9,UNC             ; [CPU_] |1440| 
        ; branch occurs ; [] |1440| 
$C$L8:    
$C$DW$L$_DelayUs$2$B:
;***	-----------------------g2:
;** 1442	-----------------------    asm(" RPT #100 || NOP");
;** 1443	-----------------------    Usec = Usec-1u;
 RPT #100 || NOP
...
$C$DW$L$_DelayUs$3$B:
;***	-----------------------g3:
;** 1443	-----------------------    if ( Usec != 0xffffu ) goto g2;
;***  	-----------------------    return;
	.dwpsn	file "../APP/Initial.c",line 1443,column 2,is_stmt
        CMP       *-SP[1],#65535        ; [CPU_] |1443| 
        BF        $C$L8,NEQ             ; [CPU_] |1443| 
...
$C$DW$145	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$145, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM5048 LV\IVEM5048LV\IVEM5048LV_28066_V13.00\IVEM LV 5048\Debug\Initial.asm:$C$L9:1:1773023422")
	.dwattr $C$DW$145, DW_AT_TI_begin_file("../APP/Initial.c")
	.dwattr $C$DW$145, DW_AT_TI_begin_line(0x5a0)
	.dwattr $C$DW$145, DW_AT_TI_end_line(0x5a3)
...
$C$DW$147	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$140, DW_AT_TI_end_line(0x5a5)
...
;*** 765	-----------------------    *(&GpioCtrlRegs+13L) &= 0xfbffu;
;*** 766	-----------------------    *(&GpioDataRegs+3L) |= 0x400u;
;*** 767	-----------------------    *(&GpioCtrlRegs+9L) &= 0xffcfu;
;*** 768	-----------------------    *(&GpioCtrlRegs+11L) |= 0x400u;
;*** 770	-----------------------    *(&GpioCtrlRegs+13L) &= 0xf7ffu;
;*** 771	-----------------------    *(&GpioDataRegs+5L) |= 0x800u;
;*** 772	-----------------------    *(&GpioCtrlRegs+9L) &= 0xff3fu;
;*** 773	-----------------------    *(&GpioCtrlRegs+11L) |= 0x800u;
;*** 776	-----------------------    *(&GpioCtrlRegs+13L) &= 0xefffu;
;*** 777	-----------------------    *(&GpioCtrlRegs+5L) |= 0x300u;
;*** 778	-----------------------    *(&GpioCtrlRegs+9L) = *(&GpioCtrlRegs+9L)&0xfdffu|0x100u;
;*** 779	-----------------------    *(&GpioCtrlRegs+13L) &= 0xdfffu;
;*** 780	-----------------------    *(&GpioCtrlRegs+9L) = *(&GpioCtrlRegs+9L)&0xf7ffu|0x400u;
;*** 782	-----------------------    *(&GpioCtrlRegs+13L) &= 0x7fffu;
;*** 783	-----------------------    *(&GpioCtrlRegs+9L) = *(&GpioCtrlRegs+9L)&0x3fffu|0x4000u;
;*** 784	-----------------------    *(&GpioCtrlRegs+13L) &= 0xbfffu;
;*** 785	-----------------------    *(&GpioCtrlRegs+5L) |= 0x3000u;
;*** 786	-----------------------    *(&GpioCtrlRegs+9L) = *(&GpioCtrlRegs+9L)&0xdfffu|0x1000u;
;*** 788	-----------------------    *((volatile struct GPBDAT_BITS *)C$1+28L) &= 0xfffeu;
;*** 789	-----------------------    *((volatile struct GPBDAT_BITS *)C$2+10L) |= 1u;
;*** 790	-----------------------    *((volatile struct GPB1_BITS *)C$1+22L) &= 0xfffcu;
;*** 791	-----------------------    *((volatile struct GPBDAT_BITS *)C$1+26L) |= 1u;
;*** 793	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfffdu;
;*** 794	-----------------------    *(&GpioDataRegs+10L) |= 2u;
;*** 795	-----------------------    *(&GpioCtrlRegs+22L) &= 0xfff3u;
;*** 796	-----------------------    *(&GpioCtrlRegs+26L) |= 2u;
;*** 798	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfffbu;
;*** 799	-----------------------    *(&GpioDataRegs+10L) |= 4u;
;*** 800	-----------------------    *(&GpioCtrlRegs+22L) &= 0xffcfu;
;*** 801	-----------------------    *(&GpioCtrlRegs+26L) |= 4u;
;*** 803	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfff7u;
;*** 804	-----------------------    *((volatile struct GPBDAT_BITS *)C$2+12L) |= 0x8u;
;*** 805	-----------------------    *(&GpioCtrlRegs+22L) &= 0xff3fu;
;*** 806	-----------------------    *(&GpioCtrlRegs+26L) &= 0xfff7u;
;*** 808	-----------------------    *(&GpioCtrlRegs+28L) &= 0xffefu;
;*** 809	-----------------------    *(&GpioDataRegs+12L) |= 0x10u;
;*** 810	-----------------------    *(&GpioCtrlRegs+22L) &= 0xfcffu;
;*** 811	-----------------------    *(&GpioCtrlRegs+26L) &= 0xffefu;
;*** 813	-----------------------    *(&GpioCtrlRegs+28L) &= 0xffdfu;
;*** 814	-----------------------    *(&GpioDataRegs+10L) |= 0x20u;
;*** 815	-----------------------    *(&GpioCtrlRegs+22L) &= 0xf3ffu;
;*** 816	-----------------------    *(&GpioCtrlRegs+26L) |= 0x20u;
;*** 818	-----------------------    *(&GpioCtrlRegs+28L) &= 0xffbfu;
;*** 819	-----------------------    *(&GpioDataRegs+12L) |= 0x40u;
;*** 820	-----------------------    *(&GpioCtrlRegs+22L) &= 0xcfffu;
;*** 821	-----------------------    *(&GpioCtrlRegs+26L) &= 0xffbfu;
;*** 823	-----------------------    *(&GpioCtrlRegs+28L) |= 0x80u;
;*** 824	-----------------------    *(&GpioDataRegs+12L) |= 0x80u;
;*** 825	-----------------------    *(&GpioCtrlRegs+22L) &= 0x3fffu;
;*** 826	-----------------------    *(&GpioCtrlRegs+26L) |= 0x80u;
;*** 828	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfeffu;
;*** 829	-----------------------    *(&GpioCtrlRegs+23L) = *((volatile struct GPB1_BITS *)C$1+23L)&0xfffcu|1u;
;*** 831	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfdffu;
;*** 832	-----------------------    *(&GpioCtrlRegs+23L) = *(&GpioCtrlRegs+23L)&0xfff7u|4u;
;*** 834	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfbffu;
;*** 835	-----------------------    *(&GpioCtrlRegs+23L) = *(&GpioCtrlRegs+23L)&0xffdfu|0x10u;
;*** 837	-----------------------    *(&GpioCtrlRegs+28L) &= 0xf7ffu;
;*** 838	-----------------------    *(&GpioCtrlRegs+23L) = *(&GpioCtrlRegs+23L)&0xff7fu|0x40u;
;*** 840	-----------------------    *(&GpioCtrlRegs+28L) &= 0xefffu;
;*** 841	-----------------------    *(&GpioDataRegs+12L) |= 0x1000u;
;*** 842	-----------------------    *(&GpioCtrlRegs+23L) &= 0xfcffu;
;*** 843	-----------------------    *(&GpioCtrlRegs+26L) |= 0x1000u;
;*** 845	-----------------------    *((volatile struct GPBDAT_BITS *)C$1+29L) |= 4u;
;*** 846	-----------------------    *((volatile struct GPB2_BITS *)C$1+24L) &= 0xffcfu;
;*** 847	-----------------------    *((volatile struct GPBDAT_BITS *)C$1+27L) &= 0xfffbu;
;*** 849	-----------------------    *(&GpioCtrlRegs+29L) |= 0x8u;
;*** 850	-----------------------    *(&GpioCtrlRegs+24L) &= 0xff3fu;
;*** 851	-----------------------    *(&GpioCtrlRegs+27L) &= 0xfff7u;
;*** 853	-----------------------    *(&GpioCtrlRegs+29L) |= 0x10u;
;*** 854	-----------------------    *(&GpioCtrlRegs+24L) &= 0xfcffu;
;*** 855	-----------------------    *(&GpioCtrlRegs+27L) &= 0xffefu;
;*** 857	-----------------------    *(&GpioCtrlRegs+29L) &= 0xffdfu;
;*** 858	-----------------------    *((volatile struct GPBDAT_BITS *)C$2+13L) |= 0x20u;
;*** 859	-----------------------    *(&GpioCtrlRegs+24L) &= 0xf3ffu;
;*** 860	-----------------------    *(&GpioCtrlRegs+27L) &= 0xffdfu;
;*** 862	-----------------------    *(&GpioCtrlRegs+29L) &= 0xffbfu;
;*** 863	-----------------------    *(&GpioDataRegs+13L) |= 0x40u;
;*** 864	-----------------------    *(&GpioCtrlRegs+24L) &= 0xcfffu;
;*** 865	-----------------------    *(&GpioCtrlRegs+27L) |= 0x40u;
;*** 867	-----------------------    *(&GpioCtrlRegs+29L) &= 0xff7fu;
;*** 868	-----------------------    *(&GpioDataRegs+13L) |= 0x80u;
;*** 869	-----------------------    *(&GpioCtrlRegs+24L) &= 0x3fffu;
;*** 870	-----------------------    *(&GpioCtrlRegs+27L) |= 0x80u;
;*** 872	-----------------------    *(&GpioCtrlRegs+29L) &= 0xfeffu;
;*** 873	-----------------------    *(&GpioDataRegs+13L) |= 0x100u;
;*** 874	-----------------------    *((volatile struct GPB2_BITS *)C$1+25L) &= 0xfffcu;
;*** 875	-----------------------    *(&GpioCtrlRegs+27L) |= 0x100u;
;*** 877	-----------------------    *(&GpioCtrlRegs+29L) |= 0x200u;
;*** 878	-----------------------    *(&GpioDataRegs+13L) |= 0x200u;
;*** 879	-----------------------    *(&GpioCtrlRegs+25L) &= 0xfff3u;
;*** 880	-----------------------    *(&GpioCtrlRegs+27L) |= 0x200u;
;*** 882	-----------------------    *(&GpioCtrlRegs+29L) |= 0x400u;
;*** 883	-----------------------    *(&GpioDataRegs+13L) |= 0x400u;
;*** 884	-----------------------    *(&GpioCtrlRegs+25L) &= 0xffcfu;
;*** 885	-----------------------    *(&GpioCtrlRegs+27L) &= 0xfbffu;
;*** 886	-----------------------    asm(" EDIS");
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
...
$C$DW$156	.dwtag  DW_TAG_variable, DW_AT_name("$O$C2")
 ...
 EALLOW
	...
	.dwpsn	file "../APP/Initial.c",line 788,column 2,is_stmt
        MOVL      XAR6,XAR4             ; [CPU_] |788| 
        ADDB      XAR6,#28              ; [CPU_U] |788| 
	...
	.dwpsn	file "../APP/Initial.c",line 734,column 2,is_stmt
        AND       @_GpioCtrlRegs+13,#0xfff7 ; [CPU_] |734| 
...
$C$DW$157	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$154, DW_AT_TI_end_line(0x379)
...
$C$DW$158	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitSCI")
	...
	.dwattr $C$DW$158, DW_AT_TI_begin_line(0x56d)
	.dwattr $C$DW$158, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$158, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 1390,column 1,is_stmt,address _sInitSCI
...
;***************************************************************
_sInitSCI:
;** 1392	-----------------------    SciaRegs.SCICCR.all = 7u;
;** 1394	-----------------------    SciaRegs.SCICTL1.all = 3u;
;** 1396	-----------------------    SciaRegs.SCIHBAUD = 0u;
;** 1397	-----------------------    SciaRegs.SCILBAUD = 145u;
;** 1403	-----------------------    SciaRegs.SCICTL2.all = 3u;
;** 1404	-----------------------    SciaRegs.SCICTL1.all = 35u;
;** 1407	-----------------------    ScibRegs.SCICCR.all = 7u;
;** 1409	-----------------------    ScibRegs.SCICTL1.all = 3u;
;** 1415	-----------------------    ScibRegs.SCIHBAUD = 2u;
;** 1416	-----------------------    ScibRegs.SCILBAUD = 73u;
;** 1419	-----------------------    ScibRegs.SCICTL2.all = 3u;
;** 1420	-----------------------    ScibRegs.SCICTL1.all = 35u;
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$159	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$158, DW_AT_TI_end_line(0x58d)
