...
void sInitGpio(void)
{
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO7 = 0;    // Enable pullup on  			//AD.SWITCH1
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO35 = 0;  // Enable pullup on GPIO35      //SW.ESC/TDI
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO36 = 0;  // Enable pullup on GPIO36      //SW.ENT/TMS
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO37 = 0;  // Enable pullup on GPIO37      //LCD.CS/TDO
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO38 = 0;  // Enable pullup on GPIO38      //SW.DOWN/TCK
