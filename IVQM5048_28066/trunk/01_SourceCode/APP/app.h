...
extern interrupt void HardOverCurrInterrupt(void);
...
extern INT8U 		*sGet24V120DefaultTable2(void);
extern INT8U 		*sGet48V120DefaultTable2(void);
...
extern INT16S g_wBatVoltSlopeCal;//电池电压斜率开始计算电压
extern INT16S g_wBatMinVoltDerate;//电池电压斜率降载最小电压
extern INT16S g_wBatMaxVoltDerate;//电池电压斜率降载最大电压
...
extern INT16S wOutputVoltBasic;
extern INT16U uwSinAmpLimitMax;
extern INT16S uwInvVoltLimtHight;
extern INT16S gi_wInvSinAmpLimit;
extern INT16S wKpwmUpLimit;
extern INT16U wInitLineVoltLLoss;// 
extern INT16U wInitLineVoltLBack;// 
extern INT16U wInitLineVoltHLoss ; //       
extern INT16U wInitLineVoltHBack ; // 
extern INT16U wAPLInitLineVoltLLoss ;  	// 
extern INT16U wAPLInitLineVoltLBack;	// 
extern INT16U bBatToLineModeflag;
