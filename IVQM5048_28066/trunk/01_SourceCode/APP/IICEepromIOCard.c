...
extern INT16S TestEEPROM;
extern INT16S TestEEPROMSave1Cnt;
extern INT16S TestEEPROMSave2Cnt;
extern INT16S TestEEPROMFlag;
...
void sReadEeprom1(void)			
{
	...
	INT8U   *pDefaultTable;
	INT8U	bCnt = 3;
	INT8U Test_CheckSum1 = 0;
	do
	{
		Test_CheckSum1 = sEepromRead(0,cEepromTotalLength1,(INT8U *)uEepromCfg1.wEepromCfg1);
		if(Test_CheckSum1 == cEepromSuccess)
		{
	...
	else if(wLength==17)
	{
		...
		wRestoreSerial5 = uEepromCfg1.wEepromCfg1[17];
		bRestoreFactoryFlag = 1;
	}
	else
	{
	...
	if(dwWarningCode&cIICEepromFail == 1)
	{
		TestEEPROM = Test_CheckSum1+10;
	}
...
void sReadEeprom2(void)			
{
	...
	INT8U   *pDefaultTable;
	INT8U	bCnt = 3;
	INT8U Test_CheckSum2 = 0;
	do
	{
		Test_CheckSum2 = sEepromRead(cEepromTotalLength1,cEepromTotalLength2,(INT8U *)uEepromCfg2.wEepromCfg2);
		if(Test_CheckSum2 == cEepromSuccess)
		{
...
{
	INT8U	bCnt = 3;
	INT8U Test_CheckSum3 = 0;
	do
	{
		Test_CheckSum3 = sEepromRead(cEepromTotalLength1+cEepromTotalLength2,cEepromTotalLength3,uEepromCfg3.EepromStructCfg3.bEE3CommandBuffer);
		if(Test_CheckSum3 == cEepromSuccess)
		{
			return;
...
{
	INT8U	bCnt = 3;
	INT8U Test_CheckSum4 = 0;
	do
	{
		Test_CheckSum4 = sEepromRead(cEepromTotalLength1+cEepromTotalLength2+cEepromTotalLength3,cEepromTotalLength4,(INT8U *)uEepromCfg4.wEepromCfg4);
		if(Test_CheckSum4 == cEepromSuccess)
		{
...
void sEepromSave1(void)
{
	...
	TestEEPROMSave1Cnt++;
	if(TestEEPROMSave1Cnt>99)
	{
		TestEEPROMSave1Cnt = 0;
	}
...
void sEepromSave2(void)
{
	...
	TestEEPROMSave2Cnt++;
	if(TestEEPROMSave2Cnt>99)
	{
		TestEEPROMSave2Cnt = 0;
	}
...
INT8U   sbGetEepromOutputPriority(void)//输出优先级
{
    return(uEepromCfg2.EepromStructCfg2.bOutputPriority);
}

void    sSetEepromOutputPriority(INT8U bPriority) //输出优先级
{
