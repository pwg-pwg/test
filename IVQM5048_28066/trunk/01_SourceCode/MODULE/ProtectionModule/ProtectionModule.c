...
void sTempModuleUpdate(void)
{
	...
	{
		wInvOverTempPoint = cHsTempOv-30;
		wInvOverTempBackPoint = cHsTempOvBack-20;
		wInvHsTempDerate =cHsTempDerate-30;
		wInvHsTempDerateUp =cHsTempDerateUp-30;
		wInvHsTempDerateBack =cHsTempDerateBack-15;
	}
	else
	{
...
INT8U sNTCDisConnectFaultChk(void)
{
	...
	else if(cTxNtcDisconnect == (sdwGetWarningCode() & cTxNtcDisconnect))
	{
		return 1;
	}
	else
