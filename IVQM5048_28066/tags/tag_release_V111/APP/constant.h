...
#define cWarn3PhaseNLossFault	10
...
// TEMP
//现在定这个温度点是考虑电感温升太高定的，后续改善了电感温度可以把这个温度点重新调整
#define	cTxtTempOv					100//111
#define	cTxtTempOvBack				90//100

#define	cTxtTempDerate				90//100
#define	cTxtTempDerateUp			100//110
#define	cTxtTempDerateBack			80//90

#define	cTxtTempDerate10KVA			140
#define	cTxtTempDerateUp10KVA		160
#define	cTxtTempDerateBack10KVA		130

#define	cTxtTempStatusBase			90//100	// 变压器温度状态:＞100=1,＞110=2,＞120=3,＞130=4,＞140=5,＞150=6

#define	cHsTempOv					76//90
#define	cHsTempOvBack				45//60

#define	cHsTempDerate				70//80
#define	cHsTempDerateUp				75//90
#define	cHsTempDerateBack			45//60

#define	cHsTempStatusBase			45	// 散热片温度状态:＞50=1,＞60=2,＞70=3,＞80=4

#define	cMpptHsTempStatusBase		45
...
#define		c3PhaseNLoss			0x00100000
...
#define cOutputUtilityFrist	        0//Utility First
#define cOutputSolarFrist	        1//PV First
#define cOutputSolarBatUtility      2//PV And Utility
