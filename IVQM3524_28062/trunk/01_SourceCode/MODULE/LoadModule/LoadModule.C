...
INT16U	wL2OPCurrentNew;
INT16U	wL2LowOPCurrentNew;

INT32S	dwL2OPWattNew;
INT32U	dwL2OPVANew;
INT32S	dwL2OPWatt;
INT32U	dwL2OPVA;
INT16U	wL2OPWattPercent;
INT16U	wL2OPVAPercent;
INT16U	wL2OPPowerPercent;

INT32U  dwL1OPVANew;
INT32S	dwL1OPWattNew;
...
void sInvPowerPercentMaxCal(INT16U wOPWatt100,INT16U wOPVA100)
{
	...
	wTempWatt = (INT16U)(((INT32U)wTempWatt * g_wOPVoltTransferRatio) >> 10);//g_wOPVoltTransferRatioÖµÒÑ¾­*2^10
...
void sL2OPCurrentAdj(INT16U wROPCurrentRMS)
{
	wL2OPCurrentNew = wROPCurrentRMS;
}


INT16U swGetL2OPCurrentNew(void)
{
	return(wL2OPCurrentNew);
}

INT16U swGetL2LowOPCurrentNew(void)
{
	return(wL2LowOPCurrentNew);
}



INT32U sdwGetL2OPVA(void)
{
	return(dwL2OPVANew);
}
/*
INT16U swGetL2LoadWattPercent(void)
{
	return(wOPL2WattPercent);
}

INT16U swGetL2LoadVAPercent(void)
{
	return(wOPL2VAPercent);
}
*/
INT16U swGetL1L2MaxOPCurrent(void)
{
	return(wROPCurrentNew>wL2OPCurrentNew? wROPCurrentNew:wL2OPCurrentNew);
}


void sSetL1OPVVA(INT32U dwOPVANewNew)
{
	dwL1OPVANew = dwOPVANewNew;
	
}
void sSetL2OPVVA(INT32U dwOPVANewNew)
{
	dwL2OPVANew = dwOPVANewNew;
	
}

void sSetOPVACal(INT32U dwOPVANewNew)
{
	dwOPVANew = dwOPVANewNew;
	
}

INT32U sGetL1OPVVA(void)
{
	return dwL1OPVANew ;
	
}
INT32U sGetL2OPVVA(void)
{
	return dwL2OPVANew ;
}

void setL1OPWatt(INT32U dwPWattNew)
{
	dwL1OPWattNew =dwPWattNew;
}
INT32U sdwGetL1OPWatt(void)
{
	return(dwL1OPWattNew);
}

void setL2OPWatt(INT32U dwPWattNew)
{
	dwL2OPWattNew =dwPWattNew;
}
INT32U sdwGetL2OPWatt(void)
{
	return(dwL2OPWattNew);
}
