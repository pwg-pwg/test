...
void sTempModuleUpdate(void)
{
	...
	{
		wTxtOverTempPoint = cTxtTempOv-20;
		wTxtOverTempBackPoint = cTxtTempOvBack-20;
		
		wTxtTempDerate =cTxtTempDerate-20;
		wTxtTempDerateUp =cTxtTempDerateUp-20;
		wTxtTempDerateBack =cTxtTempDerateBack-20;
	...
	{
		wInvOverTempPoint = cHsTempOv-30;//55¡æ
		wInvOverTempBackPoint = cHsTempOvBack-20;//35¡æ
		wInvHsTempDerate =cHsTempDerate-30;//45¡æ
		wInvHsTempDerateUp =cHsTempDerateUp-30;//55¡æ
		wInvHsTempDerateBack =cHsTempDerateBack-15;//40¡æ
	}
	else
	{
...
void sAvrTempDeratingChk(INT8U bFilter)
{
	...
	if(bPVMode == cBatteryMode)
	{
		...
		else
		{
			...
			{
				wTempDerateRangeTx =wTempDegreeTxt -wTxtTempDerate;
			}
		}
...
void sMpptTempChk(INT8U bFilter)
{
	...
	switch(bMpptHsTempInfo)
	{
		case 3:
		{
			if(sbUnderLevelChk(wSccDispHsTemp, cMpptHsTempStatusBase+20, bFilter, &bHighDegreeCntB) == true)
			{
				bMpptHsTempInfo = 2;
				bNormalCnt = 0;
				bHighDegreeCntA = 0;
		...
		case 2:
		{
			if(sbOverLevelChk(wSccDispHsTemp, cMpptHsTempStatusBase + 30, bFilter, &bHighDegreeCntB) == true)
			{
				bMpptHsTempInfo = 3; 
			 ...
			 else if(sbUnderLevelChk(wSccDispHsTemp, cMpptHsTempStatusBase+10, bFilter, &bHighDegreeCntA) == true)
			{
				bMpptHsTempInfo = 1;
				bNormalCnt = 0;
				bHighDegreeCntA = 0;
