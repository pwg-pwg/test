...
#define cPrioGrid												3
//#define cPrioPara												4
#define cPrioBusBatProt										4
#define cPrioInterface											5
#define cPrioDisplayBuzz										6
...
extern INT16S swGetL2OpCurrSampleBiasTemp(void);
extern void   sSetL2OpCurrSampleBiasTemp(INT16S wVaule);
