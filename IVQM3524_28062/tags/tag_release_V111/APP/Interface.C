...
INT16U wFanComCtrl2 =0;
INT16U wFanSpeedCtrl2;
...
void	sParsing(INT8U sciid)
{
	...
	{
		if( wComIndex >= bCancleCRCComIndex && wComIndex !=cCOMM_NUM -1)    //20120115 Amy 
		{
			bCRCChkFlg = 1;
		}
		else
...
//	sbNumToXXX(swGetTempDegreeBat(),pDataBuf);
	sbNumToXXX(wSccDispHsTemp,pDataBuf);
	bStrLen += 3;
	bUserDataBuf0[sciid][bStrLen++]=CHAR_SPACE; 
	...
	if(gi_wInvVoltBias<0)
	{
		wTemp =-gi_wInvVoltBias;
		bUserDataBuf0[sciid][bStrLen++]='-'; 
	}
	else
	{
	...
	*/
	...
	bUserDataBuf0[sciid][bStrLen++]=':';
	wTemp =wFANPWMTempSet;
	pDataBuf=&bUserDataBuf0[sciid][bStrLen];
	sbNumToXXX(wTemp,pDataBuf);   
	bStrLen += 3;
	bUserDataBuf0[sciid][bStrLen++]=CHAR_SPACE; 
...
//extern 	INT16U wRSinAmpTest;
extern 	INT16U wRSinAmp;
extern 	INT16U wOutPutVolt;
...
void	sTestCommand(INT8U sciid)
{
	...
	if((bCommandBuffer[sciid][3] == 'D') && (bCommandBuffer[sciid][4] == 'C')\
		&& (bCommandBuffer[sciid][5] == 'V') &&(bCommandBuffer[sciid][6] == '?'))//DCV?
	{
		bUserDataBuf0[sciid][0] = '(';
		wTemp = wDCVoltSet;
		if(wTemp < 0)
	...
	else if((bCommandBuffer[sciid][3] == 'V') && (bCommandBuffer[sciid][4] == 'S'))//VS
	{
	...
	else if((bCommandBuffer[sciid][3] == 'K') && (bCommandBuffer[sciid][4] == 'I'))//KI
	{
		wTemp =(bCommandBuffer[sciid][5] - '0') * 1000 + (bCommandBuffer[sciid][6] - '0')*100
			      + (bCommandBuffer[sciid][7] - '0') * 10 + (bCommandBuffer[sciid][8] - '0'); 
	...
	else if((bCommandBuffer[sciid][3] == 'K') && (bCommandBuffer[sciid][4] == 'P')&& (bCommandBuffer[sciid][5] == '?'))//KP?
	{
		bUserDataBuf0[sciid][0] = '(';
	...
	else if((bCommandBuffer[sciid][3] == 'K') && (bCommandBuffer[sciid][4] == 'P'))//KP
	{
	...
	else if((bCommandBuffer[sciid][3] == 'F') && (bCommandBuffer[sciid][4] == 'D'))//FD
	{
		wTemp = (bCommandBuffer[sciid][5] - '0') * 100 + (bCommandBuffer[sciid][6] - '0') * 10
			+ bCommandBuffer[sciid][7] - '0';
	...
	else if((bCommandBuffer[sciid][3] == 'S') && (bCommandBuffer[sciid][4] == 'I')&& (bCommandBuffer[sciid][5] == '?'))//SI?
	{
		bUserDataBuf0[sciid][0] = '(';
		wTemp = wRSinAmp/10;
		
		sbNumToXXXX(wTemp,&bUserDataBuf0[sciid][1]);
		bUserDataBuf0[sciid][5] = 0x0D;
		sSciWrite(sciid,bUserDataBuf0[sciid],6);
	}
	else if((bCommandBuffer[sciid][3] == 'S') && (bCommandBuffer[sciid][4] == 'I'))//SI
	{
		wTemp = (bCommandBuffer[sciid][5] - '0') * 1000 + (bCommandBuffer[sciid][6] - '0') * 100
			+ (bCommandBuffer[sciid][7] - '0')*10 +(bCommandBuffer[sciid][8] - '0');
		if(wTemp >= 100 && wTemp <= 1300)
		{
//			wRSinAmpTest =wTemp*10;
			sACK(sciid);
		}
		else
		{
	...
	else if((bCommandBuffer[sciid][3] == 'O') && (bCommandBuffer[sciid][4] == 'V'))//OV
	{
		wTemp = (bCommandBuffer[sciid][5] - '0') * 100 + (bCommandBuffer[sciid][6] - '0') * 10
			+ (bCommandBuffer[sciid][7] - '0');
		if(wTemp >= 190 && wTemp <= 230)
		{
			wOutPutVolt =wTemp*10;
			sACK(sciid);
		}
		else
		{
	...
	else if((bCommandBuffer[sciid][3] == 'C') && (bCommandBuffer[sciid][4] == 'L')&& (bCommandBuffer[sciid][5] == '?'))//CL?
	{
		
		bUserDataBuf0[sciid][0] = '(';
		wTemp = g_wInvOverCurrRated;
		
		sbNumToXXX(wTemp,&bUserDataBuf0[sciid][1]);
		bUserDataBuf0[sciid][4] = 0x0D;
		sSciWrite(sciid,bUserDataBuf0[sciid],5);
	}
	else if((bCommandBuffer[sciid][3] == 'C') && (bCommandBuffer[sciid][4] == 'L'))//CL
	{
		wTemp = (bCommandBuffer[sciid][5] - '0') * 10 + (bCommandBuffer[sciid][6] - '0');
		
		if(wTemp >= 0 && wTemp <= 100)
		{
			g_wInvOverCurrRated =wTemp;
			sACK(sciid);
		}
		else
		{
	...
	else if((bCommandBuffer[sciid][3] == 'M') && (bCommandBuffer[sciid][4] == 'F')\
			&&(bCommandBuffer[sciid][5] == 'A') && (bCommandBuffer[sciid][6] == 'N'))//MFAN
		{
			wFanComCtrl2 =(bCommandBuffer[sciid][7] - '0') ;
			wTemp = (bCommandBuffer[sciid][7] - '0')*100 +(bCommandBuffer[sciid][8] - '0')*10 +(bCommandBuffer[sciid][9] - '0');
			if(wTemp >= 0 && wTemp <= 100)
			{
				wFanSpeedCtrl2 =wTemp; //Test extern INT16U ;
				sACK(sciid);
			}
			else
			{
		...
		else if((bCommandBuffer[sciid][3] == 'I') && (bCommandBuffer[sciid][4] == 'F')\
			&&(bCommandBuffer[sciid][5] == 'A') && (bCommandBuffer[sciid][6] == 'N'))//IFAN
		{
			wFanComCtrl =(bCommandBuffer[sciid][7] - '0') ;
			wTemp = (bCommandBuffer[sciid][7] - '0')*100 +(bCommandBuffer[sciid][8] - '0')*10 +(bCommandBuffer[sciid][9] - '0');
			if(wTemp >= 0 && wTemp <= 100)
			{
				wFanSpeedCtrl =wTemp; //Test extern INT16U ;
				sACK(sciid);
			}
			else
			{
