...
INT16U		wL1InverterVoltNew;
INT16U		wL1InverterInvLCurrNew;
INT16U 		wL1InverterOPCurrAdj = 2048;
...
*************************************************************************************/
void	sRInverterVoltAdj(INT16U wRInverterVoltRMS)//均方根
{
...
void	sL1InverterVoltAdj(INT16U wRInverterVoltRMS)
{
	//wL1InverterVoltNew = (INT16U)(((INT32U)wRInverterVoltRMS*(INT32U)wL1InverterVoltAdj) >> 11);
	wL1InverterVoltNew = wRInverterVoltRMS;
}

void	sL1InverterInvLCurrAdj(INT16U wRInverterInvLCurrRMS)
{
	wL1InverterInvLCurrNew = (INT16U)(((INT32U)wRInverterInvLCurrRMS*(INT32U)wL1InverterOPCurrAdj) >> 11);
}
...
//	wInverterPeriodCntNew = 90000000/（选择频率*100）
//	wPointerMaxTemp = wInverterPeriodCntNew*factor/cPWMCntlPeriod 
//					= 90000000/(选择频率*100)*50Hz/2344 
//					= (90000000/100/2344)*(选择频率/50Hz)
//					= 383.959*(选择频率/50Hz)
...
INT16U	swGetL1InverterVolt(void)
{
	return(wL1InverterVoltNew);
}
