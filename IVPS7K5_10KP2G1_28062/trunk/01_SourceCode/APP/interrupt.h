...
#ifdef SECONDVER
#define	cFwVersion		115	   //114由111重工而来,115由114变更子类
//#define	cDebugVersion      111-1

#else
#define	cFwVersion		204	// 正式版本程序V203
...
struct EepromStruct1
{
	...
	INT16U  wEEpromVer;		
	INT16U  wEEL2OPCurrAdj;
	INT16U  wEE1Reseverd15;
	INT16U  wEE1Reseverd16;
...
#define	mEEL2OPCurrAdj()		uEepromCfg1.EepromStructCfg1.wEEL2OPCurrAdj
...
#define	mBusSoftOKFlg			strLocalInvStatus.BIT.wBusSoftOK
#define	mBusSoftWaitFlg			strLocalInvStatus.BIT.wBusSoftWait
#define	mBusSoftEn				strLocalInvStatus.BIT.wBusSoftEn
#define	mOverLoadFail			strLocalInvStatus.BIT.wOverLoadFail
...
extern INT16S	swL1InvVoltRmsCal(void);
...
extern INT16S	swL2OPCurrRmsCal(void);
...
extern INT16S swL2OpCurrAveCal(void);
...
extern INT16U   swGetEEL2OPCurrAdj(void);
extern void    sSetEEL2OPCurrAdj(INT16U wValue);
...
extern INT32S sdwL2OPWattCal(void);
extern void sSetL1LoadPowerWatt(INT16S wValue);
extern void sSetL2LoadPowerWatt(INT16S wValue);
