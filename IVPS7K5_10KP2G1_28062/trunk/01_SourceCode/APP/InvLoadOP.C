...
INT16U sGetmaximum(INT16U uwCompareValue1,INT16U uwCompareValue2);
...
void sOverLoadProtect(void)      
{
	...
	INT16U uwLoadPowerPercent =0;
	 ...
	 uwLoadPowerPercent =sGetmaximum(swGetL1PowerPercent(),swGetL2PowerPercent());
	 uwLoadPowerPercent =sGetmaximum(swGetLoadPowerPercent(),uwLoadPowerPercent);
