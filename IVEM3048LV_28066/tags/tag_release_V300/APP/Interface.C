...
extern INT16S g_swTjEndFanSpeedPWM;
...
const pFunc1	GetDataSubArray[100]=
{
	...
	swGetInnelTempSample,	swGetModelSample,			swGetRInvDCVoltSample,					//18-20	
	swGetRInvCurr1Sample,	swGetRInvCurr2Sample,		swReturnNull,							//21-23
	swReturnNull,			swReturnNull,				swReturnNull,							//24-26
	...
	swReturnNull,			swReturnNull,				swReturnNull,							//45-47
	swGetBoost_PWM,			swReturnNull,				(pFunc1)suwGetBoost1CtrlSts,			//48-50
	swGetRInvCurr1Real,		swGetRInvCurr2Real,			swReturnNull,							//51-53
	swReturnNull,			swReturnNull,				swReturnNull,							//54-56
	...
	swReturnNull,			swReturnNull,				swGetPDCDCImo,							//75-77
	...
	swGetInvCurrCtrlFBImo_P,swGetInvCurrCtrlFBR_Is_P,	swGetInvCurrCtrlFBVm_P,					//87-89
	swReturnNull,			swReturnNull,				swReturnNull,							//90-92
	swReturnNull,			swReturnNull,				swReturnNull,							//93-95
	swReturnNull,			swReturnNull,				swReturnNull,							//96-98
	swReturnNull																				// 99
};
...
void sQ2Command(INT8U sciid)
{
	...
	g_ubUserDataBuf0[sciid][wSciLength++] = 'j';
	sNumToASCII(g_swLLC_MosTj, 3, 0, &g_ubUserDataBuf0[sciid][wSciLength]);
	wSciLength += 3;
	g_ubUserDataBuf0[sciid][wSciLength++] = cChar_Space;
	sNumToASCII(g_swBUCK_IGBTTj, 3, 0, &g_ubUserDataBuf0[sciid][wSciLength]);
	wSciLength += 3;
	g_ubUserDataBuf0[sciid][wSciLength++] = cChar_Space;
	sNumToASCII(g_swINV_IGBTTj, 3, 0, &g_ubUserDataBuf0[sciid][wSciLength]);
	wSciLength += 3;
	g_ubUserDataBuf0[sciid][wSciLength++] = cChar_Space;
	sNumToASCII(g_swPV_BOOST_DiodeTj, 3, 0, &g_ubUserDataBuf0[sciid][wSciLength]);
	wSciLength += 3;
	g_ubUserDataBuf0[sciid][wSciLength++] = cChar_Space;
	...
	sNumToASCII(Temp, 4, 0, &g_ubUserDataBuf0[sciid][wSciLength]);
	wSciLength += 4;
	g_ubUserDataBuf0[sciid][wSciLength++] = cChar_Space;

	Temp = g_wConvertHTemp;
	if(Temp < 0)
	{
		g_ubUserDataBuf0[sciid][wSciLength++] = '-';
		Temp = -g_wConvertHTemp;
