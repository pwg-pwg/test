...
//		}		
	...
	uwStandardRefVolt = (uwStandardRefVolt * cTransformerRatio) + cBusVoltReal30V + g_wGridChgBatCompVolt;
	...
	if(uwBusVoltRefTemp < cBusVoltReal330V)
	{
		uwBusVoltRefTemp = cBusVoltReal330V;
	}
...
void sPowerPriorityProc(void)
{
	...
	INT32S dwPowerTemp;
//	static INT16S swFPCurrLimitTemp = 0;
//	static INT16S swFPCurrLimitCnt = cCntl_FPCurrLimit;
	...
	g_dwBatACChgLimit = (g_dwBatACChgLimit * 140) >> 7;	//0.914 efficiency
	...
	{
		g_wLineVoltDeratPowerLimit = 900;
	}
...
//	}
	...
	{
//		if((INT32S)gi_wInvChgCurrLimit < (g_dwInvChgLimit - 5))
//		{
//			gi_wInvChgCurrLimit += 5;
//		}
//		else if((INT32S)gi_wInvChgCurrLimit > (g_dwInvChgLimit + 5))
//		{
//			gi_wInvChgCurrLimit -= 5;
//		}
//		else
//		{
//			gi_wInvChgCurrLimit = g_dwInvChgLimit;
//		}
//
...
//		if(++swFPCurrLimitCnt > 50)
//		{	
//			swFPCurrLimitCnt = 0;
//
//			if(g_uwRLineVolt > cLineVolt100V)
//			{
//				swFPCurrLimitTemp = cCntl_FPCurrLimit;
//
//			}
//			else if(g_uwRLineVolt > cLineVolt90V)
//			{
//				swFPCurrLimitTemp = (INT16S)((INT32U)(g_uwRLineVolt-cLineVolt80V)*cCntl_FPCurrLimit/200);
//			}
//			else
//			{
//				swFPCurrLimitTemp = cCntl_FPCurrLimit/2;
//			}
//		}
//				
//		if(gi_wInvChgCurrLimit < swFPCurrLimitTemp)
//		{
//			gi_wInvChgCurrLimit ++;
//		}
//		else if(gi_wInvChgCurrLimit > swFPCurrLimitTemp)
//		{
//			gi_wInvChgCurrLimit --;
//		}
...
void sEnergyInfoUpdate(void)
{
	...
	if((g_wAgingMode && ((!g_uwSolarLoss && !g_wSolarPowerWeak) || (!subGetParaBatOpenSts() && !fBMSStopDischgFlg)))
	...
	if(!fBMSStopChargeFlg && ((!subGetParaBatOpenSts()
	&& (fBMSForceChgFlg || g_fBatDanger || swGetEEChgPriority() == cChargeSolarAndUtilityFrist
	|| swGetEEChgPriority() == cChargeUtilityFrist
	|| (swGetEEChgPriority() == cChargeSolarFrist && g_uwSolarLoss && !g_uniInputStatus.BIT.uwSysSCCOK))) || g_wSysLiBatActFlg))
	{
	...
	&& ((swGetEEOPPriority() != cOutputUtilityFrist) || subGetParaBatOpenSts()))
	{
...
void sInputOutputRvsChk(INT8U bFilter)
{
	...
	{
		if(sbOverLevelChk(g_uwROPVoltAvg, 700, bFilter, &s_uwChkCnt))
		{
