...
INT16S gi_wConvertLTempSample;
INT16S gi_wInnelTempSample;
INT16S gi_wConvertHTempSample;
						...
						INT16S *pwGeneratorWaveChkCnt, INT16S *pwGeneratorVoltMax, INT16S *pwGeneratorVoltMin)
{
	...
	if(((abs(wLinvVolt) < 300 ) || abs(wLinvVolt) > 2200 ) && abs(wOPCurr) < cOPCurr5A )
	{	
...
//	hoCHGLED^=1;
	...
	gi_wConvertLTempSample	=	ADCRESULT14;
	...
	{
		hoADCSWITCH1On;
		gi_wInvTempSample 	= 	ADCRESULT11;
		gi_wConvertHTempSample		=	ADCRESULT12;
...
//		}
	...
	if(!s_wCnt)
	{
		...
		if(g_wKpwm>=1200)        //2344*128/150 = 2000 		//2344*128/250  =1200 
		{
	        g_wKpwm=1200;
		}
