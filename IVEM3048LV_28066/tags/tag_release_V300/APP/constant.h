...
#define cInt_InvCurrPrtPnt			cInv75A//cInv75A
...
#define cCntl_InvVoltKv				80
#define cCntl_InvVoltKi				500
...
#define	cCntl_InvCurrLimit			3520	//110A*32
...
#define cDSPVersion		((1000*mModel) + 300)
//#define	cTestCmd		
...
#if mModel == cModel3048
#define cDCDCConvertPeriod			900		//50K    ////LLC Hardware Version2 Frequency   //41K  LLC Hardware Version1 Frequency
#define cDCDCConvertDutyMax			405		//45%duty
#define cDCDCConvertDuty030			270		//30%duty
#define cDCDCConvertDuty025			225		//25%duty
#define cDCDCConvertDuty015			135		//15%duty
#define cDCDCConvertDuty010			90		//10%duty  
#define cDCDCConvertDuty006			54		//6%duty  
#define cDCDCConvertDuty002			18		//2%duty  
...
#else
#define cDCDCConvertPeriod			1000	//45K
#define cDCDCConvertDutyMax			450		//45%duty  //0x0176	//40%duty
...
#define	cInvDCVoltRatio			250				//0.5VMax	2^10 * 1000		1mV << 10	1.5Vbias
...
#elif mModel == cModel5048
#define	cInvCurrRatio			990				//198.0AMax 2^10 * 10		0.1A << 10	1.5Vbias
#define	cOPCurrRatio			971				//194.12AMax	2^10 * 10		0.1A << 10	1.5Vbias
#endif
...
#define	cILLCAvgCurrRatio		91				//36.4AMax   	2^10 * 10		0.1A << 10	1.65Vbias
...
#define	cDCDC35A			1740//(INT16S)((((INT32S)3500 << 10) /cDCDCCurrRatio + 5) /10)
