...
;	D:\Program Application\CCS6.1.1\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\zhang\\AppData\\Local\\Temp\\108042 C:\\Users\\zhang\\AppData\\Local\\Temp\\108044 
;	D:\Program Application\CCS6.1.1\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\zhang\\AppData\\Local\\Temp\\1080412 
	.sect	".text"
...
;*** 105	-----------------------    y$5 = (wPDCDCCurr+wNDCDCCurr)*6;
...
;*** 98	-----------------------    g_wDCDCCurr = (wPDCDCCurr+wNDCDCCurr)*6;
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$91	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../MODULE/BatteryModule/BatteryModule.C",line 64,column 2,is_stmt
        MOV       AL,@_g_wBatUnderVolt  ; [CPU_] |64| 
        ADDB      AL,#20                ; [CPU_] |64| 
        MOVZ      AR1,AL                ; [CPU_] |64| 
        MOV       @_g_wBatLowVolt,AL    ; [CPU_] |64| 
...
$C$DW$104	.dwtag  DW_TAG_variable, DW_AT_name("uwFilter")
	...
	.dwpsn	file "../MODULE/BatteryModule/BatteryModule.C",line 300,column 2,is_stmt
        ...
        ; branchcc occurs ; [] |300| 
;*** 302	-----------------------    if ( !(sbUnderLevelChk((int)g_uwBatVoltAvg, g_wBatWeakVolt, uwFilter, &g_uwBatWeakChkCnt) || g_fBatUnder) ) goto g4;
...
$C$L10:    
;***	-----------------------g12:
;*** 334	-----------------------    if ( sbOverLevelChk((int)g_uwBatVoltAvg, (int)wBatWeakBackVolt, uwFilter, &g_uwBatWeakChkCnt) == 0u && g_wBatChgStage != 2 && (g_fBMSSOCFull == 0u && s_uwBatVoltOverCnt < 500u) || g_fBatUnder ) goto g14;
...
;*** 202	-----------------------    if ( g_fBatUnder ) goto g16;
	.dwpsn	file "../MODULE/BatteryModule/BatteryModule.C",line 202,column 2,is_stmt
        ...
        ; branchcc occurs ; [] |202| 
;*** 204	-----------------------    if ( !sbUnderLevelChk((int)g_uwBatVoltAvg, wBatUnderVolt, uwFilter, &s_uwBatChkCnt) ) goto g18;
;*** 206	-----------------------    g_fBatUnder = 1u;
;*** 206	-----------------------    goto g18;
...
$C$L21:    
;***	-----------------------g16:
;*** 211	-----------------------    if ( sbOverLevelChk((int)g_uwBatVoltAvg, g_wBatUnderBackVolt, uwFilter, &s_uwBatChkCnt) == 0u && g_wBatChgStage != 2 && g_fBMSSOCFull == 0u ) goto g18;
...
;*** 221	-----------------------    if ( g_fBatDanger ) goto g22;
	.dwpsn	file "../MODULE/BatteryModule/BatteryModule.C",line 221,column 3,is_stmt
        ...
        ; branchcc occurs ; [] |221| 
;*** 223	-----------------------    if ( !sbUnderLevelChk((int)g_uwBatVoltAvg, g_wBatUnderVolt, 3000u, &s_uwBatDangerChkCnt) ) goto g24;
;*** 225	-----------------------    g_fBatDanger = 1u;
;*** 225	-----------------------    goto g24;
...
$C$L24:    
;***	-----------------------g22:
;*** 230	-----------------------    if ( sbOverLevelChk((int)g_uwBatVoltAvg, g_wBatUnderVolt+8, 30000u, &s_uwBatDangerChkCnt) == 0u && g_wBatChgStage != 2 && g_fBMSSOCFull == 0u ) goto g24;
...
$C$DW$132	.dwtag  DW_TAG_variable, DW_AT_name("uwBatOverLevel")
	...
	.dwpsn	file "../MODULE/BatteryModule/BatteryModule.C",line 137,column 2,is_stmt
        ...
        ; branchcc occurs ; [] |137| 
;*** 146	-----------------------    if ( !sbOverLevelChk((int)g_uwBatVoltAvg, (int)uwBatOverLevel, uwFilter, &s_uwBatChkCnt) ) goto g6;
;*** 148	-----------------------    g_fBatOver = 1u;
;*** 148	-----------------------    goto g6;
...
$C$L31:    
;***	-----------------------g4:
;*** 139	-----------------------    if ( !sbUnderLevelChk((int)g_uwBatVoltAvg, (int)(uwBatOverLevel-20u), uwFilter, &s_uwBatChkCnt) ) goto g6;
...
$C$DW$140	.dwtag  DW_TAG_variable, DW_AT_name("uwFilter")
	...
	.dwpsn	file "../MODULE/BatteryModule/BatteryModule.C",line 367,column 2,is_stmt
        ...
        ; branchcc occurs ; [] |367| 
;*** 376	-----------------------    if ( !sbOverLevelChk((int)g_uwBatVoltAvg, g_wBatVoltRef+5, uwFilter, &s_uwBatOverChgChkCnt) ) goto g6;
...
$C$L33:    
;***	-----------------------g4:
;*** 369	-----------------------    if ( !sbUnderLevelChk((int)g_uwBatVoltAvg, g_wBatVoltRef, uwFilter, &s_uwBatOverChgChkCnt) ) goto g6;
...
$C$DW$150	.dwtag  DW_TAG_variable, DW_AT_name("uwBatOpenLevel")
	...
	.dwpsn	file "../MODULE/BatteryModule/BatteryModule.C",line 348,column 2,is_stmt
        ...
        ; branchcc occurs ; [] |348| 
;*** 350	-----------------------    if ( !sbUnderLevelChk((int)g_uwBatVoltAvg, (int)uwBatOpenLevel, uwFilter, &s_uwBatChkCnt) ) goto g6;
;*** 352	-----------------------    g_fBatOpen = 1u;
;*** 352	-----------------------    goto g6;
...
$C$L35:    
;***	-----------------------g4:
;*** 357	-----------------------    if ( !sbOverLevelChk((int)g_uwBatVoltAvg, (int)(uwBatOpenLevel+40u), uwFilter, &s_uwBatChkCnt) ) goto g6;
...
;*** 279	-----------------------    if ( g_fBatLow ) goto g5;
	...
	.dwpsn	file "../MODULE/BatteryModule/BatteryModule.C",line 279,column 3,is_stmt
        ...
        ; branchcc occurs ; [] |279| 
;*** 281	-----------------------    if ( !sbUnderLevelChk((int)g_uwBatVoltAvg, g_wBatLowVolt, uwFilter, &s_uwBatChkCnt) ) goto g8;
;*** 283	-----------------------    g_fBatLow = 1u;
;*** 283	-----------------------    goto g8;
...
$C$L37:    
;***	-----------------------g5:
;*** 288	-----------------------    if ( !sbOverLevelChk((int)g_uwBatVoltAvg, g_wBatLowBackVolt, uwFilter, &s_uwBatChkCnt) ) goto g8;
...
$C$DW$166	.dwtag  DW_TAG_variable, DW_AT_name("uwFilter")
	...
	.dwpsn	file "../MODULE/BatteryModule/BatteryModule.C",line 386,column 2,is_stmt
        ...
        ; branchcc occurs ; [] |386| 
;*** 395	-----------------------    if ( !sbOverLevelChk(*(&g_strSysBMSCtrlInfo+1)>>8, 99, uwFilter, &s_uwBMSSOCFullChkCnt) ) goto g6;
...
$C$L41:    
;***	-----------------------g4:
;*** 388	-----------------------    if ( !sbUnderLevelChk(*(&g_strSysBMSCtrlInfo+1)>>8, 99, 5u, &s_uwBMSSOCFullChkCnt) ) goto g6;
        MOVW      DP,#_g_strSysBMSCtrlInfo+1 ; [CPU_U] 
