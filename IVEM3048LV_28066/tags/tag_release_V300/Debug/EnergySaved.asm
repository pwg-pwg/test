...
;	D:\Program Application\CCS6.1.1\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\zhang\\AppData\\Local\\Temp\\158322 C:\\Users\\zhang\\AppData\\Local\\Temp\\158324 
;	D:\Program Application\CCS6.1.1\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\zhang\\AppData\\Local\\Temp\\1583212 
	.sect	".text"
...
$C$DW$47	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$47, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM3048 LV\IVEM3048 LV 28066\IVEM3048LV_28066_V300_20230525\IVEM3048LV\Debug\EnergySaved.asm:$C$L1:1:1700724809")
...
$C$DW$58	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$58, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM3048 LV\IVEM3048 LV 28066\IVEM3048LV_28066_V300_20230525\IVEM3048LV\Debug\EnergySaved.asm:$C$L3:1:1700724809")
...
;*** 64	-----------------------    if ( s_uwPVStableCnt >= 12000u ) goto g11;
	...
	.dwpsn	file "../APP/EnergySaved.c",line 64,column 4,is_stmt
        CMP       @_s_uwPVStableCnt$2,#12000 ; [CPU_] |64| 
        B         $C$L10,HIS            ; [CPU_] |64| 
        ; branchcc occurs ; [] |64| 
;*** 66	-----------------------    ++s_uwPVStableCnt;
;*** 66	-----------------------    goto g11;
...
$C$L8:    
;***	-----------------------g8:
;*** 71	-----------------------    if ( s_uwPVStableCnt < 12000u ) goto g10;
        MOVW      DP,#_s_uwPVStableCnt$2 ; [CPU_U] 
	.dwpsn	file "../APP/EnergySaved.c",line 71,column 4,is_stmt
        CMP       @_s_uwPVStableCnt$2,#12000 ; [CPU_] |71| 
        B         $C$L9,LO              ; [CPU_] |71| 
        ; branchcc occurs ; [] |71| 
...
;*** 264	-----------------------    if ( s_uwLoadStableCnt >= 12000u ) goto g11;
	...
	.dwpsn	file "../APP/EnergySaved.c",line 264,column 4,is_stmt
        CMP       @_s_uwLoadStableCnt$4,#12000 ; [CPU_] |264| 
...
$C$L38:    
;***	-----------------------g8:
;*** 271	-----------------------    if ( s_uwLoadStableCnt < 12000u ) goto g10;
        MOVW      DP,#_s_uwLoadStableCnt$4 ; [CPU_U] 
	.dwpsn	file "../APP/EnergySaved.c",line 271,column 4,is_stmt
        CMP       @_s_uwLoadStableCnt$4,#12000 ; [CPU_] |271| 
        B         $C$L39,LO             ; [CPU_] |271| 
        ; branchcc occurs ; [] |271| 
