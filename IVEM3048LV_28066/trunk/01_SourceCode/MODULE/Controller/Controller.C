									...
									INT16S wInvSinpoint, INT16S wInvSinpointMax, INT16S wInvSinAmp, INT16S wInvSinValue)
{
	...
	g_strInvVoltCtrlPara.dwK_1 = (g_strInvVoltCtrlPara.dwK_1 * 133 + g_strInvVoltCtrlPara.dwVoltLimit * 123) >> 8;
	
	g_strInvVoltCtrlPara.dwK_1 = g_strInvVoltCtrlPara.dwVoltLimit;
	g_strInvVoltCtrlPara.dwVoltLimit = g_strInvVoltCtrlPara.dwK_1 + g_strInvVoltCtrlPara.wInvVoltCntl;
...
void sInitInvCurrCntlPara(void)
{
	...
	g_strInvCurrCtrlPara.wFBKcd_2 = 2587;
							...
							INT16S wInvChgCurrLimit, INT16S wInvFeedCurrLimit)
{
	...
	if(g_strInvCurrCtrlPara.wFBImo_P > 4500)   g_strInvCurrCtrlPara.wFBImo_P = 4500;  //4500 = 45*100
	else if(g_strInvCurrCtrlPara.wFBImo_P < -4500)  g_strInvCurrCtrlPara.wFBImo_P = -4500;
