...
;* Date/Time created: Thu Nov 23 15:33:32 2023                 *
;***************************************************************
...
;**************************************************************
	...
	.field	1050,16			; _g_wBMSTestDischgCurr @ 0

	.sect	".cinit"
	.align	1
	.field  	-1,16
	.field  	_g_wBMSTestChgCurr+0,32
	.field	600,16			; _g_wBMSTestChgCurr @ 0
...
;	D:\Program Application\CCS6.1.1\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\zhang\\AppData\\Local\\Temp\\266082 C:\\Users\\zhang\\AppData\\Local\\Temp\\266084 
;	D:\Program Application\CCS6.1.1\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\zhang\\AppData\\Local\\Temp\\2660812 
	.sect	".text"
...
$C$DW$52	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$52, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM3048 LV\IVEM3048 LV 28066\IVEM3048LV_28066_V300_20230525\IVEM3048LV\Debug\Interface_BMS.asm:$C$L1:1:1700724812")
...
$C$DW$75	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$75, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM3048 LV\IVEM3048 LV 28066\IVEM3048LV_28066_V300_20230525\IVEM3048LV\Debug\Interface_BMS.asm:$C$L3:1:1700724812")
...
$C$DW$100	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$100, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM3048 LV\IVEM3048 LV 28066\IVEM3048LV_28066_V300_20230525\IVEM3048LV\Debug\Interface_BMS.asm:$C$L5:1:1700724812")
...
$C$DW$123	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$123, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM3048 LV\IVEM3048 LV 28066\IVEM3048LV_28066_V300_20230525\IVEM3048LV\Debug\Interface_BMS.asm:$C$L9:1:1700724812")
...
$C$DW$146	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$146, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM3048 LV\IVEM3048 LV 28066\IVEM3048LV_28066_V300_20230525\IVEM3048LV\Debug\Interface_BMS.asm:$C$L11:1:1700724812")
...
$C$DW$163	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$163, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM3048 LV\IVEM3048 LV 28066\IVEM3048LV_28066_V300_20230525\IVEM3048LV\Debug\Interface_BMS.asm:$C$L15:1:1700724812")
...
;***************************************************************
_sBMSDataParsing:
;*** 168	-----------------------    if ( ubDataLength < 7u || pubDataBuff[1] != 3u || *pubDataBuff != g_uwBMSCmdAddrID ) goto g5;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
        MOVL      *SP++,XAR1            ; [CPU_] 
...
;*** 177	-----------------------    (g_wBMSType == 1) ? (uwRxNum = ((uwRxNum<<8)+pubDataBuff[3]+3u)*2u) : (uwRxNum = uwRxNum+5u);
	.dwpsn	file "../APP/Interface_BMS.C",line 177,column 4,is_stmt
        MOV       AH,@_g_wBMSType       ; [CPU_] |177| 
	.dwpsn	file "../APP/Interface_BMS.C",line 174,column 3,is_stmt
        MOVZ      AR4,*+XAR2[2]         ; [CPU_] |174| 
	.dwpsn	file "../APP/Interface_BMS.C",line 177,column 4,is_stmt
        CMPB      AH,#1                 ; [CPU_] |177| 
        BF        $C$L16,NEQ            ; [CPU_] |177| 
        ; branchcc occurs ; [] |177| 
        MOV       ACC,AR4 << #8         ; [CPU_] |177| 
        ADD       AL,*+XAR2[3]          ; [CPU_] |177| 
        ADDB      AL,#3                 ; [CPU_] |177| 
        MOV       ACC,AL << #1          ; [CPU_] |177| 
        MOVZ      AR4,AL                ; [CPU_] |177| 
        B         $C$L17,UNC            ; [CPU_] |177| 
        ; branch occurs ; [] |177| 
$C$L16:    
        ADDB      XAR4,#5               ; [CPU_U] |177| 
$C$L17:    
;*** 185	-----------------------    if ( uwRxNum != ubDataLength ) goto g5;
        MOV       AL,AR6                ; [CPU_] 
...
;*** 190	-----------------------    if ( uwCRC != CRC16_MODBUS(pubDataBuff, C$2) ) goto g5;
	.dwpsn	file "../APP/Interface_BMS.C",line 189,column 3,is_stmt
        ADDB      AL,#-2                ; [CPU_] |189| 
        MOVZ      AR6,AL                ; [CPU_] |189| 
...
;*** 583	-----------------------    if ( g_wBMSType == 1 ) goto g12;
	...
	.dwpsn	file "../APP/Interface_BMS.C",line 580,column 5,is_stmt
        INC       *-SP[2]               ; [CPU_] |580| 
	.dwpsn	file "../APP/Interface_BMS.C",line 581,column 5,is_stmt
        MOV       *-SP[12],AL           ; [CPU_] |581| 
        MOV       *-SP[19],AL           ; [CPU_] |581| 
...
$C$DW$230	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../APP/Interface_BMS.C",line 620,column 6,is_stmt
        MOVZ      AR3,AL                ; [CPU_] |620| 
	.dwpsn	file "../APP/Interface_BMS.C",line 622,column 6,is_stmt
        MOVB      AH,#10                ; [CPU_] |622| 
	.dwpsn	file "../APP/Interface_BMS.C",line 621,column 6,is_stmt
        MOV       *-SP[4],AL            ; [CPU_] |621| 
        MOV       *-SP[25],AL           ; [CPU_] |621| 
	.dwpsn	file "../APP/Interface_BMS.C",line 622,column 6,is_stmt
...
$C$DW$231	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../APP/Interface_BMS.C",line 622,column 6,is_stmt
        MOV       *-SP[6],AL            ; [CPU_] |622| 
        MOV       AH,*-SP[6]            ; [CPU_] 
        MOV       *-SP[24],AH           ; [CPU_] |622| 
	.dwpsn	file "../APP/Interface_BMS.C",line 623,column 6,is_stmt
...
;*** 593	-----------------------    if ( wTemp&0x80 ) goto g14;
	...
	.dwpsn	file "../APP/Interface_BMS.C",line 586,column 6,is_stmt
        MOV       *-SP[4],AR3           ; [CPU_] |586| 
        MOV       AL,*-SP[4]            ; [CPU_] 
        MOV       *-SP[25],AL           ; [CPU_] |586| 
	.dwpsn	file "../APP/Interface_BMS.C",line 585,column 6,is_stmt
        MOV       PL,AR3                ; [CPU_] |585| 
	.dwpsn	file "../APP/Interface_BMS.C",line 587,column 6,is_stmt
        MOV       AH,*+XAR4[1]          ; [CPU_] |587| 
        MOV       *-SP[6],AH            ; [CPU_] |587| 
        MOV       *-SP[24],AH           ; [CPU_] |587| 
	.dwpsn	file "../APP/Interface_BMS.C",line 590,column 6,is_stmt
...
;*** 654	-----------------------    if ( v$4 <= v$1 ) goto g23;
        MOV       AL,AR3                ; [CPU_] 
        MOV       *-SP[11],AR0          ; [CPU_] |611| 
        MOV       *-SP[26],AR0          ; [CPU_] |611| 
	.dwpsn	file "../APP/Interface_BMS.C",line 654,column 5,is_stmt
        CMP       AL,*-SP[3]            ; [CPU_] |654| 
...
;*** 656	-----------------------    v$31 = v$4;
	.dwpsn	file "../APP/Interface_BMS.C",line 656,column 6,is_stmt
        MOV       *-SP[22],AR3          ; [CPU_] |656| 
        MOV       *-SP[3],AR3           ; [CPU_] |656| 
...
;*** 660	-----------------------    v$30 = v$6;
	...
	.dwpsn	file "../APP/Interface_BMS.C",line 660,column 6,is_stmt
        MOV       *-SP[5],AR0           ; [CPU_] |660| 
        MOV       *-SP[21],AR0          ; [CPU_] |660| 
...
;*** 668	-----------------------    if ( (v$28 = v$2) <= 30000 ) goto g29;
	...
	.dwpsn	file "../APP/Interface_BMS.C",line 663,column 5,is_stmt
        CMP       AL,*-SP[7]            ; [CPU_] |663| 
	.dwpsn	file "../APP/Interface_BMS.C",line 665,column 6,is_stmt
        MOV       *-SP[20],AL,GT        ; [CPU_] |665| 
        MOV       *-SP[7],AL,GT         ; [CPU_] |665| 
        MOV       AL,*-SP[27]           ; [CPU_] 
...
;*** 684	-----------------------    v$20 = v$13;
	.dwpsn	file "../APP/Interface_BMS.C",line 684,column 6,is_stmt
        MOV       *-SP[9],AR4           ; [CPU_] |684| 
        MOV       AL,*-SP[9]            ; [CPU_] 
        MOV       *-SP[14],AL           ; [CPU_] |684| 
...
;*** 689	-----------------------    v$25 = v$19 = 0u;
	.dwpsn	file "../APP/Interface_BMS.C",line 689,column 6,is_stmt
        MOVB      AL,#0                 ; [CPU_] |689| 
        MOV       *-SP[13],AL           ; [CPU_] |689| 
        MOV       *-SP[18],AL           ; [CPU_] |689| 
...
$C$DW$234	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$234, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM3048 LV\IVEM3048 LV 28066\IVEM3048LV_28066_V300_20230525\IVEM3048LV\Debug\Interface_BMS.asm:$C$L19:1:1700724812")
...
$C$DW$300	.dwtag  DW_TAG_variable, DW_AT_name("uwBMSCmdAddrIDTemp")
	...
	.dwpsn	file "../APP/Interface_BMS.C",line 212,column 2,is_stmt
        MOVL      XAR1,#_g_strBMSComSts ; [CPU_U] |212| 
        MOVL      ACC,XAR1              ; [CPU_] |212| 
...
;*** 232	-----------------------    goto g11;
	.dwpsn	file "../APP/Interface_BMS.C",line 231,column 4,is_stmt
        MOV       AL,AR6                ; [CPU_] |231| 
        AND       AH,AR6,#0xffe3        ; [CPU_] |231| 
        ADDB      AL,#4                 ; [CPU_] |231| 
        ANDB      AL,#0x1c              ; [CPU_] |231| 
        OR        AL,AH                 ; [CPU_] |231| 
        MOV       *+XAR4[0],AL          ; [CPU_] |231| 
...
;*** 275	-----------------------    if ( !s_uwCycleNoOkChkEn ) goto g17;
	.dwpsn	file "../APP/Interface_BMS.C",line 273,column 5,is_stmt
        MOV       AH,@_s_uwComOKFlg$3   ; [CPU_] |273| 
	...
	.dwpsn	file "../APP/Interface_BMS.C",line 274,column 5,is_stmt
        ...
        ADDB      AL,#1                 ; [CPU_] 
	.dwpsn	file "../APP/Interface_BMS.C",line 273,column 5,is_stmt
        MOV       @_s_uwComOKFlgPre$4,AH ; [CPU_] |273| 
        MOVZ      AR4,AL                ; [CPU_] 
	.dwpsn	file "../APP/Interface_BMS.C",line 275,column 5,is_stmt
        MOV       AL,@_s_uwCycleNoOkChkEn$2 ; [CPU_] |275| 
...
;*** 289	-----------------------    if ( uwTemp != uwBMSCmdAddrIDTemp ) goto g23;
	.dwpsn	file "../APP/Interface_BMS.C",line 288,column 7,is_stmt
        ...
        LSL       AL,T                  ; [CPU_] |288| 
        OR        @_s_uwComOKFlg$3,AL   ; [CPU_] |288| 
        MOV       AL,AR5                ; [CPU_] 
...
;*** 284	-----------------------    if ( (L$1 = L$1-1) != (-1) ) goto g20;
	.dwpsn	file "../APP/Interface_BMS.C",line 284,column 33,is_stmt
        ADDB      XAR7,#1               ; [CPU_U] |284| 
        ADDB      XAR5,#1               ; [CPU_U] |284| 
...
;*** 302	-----------------------    if ( uwTemp <= 15u ) goto g27;
	...
	.dwpsn	file "../APP/Interface_BMS.C",line 301,column 6,is_stmt
        MOV       @_s_uwCycleNoOkChkID$1,AR4 ; [CPU_] |301| 
...
$C$DW$302	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$302, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM3048 LV\IVEM3048 LV 28066\IVEM3048LV_28066_V300_20230525\IVEM3048LV\Debug\Interface_BMS.asm:$C$L63:1:1700724812")
	.dwattr $C$DW$302, DW_AT_TI_begin_file("../APP/Interface_BMS.C")
	.dwattr $C$DW$302, DW_AT_TI_begin_line(0x10c)
	.dwattr $C$DW$302, DW_AT_TI_end_line(0x14a)
...
$C$DW$321	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$321, DW_AT_name("D:\Project Program\Backup Program\IVEM Program\IVEM3048 LV\IVEM3048 LV 28066\IVEM3048LV_28066_V300_20230525\IVEM3048LV\Debug\Interface_BMS.asm:$C$L66:2:1700724812")
	.dwattr $C$DW$321, DW_AT_TI_begin_file("../APP/Interface_BMS.C")
	.dwattr $C$DW$321, DW_AT_TI_begin_line(0x11c)
	.dwattr $C$DW$321, DW_AT_TI_end_line(0x126)
...
$C$DW$326	.dwtag  DW_TAG_subprogram, DW_AT_name("sBMSCommandProc")
	...
	.dwattr $C$DW$326, DW_AT_TI_begin_line(0x93)
...
$C$DW$336	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$326, DW_AT_TI_end_line(0xa2)
