...
//AFCI
extern void sSetEEAFCIEn(INT16S wValue);
extern INT16S swGetEEAFCIEn(void);
extern void sSetEEClearARCFault(INT16S wValue);
extern INT16S swGetEEClearARCFault(void);
