...
#define cFAULTRECORD_RD_REGION  0x09
#define cMCU_RD_REGION          0x0C
...
enum McuFlag_ID
{
	...
	MCUFlag_RemoteLoadOnSts,
    MCUFlag_RemoteFaultRestart,
    MCUFlag_AFCIStatus,
	McuFlag_AddrEnd,
...
struct EepromDataStruct1
{
	...
	INT16U	wEEReserved8;
	INT16U	wEEpromVer; 	
	INT16U	wEEPV2VoltAdj;
	INT16U	wEEPV2CurrAdj;
...
struct RealTimeDataStruct
{
	...
	INT16S wReserved8;    //0x116E
	INT16S wReserved9;    //0x116F
	INT16S wReserved10;   //0x1170
	INT16S wReserved11;   //0x1171
    ...
    INT16S wReserved16;                //0x1192
    INT16S wReserved17;                //0x1193
    ...
    INT16S wBatPowerConvertion;        //0x119F
...
struct McuFlagDataStruct
{
    INT16U uwSetPageFlag;
    INT16U uwRemoteLoadOnSts;
    INT16U uwRemoteFaultRestart;
    INT16U uwAFCIStatus;
};
...
#define cMcuFlagDataLen     sizeof(struct McuFlagDataStruct)
...
#define REALDATA_REG_BMS_BASE_LEN   9                   // 实时数据BMS寄存器长度
...
typedef union
{
    INT16U wBuff[cMcuFlagDataLen];
    struct McuFlagDataStruct Stru;
}UNMCUData;
...
extern void   sFaultListClr(void);
#endif /* MODBUS_H_ */
