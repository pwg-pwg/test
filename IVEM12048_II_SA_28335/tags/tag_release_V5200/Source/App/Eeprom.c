...
extern  INT16S g_wClearARCFault;
/******************************************************************************
...
{
    2200,                 //        INT16S    wEEOutputVolt;
    6000,                 //        INT16S    wEEOutputFreq;
...
//    if(swGetEEOutputVolt() != 2300)    
    ...
    //------------------------------------
    //AFCI
    if(swGetEEAFCIEn() < 0 || swGetEEAFCIEn() > 1)
    {
        sSetEEAFCIEn(cEepromDaultTable2.wEEAFCIEn);
        bUserChangeFlag = 1;
    }
    if(swGetEEClearARCFault() != 0)
    {
...
void sSetEEAFCIEn(INT16S wValue)
{
    OS_ENTER_CRITICAL();
    uEepromCfg2.EepromStructCfg2.wEEAFCIEn = wValue;
    OS_EXIT_CRITICAL();
}

INT16S swGetEEAFCIEn(void)
{
    return(uEepromCfg2.EepromStructCfg2.wEEAFCIEn);
}

void sSetEEClearARCFault(INT16S wValue)
{
    OS_ENTER_CRITICAL();
    g_wClearARCFault = wValue;
    OS_EXIT_CRITICAL();
}

INT16S swGetEEClearARCFault(void)
{
    return g_wClearARCFault;
}
