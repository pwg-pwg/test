...
//	g_wPv2CurrLimit = 187 * 8;
	...
	//========================
	//电压环8周期跑1次的参数
	g_strPVCtrlLoop.wBusVoltKp = 500;  //500/256=1.95
	g_strPVCtrlLoop.wBusVoltKi = 400;  //300/4096=0.073
	g_strPVCtrlLoop.wPVVoltKp = 80;   //120/256=0.468
	g_strPVCtrlLoop.wPVVoltKi = 120;   //20/4096=0.0048
	g_strPVCtrlLoop.wPVCurrKp = 50;//30;   //25/256=0.097
	g_strPVCtrlLoop.wPVCurrKi = 40;//20;   //20/4096=0.0048
