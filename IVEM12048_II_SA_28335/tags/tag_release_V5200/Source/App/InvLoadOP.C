...
extern INT16U g_uwSolarPower1Filter;
extern INT16U g_uwSolarPower2Filter;
...
//	uwStandardRefVolt += g_wLoadBusVoltComp;
	...
	else
	{
		...
		else
		{
            ...
            if(g_uwSolarPower1Filter < 750 && g_uwSolarPower2Filter < 750)
            {
                uwPV1KeepBusRefTemp = g_wDCDCBusVoltRef + cBusVoltReal8V;
            }
            else
            {
                uwPV1KeepBusRefTemp = g_wDCDCBusVoltRef + cBusVoltReal20V;
            }

            if(g_wPV1KeepBusVRef > uwPV1KeepBusRefTemp)
            {
                g_wPV1KeepBusVRef = g_wPV1KeepBusVRef - cBusVoltReal1V;
            }
            else if(g_wPV1KeepBusVRef < uwPV1KeepBusRefTemp)
            {
                g_wPV1KeepBusVRef = g_wPV1KeepBusVRef + cBusVoltReal1V;
            }
            else
            {
                g_wPV1KeepBusVRef = uwPV1KeepBusRefTemp;
            }
		}
	}
