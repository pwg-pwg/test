...
PAGE 0:    /* Program Memory */
   ...
   /* Flash sectors */																				//     16bit
   FLASH_BOOT		       : origin = 0x080000, length = 0x02000  				/* on-chip Flash */	// 8K  BootLoad 

   FLASH_BOOT_FLAG1		   : origin = 0x082002, length = 0x00001, fill = 0x4635 /* on-chip Flash */ // F5  boot状态标志
   //FLASH_BOOT_FLAG2		   : origin = 0x082003, length = 0x00001, fill = 0x504E	/* on-chip Flash */ // PN  boot状态标志 IVCM_PRO系列/IVCM_LV系列
   FLASH_BOOT_FLAG2		   : origin = 0x082003, length = 0x00001, fill = 0x434E	/* on-chip Flash */ // CN  boot状态标志 IVCM3224/IVCM2012
   //FLASH_BOOT_FLAG2		   : origin = 0x082003, length = 0x00001, fill = 0x444E	/* on-chip Flash */ // DN  boot状态标志	IVDM系列
   FLASH_FINV			   : origin = 0x082010, length = 0x17FF0  				/* on-chip Flash */	// 95K APP
   
   FLASH_RSVD 			   : origin = 0x09A000, length = 0x05FF0  				/* on-chip Flash */	// 24K 预留空间
...
UNION run = PIEVECTTABLE
{
  ...
  .bss:cio          : > RAMLS
   ...
   OSStack          : > RAMLS, ALIGN(8)
   DataBuff         : > RAMLS, ALIGN(8)
