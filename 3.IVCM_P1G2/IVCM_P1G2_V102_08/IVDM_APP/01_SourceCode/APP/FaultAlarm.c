...
void sFaultRstCntProc(INT16U uwFilter)
{
	...
	if(g_uwBatVoltOverCnt > 0)
	{
		if(g_uwBatVoltOverRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwDCDCCurrOverCnt > 0)
	{
		if(g_uwDCDCCurrOverRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwLLCLPTempOverCnt > 0)
	{
		if(g_uwLLCLPTempOverRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwLLCTraTempOverCnt > 0)
	{
		if(g_uwLLCTraTempOverRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwBusVoltOverCnt > 0)
	{
		if(g_uwBusVoltOverRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwBusHwVoltOverCnt > 0)
	{
		if(g_uwBusHwVoltOverRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwBusVoltUnderCnt > 0)
	{
		if(g_uwBusVoltUnderRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwBusSoftTimeOutCnt > 0)
	{
		if(g_uwBusSoftTimeOutRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwInvSoftTimeOutCnt > 0)
	{
		if(g_uwInvSoftTimeOutRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwInvVoltHighCnt > 0)
	{
		if(g_uwInvVoltHighRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwInvCurrOverCnt > 0)
	{
		if(g_uwInvCurrOverRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwInvHWCurrOverCnt > 0)
	{
		if(g_uwInvHWCurrOverRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwInvShortCnt > 0)
	{
		if(g_uwInvShortRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwInvCircirtTempOverCnt > 0)
	{
		if(g_uwInvCircirtTempOverRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwInvNtcConnectCnt > 0)
	{
		if(g_uwInvNtcConnectRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	{
		if(g_uwOverLoadRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwOutputVoltLowCnt > 0)
	{
		if(g_uwOutputVoltLowRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwOutputVoltHighCnt > 0)
	{
		if(g_uwOutputVoltHighRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwBatHNtcConnectCnt > 0)
	{
		if(g_uwBatHNtcConnectRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwBatLNtcConnectCnt > 0)
	{
		if(g_uwBatLNtcConnectRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwGridCurrOverCnt > 0)
	{
		if(g_uwGridCurrOverRstCnt > cTONEHOUR)		//60*60 = 1H
		{
	...
	if(g_uwOPCurrOverCnt > 0)
	{
		if(g_uwOPCurrOverRstCnt > cTONEHOUR)		//60*60 = 1H
		{
