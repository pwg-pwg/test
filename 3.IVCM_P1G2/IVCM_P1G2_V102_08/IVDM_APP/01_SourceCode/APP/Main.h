...
#define cCtrlV06					6	// 优化部分功能
#define cCtrlV07					7	// 
#define cCtrlV08					8	// 优化LLC软起方式
#define cCtrlV09					9
#define cCtrlV10					10
#define cCtrlV11					11
#define cCtrlV12					12
...
#define cCtrlHV01					1			// 修改逆变硬件过流保护49A->55A; 蜂鸣器加上拉做机型识别

// 功率板硬件版本
#define cMainHV00					0			// 初版
#define cMainHV01					1			// 逆变电流采样改到滤波前;LLC加RC，软起加快;LLC不触发硬件封波
