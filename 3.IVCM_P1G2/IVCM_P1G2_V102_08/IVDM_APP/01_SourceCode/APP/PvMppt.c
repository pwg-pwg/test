...
void	sBuckMpptMethod(void)
{
	...
	if(suwGetBatChgCtrlMpptPause() == true)
	{
		wCnt = 0;
...
INT16U	suwGetBatChgCtrlPvVoltLoopSel(void)
{
	return fBatChgCtrl.bits.bPvVoltLoopSel;
}

INT16U	suwGetBatChgCtrlMpptPause(void)
{
...
********************************************************************************/
void	suwSetBatChgCtrlPvVoltLoopSel(INT16U wData)
{
	fBatChgCtrl.bits.bPvVoltLoopSel = wData;
}

void	suwSetBatChgCtrlMpptPause(INT16U wData)
{
	fBatChgCtrl.bits.bMpptPause = wData;
}
