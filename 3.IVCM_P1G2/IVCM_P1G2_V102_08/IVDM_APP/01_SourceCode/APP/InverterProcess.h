...
struct	INV_PARAMETER_DATA_FEILD
{
	...
	INT16U uwBatBusOverVolt;		// 电池母线硬件过压保护
	INT16U uwControlHv;				// 控制板硬件版本
	INT16U uwMainHv;				// 功率板硬件版本
	...
	INT16S uwInvCurrLimit;			// 逆变控制器限流值
...
INVERTER_PROCESS INT16U	uwGetBatBusOverVoltEn(void);
INVERTER_PROCESS INT16U	uwGetControlHv(void);
INVERTER_PROCESS INT16U	uwGetMainHv(void);
...
INVERTER_PROCESS INT16S	uwGetInvCurrLimit(void);
...
INVERTER_PROCESS INT16U	uwGetModelInitialFinish(void);
