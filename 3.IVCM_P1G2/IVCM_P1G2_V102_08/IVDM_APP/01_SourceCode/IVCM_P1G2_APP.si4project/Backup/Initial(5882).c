...
//    CMPSSLITE_setDACValueHigh(CMPSSLITE3_BASE,3506U);	// 47A(硬件保护49A)     4700/(6600/2048)+2048
	CMPSSLITE_setDACValueHigh(CMPSSLITE3_BASE,3444U);	// 45A(硬件保护55.8A) 5000/(6600/2048)+2048
...
//    CMPSSLITE_setDACValueLow(CMPSSLITE3_BASE,590U);	// 47A
	CMPSSLITE_setDACValueLow(CMPSSLITE3_BASE,652U); // 45A
//	CMPSSLITE_setDACValueLow(CMPSSLITE3_BASE,496U);	// 50A 
    //
    //  Configures the digital filter of the high comparator.
    // 配置高比较器的数字滤波器。
