...
void	sInvParaUpdate(void)
{
	...
	else if(g_uwModelVar == cCtrlIVCM1612P1G2_LV)
	{
		...
		strInvParameterData.Field.uwBusVoltOver3 = cBusVoltReal290V;			// Bus过压3 中断级
		strInvParameterData.Field.uwBusVoltLow1 = cBusVoltReal150V;				// Bus低压1 
		strInvParameterData.Field.uwDcDcPWMPeriod = 1579; 						// DcDc频率 38K = 120MHz/2/(1579)
		strInvParameterData.Field.uwDcDcPWMDutySet = 158;						// DcDc占空比 (1579/2-158)/1579 = 40%
