...
/***************************设备信息********************************/
// 逆变器机型
#define cCtrlIVCM3224P1G2				0			// IVCM3224P1G2
#define cCtrlIVCM2012P1G2				1			// IVDM2012P1G2
...
#define cDspCtrlVersion				cCtrlV101	// 当前编译版本

/***************************************************************
#define cCtrlV00					0	// 20251024 V100 量产第一版本定版
#define cCtrlV01					1	// 20251027 V100 全部故障增加恢复条件 量产版本
#define cCtrlV02					2	// 20251028 V100 优化离网控制器，降低THDU 此版本控制器参数只用于认证
#define cCtrlV03					3	// 20251105 V100 增加电池低压时跳市电模式逻辑,增加离网切并网时间设置 量产版本
#define cCtrlV04					4	// 20251112 V100 增加输出过流和机型识别错误故障，计算市电电流改用视在功率，负载百分比采用视在功率计算
#define cCtrlV05					5	// 20251113 V100 优化LCD显示，主功率市电部分逻辑，PV温度风扇调速，市电电流功率计算优化等


***************************************************************/
// DSP软件子版本
#define cCtrlV00					0	// 20251127 V101 程序定版转正 
#define cCtrlV01					1	// 20251128 V101 增加电池母线过压硬件保护，添加馈电使能，优化功率折算等
#define cCtrlV02					2	// 20260104 V101 增加PV电流和逆变电流TZ保护
#define cCtrlV03					3	
#define cCtrlV04					4	
#define cCtrlV05					5
#define cCtrlV06					6
...
#define cCtrlV16					16
#define cCtrlV17					17
#define cCtrlV18					18	// 添加了新的并网电流控制器
#define cCtrlV19					19	// 20250721
#define cCtrlV20					20	// 20250721 添加BMS 485和CAN通信
#define cCtrlV21					21	// 20250729 初步优化主功率运行和切换逻辑
#define cCtrlV22					22	// 20250730 主逻辑修改，PV环路加负载补偿，AC限流加积分器补偿，并网带载的一个积分器补偿
#define cCtrlV23					23	// 20250801	修改调试寄存器，重新排版，优化主功率能量流向的一些控制和限制，包括AC限流的调整
#define cCtrlV24					24	// 20250806 优化了些并网控制逻辑的细节
#define cCtrlV25					25	// 20250807
#define cCtrlV26					26	// 20250808 故障告警的优化，PV改成告警
#define cCtrlV27					27	// 20250808
#define cCtrlV28					28	// 20250811
#define cCtrlV29					29	// 20250811
#define cCtrlV30					30	// 20250812
#define cCtrlV31					31	// 20250814
#define cCtrlV32					32	// 20250819
#define cCtrlV33					33	// 20250819
#define cCtrlV34					34	// 20250821 细节优化，增加PV辅源管脚和PV关辅源逻辑
#define cCtrlV35					35	// 20250821 锁相环偏置去掉，恢复软件锁相环应用
#define cCtrlV36					36	// 20250821 解决烧录完成后会报故障的问题
#define cCtrlV37					37	// 20250902 添加功率折算代码，设置项支持孤岛使能设置
#define cCtrlV38					38	// 20250902 部分代码合并，允许卖电，功能未添加完,优化测试部问题点，BMS通信协议修改
#define cCtrlV39					39	// 优化测试部问题中
#define cCtrlV40					40	// 增加三段式充电,风扇转速调节
#define cCtrlV41					41	// 20251024兼容IVCM2012P1G2和LV机型
