...
void	sInvParaUpdate(void)
{
	...
	else if(g_uwModelVar == cCtrlIVCM1612P1G2_LV)
	{
		...
		strInvParameterData.Field.uwDcDcPWMPeriod = 1714;//1579; 						// DcDc频率 38K = 120MHz/2/(1579)
		strInvParameterData.Field.uwDcDcPWMDutySet = 171;//158;						// DcDc占空比 (1579/2-158)/1579 = 40%
