/*** 
 * @Author: your name
 * @Date: 2024-05-24 20:47:38
 * @LastEditTime: 2024-06-01 16:11:15
 * @LastEditors: your name
 * @Description: 
 * @FilePath: \IVEM8048\MODULE\InverterModule\invertermodule.h
...
#define cPeriod50Hz			20000 //逆变周期  20ms.1ms放大1000倍
...
typedef	struct
{
				INT8U	IntConflict; // 方向  1: 逆变超前 0 逆变  //  也可能是数据过大, 进1处理
				INT16U	InvTd;// 逆变sin波和同步零点的时间间隔
}INV_TD;

extern INV_TD	*spGetInvTd(void);
extern INV_TD	*spGetInvSynTd(void);
extern INV_TD	*spGetInvGenTd(void);
