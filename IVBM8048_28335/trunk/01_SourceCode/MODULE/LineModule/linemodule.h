...
#define		cBitLineStatusVoltLoss		0x0001 //电压不在范围
#define		cBitLineStatusFreqLoss		0x0002 //频率不在范围
#define		cBitLineStatusWaveLoss		0x0004 //  意思相当于  线电压或者频率或者wav 有问题
#define		cBitLineStatusLineLoss		0x0008 // 找不到市电了
#define		cBitLineStatusPhaseLoss		0x0010 // 相位丢失
#define		cBitLineStatusFeedLoss		0x0020 // feed 相关存在问题
...
struct	STRLineSts{
		INT16U	RVoltLoss:1;	 //电压不在范围 ac范围 在APL模式下, 不在电压范围呢
		INT16U	SVoltLoss:1;	
		INT16U	TVoltLoss:1;
		INT16U	WaveLoss:1; // 零位丢失的话， 这位会至1   波形有问题
		INT16U	FreqLoss:1;// 零位丢失 这个会置1
		INT16U	PhaseLoss:1; // 相位错误 
		INT16U	RFreqLoss:1; //输入频率是否在范围
		INT16U	SFreqLoss:1; 
		INT16U	TFreqLoss:1;
		INT16U	AbNormal:1;
		INT16U	Reserved:6;
...
struct	STRLineFeedSts{
		INT16U	RFeedVoltLoss:1;	 //输入市电电压 //电压不在  264和150 之间, 判断 市电超过范围,
		INT16U	SFeedVoltLoss:1;	
		INT16U	TFeedVoltLoss:1;
		INT16U	RFeedFreqLoss:1; //输入频率是否在范围
...
#define		mGetGenWaveLossSts()			strfGen.WaveLoss
#define		mSetGenWaveLossSts(x)		strfGen.WaveLoss = x
