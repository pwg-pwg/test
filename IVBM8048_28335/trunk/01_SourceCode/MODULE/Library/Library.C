...
Parameters:
	...
	bFiler: Number of times to be confirmed
	pbCounter: pointer of Counter register
	?? wCompareData > wHighLever ?????  pbCounter ,?? bFilter ???true
Internal Variable:
...
Return Value:
	...
	false:	0
*******************************************************************************/
// wCompareData ??  wHighLever   ??pbCounter >    bFilter
...
Parameters:
	...
	pbCounter: pointer of Counter register
Internal Variable:
 ?? wCompareData < wLowLever ?????  pbCounter ,?? bFilter ???true,
Return Value:
	true:	1 ( The data to be compared is over level )
	false:	0
*******************************************************************************/
//  wCompareData <  wLowLever  ??  pbCounter > bFilter
