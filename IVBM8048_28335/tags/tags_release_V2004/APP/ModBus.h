...
enum EE_E2_ID
{
	...
	E2_BMSDisComWork,		//0x4A    Never Use
	...
	E2_GenPowerMax,		//0x63
	E2_GenChargeEn,		//0x64
	E2_OutPowerMax_OP2,	//0x65
	E2_DSPRDCDCCurrAdj,	//0x66
	E2_DSPRDCDCCurrAvgAdj,		//0x67
	E2_EEPowerConvertionType,	//0x68
	E2_Flag,			//0x69
	E2_CheckSum,		//0x6A
	E2_AddrEnd,
...
enum ATE_ID
{
	...
	// ATE_DcdcCurrAdj0,	//0x41
	// ATE_DcdcCurrAdj1,	//0x42
	// ATE_DcdcCurrAdj2,	//0x43
	// ATE_DcdcCurrAvgAdj0,	//0x44
	// ATE_DcdcCurrAvgAdj1,	//0x45
	// ATE_DcdcCurrAvgAdj2,	//0x46
	ATE_AddrEnd,
...
struct EepromDataStruct2//读取Eeprom的数值
{
	INT16U	wEEBatVoltUnder;	//0X2100+E1_LEN
	INT16U	wEEReserved1; 
	INT16U	wEEReserved2;	   
	INT16U	wEEBatCVVolt; 		   
	...
	INT16U  wGenPowerMax;
	INT16U  wGenChargeEn;
	INT16U  wOutPowerMax_OP2;
	INT16U	wDcdcCurrAdj;
	INT16U  wDcdcCurrAvgAdj;
	INT16U	wPowerConvertionType;
...
struct RealTimeDataStruct
{
	...
	// INT32S wRLineDCI;				//0x111A
	// INT32S wRLineWatt;				//0x111B
	// INT32S wRLineVA;				//0x111C
	// INT32S wRLinePF;				//0x111D
	...
	INT16S wLoadPowerConvertionL;   //0x1160
	...
	INT16U wReserved2;    		//0x1169
	INT16S wReserved3;    		//0x116A
	INT16S wReserved4;    		//0x116B
	INT16S wReserved5;    		//0x116C
	INT16S wGridGenType;    		//0x116D
	INT16S wLineCurrTConvertion;    //0x116E 
	INT16S wLoadCurrTConvertion;    //0x116F
	INT16S wBatCurrTConvertion;   //0x1170
	INT16S wPV1CurrTConvertion;   //0x1171
	INT16S wPV2CurrTConvertion;   //0x1172
	INT16S wGenCurrTConvertion;   //0x1173
	INT16S wLinePowerTConvertionH;   //0x1174
	INT16S wLinePowerTConvertionL;   //0x1175
	INT16S wLoadPowerTConvertionH;   //0x1176
	INT16S wLoadPowerTConvertionL;   //0x1177
	INT16S wBatPowerTConvertion;   //0x1178
	INT16S wPV1PowerTConvertion;   //0x1179
	INT16S wPV2PowerTConvertion;   //0x117A
	INT16S wGenPowerTConvertionH;   //0x117B
	INT16S wGenPowerTConvertionL;   //0x117C
	INT16S wReservedCnt[29];
};
...
#define REALDATA_REG_BMS_BASE_LEN	9				// [0X1130-0X1138]实时数据BMS寄存器长度

#define SETTING_REG_BASE_ADDR	0x2100				// EEPROM数据寄存器起始地址  设置寄存器
#define SETTING_REG_BASE_LEN	E1_Len+E2_Len		// EEPROM数据寄存器长度

#define MCUFLAG_REG_BASE_ADDR	0x2800 			    // 从MCU传过来的标志位
...
#define FAULT_LOG_ADDR			0x8100					//FAULT LOG
#define FAULT_LOG_LEN			(cFault_log_len*cFault_log_num/2)		
