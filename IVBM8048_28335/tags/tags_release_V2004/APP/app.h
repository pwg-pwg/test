...
typedef union
{
	...
	struct
	{
		...
		INT16U	uwSysSCCOK:1; //太阳能 没有问题true
		INT16U	uwOPVoltDrtErr:5;
		INT16U	uwBatPowerDown:1;
		INT16U	uwInputPhaseLoss:1;   //市电缺相
	}BIT;
}UNIInputStatus;
...
extern UNIInputStatus2 g_uniInputStatus2;
...
typedef union
{
	...
	struct
	{
		...
		INT16U	uwSystemMainRlyOn:1; //总的来说,只要输出模式 并网处于单独模式 或1模式 就会是1
...
#define mBMSBatSOC				g_strSysBMSCtrlInfo.uniBMSCutVoltSOC.BIT.uwBMSSOC //电池的标志应该是
#define mBMSFaultCode			g_strSysBMSCtrlInfo.uniBMSInfo.BIT.uwBMSFaultCode
#define fBMSConnectFlg			g_strSysBMSCtrlInfo.uniBMSInfo.BIT.uwBMSConnectFlg //BMS 通信连接 flag
#define fBMSStopChargeFlg		g_strSysBMSCtrlInfo.uniBMSInfo.BIT.uwBMSStopChgFlg  /// 电池停止充电
#define fBMSStopDischgFlg		g_strSysBMSCtrlInfo.uniBMSInfo.BIT.uwBMSStopDischgFlg // 停止放电
#define fBMSForceChgFlg			g_strSysBMSCtrlInfo.uniBMSInfo.BIT.uwBMSForceChgFlg // 强制充电
...
typedef union
{
	...
	struct
	{
		INT16U	uwLoadConnectOK:1; // 负载链接
		INT16U	uwBatPowerDir:2; //电池功率方向  1充电 2放电
		INT16U	uwDCACPowerDir:2; //DC AC方向   2:DC->AC 电池 供电  0:  AC->DC
		INT16U	uwGridPowerDir:2;// 0：无市电  1:市电给用户供电  2：充电
		INT16U	uwSCC1OK:1; // 太阳能1  1:代表正常
		INT16U	uwSCC1Chg:1;// 太阳能 boost 启动, 
		INT16U	uwSCC2OK:1;// 太阳能2 1:代表正常 
		INT16U	uwSCC2Chg:1; // 太阳能 boost 启动, 
...
#define cOPRlyDelayTime						80//50
#define	cGridRlyDelayTime					30

#define	cDelay30ms		300
...
#define eInvLoadOPSinZero					2 // 逆变sin波的0点
...
#define eParaSYNLineLoss					12 // 并网零点同步信号丢失
...
extern INT16S TestCnt;
extern INT16S TestMode;
extern INT16S TestMode1;
extern INT16S TestMode2;
extern INT16S TestMode3;
