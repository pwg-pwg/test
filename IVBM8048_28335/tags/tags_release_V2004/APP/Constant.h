...
#define cModel3024	0//3
#define cModel5048	1//5
#define cModel8048      2//8
#define cModel10048     3//8
#define cModel12048     4//8
...
#define cModbusSubType				0x440E          //机器子类      IVBM
#define cBatSerialPcs				4
...
#define cGen_PowerMaxSet	500
#define cGen_CurrMax    	320

#define cDSP_Version	        4

#elif mModel == cModel10048
#define cTransformerRatio			7
#define cACOPRateVolt				2300
#define cInvVAMax					10000	//8000
#define cInvWattMax					10000	//8000
#define cDerateWattMax				10000	//8000
#define cDerateWattMin				8000	//cDerateWattMax*0.8
#define cDerateWattRate				666		//(cDerateWattMax-cDerateWattMin)/(45V-42V)
#define	cPVMaxPower					11000	//10K
#define cPVCurrLimit				2000	//20A PV1.I=PV2.I=20A		8000W = 250V*32A
#define cModbusSubType				0x4412          //机器子类      IVBM
#define cBatSerialPcs				4
#define cBatDischgCurrMax			3000//2850	//285A
#define	cDCDCCntlCurrntLimit		        4000//3600	//45*80 = 3600 45A
#define cInt_InvCurrPrtPnt			cInv120A//cInv100A
...
#define cCntl_PVMPPTKp				16
#define cCntl_PVBSTVmoLimit			2500	//(PV1.I+5A)=(PV2.I+5A) = 20A+5A
#define	cCntl_InvCurrLimit			2880//2880	//90A = 90*32 = 2880
#define	cCntl_FPCurrLimit			6504	//46A*1.414*100 = 6504
#define cCntl_InvVoltKv				48
#define cCntl_InvVoltKi				300
#define cCntl_DCDCBusKpFast			1200
#define cCntl_DCDCBusKiFast			50
...
#define cCntl_DCDCBusKiSlow			5
#define cCntl_FBKCurrentForward		20
#define	cSettingMaxChgCurr			200		//150A
#define	cSettingMaxACChgCurr		200		//150A
#define cLiBatActChgCurr			50		//5A
#define cMaxACInputCurr				650		//53A    //配套市电空开63A，留10A裕量
#define cGridRateCurr 				540		//530/1.2
#define cPVNumber					2
#define cInvChgFeedForward          205     //0.8*256
#define cInvDisChgFeedForward       231     //0.9*256
#define cBias_DCDCCurrentSampleSet	9
#define cGen_PowerMaxSet	600
#define cGen_CurrMax    	320

#define cDSP_Version	        3

#elif mModel == cModel12048
#define cTransformerRatio			7
#define cACOPRateVolt				2300
#define cInvVAMax					12000	//8000
#define cInvWattMax					12000	//8000
#define cDerateWattMax				12000	//8000
#define cDerateWattMin				9600	//cDerateWattMax*0.8
#define cDerateWattRate				800		//(cDerateWattMax-cDerateWattMin)/(45V-42V)
#define	cPVMaxPower					14400	//10K
#define cPVCurrLimit				2000	//20A PV1.I=PV2.I=20A		8000W = 250V*32A
#define cModbusSubType				0x4412          //机器子类      IVBM
#define cBatSerialPcs				4
#define cBatDischgCurrMax			3500	//285A
#define	cDCDCCntlCurrntLimit		4800	//45*80 = 3600 45A
#define cInt_InvCurrPrtPnt			cInv160A//逆变软件过流
#define cInt_DCDCCurrPrtPnt			cDCDC75A
#define cInt_PVCurrPrtPnt			cSolarCurr30A//PV1.I + 10A = 20A+10A = 30A
#define cBias_InvSampleSet			0
#define cCntl_PVBUSKp				100
#define cCntl_PVMPPTKp				16
#define cCntl_PVBSTVmoLimit			2500	//(PV1.I+5A)=(PV2.I+5A) = 20A+5A
#define	cCntl_InvCurrLimit			2880	//90A = 90*32 = 2880
#define	cCntl_FPCurrLimit			7777	//55A*1.414*100
#define cCntl_InvVoltKv				48
#define cCntl_InvVoltKi				300
#define cCntl_DCDCBusKpFast			1200
#define cCntl_DCDCBusKiFast			50
...
#define cCntl_DCDCBusKiSlow			5
#define cCntl_FBKCurrentForward		20
#define	cSettingMaxChgCurr			240		//150A
#define	cSettingMaxACChgCurr		240		//150A
#define cLiBatActChgCurr			50		//5A
#define cMaxACInputCurr				650		//53A    //配套市电空开63A，留10A裕量
#define cGridRateCurr 				540		//530/1.2
#define cPVNumber					2
...
#define cInvDisChgFeedForward       231     //0.9*256
#define cBias_DCDCCurrentSampleSet	9
#define cGen_PowerMaxSet	720
#define cGen_CurrMax    	650
#define cDSP_Version	        1
...
#define cDSPVersion		((1000*mModel) + cDSP_Version)  
//#define	cTestCmd		                   
...
#define cDCDCConvertDuty002			38		//2%duty  
#define cDCDCConvertDuty0001		1		//0.1%duty  
#define cDCDCConvertDutySoftStep	50		//2s	1cnt per 52
...
#define cLLCBatDutySoftStart		cDCDCConvertDuty0001
#define cDCDCConvertDutyLimit1		cDCDCConvertDuty010
#define cDCDCConvertDutyLimit2		cDCDCConvertDuty030

#define cINVIMOLimit		6000
...
#define cFBWait				0 // 等待
#define cFBInvOpenLoop		1 // //这个模式实在调试模式中使用, 控制逆变的PWM
#define cFBInvCtrlVolt		2//逆 逆变状态
#define cFBInvCtrlBus		3 //bus线 整流

// dcdc 工作状态  
#define cDCDCWait				0  // 等待
#define cDCDCSoft				1 // 缓一下状态
#define cDCDCWork				2 // 正常工作状态
#define cDCDCBuckSoft			3          // buck 工作时, 软处理一下
#define cDCDCBoostSoft			4 // 开2 2%

#define cPowerOnMode			0 //初次上电
#define cStandbyMode			1 //等待模式， 等待某种条件满足，然后转到别的模式
#define cBypassMode				2 //旁路模式  市电直接接入给用户供电
#define cBatteryMode			3  //电池模式，电池逆变供电
#define cFaultMode				4 //错误
#define cLineMode				5 //社会供电下， 逆变供电
#define cChgMode				6  //和充电模式
//below macro are used in Line mode
#define cLineLoss				10 //市电丢失

//警告码  uniWarningCode

//故障码
#define cBusVoltOver			1 //  bus线 过压 超过510v
#define cBusVoltUnder			2 // bus线 低压, 防止通过bus 向PV 灌压
#define cBusSoftTimeOut			3
#define cInvSoftTimeOut			4
#define cInvCurrOver			5  // 逆变 过流故障
#define cInvHWCurrOver			6 // 逆变硬件 过流故障
#define cInvVoltLow				7
#define cInvVoltHigh			8 //逆变输出超压
#define cInvShort				9 // 逆变短路
#define cOverLoad				10
#define cBatVoltOver			11 // 电池超压 超过62V
#define cDCDCCurrOver			12  // dcdc 过流
#define cPVVoltOver				13  // pv电压过高 故障码
#define cPVShort				14 // 故障码 14  太阳能短路
#define cSolarPowerAbnormal		15
#define cSolarInputCurrOver		16 // 太阳能输入过流
#define cFanLock				17 // 风扇堵转 
#define cPVCircirtTempOver		18   // 太阳能 端超温
#define cConvertLCircirtTempOver 19// llc 温度故障
#define cInvCircirtTempOver		20  // 逆变温度故障
#define cInnelTempOver			21
#define cDCDCCTSenserFault		22
#define cDCDCAvgCTSenserFault	23
#define cINVCTSenserFault		24
#define cOPCTSenserFault		25 // 传感器故障, 需要返厂
#define cShareCTSenserFault		26
#define cInputOutputReverse		27
#define cSigPalInstallFault		28
#define cDCDCSoftTimeOut		29 // dcdc 启动超时
#define cBootloadFail			30
#define cConvertHCircirtTempOver 31  // llc 高压温度故障
#define cLLCTXTempOver 			32
#define cLLCCurrOver 			33  // llc 过流
#define cDCDCHWCurrOver 		34 //没有34 这一想
#define cBUSHWVoltOver 			35 // 说明书没有这一项
...
#define cParaOPSettingDiff		46 /// 输出设置有差异
#define cGenCTSenserFault               47 
#define cACVoltOverFault                48
...
************************************************************************************/
#define	cNewMode			0  // 新 模式, 不知道自己处于什么角色
#define	cSlaveMode			1
#define	cMasterMode			2 //主模式  处于单机模式, 模式说 并网模式,但是是主机
...
#define	cConvertVoltRatio		1567//1508			//603.0VMax  	2^10 * 10		0.1V << 10	0Vbias
#define	cILLCAvgCurrRatio		173				//69.26AMax   	2^10 * 10		0.1A << 10	1.5Vbias
//**********GEN************//
#define cGenVoltRatio               2002//2113                     //2002
#define cGenCurrRatio               649     //640            //80A

//Q5表示的是其中一种定点数的表示方式   做一个定点显示
...
#define	cInv70A				1020//(INT16S)((((INT32S)7000 << 10) /cInvCurrRatio + 5) /10)
#define	cInv100A			1457//(INT16S)((((INT32S)10000 << 10) /cInvCurrRatio + 5) /10)
#define	cInv120A			1748//(INT16S)((((INT32S)12000 << 10) /cInvCurrRatio + 5) /10)
#define	cInv130A			1894//(INT16S)((((INT32S)12000 << 10) /cInvCurrRatio + 5) /10)
//cDCDCCurrRatio 469
#define	cDCDC20A			437//(INT16S)((((INT32S)2000 << 10) /cDCDCCurrRatio + 5) /10)
#define	cDCDC25A			546//(INT16S)((((INT32S)2500 << 10) /cDCDCCurrRatio + 5) /10)
#define	cDCDC30A			656//(INT16S)((((INT32S)3000 << 10) /cDCDCCurrRatio + 5) /10)
#define	cDCDC35A			765//(INT16S)((((INT32S)3500 << 10) /cDCDCCurrRatio + 5) /10)
#define	cDCDC50A			1092//(INT16S)((((INT32S)5000 << 10) /cDCDCCurrRatio + 5) /10)
#define	cDCDC60A			1310//(INT16S)((((INT32S)5000 << 10) /cDCDCCurrRatio + 5) /10)
//cBUSVoltRatio 1567
#define	cBusVolt10V			65//(INT16S)((((INT32S)1000 << 10) /cBUSVoltRatio + 5) /10)
#define	cBusVolt50V			327//(INT16S)((((INT32S)5000 << 10) /cBUSVoltRatio + 5) /10)
#define	cBusVolt280V		1830//(INT16S)((((INT32S)28000 << 10) /cBUSVoltRatio + 5) /10)
...
#define	cInv70A				1020//(INT16S)((((INT32S)7000 << 10) /cInvCurrRatio + 5) /10)
#define	cInv100A			1457//(INT16S)((((INT32S)10000 << 10) /cInvCurrRatio + 5) /10)
#define	cInv160A			2331//(INT16S)((((INT32S)10000 << 10) /cInvCurrRatio + 5) /10)
//cDCDCCurrRatio 469
#define	cDCDC20A			437//(INT16S)((((INT32S)2000 << 10) /cDCDCCurrRatio + 5) /10)
#define	cDCDC25A			546//(INT16S)((((INT32S)2500 << 10) /cDCDCCurrRatio + 5) /10)
#define	cDCDC30A			656//(INT16S)((((INT32S)3000 << 10) /cDCDCCurrRatio + 5) /10)
...
#define	cDCDC50A			1092//(INT16S)((((INT32S)5000 << 10) /cDCDCCurrRatio + 5) /10)
#define	cDCDC60A			1310//(INT16S)((((INT32S)5000 << 10) /cDCDCCurrRatio + 5) /10)
#define	cDCDC75A			1638//(INT16S)((((INT32S)5000 << 10) /cDCDCCurrRatio + 5) /10)
//cBUSVoltRatio 1567
#define	cBusVolt10V			65//(INT16S)((((INT32S)1000 << 10) /cBUSVoltRatio + 5) /10)
#define	cBusVolt50V			327//(INT16S)((((INT32S)5000 << 10) /cBUSVoltRatio + 5) /10)
#define	cBusVolt280V		1830//(INT16S)((((INT32S)28000 << 10) /cBUSVoltRatio + 5) /10)
...
#define cBatChgCVStage			1    // cv 充电阶段  恒电压充电 , 快速充电
#define cBatChgFloatStage		2   // float 充电阶段  恒电流充电 
...
#define cOutputUtilityFirst	                0 // 输出优先级
#define cOutputSolarFirst	                1 //太阳能优先级 感觉就没有用到过,可能太阳能 和电池要一起来
#define cOutputSolarBatUtility              2

#define cDCDCChgDischgDis					0x00
#define cDCDCChgEnable						0x01 //充电使能
#define cDCDCDischgEnable					0x02 //放电使能

#define	cLineModeSysNormal					0
#define cLineModeSysRstRdy					1 //系统需要重启
#define cLineModeSysAbnormal				2

#define cBatType_AGM						0// AGM电池
#define cBatType_FLD						1 // 浮动充电池
#define cBatType_USER						2 // 用户电池
#define cBatType_LIB						3 // 锂电池
