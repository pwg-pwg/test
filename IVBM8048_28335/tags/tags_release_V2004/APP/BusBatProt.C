...
extern void sInvPowerConversionCal(void);
...
void sBusBatProtectTask(void)
{
	...
	while(1)
	{
		...
		if(event&(1<<eBusBatProtTimer))			
		{
			...
			sBusOverChk(cBusVoltReal470V, 50, cBusVoltReal500V, 5);	//bus线 电压, 过压检测
...
//	static INT16U s_uwInnelTempWRChkCnt = 0;
	...
	static INT16U s_uwInFanOverTCnt = 0;
