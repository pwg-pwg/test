...
extern	INT16U	g_wBMSDisConnectNum;
...
void sWarningUpdate(void)
{
	...
	if(!fBMSConnectFlg && g_uwBatType == cBatSocType && g_uwWorkMode > cPowerOnMode && g_wBMSDisConnectNum > 3)
	{
...
void sGridOverVOutCheck(void)
{
	if((g_uwWorkMode == cLineMode) /* || (g_uwWorkMode == cBypassMode) */)
	{
		if((((g_uwRLineVolt > 2700) && subGetLineVoltLossStatus()) || ((g_uwRGenVolt > 2700) && subGetGenVoltLossStatus())) && (g_uwRInvCurr > 70))
		{
			// wGridOverVOut = 10;	
		}
	}
