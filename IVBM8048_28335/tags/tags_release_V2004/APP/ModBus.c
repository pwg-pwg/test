...
extern INT32S  g_wLinePowerTConversion;
extern INT32S  g_wLoadPowerTConversion;
extern INT16S  g_wBatPowerTConversion;
extern INT16S  g_wPV1PowerTConversion;
extern INT16S  g_wPV2PowerTConversion;
extern INT32S  g_wGenPowerTConversion;
...
//				}
		...
		case E2_ThresholdSOCMin_OP2:
			...
			break;
		/************25/10/24/LMZ***************/
		case E2_BMSDisComWork:
			if(WrData < 2)
			{
				sSetBMSConnectEN(WrData);
				OSEventSend(cPrioInterface, eI2CEEpromUserSave);
			}
			else
			{
		...
		break;
		case E2_GridGenType:
			if(WrData != swGetEEGridGenType() && WrData < 2 && (g_uwWorkMode != cBypassMode && g_uwWorkMode != cLineMode))
			{
		...
		break;
		case E2_GenPowerMax:
			if(WrData <= cGen_PowerMaxSet)//if((100 <= WrData) && (WrData <= 12000))if(WrData <= 12000)
			{
		...
		break;
		/*************************/
		// case E2_DSPRDCDCCurrAdj:
		// 	if((1548 <= WrData) && (WrData <= 2548))
		// 	{
		// 		if(WrData != swGetEEDSPRDCDCCurrAdj())
		// 		{
		// 			sSetEEDSPRDCDCCurrAdj(WrData);
		// 			OSEventSend(cPrioInterface, eI2CEEpromFacSave);
		// 		}
		// 	}
		// 	else
		...
		// 	}
		// break;
		// case E2_DSPRDCDCCurrAvgAdj:
		// 	if((1548 <= WrData) && (WrData <= 2548))
		// 	{
		// 		if(WrData != swGetEEDSPRDCDCCurrAvgAdj())
		// 		{
		// 			sSetEEDSPRDCDCCurrAvgAdj(WrData);
		// 			OSEventSend(cPrioInterface, eI2CEEpromFacSave);
		// 		}
		// 	}
		// 	else
		...
		// 	}
		// break;
		case E2_EEPowerConvertionType:
			if(WrData < 2)
			{
				sSetPowerConvertionType(WrData);
				OSEventSend(cPrioInterface, eI2CEEpromUserSave);
			}
			else
			{
...
//			}
		...
		// 	if(WrData == cEnable)
		// 	{
		// 		if(swGetEEDSPRDCDCCurrAdj() != 2048)
		// 		{
		...
		// 	wTemp1 = (INT16S)WrData - (INT16S)g_wDCDCCurr;
		// 	if(   (swGetEEDSPRDCDCCurrAdj() == 2048) 
		// 	   && abs(wTemp1) <= 150 && ((INT16S)WrData >= 300) )
		// 	{
		// 		wTemp1 = (INT16S)g_wDCDCCurr;
		// 		wTemp2 = ((INT32S)WrData * 2048 + (wTemp1 >> 1)) / wTemp1;
		// 		if((wTemp2 >= 1548) && (wTemp2 <= 2548))
		// 		{
		// 			sSetEEDSPRDCDCCurrAdj(wTemp2);
		// 			OSEventSend(cPrioInterface, eI2CEEpromFacSave);
		// 		}
		// 		else
		// 		{
		...
		// 	if((-8 <= (INT16S)WrData) && ((INT16S)WrData <= 8))
		// 	{
		// 		sSetEEDSPRDCDCCurrAdj((INT16S)swGetEEDSPRDCDCCurrAdj() + (INT16S)WrData);
		// 		if(swGetEEDSPRDCDCCurrAdj() > 2548)
		// 		{
		// 			sSetEEDSPRDCDCCurrAdj(2524);
		// 		}
		// 		else if(swGetEEDSPRDCDCCurrAdj() < 1548)
		// 		{
		// 			sSetEEDSPRDCDCCurrAdj(1548);
		// 		}
		// 		OSEventSend(cPrioInterface, eI2CEEpromFacSave);
		// 	}
		// 	else
		...
		// 	}
		// break;
		// case ATE_DcdcCurrAvgAdj0:
		// 	if(WrData == cEnable)
		// 	{
		// 		if(swGetEEDSPRDCDCCurrAvgAdj() != 2048)
		// 		{
		...
		// 	}
		// break;
		// case ATE_DcdcCurrAvgAdj1:
		// 	wTemp1 = (INT16S)WrData - (INT16S)g_wDCDCCurrAvg;
		// 	if(   (swGetEEDSPRDCDCCurrAvgAdj() == 2048) 
		// 	   && abs(wTemp1) <= 150 && ((INT16S)WrData >= 300) )
		// 	{
		// 		wTemp1 = (INT16S)g_wDCDCCurrAvg;
		// 		wTemp2 = ((INT32S)WrData * 2048 + (wTemp1 >> 1)) / wTemp1;
		// 		if((wTemp2 >= 1548) && (wTemp2 <= 2548))
		// 		{
		// 			sSetEEDSPRDCDCCurrAvgAdj(wTemp2);
		// 			OSEventSend(cPrioInterface, eI2CEEpromFacSave);
		// 		}
		// 		else
		// 		{
		...
		// 	}
		// break;
		// case ATE_DcdcCurrAvgAdj2:
		// 	if((-8 <= (INT16S)WrData) && ((INT16S)WrData <= 8))
		// 	{
		// 		sSetEEDSPRDCDCCurrAvgAdj((INT16S)swGetEEDSPRDCDCCurrAvgAdj() + (INT16S)WrData);
		// 		if(swGetEEDSPRDCDCCurrAvgAdj() > 2548)
		// 		{
		// 			sSetEEDSPRDCDCCurrAvgAdj(2524);
		// 		}
		// 		else if(swGetEEDSPRDCDCCurrAvgAdj() < 1548)
		// 		{
		// 			sSetEEDSPRDCDCCurrAvgAdj(1548);
		// 		}
		// 		OSEventSend(cPrioInterface, eI2CEEpromFacSave);
		// 	}
		// 	else
...
void sRealTimeDataUpdate(void)
{
	...
	uRealTimeData.Stru.wNegBusVolt = g_uwConvertVoltAvg;
...
*/
	...
	{
		uRealTimeData.Stru.wGenVolt = 0;
		uRealTimeData.Stru.wGenCurr = 0;
		uRealTimeData.Stru.wGenFreq = 0;
		uRealTimeData.Stru.wGenPower = 0;	
	}
	else
	{
	...
	uRealTimeData.Stru.wReserved2 = swGet1();
	uRealTimeData.Stru.wReserved3 = swGet2();
	uRealTimeData.Stru.wReserved4 = swGet3();
	uRealTimeData.Stru.wReserved5 = swGet4();
	...
	if(g_uwRInvVolt == 0)
	{
		uRealTimeData.Stru.wLineCurrTConvertion = 0;
	}
	else
	{
		uRealTimeData.Stru.wLineCurrTConvertion = (INT16S)((INT32S)g_wLinePowerTConversion * 100 / g_uwRLineVolt);
	}
	if(g_uwROPVolt == 0)
	{
		uRealTimeData.Stru.wLoadCurrTConvertion = 0;
	}
	else
	{
		uRealTimeData.Stru.wLoadCurrTConvertion = (INT16S)((INT32S)g_wLoadPowerTConversion * 100 / g_uwROPVolt);
	}
	if(g_wBatVoltAvg10 == 0)
	{
		uRealTimeData.Stru.wBatCurrTConvertion = 0;
	}
	else
	{
		uRealTimeData.Stru.wBatCurrTConvertion = (INT16S)((INT32S)g_wBatPowerTConversion * 100 / g_wBatVoltAvg10);
	}
	if(g_uwSolarVolt1Avg == 0)
	{
		uRealTimeData.Stru.wPV1CurrTConvertion = 0;
	}
	else
	{
		uRealTimeData.Stru.wPV1CurrTConvertion = (INT16S)((INT32S)g_wPV1PowerTConversion * 100 / g_uwSolarVolt1Avg);
	}
	if(g_uwSolarVolt2Avg == 0)
	{
		uRealTimeData.Stru.wPV2CurrTConvertion = 0;
	}
	else
	{
		uRealTimeData.Stru.wPV2CurrTConvertion = (INT16S)((INT32S)g_wPV2PowerTConversion * 100 / g_uwSolarVolt2Avg);
	}
	if(g_uwRGenVolt == 0)
	{
		uRealTimeData.Stru.wGenCurrTConvertion = 0;
	}
	else
	{
		uRealTimeData.Stru.wGenCurrTConvertion = (INT16S)((INT32S)g_wGenPowerTConversion * 100 / g_uwRGenVolt);
	}

	uRealTimeData.Stru.wLinePowerTConvertionH = (INT16S)((g_wLinePowerTConversion >> 16) & 0xFFFF);
	uRealTimeData.Stru.wLinePowerTConvertionL = (INT16S)(g_wLinePowerTConversion  & 0xFFFF);
	uRealTimeData.Stru.wLoadPowerTConvertionH = (INT16S)((g_wLoadPowerTConversion >> 16) & 0xFFFF);
	uRealTimeData.Stru.wLoadPowerTConvertionL = (INT16S)(g_wLoadPowerTConversion  & 0xFFFF);
	uRealTimeData.Stru.wBatPowerTConvertion = g_wBatPowerTConversion;
	uRealTimeData.Stru.wPV1PowerTConvertion = g_wPV1PowerTConversion;
	uRealTimeData.Stru.wPV2PowerTConvertion = g_wPV2PowerTConversion;
	uRealTimeData.Stru.wGenPowerTConvertionH = (INT16S)((g_wGenPowerTConversion >> 16) & 0xFFFF);
	uRealTimeData.Stru.wGenPowerTConvertionL = (INT16S)(g_wGenPowerTConversion  & 0xFFFF);
	/********************************************/
...
void sEESettingUpdate(void)
{
	...
	// strEepromDataStruct2.wEEDcdcCurrAdj = swGetEEDSPRDCDCCurrAdj();
	// strEepromDataStruct2.wEEDcdcCurrAvgAdj = swGetEEDSPRDCDCCurrAvgAdj();
	strEepromDataStruct2.wPowerConvertionType = swGetPowerConvertionType();
	strEepromDataStruct2.wBMSDisComWork = swGetBMSConnectEN();
}
