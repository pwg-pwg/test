...
struct EepromStruct2
{
	...
	INT16U  wEEPowerConvertionType;
	INT16U	wEEBMSDisComWork;
	INT16U  wFlag;
	INT16U  wEECheckSum2;
};
...
extern void sSetEEDSPRDCDCCurrAdj(INT16S wValue);
extern INT16S swGetEEDSPRDCDCCurrAdj(void);
extern void sSetEEDSPRDCDCCurrAvgAdj(INT16S wValue);
extern INT16S swGetEEDSPRDCDCCurrAvgAdj(void);
extern void sSetPowerConvertionType(INT16U wValue);
extern INT16U swGetPowerConvertionType(void);
extern void sSetBMSConnectEN(INT16U wValue);
extern INT16U swGetBMSConnectEN(void);
