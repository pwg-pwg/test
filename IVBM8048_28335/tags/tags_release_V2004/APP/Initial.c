...
//	sApwmInit();
	...
	IER |=(M_INT1 | M_INT3 | M_INT4 |M_INT8| M_INT9| M_INT12);	//PIEIER

    //Enbale PIE group 1 interrupt 7 for TINT0     	
	PieCtrlRegs.PIEIER1.bit.INTx7 =1;		//OSTimeBase
	PieCtrlRegs.PIEIER1.bit.INTx4 =1;		//GENZeroCrossInterrupt
	...
	PieCtrlRegs.PIEACK.all = (PIEACK_GROUP1 | PIEACK_GROUP3 |PIEACK_GROUP4 | PIEACK_GROUP8 | PIEACK_GROUP9 | PIEACK_GROUP12);
...
void sInitGpio(void)
{
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO0 = 0;  // Enable pullup on          BUSSOFT.ON  
	GpioDataRegs.GPACLEAR.bit.GPIO0 = 1; // Load output latch to low
	GpioCtrlRegs.GPAMUX1.bit.GPIO0 = 0; // GPIO0 = I/O
	GpioCtrlRegs.GPADIR.bit.GPIO0 = 1;  // GPIO0= output
		
	GpioCtrlRegs.GPAPUD.bit.GPIO1 = 0;     // Enable pullup on GPIO1
	//GpioCtrlRegs.GPAMUX1.bit.GPIO1 = 1;  // GPIO1 = PWM1B   BUZ.PWM
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO1 = 0;  // Enable pullup on           BUZ.PWM
	...
	GpioCtrlRegs.GPADIR.bit.GPIO23 = 0;  // GPIO21 = Input
	...
	/*********LMZ*********/
	GpioCtrlRegs.GPBPUD.bit.GPIO42 = 1;  // Enable pullup on          GEN.TB
	GpioCtrlRegs.GPBMUX1.bit.GPIO42 = 0; // GPIO30 = I/O
	GpioCtrlRegs.GPBQSEL1.bit.GPIO42 = 1;
	GpioCtrlRegs.GPBDIR.bit.GPIO42= 0;  // GPIO30 = input

	GpioCtrlRegs.GPBPUD.bit.GPIO35 = 0;  // Enable pullup on          FAN.ON1
	GpioDataRegs.GPBCLEAR.bit.GPIO35 = 1; // Load output latch to low
	GpioCtrlRegs.GPBMUX1.bit.GPIO35 = 0; // GPIO35 = I/O
	GpioCtrlRegs.GPBDIR.bit.GPIO35 = 1;  // GPIO35 = output

	GpioCtrlRegs.GPBPUD.bit.GPIO37 = 0;  // Enable pullup on          FAN.ON2
	GpioDataRegs.GPBCLEAR.bit.GPIO37 = 1; // Load output latch to low
	GpioCtrlRegs.GPBMUX1.bit.GPIO37 = 0; // GPIO35 = I/O
	GpioCtrlRegs.GPBDIR.bit.GPIO37 = 1;  // GPIO35 = output

	GpioCtrlRegs.GPAPUD.bit.GPIO30 = 0;  // Enable pullup on          BUZ
	GpioDataRegs.GPACLEAR.bit.GPIO30 = 1; // Load output latch to low
	GpioCtrlRegs.GPAMUX2.bit.GPIO30 = 0; // GPIO35 = I/O
	GpioCtrlRegs.GPADIR.bit.GPIO30 = 1;  // GPIO35 = output
	/*********************/
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO39 = 0;  // Enable pullup on          BUSSOFT.ON  //GJ_OFF
	...
	// GpioCtrlRegs.GPBDIR.bit.GPIO42 = 0;  // GPIO42 = Output
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO46 = 0;  // Enable pullup on          GEN.RLY
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO48 = 1;  // Disable pullup on          BUS.V.OVER  
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO52 = 0;  // Enable pullup on          Reserved
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO69 = 0;  // Enable pullup on          Reserved
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO70 = 0;  // Enable pullup on          Reserved
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO71 = 0;  // Enable pullup on          Reserved
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO72 = 0;  // Enable pullup on          Reserved
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO73 = 0;  // Enable pullup on          Reserved
...
//		EPwm2Regs.CMPA.half.CMPA = cPWMCntlPeriod50Hz/8;
	...
	EDIS;
	EPwm3Regs.TBPRD = cPWMCntlPeriod50Hz; // 实际周期计算 = 150_000_000 / ( 3905 *2)    19.206 kHZ    52.06us
	...
	EDIS;
	EPwm4Regs.TBPRD = cPWMCntlPeriod50Hz; //实际周期计算 = 150_000_000 / ( 3905 *2)    19.206 kHZ    52.06us
	...
	EDIS;
	EPwm5Regs.TBPRD = cPWMCntlPeriod50Hz; // Period = 5200 TBCLK counts //实际周期计算 = 150_000_000 / ( 3905 *2)    19.206 kHZ    52.06us
...
void sInitEXINTF(void)                         
{
   ...
   EALLOW;
   GpioIntRegs.GPIOXINT1SEL.bit.GPIOSEL=42;
   PieVectTable.XINT1 = &GENZeroCrossInterrupt;
   XIntruptRegs.XINT1CR.bit.POLARITY = 0; 	//down
