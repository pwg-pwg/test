...
//	g_wVref = (INT16S)(((INT32S)g_wRSinAmp * pSinTab[g_wCtrlSinpointer] >> 14)) + g_wRInvDCVoltCntl;//+ g_wRInvDCSet
	...
	g_dwVoltLimit = ((g_dwVBeforeSaturation - g_wRInvCurrCntl)*g_wInvKiTemp >> 7) + g_wRInvVoltCntl; // // 之前的输出, 和这个逆变电流再次做对比
...
//	}
	...
	// TestMode=g_wBatVoltErr;	//0
	// TestMode1=dwChgLimit;	//1
	// TestMode2=dwDischgLimit;		//1
