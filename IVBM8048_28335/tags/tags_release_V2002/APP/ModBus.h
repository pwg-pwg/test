...
struct EepromDataStruct2//读取Eeprom的数值
{
	...
	INT16U	wEEDcdcCurrAdj;
	INT16U  wEEDcdcCurrAvgAdj;
...
struct RealTimeDataStruct
{
	...
	INT16S wGenPowerConvertionH;    //0x116E 
	INT16S wGenPowerConvertionL;    //0x116F
	INT16S wReserved6;   //0x1170
	INT16S wReserved7;   //0x1171
	INT16S wReservedCnt[40];
};
