...
//				}
		...
		break;
		case E2_GenPowerMax:
			if(WrData <= 500)//if((100 <= WrData) && (WrData <= 12000))if(WrData <= 12000)
			{
...
*/
	...
	// uRealTimeData.Stru.wReserved2 = swGetEEDSPROPCurrAdj;
	// uRealTimeData.Stru.wReserved3 = swGetEEDSPROPShareCurrAdj;
	// uRealTimeData.Stru.wReserved4 = swGetEEDSPRLineVoltAdj;
	// uRealTimeData.Stru.wReserved5 = swGetEEConvertVoltAdj;
