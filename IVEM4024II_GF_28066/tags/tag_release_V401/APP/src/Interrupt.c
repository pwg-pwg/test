...
extern void sPhaseLockControl(INT16S wPhaseLockInputR,INT16S wPhaseLockInputS,INT16S wPhaseLockInputT);
/***********************************************************************************
...
//    swGetLineQuadraticSum(g_wRLineVoltReal);
    ...
    {
		sPhaseLockControl(g_wRLineVoltReal,0,0);
		g_wRSinPointerwThetaTemp = wTheta;

    	if(g_wRSinPointerwThetaTemp >= g_wSinePointMax)
    	{
    		g_wRSinPointerwThetaTemp -= g_wSinePointMax;
    	}
