...
#define cDSPVersion		((1000*mModel) + 401)//SVN
#define cDSPPreVer      0
...
#define cModbusSubType              0x5206      //电池节数<<8+(2+(P-2KW)/0.5KW) = 电池节数 << 8 + （2*power -2kw）
...
#define	cSettingMaxDisChgCurr		165		    //165
...
#define cBatCurrReal20A             200
#define cBatCurrReal50A             500
...
#define cGridRlyDelayTime               84//50
