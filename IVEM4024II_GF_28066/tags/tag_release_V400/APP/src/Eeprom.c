...
void sEEpromDataRangeChk(void)
{
    ...
    {
        sSetEEPowerDisplayType(1);
        bUserChangeFlag = 0;
    }
    // Feed Power Set
	if(swGetEEFeedPower() < 0 || swGetEEFeedPower() > 4000)
	{
		sSetEEFeedPower(4000);
        bUserChangeFlag = 1;
	}
