...
extern INT16U	g_uwSolarVoltAvgMax;
...
extern INT16U swGetSolar1BypassFlag(void);
extern INT16U swGetSolar2BypassFlag(void);


extern void sPVBSTCntlDecrsFast(void);
extern void sPV2BSTCntlDecrsFast(void);

extern INT16S swGetSolarVolt1Ref(void);
extern INT16S swGetSolarVolt2Ref(void);


extern INT16S swGetSolarVcmp_P1(void);
extern INT16S swGetSolarVcmp_P1_1(void);
extern INT16S swGetSolarIerr_P1_0(void);
extern INT16S swGetSolarIerr_P1(void);
extern INT16S swGetSolarIerr_P1_1(void);


extern INT16S swGetBusVoltErr(void);
extern INT16S swGetBusVoltP(void);	
extern INT16S swGetBusVoltI(void);								
extern INT16S swGetBusVoltOut(void);

extern INT16S  swGetPVVoltErr(void);
extern INT16S  swGetPVVoltP(void);	
extern INT16S  swGetPVVoltI(void);							
extern INT16S  swGetPVVoltOut(void);

extern INT16S sGetPVCurrRef(void);
extern INT16S  swGetPVCurrErr(void);
extern INT16S  swGetPVCurrP(void);
extern INT16S  swGetPVCurrI(void);
extern INT16S  swGetPVCurrOut(void);
extern INT16S  swGetPVVoltAvg(void);
