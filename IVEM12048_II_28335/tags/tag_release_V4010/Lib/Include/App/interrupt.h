...
typedef union
{
	...
	struct
	{
		INT16U uwPVChgEn					:1;  //bit0
		INT16U uwACChgEn					:1;  //bit1
		INT16U uwFeedPowerEn				:1;  //bit2
		INT16U uwGridModePVBatPowerLoadEn	:1;  //bit3
		INT16U uwReseved					:12; //bit4-15
	}Bit;
}UEnergyInfo;
...
typedef union
{
    ...
    struct
    {
        INT16U uwPV1Work					:1;	//Bit0
        INT16U uwPV2Work					:1;	//Bit1
        INT16U uwBatDirection				:2;	//Bit2-3
        INT16U uwInvDirection				:2;	//Bit4-5
        INT16U uwLineDirection				:2;	//Bit6-7

        INT16U uwLoadDirection				:1;	//Bit8
        INT16U uwLineLoss					:1;	//Bit9
        INT16U uwBatOpen					:1;	//Bit10
        INT16U uwBatUnder					:1;	//Bit11
        INT16U uwLineBatDischgEn			:1;	//Bit12
        INT16U uwReserved					:3;	//Bit13-15
    }Bit;
}USystemSts;
...
typedef union
{
    ...
    struct
    {
        ...
        INT16U uwInvDirection		:2;		//b4-b5: 0=OFF, 1=Grid Charge, 2=Batt Discharge or Feed power to Grid
        INT16U uwLoadDirection		:1;		//b6
        INT16U uwMPPTWork			:1;		//b7

        INT16U uwLineDirection		:2;		//b9-8 : 0=OFF, 1=Draw power from Grid, 2= Feed power to Grid
...
extern INT16S g_wLoadCurrAvg;
extern INT16S g_wLoadCurrAvgBack;
...
extern INT16U g_wBus_VoltAvg_By10mS;
extern INT16S dwLimitTest[];
extern INT16U g_wRelayPowerOnStep;
...
extern interrupt void GeneratorZeroCrossInterrupt(void);
...
extern INT16S swGetRGenVoltSample(void);
extern INT16S swGetRGenCurrSample(void);
extern INT16S swGetRSmartLoadCurrSample(void);
...
extern INT16S	swGetVoltkp(void);
extern INT16S	swGetVoltki(void);
extern INT16S	swGetCurrErr(void);
extern INT16S	swGetCurrkp(void);
extern INT16S	swGetCurrki(void);
extern INT16S	swGetDischgLimit(void);
extern INT16S	swGetChgLimit(void);


extern INT16S swGetROPCurr1Sample(void);
extern INT16S swGetROPCurr2Sample(void);
extern INT16S swGetROPCurrZeroSample(void);
extern INT16S swGetLimitTest1(void);
extern INT16S swGetLimitTest2(void);
extern INT16S swGetLimitTest3(void);
extern INT16S swGetLimitTest4(void);
#endif
