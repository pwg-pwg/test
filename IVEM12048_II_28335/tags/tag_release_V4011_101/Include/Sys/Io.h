...
#define liBUSVOVER     		    GpioDataRegs.GPBDAT.bit.GPIO52
...
#define hoTEST2SIGTog 		    GpioDataRegs.GPBTOGGLE.bit.GPIO50 = 1 // TP8
...
#define hoTEST1SIGTog 		    GpioDataRegs.GPBTOGGLE.bit.GPIO51 = 1 // TP32
...
#define hoLINELED     		    GpioDataRegs.GPCDAT.bit.GPIO68			//GPIO60
#define hoLINELEDOn 		    GpioDataRegs.GPCSET.bit.GPIO68 = 1
#define hoLINELEDOff 		    GpioDataRegs.GPCCLEAR.bit.GPIO68 = 1
...
#define hoINVLED     		    GpioDataRegs.GPBDAT.bit.GPIO60
#define hoINVLEDOn 			    GpioDataRegs.GPBSET.bit.GPIO60 = 1
#define hoINVLEDOff 		    GpioDataRegs.GPBCLEAR.bit.GPIO60 = 1
//------------------------------------------
// IVEM8048 按键接入监控板，此处按键处理无效
#define hiBUTTONSWDOWN     	    GpioDataRegs.GPCDAT.bit.GPIO70

#define hiBUTTONSWUP     	    GpioDataRegs.GPCDAT.bit.GPIO73

#define hiBUTTONSWENT     	    GpioDataRegs.GPCDAT.bit.GPIO71

#define hiBUTTONSWESC     	    GpioDataRegs.GPCDAT.bit.GPIO72

//------------------------------------------
#define hoADC_8CH_S2     	    GpioDataRegs.GPCDAT.bit.GPIO70
#define hoADC_8CH_S2_TOG 	    GpioDataRegs.GPCTOGGLE.bit.GPIO70 	= 1
#define hoADC_8CH_S2_On 	    GpioDataRegs.GPCSET.bit.GPIO70 		= 1
#define hoADC_8CH_S2_Off 	    GpioDataRegs.GPCCLEAR.bit.GPIO70 	= 1

#define hoADC_8CH_S1     	    GpioDataRegs.GPCDAT.bit.GPIO71
#define hoADC_8CH_S1_TOG 	    GpioDataRegs.GPCTOGGLE.bit.GPIO71 	= 1
#define hoADC_8CH_S1_On 	    GpioDataRegs.GPCSET.bit.GPIO71 		= 1
#define hoADC_8CH_S1_Off 	    GpioDataRegs.GPCCLEAR.bit.GPIO71 	= 1

#define hoADC_8CH_S0     	    GpioDataRegs.GPCDAT.bit.GPIO72
#define hoADC_8CH_S0_TOG 	    GpioDataRegs.GPCTOGGLE.bit.GPIO72 	= 1
#define hoADC_8CH_S0_On 	    GpioDataRegs.GPCSET.bit.GPIO72 		= 1
#define hoADC_8CH_S0_Off 	    GpioDataRegs.GPCCLEAR.bit.GPIO72 	= 1

//------------------------------------------
// GEN.SOFT.RLY = GEN.RLY 是发电机软启动继电器的控制IO
#define hoGEN_SOFT_RLY                  GpioDataRegs.GPCDAT.bit.GPIO73
#define hoGEN_SOFT_RLY_On               GpioDataRegs.GPCCLEAR.bit.GPIO73    = 1
#define hoGEN_SOFT_RLY_Off              GpioDataRegs.GPCSET.bit.GPIO73      = 1
#define mChkGen_Soft_Rly_State()        hoGEN_SOFT_RLY
// SMART_PORTS.RLY = OP(TWINS).RLY 是复用端口L线继电器的控制IO（可以为发电机输入，也可以是第二路输出）
#define hoSMART_PORT_RLY                GpioDataRegs.GPBDAT.bit.GPIO40
#define hoSMART_PORT_RLY_On             GpioDataRegs.GPBSET.bit.GPIO40      = 1
#define hoSMART_PORT_RLY_Off            GpioDataRegs.GPBCLEAR.bit.GPIO40    = 1
#define mChkSmart_Port_Rly_On()         hoSMART_PORT_RLY
// SMART_SCR = GEN_SCR 是复用端口SCR的控制IO（可以为发电机输入，也可以是第二路输出）
#define hoSMART_PORT_SCR                GpioDataRegs.GPCDAT.bit.GPIO74
#define hoSMART_PORT_SCR_On             GpioDataRegs.GPCSET.bit.GPIO74      = 1
#define hoSMART_PORT_SCR_Off            GpioDataRegs.GPCCLEAR.bit.GPIO74    = 1
#define mChkSmart_Port_Scr_On()         hoSMART_PORT_SCR
// SMART_PORTS = GEN_N_RLY 是复用端口N线继电器的控制IO（可以为发电机输入，也可以是第二路输出）
#define hoSMART_PORT_N_RLY              GpioDataRegs.GPCDAT.bit.GPIO75
#define hoSMART_PORT_N_RLY_On           GpioDataRegs.GPCSET.bit.GPIO75      = 1
#define hoSMART_PORT_N_RLY_Off          GpioDataRegs.GPCCLEAR.bit.GPIO75    = 1
...
//------------------------------------------
#define hoLLC_CH_SD			GpioDataRegs.GPCDAT.bit.GPIO78
#define hoLLC_CH_SD_On 		GpioDataRegs.GPCSET.bit.GPIO78 	 = 1
#define hoLLC_CH_SD_Off 	GpioDataRegs.GPCCLEAR.bit.GPIO78 = 1

#define hoLLC_CL_SD     	GpioDataRegs.GPCDAT.bit.GPIO79
#define hoLLC_CL_SD_On 		GpioDataRegs.GPCSET.bit.GPIO79 		= 1
#define hoLLC_CL_SD_Off 	GpioDataRegs.GPCCLEAR.bit.GPIO79 	= 1
//------------------------------------------
...
#define hoRelay_POWERON_STA     GpioDataRegs.GPCDAT.bit.GPIO69
#define hoRelay_POWERON_ON      GpioDataRegs.GPCSET.bit.GPIO69 = 1
#define hoRelay_POWERON_OFF     GpioDataRegs.GPCCLEAR.bit.GPIO69 = 1
