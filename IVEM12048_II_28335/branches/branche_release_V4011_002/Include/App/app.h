...
typedef union
{
	...
	struct
	{
		...
		INT16U	uwGenInputPhaseLoss	:1;   //发电机缺相
...
typedef union
{
	...
	struct
	{
		...
		INT16U	uwSCC1OK			:1; //PV 1 ok
		INT16U	uwSCC1Chg			:1; //PV 1 charging
		INT16U	uwSCC2OK			:1;
		INT16U	uwSCC2Chg			:1;
...
#define cInvOffToSCROnTime					5
#define cSFTRlySCRDelayTime					2
#define cOPRlySCRDelayTime					2

#define cBatSwitchLineDelayTime				80
#define cSFTRlyDelayTime					109//102//106//88
#define cOPRlyDelayTime						109//102//96//88

#define	cDelay19ms							190
...
#define eEepromSaveFaultRecord              11
#define eEepromSaveFaultRecordBackup        12
