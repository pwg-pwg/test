...
//Atmel AT24C512C    512Kbit = 65536*8 byte = 512page* 128byte    128byte/page   128=0x80
#define		cEeprom1Address			      0			//Check  if cEepromTotalLength1 over 0x100    page1-2
#define		cEeprom2Address			      0x100		//Check  if cEepromTotalLength2 over 0x100    page3-4
#define		cEeprom1BackupAddress	      0x300		//Check  if cEepromTotalLength1 over 0x100    page3/4
...
extern void sSetEESetRecoverEn(INT16S wValue);
extern INT16S swGetEESetRecoverEn(void);
