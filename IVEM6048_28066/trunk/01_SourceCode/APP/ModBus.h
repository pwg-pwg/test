...
enum EE_E2_ID
{
	...
	E2_ClrPVEnergyLog,   	//0x5E  wClrPVEnergyLog
	E2_EEFactory,			//0x5F  wEEFactory
...
extern struct EepromFaultStruct  strEepromFaultStruct1;
...
extern void sFaultRecord(INT16U uwFaultID, INT16S wFalutValue, INT16U uwFlag);
