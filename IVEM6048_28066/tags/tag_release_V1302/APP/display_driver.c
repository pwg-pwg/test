...
#define  Lcd_ID_LOGO        112//
#define  Lcd_ID_IVEM6048    113//
#define  Lcd_ID_IVEM3024    114//
#define  Lcd_ID_IVEM5048    115//29*4-1
...
{   
	...
	for(i = 0; i < VRAMSIZE; i++)
	{
		#if mModel == cModel6048
		if(i == Lcd_ID_IVEM3024 || i == Lcd_ID_IVEM5048)
		{
			ViewBuf[i].BIT.val = DISPLAY_OFF;
		}
		else
		...
		#else
		if(i == Lcd_ID_IVEM3024 || i == Lcd_ID_IVEM6048)
		{
			ViewBuf[i].BIT.val = DISPLAY_OFF;
		}
		else
