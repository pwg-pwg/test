...
// TODO  测试变量
INT16S	g_wBatVoltErrTemp;
INT16S	g_wBusVoltErrTemp;
INT16S  g_dwPDCDCImoTemp;
INT16S	g_wPDCDCIreal80 = 0;
INT16S	g_wPDCDCPWMTemp = 0;
