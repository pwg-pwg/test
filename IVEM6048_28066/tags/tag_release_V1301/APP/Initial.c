...
void sInitGpio(void)
{
	...
	GpioCtrlRegs.GPAMUX1.bit.GPIO4 		= 0;   	// GPIO4 = EPWM3A
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO11 		= 0;   	// Enable pullup on GPIO11    	//LED.FAULT
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO17 		= 0;  	// Enable pullup on GPIO17     //RTC_CLK.SCL
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO18 		= 0;   	// Enable pullup on GPIO18     //RTC_CLK.SDA
	...
	GpioDataRegs.GPASET.bit.GPIO26 		= 1;	// Load output latch to HIGH
...
//
//	GpioCtrlRegs.GPBPUD.bit.GPIO52 		= 0;	// Enable pullup on GPIO25      //AD.SWITCH0
//	GpioDataRegs.GPBCLEAR.bit.GPIO52 	= 1;	// Load output latch to low
//	GpioCtrlRegs.GPBMUX2.bit.GPIO52 	= 0;	// GPIO25 = I/O
//	GpioCtrlRegs.GPBDIR.bit.GPIO52 		= 1;	// GPIO25 = output
