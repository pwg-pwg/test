...
;* Date/Time created: Tue Apr 02 16:48:42 2024                 *
;***************************************************************
...
;**************************************************************
	...
	.field	7000,16			; _g_wSolarPowerMax @ 0
...
;	D:\Program Application\CCS6.1.1\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\zhang\\AppData\\Local\\Temp\\534762 C:\\Users\\zhang\\AppData\\Local\\Temp\\534764 
;	D:\Program Application\CCS6.1.1\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\zhang\\AppData\\Local\\Temp\\5347612 
	.sect	".text"
	.global	_swMPPTTrack
...
$C$DW$118	.dwtag  DW_TAG_subprogram, DW_AT_name("swGetBoost1_PWM")
	...
	.dwattr $C$DW$118, DW_AT_TI_begin_line(0x4de)
	.dwattr $C$DW$118, DW_AT_TI_begin_column(0x08)
	.dwattr $C$DW$118, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 1247,column 1,is_stmt,address _swGetBoost1_PWM
...
;***************************************************************
_swGetBoost1_PWM:
;** 1248	-----------------------    return g_wR_Boost1_PWM;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
        MOVW      DP,#_g_wR_Boost1_PWM  ; [CPU_U] 
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 1248,column 2,is_stmt
        MOV       AL,@_g_wR_Boost1_PWM  ; [CPU_] |1248| 
$C$DW$119	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$118, DW_AT_TI_end_line(0x4e1)
...
;*** 902	-----------------------    if ( !uwBoost2Sts ) goto g11;
	...
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 902,column 8,is_stmt
        ...
        ; branchcc occurs ; [] |902| 
;*** 904	-----------------------    dwSolarPower1Limit = 7000L;
;*** 905	-----------------------    if ( dwSolarPowerMax > 70000L ) goto g29;
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 904,column 4,is_stmt
        MOVL      XAR4,#7000            ; [CPU_U] |904| 
...
$C$L61:    
;*** 861	-----------------------    if ( dwSolarPower1Limit <= 70000L ) goto g21;
        MOVW      DP,#_dwSolarPower1Limit$15 ; [CPU_U] 
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 861,column 5,is_stmt
        MOVL      XAR4,#70000           ; [CPU_U] |861| 
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 855,column 6,is_stmt
...
;*** 885	-----------------------    if ( dwSolarPower1Limit < 0L ) goto g26;
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 885,column 4,is_stmt
        ...
        B         $C$L65,LT             ; [CPU_] |885| 
        ; branchcc occurs ; [] |885| 
;*** 886	-----------------------    if ( dwSolarPower1Limit <= 70000L ) goto g27;
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 886,column 9,is_stmt
        MOVL      XAR4,#70000           ; [CPU_U] |886| 
...
;*** 887	-----------------------    if ( dwSolarPower2Limit < 0L ) goto g30;
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 887,column 4,is_stmt
        ...
        B         $C$L67,LT             ; [CPU_] |887| 
        ; branchcc occurs ; [] |887| 
;*** 888	-----------------------    if ( dwSolarPower2Limit <= 70000L ) goto g32;
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 888,column 9,is_stmt
        MOVL      XAR4,#70000           ; [CPU_U] |888| 
...
;*** 938	-----------------------    ((long)g_uwSolarPower1Avg > C$2+500L) ? (wSolarLimitCurrTemp = wSolarLimitCurrTemp-10) : (wSolarLimitCurrTemp = ((long)g_uwSolarPower1Avg > C$2+300L) ? wSolarLimitCurrTemp-5 : ((long)g_uwSolarPower1Avg > C$2+200L) ? wSolarLimitCurrTemp-2 : ((long)g_uwSolarPower1Avg > C$2 || g_uwSolarCurr1Avg > 2700u) ? wSolarLimitCurrTemp-1 : wSolarLimitCurrTemp+1);
...
$C$L75:    
        ...
        B         $C$L76,LT             ; [CPU_] |938| 
        ; branchcc occurs ; [] |938| 
        CMP       @_g_uwSolarCurr1Avg,#2700 ; [CPU_] |938| 
...
;*** 983	-----------------------    ((long)g_uwSolarPower2Avg > C$1+500L) ? (wSolarLimitCurrTemp = wSolarLimitCurrTemp-10) : (wSolarLimitCurrTemp = ((long)g_uwSolarPower2Avg > C$1+300L) ? wSolarLimitCurrTemp-5 : ((long)g_uwSolarPower2Avg > C$1+200L) ? wSolarLimitCurrTemp-2 : ((long)g_uwSolarPower2Avg > C$1 || g_uwSolarCurr2Avg > 2700u) ? wSolarLimitCurrTemp-1 : wSolarLimitCurrTemp+1);
	SETC	INTM
...
$C$L85:    
        ...
        B         $C$L86,LT             ; [CPU_] |983| 
        ; branchcc occurs ; [] |983| 
        CMP       @_g_uwSolarCurr2Avg,#2700 ; [CPU_] |983| 
