...
{ 
	...
	{
		#if mModel == cModel5048
		sSendBitToVram(cBIT_LOGO, DISPLAY_OFF, cALWAYS_LIGHT);
		sSendBitToVram(cBIT_IVEM5048, DISPLAY_OFF, cALWAYS_LIGHT);
		#else
		sSendBitToVram(cBIT_LOGO, DISPLAY_OFF, cALWAYS_LIGHT);
		sSendBitToVram(cBIT_IVEM6048, DISPLAY_OFF, cALWAYS_LIGHT);
		#endif
	}
