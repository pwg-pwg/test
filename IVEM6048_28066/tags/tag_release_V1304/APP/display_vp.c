...
void sDisplayTask(void)
{
	...
	while(1)
	{
		...
		if(event&(1<<eDisplayTimer))	 //100ms
		{
			...
			//
			if(swGetEESetRecoverEn() && mLCDPage)//退出该设置界面后生效
			{
...
void sSettingPageMaxChgCurr(INT8U* pubOprtStep, INT16S* pwChangeValue)
{
	...
	if(subSettingValueOprt(pubOprtStep, pwChangeValue, &wSettingValue, &s_wSettingValueTemp, &ubDisplayTime, cSettingMaxChgCurr, 1))
	{
...
void sSettingPageMaxACChgCurr(INT8U* pubOprtStep, INT16S* pwChangeValue)
{
	...
	if(subSettingValueOprt(pubOprtStep, pwChangeValue, &wSettingValue, &s_wSettingValueTemp, &ubDisplayTime, cSettingMaxACChgCurr, 1))
	{
