...
// 硬件采样系数
#define cPvVoltHwGain               GetModelParam(ePvVoltHwGain) 
#define cPvCurrHwGain               GetModelParam(ePvCurrHwGain) 	
#define cPvCurrFiltHwGain           GetModelParam(ePvCurrFiltHwGain) 	
#define cPvIsoVoltHwGain            GetModelParam(ePvIsoVoltHwGain) 
#define cBusVoltHwGain              GetModelParam(eBusVoltHwGain) 
...
#define fReal_PvPower(PvPower)      ((float)PvPower * cPvPowerRated) //5200
