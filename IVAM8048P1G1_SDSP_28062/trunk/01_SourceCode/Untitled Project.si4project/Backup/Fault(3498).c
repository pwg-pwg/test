...
void Fault_Task_1ms(void)
{
    static Uint16 s_u16ChkTime1 = 0, s_u16ChkCnt1 = 0, s_u16ChkCnt2 = 0, s_uIoStateBack1 = 0;
    static Uint16 s_u16ChkTime2 = 0, s_u16ChkCnt3 = 0, s_u16ChkCnt4 = 0, s_uIoStateBack2 = 0;
...
static void Fault_LlcTempOver(void)
{
    ...
    {
        if(stAdcTemp.Ave.LLC_Temp < cLLCTempOvpRes && stAdcTemp.Ave.LLC_Temp > 50)
        {
            s_u16ChkCnt1++;
            if(s_u16ChkCnt1 >= SecondBy20msBase(30))
            {
...
******************************************************************************/
 static void Fault_InnerTempOver(void)
 {
     ...
     {
        if(stAdcTemp.Ave.Innel_Temp < cInnerTempOvpRes && stAdcTemp.Ave.Innel_Temp > 50)
         {
             s_u16ChkCnt1++;
             if(s_u16ChkCnt1 >= SecondBy20msBase(30))
             {
