...
//	static Uint16 uiGlobalScanEnPre = 0;
    ...
    //MPPT 1s扰动,全局扫描100ms扰动
	if(++uiTimeCnt >= uiDelyPeriod /*|| MPPTGLOBALSCAN == strMpptCtrlData_Pv1.uiMpptSearchState*/)
	{
		//===============================================================
		//Pv Mppt
		//===============================================================
		...
		else	//PV充足，顶母线后不作MPPT
		{
			...
			strMpptCtrlData_Pv1.uiMpptSearchState = MPPTINITIAL;
//			strGlobalScanPv1.uiGlobalScanState = SCANINITIAL;    //这里加不加都行,再次扫描会赋值SCANINITIAL
		}
