...
#define cMachineMode             GetModelParam(eMachineMode)   
...
#define cPowerRated              GetModelParam(ePowerRated)   
#define cPvPowerRated            GetModelParam(ePvPowerRated)   
#define cPvPowerSigMax           GetModelParam(ePvPowerSigMax)   
#define cPvPowerMax              GetModelParam(ePvPowerMax) 

#define cVBusRated               GetModelParam(eVBusRated) 
#define cIBusRated               GetModelParam(eIBusRated)                   // BUS电流
#define cVPvRated                GetModelParam(eVPvRated) 
#define cVInvRated               GetModelParam(eVInvRated) 
#define cIPvRated                GetModelParam(eIPvRated) 
#define cIInvRated               GetModelParam(eIInvRated) 
#define cVPvIsoRated             GetModelParam(eVPvIsoRated) 

#define cPvCurrMax               GetModelParam(ePvCurrMax)       // Pv最大电流20A 定标是15A
#define cPvCurrRef0_5A           GetModelParam(ePvCurrRef0_5A)   // 0.5A,定标是15A

#define cKPowerRated             (float)(1.0/cPowerRated)
#define cKPvPowerRated           (float)(1.0/cPvPowerRated)
#define cKPvPowerSig             (float)(cPvPowerSigMax/cPvPowerRated)
#define cKPvPowerMax             (float)(cPvPowerMax/cPvPowerRated)
...
//2s timer delay counter define
#define cDelay20s_2s            10
#define cDelay30min_2s          900

// delay in int 1/15000  15000*t(unit s)
#define cDelay1ms_Isr           15
#define cDelay5ms_Isr           75
#define cDelay20ms_Isr          300
#define cDelay40ms_Isr          600
#define cDelay100ms_Isr         1500
#define cDelay300ms_Isr         4500
#define cDelay5s_Isr            75000
