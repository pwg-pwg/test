...
#define cMachineMode             fModelParam[eMachineMode]   
...
#define cPvPowerRated            fModelParam[ePvPowerRated ]
#define cPvPowerSigMax           fModelParam[ePvPowerSigMax]
#define cPvPowerMax              fModelParam[ePvPowerMax   ]

#define cVBusRated               fModelParam[eVBusRated    ]
#define cIBusRated               fModelParam[eIBusRated    ]  // BUS电流
#define cVPvRated                fModelParam[eVPvRated     ]
#define cVInvRated               fModelParam[eVInvRated    ]
#define cIPvRated                fModelParam[eIPvRated     ]
#define cIInvRated               fModelParam[eIInvRated    ]
#define cVPvIsoRated             fModelParam[eVPvIsoRated  ]

#define cPvCurrMax               fModelParam[ePvCurrMax    ]  // Pv最大电流20A 定标是15A
#define cPvCurrRef0_5A           fModelParam[ePvCurrRef0_5A]  // 0.5A,定标是15A
