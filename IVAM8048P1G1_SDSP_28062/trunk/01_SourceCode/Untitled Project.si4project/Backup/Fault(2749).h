...
// Pv过流 (快速保护用定标 慢速用实际值)
#define cPvCurrOvIsrLimit  GetModelParam(ePvCurrOvIsrLimit) //2.1333f // 32A ;
#define cPvCurrOvIsrRes    GetModelParam(ePvCurrOvIsrLimit) //0.8f    // 16A;

#define cPvCurrOvLimit     GetModelParam(ecPvCurrOvLimit)   //30.0f   //20A+10A 暂定
#define cPvCurrOvRes       GetModelParam(ecPvCurrOvRes)     //20.0f 
...
#define cLLCTempOvpLmt     830.0f
#define cLLCTempOvpRes     700.0f
...
// 内部过温（unit 0.1度）
#define cInnerTempOvpLmt   850.0f
#define cInnerTempOvpRes   700.0f
