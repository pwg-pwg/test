...
// Pv过流 (快速保护用定标 慢速用实际值)
#define cPvCurrOvIsrLimit  2.1333f // 32A ;
#define cPvCurrOvIsrRes    0.8f    // 16A;

#define cPvCurrOvLimit     30.0f   //20A+10A 暂定
#define cPvCurrOvRes       20.0f 
...
#define  cModel_IVAM6048       0x01
#define  cModel_IVAM8048       0x02
#define  cModelChkFinish       4
