...
// 硬件采样系数
#define cPvVoltHwGain               fModelParam[ePvVoltHwGain    ] 
#define cPvCurrHwGain               fModelParam[ePvCurrHwGain    ] 	
#define cPvCurrFiltHwGain           fModelParam[ePvCurrFiltHwGain] 	
#define cPvIsoVoltHwGain            fModelParam[ePvIsoVoltHwGain ] 
