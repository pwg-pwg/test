...
// Pv过流 (快速保护用定标 慢速用实际值)
#define cPvCurrOvIsrLimit  fModelParam[ePvCurrOvIsrLimit]  //2.1333f // 32A ;
#define cPvCurrOvIsrRes    fModelParam[ePvCurrOvIsrLimit]  //0.8f    // 16A;

#define cPvCurrOvLimit     fModelParam[ecPvCurrOvLimit  ]  //30.0f   //20A+10A 暂定
#define cPvCurrOvRes       fModelParam[ecPvCurrOvRes    ]  //20.0f 
