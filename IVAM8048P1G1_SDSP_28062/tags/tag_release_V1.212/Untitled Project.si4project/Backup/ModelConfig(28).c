...
//				while(AdcRegs.ADCSOCFLG1.bit.SOC1 != 0);
		...
		{
		    //要不要做成故障？TODO
			uiCurrentModel = eModelIVAM6048;  //识别失败默认为6K
		}
		uiMachineInfo[eS2MMachineInfo_Model] = 0x11;//uiCurrentModel;
		uiMachineInfo[eS2MMachineInfo_Version] = 0x22;//uiCurrentModel;  //To测试
