...
static const float g_ModelParamTable[eParamCount][eModelCount] = {
    ...
    //硬件采样系数
    {  0.0043478f  ,  0.0043478f  },  // ePvVoltHwGain     PV电压采样系数
	...
	{  2.1333f	   ,  2.15f		  },  // ePvCurrOvIsrLimit
	{  0.8f		   ,  1.05f		  },  // cPvCurrOvIsrRes
	{  30		   ,  40		  },  // ePvCurrOvLimit
	{  20		   ,  27		  },  // ePvCurrOvRes

    //过温保护
    {  830.0f	   ,  840.0f	  },  // eLLCTempOvpLmt    LLC散热器过温
	{  700.0f      ,  700.0f	  },  // eLLCTempOvpRes    LLC散热器恢复
    {  850.0f      ,  820.0f      },  // eInnerTempOvpLmt  内部过温
	{  700.0f      ,  700.0f	  }   // eInnerTempOvpRes  内部过温恢复
};
