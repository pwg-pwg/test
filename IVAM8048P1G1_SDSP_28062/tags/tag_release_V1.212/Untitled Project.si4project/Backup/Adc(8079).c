...
void Adc_System_PeripheralInit(void)
{
	...
	AdcRegs.ADCSOC4CTL.bit.CHSEL	= 5;	//set SOC4	  ADCINA5  PV2电感电流		    / ADCINB5  PV1电感电流
	AdcRegs.ADCSOC6CTL.bit.CHSEL	= 2;	//set SOC6	  ADCINA2  PV1电压			/ ADCINB2  NULL
...
void Adc_ResultGet(void)
{
    ...
    // ****************************** End *************************** //
	  ...
	  stADC.iSample.CurrPv2     = AdcResult.ADCRESULT4 - stAdcOffSet.CurrPv2;
	  stADC.iSample.CurrPv1     = AdcResult.ADCRESULT5 - stAdcOffSet.CurrPv1;

	  stADC.iSample.VoltPv1 	= AdcResult.ADCRESULT6;	
...
//			stPower.fPv2Scale = stADC.fRealScale.VoltPv2 * stADC.fRealScale.CurrPv2;
    ...
    stValue.fAveReal.VBus        = mVBusRealCalc(stValue.fAveReal.VBus);
