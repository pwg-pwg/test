...
// PV 开关频率
#define  PV_PWM_Freq     			32000L		//=PV 开关频率
#define  PV_PWM_Period     		    1406		//(Uint16)((EPWMCLK / PV_PWM_Freq) >> 1)		//=LLC 控制周期值

// 蜂鸣器 开关频率
#define  BUZ_PWM_Freq     			16000L							//=SCR 控制频率
#define  BUZ_PWM_Period     		2812		//(Uint16)((EPWMCLK / SCR_PWM_Freq) >> 1)		//=SCR 控制周期值
