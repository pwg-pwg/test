...
Refer documents :
******************************************************************************/
Uint16  bFirstRecFlag = 0;
Uint16  bFirstRecBuff[10] = {0};
void IntSci_Machine(void)
{
...
//      		    else                 hoTestIoOn;
				...
				if(bFirstRecFlag == 0)
				{
					bFirstRecBuff[uiIntSciRxDataLengthCnt] = uiIntSciRxDataBuff[uiIntSciRxDataLengthCnt];
				}
...
//			    bTest2++;
			...
			if(uiIntSciRxDataBuff[1] == 0x41 && uiIntSciRxDataLengthCnt == 9)
			{
			    bTest4++;
				bTest5 = uiIntSciFrameEndTimeCnt;
			}
			if(uiIntSciRxDataBuff[1] == 0x41) bTest1++;
			if(uiIntSciRxDataLengthCnt == 9)  bTest2++;
