...
// Pv过流 (快速保护用定标 慢速用实际值)
#define cPvCurrOvIsrLimit  fModelParam[ePvCurrOvIsrLimit]  // 6K:32A  8K:43A
#define cPvCurrOvIsrRes    fModelParam[ePvCurrOvIsrRes  ]  // 6K:16A  8K:21A

#define cPvCurrOvLimit     fModelParam[ePvCurrOvLimit  ]   // 6K:30A  8K:40A 
