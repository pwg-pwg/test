...
typedef struct
{
	...
	INT16S wBMSRcmdChgVolt;        //充电安全电压
	INT16S wBMSRcmdCutoffVolt;     //放电的截止电压
	INT16S wBMSRcmdMaxChgCurr;     //最大充电电流限制
	INT16S wBMSRcmdMaxDischgCurr;   //最大放电电流限制
...
typedef struct
{
	...
	INT16U wBMSComPal;//并联状态
	INT16U wBMSComFlg;//通讯地址连接状态
