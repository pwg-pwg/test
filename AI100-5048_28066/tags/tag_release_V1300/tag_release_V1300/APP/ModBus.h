...
enum EE_E2_ID
{
	...
	E2_FeedPowerEn,			//0x42
	E2_Reserved20,			//0x43	wTimingOP2StartTime
	E2_Reserved21,			//0x44	wTimingOP2EndTime
	E2_Reserved22,			//0x45	wDurationTime_OP2
	E2_Reserved23,			//0x46	wThresholdVoltMin_OP2
	E2_Reserved24,			//0x47	wThresholdSOCMin_OP2
	E2_Reserved25,			//0x48	bEEFauldCode
	E2_Reserved26,			//0x49	bEEPvMode
	E2_Reserved27,			//0x4A	bEELoadVA
	E2_Reserved28,			//0x4B	bEELoadWatt
	E2_Reserved29,			//0x4C	bEEInvWatt
	E2_Reserved30,			//0x4D	bEEBusVolt
	E2_Reserved31,			//0x4E	bEEBatVolt
	E2_Reserved32,			//0x4F	bEEBatVolt
	E2_Reserved33,			//0x50	bEELineFreq
	E2_Reserved34,			//0x51	bEEInvVolt
	E2_Reserved35,			//0x52	bEEInvFreq
	E2_Reserved36,			//0x53	bEEOPCurr
	E2_Reserved37,			//0x54	bEEMaxTemperature
	E2_Reserved38,			//0x55	bEEStatusCode
	E2_BattVoltBackToUtility,//0x56
	E2_OutputMode,			//0x57
	E2_AutoBackMainPageEn,	//0x58
	E2_BattVoltBackToBatt,	//0x59
	E2_Reserved40,			//0x5A	wSysSCCOKCondition
	E2_Reserved41,			//0x5B	wSolarPowerBalance
	E2_ModBusAddr,			//0x5C	wModBusAddr
	E2_Reserved42,			//0x5D	wLineWaitSec
	E2_Reserved43,			//0x5E
	E2_Reserved44,			//0x5F
...
enum IOT_ID
{
	IOT_AddrStart = 0,			//0x00
	IOT_Type = ATE_AddrStart,
	IOT_Version,
	IOT_IPAddressH,				//0x01
	IOT_IPAddressL,				//0x02
	IOT_SN1,						//0x03
...
struct RealTimeBMSDataStruct
{
    ...
    INT16U MaximumCellTemperature;
    INT16U MinimumCellTemperatureNo;
    INT16U MinimumCellTemperature;
    INT16U wBMS_SN[5];
};
...
#define REALBMSDATA_REG_BASE_ADDR  0x11FE                   // 实时数据BMS寄存器起始地址
#define REALBMSDATA_REG_BASE_LEN   cRealTimeBMSDataLen      // 实时数据BMS寄存器长度
