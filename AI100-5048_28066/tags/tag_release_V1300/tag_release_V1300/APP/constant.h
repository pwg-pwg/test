...
//#define mModel			cModel6048

#define cDSPVersion		(1000 + 300)//SVN
...
#define cModbusSubType				0x2408//一体机
...
#define cDerateWattRate				117//100//138		//(6000W-5400W)/(48.0V-42V)
#define	cPVMaxPower					7000
#define cPVCurrLimit				2700	//20A//27A
#define cModbusSubType				0x040A
#define cBatSerialPcs				4
#define cBatDischgCurrMax			2200	//180A				//xxx
#define	cDCDCCntlCurrntLimit		2400	//30*80 30A
...
#define	cIoVoltRatio			75				//3VMax  		2^10 * 100		0.01V << 10	0Vbias
...
//#define	cPVCurrRatio			935				//37.4AMax    	2^10 * 100		0.01A << 10	0Vbias
...
#define	mIoVoltReal(x)		(INT16S)(((INT32S)x * cIoVoltRatio) >> 10)
