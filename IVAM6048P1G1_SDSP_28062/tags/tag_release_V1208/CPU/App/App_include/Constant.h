...
#define cPvPowerRated            (float)6000.0  // 单路Pv 额定6000W
#define cPvPowerSigMax           (float)6500.0  // 单路Pv 最大6500W
#define cPvPowerMax              (float)12000.0 // 总Pv   最大12000W
#elif(cPvPowerRateScale == 16)
#define cPvPowerRated            (float)4800.0  
#define cPvPowerSigMax           (float)4800.0
#define cPvPowerMax   			 (float)9600.0	
#endif
...
#if(cPvPowerRateScale == 20)
#define cIPvRated                (float)15.0f  // 15 = cPvPowerRated/cVPvRated
#else
#define cIPvRated                (float)12.0f  // 12 = cPvPowerRated/cVPvRated
#endif
...
#define cPvCurrRef0_5A           (float)0.0333f  // 0.5A,定标是15A
#else
