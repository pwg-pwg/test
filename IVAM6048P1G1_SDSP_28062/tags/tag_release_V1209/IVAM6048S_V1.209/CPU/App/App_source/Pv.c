...
//  else  if(hiMstToSlv_En4)
//	{
//	    g_strPv1VoltLoop.integrator = g_strPv1VoltLoop.integrator * 0.9f;
//		g_strPv1CurrLoop.integrator = g_strPv1CurrLoop.integrator * 0.9f;
//	}
...
//		else  if(hiMstToSlv_En4)
//		{
//		    g_strPv2VoltLoop.integrator = g_strPv2VoltLoop.integrator * 0.9f;
//			g_strPv2CurrLoop.integrator = g_strPv2CurrLoop.integrator * 0.9f;
//		}
