...
//	static Uint16 uiGlobalScanEnPre = 0;
	static Uint16 uiDelyPeriod = cDelay2s_100ms;

    if(MPPTGLOBALSCAN == strMpptCtrlData_Pv1.uiMpptSearchState)  uiDelyPeriod = 3;  //300ms
	else  														 uiDelyPeriod = cDelay1s_100ms;
	
	if(++uiTimeCnt >= uiDelyPeriod)
	{
		//===============================================================
		//Pv Mppt
		//===============================================================
