...
//	static int16 Pv1BusChkCnt = 0,Pv1BusLimitFlg = FALSE;
    ...
    //=======================================================================
    if((MPPTGLOBALSCAN == strMpptCtrlData_Pv1.uiMpptSearchState) && (SCANPREPARE == strGlobalScanPv1.uiGlobalScanState))
	{
...
//        if((Pv2BusLimitFlg == TRUE)&&(stADC.fRealScale.VBus - g_strPv2BusVoltLoop.Ref > 0.125))  // 0.0375*800 Set_BusVolt(40)
	...
	else  // 独立跑 则需要重新跑电压环
	{
		...
		// PV2 Ctrl Pv Curr Loop
		//=======================================================================
		if((MPPTGLOBALSCAN == strMpptCtrlData_Pv2.uiMpptSearchState) && (SCANPREPARE == strGlobalScanPv2.uiGlobalScanState))
		{
