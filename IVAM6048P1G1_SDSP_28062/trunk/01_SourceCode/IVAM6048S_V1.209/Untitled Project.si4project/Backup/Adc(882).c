...
void Adc_ResultGet(void)
{
    ...
    // Model PV.ISO.V 环境温度     PV电感温度 INV电感温度 电池温度  LLC 变压器温度 LLC-IGBT温度
    // ****************************** End *************************** //
    ...
    // 6048的温度采样是独立通道
    stAdcTemp.Sample.Innel_Temp  = AdcResult.ADCRESULT10; 
...
//
       ...
       //stAdcTemp.Ave.Innel_Temp = Temp_TempCalculate(stAdcTemp.AveSmp.Innel_Temp , eTemp_InnelTempID);
        stAdcTemp.Ave.Innel_Temp = Temp_TempCalculate(2048 , eTemp_InnelTempID);
