...
// #define cPvPowerRate1p6          160   // Pv1.6倍超配
#define cPvPowerRateScale           216   // Pv2.16倍超配 -- 短时间可以2倍运行
...
#if(cPvPowerRateScale == 216)
#define cPvPowerMaxSingle        (float)6500.0   // 单路Pv 最大6500W
#define cPvPowerMax 			 (float)12000.0  // 总Pv    最大12000W
#elif(cPvPowerRateScale == 160)
#define cPvPowerMaxSingle        (float)4800.0   // 单路Pv 最大4800W
#define cPvPowerMax 			 (float)9600.0   // 总Pv    最大9600W
#endif

#define cKPowerRated             (float)(1.0/cPowerRated)
#define cKPvPowerRated           (float)(1.0/cPvPowerMaxSingle)
#define cKMaxPvPowerRated        (float)(cPvPowerMax/cPvPowerMaxSingle)  //总PV功率定标
...
#if(cPvPowerRateScale == 216)
#define cIPvRated                (float)16.25f  // 16.25 = cPvPowerMaxSingle/cVPvRated
#else
#define cIPvRated                (float)12.0f   // 12 = cPvPowerMaxSingle/cVPvRated
#endif
...
#if(cPvPowerRateScale == 216)
#define cPvCurrMax               (float)1.2307f  // Pv最大电流20A 定标是16.25A
#else
