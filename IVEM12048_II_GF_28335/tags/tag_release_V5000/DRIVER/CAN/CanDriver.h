...
extern	void	sCanInitial2(INT8U prio,INT8U event);
extern	void	sCanEventDisable2(void);
extern	void	sCanEventEnable2(void);
extern  INT8U   sbGetCanEventEnable2(void);
extern	void	sCan2RxISR0(void);
extern	void	sCan2RxISR3(void);
extern  void    sCan2RxISR5(void);
extern  void    sCan2RxISR6(void);
extern	void	sCan2TxISR1(void);
extern	void    sCan2ResetTxInt2(void);
extern	void    sCan2ResetTxInt4(void);
extern	void    sCan2ResetTxInt7(void);
extern	void    sCan2ResetTxInt8(void);
extern	void    sCan2ResetTxInt9(void);

extern	INT8U	sCanRead2(CANFRAME *pdata);
extern	INT8U	sCan2Write1(CANFRAME *pdata);
extern  void    sCan2Write2(CANFRAME *pdata);
extern  void    sCan2Write4(CANFRAME *pdata);
extern  void    sCan2Write7(CANFRAME *pdata);
extern  void    sCan2Write8(CANFRAME *pdata);
extern  void    sCan2Write9(CANFRAME *pdata);
extern  void	sCan2Write10(CANFRAME *pdata,INT16U wLengthTemp);
extern	void	sCan2SetRxId(INT32U id);
extern	void	sCan2SetRxMask(INT32U mask);
