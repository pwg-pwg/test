...
#define		mRTCI2CClockHigh()		GpioDataRegs.GPBSET.bit.GPIO55 = 1
#define		mRTCI2CClockLow()		GpioDataRegs.GPBCLEAR.bit.GPIO55 = 1
#define		mRTCI2CDataHigh()		GpioDataRegs.GPBSET.bit.GPIO56 = 1
#define		mRTCI2CDataLow()		GpioDataRegs.GPBCLEAR.bit.GPIO56 = 1
#define		mRTCI2CReadData()		GpioDataRegs.GPBDAT.bit.GPIO56
