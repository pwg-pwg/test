...
struct EepromStruct2
{
	...
	INT16U  wEEBatUnderVolt;//电池欠压保护触发阈值
	INT16U  wEEBatUnderBackVolt;//电池欠压保护恢复阈值
	INT16U  wEEBatCVVolt;
...
#define cEeprom1Address             0x000       //Check  if cEepromTotalLength1 over 0x100
...
#define cEeprom5FaultAddress        (cEeprom4BackupAddress + cEepromTotalLength3)
#define cEeprom5BackupFaultAddress  (cEeprom5FaultAddress + cEepromFaultLength)
...
extern void sSetEEDSPDcdcCurrAdj(INT16S wValue);
extern INT16S swGetEEDSPDcdcCurrAdj(void);
...
extern INT16S swGetEEPowerDisplayType(void);
extern void sSetEEFeedPower(INT16S wValue);
extern INT16U swGetEEFeedPower(void);
extern void sSetEEIslandProtectEn(INT16S wValue);
extern INT16U swGetEEIslandProtectEn(void);
