...
typedef struct
{
    ...
    float32 fPInv_Conver;      // 真实功率，根据电压折算
    float32 fSInv_Conver;      // 真实功率，根据电压折算
    float32 fPLoad_Conver;     // 真实功率，根据电压折算
    float32 fSLoad_Conver;     // 真实功率，根据电压折算
    float32 fPSmartLoad_Conver;// 真实功率，根据电压折算
    float32 fSSmartLoad_Conver;// 真实功率，根据电压折算
