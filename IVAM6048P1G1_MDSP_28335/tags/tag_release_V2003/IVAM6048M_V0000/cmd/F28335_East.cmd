...
PAGE 0:    /* Program Memory */
   ...
   RAML0       : origin = 0x008000, length = 0x003A00     /* on-chip RAM block L0 */
   /*RAML1       : origin = 0x009000, length = 0x001000*/     /* on-chip RAM block L1 */ /*@shumh20140923*/
   RAML2       : origin = 0x00BA00, length = 0x003600     /* on-chip RAM block L2 */
...
//   RAMBootF    : origin = 0x00F900, length = 0x000700   /*@chenyt on-chip RAM block L1 */
   ...
   IAPFlagW    : origin = 0x33FF7C, length = 0x000004     /*IAP标志位 0x8888,仅用来合并APP,检查看两个程序合并对不对*/
   ...
   APPFlagW    : origin = 0x337F7A, length = 0x000004	  /*APP标志位 0xAAAA,升级成功后由Iap擦写*/
...
PAGE 1 :   /* Data Memory */
  ...
  /*RAML6       : origin = 0x00E000, length = 0x001000*/     /* on-chip RAM block L1 */
   FUNCRAM     : origin = 0x00F900, length = 0x000700     /* on-chip RAM block L1 */
...
//   APPFlag	           : > APPFlagW    PAGE = 0/* 直接CMD用fill,这里就不能声明,要不然默认零,这个是.sect "APPFlag"搭配用 */
   ...
   E2promBag	       : > RAMM0       PAGE = 1
   I2cDrvBag	       : > RAMM0       PAGE = 1
   I2cE2Bag 	       : > RAMM0       PAGE = 1
   SysInfo		       : > RAMM0       PAGE = 1
