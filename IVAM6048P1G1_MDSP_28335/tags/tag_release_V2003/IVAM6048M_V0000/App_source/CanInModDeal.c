...
//    bSelfFrameFlagData_ToConstVolt  = strBatChgState.unFlag.bit.bToContVolt;
    ...
    // }
    uiSelfFrameAnalogData_PLoadPCT = (int16)((stPower.POut.PhaseA + stPower.SSmartLoad.PhaseA) * 100); // 放大100倍
...
//            if(bFrameFlagData_ToConstVolt(uiFrameIDTemp))  { s_uiUPMToConstVoltCnt ++; }
    ...
    fMasterAnalogData_OutAvgQa = (float)((int16)iSysReactivePowerAvgA) * 0.0001f; 
...
// stateTest[0] = uiMFrameFlagData_Sys2UpmFlag3(ePhaseA);
// stateTest[1] = uiMFrameFlagData_Sys2UpmFlag3(ePhaseB);
// stateTest[2] = uiMFrameFlagData_Sys2UpmFlag3(ePhaseC);
// stateTest[3] = g_ParaVar.fBatCurrPCTSummyInPhase;
// stateTest[4] = g_ParaVar.fPLoadPCTSummyInPhase;
// stateTest[5] = g_ParaVar.fPPvPCTSummyInPhase;
}
