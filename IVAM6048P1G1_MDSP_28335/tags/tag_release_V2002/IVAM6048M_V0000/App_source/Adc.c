...
//            stValue.fRmsScale.VInvAB = sqrt(stValue.lSum2.VInvAB * fAdcCountDiv );
            ...
            stPower.SInv.PhaseA = stValue.fRmsScale.VInvA * stValue.fRmsScale.IInvA * stPower.fVOutTransferRatio;//加入功率折算

            //有功功率      瞬时电压*瞬时电流，累加求平均
            // stPower.PInv.PhaseA = stPower.PSum.InvA * fAdcCountDiv;
            // stPower.PInv.PhaseB = stPower.PSum.InvB * fAdcCountDiv;
            stPower.PInv.PhaseA = stPower.PSum.InvA * fAdcCountDiv * stPower.fVOutTransferRatio;//加入功率折算
