		...
		case eComWriteSetMultipleData:
		{
			   ...
			   && (uiSciBufferDataID + uiSciBufferDataLength) <= SetDataNormalIDEnd )
			{
                for(usLoop = uiSciBufferDataIDTemp; usLoop < (uiSciBufferDataID + uiSciBufferDataLength); usLoop++)
                {
                    ...
                    {
                        if(   (int16)uireceivedatatemp < (int16)uiSetDataRange[uiSciBufferDataIDTemp - SetDataNormalIDBegin][eMinValue]
                           || (int16)uireceivedatatemp > (int16)uiSetDataRange[uiSciBufferDataIDTemp - SetDataNormalIDBegin][eMaxValue]
                          ) //超出设定范围则用默认值
                        {
                            uiBuffLength = 1;
                            uiErrorCode = MbDataError;
                    ...
                    {
                        if(   uireceivedatatemp < uiSetDataRange[uiSciBufferDataIDTemp - SetDataNormalIDBegin][eMinValue]
                           || uireceivedatatemp > uiSetDataRange[uiSciBufferDataIDTemp - SetDataNormalIDBegin][eMaxValue]
                          ) //超出设定范围则用默认值
                        {
                            uiBuffLength = 1;
                            uiErrorCode = MbDataError;
