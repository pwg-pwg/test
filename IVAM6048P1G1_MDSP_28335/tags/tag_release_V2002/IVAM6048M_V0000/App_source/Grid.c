...
//	g_SafetyConnect.f32FGridMaxLimitBack = g_SafetyFreq.f32FGridMax2Limit;
    ...
    // 提取最小值作为电压恢复点
    Dnlimit(g_SafetyConnect.f32VGridMaxLimitBack, g_SafetyVolt.f32VGridMax1Limit);
    Dnlimit(g_SafetyConnect.f32VGridMaxLimitBack, g_SafetyVolt.f32VGridMax2Limit);
    // Dnlimit(g_SafetyConnect.f32VGridMaxLimitBack, g_SafetyVolt.f32VGridMax3Limit);

    //-----------------------
    // 提取最大值作为电压恢复点
    Uplimit(g_SafetyConnect.f32VGridMinLimitBack, g_SafetyVolt.f32VGridMin1Limit);
    Uplimit(g_SafetyConnect.f32VGridMinLimitBack, g_SafetyVolt.f32VGridMin2Limit);
    // Uplimit(g_SafetyConnect.f32VGridMinLimitBack, g_SafetyVolt.f32VGridMin3Limit);

    //-----------------------
    // 提取最小值作为频率恢复点
    Dnlimit(g_SafetyConnect.f32FGridMaxLimitBack, g_SafetyFreq.f32FGridMax1Limit);
    Dnlimit(g_SafetyConnect.f32FGridMaxLimitBack, g_SafetyFreq.f32FGridMax2Limit);
    // Dnlimit(g_SafetyConnect.f32FGridMaxLimitBack, g_SafetyFreq.f32FGridMax3Limit);

    //-----------------------
    // 提取最大值作为频率恢复点
    Uplimit(g_SafetyConnect.f32FGridMinLimitBack, g_SafetyFreq.f32FGridMin1Limit);
    Uplimit(g_SafetyConnect.f32FGridMinLimitBack, g_SafetyFreq.f32FGridMin2Limit);
    // Uplimit(g_SafetyConnect.f32FGridMinLimitBack, g_SafetyFreq.f32FGridMin3Limit);
