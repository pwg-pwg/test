...
enum
{
    ...
    eAnalog_GridPbSum,
    eAnalog_GridPcSum,
    eAnalog_PowerDeratPer,   // 并机降额百分比
    eAnalog_BatDisCurr,      // 电池放电电流百分比
    eFrameAnalog_End
}; // 自身模块模拟量
...
enum
{
    ...
    eMAnalog_OutAvgQb,
    eMAnalog_OutAvgQc,
    eMAnalog_BattDisCurr,
    eMAnalog_OutDeratVal,
    eMasterAnalog_End
};  // 主机汇总后的模拟量
...
typedef struct
{
    union
    {
        ...
        struct
        {
            Uint16  bLiActEn                :1;     // 锂电激活使能
            Uint16  bBatChgMode             :2;     // 电池充电模式
            Uint16  bBatChgModeNum          :2;     // 电池充电模式
            Uint16  bSmartOutEnable         :1;
            Uint16  bSmartOutSyn            :1;
            Uint16  bBatCutOff              :1;
            Uint16  bBatCutOffNum           :1;
...
#define  uiFrameAnalogData_DeratPerc(x)           strFrameAnalogData[x].uiRealAnalog[eAnalog_PowerDeratPer]
#define  uiFrameAnalogData_BatDisCurr(x)          strFrameAnalogData[x].uiRealAnalog[eAnalog_BatDisCurr]
...
//--------- 相序主机模拟量 整数（主机发送的）---------//
#define  uiMFrameData_BatDisCurr(x)               strMFrameData[x].uiRealAnalog[0]
...
#define  uiSelfFrameAnalogData_DeratPerc          strSelfFrameAnalogData.uiRealAnalog[eAnalog_PowerDeratPer]
#define  uiSelfFrameAnalogData_BatDischCurr       strSelfFrameAnalogData.uiRealAnalog[eAnalog_BatDisCurr]
//------------------------------------------------------------------
...
// #define  uiRxFromSysAnalog_BatDischCurr           strRxFromSysAnalog.uiRealAnalog[eMAnalog_BattDisCurr]
#define  uiRxFromSysAnalog_OutDeratVal            strRxFromSysAnalog.uiRealAnalog[eMAnalog_OutDeratVal]
...
// #define  fRxFromSysAnalog_BatDischCurr            strRxFromSysCtrlAnalog.fRealAnalog[eMAnalog_BattDisCurr]
#define  fRxFromSysAnalog_OutDerarVal             strRxFromSysCtrlAnalog.fRealAnalog[eMAnalog_OutDeratVal]
...
#define  fMasterAnalogData_OutDeratVal         strMasterAnalogData.fRealAnalog[eMAnalog_OutDeratVal]
...
typedef union
{
    ...
    struct
    {
        Uint16  bUpmLiActEn             :1;
        Uint16  bUpmBatChgMode          :2;
        Uint16                          :2;
        Uint16                          :1;
...
// Add @Liam 20250803
//-----------------------------------------------------------------------------
CanInModDeal_PUBLIC Uint16  uiMasterPhaseSend;
