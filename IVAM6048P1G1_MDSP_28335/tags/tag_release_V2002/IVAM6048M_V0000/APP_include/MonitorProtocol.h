...
{                                     //枚举地址   监控地址
    ...
    eSetRsvd360                        , // 360   8808   预留360
    eSetRsvd361                        , // 361   8809   预留361
...
{                              //枚举地址   监控地址
	...
	eComATECommand              , // 16   16656  ATE指令集：bit0=ATE Pv校准恒流控制
...
enum
{
    ...
    eBMS1BatVolt                                 ,   //  11   预留2  电池电压当前值BMS采样  0.01 eg 4900表示49V
...
{                                   //枚举地址   监控地址
    ...
    eAnalogRsvd301                   , // 301   4653    预留
    eAnalogRsvd302                   , // 302   4654    预留
    eBMS2CurrentBMSAddr              , // 303   4655    当前电池包通讯地址
    eBMS2BMS_Flg                     , // 304   4656
    eBMS2ChargeVoltLimit             , // 305   4657    充电电压限制
    eBMS2DischargeVoltLimit          , // 306   4658    放电电压限制
    eBMS2ChargeCurrLimit             , // 307   4659    充电电流限制
    eBMS2DischargeCurrLimit          , // 308   4660    放电电流限制
    eBMS2BmsStatusHi                 , // 309   4661    充放状态高
    eBMS2BmsStatusLo                 , // 310   4662    充放状态低
    eBMS2FaultFlagHi                 , // 311   4663    故障标志高
    eBMS2FaultFlagLo                 , // 312   4664    故障标志低
    eBMS2AlarmFlagHi                 , // 313   4665    告警标志高
    eBMS2AlarmFlagLo                 , // 314   4666    告警标志低
    eBMS2NoticeFlagHi                , // 315   4667    提示标志高
    eBMS2NoticeFlagLo                , // 316   4668    提示标志低
    eBMS2TotalCurr                   , // 317   4669    总电流
    eBMS2TotalVolt                   , // 318   4670    总电压
    eBMS2Rsvd1                       , // 319   4671    预留
    eBMS2Rsvd2                       , // 320   4672    预留
    eBMS2TotalSOC                    , // 321   4673    总SOC
    eBMS2TotalSOH                    , // 322   4674    总SOH
    eBMS2TotalCapacityHigh           , // 323   4675    总容量
    eBMS2TotalCapacityLow            , // 324   4676    总容量
    eBMS2ParallelNumber              , // 325   4677    串/并联数量
    eBMS2ParallelStatus              , // 326   4678    串/并联状态
    eBMS2Rsvd3                       , // 327   4679    预留
    eBMS2Rsvd4                       , // 328   4680    预留
    eBMS2MaximumCellVoltNo           , // 329   4681    最高电芯电压编号
    eBMS2MaximumCellVolt             , // 330   4682    最高电芯电压
    eBMS2MinimumCellVoltNo           , // 331   4683    最低电芯电压编号
    eBMS2MinimumCellVolt             , // 332   4684    最低电芯电压
    eBMS2MaximumCellTempeNo          , // 333   4685    最高电芯温度编号
    eBMS2MaximumCellTempe            , // 334   4686    最高电芯温度
    eBMS2MinimumCellTempeNo          , // 335   4687    最低电芯温度编号
    eBMS2MinmumCellTempe             , // 336   4688    最低电芯温度
    eBMS2SN1                         , // 337   4689    电池包机器序列号
    eBMS2SN2                         , // 338   4690
    eBMS2SN3                         , // 339   4691
    eBMS2SN4                         , // 340   4692
    eBMS2SN5                         , // 341   4693
    ...
    eAnalogRsvd323                   , // 372   4724    预留
    eAnalogRsvd324                   , // 373   4725    预留
...
typedef union
{
    ...
    struct
    {
        ...
        Uint16  bGridRsv2                  :1;     // 63 预留--硬件零偏采样故障
        ...
        Uint16  bGenRsvd08                 :1;     // 72 油机预留告警8
        Uint16  bGenRsvd09                 :1;     // 73 油机预留告警9
        Uint16  bGenRsvd10                 :1;     // 74 油机预留告警10
...
typedef union
{
    ...
    struct
    {
        Uint16 uibattery         :1;  // B0   1-display      ; 0-dont display
        Uint16 uibatteryFlow     :1;  // B1   1-EnergyFlow   ; 0-dont Flow
        Uint16 uibatteryEnerDire :1;  // B2   1-discharge    ; 0-Charge
        Uint16 uiPV              :1;  // B3   1-display      ; 0-dont display
        Uint16 uiPVFlow          :1;  // B4   1-EnergyFlow   ; 0-dont Flow
        Uint16 uiLoad            :1;  // B5   1-display      ; 0-dont display
        Uint16 uiLoadFlow        :1;  // B6   1-EnergyFlow   ; 0-dont Flow
        Uint16 uiLine            :1;  // B7   1-display      ; 0-dont display

        Uint16 uiLineFlow        :1;  // B8   1-EnergyFlow   ; 0-dont Flow
        Uint16 uiLinePowerDire   :1;  // B9   1-feed to grid ; 0-get from grid
        Uint16 uiGen             :1;  // B10  1-display      ; 0-dont display
        Uint16 uiGenFlow         :1;  // B11  1-EnergyFlow   ; 0-dont Flow
        Uint16 uiGenPowerDire    :1;  // B12  1-feed to gen  ; 0-get from gen
        Uint16 uiSmartLoad       :1;  // B13  1-display      ; 0-dont display
        Uint16 uiSmartLoadFlow   :1;  // B14  1-EnergyFlow   ; 0-dont Flow
        Uint16 uiLoadPowerDire   :1;  // B15  1-LoadFlowtoOutSide; 0-FlowtoLoad
    }BIT;
}UNPowerFlowMsg;
...
typedef union
{
    ...
    struct
    {
        Uint16 MicroInv         :1;  // B0   1-display      ; 0-dont display
        Uint16 MicroInvFlow     :1;  // B1   1-EnergyFlow   ; 0-dont Flow
        Uint16 Rsvd02           :1;  // B2
        Uint16 Rsvd03           :1;  // B3
        Uint16 Rsvd04           :1;  // B4
        Uint16 Rsvd05           :1;  // B5
