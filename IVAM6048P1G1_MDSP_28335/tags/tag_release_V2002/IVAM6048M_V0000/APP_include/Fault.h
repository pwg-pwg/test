...
#define cVBusOvIsrLimit     1.40f   //Set_BusVolt(560)
#define cVBusOvIsrRes       1.35f   //Set_BusVolt(600)	//未使用

#define cVBusOvLimit        555.0f  // 1.3875
#define cVBusOvRes          540.0f  // 1.35
#define cVHalfBusOvLimit    300.0f
#define cVHalfBusOvRes      270.0f

// Bus欠压 (快速保护用定标 慢速用实际有效值)
#define cVBusUnIsrLimit     0.8125f //Set_BusVolt(325)
...
//电池过流减PV积分
#define cBatChgCurrOvPvDisc     160.0f
#define cBatChgCurrOvPvResc     100.0f

//电池过流封PV驱动
#define cBatChgCurrOvPvOff      180.0f
#define cBatChgCurrOvPvOn       80.0f


//电池过流报故障
#define cBatChgCurrOvLimit      150.0f
#define cBatDisChgCurrOvLimit   150.0f
#define cBatDisChgCurrOvLimit2  160.0f
...
#define cShortCurrLimit     24.0f // 大概1.1倍
...
// Public Variables
//-----------------------------------------------------------------------------
FAULT_PUBLIC Uint16 BatAbnormalFlg;
