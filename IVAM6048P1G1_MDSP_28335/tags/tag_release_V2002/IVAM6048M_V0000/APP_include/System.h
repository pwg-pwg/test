...
typedef union
{
    ...
    struct
    {
        // byte 0
        Uint16  wordL               :16;  // B0
        Uint16  wordH               :16;  // B1 系统给Pv下发的开关机标志
    }Word;
    struct
    {
        // byte 0
        ...
        Uint16  LiActiveFinish      :1;  // B3    电池激活完成标志
        Uint16  LiActLLCWork        :1;  // B4    电池激活时PV BOOST开始工作标志
        Uint16  GridCharEn          :1;  // B5    电网总充电使能
        Uint16  GenCharEn           :1;  // B6    发电机总充电使能(系统模式为发电机模式才检测)
        Uint16  GenConnectEn	    :1;  // B7    (发电机是否符合连接条件使能)
...
typedef union
{
    ...
    struct
    {
        ...
        Uint16  bBat1State      :3; // B8-B10  0:待机  1:充电  2:放电
        Uint16  bState1_11      :1; // B11
        Uint16  bState1_12      :1; // B12
        Uint16  bState1_13      :1; // B13
        Uint16  bBusIsoState    :2; // B14B15 0:未检测  1 检测中  2 检测通过  3 检测失败
    } bit;
}UnSystemState1;
