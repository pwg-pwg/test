...
#define     cInvRlyCloseDlyTime2           (float)(cInvRlyCloseDlyTime1 + cRlyCloseDeltaTime)//7.66mS = 7.32mS + 弹跳时间0.34ms

#define     cInvRlyOpenDlyTime1            (float)1.1f//1.6mS
#define     cInvRlyOpenDlyTime2            (float)(cInvRlyOpenDlyTime1 + 0.4)//2.0mS = 1.6mS + 弹跳时间0.8ms，硬件实测时间为1.8mS

#elif(cRlyType == 1)

#define     cRlyCloseDeltaTime             (float)1.8f//0.34ms
#define     cRlyCloseDlyTime1              (float)7.7f//7.7mS
#define     cRlyCloseDlyTime2              (float)(cRlyCloseDlyTime1 + cRlyCloseDeltaTime)//7.66mS = 7.32mS + 弹跳时间0.34ms

#define     cRlyOpenDlyTime1               (float)2.5f//1.5mS
#define     cRlyOpenDlyTime2               (float)(cRlyOpenDlyTime1 + 0.4)//2.0mS = 1.6mS + 弹跳时间0.8ms，硬件实测时间为1.8mS

#define     cInvRlyCloseDeltaTime          (float)0.27f//0.34ms
#define     cInvRlyCloseDlyTime1           (float)8.7f//7.58mS
#define     cInvRlyCloseDlyTime2           (float)(cInvRlyCloseDlyTime1 + cInvRlyCloseDeltaTime)//7.66mS = 7.32mS + 弹跳时间0.34ms

#define     cInvRlyOpenDlyTime1            (float)1.3f//1.6mS
#define     cInvRlyOpenDlyTime2            (float)(cInvRlyOpenDlyTime1 + 0.4)//2.0mS = 1.6mS + 弹跳时间0.8ms，硬件实测时间为1.8mS
