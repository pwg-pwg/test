...
{
    // return(25);
	return((int16)(fReal_BusVolt(strBusVoltUpLmtRegu.Ref)));
}
int16 swGetFunc26(void)
{
    return(26);
...
{
    // return(27);
	// return((int16)(fReal_BusVolt(strBusVoltUpLmtRegu.integrator)));
	return((int16)stateTest[9]);
}
int16 swGetFunc28(void)
{
    // return(28);
	// return((int16)(fReal_BusVolt(strBusVoltUpLmtRegu.Out)));
	return((int16)stateTest[8]);
}
int16 swGetFunc29(void)
{
    // return(29);
	// return((int16)(fPinvLoopOutputRef * cPowerRated));//BUS高低压环总触发输出
...
//    return((int16)(stADC.fRealScale.IGridA * g_GridManager.Rated.f32IOut * 100));
    return((int16)(fInvActivePowerFilt * 6000));
...
//    return((int16)(stADC.fRealScale.IGridB * g_GridManager.Rated.f32IOut * 100));
    // return((int16)(fInvReactivePowerFilt * 6000));
...
//    return((int16)(strPllToGrid.fSin * 1000));
    ...
    // return((int16)(g_InvVar.fGridOutLoopOut * 1000));
    // return((int16)(strGenVolt.fFreStepRad * 100000));
    return((int)(strLoadVoltRmsRealRef.fphaseA * g_GridManager.Rated.f32VOut * 10));
}
int16 swGetFunc88(void)
{
...
//    return((int16)(fInvActivePowerReal * 4000));
    ...
    // return((int16)(fInvActivePowerReal * g_GridManager.Rated.f32IOut * 100));
    return((int)(stValue.fRmsScale.VInvA * g_GridManager.Rated.f32VOut * 10));
}
int16 swGetFunc89(void)
{
    return((int)(strLoadVoltARmsRegu.Err * g_GridManager.Rated.f32VOut * 10));
...
//    return((int16)(fInvReactivePowerReal * 4000));
    ...
    // return((int16)(fInvReactivePowerReal * g_GridManager.Rated.f32IOut * 100));
}
int16 swGetFunc90(void)
{
    // return((int)( strPllOfSys.fFinalStepRad * 100000));
	// return((int16)(g_ParaVar.fCurrInvA_UdFilt * g_GridManager.Rated.f32IOut * 100));
   return((int)(strLoadVoltARmsRegu.Out * g_GridManager.Rated.f32VOut * 10));
...
//    return((int16)(strPllToInv.fSinB * g_GridManager.Rated.f32VOut * 10));
    ...
    // return((int16)(stADC.fRealScale.VInvA * g_GridManager.Rated.f32VOut * 10));
    return((int16)(strLoadVoltARealRegu.Ref * g_GridManager.Rated.f32VOut * 10));
}
int16 swGetFunc92(void)
{
...
//    return((int16)(strPllToInv.fSinC * g_GridManager.Rated.f32VOut * 10));
    ...
    // return((int16)(strLoadVoltARealRegu.Out * 1000));
}
int16 swGetFunc93(void)
{
