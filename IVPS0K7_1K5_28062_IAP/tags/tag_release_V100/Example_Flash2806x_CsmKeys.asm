...
_PRG_key4  .word 0x1314  ; PSWD bits 79-64
_PRG_key5  .word 0x2046  ; PSWD bits 95-80
_PRG_key6  .word 0x1284  ; PSWD bits 111-96
_PRG_key7  .word 0x9550  ; PSWD bits 127-112
