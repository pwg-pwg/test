...
;* Date/Time created: Thu Apr 03 14:40:18 2025                 *
;***************************************************************
...
;	D:\ccs software\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\Lin\\AppData\\Local\\Temp\\426322 C:\\Users\\Lin\\AppData\\Local\\Temp\\426324 
;	D:\ccs software\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\Lin\\AppData\\Local\\Temp\\4263212 
	.sect	".text"
	.global	_swGetVref
...
;*** 727	-----------------------    if ( y$196 > 0 ) goto g76;
	...
	.dwpsn	file "../MODULE/InverterCntl/InvCntModule.C",line 727,column 2,is_stmt
        ...
        ; branchcc occurs ; [] |727| 
;*** 753	-----------------------    if ( g_wDCDCDirection == 1 && g_wDCDCOverCurrCnt <= 0 && (g_wBatOverVoltCnt < 2 && gi_wDCDCChgDischgEnDisable&1) && g_uwFaultCode == 0u ) goto g70;
...
;*** 757	-----------------------    asm(" EDIS");
;*** 758	-----------------------    if ( g_wBatOverVoltCnt < 2 && g_wDCDCOverCurrCnt <= 0 ) goto g71;
        MOVW      DP,#_g_wDCDCDirection ; [CPU_U] 
