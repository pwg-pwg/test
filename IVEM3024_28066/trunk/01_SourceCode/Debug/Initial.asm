...
;* Date/Time created: Thu Apr 03 14:38:52 2025                 *
;***************************************************************
...
;	D:\ccs software\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\Lin\\AppData\\Local\\Temp\\291722 C:\\Users\\Lin\\AppData\\Local\\Temp\\291724 
;	D:\ccs software\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\Lin\\AppData\\Local\\Temp\\2917212 
	.sect	".text"
...
$C$DW$96	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitSysCtrl")
	...
	.dwattr $C$DW$96, DW_AT_TI_begin_line(0x159)
	.dwattr $C$DW$96, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$96, DW_AT_TI_max_frame_size(-4)
	.dwpsn	file "../APP/Initial.c",line 346,column 1,is_stmt,address _sInitSysCtrl
...
_sInitSysCtrl:
;*** 359	-----------------------    asm(" EALLOW");
;*** 360	-----------------------    (*(C$3 = &SysCtrlRegs)).WDCR = 104u;
;*** 361	-----------------------    asm(" EDIS");
;*** 363	-----------------------    asm(" setc INTM");
;*** 364	-----------------------    IER = 0u;
;*** 365	-----------------------    IFR = 0u;
;*** 367	-----------------------    asm(" EALLOW");
;*** 368	-----------------------    *((volatile struct PCLKCR0_BITS *)C$3+12L) |= 0x8u;
;*** 369	-----------------------    (*(void (*)())0x3d7c80uL)();
;*** 370	-----------------------    *(&SysCtrlRegs+12L) &= 0xfff7u;
;*** 371	-----------------------    asm(" EDIS");
;*** 376	-----------------------    asm(" EALLOW");
;*** 377	-----------------------    *((volatile struct CLKCTL_BITS *)C$3+2L) &= 0xbfffu;
;*** 378	-----------------------    *(&SysCtrlRegs+2L) |= 0x2000u;
;*** 379	-----------------------    *(&SysCtrlRegs+2L) &= 0xfffdu;
;*** 380	-----------------------    *(&SysCtrlRegs+2L) |= 1u;
;*** 381	-----------------------    *(&SysCtrlRegs+2L) &= 0xfffbu;
;*** 382	-----------------------    *(&SysCtrlRegs+2L) |= 0x400u;
;*** 383	-----------------------    *(&SysCtrlRegs+2L) &= 0xfeffu;
;*** 384	-----------------------    asm(" EDIS");
;*** 388	-----------------------    if ( !(*((volatile struct PLLSTS_BITS *)C$3+1L)&0x8u) ) goto g3;
	.dwcfi	cfa_offset, -2
...
$C$DW$99	.dwtag  DW_TAG_variable, DW_AT_name("$O$C3")
 ...
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 360,column 2,is_stmt
        MOVB      XAR0,#25              ; [CPU_] |360| 
        MOVL      XAR1,#_SysCtrlRegs    ; [CPU_U] |360| 
        MOVB      *+XAR1[AR0],#104,UNC  ; [CPU_] |360| 
 EDIS
 setc INTM
 ...
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 369,column 2,is_stmt
        MOVL      XAR7,#4029568         ; [CPU_U] |369| 
        SPM       #0                    ; [CPU_] 
	.dwpsn	file "../APP/Initial.c",line 368,column 2,is_stmt
        MOVL      XAR4,XAR1             ; [CPU_] |368| 
        ADDB      XAR4,#12              ; [CPU_U] |368| 
        OR        *+XAR4[0],#0x0008     ; [CPU_] |368| 
	.dwpsn	file "../APP/Initial.c",line 369,column 2,is_stmt
$C$DW$100	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../APP/Initial.c",line 370,column 2,is_stmt
        AND       @_SysCtrlRegs+12,#0xfff7 ; [CPU_] |370| 
 EDIS
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 377,column 2,is_stmt
        AND       *+XAR1[2],#0xbfff     ; [CPU_] |377| 
	.dwpsn	file "../APP/Initial.c",line 378,column 2,is_stmt
        OR        @_SysCtrlRegs+2,#0x2000 ; [CPU_] |378| 
	.dwpsn	file "../APP/Initial.c",line 379,column 2,is_stmt
        AND       @_SysCtrlRegs+2,#0xfffd ; [CPU_] |379| 
	.dwpsn	file "../APP/Initial.c",line 380,column 2,is_stmt
        OR        @_SysCtrlRegs+2,#0x0001 ; [CPU_] |380| 
	.dwpsn	file "../APP/Initial.c",line 381,column 2,is_stmt
        AND       @_SysCtrlRegs+2,#0xfffb ; [CPU_] |381| 
	.dwpsn	file "../APP/Initial.c",line 382,column 2,is_stmt
        OR        @_SysCtrlRegs+2,#0x0400 ; [CPU_] |382| 
	.dwpsn	file "../APP/Initial.c",line 383,column 2,is_stmt
        AND       @_SysCtrlRegs+2,#0xfeff ; [CPU_] |383| 
 EDIS
	.dwpsn	file "../APP/Initial.c",line 388,column 2,is_stmt
        TBIT      *+XAR1[1],#3          ; [CPU_] |388| 
        BF        $C$L1,NTC             ; [CPU_] |388| 
        ; branchcc occurs ; [] |388| 
;*** 390	-----------------------    asm(" EALLOW");
;*** 393	-----------------------    *(&SysCtrlRegs+1L) |= 0x10u;
;*** 394	-----------------------    asm(" EDIS");
;*** 397	-----------------------    asm("        ESTOP0");
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 393,column 7,is_stmt
        OR        @_SysCtrlRegs+1,#0x0010 ; [CPU_] |393| 
 EDIS
        ESTOP0
$C$L1:    
;***	-----------------------g3:
;*** 402	-----------------------    if ( !(*(&SysCtrlRegs+1L)&0x180u) ) goto g5;
	.dwpsn	file "../APP/Initial.c",line 402,column 2,is_stmt
        AND       AL,@_SysCtrlRegs+1,#0x0180 ; [CPU_] |402| 
        BF        $C$L2,EQ              ; [CPU_] |402| 
        ; branchcc occurs ; [] |402| 
;*** 404	-----------------------    asm(" EALLOW");
;*** 405	-----------------------    *(&SysCtrlRegs+1L) &= 0xfe7fu;
;*** 406	-----------------------    asm(" EDIS");
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 405,column 7,is_stmt
        AND       @_SysCtrlRegs+1,#0xfe7f ; [CPU_] |405| 
 EDIS
$C$L2:    
;***	-----------------------g5:
;*** 409	-----------------------    if ( (*((C$2 = &SysCtrlRegs)+17L)&0x1fu) == 9 ) goto g9;
	.dwpsn	file "../APP/Initial.c",line 409,column 3,is_stmt
        MOVL      XAR4,#_SysCtrlRegs    ; [CPU_U] |409| 
        MOVB      XAR0,#17              ; [CPU_] |409| 
        MOV       AL,*+XAR4[AR0]        ; [CPU_] |409| 
        ANDB      AL,#0x1f              ; [CPU_] |409| 
        CMPB      AL,#9                 ; [CPU_] |409| 
        BF        $C$L4,EQ              ; [CPU_] |409| 
        ; branchcc occurs ; [] |409| 
;*** 411	-----------------------    asm(" EALLOW");
;*** 413	-----------------------    *((volatile struct PLLSTS_BITS *)C$2+1L) |= 0x40u;
;*** 414	-----------------------    *(&SysCtrlRegs+17L) = *(&SysCtrlRegs+17L)&0xffe0u|0x9u;
;*** 415	-----------------------    asm(" EDIS");
;*** 435	-----------------------    asm(" EALLOW");
;*** 437	-----------------------    SysCtrlRegs.WDCR = 104u;
;*** 438	-----------------------    asm(" EDIS");
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 413,column 7,is_stmt
        OR        *+XAR4[1],#0x0040     ; [CPU_] |413| 
	.dwpsn	file "../APP/Initial.c",line 414,column 7,is_stmt
        AND       AL,@_SysCtrlRegs+17,#0xffe0 ; [CPU_] |414| 
        ORB       AL,#0x09              ; [CPU_] |414| 
        MOV       @_SysCtrlRegs+17,AL   ; [CPU_] |414| 
 EDIS
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 437,column 4,is_stmt
        MOVB      @_SysCtrlRegs+25,#104,UNC ; [CPU_] |437| 
 EDIS
$C$L3:    
	.dwpsn	file "../APP/Initial.c",line 438,column 4,is_stmt
$C$DW$L$_sInitSysCtrl$7$B:
;***	-----------------------g7:
;*** 440	-----------------------    if ( !(*(&SysCtrlRegs+1L)&1u) ) goto g7;
	.dwpsn	file "../APP/Initial.c",line 440,column 12,is_stmt
        TBIT      @_SysCtrlRegs+1,#0    ; [CPU_] |440| 
        BF        $C$L3,NTC             ; [CPU_] |440| 
        ; branchcc occurs ; [] |440| 
$C$DW$L$_sInitSysCtrl$7$E:
;*** 446	-----------------------    asm(" EALLOW");
;*** 447	-----------------------    *(&SysCtrlRegs+1L) &= 0xffbfu;
;*** 448	-----------------------    asm(" EDIS");
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 447,column 6,is_stmt
        AND       @_SysCtrlRegs+1,#0xffbf ; [CPU_] |447| 
 EDIS
$C$L4:    
;***	-----------------------g9:
;*** 451	-----------------------    asm(" EALLOW");
;*** 452	-----------------------    *((C$1 = &SysCtrlRegs)+1L) |= 0x180u;
;*** 453	-----------------------    asm(" EDIS");
;*** 456	-----------------------    asm(" EALLOW");
;*** 457	-----------------------    (*(volatile struct SYS_CTRL_REGS *)C$1).LOSPCP.all = 4u;
;*** 459	-----------------------    *(volatile unsigned *)C$1 = *(volatile unsigned *)C$1&0xfffeu|2u;
;*** 461	-----------------------    *((volatile struct PCLKCR0_BITS *)C$1+12L) |= 0x8u;
;*** 462	-----------------------    *(&SysCtrlRegs+12L) &= 0xffefu;
;*** 463	-----------------------    *(&SysCtrlRegs+12L) |= 0x400u;
;*** 464	-----------------------    *(&SysCtrlRegs+12L) |= 0x800u;
;*** 465	-----------------------    *(&SysCtrlRegs+12L) &= 0xfeffu;
;*** 466	-----------------------    *(&SysCtrlRegs+12L) &= 0xfdffu;
;*** 467	-----------------------    *(&SysCtrlRegs+12L) |= 0x4000u;
;*** 469	-----------------------    *((volatile struct PCLKCR1_BITS *)C$1+13L) |= 0x100u;
;*** 470	-----------------------    *(&SysCtrlRegs+13L) |= 0x200u;
;*** 471	-----------------------    *(&SysCtrlRegs+13L) |= 0x400u;
;*** 473	-----------------------    *(&SysCtrlRegs+13L) |= 1u;
;*** 475	-----------------------    *(&SysCtrlRegs+13L) |= 2u;
;*** 476	-----------------------    *(&SysCtrlRegs+13L) |= 4u;
;*** 477	-----------------------    *(&SysCtrlRegs+13L) |= 0x8u;
;*** 478	-----------------------    *(&SysCtrlRegs+13L) |= 0x10u;
;*** 479	-----------------------    *(&SysCtrlRegs+13L) |= 0x20u;
;*** 480	-----------------------    *(&SysCtrlRegs+13L) |= 0x40u;
;*** 481	-----------------------    *(&SysCtrlRegs+13L) |= 0x80u;
;*** 483	-----------------------    *(&SysCtrlRegs+13L) &= 0xbfffu;
;*** 484	-----------------------    *(&SysCtrlRegs+13L) &= 0x7fffu;
;*** 486	-----------------------    *(&SysCtrlRegs+12L) &= 0xfffbu;
;*** 487	-----------------------    asm(" EDIS");
;***  	-----------------------    return;
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 452,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |452| 
        ADDB      XAR5,#1               ; [CPU_U] |452| 
        OR        *+XAR5[0],#0x0180     ; [CPU_] |452| 
 EDIS
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 457,column 3,is_stmt
        MOVB      XAR0,#11              ; [CPU_] |457| 
        MOVB      *+XAR4[AR0],#4,UNC    ; [CPU_] |457| 
	.dwpsn	file "../APP/Initial.c",line 461,column 4,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |461| 
	.dwpsn	file "../APP/Initial.c",line 459,column 3,is_stmt
        AND       AL,*+XAR4[0],#0xfffe  ; [CPU_] |459| 
	.dwpsn	file "../APP/Initial.c",line 461,column 4,is_stmt
        ADDB      XAR5,#12              ; [CPU_U] |461| 
	.dwpsn	file "../APP/Initial.c",line 459,column 3,is_stmt
        ORB       AL,#0x02              ; [CPU_] |459| 
        MOV       *+XAR4[0],AL          ; [CPU_] |459| 
	.dwpsn	file "../APP/Initial.c",line 461,column 4,is_stmt
        OR        *+XAR5[0],#0x0008     ; [CPU_] |461| 
	.dwpsn	file "../APP/Initial.c",line 469,column 4,is_stmt
        ADDB      XAR4,#13              ; [CPU_U] |469| 
	.dwpsn	file "../APP/Initial.c",line 462,column 4,is_stmt
        AND       @_SysCtrlRegs+12,#0xffef ; [CPU_] |462| 
	.dwpsn	file "../APP/Initial.c",line 463,column 4,is_stmt
        OR        @_SysCtrlRegs+12,#0x0400 ; [CPU_] |463| 
	.dwpsn	file "../APP/Initial.c",line 464,column 4,is_stmt
        OR        @_SysCtrlRegs+12,#0x0800 ; [CPU_] |464| 
	.dwpsn	file "../APP/Initial.c",line 465,column 4,is_stmt
        AND       @_SysCtrlRegs+12,#0xfeff ; [CPU_] |465| 
	.dwpsn	file "../APP/Initial.c",line 466,column 4,is_stmt
        AND       @_SysCtrlRegs+12,#0xfdff ; [CPU_] |466| 
	.dwpsn	file "../APP/Initial.c",line 467,column 4,is_stmt
        OR        @_SysCtrlRegs+12,#0x4000 ; [CPU_] |467| 
	.dwpsn	file "../APP/Initial.c",line 469,column 4,is_stmt
        OR        *+XAR4[0],#0x0100     ; [CPU_] |469| 
	.dwpsn	file "../APP/Initial.c",line 470,column 4,is_stmt
        OR        @_SysCtrlRegs+13,#0x0200 ; [CPU_] |470| 
	.dwpsn	file "../APP/Initial.c",line 471,column 4,is_stmt
        OR        @_SysCtrlRegs+13,#0x0400 ; [CPU_] |471| 
	.dwpsn	file "../APP/Initial.c",line 473,column 4,is_stmt
        OR        @_SysCtrlRegs+13,#0x0001 ; [CPU_] |473| 
	.dwpsn	file "../APP/Initial.c",line 475,column 4,is_stmt
        OR        @_SysCtrlRegs+13,#0x0002 ; [CPU_] |475| 
	.dwpsn	file "../APP/Initial.c",line 476,column 4,is_stmt
        OR        @_SysCtrlRegs+13,#0x0004 ; [CPU_] |476| 
	.dwpsn	file "../APP/Initial.c",line 477,column 4,is_stmt
        OR        @_SysCtrlRegs+13,#0x0008 ; [CPU_] |477| 
	.dwpsn	file "../APP/Initial.c",line 478,column 4,is_stmt
        OR        @_SysCtrlRegs+13,#0x0010 ; [CPU_] |478| 
	.dwpsn	file "../APP/Initial.c",line 479,column 4,is_stmt
        OR        @_SysCtrlRegs+13,#0x0020 ; [CPU_] |479| 
	.dwpsn	file "../APP/Initial.c",line 480,column 4,is_stmt
        OR        @_SysCtrlRegs+13,#0x0040 ; [CPU_] |480| 
	.dwpsn	file "../APP/Initial.c",line 481,column 4,is_stmt
        OR        @_SysCtrlRegs+13,#0x0080 ; [CPU_] |481| 
	.dwpsn	file "../APP/Initial.c",line 483,column 4,is_stmt
        AND       @_SysCtrlRegs+13,#0xbfff ; [CPU_] |483| 
	.dwpsn	file "../APP/Initial.c",line 484,column 4,is_stmt
        AND       @_SysCtrlRegs+13,#0x7fff ; [CPU_] |484| 
	.dwpsn	file "../APP/Initial.c",line 486,column 4,is_stmt
        AND       @_SysCtrlRegs+12,#0xfffb ; [CPU_] |486| 
 EDIS
	.dwcfi	cfa_offset, -4
        MOVL      XAR1,*--SP            ; [CPU_] 
	.dwcfi	cfa_offset, -2
...
$C$DW$102	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$102, DW_AT_name("D:\CCS_Code\IVEM3024_ALL\IVEM3024_28066\IVEM3024_28066_V3.07 20241213\IVEM3024\Debug\Initial.asm:$C$L3:1:1743662332")
	.dwattr $C$DW$102, DW_AT_TI_begin_file("../APP/Initial.c")
	.dwattr $C$DW$102, DW_AT_TI_begin_line(0x1b8)
	.dwattr $C$DW$102, DW_AT_TI_end_line(0x1bc)
$C$DW$103	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$96, DW_AT_TI_end_line(0x1e8)
...
$C$DW$104	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitPieCtrl")
	...
	.dwattr $C$DW$104, DW_AT_TI_begin_line(0x393)
	.dwattr $C$DW$104, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$104, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 916,column 1,is_stmt,address _sInitPieCtrl
...
_sInitPieCtrl:
;*** 918	-----------------------    asm(" setc INTM");
;*** 921	-----------------------    *&PieCtrlRegs &= 0xfffeu;
;*** 924	-----------------------    PieCtrlRegs.PIEIER1.all = 0u;
;*** 925	-----------------------    PieCtrlRegs.PIEIER2.all = 0u;
;*** 926	-----------------------    PieCtrlRegs.PIEIER3.all = 0u;
;*** 927	-----------------------    PieCtrlRegs.PIEIER4.all = 0u;
;*** 928	-----------------------    PieCtrlRegs.PIEIER5.all = 0u;
;*** 929	-----------------------    PieCtrlRegs.PIEIER6.all = 0u;
;*** 930	-----------------------    PieCtrlRegs.PIEIER7.all = 0u;
;*** 931	-----------------------    PieCtrlRegs.PIEIER8.all = 0u;
;*** 932	-----------------------    PieCtrlRegs.PIEIER9.all = 0u;
;*** 933	-----------------------    PieCtrlRegs.PIEIER10.all = 0u;
;*** 934	-----------------------    PieCtrlRegs.PIEIER11.all = 0u;
;*** 935	-----------------------    PieCtrlRegs.PIEIER12.all = 0u;
;*** 938	-----------------------    PieCtrlRegs.PIEIFR1.all = 0u;
;*** 939	-----------------------    PieCtrlRegs.PIEIFR2.all = 0u;
;*** 940	-----------------------    PieCtrlRegs.PIEIFR3.all = 0u;
;*** 941	-----------------------    PieCtrlRegs.PIEIFR4.all = 0u;
;*** 942	-----------------------    PieCtrlRegs.PIEIFR5.all = 0u;
;*** 943	-----------------------    PieCtrlRegs.PIEIFR6.all = 0u;
;*** 944	-----------------------    PieCtrlRegs.PIEIFR7.all = 0u;
;*** 945	-----------------------    PieCtrlRegs.PIEIFR8.all = 0u;
;*** 946	-----------------------    PieCtrlRegs.PIEIFR9.all = 0u;
;*** 947	-----------------------    PieCtrlRegs.PIEIFR10.all = 0u;
;*** 948	-----------------------    PieCtrlRegs.PIEIFR11.all = 0u;
;*** 949	-----------------------    PieCtrlRegs.PIEIFR12.all = 0u;
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$105	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$104, DW_AT_TI_end_line(0x3b6)
...
$C$DW$106	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitPieVectTable")
	...
	.dwattr $C$DW$106, DW_AT_TI_begin_line(0x3bf)
	.dwattr $C$DW$106, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$106, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 960,column 1,is_stmt,address _sInitPieVectTable
...
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
;*** 962	-----------------------    Source = &PieVectTableInit;
;*** 963	-----------------------    Dest = &PieVectTable;
;***  	-----------------------    L$1 = 127;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$108	.dwtag  DW_TAG_variable, DW_AT_name("Dest")
 ...
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 962,column 10,is_stmt
        MOVL      XAR5,#_PieVectTableInit ; [CPU_U] |962| 
	.dwpsn	file "../APP/Initial.c",line 963,column 10,is_stmt
        MOVL      XAR4,#_PieVectTable   ; [CPU_U] |963| 
        MOVB      XAR6,#127             ; [CPU_] 
$C$L5:    
...
;*** 966	-----------------------    if ( (L$1 = L$1-1) != (-1) ) goto g2;
	.dwpsn	file "../APP/Initial.c",line 967,column 3,is_stmt
        MOVL      ACC,*XAR5++           ; [CPU_] |967| 
        MOVL      *XAR4++,ACC           ; [CPU_] |967| 
	.dwpsn	file "../APP/Initial.c",line 966,column 11,is_stmt
        BANZ      $C$L5,AR6--           ; [CPU_] |966| 
        ; branchcc occurs ; [] |966| 
...
;***  	-----------------------    return;
 EDIS
	...
	.dwpsn	file "../APP/Initial.c",line 971,column 2,is_stmt
        OR        @_PieCtrlRegs,#0x0001 ; [CPU_] |971| 
...
$C$DW$110	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$110, DW_AT_name("D:\CCS_Code\IVEM3024_ALL\IVEM3024_28066\IVEM3024_28066_V3.07 20241213\IVEM3024\Debug\Initial.asm:$C$L5:1:1743662332")
	.dwattr $C$DW$110, DW_AT_TI_begin_file("../APP/Initial.c")
	.dwattr $C$DW$110, DW_AT_TI_begin_line(0x3c6)
	.dwattr $C$DW$110, DW_AT_TI_end_line(0x3c7)
$C$DW$111	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$106, DW_AT_TI_end_line(0x3cd)
...
$C$DW$112	.dwtag  DW_TAG_subprogram, DW_AT_name("MemCopy")
	...
	.dwattr $C$DW$112, DW_AT_TI_begin_line(0x5ba)
	.dwattr $C$DW$112, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$112, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 1467,column 1,is_stmt,address _MemCopy
...
;***************************************************************
_MemCopy:
;** 1468	-----------------------    if ( SourceAddr >= SourceEndAddr ) goto g4;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$119	.dwtag  DW_TAG_variable, DW_AT_name("$O$L1")
	...
	.dwattr $C$DW$119, DW_AT_location[DW_OP_reg14]
        MOVL      ACC,XAR5              ; [CPU_] |1467| 
        MOVL      XAR6,*-SP[4]          ; [CPU_] |1467| 
	.dwpsn	file "../APP/Initial.c",line 1468,column 11,is_stmt
        CMPL      ACC,XAR4              ; [CPU_] |1468| 
        B         $C$L7,LOS             ; [CPU_] |1468| 
...
$C$DW$L$_MemCopy$3$B:
;***	-----------------------g3:
;** 1470	-----------------------    *DestAddr++ = *SourceAddr++;
;** 1468	-----------------------    if ( (L$1 = L$1-1L) != (-1L) ) goto g3;
;***	-----------------------g4:
;***  	-----------------------    return;
	.dwpsn	file "../APP/Initial.c",line 1470,column 8,is_stmt
        MOV       AL,*XAR4++            ; [CPU_] |1470| 
	.dwpsn	file "../APP/Initial.c",line 1468,column 11,is_stmt
        SUBB      XAR5,#1               ; [CPU_U] |1468| 
	.dwpsn	file "../APP/Initial.c",line 1470,column 8,is_stmt
        MOV       *XAR6++,AL            ; [CPU_] |1470| 
	.dwpsn	file "../APP/Initial.c",line 1468,column 11,is_stmt
        MOVB      ACC,#0                ; [CPU_] |1468| 
        SUBB      ACC,#1                ; [CPU_] |1468| 
        CMPL      ACC,XAR5              ; [CPU_] |1468| 
        BF        $C$L6,NEQ             ; [CPU_] |1468| 
        ; branchcc occurs ; [] |1468| 
$C$DW$L$_MemCopy$3$E:
$C$L7:    
...
$C$DW$121	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$121, DW_AT_name("D:\CCS_Code\IVEM3024_ALL\IVEM3024_28066\IVEM3024_28066_V3.07 20241213\IVEM3024\Debug\Initial.asm:$C$L6:1:1743662332")
	.dwattr $C$DW$121, DW_AT_TI_begin_file("../APP/Initial.c")
	.dwattr $C$DW$121, DW_AT_TI_begin_line(0x5bc)
	.dwattr $C$DW$121, DW_AT_TI_end_line(0x5bf)
$C$DW$122	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$112, DW_AT_TI_end_line(0x5c1)
...
$C$DW$123	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitFlash")
	...
	.dwattr $C$DW$123, DW_AT_TI_begin_line(0x1ef)
	.dwattr $C$DW$123, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$123, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 496,column 1,is_stmt,address _sInitFlash
...
_sInitFlash:
;*** 497	-----------------------    asm(" EALLOW");
;*** 500	-----------------------    *(C$1 = &FlashRegs) |= 1u;
;*** 508	-----------------------    *(&FlashRegs+6L) = *((volatile struct FBANKWAIT_BITS *)C$1+6L)&0xf3ffu|0x300u;
;*** 511	-----------------------    *(&FlashRegs+6L) = *(&FlashRegs+6L)&0xfff0u|3u;
;*** 514	-----------------------    *(&FlashRegs+7L) = *((volatile struct FOTPWAIT_BITS *)C$1+7L)&0xffe0u|5u;
;*** 518	-----------------------    *((volatile struct FSTDBYWAIT_BITS *)C$1+4L) |= 0x1ffu;
;*** 519	-----------------------    *((volatile struct FACTIVEWAIT_BITS *)C$1+5L) |= 0x1ffu;
;*** 520	-----------------------    asm(" EDIS");
;*** 525	-----------------------    asm(" RPT #7 || NOP");
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
...
$C$DW$124	.dwtag  DW_TAG_variable, DW_AT_name("$O$C1")
 ...
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 500,column 4,is_stmt
        MOVL      XAR4,#_FlashRegs      ; [CPU_U] |500| 
        MOVW      DP,#_FlashRegs+6      ; [CPU_U] 
        OR        *+XAR4[0],#0x0001     ; [CPU_] |500| 
	.dwpsn	file "../APP/Initial.c",line 508,column 4,is_stmt
        AND       AL,*+XAR4[6],#0xf3ff  ; [CPU_] |508| 
        OR        AL,#0x0300            ; [CPU_] |508| 
        MOV       @_FlashRegs+6,AL      ; [CPU_] |508| 
	.dwpsn	file "../APP/Initial.c",line 511,column 4,is_stmt
        AND       AL,@_FlashRegs+6,#0xfff0 ; [CPU_] |511| 
        ORB       AL,#0x03              ; [CPU_] |511| 
        MOV       @_FlashRegs+6,AL      ; [CPU_] |511| 
	.dwpsn	file "../APP/Initial.c",line 514,column 4,is_stmt
        AND       AL,*+XAR4[7],#0xffe0  ; [CPU_] |514| 
        ORB       AL,#0x05              ; [CPU_] |514| 
        MOV       @_FlashRegs+7,AL      ; [CPU_] |514| 
	.dwpsn	file "../APP/Initial.c",line 518,column 4,is_stmt
        OR        *+XAR4[4],#0x01ff     ; [CPU_] |518| 
	.dwpsn	file "../APP/Initial.c",line 519,column 4,is_stmt
        OR        *+XAR4[5],#0x01ff     ; [CPU_] |519| 
 EDIS
 RPT #7 || NOP
        SPM       #0                    ; [CPU_] 
$C$DW$125	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$123, DW_AT_TI_end_line(0x20e)
...
$C$DW$126	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitEPWM")
	...
	.dwattr $C$DW$126, DW_AT_TI_begin_line(0x3d4)
	.dwattr $C$DW$126, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$126, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 981,column 1,is_stmt,address _sInitEPWM
...
_sInitEPWM:
;*** 982	-----------------------    asm(" EALLOW");
;*** 983	-----------------------    *(&SysCtrlRegs+12L) &= 0xfffbu;
;*** 984	-----------------------    asm(" EDIS");
;*** 987	-----------------------    asm(" EALLOW");
;*** 988	-----------------------    *(&EPwm1Regs+20L) = *((C$8 = &EPwm1Regs)+20L)&0xfffeu|2u;
;*** 989	-----------------------    *(&EPwm1Regs+20L) = *(&EPwm1Regs+20L)&0xfffbu|0x8u;
;*** 990	-----------------------    *((volatile struct AQSFRC_BITS *)C$8+13L) |= 0xc0u;
;*** 991	-----------------------    asm(" EDIS");
;*** 992	-----------------------    EPwm1Regs.TBPRD = 2344u;
;*** 993	-----------------------    EPwm1Regs.TBPHS.half.TBPHS = 0u;
;*** 994	-----------------------    EPwm1Regs.TBCTR = 0u;
;*** 995	-----------------------    *(volatile unsigned *)C$8 &= 0xe3ffu;
;*** 996	-----------------------    *(volatile unsigned *)C$8 &= 0xfc7fu;
;*** 997	-----------------------    *(volatile unsigned *)C$8 = *(volatile unsigned *)C$8&0xfffeu|2u;
;*** 998	-----------------------    *(volatile unsigned *)C$8 &= 0xfffbu;
;*** 999	-----------------------    *(volatile unsigned *)C$8 &= 0xfff7u;
;** 1001	-----------------------    *(volatile unsigned *)C$8 |= 0x30u;
;** 1003	-----------------------    *((volatile struct CMPCTL_BITS *)C$8+7L) &= 0xffefu;
;** 1004	-----------------------    *(&EPwm1Regs+7L) &= 0xfffcu;
;** 1005	-----------------------    *(&EPwm1Regs+7L) &= 0xffbfu;
;** 1006	-----------------------    *(&EPwm1Regs+7L) &= 0xfff3u;
;** 1007	-----------------------    EPwm1Regs.AQCTLA.all = 1365u;
;** 1008	-----------------------    EPwm1Regs.AQCTLB.all = 1365u;
;** 1009	-----------------------    EPwm1Regs.CMPA.half.CMPA = 0xffffu;
;** 1010	-----------------------    EPwm1Regs.CMPB = 0xffffu;
;** 1012	-----------------------    *((volatile struct DBCTL_BITS *)C$8+15L) &= 0xfffcu;
;** 1013	-----------------------    *(&EPwm1Regs+15L) = *(&EPwm1Regs+15L)&0xfffbu|0x8u;
;** 1014	-----------------------    EPwm1Regs.DBFED = 333u;
;** 1015	-----------------------    EPwm1Regs.DBRED = 333u;
;** 1017	-----------------------    *((volatile struct ETPS_BITS *)C$8+26L) &= 0xfff3u;
;** 1018	-----------------------    *(&EPwm1Regs+26L) = *(&EPwm1Regs+26L)&0xfffcu|1u;
;** 1019	-----------------------    *((volatile struct ETSEL_BITS *)C$8+25L) |= 0x8u;
;** 1021	-----------------------    *(&EPwm1Regs+25L) = *(&EPwm1Regs+25L)&0xfff8u|2u;
;** 1023	-----------------------    *((volatile struct ETCLR_BITS *)C$8+28L) |= 1u;
;** 1025	-----------------------    *(&EPwm1Regs+25L) |= 0x800u;
;** 1026	-----------------------    *(&EPwm1Regs+25L) = *(&EPwm1Regs+25L)&0xf8ffu|0x200u;
;** 1027	-----------------------    *(&EPwm1Regs+26L) = *(&EPwm1Regs+26L)&0xf7ffu|0x400u;
;** 1028	-----------------------    *(&EPwm1Regs+26L) = *(&EPwm1Regs+26L)&0xfdffu|0x100u;
;** 1029	-----------------------    *(&EPwm1Regs+25L) |= 0x8000u;
;** 1030	-----------------------    *(&EPwm1Regs+25L) = *(&EPwm1Regs+25L)&0x8fffu|0x2000u;
;** 1031	-----------------------    *(&EPwm1Regs+26L) = *(&EPwm1Regs+26L)&0x3fffu|0x4000u;
;** 1032	-----------------------    *(&EPwm1Regs+26L) = *(&EPwm1Regs+26L)&0xdfffu|0x1000u;
;** 1035	-----------------------    asm(" EALLOW");
;** 1036	-----------------------    *(&EPwm2Regs+20L) = *((C$7 = &EPwm2Regs)+20L)&0xfffeu|2u;
;** 1037	-----------------------    *(&EPwm2Regs+20L) = *(&EPwm2Regs+20L)&0xfffbu|0x8u;
;** 1038	-----------------------    *((volatile struct AQSFRC_BITS *)C$7+13L) |= 0xc0u;
;** 1039	-----------------------    asm(" EDIS");
;** 1040	-----------------------    EPwm2Regs.TBPRD = 2344u;
;** 1041	-----------------------    EPwm2Regs.TBPHS.half.TBPHS = 0u;
;** 1042	-----------------------    EPwm2Regs.TBCTR = 0u;
;** 1043	-----------------------    *(volatile unsigned *)C$7 &= 0xe3ffu;
;** 1044	-----------------------    *(volatile unsigned *)C$7 &= 0xfc7fu;
;** 1045	-----------------------    *(volatile unsigned *)C$7 = *(volatile unsigned *)C$7&0xfffeu|2u;
;** 1046	-----------------------    *(volatile unsigned *)C$7 &= 0xfffbu;
;** 1047	-----------------------    *(volatile unsigned *)C$7 &= 0xfff7u;
;** 1049	-----------------------    *(volatile unsigned *)C$7 |= 0x30u;
;** 1051	-----------------------    *((volatile struct CMPCTL_BITS *)C$7+7L) &= 0xffefu;
;** 1052	-----------------------    *(&EPwm2Regs+7L) &= 0xfffcu;
;** 1053	-----------------------    *(&EPwm2Regs+7L) &= 0xffbfu;
;** 1054	-----------------------    *(&EPwm2Regs+7L) &= 0xfff3u;
;** 1055	-----------------------    EPwm2Regs.AQCTLA.all = 1365u;
;** 1056	-----------------------    EPwm2Regs.AQCTLB.all = 1365u;
;** 1057	-----------------------    EPwm2Regs.CMPA.half.CMPA = 0xffffu;
;** 1058	-----------------------    EPwm2Regs.CMPB = 0xffffu;
;** 1060	-----------------------    *((volatile struct DBCTL_BITS *)C$7+15L) &= 0xfffcu;
;** 1061	-----------------------    *(&EPwm2Regs+15L) = *(&EPwm2Regs+15L)&0xfffbu|0x8u;
;** 1062	-----------------------    EPwm2Regs.DBFED = 333u;
;** 1063	-----------------------    EPwm2Regs.DBRED = 333u;
;** 1065	-----------------------    *((volatile struct ETPS_BITS *)C$7+26L) &= 0xfff3u;
;** 1066	-----------------------    *(&EPwm2Regs+26L) = *(&EPwm2Regs+26L)&0xfffcu|1u;
;** 1067	-----------------------    *((volatile struct ETSEL_BITS *)C$7+25L) |= 0x8u;
;** 1068	-----------------------    *(&EPwm2Regs+25L) = *(&EPwm2Regs+25L)&0xfff8u|1u;
;** 1070	-----------------------    *((volatile struct ETCLR_BITS *)C$7+28L) |= 1u;
;** 1072	-----------------------    *(&EPwm2Regs+25L) |= 0x800u;
;** 1073	-----------------------    *(&EPwm2Regs+25L) = *(&EPwm2Regs+25L)&0xf9ffu|0x100u;
;** 1074	-----------------------    *(&EPwm2Regs+26L) = *(&EPwm2Regs+26L)&0xf7ffu|0x400u;
;** 1075	-----------------------    *(&EPwm2Regs+26L) = *(&EPwm2Regs+26L)&0xfdffu|0x100u;
;** 1076	-----------------------    *(&EPwm2Regs+25L) |= 0x8000u;
;** 1077	-----------------------    *(&EPwm2Regs+25L) = *(&EPwm2Regs+25L)&0x9fffu|0x1000u;
;** 1078	-----------------------    *(&EPwm2Regs+26L) = *(&EPwm2Regs+26L)&0x3fffu|0x4000u;
;** 1079	-----------------------    *(&EPwm2Regs+26L) = *(&EPwm2Regs+26L)&0xdfffu|0x1000u;
;** 1081	-----------------------    asm(" EALLOW");
;** 1082	-----------------------    *(&EPwm3Regs+20L) = *((C$6 = &EPwm3Regs)+20L)&0xfffeu|2u;
;** 1083	-----------------------    asm(" EDIS");
;** 1085	-----------------------    EPwm3Regs.TBPRD = 2344u;
;** 1087	-----------------------    EPwm3Regs.TBPHS.half.TBPHS = 0u;
;** 1088	-----------------------    EPwm3Regs.TBCTR = 0u;
;** 1089	-----------------------    *(volatile unsigned *)C$6 &= 0xe3ffu;
;** 1090	-----------------------    *(volatile unsigned *)C$6 &= 0xfc7fu;
;** 1091	-----------------------    *(volatile unsigned *)C$6 = *(volatile unsigned *)C$6&0xfffeu|2u;
;** 1092	-----------------------    *(volatile unsigned *)C$6 &= 0xfffbu;
;** 1093	-----------------------    *(volatile unsigned *)C$6 &= 0xfff7u;
;** 1094	-----------------------    *(volatile unsigned *)C$6 |= 0x30u;
;** 1096	-----------------------    *((volatile struct CMPCTL_BITS *)C$6+7L) &= 0xffefu;
;** 1097	-----------------------    *(&EPwm3Regs+7L) &= 0xfffcu;
;** 1098	-----------------------    *(&EPwm3Regs+7L) &= 0xffbfu;
;** 1099	-----------------------    *(&EPwm3Regs+7L) &= 0xfff3u;
;** 1101	-----------------------    EPwm3Regs.AQCTLA.all = 1365u;
;** 1102	-----------------------    EPwm3Regs.AQCTLB.all = 1365u;
;** 1103	-----------------------    EPwm3Regs.CMPA.half.CMPA = 0xffffu;
;** 1104	-----------------------    *((volatile struct DBCTL_BITS *)C$6+15L) &= 0xfffcu;
;** 1108	-----------------------    *((volatile struct ETSEL_BITS *)C$6+25L) &= 0xfff7u;
;** 1110	-----------------------    *((volatile struct ETCLR_BITS *)C$6+28L) |= 1u;
;** 1116	-----------------------    EPwm4Regs.TBPRD = 4499u;
;** 1118	-----------------------    EPwm4Regs.TBPHS.half.TBPHS = 0u;
;** 1119	-----------------------    EPwm4Regs.TBCTR = 0u;
;** 1120	-----------------------    *(C$5 = &EPwm4Regs) &= 0xe3ffu;
;** 1121	-----------------------    *C$5 &= 0xfc7fu;
;** 1122	-----------------------    *C$5 &= 0xfffcu;
;** 1123	-----------------------    *C$5 &= 0xfffbu;
;** 1124	-----------------------    *C$5 &= 0xfff7u;
;** 1126	-----------------------    *C$5 |= 0x30u;
;** 1129	-----------------------    *((volatile struct CMPCTL_BITS *)C$5+7L) &= 0xffefu;
;** 1130	-----------------------    *(&EPwm4Regs+7L) &= 0xffbfu;
;** 1131	-----------------------    *(&EPwm4Regs+7L) &= 0xfffcu;
;** 1132	-----------------------    *(&EPwm4Regs+7L) &= 0xfff3u;
;** 1135	-----------------------    EPwm4Regs.AQCTLA.all = 0u;
;** 1136	-----------------------    *(&EPwm4Regs+11L) = *((volatile struct AQCTL_BITS *)C$5+11L)&0xffefu|0x20u;
;** 1137	-----------------------    *(&EPwm4Regs+11L) = *(&EPwm4Regs+11L)&0xfffcu|1u;
;** 1138	-----------------------    *((volatile struct DBCTL_BITS *)C$5+15L) &= 0xfffcu;
;** 1143	-----------------------    *((volatile struct ETPS_BITS *)C$5+26L) &= 0xfff3u;
;** 1144	-----------------------    *(&EPwm4Regs+26L) = *(&EPwm4Regs+26L)&0xfffcu|1u;
;** 1145	-----------------------    *((volatile struct ETSEL_BITS *)C$5+25L) &= 0xfff7u;
;** 1146	-----------------------    *(&EPwm4Regs+25L) = *(&EPwm4Regs+25L)&0xfff8u|2u;
;** 1147	-----------------------    *((volatile struct ETCLR_BITS *)C$5+28L) |= 1u;
;** 1150	-----------------------    asm(" EALLOW");
;** 1151	-----------------------    *(&EPwm5Regs+20L) = *((C$4 = &EPwm5Regs)+20L)&0xfffeu|2u;
;** 1152	-----------------------    *(&EPwm5Regs+20L) |= 0xcu;
;** 1153	-----------------------    *((volatile struct AQSFRC_BITS *)C$4+13L) &= 0xff3fu;
;** 1154	-----------------------    asm(" EDIS");
;** 1155	-----------------------    EPwm5Regs.TBPRD = 2344u;
;** 1156	-----------------------    EPwm5Regs.TBPHS.half.TBPHS = 0u;
;** 1157	-----------------------    EPwm5Regs.TBCTR = 0u;
;** 1158	-----------------------    *(volatile unsigned *)C$4 &= 0xe3ffu;
;** 1159	-----------------------    *(volatile unsigned *)C$4 &= 0xfc7fu;
;** 1160	-----------------------    *(volatile unsigned *)C$4 = *(volatile unsigned *)C$4&0xfffeu|2u;
;** 1161	-----------------------    *(volatile unsigned *)C$4 &= 0xfffbu;
;** 1162	-----------------------    *(volatile unsigned *)C$4 &= 0xfff7u;
;** 1163	-----------------------    *(volatile unsigned *)C$4 |= 0x30u;
;** 1165	-----------------------    *((volatile struct CMPCTL_BITS *)C$4+7L) &= 0xffefu;
;** 1166	-----------------------    *(&EPwm5Regs+7L) &= 0xfffcu;
;** 1167	-----------------------    *(&EPwm5Regs+7L) &= 0xffbfu;
;** 1168	-----------------------    *(&EPwm5Regs+7L) &= 0xfff3u;
;** 1170	-----------------------    EPwm5Regs.AQCTLA.all = 1365u;
;** 1171	-----------------------    EPwm5Regs.AQCTLB.all = 1365u;
;** 1172	-----------------------    EPwm5Regs.CMPA.half.CMPA = 0xffffu;
;** 1173	-----------------------    EPwm5Regs.CMPB = 0xffffu;
;** 1174	-----------------------    *((volatile struct DBCTL_BITS *)C$4+15L) &= 0xfffcu;
;** 1175	-----------------------    *(&EPwm5Regs+15L) = *(&EPwm5Regs+15L)&0xfffbu|0x8u;
;** 1176	-----------------------    EPwm5Regs.DBFED = 333u;
;** 1177	-----------------------    EPwm5Regs.DBRED = 333u;
;** 1179	-----------------------    *((volatile struct ETPS_BITS *)C$4+26L) &= 0xfff3u;
;** 1181	-----------------------    *(&EPwm5Regs+26L) = *(&EPwm5Regs+26L)&0xfffcu|1u;
;** 1182	-----------------------    *((volatile struct ETSEL_BITS *)C$4+25L) &= 0xfff7u;
;** 1184	-----------------------    *(&EPwm5Regs+25L) = *(&EPwm5Regs+25L)&0xfff8u|1u;
;** 1185	-----------------------    *((volatile struct ETCLR_BITS *)C$4+28L) |= 1u;
;** 1192	-----------------------    EPwm6Regs.TBPRD = 0xafc7u;
;** 1194	-----------------------    EPwm6Regs.TBPHS.half.TBPHS = 0u;
;** 1195	-----------------------    EPwm6Regs.TBCTR = 0u;
;** 1196	-----------------------    *(C$3 = &EPwm6Regs) &= 0xe3ffu;
;** 1197	-----------------------    *C$3 &= 0xfc7fu;
;** 1198	-----------------------    *C$3 &= 0xfffcu;
;** 1199	-----------------------    *C$3 &= 0xfffbu;
;** 1200	-----------------------    *C$3 &= 0xfff7u;
;** 1202	-----------------------    *C$3 |= 0x30u;
;** 1205	-----------------------    *((volatile struct CMPCTL_BITS *)C$3+7L) &= 0xffefu;
;** 1206	-----------------------    *(&EPwm6Regs+7L) &= 0xffbfu;
;** 1207	-----------------------    *(&EPwm6Regs+7L) &= 0xfffcu;
;** 1208	-----------------------    *(&EPwm6Regs+7L) &= 0xfff3u;
;** 1211	-----------------------    EPwm6Regs.AQCTLA.all = 1365u;
;** 1212	-----------------------    EPwm6Regs.AQCTLB.all = 1365u;
;** 1213	-----------------------    EPwm6Regs.CMPA.half.CMPA = 0xffffu;
;** 1214	-----------------------    EPwm6Regs.CMPB = 0xafc7u;
;** 1215	-----------------------    *((volatile struct DBCTL_BITS *)C$3+15L) &= 0xfffcu;
;** 1217	-----------------------    *((volatile struct ETPS_BITS *)C$3+26L) &= 0xfff3u;
;** 1218	-----------------------    *(&EPwm6Regs+26L) = *(&EPwm6Regs+26L)&0xfffcu|1u;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$134	.dwtag  DW_TAG_variable, DW_AT_name("$O$C8")
 ...
 EDIS
	...
	.dwpsn	file "../APP/Initial.c",line 1130,column 2,is_stmt
        AND       @_EPwm4Regs+7,#0xffbf ; [CPU_] |1130| 
	.dwpsn	file "../APP/Initial.c",line 1131,column 2,is_stmt
        AND       @_EPwm4Regs+7,#0xfffc ; [CPU_] |1131| 
	.dwpsn	file "../APP/Initial.c",line 1132,column 2,is_stmt
        AND       @_EPwm4Regs+7,#0xfff3 ; [CPU_] |1132| 
	.dwpsn	file "../APP/Initial.c",line 1135,column 2,is_stmt
        MOV       @_EPwm4Regs+11,#0     ; [CPU_] |1135| 
	.dwpsn	file "../APP/Initial.c",line 1136,column 2,is_stmt
        AND       AL,*+XAR4[AR0],#0xffef ; [CPU_] |1136| 
        ORB       AL,#0x20              ; [CPU_] |1136| 
        MOV       @_EPwm4Regs+11,AL     ; [CPU_] |1136| 
	.dwpsn	file "../APP/Initial.c",line 1137,column 2,is_stmt
        AND       AL,@_EPwm4Regs+11,#0xfffc ; [CPU_] |1137| 
        ORB       AL,#0x01              ; [CPU_] |1137| 
        MOV       @_EPwm4Regs+11,AL     ; [CPU_] |1137| 
	.dwpsn	file "../APP/Initial.c",line 1138,column 2,is_stmt
 ...
 EDIS
	...
	.dwpsn	file "../APP/Initial.c",line 1185,column 2,is_stmt
        ADDB      XAR4,#28              ; [CPU_U] |1185| 
	.dwpsn	file "../APP/Initial.c",line 1181,column 2,is_stmt
        AND       AL,@_EPwm5Regs+26,#0xfffc ; [CPU_] |1181| 
        ORB       AL,#0x01              ; [CPU_] |1181| 
        MOV       @_EPwm5Regs+26,AL     ; [CPU_] |1181| 
	.dwpsn	file "../APP/Initial.c",line 1182,column 2,is_stmt
        AND       *+XAR5[0],#0xfff7     ; [CPU_] |1182| 
	.dwpsn	file "../APP/Initial.c",line 1184,column 2,is_stmt
        AND       AL,@_EPwm5Regs+25,#0xfff8 ; [CPU_] |1184| 
        ORB       AL,#0x01              ; [CPU_] |1184| 
        MOV       @_EPwm5Regs+25,AL     ; [CPU_] |1184| 
        MOVW      DP,#_EPwm6Regs+5      ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 1185,column 2,is_stmt
        OR        *+XAR4[0],#0x0001     ; [CPU_] |1185| 
	.dwpsn	file "../APP/Initial.c",line 1196,column 2,is_stmt
        MOVL      XAR4,#_EPwm6Regs      ; [CPU_U] |1196| 
	.dwpsn	file "../APP/Initial.c",line 1215,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1215| 
        ADDB      XAR5,#15              ; [CPU_U] |1215| 
	.dwpsn	file "../APP/Initial.c",line 1192,column 2,is_stmt
        MOV       @_EPwm6Regs+5,#44999  ; [CPU_] |1192| 
	.dwpsn	file "../APP/Initial.c",line 1194,column 2,is_stmt
        MOV       @_EPwm6Regs+3,#0      ; [CPU_] |1194| 
	.dwpsn	file "../APP/Initial.c",line 1195,column 2,is_stmt
        MOV       @_EPwm6Regs+4,#0      ; [CPU_] |1195| 
	.dwpsn	file "../APP/Initial.c",line 1196,column 2,is_stmt
        AND       *+XAR4[0],#0xe3ff     ; [CPU_] |1196| 
	.dwpsn	file "../APP/Initial.c",line 1197,column 2,is_stmt
        AND       *+XAR4[0],#0xfc7f     ; [CPU_] |1197| 
	.dwpsn	file "../APP/Initial.c",line 1198,column 2,is_stmt
        AND       *+XAR4[0],#0xfffc     ; [CPU_] |1198| 
	.dwpsn	file "../APP/Initial.c",line 1199,column 2,is_stmt
        AND       *+XAR4[0],#0xfffb     ; [CPU_] |1199| 
	.dwpsn	file "../APP/Initial.c",line 1200,column 2,is_stmt
        AND       *+XAR4[0],#0xfff7     ; [CPU_] |1200| 
	.dwpsn	file "../APP/Initial.c",line 1202,column 2,is_stmt
        OR        *+XAR4[0],#0x0030     ; [CPU_] |1202| 
	.dwpsn	file "../APP/Initial.c",line 1205,column 2,is_stmt
        AND       *+XAR4[7],#0xffef     ; [CPU_] |1205| 
	.dwpsn	file "../APP/Initial.c",line 1206,column 2,is_stmt
        AND       @_EPwm6Regs+7,#0xffbf ; [CPU_] |1206| 
	.dwpsn	file "../APP/Initial.c",line 1207,column 2,is_stmt
        AND       @_EPwm6Regs+7,#0xfffc ; [CPU_] |1207| 
	.dwpsn	file "../APP/Initial.c",line 1208,column 2,is_stmt
        AND       @_EPwm6Regs+7,#0xfff3 ; [CPU_] |1208| 
	.dwpsn	file "../APP/Initial.c",line 1211,column 2,is_stmt
        MOV       @_EPwm6Regs+11,#1365  ; [CPU_] |1211| 
	.dwpsn	file "../APP/Initial.c",line 1212,column 2,is_stmt
        MOV       @_EPwm6Regs+12,#1365  ; [CPU_] |1212| 
	.dwpsn	file "../APP/Initial.c",line 1213,column 2,is_stmt
        MOV       @_EPwm6Regs+9,#65535  ; [CPU_] |1213| 
	.dwpsn	file "../APP/Initial.c",line 1214,column 2,is_stmt
        MOV       @_EPwm6Regs+10,#44999 ; [CPU_] |1214| 
	.dwpsn	file "../APP/Initial.c",line 1215,column 2,is_stmt
        AND       *+XAR5[0],#0xfffc     ; [CPU_] |1215| 
	.dwpsn	file "../APP/Initial.c",line 1217,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1217| 
        ADDB      XAR5,#26              ; [CPU_U] |1217| 
        AND       *+XAR5[0],#0xfff3     ; [CPU_] |1217| 
	.dwpsn	file "../APP/Initial.c",line 1218,column 2,is_stmt
        AND       AL,@_EPwm6Regs+26,#0xfffc ; [CPU_] |1218| 
;** 1219	-----------------------    *((volatile struct ETSEL_BITS *)C$3+25L) |= 0x8u;
;** 1220	-----------------------    *(&EPwm6Regs+25L) = *(&EPwm6Regs+25L)&0xfff8u|2u;
;** 1221	-----------------------    *((volatile struct ETCLR_BITS *)C$3+28L) |= 1u;
;** 1230	-----------------------    asm(" EALLOW");
;** 1231	-----------------------    *(&EPwm7Regs+20L) = *((C$2 = &EPwm7Regs)+20L)&0xfffeu|2u;
;** 1232	-----------------------    *(&EPwm7Regs+20L) = *(&EPwm7Regs+20L)&0xfffbu|0x8u;
;** 1233	-----------------------    *((volatile struct AQSFRC_BITS *)C$2+13L) &= 0xff3fu;
;** 1234	-----------------------    asm(" EDIS");
;** 1235	-----------------------    EPwm7Regs.TBPRD = 2344u;
;** 1236	-----------------------    EPwm7Regs.TBPHS.half.TBPHS = 0u;
;** 1237	-----------------------    EPwm7Regs.TBCTR = 0u;
;** 1238	-----------------------    *(volatile unsigned *)C$2 &= 0xe3ffu;
;** 1239	-----------------------    *(volatile unsigned *)C$2 &= 0xfc7fu;
;** 1240	-----------------------    *(volatile unsigned *)C$2 = *(volatile unsigned *)C$2&0xfffeu|2u;
;** 1241	-----------------------    *(volatile unsigned *)C$2 &= 0xfffbu;
;** 1242	-----------------------    *(volatile unsigned *)C$2 &= 0xfff7u;
;** 1243	-----------------------    *(volatile unsigned *)C$2 |= 0x30u;
;** 1245	-----------------------    *((volatile struct CMPCTL_BITS *)C$2+7L) &= 0xffefu;
;** 1246	-----------------------    *(&EPwm7Regs+7L) &= 0xfffcu;
;** 1247	-----------------------    *(&EPwm7Regs+7L) &= 0xffbfu;
;** 1248	-----------------------    *(&EPwm7Regs+7L) &= 0xfff3u;
;** 1250	-----------------------    EPwm7Regs.AQCTLA.all = 1365u;
;** 1251	-----------------------    EPwm7Regs.AQCTLB.all = 1365u;
;** 1252	-----------------------    EPwm7Regs.CMPA.half.CMPA = 0xffffu;
;** 1253	-----------------------    EPwm7Regs.CMPB = 0xffffu;
;** 1254	-----------------------    *((volatile struct DBCTL_BITS *)C$2+15L) &= 0xfffcu;
;** 1255	-----------------------    *(&EPwm7Regs+15L) = *(&EPwm7Regs+15L)&0xfffbu|0x8u;
;** 1256	-----------------------    EPwm7Regs.DBFED = 333u;
;** 1257	-----------------------    EPwm7Regs.DBRED = 333u;
;** 1259	-----------------------    *((volatile struct ETPS_BITS *)C$2+26L) &= 0xfff3u;
;** 1261	-----------------------    *(&EPwm7Regs+26L) = *(&EPwm7Regs+26L)&0xfffcu|1u;
;** 1262	-----------------------    *((volatile struct ETSEL_BITS *)C$2+25L) &= 0xfff7u;
;** 1264	-----------------------    *(&EPwm7Regs+25L) = *(&EPwm7Regs+25L)&0xfff8u|1u;
;** 1265	-----------------------    *((volatile struct ETCLR_BITS *)C$2+28L) |= 1u;
;** 1268	-----------------------    asm(" EALLOW");
;** 1269	-----------------------    *(&EPwm8Regs+20L) = *((C$1 = &EPwm8Regs)+20L)&0xfffeu|2u;
;** 1270	-----------------------    *(&EPwm8Regs+20L) = *(&EPwm8Regs+20L)&0xfffbu|0x8u;
;** 1271	-----------------------    *((volatile struct AQSFRC_BITS *)C$1+13L) &= 0xff3fu;
;** 1273	-----------------------    asm(" EDIS");
;** 1274	-----------------------    EPwm8Regs.TBPRD = 1097u;
;** 1275	-----------------------    EPwm8Regs.TBPHS.half.TBPHS = 0u;
;** 1276	-----------------------    EPwm8Regs.TBCTR = 0u;
;** 1277	-----------------------    *(volatile unsigned *)C$1 &= 0xe3ffu;
;** 1278	-----------------------    *(volatile unsigned *)C$1 &= 0xfc7fu;
;** 1279	-----------------------    *(volatile unsigned *)C$1 = *(volatile unsigned *)C$1&0xfffeu|2u;
;** 1280	-----------------------    *(volatile unsigned *)C$1 &= 0xfffbu;
;** 1281	-----------------------    *(volatile unsigned *)C$1 &= 0xfff7u;
;** 1282	-----------------------    *(volatile unsigned *)C$1 |= 0x30u;
;** 1284	-----------------------    *((volatile struct CMPCTL_BITS *)C$1+7L) &= 0xffefu;
;** 1285	-----------------------    *(&EPwm8Regs+7L) &= 0xfffcu;
;** 1286	-----------------------    *(&EPwm8Regs+7L) &= 0xffbfu;
;** 1287	-----------------------    *(&EPwm8Regs+7L) = *(&EPwm8Regs+7L)&0xfff7u|4u;
;** 1289	-----------------------    EPwm8Regs.AQCTLA.all = 1365u;
;** 1290	-----------------------    EPwm8Regs.AQCTLB.all = 1365u;
;** 1291	-----------------------    EPwm8Regs.CMPA.half.CMPA = 0xffffu;
;** 1292	-----------------------    EPwm8Regs.CMPB = 0xffffu;
;** 1293	-----------------------    *((volatile struct DBCTL_BITS *)C$1+15L) &= 0xfffcu;
;** 1294	-----------------------    *(&EPwm8Regs+15L) = *(&EPwm8Regs+15L)&0xfffbu|0x8u;
;** 1295	-----------------------    EPwm8Regs.DBFED = 333u;
;** 1296	-----------------------    EPwm8Regs.DBRED = 333u;
;** 1298	-----------------------    *((volatile struct ETPS_BITS *)C$1+26L) &= 0xfff3u;
;** 1300	-----------------------    *(&EPwm8Regs+26L) = *(&EPwm8Regs+26L)&0xfffcu|1u;
;** 1301	-----------------------    *((volatile struct ETSEL_BITS *)C$1+25L) &= 0xfff7u;
;** 1303	-----------------------    *(&EPwm8Regs+25L) = *(&EPwm8Regs+25L)&0xfff8u|1u;
;** 1304	-----------------------    *((volatile struct ETCLR_BITS *)C$1+28L) |= 1u;
;** 1306	-----------------------    EPwm8Regs.AQCTLA.all = 0u;
;** 1307	-----------------------    *(&EPwm8Regs+11L) = *((volatile struct AQCTL_BITS *)C$1+11L)&0xffdfu|0x10u;
;** 1308	-----------------------    *(&EPwm8Regs+11L) = *(&EPwm8Regs+11L)&0xff7fu|0x40u;
;** 1309	-----------------------    EPwm8Regs.CMPA.half.CMPA = 1097u;
;** 1310	-----------------------    EPwm8Regs.AQCTLB.all = 0u;
;** 1311	-----------------------    *(&EPwm8Regs+12L) = *((volatile struct AQCTL_BITS *)C$1+12L)&0xfdffu|0x100u;
;** 1312	-----------------------    *(&EPwm8Regs+12L) = *(&EPwm8Regs+12L)&0xf7ffu|0x400u;
;** 1313	-----------------------    EPwm8Regs.CMPB = 0u;
;** 1315	-----------------------    asm(" EALLOW");
;** 1316	-----------------------    *(&SysCtrlRegs+12L) |= 4u;
;** 1317	-----------------------    asm(" EDIS");
;***  	-----------------------    return;
        ORB       AL,#0x01              ; [CPU_] |1218| 
	.dwpsn	file "../APP/Initial.c",line 1219,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1219| 
	.dwpsn	file "../APP/Initial.c",line 1218,column 2,is_stmt
        MOV       @_EPwm6Regs+26,AL     ; [CPU_] |1218| 
	.dwpsn	file "../APP/Initial.c",line 1221,column 2,is_stmt
        ADDB      XAR4,#28              ; [CPU_U] |1221| 
	.dwpsn	file "../APP/Initial.c",line 1219,column 2,is_stmt
        ADDB      XAR5,#25              ; [CPU_U] |1219| 
        OR        *+XAR5[0],#0x0008     ; [CPU_] |1219| 
	.dwpsn	file "../APP/Initial.c",line 1220,column 2,is_stmt
        AND       AL,@_EPwm6Regs+25,#0xfff8 ; [CPU_] |1220| 
        ORB       AL,#0x02              ; [CPU_] |1220| 
        MOV       @_EPwm6Regs+25,AL     ; [CPU_] |1220| 
	.dwpsn	file "../APP/Initial.c",line 1221,column 2,is_stmt
        OR        *+XAR4[0],#0x0001     ; [CPU_] |1221| 
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 1231,column 2,is_stmt
        MOVB      XAR0,#20              ; [CPU_] |1231| 
        MOVL      XAR4,#_EPwm7Regs      ; [CPU_U] |1231| 
        MOVW      DP,#_EPwm7Regs+20     ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 1233,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1233| 
	.dwpsn	file "../APP/Initial.c",line 1231,column 2,is_stmt
        AND       AL,*+XAR4[AR0],#0xfffe ; [CPU_] |1231| 
	.dwpsn	file "../APP/Initial.c",line 1233,column 2,is_stmt
        ADDB      XAR5,#13              ; [CPU_U] |1233| 
	.dwpsn	file "../APP/Initial.c",line 1231,column 2,is_stmt
        ORB       AL,#0x02              ; [CPU_] |1231| 
        MOV       @_EPwm7Regs+20,AL     ; [CPU_] |1231| 
	.dwpsn	file "../APP/Initial.c",line 1232,column 2,is_stmt
        AND       AL,@_EPwm7Regs+20,#0xfffb ; [CPU_] |1232| 
        ORB       AL,#0x08              ; [CPU_] |1232| 
        MOV       @_EPwm7Regs+20,AL     ; [CPU_] |1232| 
	.dwpsn	file "../APP/Initial.c",line 1233,column 2,is_stmt
        AND       *+XAR5[0],#0xff3f     ; [CPU_] |1233| 
 EDIS
...
$C$DW$135	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$126, DW_AT_TI_end_line(0x527)
...
$C$DW$136	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitECAP")
	...
	.dwattr $C$DW$136, DW_AT_TI_begin_line(0x52d)
	.dwattr $C$DW$136, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$136, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 1326,column 1,is_stmt,address _sInitECAP
...
;***************************************************************
_sInitECAP:
;** 1327	-----------------------    ECap1Regs.ECEINT.all = 0u;
;** 1328	-----------------------    ECap1Regs.ECCLR.all = 0xffffu;
;** 1329	-----------------------    *((C$2 = &ECap1Regs)+20L) &= 0xfeffu;
;** 1330	-----------------------    *((volatile struct ECCTL2_BITS *)C$2+21L) &= 0xffefu;
;** 1331	-----------------------    *(&ECap1Regs+21L) &= 0xfdffu;
;** 1332	-----------------------    *(&ECap1Regs+21L) |= 1u;
;** 1333	-----------------------    *(&ECap1Regs+21L) |= 0xc0u;
;** 1334	-----------------------    *(&ECap1Regs+21L) &= 0xffdfu;
;** 1335	-----------------------    *(&ECap1Regs+21L) &= 0xfff9u;
;** 1336	-----------------------    *(&ECap1Regs+20L) |= 1u;
;** 1337	-----------------------    *(&ECap1Regs+20L) &= 0xfffdu;
;** 1338	-----------------------    *(&ECap1Regs+20L) &= 0xc1ffu;
;** 1340	-----------------------    ECap2Regs.ECEINT.all = 0u;
;** 1341	-----------------------    ECap2Regs.ECCLR.all = 0xffffu;
;** 1342	-----------------------    *((C$1 = &ECap2Regs)+20L) &= 0xfeffu;
;** 1343	-----------------------    *((volatile struct ECCTL2_BITS *)C$1+21L) &= 0xffefu;
;** 1344	-----------------------    *(&ECap2Regs+21L) &= 0xfdffu;
;** 1345	-----------------------    *(&ECap2Regs+21L) |= 1u;
;** 1346	-----------------------    *(&ECap2Regs+21L) |= 0xc0u;
;** 1347	-----------------------    *(&ECap2Regs+21L) &= 0xffdfu;
;** 1348	-----------------------    *(&ECap2Regs+21L) &= 0xfff9u;
;** 1349	-----------------------    *(&ECap2Regs+20L) |= 1u;
;** 1350	-----------------------    *(&ECap2Regs+20L) &= 0xfffdu;
;** 1351	-----------------------    *(&ECap2Regs+20L) &= 0xc1ffu;
;** 1381	-----------------------    *(&ECap1Regs+21L) |= 0x8u;
;** 1382	-----------------------    *(&ECap1Regs+20L) |= 0x100u;
;** 1383	-----------------------    *((volatile struct ECEINT_BITS *)C$2+22L) |= 2u;
;** 1385	-----------------------    *(&ECap2Regs+21L) |= 0x8u;
;** 1386	-----------------------    *(&ECap2Regs+20L) |= 0x100u;
;** 1387	-----------------------    *((volatile struct ECEINT_BITS *)C$1+22L) |= 2u;
;** 1394	-----------------------    *(&ECap1Regs+21L) |= 0x10u;
;** 1395	-----------------------    *(&ECap2Regs+21L) |= 0x10u;
;** 1396	-----------------------    *(&ECap3Regs+21L) |= 0x10u;
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$138	.dwtag  DW_TAG_variable, DW_AT_name("$O$C2")
	...
	.dwpsn	file "../APP/Initial.c",line 1329,column 2,is_stmt
        MOVL      XAR4,#_ECap1Regs      ; [CPU_U] |1329| 
	.dwpsn	file "../APP/Initial.c",line 1327,column 2,is_stmt
        MOV       @_ECap1Regs+22,#0     ; [CPU_] |1327| 
	.dwpsn	file "../APP/Initial.c",line 1329,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1329| 
	.dwpsn	file "../APP/Initial.c",line 1328,column 2,is_stmt
        MOV       @_ECap1Regs+24,#65535 ; [CPU_] |1328| 
	.dwpsn	file "../APP/Initial.c",line 1329,column 2,is_stmt
        ADDB      XAR5,#20              ; [CPU_U] |1329| 
        AND       *+XAR5[0],#0xfeff     ; [CPU_] |1329| 
	.dwpsn	file "../APP/Initial.c",line 1330,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1330| 
        ADDB      XAR5,#21              ; [CPU_U] |1330| 
        AND       *+XAR5[0],#0xffef     ; [CPU_] |1330| 
	.dwpsn	file "../APP/Initial.c",line 1342,column 3,is_stmt
        MOVL      XAR5,#_ECap2Regs      ; [CPU_U] |1342| 
	.dwpsn	file "../APP/Initial.c",line 1331,column 2,is_stmt
        AND       @_ECap1Regs+21,#0xfdff ; [CPU_] |1331| 
	.dwpsn	file "../APP/Initial.c",line 1342,column 3,is_stmt
        MOVL      XAR6,XAR5             ; [CPU_] |1342| 
	.dwpsn	file "../APP/Initial.c",line 1383,column 3,is_stmt
        ADDB      XAR4,#22              ; [CPU_U] |1383| 
	.dwpsn	file "../APP/Initial.c",line 1332,column 2,is_stmt
        OR        @_ECap1Regs+21,#0x0001 ; [CPU_] |1332| 
	.dwpsn	file "../APP/Initial.c",line 1342,column 3,is_stmt
        ADDB      XAR6,#20              ; [CPU_U] |1342| 
	.dwpsn	file "../APP/Initial.c",line 1333,column 3,is_stmt
        OR        @_ECap1Regs+21,#0x00c0 ; [CPU_] |1333| 
	.dwpsn	file "../APP/Initial.c",line 1334,column 3,is_stmt
        AND       @_ECap1Regs+21,#0xffdf ; [CPU_] |1334| 
	.dwpsn	file "../APP/Initial.c",line 1335,column 3,is_stmt
        AND       @_ECap1Regs+21,#0xfff9 ; [CPU_] |1335| 
	.dwpsn	file "../APP/Initial.c",line 1336,column 3,is_stmt
        OR        @_ECap1Regs+20,#0x0001 ; [CPU_] |1336| 
	.dwpsn	file "../APP/Initial.c",line 1337,column 3,is_stmt
        AND       @_ECap1Regs+20,#0xfffd ; [CPU_] |1337| 
	.dwpsn	file "../APP/Initial.c",line 1338,column 3,is_stmt
        AND       @_ECap1Regs+20,#0xc1ff ; [CPU_] |1338| 
        MOVW      DP,#_ECap2Regs+22     ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 1340,column 2,is_stmt
        MOV       @_ECap2Regs+22,#0     ; [CPU_] |1340| 
	.dwpsn	file "../APP/Initial.c",line 1341,column 3,is_stmt
        MOV       @_ECap2Regs+24,#65535 ; [CPU_] |1341| 
	.dwpsn	file "../APP/Initial.c",line 1342,column 3,is_stmt
        AND       *+XAR6[0],#0xfeff     ; [CPU_] |1342| 
	.dwpsn	file "../APP/Initial.c",line 1343,column 3,is_stmt
        MOVL      XAR6,XAR5             ; [CPU_] |1343| 
        ADDB      XAR6,#21              ; [CPU_U] |1343| 
	.dwpsn	file "../APP/Initial.c",line 1387,column 3,is_stmt
        ADDB      XAR5,#22              ; [CPU_U] |1387| 
	.dwpsn	file "../APP/Initial.c",line 1343,column 3,is_stmt
        AND       *+XAR6[0],#0xffef     ; [CPU_] |1343| 
	.dwpsn	file "../APP/Initial.c",line 1344,column 3,is_stmt
        AND       @_ECap2Regs+21,#0xfdff ; [CPU_] |1344| 
	.dwpsn	file "../APP/Initial.c",line 1345,column 2,is_stmt
        OR        @_ECap2Regs+21,#0x0001 ; [CPU_] |1345| 
	.dwpsn	file "../APP/Initial.c",line 1346,column 2,is_stmt
        OR        @_ECap2Regs+21,#0x00c0 ; [CPU_] |1346| 
	.dwpsn	file "../APP/Initial.c",line 1347,column 2,is_stmt
        AND       @_ECap2Regs+21,#0xffdf ; [CPU_] |1347| 
	.dwpsn	file "../APP/Initial.c",line 1348,column 3,is_stmt
        AND       @_ECap2Regs+21,#0xfff9 ; [CPU_] |1348| 
	.dwpsn	file "../APP/Initial.c",line 1349,column 3,is_stmt
        OR        @_ECap2Regs+20,#0x0001 ; [CPU_] |1349| 
	.dwpsn	file "../APP/Initial.c",line 1350,column 3,is_stmt
        AND       @_ECap2Regs+20,#0xfffd ; [CPU_] |1350| 
	.dwpsn	file "../APP/Initial.c",line 1351,column 3,is_stmt
        AND       @_ECap2Regs+20,#0xc1ff ; [CPU_] |1351| 
        MOVW      DP,#_ECap1Regs+21     ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 1381,column 2,is_stmt
        OR        @_ECap1Regs+21,#0x0008 ; [CPU_] |1381| 
	.dwpsn	file "../APP/Initial.c",line 1382,column 3,is_stmt
        OR        @_ECap1Regs+20,#0x0100 ; [CPU_] |1382| 
        MOVW      DP,#_ECap2Regs+21     ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 1383,column 3,is_stmt
        OR        *+XAR4[0],#0x0002     ; [CPU_] |1383| 
	.dwpsn	file "../APP/Initial.c",line 1385,column 3,is_stmt
        OR        @_ECap2Regs+21,#0x0008 ; [CPU_] |1385| 
	.dwpsn	file "../APP/Initial.c",line 1386,column 3,is_stmt
        OR        @_ECap2Regs+20,#0x0100 ; [CPU_] |1386| 
        MOVW      DP,#_ECap1Regs+21     ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 1387,column 3,is_stmt
        OR        *+XAR5[0],#0x0002     ; [CPU_] |1387| 
	.dwpsn	file "../APP/Initial.c",line 1394,column 3,is_stmt
        OR        @_ECap1Regs+21,#0x0010 ; [CPU_] |1394| 
        MOVW      DP,#_ECap2Regs+21     ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 1395,column 3,is_stmt
        OR        @_ECap2Regs+21,#0x0010 ; [CPU_] |1395| 
        MOVW      DP,#_ECap3Regs+21     ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 1396,column 2,is_stmt
        OR        @_ECap3Regs+21,#0x0010 ; [CPU_] |1396| 
$C$DW$139	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$136, DW_AT_TI_end_line(0x57f)
...
$C$DW$140	.dwtag  DW_TAG_subprogram, DW_AT_name("DelayUs")
	...
	.dwattr $C$DW$140, DW_AT_TI_begin_line(0x5b1)
	.dwattr $C$DW$140, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$140, DW_AT_TI_max_frame_size(-4)
	.dwpsn	file "../APP/Initial.c",line 1458,column 1,is_stmt,address _DelayUs
...
$C$DW$143	.dwtag  DW_TAG_variable, DW_AT_name("Usec")
	...
	.dwattr $C$DW$143, DW_AT_location[DW_OP_breg20 -1]
        MOV       *-SP[1],AL            ; [CPU_] |1458| 
	.dwpsn	file "../APP/Initial.c",line 1459,column 5,is_stmt
        DEC       *-SP[1]               ; [CPU_] |1459| 
        B         $C$L9,UNC             ; [CPU_] |1459| 
        ; branch occurs ; [] |1459| 
$C$L8:    
$C$DW$L$_DelayUs$2$B:
;***	-----------------------g2:
;** 1461	-----------------------    asm(" RPT #100 || NOP");
;** 1462	-----------------------    Usec = Usec-1u;
 RPT #100 || NOP
...
$C$DW$L$_DelayUs$3$B:
;***	-----------------------g3:
;** 1462	-----------------------    if ( Usec != 0xffffu ) goto g2;
;***  	-----------------------    return;
	.dwpsn	file "../APP/Initial.c",line 1462,column 2,is_stmt
        CMP       *-SP[1],#65535        ; [CPU_] |1462| 
        BF        $C$L8,NEQ             ; [CPU_] |1462| 
...
$C$DW$145	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$145, DW_AT_name("D:\CCS_Code\IVEM3024_ALL\IVEM3024_28066\IVEM3024_28066_V3.07 20241213\IVEM3024\Debug\Initial.asm:$C$L9:1:1743662332")
	.dwattr $C$DW$145, DW_AT_TI_begin_file("../APP/Initial.c")
	.dwattr $C$DW$145, DW_AT_TI_begin_line(0x5b3)
	.dwattr $C$DW$145, DW_AT_TI_end_line(0x5b6)
...
$C$DW$147	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$140, DW_AT_TI_end_line(0x5b8)
...
$C$DW$148	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitAdc")
	...
	.dwattr $C$DW$148, DW_AT_TI_begin_line(0x224)
	.dwattr $C$DW$148, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$148, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 549,column 1,is_stmt,address _sInitAdc
...
_sInitAdc:
;*** 560	-----------------------    asm(" EALLOW");
;*** 561	-----------------------    *(&SysCtrlRegs+12L) |= 0x8u;
;*** 562	-----------------------    (*(void (*)())0x3d7c80uL)();
;*** 563	-----------------------    asm(" EDIS");
;*** 578	-----------------------    asm(" EALLOW");
;*** 579	-----------------------    *(C$1 = &AdcRegs) |= 0x40u;
;*** 580	-----------------------    *C$1 |= 0x20u;
;*** 581	-----------------------    *C$1 |= 0x80u;
;*** 582	-----------------------    *C$1 |= 0x4000u;
;*** 583	-----------------------    *C$1 &= 0xfff7u;
...
;*** 586	-----------------------    DelayUs(5555u);
;*** 588	-----------------------    asm(" EALLOW");
;*** 590	-----------------------    *((volatile struct ADCCTL2_BITS *)C$1+1L) |= 1u;
;*** 591	-----------------------    *(&AdcRegs+1L) &= 0xfffbu;
;*** 593	-----------------------    *(&AdcRegs+1L) |= 2u;
;*** 594	-----------------------    asm(" EDIS");
;*** 596	-----------------------    DelayUs(5555u);
;*** 598	-----------------------    asm(" EALLOW");
;*** 600	-----------------------    *((volatile struct SOCPRICTL_BITS *)C$1+16L) |= 0x8000u;
;*** 602	-----------------------    *((volatile struct ADCSOCxCTL_BITS *)C$1+32L) &= 0xfc3fu;
;*** 603	-----------------------    *(&AdcRegs+33L) = *((volatile struct ADCSOCxCTL_BITS *)C$1+33L)&0xfc7fu|0x40u;
;*** 604	-----------------------    *(&AdcRegs+34L) = *((volatile struct ADCSOCxCTL_BITS *)C$1+34L)&0xfc3fu|0x80u;
;*** 605	-----------------------    *(&AdcRegs+35L) = *((volatile struct ADCSOCxCTL_BITS *)C$1+35L)&0xfcffu|0xc0u;
;*** 606	-----------------------    *(&AdcRegs+36L) = *((volatile struct ADCSOCxCTL_BITS *)C$1+36L)&0xfc3fu|0x100u;
;*** 607	-----------------------    *(&AdcRegs+37L) = *((volatile struct ADCSOCxCTL_BITS *)C$1+37L)&0xfc7fu|0x140u;
;*** 608	-----------------------    *(&AdcRegs+38L) = *((volatile struct ADCSOCxCTL_BITS *)C$1+38L)&0xfc3fu|0x180u;
;*** 609	-----------------------    *(&AdcRegs+39L) = *((volatile struct ADCSOCxCTL_BITS *)C$1+39L)&0xfdffu|0x1c0u;
;*** 610	-----------------------    *(&AdcRegs+40L) = *((volatile struct ADCSOCxCTL_BITS *)C$1+40L)&0xfe3fu|0x200u;
;*** 611	-----------------------    *(&AdcRegs+41L) = *((volatile struct ADCSOCxCTL_BITS *)C$1+41L)&0xfe7fu|0x240u;
;*** 612	-----------------------    *(&AdcRegs+42L) = *((volatile struct ADCSOCxCTL_BITS *)C$1+42L)&0xfe3fu|0x280u;
;*** 613	-----------------------    *(&AdcRegs+43L) = *((volatile struct ADCSOCxCTL_BITS *)C$1+43L)&0xfeffu|0x2c0u;
;*** 614	-----------------------    *(&AdcRegs+44L) = *((volatile struct ADCSOCxCTL_BITS *)C$1+44L)&0xff3fu|0x300u;
;*** 615	-----------------------    *(&AdcRegs+45L) = *((volatile struct ADCSOCxCTL_BITS *)C$1+45L)&0xff7fu|0x340u;
;*** 616	-----------------------    *(&AdcRegs+46L) = *((volatile struct ADCSOCxCTL_BITS *)C$1+46L)&0xffbfu|0x380u;
;*** 617	-----------------------    *((volatile struct ADCSOCxCTL_BITS *)C$1+47L) |= 0x3c0u;
;*** 619	-----------------------    *(&AdcRegs+32L) = *(&AdcRegs+32L)&0xffc0u|6u;
;*** 620	-----------------------    *(&AdcRegs+33L) = *(&AdcRegs+33L)&0xffc0u|6u;
;*** 621	-----------------------    *(&AdcRegs+34L) = *(&AdcRegs+34L)&0xffc0u|6u;
;*** 622	-----------------------    *(&AdcRegs+35L) = *(&AdcRegs+35L)&0xffc0u|6u;
;*** 623	-----------------------    *(&AdcRegs+36L) = *(&AdcRegs+36L)&0xffc0u|6u;
;*** 624	-----------------------    *(&AdcRegs+37L) = *(&AdcRegs+37L)&0xffc0u|6u;
;*** 625	-----------------------    *(&AdcRegs+38L) = *(&AdcRegs+38L)&0xffc0u|6u;
;*** 626	-----------------------    *(&AdcRegs+39L) = *(&AdcRegs+39L)&0xffc0u|6u;
;*** 627	-----------------------    *(&AdcRegs+40L) = *(&AdcRegs+40L)&0xffc0u|6u;
;*** 628	-----------------------    *(&AdcRegs+41L) = *(&AdcRegs+41L)&0xffc0u|6u;
;*** 629	-----------------------    *(&AdcRegs+42L) = *(&AdcRegs+42L)&0xffc0u|6u;
;*** 630	-----------------------    *(&AdcRegs+43L) = *(&AdcRegs+43L)&0xffc0u|6u;
;*** 631	-----------------------    *(&AdcRegs+44L) = *(&AdcRegs+44L)&0xffc0u|6u;
;*** 632	-----------------------    *(&AdcRegs+45L) = *(&AdcRegs+45L)&0xffc0u|6u;
;*** 633	-----------------------    *(&AdcRegs+46L) = *(&AdcRegs+46L)&0xffc0u|6u;
;*** 634	-----------------------    *(&AdcRegs+47L) = *(&AdcRegs+47L)&0xffc0u|6u;
;*** 636	-----------------------    *(&AdcRegs+32L) &= 0x7ffu;
;*** 637	-----------------------    *(&AdcRegs+33L) &= 0x7ffu;
;*** 638	-----------------------    *(&AdcRegs+34L) &= 0x7ffu;
;*** 639	-----------------------    *(&AdcRegs+35L) &= 0x7ffu;
;*** 640	-----------------------    *(&AdcRegs+36L) &= 0x7ffu;
;*** 641	-----------------------    *(&AdcRegs+37L) &= 0x7ffu;
;*** 642	-----------------------    *(&AdcRegs+38L) &= 0x7ffu;
;*** 643	-----------------------    *(&AdcRegs+39L) &= 0x7ffu;
;*** 644	-----------------------    *(&AdcRegs+40L) &= 0x7ffu;
;*** 645	-----------------------    *(&AdcRegs+41L) &= 0x7ffu;
;*** 646	-----------------------    *(&AdcRegs+42L) &= 0x7ffu;
;*** 647	-----------------------    *(&AdcRegs+43L) &= 0x7ffu;
;*** 648	-----------------------    *(&AdcRegs+44L) &= 0x7ffu;
;*** 649	-----------------------    *(&AdcRegs+45L) &= 0x7ffu;
;*** 650	-----------------------    *(&AdcRegs+46L) &= 0x7ffu;
;*** 651	-----------------------    *(&AdcRegs+47L) &= 0x7ffu;
;*** 652	-----------------------    asm(" EDIS");
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
...
$C$DW$149	.dwtag  DW_TAG_variable, DW_AT_name("$O$C1")
 ...
 EALLOW
        MOVW      DP,#_SysCtrlRegs+12   ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 562,column 3,is_stmt
        MOVL      XAR7,#4029568         ; [CPU_U] |562| 
        SPM       #0                    ; [CPU_] 
	.dwpsn	file "../APP/Initial.c",line 561,column 3,is_stmt
        OR        @_SysCtrlRegs+12,#0x0008 ; [CPU_] |561| 
	.dwpsn	file "../APP/Initial.c",line 562,column 3,is_stmt
...
$C$DW$153	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$148, DW_AT_TI_end_line(0x28d)
...
$C$DW$154	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitGpio")
	...
	.dwattr $C$DW$154, DW_AT_TI_begin_line(0x294)
	.dwattr $C$DW$154, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$154, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 661,column 1,is_stmt,address _sInitGpio
...
_sInitGpio:
;*** 662	-----------------------    asm(" EALLOW");
;*** 664	-----------------------    *((C$1 = &GpioCtrlRegs)+12L) &= 0xfffeu;
;*** 665	-----------------------    *(&GpioCtrlRegs+6L) = *((volatile struct GPA1_BITS *)C$1+6L)&0xfffcu|1u;
;*** 667	-----------------------    *(&GpioCtrlRegs+12L) &= 0xfffdu;
;*** 668	-----------------------    *(&GpioCtrlRegs+6L) = *(&GpioCtrlRegs+6L)&0xfff7u|4u;
;*** 670	-----------------------    *(&GpioCtrlRegs+12L) &= 0xfffbu;
;*** 671	-----------------------    *(&GpioCtrlRegs+6L) = *(&GpioCtrlRegs+6L)&0xffdfu|0x10u;
;*** 673	-----------------------    *(&GpioCtrlRegs+12L) &= 0xfff7u;
;*** 674	-----------------------    *(&GpioCtrlRegs+6L) = *(&GpioCtrlRegs+6L)&0xff7fu|0x40u;
;*** 676	-----------------------    *(&GpioCtrlRegs+12L) &= 0xffefu;
;*** 677	-----------------------    *((C$2 = &GpioDataRegs)+4L) |= 0x10u;
;*** 678	-----------------------    ((volatile unsigned *)C$1)[10] |= 0x10u;
;*** 679	-----------------------    *(&GpioCtrlRegs+6L) &= 0xfcffu;
;*** 681	-----------------------    *(&GpioCtrlRegs+12L) &= 0xffdfu;
;*** 682	-----------------------    ((volatile unsigned *)C$2)[2] |= 0x20u;
;*** 683	-----------------------    *(&GpioCtrlRegs+10L) |= 0x20u;
;*** 684	-----------------------    *(&GpioCtrlRegs+6L) &= 0xf3ffu;
;*** 686	-----------------------    *(&GpioCtrlRegs+12L) &= 0xffbfu;
;*** 687	-----------------------    *(&GpioCtrlRegs+6L) = *(&GpioCtrlRegs+6L)&0xdfffu|0x1000u;
;*** 689	-----------------------    *(&GpioCtrlRegs+12L) &= 0xff7fu;
;*** 690	-----------------------    *(&GpioDataRegs+4L) |= 0x80u;
;*** 691	-----------------------    *(&GpioCtrlRegs+10L) |= 0x80u;
;*** 692	-----------------------    *(&GpioCtrlRegs+6L) &= 0x3fffu;
;*** 694	-----------------------    *(&GpioCtrlRegs+12L) &= 0xfeffu;
;*** 695	-----------------------    *(&GpioCtrlRegs+7L) = *((volatile struct GPA1_BITS *)C$1+7L)&0xfffcu|1u;
;*** 697	-----------------------    *(&GpioCtrlRegs+12L) &= 0xfdffu;
;*** 698	-----------------------    *(&GpioDataRegs+4L) |= 0x200u;
;*** 699	-----------------------    *(&GpioCtrlRegs+10L) |= 0x200u;
;*** 700	-----------------------    *(&GpioCtrlRegs+7L) &= 0xfff3u;
;*** 702	-----------------------    *(&GpioCtrlRegs+12L) &= 0xfbffu;
;*** 703	-----------------------    *(&GpioDataRegs+4L) |= 0x400u;
;*** 704	-----------------------    *(&GpioCtrlRegs+10L) |= 0x400u;
;*** 705	-----------------------    *(&GpioCtrlRegs+7L) &= 0xffcfu;
;*** 707	-----------------------    *(&GpioCtrlRegs+12L) &= 0xf7ffu;
;*** 708	-----------------------    *(&GpioDataRegs+2L) |= 0x800u;
;*** 709	-----------------------    *(&GpioCtrlRegs+10L) |= 0x800u;
;*** 710	-----------------------    *(&GpioCtrlRegs+7L) &= 0xff3fu;
;*** 712	-----------------------    *(&GpioCtrlRegs+12L) &= 0xefffu;
;*** 713	-----------------------    *(&GpioDataRegs+2L) |= 0x1000u;
;*** 714	-----------------------    *(&GpioCtrlRegs+7L) &= 0xfcffu;
;*** 715	-----------------------    *(&GpioCtrlRegs+10L) |= 0x1000u;
;*** 717	-----------------------    *(&GpioCtrlRegs+12L) &= 0xdfffu;
;*** 718	-----------------------    *(&GpioDataRegs+4L) |= 0x2000u;
;*** 719	-----------------------    *(&GpioCtrlRegs+7L) &= 0xf3ffu;
;*** 720	-----------------------    *(&GpioCtrlRegs+10L) &= 0xdfffu;
;*** 722	-----------------------    *(&GpioCtrlRegs+12L) &= 0xbfffu;
;*** 723	-----------------------    *(&GpioDataRegs+2L) |= 0x4000u;
;*** 724	-----------------------    *(&GpioCtrlRegs+7L) &= 0xcfffu;
;*** 725	-----------------------    *(&GpioCtrlRegs+10L) |= 0x4000u;
;*** 727	-----------------------    *(&GpioCtrlRegs+12L) &= 0x7fffu;
;*** 728	-----------------------    *((volatile struct GPA1_BITS *)C$1+3L) &= 0x3fffu;
;*** 729	-----------------------    *(&GpioCtrlRegs+7L) = *(&GpioCtrlRegs+7L)&0x3fffu|0x4000u;
;*** 731	-----------------------    ((volatile unsigned *)C$1)[13] &= 0xfffeu;
;*** 732	-----------------------    ((volatile unsigned *)C$2)[3] |= 1u;
;*** 733	-----------------------    *((volatile struct GPA2_BITS *)C$1+8L) &= 0xfffcu;
;*** 734	-----------------------    ((volatile unsigned *)C$1)[11] |= 1u;
;*** 736	-----------------------    *(&GpioCtrlRegs+13L) &= 0xfffdu;
;*** 737	-----------------------    *(&GpioDataRegs+3L) |= 2u;
;*** 738	-----------------------    *(&GpioCtrlRegs+8L) &= 0xfff3u;
;*** 739	-----------------------    *(&GpioCtrlRegs+11L) |= 2u;
;*** 741	-----------------------    *(&GpioCtrlRegs+13L) &= 0xfffbu;
;*** 742	-----------------------    ((volatile unsigned *)C$2)[5] |= 4u;
;*** 743	-----------------------    *(&GpioCtrlRegs+8L) &= 0xffcfu;
;*** 744	-----------------------    *(&GpioCtrlRegs+11L) |= 4u;
;*** 746	-----------------------    *(&GpioCtrlRegs+13L) |= 0x8u;
;*** 747	-----------------------    *(&GpioDataRegs+5L) |= 0x8u;
;*** 748	-----------------------    *(&GpioCtrlRegs+8L) &= 0xff3fu;
;*** 749	-----------------------    *(&GpioCtrlRegs+11L) |= 0x8u;
;*** 751	-----------------------    *(&GpioCtrlRegs+13L) &= 0xffefu;
;*** 752	-----------------------    *(&GpioDataRegs+5L) |= 0x10u;
;*** 753	-----------------------    *(&GpioCtrlRegs+8L) &= 0xfcffu;
;*** 754	-----------------------    *(&GpioCtrlRegs+11L) |= 0x10u;
;*** 756	-----------------------    *(&GpioCtrlRegs+13L) |= 0x20u;
;*** 757	-----------------------    *(&GpioDataRegs+5L) |= 0x20u;
;*** 758	-----------------------    *(&GpioCtrlRegs+8L) &= 0xf3ffu;
;*** 759	-----------------------    *(&GpioCtrlRegs+11L) |= 0x20u;
;*** 762	-----------------------    *(&GpioCtrlRegs+13L) &= 0xffbfu;
;*** 763	-----------------------    *(&GpioCtrlRegs+8L) |= 0x3000u;
;*** 765	-----------------------    *(&GpioCtrlRegs+13L) &= 0xff7fu;
;*** 766	-----------------------    *((volatile struct GPA2_BITS *)C$1+4L) |= 0xc000u;
;*** 767	-----------------------    *(&GpioCtrlRegs+8L) |= 0xc000u;
;*** 769	-----------------------    *(&GpioCtrlRegs+13L) &= 0xfeffu;
;*** 770	-----------------------    *(&GpioCtrlRegs+5L) = *((volatile struct GPA2_BITS *)C$1+5L)&0xfffcu|1u;
;*** 771	-----------------------    *(&GpioCtrlRegs+9L) = *((volatile struct GPA2_BITS *)C$1+9L)&0xfffcu|1u;
;*** 773	-----------------------    *(&GpioCtrlRegs+13L) &= 0xfdffu;
;*** 774	-----------------------    *(&GpioDataRegs+5L) |= 0x200u;
;*** 775	-----------------------    *(&GpioCtrlRegs+9L) &= 0xfff3u;
;*** 776	-----------------------    *(&GpioCtrlRegs+11L) |= 0x200u;
;*** 781	-----------------------    *(&GpioCtrlRegs+13L) &= 0xfbffu;
;*** 782	-----------------------    *(&GpioDataRegs+3L) |= 0x400u;
;*** 783	-----------------------    *(&GpioCtrlRegs+9L) &= 0xffcfu;
;*** 784	-----------------------    *(&GpioCtrlRegs+11L) |= 0x400u;
;*** 786	-----------------------    *(&GpioCtrlRegs+13L) &= 0xf7ffu;
;*** 787	-----------------------    *(&GpioDataRegs+5L) |= 0x800u;
;*** 788	-----------------------    *(&GpioCtrlRegs+9L) &= 0xff3fu;
;*** 789	-----------------------    *(&GpioCtrlRegs+11L) |= 0x800u;
;*** 792	-----------------------    *(&GpioCtrlRegs+13L) &= 0xefffu;
;*** 793	-----------------------    *(&GpioCtrlRegs+5L) |= 0x300u;
;*** 794	-----------------------    *(&GpioCtrlRegs+9L) = *(&GpioCtrlRegs+9L)&0xfdffu|0x100u;
;*** 795	-----------------------    *(&GpioCtrlRegs+13L) &= 0xdfffu;
;*** 796	-----------------------    *(&GpioCtrlRegs+9L) = *(&GpioCtrlRegs+9L)&0xf7ffu|0x400u;
;*** 798	-----------------------    *(&GpioCtrlRegs+13L) &= 0x7fffu;
;*** 799	-----------------------    *(&GpioCtrlRegs+9L) = *(&GpioCtrlRegs+9L)&0x3fffu|0x4000u;
;*** 800	-----------------------    *(&GpioCtrlRegs+13L) &= 0xbfffu;
;*** 801	-----------------------    *(&GpioCtrlRegs+5L) |= 0x3000u;
;*** 802	-----------------------    *(&GpioCtrlRegs+9L) = *(&GpioCtrlRegs+9L)&0xdfffu|0x1000u;
;*** 804	-----------------------    *((volatile struct GPBDAT_BITS *)C$1+28L) &= 0xfffeu;
;*** 805	-----------------------    *((volatile struct GPBDAT_BITS *)C$2+10L) |= 1u;
;*** 806	-----------------------    *((volatile struct GPB1_BITS *)C$1+22L) &= 0xfffcu;
;*** 807	-----------------------    *((volatile struct GPBDAT_BITS *)C$1+26L) |= 1u;
;*** 809	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfffdu;
;*** 810	-----------------------    *(&GpioDataRegs+10L) |= 2u;
;*** 811	-----------------------    *(&GpioCtrlRegs+22L) &= 0xfff3u;
;*** 812	-----------------------    *(&GpioCtrlRegs+26L) |= 2u;
;*** 814	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfffbu;
;*** 815	-----------------------    *(&GpioDataRegs+10L) |= 4u;
;*** 816	-----------------------    *(&GpioCtrlRegs+22L) &= 0xffcfu;
;*** 817	-----------------------    *(&GpioCtrlRegs+26L) |= 4u;
;*** 819	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfff7u;
;*** 820	-----------------------    *((volatile struct GPBDAT_BITS *)C$2+12L) |= 0x8u;
;*** 821	-----------------------    *(&GpioCtrlRegs+22L) &= 0xff3fu;
;*** 822	-----------------------    *(&GpioCtrlRegs+26L) &= 0xfff7u;
;*** 824	-----------------------    *(&GpioCtrlRegs+28L) &= 0xffefu;
;*** 825	-----------------------    *(&GpioDataRegs+12L) |= 0x10u;
;*** 826	-----------------------    *(&GpioCtrlRegs+22L) &= 0xfcffu;
;*** 827	-----------------------    *(&GpioCtrlRegs+26L) &= 0xffefu;
;*** 829	-----------------------    *(&GpioCtrlRegs+28L) &= 0xffdfu;
;*** 830	-----------------------    *(&GpioDataRegs+10L) |= 0x20u;
;*** 831	-----------------------    *(&GpioCtrlRegs+22L) &= 0xf3ffu;
;*** 832	-----------------------    *(&GpioCtrlRegs+26L) |= 0x20u;
;*** 834	-----------------------    *(&GpioCtrlRegs+28L) &= 0xffbfu;
;*** 835	-----------------------    *(&GpioDataRegs+12L) |= 0x40u;
;*** 836	-----------------------    *(&GpioCtrlRegs+22L) &= 0xcfffu;
;*** 837	-----------------------    *(&GpioCtrlRegs+26L) &= 0xffbfu;
;*** 839	-----------------------    *(&GpioCtrlRegs+28L) |= 0x80u;
;*** 840	-----------------------    *(&GpioDataRegs+12L) |= 0x80u;
;*** 841	-----------------------    *(&GpioCtrlRegs+22L) &= 0x3fffu;
;*** 842	-----------------------    *(&GpioCtrlRegs+26L) |= 0x80u;
;*** 844	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfeffu;
;*** 845	-----------------------    *(&GpioCtrlRegs+23L) = *((volatile struct GPB1_BITS *)C$1+23L)&0xfffcu|1u;
;*** 847	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfdffu;
;*** 848	-----------------------    *(&GpioCtrlRegs+23L) = *(&GpioCtrlRegs+23L)&0xfff7u|4u;
;*** 850	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfbffu;
;*** 851	-----------------------    *(&GpioCtrlRegs+23L) = *(&GpioCtrlRegs+23L)&0xffdfu|0x10u;
;*** 853	-----------------------    *(&GpioCtrlRegs+28L) &= 0xf7ffu;
;*** 854	-----------------------    *(&GpioCtrlRegs+23L) = *(&GpioCtrlRegs+23L)&0xff7fu|0x40u;
;*** 856	-----------------------    *(&GpioCtrlRegs+28L) &= 0xefffu;
;*** 857	-----------------------    *(&GpioDataRegs+12L) |= 0x1000u;
;*** 858	-----------------------    *(&GpioCtrlRegs+23L) &= 0xfcffu;
;*** 859	-----------------------    *(&GpioCtrlRegs+26L) |= 0x1000u;
;*** 861	-----------------------    *((volatile struct GPBDAT_BITS *)C$1+29L) &= 0xfffbu;
;*** 862	-----------------------    *((volatile struct GPBDAT_BITS *)C$2+13L) |= 4u;
;*** 863	-----------------------    *((volatile struct GPB2_BITS *)C$1+24L) &= 0xffcfu;
;*** 864	-----------------------    *((volatile struct GPBDAT_BITS *)C$1+27L) &= 0xfffbu;
;*** 866	-----------------------    *(&GpioCtrlRegs+29L) &= 0xfff7u;
;*** 867	-----------------------    *(&GpioDataRegs+13L) |= 0x8u;
;*** 868	-----------------------    *(&GpioCtrlRegs+24L) &= 0xff3fu;
;*** 869	-----------------------    *(&GpioCtrlRegs+27L) |= 0x8u;
;*** 871	-----------------------    *(&GpioCtrlRegs+29L) &= 0xffefu;
;*** 872	-----------------------    *(&GpioDataRegs+13L) |= 0x10u;
;*** 873	-----------------------    *(&GpioCtrlRegs+24L) &= 0xfcffu;
;*** 874	-----------------------    *(&GpioCtrlRegs+27L) |= 0x10u;
;*** 876	-----------------------    *(&GpioCtrlRegs+29L) &= 0xffdfu;
;*** 877	-----------------------    *(&GpioDataRegs+13L) |= 0x20u;
;*** 878	-----------------------    *(&GpioCtrlRegs+24L) &= 0xf3ffu;
;*** 879	-----------------------    *(&GpioCtrlRegs+27L) &= 0xffdfu;
;*** 881	-----------------------    *(&GpioCtrlRegs+29L) &= 0xffbfu;
;*** 882	-----------------------    *(&GpioDataRegs+13L) |= 0x40u;
;*** 883	-----------------------    *(&GpioCtrlRegs+24L) &= 0xcfffu;
;*** 884	-----------------------    *(&GpioCtrlRegs+27L) |= 0x40u;
;*** 886	-----------------------    *(&GpioCtrlRegs+29L) &= 0xff7fu;
;*** 887	-----------------------    *(&GpioDataRegs+13L) |= 0x80u;
;*** 888	-----------------------    *(&GpioCtrlRegs+24L) &= 0x3fffu;
;*** 889	-----------------------    *(&GpioCtrlRegs+27L) |= 0x80u;
;*** 891	-----------------------    *(&GpioCtrlRegs+29L) &= 0xfeffu;
;*** 892	-----------------------    *(&GpioDataRegs+13L) |= 0x100u;
;*** 893	-----------------------    *((volatile struct GPB2_BITS *)C$1+25L) &= 0xfffcu;
;*** 894	-----------------------    *(&GpioCtrlRegs+27L) |= 0x100u;
;*** 896	-----------------------    *(&GpioCtrlRegs+29L) |= 0x200u;
;*** 897	-----------------------    *(&GpioDataRegs+13L) |= 0x200u;
;*** 898	-----------------------    *(&GpioCtrlRegs+25L) &= 0xfff3u;
;*** 899	-----------------------    *(&GpioCtrlRegs+27L) |= 0x200u;
;*** 901	-----------------------    *(&GpioCtrlRegs+29L) |= 0x400u;
;*** 902	-----------------------    *(&GpioDataRegs+13L) |= 0x400u;
;*** 903	-----------------------    *(&GpioCtrlRegs+25L) &= 0xffcfu;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
;* AR4   assigned to $O$C1
...
$C$DW$156	.dwtag  DW_TAG_variable, DW_AT_name("$O$C2")
 ...
 EALLOW
	...
	.dwpsn	file "../APP/Initial.c",line 720,column 2,is_stmt
        AND       @_GpioCtrlRegs+10,#0xdfff ; [CPU_] |720| 
...
$C$DW$157	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$154, DW_AT_TI_end_line(0x38c)
...
$C$DW$158	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitSCI")
	...
	.dwattr $C$DW$158, DW_AT_TI_begin_line(0x580)
	.dwattr $C$DW$158, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$158, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 1409,column 1,is_stmt,address _sInitSCI
...
;***************************************************************
_sInitSCI:
;** 1411	-----------------------    SciaRegs.SCICCR.all = 7u;
;** 1413	-----------------------    SciaRegs.SCICTL1.all = 3u;
;** 1415	-----------------------    SciaRegs.SCIHBAUD = 0u;
;** 1416	-----------------------    SciaRegs.SCILBAUD = 145u;
;** 1422	-----------------------    SciaRegs.SCICTL2.all = 3u;
;** 1423	-----------------------    SciaRegs.SCICTL1.all = 35u;
;** 1426	-----------------------    ScibRegs.SCICCR.all = 7u;
;** 1428	-----------------------    ScibRegs.SCICTL1.all = 3u;
;** 1434	-----------------------    ScibRegs.SCIHBAUD = 2u;
;** 1435	-----------------------    ScibRegs.SCILBAUD = 73u;
;** 1438	-----------------------    ScibRegs.SCICTL2.all = 3u;
;** 1439	-----------------------    ScibRegs.SCICTL1.all = 35u;
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$159	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$158, DW_AT_TI_end_line(0x5a0)
...
;*** 247	-----------------------    IFR = 0u;
;*** 249	-----------------------    asm(" EALLOW");
;*** 250	-----------------------    *((C$2 = &GpioCtrlRegs)+28L) &= 0xfbffu;
;*** 251	-----------------------    *(&GpioDataRegs+12L) |= 0x400u;
;*** 252	-----------------------    *((volatile struct GPB1_BITS *)C$2+23L) &= 0xffcfu;
;*** 253	-----------------------    ((volatile unsigned *)C$2)[26] |= 0x400u;
;*** 255	-----------------------    *(&GpioCtrlRegs+28L) &= 0xf7ffu;
;*** 256	-----------------------    *(&GpioDataRegs+12L) |= 0x800u;
;*** 257	-----------------------    *(&GpioCtrlRegs+23L) &= 0xff3fu;
;*** 258	-----------------------    *(&GpioCtrlRegs+26L) |= 0x800u;
;*** 259	-----------------------    asm(" EDIS");
;*** 263	-----------------------    sInitPieCtrl();
;*** 269	-----------------------    sInitPieVectTable();
;*** 272	-----------------------    MemCopy(&RamfuncsLoadStart, &RamfuncsLoadEnd, &RamfuncsRunStart);
;*** 273	-----------------------    sInitFlash();
;*** 276	-----------------------    sInitEPWM();
;*** 277	-----------------------    sInitECAP();
;*** 280	-----------------------    sInitAdc();
...
$C$DW$163	.dwtag  DW_TAG_TI_branch
 ...
 setc INTM
	...
	.dwpsn	file "../APP/Initial.c",line 247,column 2,is_stmt
        AND       IFR,#0                ; [CPU_] |247| 
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 250,column 5,is_stmt
        MOVL      XAR4,#_GpioCtrlRegs   ; [CPU_U] |250| 
        MOVW      DP,#_GpioDataRegs+12  ; [CPU_U] 
        MOVL      XAR5,XAR4             ; [CPU_] |250| 
        ADDB      XAR5,#28              ; [CPU_U] |250| 
        AND       *+XAR5[0],#0xfbff     ; [CPU_] |250| 
	.dwpsn	file "../APP/Initial.c",line 251,column 5,is_stmt
        OR        @_GpioDataRegs+12,#0x0400 ; [CPU_] |251| 
	.dwpsn	file "../APP/Initial.c",line 252,column 5,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |252| 
        MOVW      DP,#_GpioCtrlRegs+28  ; [CPU_U] 
        ADDB      XAR5,#23              ; [CPU_U] |252| 
	.dwpsn	file "../APP/Initial.c",line 253,column 5,is_stmt
        ADDB      XAR4,#26              ; [CPU_U] |253| 
	.dwpsn	file "../APP/Initial.c",line 252,column 5,is_stmt
        AND       *+XAR5[0],#0xffcf     ; [CPU_] |252| 
	.dwpsn	file "../APP/Initial.c",line 253,column 5,is_stmt
        OR        *+XAR4[0],#0x0400     ; [CPU_] |253| 
	.dwpsn	file "../APP/Initial.c",line 255,column 5,is_stmt
        AND       @_GpioCtrlRegs+28,#0xf7ff ; [CPU_] |255| 
        MOVW      DP,#_GpioDataRegs+12  ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 256,column 5,is_stmt
        OR        @_GpioDataRegs+12,#0x0800 ; [CPU_] |256| 
        MOVW      DP,#_GpioCtrlRegs+23  ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 257,column 5,is_stmt
        AND       @_GpioCtrlRegs+23,#0xff3f ; [CPU_] |257| 
	.dwpsn	file "../APP/Initial.c",line 258,column 5,is_stmt
        OR        @_GpioCtrlRegs+26,#0x0800 ; [CPU_] |258| 
 EDIS
        SPM       #0                    ; [CPU_] 
	.dwpsn	file "../APP/Initial.c",line 263,column 2,is_stmt
$C$DW$164	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$164, DW_AT_low_pc(0x00)
	.dwattr $C$DW$164, DW_AT_name("_sInitPieCtrl")
	.dwattr $C$DW$164, DW_AT_TI_call
        LCR       #_sInitPieCtrl        ; [CPU_] |263| 
        ; call occurs [#_sInitPieCtrl] ; [] |263| 
	.dwpsn	file "../APP/Initial.c",line 269,column 2,is_stmt
$C$DW$165	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$165, DW_AT_low_pc(0x00)
	.dwattr $C$DW$165, DW_AT_name("_sInitPieVectTable")
	.dwattr $C$DW$165, DW_AT_TI_call
        LCR       #_sInitPieVectTable   ; [CPU_] |269| 
        ; call occurs [#_sInitPieVectTable] ; [] |269| 
	.dwpsn	file "../APP/Initial.c",line 272,column 2,is_stmt
        MOVL      XAR4,#_RamfuncsRunStart ; [CPU_U] |272| 
        MOVL      XAR5,#_RamfuncsLoadEnd ; [CPU_U] |272| 
        MOVL      *-SP[2],XAR4          ; [CPU_] |272| 
        MOVL      XAR4,#_RamfuncsLoadStart ; [CPU_U] |272| 
$C$DW$166	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$166, DW_AT_low_pc(0x00)
	.dwattr $C$DW$166, DW_AT_name("_MemCopy")
	.dwattr $C$DW$166, DW_AT_TI_call
        LCR       #_MemCopy             ; [CPU_] |272| 
        ; call occurs [#_MemCopy] ; [] |272| 
	.dwpsn	file "../APP/Initial.c",line 273,column 2,is_stmt
$C$DW$167	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$167, DW_AT_low_pc(0x00)
	.dwattr $C$DW$167, DW_AT_name("_sInitFlash")
	.dwattr $C$DW$167, DW_AT_TI_call
        LCR       #_sInitFlash          ; [CPU_] |273| 
        ; call occurs [#_sInitFlash] ; [] |273| 
	.dwpsn	file "../APP/Initial.c",line 276,column 2,is_stmt
$C$DW$168	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$168, DW_AT_low_pc(0x00)
	.dwattr $C$DW$168, DW_AT_name("_sInitEPWM")
	.dwattr $C$DW$168, DW_AT_TI_call
        LCR       #_sInitEPWM           ; [CPU_] |276| 
        ; call occurs [#_sInitEPWM] ; [] |276| 
	.dwpsn	file "../APP/Initial.c",line 277,column 2,is_stmt
$C$DW$169	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$169, DW_AT_low_pc(0x00)
	.dwattr $C$DW$169, DW_AT_name("_sInitECAP")
	.dwattr $C$DW$169, DW_AT_TI_call
        LCR       #_sInitECAP           ; [CPU_] |277| 
        ; call occurs [#_sInitECAP] ; [] |277| 
	.dwpsn	file "../APP/Initial.c",line 280,column 2,is_stmt
$C$DW$170	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$170, DW_AT_low_pc(0x00)
	.dwattr $C$DW$170, DW_AT_name("_sInitAdc")
	.dwattr $C$DW$170, DW_AT_TI_call
        LCR       #_sInitAdc            ; [CPU_] |280| 
        ; call occurs [#_sInitAdc] ; [] |280| 
	.dwpsn	file "../APP/Initial.c",line 283,column 2,is_stmt
$C$DW$171	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$171, DW_AT_low_pc(0x00)
	.dwattr $C$DW$171, DW_AT_name("_sInitGpio")
	.dwattr $C$DW$171, DW_AT_TI_call
        LCR       #_sInitGpio           ; [CPU_] |283| 
        ; call occurs [#_sInitGpio] ; [] |283| 
	.dwpsn	file "../APP/Initial.c",line 286,column 2,is_stmt
$C$DW$172	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$172, DW_AT_low_pc(0x00)
	.dwattr $C$DW$172, DW_AT_name("_sInitSCI")
	.dwattr $C$DW$172, DW_AT_TI_call
        LCR       #_sInitSCI            ; [CPU_] |286| 
...
$C$DW$173	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$173, DW_AT_TI_call
        LCR       #_sCanInitial         ; [CPU_] |290| 
        ; call occurs [#_sCanInitial] ; [] |290| 
;*** 295	-----------------------    asm(" EALLOW");
;*** 296	-----------------------    PieVectTable.EPWM1_INT = &INVInterrupt;
;*** 299	-----------------------    PieVectTable.EPWM2_INT = &MPPTInterrupt;
;*** 300	-----------------------    PieVectTable.EPWM6_INT = &OSTimeBase;
;*** 301	-----------------------    PieVectTable.USER12 = &OSCtxSw;
;*** 302	-----------------------    PieVectTable.ECAP1_INT = &LineZeroCrossInterrupt;
;*** 303	-----------------------    PieVectTable.ECAP2_INT = &SYNZeroCrossInterrupt;
...
;***  	-----------------------    return;
 EALLOW
	...
	.dwpsn	file "../APP/Initial.c",line 299,column 2,is_stmt
        MOVL      XAR4,#_MPPTInterrupt  ; [CPU_U] |299| 
        MOVL      @_PieVectTable+98,XAR4 ; [CPU_] |299| 
	.dwpsn	file "../APP/Initial.c",line 300,column 2,is_stmt
        MOVL      XAR4,#_OSTimeBase     ; [CPU_U] |300| 
        MOVL      @_PieVectTable+106,XAR4 ; [CPU_] |300| 
        MOVW      DP,#_PieVectTable+62  ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 301,column 2,is_stmt
        MOVL      XAR4,#_OSCtxSw        ; [CPU_U] |301| 
        MOVL      @_PieVectTable+62,XAR4 ; [CPU_] |301| 
        MOVW      DP,#_PieVectTable+112 ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 302,column 2,is_stmt
        MOVL      XAR4,#_LineZeroCrossInterrupt ; [CPU_U] |302| 
        MOVL      @_PieVectTable+112,XAR4 ; [CPU_] |302| 
	.dwpsn	file "../APP/Initial.c",line 303,column 2,is_stmt
        MOVL      XAR4,#_SYNZeroCrossInterrupt ; [CPU_U] |303| 
 ...
 EDIS
	...
	.dwpsn	file "../APP/Initial.c",line 318,column 2,is_stmt
        OR        @_PieCtrlRegs+6,#0x0002 ; [CPU_] |318| 
	.dwpsn	file "../APP/Initial.c",line 321,column 2,is_stmt
...
$C$DW$174	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$160, DW_AT_TI_end_line(0x153)
