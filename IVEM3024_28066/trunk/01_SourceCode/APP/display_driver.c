...
#define  Lcd_ID_IVEM6048    113  //cBIT_IVEM6048
#define  Lcd_ID_IVEM3024    114  //cBIT_IVEM3024
#define  Lcd_ID_IVEM5048    115  //cBIT_IVEM5048
...
{   
	...
	for(i = 0; i < VRAMSIZE; i++)
	{
	    ...
	    if(i !=  Lcd_ID_IVEM5048 && i !=  Lcd_ID_IVEM6048 )
	#elif mModel == cModel5048
		if(i !=  Lcd_ID_IVEM6048 && i !=  Lcd_ID_IVEM3024)
	#endif			
		{
