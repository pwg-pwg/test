...
;* Date/Time created: Mon Aug 28 12:02:54 2023                 *
;***************************************************************
...
;	D:\Program Application\CCS6.1.1\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\zhang\\AppData\\Local\\Temp\\231002 C:\\Users\\zhang\\AppData\\Local\\Temp\\231004 
;	D:\Program Application\CCS6.1.1\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\zhang\\AppData\\Local\\Temp\\2310012 
	.sect	".text"
...
$C$DW$102	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$102, DW_AT_name("D:\Project Program\Current Program\IVEM3024\28066\IVEM3024_28066_V3.05\IVEM3024\Debug\Initial.asm:$C$L3:1:1693195374")
...
$C$DW$104	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitPieCtrl")
	...
	.dwattr $C$DW$104, DW_AT_TI_begin_line(0x387)
	.dwattr $C$DW$104, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$104, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 904,column 1,is_stmt,address _sInitPieCtrl
...
_sInitPieCtrl:
;*** 906	-----------------------    asm(" setc INTM");
;*** 909	-----------------------    *&PieCtrlRegs &= 0xfffeu;
;*** 912	-----------------------    PieCtrlRegs.PIEIER1.all = 0u;
;*** 913	-----------------------    PieCtrlRegs.PIEIER2.all = 0u;
;*** 914	-----------------------    PieCtrlRegs.PIEIER3.all = 0u;
;*** 915	-----------------------    PieCtrlRegs.PIEIER4.all = 0u;
;*** 916	-----------------------    PieCtrlRegs.PIEIER5.all = 0u;
;*** 917	-----------------------    PieCtrlRegs.PIEIER6.all = 0u;
;*** 918	-----------------------    PieCtrlRegs.PIEIER7.all = 0u;
;*** 919	-----------------------    PieCtrlRegs.PIEIER8.all = 0u;
;*** 920	-----------------------    PieCtrlRegs.PIEIER9.all = 0u;
;*** 921	-----------------------    PieCtrlRegs.PIEIER10.all = 0u;
;*** 922	-----------------------    PieCtrlRegs.PIEIER11.all = 0u;
;*** 923	-----------------------    PieCtrlRegs.PIEIER12.all = 0u;
;*** 926	-----------------------    PieCtrlRegs.PIEIFR1.all = 0u;
;*** 927	-----------------------    PieCtrlRegs.PIEIFR2.all = 0u;
;*** 928	-----------------------    PieCtrlRegs.PIEIFR3.all = 0u;
;*** 929	-----------------------    PieCtrlRegs.PIEIFR4.all = 0u;
;*** 930	-----------------------    PieCtrlRegs.PIEIFR5.all = 0u;
;*** 931	-----------------------    PieCtrlRegs.PIEIFR6.all = 0u;
;*** 932	-----------------------    PieCtrlRegs.PIEIFR7.all = 0u;
;*** 933	-----------------------    PieCtrlRegs.PIEIFR8.all = 0u;
;*** 934	-----------------------    PieCtrlRegs.PIEIFR9.all = 0u;
;*** 935	-----------------------    PieCtrlRegs.PIEIFR10.all = 0u;
;*** 936	-----------------------    PieCtrlRegs.PIEIFR11.all = 0u;
;*** 937	-----------------------    PieCtrlRegs.PIEIFR12.all = 0u;
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$105	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$104, DW_AT_TI_end_line(0x3aa)
...
$C$DW$106	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitPieVectTable")
	...
	.dwattr $C$DW$106, DW_AT_TI_begin_line(0x3b3)
	.dwattr $C$DW$106, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$106, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 948,column 1,is_stmt,address _sInitPieVectTable
...
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
;*** 950	-----------------------    Source = &PieVectTableInit;
;*** 951	-----------------------    Dest = &PieVectTable;
;***  	-----------------------    L$1 = 127;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$108	.dwtag  DW_TAG_variable, DW_AT_name("Dest")
 ...
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 950,column 10,is_stmt
        MOVL      XAR5,#_PieVectTableInit ; [CPU_U] |950| 
	.dwpsn	file "../APP/Initial.c",line 951,column 10,is_stmt
        MOVL      XAR4,#_PieVectTable   ; [CPU_U] |951| 
        MOVB      XAR6,#127             ; [CPU_] 
$C$L5:    
$C$DW$L$_sInitPieVectTable$2$B:
;***	-----------------------g2:
;*** 955	-----------------------    *Dest++ = *Source++;
;*** 954	-----------------------    if ( (L$1 = L$1-1) != (-1) ) goto g2;
	.dwpsn	file "../APP/Initial.c",line 955,column 3,is_stmt
        MOVL      ACC,*XAR5++           ; [CPU_] |955| 
        MOVL      *XAR4++,ACC           ; [CPU_] |955| 
	.dwpsn	file "../APP/Initial.c",line 954,column 11,is_stmt
        BANZ      $C$L5,AR6--           ; [CPU_] |954| 
        ; branchcc occurs ; [] |954| 
...
;***  	-----------------------    return;
 EDIS
	...
	.dwpsn	file "../APP/Initial.c",line 959,column 2,is_stmt
        OR        @_PieCtrlRegs,#0x0001 ; [CPU_] |959| 
...
$C$DW$110	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$110, DW_AT_name("D:\Project Program\Current Program\IVEM3024\28066\IVEM3024_28066_V3.05\IVEM3024\Debug\Initial.asm:$C$L5:1:1693195374")
	.dwattr $C$DW$110, DW_AT_TI_begin_file("../APP/Initial.c")
	.dwattr $C$DW$110, DW_AT_TI_begin_line(0x3ba)
	.dwattr $C$DW$110, DW_AT_TI_end_line(0x3bb)
...
$C$DW$112	.dwtag  DW_TAG_subprogram, DW_AT_name("MemCopy")
	...
	.dwattr $C$DW$112, DW_AT_TI_begin_line(0x5ae)
	.dwattr $C$DW$112, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$112, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 1455,column 1,is_stmt,address _MemCopy
...
;***************************************************************
_MemCopy:
;** 1456	-----------------------    if ( SourceAddr >= SourceEndAddr ) goto g4;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$119	.dwtag  DW_TAG_variable, DW_AT_name("$O$L1")
	...
	.dwattr $C$DW$119, DW_AT_location[DW_OP_reg14]
        ...
        MOVL      XAR6,*-SP[4]          ; [CPU_] |1455| 
	.dwpsn	file "../APP/Initial.c",line 1456,column 11,is_stmt
        CMPL      ACC,XAR4              ; [CPU_] |1456| 
        B         $C$L7,LOS             ; [CPU_] |1456| 
...
$C$DW$L$_MemCopy$3$B:
;***	-----------------------g3:
;** 1458	-----------------------    *DestAddr++ = *SourceAddr++;
;** 1456	-----------------------    if ( (L$1 = L$1-1L) != (-1L) ) goto g3;
;***	-----------------------g4:
;***  	-----------------------    return;
	.dwpsn	file "../APP/Initial.c",line 1458,column 8,is_stmt
        MOV       AL,*XAR4++            ; [CPU_] |1458| 
	.dwpsn	file "../APP/Initial.c",line 1456,column 11,is_stmt
        SUBB      XAR5,#1               ; [CPU_U] |1456| 
	.dwpsn	file "../APP/Initial.c",line 1458,column 8,is_stmt
        MOV       *XAR6++,AL            ; [CPU_] |1458| 
	.dwpsn	file "../APP/Initial.c",line 1456,column 11,is_stmt
        MOVB      ACC,#0                ; [CPU_] |1456| 
        SUBB      ACC,#1                ; [CPU_] |1456| 
        CMPL      ACC,XAR5              ; [CPU_] |1456| 
        BF        $C$L6,NEQ             ; [CPU_] |1456| 
        ; branchcc occurs ; [] |1456| 
$C$DW$L$_MemCopy$3$E:
$C$L7:    
...
$C$DW$121	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$121, DW_AT_name("D:\Project Program\Current Program\IVEM3024\28066\IVEM3024_28066_V3.05\IVEM3024\Debug\Initial.asm:$C$L6:1:1693195374")
	.dwattr $C$DW$121, DW_AT_TI_begin_file("../APP/Initial.c")
	.dwattr $C$DW$121, DW_AT_TI_begin_line(0x5b0)
	.dwattr $C$DW$121, DW_AT_TI_end_line(0x5b3)
$C$DW$122	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$112, DW_AT_TI_end_line(0x5b5)
...
$C$DW$126	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitEPWM")
	...
	.dwattr $C$DW$126, DW_AT_TI_begin_line(0x3c8)
	.dwattr $C$DW$126, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$126, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 969,column 1,is_stmt,address _sInitEPWM
...
_sInitEPWM:
;*** 970	-----------------------    asm(" EALLOW");
;*** 971	-----------------------    *(&SysCtrlRegs+12L) &= 0xfffbu;
;*** 972	-----------------------    asm(" EDIS");
;*** 975	-----------------------    asm(" EALLOW");
;*** 976	-----------------------    *(&EPwm1Regs+20L) = *((C$8 = &EPwm1Regs)+20L)&0xfffeu|2u;
;*** 977	-----------------------    *(&EPwm1Regs+20L) = *(&EPwm1Regs+20L)&0xfffbu|0x8u;
;*** 978	-----------------------    *((volatile struct AQSFRC_BITS *)C$8+13L) |= 0xc0u;
;*** 979	-----------------------    asm(" EDIS");
;*** 980	-----------------------    EPwm1Regs.TBPRD = 2344u;
;*** 981	-----------------------    EPwm1Regs.TBPHS.half.TBPHS = 0u;
;*** 982	-----------------------    EPwm1Regs.TBCTR = 0u;
;*** 983	-----------------------    *(volatile unsigned *)C$8 &= 0xe3ffu;
;*** 984	-----------------------    *(volatile unsigned *)C$8 &= 0xfc7fu;
;*** 985	-----------------------    *(volatile unsigned *)C$8 = *(volatile unsigned *)C$8&0xfffeu|2u;
;*** 986	-----------------------    *(volatile unsigned *)C$8 &= 0xfffbu;
;*** 987	-----------------------    *(volatile unsigned *)C$8 &= 0xfff7u;
;*** 989	-----------------------    *(volatile unsigned *)C$8 |= 0x30u;
;*** 991	-----------------------    *((volatile struct CMPCTL_BITS *)C$8+7L) &= 0xffefu;
;*** 992	-----------------------    *(&EPwm1Regs+7L) &= 0xfffcu;
;*** 993	-----------------------    *(&EPwm1Regs+7L) &= 0xffbfu;
;*** 994	-----------------------    *(&EPwm1Regs+7L) &= 0xfff3u;
;*** 995	-----------------------    EPwm1Regs.AQCTLA.all = 1365u;
;*** 996	-----------------------    EPwm1Regs.AQCTLB.all = 1365u;
;*** 997	-----------------------    EPwm1Regs.CMPA.half.CMPA = 0xffffu;
;*** 998	-----------------------    EPwm1Regs.CMPB = 0xffffu;
;** 1000	-----------------------    *((volatile struct DBCTL_BITS *)C$8+15L) &= 0xfffcu;
;** 1001	-----------------------    *(&EPwm1Regs+15L) = *(&EPwm1Regs+15L)&0xfffbu|0x8u;
;** 1002	-----------------------    EPwm1Regs.DBFED = 333u;
;** 1003	-----------------------    EPwm1Regs.DBRED = 333u;
;** 1005	-----------------------    *((volatile struct ETPS_BITS *)C$8+26L) &= 0xfff3u;
;** 1006	-----------------------    *(&EPwm1Regs+26L) = *(&EPwm1Regs+26L)&0xfffcu|1u;
;** 1007	-----------------------    *((volatile struct ETSEL_BITS *)C$8+25L) |= 0x8u;
;** 1009	-----------------------    *(&EPwm1Regs+25L) = *(&EPwm1Regs+25L)&0xfff8u|2u;
;** 1011	-----------------------    *((volatile struct ETCLR_BITS *)C$8+28L) |= 1u;
;** 1013	-----------------------    *(&EPwm1Regs+25L) |= 0x800u;
;** 1014	-----------------------    *(&EPwm1Regs+25L) = *(&EPwm1Regs+25L)&0xf8ffu|0x200u;
;** 1015	-----------------------    *(&EPwm1Regs+26L) = *(&EPwm1Regs+26L)&0xf7ffu|0x400u;
;** 1016	-----------------------    *(&EPwm1Regs+26L) = *(&EPwm1Regs+26L)&0xfdffu|0x100u;
;** 1017	-----------------------    *(&EPwm1Regs+25L) |= 0x8000u;
;** 1018	-----------------------    *(&EPwm1Regs+25L) = *(&EPwm1Regs+25L)&0x8fffu|0x2000u;
;** 1019	-----------------------    *(&EPwm1Regs+26L) = *(&EPwm1Regs+26L)&0x3fffu|0x4000u;
;** 1020	-----------------------    *(&EPwm1Regs+26L) = *(&EPwm1Regs+26L)&0xdfffu|0x1000u;
;** 1023	-----------------------    asm(" EALLOW");
;** 1024	-----------------------    *(&EPwm2Regs+20L) = *((C$7 = &EPwm2Regs)+20L)&0xfffeu|2u;
;** 1025	-----------------------    *(&EPwm2Regs+20L) = *(&EPwm2Regs+20L)&0xfffbu|0x8u;
;** 1026	-----------------------    *((volatile struct AQSFRC_BITS *)C$7+13L) |= 0xc0u;
;** 1027	-----------------------    asm(" EDIS");
;** 1028	-----------------------    EPwm2Regs.TBPRD = 2344u;
;** 1029	-----------------------    EPwm2Regs.TBPHS.half.TBPHS = 0u;
;** 1030	-----------------------    EPwm2Regs.TBCTR = 0u;
;** 1031	-----------------------    *(volatile unsigned *)C$7 &= 0xe3ffu;
;** 1032	-----------------------    *(volatile unsigned *)C$7 &= 0xfc7fu;
;** 1033	-----------------------    *(volatile unsigned *)C$7 = *(volatile unsigned *)C$7&0xfffeu|2u;
;** 1034	-----------------------    *(volatile unsigned *)C$7 &= 0xfffbu;
;** 1035	-----------------------    *(volatile unsigned *)C$7 &= 0xfff7u;
;** 1037	-----------------------    *(volatile unsigned *)C$7 |= 0x30u;
;** 1039	-----------------------    *((volatile struct CMPCTL_BITS *)C$7+7L) &= 0xffefu;
;** 1040	-----------------------    *(&EPwm2Regs+7L) &= 0xfffcu;
;** 1041	-----------------------    *(&EPwm2Regs+7L) &= 0xffbfu;
;** 1042	-----------------------    *(&EPwm2Regs+7L) &= 0xfff3u;
;** 1043	-----------------------    EPwm2Regs.AQCTLA.all = 1365u;
;** 1044	-----------------------    EPwm2Regs.AQCTLB.all = 1365u;
;** 1045	-----------------------    EPwm2Regs.CMPA.half.CMPA = 0xffffu;
;** 1046	-----------------------    EPwm2Regs.CMPB = 0xffffu;
;** 1048	-----------------------    *((volatile struct DBCTL_BITS *)C$7+15L) &= 0xfffcu;
;** 1049	-----------------------    *(&EPwm2Regs+15L) = *(&EPwm2Regs+15L)&0xfffbu|0x8u;
;** 1050	-----------------------    EPwm2Regs.DBFED = 333u;
;** 1051	-----------------------    EPwm2Regs.DBRED = 333u;
;** 1053	-----------------------    *((volatile struct ETPS_BITS *)C$7+26L) &= 0xfff3u;
;** 1054	-----------------------    *(&EPwm2Regs+26L) = *(&EPwm2Regs+26L)&0xfffcu|1u;
;** 1055	-----------------------    *((volatile struct ETSEL_BITS *)C$7+25L) |= 0x8u;
;** 1056	-----------------------    *(&EPwm2Regs+25L) = *(&EPwm2Regs+25L)&0xfff8u|1u;
;** 1058	-----------------------    *((volatile struct ETCLR_BITS *)C$7+28L) |= 1u;
;** 1060	-----------------------    *(&EPwm2Regs+25L) |= 0x800u;
;** 1061	-----------------------    *(&EPwm2Regs+25L) = *(&EPwm2Regs+25L)&0xf9ffu|0x100u;
;** 1062	-----------------------    *(&EPwm2Regs+26L) = *(&EPwm2Regs+26L)&0xf7ffu|0x400u;
;** 1063	-----------------------    *(&EPwm2Regs+26L) = *(&EPwm2Regs+26L)&0xfdffu|0x100u;
;** 1064	-----------------------    *(&EPwm2Regs+25L) |= 0x8000u;
;** 1065	-----------------------    *(&EPwm2Regs+25L) = *(&EPwm2Regs+25L)&0x9fffu|0x1000u;
;** 1066	-----------------------    *(&EPwm2Regs+26L) = *(&EPwm2Regs+26L)&0x3fffu|0x4000u;
;** 1067	-----------------------    *(&EPwm2Regs+26L) = *(&EPwm2Regs+26L)&0xdfffu|0x1000u;
;** 1069	-----------------------    asm(" EALLOW");
;** 1070	-----------------------    *(&EPwm3Regs+20L) = *((C$6 = &EPwm3Regs)+20L)&0xfffeu|2u;
;** 1071	-----------------------    asm(" EDIS");
;** 1073	-----------------------    EPwm3Regs.TBPRD = 2344u;
;** 1075	-----------------------    EPwm3Regs.TBPHS.half.TBPHS = 0u;
;** 1076	-----------------------    EPwm3Regs.TBCTR = 0u;
...
;** 1085	-----------------------    *(&EPwm3Regs+7L) &= 0xfffcu;
;** 1086	-----------------------    *(&EPwm3Regs+7L) &= 0xffbfu;
;** 1087	-----------------------    *(&EPwm3Regs+7L) &= 0xfff3u;
;** 1089	-----------------------    EPwm3Regs.AQCTLA.all = 1365u;
;** 1090	-----------------------    EPwm3Regs.AQCTLB.all = 1365u;
;** 1091	-----------------------    EPwm3Regs.CMPA.half.CMPA = 0xffffu;
;** 1092	-----------------------    *((volatile struct DBCTL_BITS *)C$6+15L) &= 0xfffcu;
;** 1096	-----------------------    *((volatile struct ETSEL_BITS *)C$6+25L) &= 0xfff7u;
;** 1098	-----------------------    *((volatile struct ETCLR_BITS *)C$6+28L) |= 1u;
;** 1104	-----------------------    EPwm4Regs.TBPRD = 4499u;
;** 1106	-----------------------    EPwm4Regs.TBPHS.half.TBPHS = 0u;
;** 1107	-----------------------    EPwm4Regs.TBCTR = 0u;
;** 1108	-----------------------    *(C$5 = &EPwm4Regs) &= 0xe3ffu;
;** 1109	-----------------------    *C$5 &= 0xfc7fu;
;** 1110	-----------------------    *C$5 &= 0xfffcu;
;** 1111	-----------------------    *C$5 &= 0xfffbu;
;** 1112	-----------------------    *C$5 &= 0xfff7u;
;** 1114	-----------------------    *C$5 |= 0x30u;
;** 1117	-----------------------    *((volatile struct CMPCTL_BITS *)C$5+7L) &= 0xffefu;
;** 1118	-----------------------    *(&EPwm4Regs+7L) &= 0xffbfu;
;** 1119	-----------------------    *(&EPwm4Regs+7L) &= 0xfffcu;
;** 1120	-----------------------    *(&EPwm4Regs+7L) &= 0xfff3u;
;** 1123	-----------------------    EPwm4Regs.AQCTLA.all = 0u;
;** 1124	-----------------------    *(&EPwm4Regs+11L) = *((volatile struct AQCTL_BITS *)C$5+11L)&0xffefu|0x20u;
;** 1125	-----------------------    *(&EPwm4Regs+11L) = *(&EPwm4Regs+11L)&0xfffcu|1u;
;** 1126	-----------------------    *((volatile struct DBCTL_BITS *)C$5+15L) &= 0xfffcu;
;** 1131	-----------------------    *((volatile struct ETPS_BITS *)C$5+26L) &= 0xfff3u;
;** 1132	-----------------------    *(&EPwm4Regs+26L) = *(&EPwm4Regs+26L)&0xfffcu|1u;
;** 1133	-----------------------    *((volatile struct ETSEL_BITS *)C$5+25L) &= 0xfff7u;
;** 1134	-----------------------    *(&EPwm4Regs+25L) = *(&EPwm4Regs+25L)&0xfff8u|2u;
;** 1135	-----------------------    *((volatile struct ETCLR_BITS *)C$5+28L) |= 1u;
;** 1138	-----------------------    asm(" EALLOW");
;** 1139	-----------------------    *(&EPwm5Regs+20L) = *((C$4 = &EPwm5Regs)+20L)&0xfffeu|2u;
;** 1140	-----------------------    *(&EPwm5Regs+20L) |= 0xcu;
;** 1141	-----------------------    *((volatile struct AQSFRC_BITS *)C$4+13L) &= 0xff3fu;
;** 1142	-----------------------    asm(" EDIS");
;** 1143	-----------------------    EPwm5Regs.TBPRD = 2344u;
;** 1144	-----------------------    EPwm5Regs.TBPHS.half.TBPHS = 0u;
;** 1145	-----------------------    EPwm5Regs.TBCTR = 0u;
;** 1146	-----------------------    *(volatile unsigned *)C$4 &= 0xe3ffu;
;** 1147	-----------------------    *(volatile unsigned *)C$4 &= 0xfc7fu;
;** 1148	-----------------------    *(volatile unsigned *)C$4 = *(volatile unsigned *)C$4&0xfffeu|2u;
;** 1149	-----------------------    *(volatile unsigned *)C$4 &= 0xfffbu;
;** 1150	-----------------------    *(volatile unsigned *)C$4 &= 0xfff7u;
;** 1151	-----------------------    *(volatile unsigned *)C$4 |= 0x30u;
;** 1153	-----------------------    *((volatile struct CMPCTL_BITS *)C$4+7L) &= 0xffefu;
;** 1154	-----------------------    *(&EPwm5Regs+7L) &= 0xfffcu;
;** 1155	-----------------------    *(&EPwm5Regs+7L) &= 0xffbfu;
;** 1156	-----------------------    *(&EPwm5Regs+7L) &= 0xfff3u;
;** 1158	-----------------------    EPwm5Regs.AQCTLA.all = 1365u;
;** 1159	-----------------------    EPwm5Regs.AQCTLB.all = 1365u;
;** 1160	-----------------------    EPwm5Regs.CMPA.half.CMPA = 0xffffu;
;** 1161	-----------------------    EPwm5Regs.CMPB = 0xffffu;
;** 1162	-----------------------    *((volatile struct DBCTL_BITS *)C$4+15L) &= 0xfffcu;
;** 1163	-----------------------    *(&EPwm5Regs+15L) = *(&EPwm5Regs+15L)&0xfffbu|0x8u;
;** 1164	-----------------------    EPwm5Regs.DBFED = 333u;
;** 1165	-----------------------    EPwm5Regs.DBRED = 333u;
;** 1167	-----------------------    *((volatile struct ETPS_BITS *)C$4+26L) &= 0xfff3u;
;** 1169	-----------------------    *(&EPwm5Regs+26L) = *(&EPwm5Regs+26L)&0xfffcu|1u;
;** 1170	-----------------------    *((volatile struct ETSEL_BITS *)C$4+25L) &= 0xfff7u;
;** 1172	-----------------------    *(&EPwm5Regs+25L) = *(&EPwm5Regs+25L)&0xfff8u|1u;
;** 1173	-----------------------    *((volatile struct ETCLR_BITS *)C$4+28L) |= 1u;
;** 1180	-----------------------    EPwm6Regs.TBPRD = 0xafc7u;
;** 1182	-----------------------    EPwm6Regs.TBPHS.half.TBPHS = 0u;
;** 1183	-----------------------    EPwm6Regs.TBCTR = 0u;
;** 1184	-----------------------    *(C$3 = &EPwm6Regs) &= 0xe3ffu;
;** 1185	-----------------------    *C$3 &= 0xfc7fu;
;** 1186	-----------------------    *C$3 &= 0xfffcu;
;** 1187	-----------------------    *C$3 &= 0xfffbu;
;** 1188	-----------------------    *C$3 &= 0xfff7u;
;** 1190	-----------------------    *C$3 |= 0x30u;
;** 1193	-----------------------    *((volatile struct CMPCTL_BITS *)C$3+7L) &= 0xffefu;
;** 1194	-----------------------    *(&EPwm6Regs+7L) &= 0xffbfu;
;** 1195	-----------------------    *(&EPwm6Regs+7L) &= 0xfffcu;
;** 1196	-----------------------    *(&EPwm6Regs+7L) &= 0xfff3u;
;** 1199	-----------------------    EPwm6Regs.AQCTLA.all = 1365u;
;** 1200	-----------------------    EPwm6Regs.AQCTLB.all = 1365u;
;** 1201	-----------------------    EPwm6Regs.CMPA.half.CMPA = 0xffffu;
;** 1202	-----------------------    EPwm6Regs.CMPB = 0xafc7u;
;** 1203	-----------------------    *((volatile struct DBCTL_BITS *)C$3+15L) &= 0xfffcu;
;** 1205	-----------------------    *((volatile struct ETPS_BITS *)C$3+26L) &= 0xfff3u;
;** 1206	-----------------------    *(&EPwm6Regs+26L) = *(&EPwm6Regs+26L)&0xfffcu|1u;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$134	.dwtag  DW_TAG_variable, DW_AT_name("$O$C8")
 ...
 EALLOW
	...
	.dwpsn	file "../APP/Initial.c",line 971,column 2,is_stmt
        AND       @_SysCtrlRegs+12,#0xfffb ; [CPU_] |971| 
 EDIS
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 976,column 2,is_stmt
        MOVL      XAR4,#_EPwm1Regs      ; [CPU_U] |976| 
        MOVB      XAR0,#20              ; [CPU_] |976| 
        MOVW      DP,#_EPwm1Regs+20     ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 978,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |978| 
	.dwpsn	file "../APP/Initial.c",line 976,column 2,is_stmt
        AND       AL,*+XAR4[AR0],#0xfffe ; [CPU_] |976| 
        ORB       AL,#0x02              ; [CPU_] |976| 
	.dwpsn	file "../APP/Initial.c",line 978,column 2,is_stmt
        ADDB      XAR5,#13              ; [CPU_U] |978| 
	.dwpsn	file "../APP/Initial.c",line 976,column 2,is_stmt
        MOV       @_EPwm1Regs+20,AL     ; [CPU_] |976| 
	.dwpsn	file "../APP/Initial.c",line 977,column 2,is_stmt
        AND       AL,@_EPwm1Regs+20,#0xfffb ; [CPU_] |977| 
        ORB       AL,#0x08              ; [CPU_] |977| 
        MOV       @_EPwm1Regs+20,AL     ; [CPU_] |977| 
	.dwpsn	file "../APP/Initial.c",line 978,column 2,is_stmt
        OR        *+XAR5[0],#0x00c0     ; [CPU_] |978| 
 EDIS
 ...
 EDIS
	...
	.dwpsn	file "../APP/Initial.c",line 1096,column 2,is_stmt
        AND       *+XAR5[0],#0xfff7     ; [CPU_] |1096| 
	.dwpsn	file "../APP/Initial.c",line 1098,column 2,is_stmt
        OR        *+XAR4[0],#0x0001     ; [CPU_] |1098| 
	.dwpsn	file "../APP/Initial.c",line 1108,column 2,is_stmt
        MOVL      XAR4,#_EPwm4Regs      ; [CPU_U] |1108| 
	.dwpsn	file "../APP/Initial.c",line 1126,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1126| 
        ADDB      XAR5,#15              ; [CPU_U] |1126| 
	.dwpsn	file "../APP/Initial.c",line 1104,column 2,is_stmt
        MOV       @_EPwm4Regs+5,#4499   ; [CPU_] |1104| 
	.dwpsn	file "../APP/Initial.c",line 1106,column 2,is_stmt
        MOV       @_EPwm4Regs+3,#0      ; [CPU_] |1106| 
	.dwpsn	file "../APP/Initial.c",line 1107,column 2,is_stmt
        MOV       @_EPwm4Regs+4,#0      ; [CPU_] |1107| 
	.dwpsn	file "../APP/Initial.c",line 1108,column 2,is_stmt
        AND       *+XAR4[0],#0xe3ff     ; [CPU_] |1108| 
	.dwpsn	file "../APP/Initial.c",line 1109,column 2,is_stmt
        AND       *+XAR4[0],#0xfc7f     ; [CPU_] |1109| 
	.dwpsn	file "../APP/Initial.c",line 1110,column 2,is_stmt
        AND       *+XAR4[0],#0xfffc     ; [CPU_] |1110| 
	.dwpsn	file "../APP/Initial.c",line 1111,column 2,is_stmt
        AND       *+XAR4[0],#0xfffb     ; [CPU_] |1111| 
	.dwpsn	file "../APP/Initial.c",line 1112,column 2,is_stmt
        AND       *+XAR4[0],#0xfff7     ; [CPU_] |1112| 
	.dwpsn	file "../APP/Initial.c",line 1114,column 2,is_stmt
        OR        *+XAR4[0],#0x0030     ; [CPU_] |1114| 
	.dwpsn	file "../APP/Initial.c",line 1117,column 2,is_stmt
        AND       *+XAR4[7],#0xffef     ; [CPU_] |1117| 
	.dwpsn	file "../APP/Initial.c",line 1118,column 2,is_stmt
        AND       @_EPwm4Regs+7,#0xffbf ; [CPU_] |1118| 
	.dwpsn	file "../APP/Initial.c",line 1119,column 2,is_stmt
        AND       @_EPwm4Regs+7,#0xfffc ; [CPU_] |1119| 
	.dwpsn	file "../APP/Initial.c",line 1120,column 2,is_stmt
        AND       @_EPwm4Regs+7,#0xfff3 ; [CPU_] |1120| 
	.dwpsn	file "../APP/Initial.c",line 1123,column 2,is_stmt
        MOV       @_EPwm4Regs+11,#0     ; [CPU_] |1123| 
	.dwpsn	file "../APP/Initial.c",line 1124,column 2,is_stmt
        AND       AL,*+XAR4[AR0],#0xffef ; [CPU_] |1124| 
        ORB       AL,#0x20              ; [CPU_] |1124| 
        MOV       @_EPwm4Regs+11,AL     ; [CPU_] |1124| 
	.dwpsn	file "../APP/Initial.c",line 1125,column 2,is_stmt
        AND       AL,@_EPwm4Regs+11,#0xfffc ; [CPU_] |1125| 
        ORB       AL,#0x01              ; [CPU_] |1125| 
        MOV       @_EPwm4Regs+11,AL     ; [CPU_] |1125| 
	.dwpsn	file "../APP/Initial.c",line 1126,column 2,is_stmt
        AND       *+XAR5[0],#0xfffc     ; [CPU_] |1126| 
	.dwpsn	file "../APP/Initial.c",line 1131,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1131| 
        ADDB      XAR5,#26              ; [CPU_U] |1131| 
        AND       *+XAR5[0],#0xfff3     ; [CPU_] |1131| 
	.dwpsn	file "../APP/Initial.c",line 1133,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1133| 
        ADDB      XAR5,#25              ; [CPU_U] |1133| 
	.dwpsn	file "../APP/Initial.c",line 1135,column 2,is_stmt
        ADDB      XAR4,#28              ; [CPU_U] |1135| 
	.dwpsn	file "../APP/Initial.c",line 1132,column 2,is_stmt
        AND       AL,@_EPwm4Regs+26,#0xfffc ; [CPU_] |1132| 
        ORB       AL,#0x01              ; [CPU_] |1132| 
        MOV       @_EPwm4Regs+26,AL     ; [CPU_] |1132| 
	.dwpsn	file "../APP/Initial.c",line 1133,column 2,is_stmt
        AND       *+XAR5[0],#0xfff7     ; [CPU_] |1133| 
	.dwpsn	file "../APP/Initial.c",line 1134,column 2,is_stmt
        AND       AL,@_EPwm4Regs+25,#0xfff8 ; [CPU_] |1134| 
        ORB       AL,#0x02              ; [CPU_] |1134| 
        MOV       @_EPwm4Regs+25,AL     ; [CPU_] |1134| 
	.dwpsn	file "../APP/Initial.c",line 1135,column 2,is_stmt
        OR        *+XAR4[0],#0x0001     ; [CPU_] |1135| 
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 1139,column 2,is_stmt
        MOVL      XAR4,#_EPwm5Regs      ; [CPU_U] |1139| 
        MOVB      XAR0,#20              ; [CPU_] |1139| 
	.dwpsn	file "../APP/Initial.c",line 1141,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1141| 
        MOVW      DP,#_EPwm5Regs+20     ; [CPU_U] 
        ADDB      XAR5,#13              ; [CPU_U] |1141| 
	.dwpsn	file "../APP/Initial.c",line 1139,column 2,is_stmt
        AND       AL,*+XAR4[AR0],#0xfffe ; [CPU_] |1139| 
        ORB       AL,#0x02              ; [CPU_] |1139| 
        MOV       @_EPwm5Regs+20,AL     ; [CPU_] |1139| 
	.dwpsn	file "../APP/Initial.c",line 1140,column 2,is_stmt
        OR        @_EPwm5Regs+20,#0x000c ; [CPU_] |1140| 
	.dwpsn	file "../APP/Initial.c",line 1141,column 2,is_stmt
        AND       *+XAR5[0],#0xff3f     ; [CPU_] |1141| 
 EDIS
	.dwpsn	file "../APP/Initial.c",line 1162,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1162| 
        ADDB      XAR5,#15              ; [CPU_U] |1162| 
	.dwpsn	file "../APP/Initial.c",line 1143,column 2,is_stmt
        MOV       @_EPwm5Regs+5,#2344   ; [CPU_] |1143| 
	.dwpsn	file "../APP/Initial.c",line 1144,column 2,is_stmt
        MOV       @_EPwm5Regs+3,#0      ; [CPU_] |1144| 
	.dwpsn	file "../APP/Initial.c",line 1145,column 2,is_stmt
        MOV       @_EPwm5Regs+4,#0      ; [CPU_] |1145| 
	.dwpsn	file "../APP/Initial.c",line 1146,column 2,is_stmt
        AND       *+XAR4[0],#0xe3ff     ; [CPU_] |1146| 
	.dwpsn	file "../APP/Initial.c",line 1147,column 2,is_stmt
        AND       *+XAR4[0],#0xfc7f     ; [CPU_] |1147| 
	.dwpsn	file "../APP/Initial.c",line 1148,column 2,is_stmt
        AND       AL,*+XAR4[0],#0xfffe  ; [CPU_] |1148| 
        ORB       AL,#0x02              ; [CPU_] |1148| 
        MOV       *+XAR4[0],AL          ; [CPU_] |1148| 
	.dwpsn	file "../APP/Initial.c",line 1149,column 2,is_stmt
        AND       *+XAR4[0],#0xfffb     ; [CPU_] |1149| 
	.dwpsn	file "../APP/Initial.c",line 1150,column 2,is_stmt
        AND       *+XAR4[0],#0xfff7     ; [CPU_] |1150| 
	.dwpsn	file "../APP/Initial.c",line 1151,column 2,is_stmt
        OR        *+XAR4[0],#0x0030     ; [CPU_] |1151| 
	.dwpsn	file "../APP/Initial.c",line 1153,column 2,is_stmt
        AND       *+XAR4[7],#0xffef     ; [CPU_] |1153| 
	.dwpsn	file "../APP/Initial.c",line 1154,column 2,is_stmt
        AND       @_EPwm5Regs+7,#0xfffc ; [CPU_] |1154| 
	.dwpsn	file "../APP/Initial.c",line 1155,column 2,is_stmt
        AND       @_EPwm5Regs+7,#0xffbf ; [CPU_] |1155| 
	.dwpsn	file "../APP/Initial.c",line 1156,column 2,is_stmt
        AND       @_EPwm5Regs+7,#0xfff3 ; [CPU_] |1156| 
	.dwpsn	file "../APP/Initial.c",line 1158,column 2,is_stmt
        MOV       @_EPwm5Regs+11,#1365  ; [CPU_] |1158| 
	.dwpsn	file "../APP/Initial.c",line 1159,column 2,is_stmt
        MOV       @_EPwm5Regs+12,#1365  ; [CPU_] |1159| 
	.dwpsn	file "../APP/Initial.c",line 1160,column 2,is_stmt
        MOV       @_EPwm5Regs+9,#65535  ; [CPU_] |1160| 
	.dwpsn	file "../APP/Initial.c",line 1161,column 2,is_stmt
        MOV       @_EPwm5Regs+10,#65535 ; [CPU_] |1161| 
	.dwpsn	file "../APP/Initial.c",line 1162,column 2,is_stmt
        AND       *+XAR5[0],#0xfffc     ; [CPU_] |1162| 
	.dwpsn	file "../APP/Initial.c",line 1167,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1167| 
        ADDB      XAR5,#26              ; [CPU_U] |1167| 
	.dwpsn	file "../APP/Initial.c",line 1163,column 2,is_stmt
        AND       AL,@_EPwm5Regs+15,#0xfffb ; [CPU_] |1163| 
        ORB       AL,#0x08              ; [CPU_] |1163| 
        MOV       @_EPwm5Regs+15,AL     ; [CPU_] |1163| 
	.dwpsn	file "../APP/Initial.c",line 1164,column 2,is_stmt
        MOV       @_EPwm5Regs+17,#333   ; [CPU_] |1164| 
	.dwpsn	file "../APP/Initial.c",line 1165,column 2,is_stmt
        MOV       @_EPwm5Regs+16,#333   ; [CPU_] |1165| 
	.dwpsn	file "../APP/Initial.c",line 1167,column 2,is_stmt
        AND       *+XAR5[0],#0xfff3     ; [CPU_] |1167| 
	.dwpsn	file "../APP/Initial.c",line 1170,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1170| 
        ADDB      XAR5,#25              ; [CPU_U] |1170| 
	.dwpsn	file "../APP/Initial.c",line 1173,column 2,is_stmt
        ADDB      XAR4,#28              ; [CPU_U] |1173| 
	.dwpsn	file "../APP/Initial.c",line 1169,column 2,is_stmt
        AND       AL,@_EPwm5Regs+26,#0xfffc ; [CPU_] |1169| 
        ORB       AL,#0x01              ; [CPU_] |1169| 
        MOV       @_EPwm5Regs+26,AL     ; [CPU_] |1169| 
	.dwpsn	file "../APP/Initial.c",line 1170,column 2,is_stmt
        AND       *+XAR5[0],#0xfff7     ; [CPU_] |1170| 
	.dwpsn	file "../APP/Initial.c",line 1172,column 2,is_stmt
        AND       AL,@_EPwm5Regs+25,#0xfff8 ; [CPU_] |1172| 
        ORB       AL,#0x01              ; [CPU_] |1172| 
        MOV       @_EPwm5Regs+25,AL     ; [CPU_] |1172| 
        MOVW      DP,#_EPwm6Regs+5      ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 1173,column 2,is_stmt
        OR        *+XAR4[0],#0x0001     ; [CPU_] |1173| 
	.dwpsn	file "../APP/Initial.c",line 1184,column 2,is_stmt
        MOVL      XAR4,#_EPwm6Regs      ; [CPU_U] |1184| 
	.dwpsn	file "../APP/Initial.c",line 1203,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1203| 
        ADDB      XAR5,#15              ; [CPU_U] |1203| 
	.dwpsn	file "../APP/Initial.c",line 1180,column 2,is_stmt
        MOV       @_EPwm6Regs+5,#44999  ; [CPU_] |1180| 
	.dwpsn	file "../APP/Initial.c",line 1182,column 2,is_stmt
        MOV       @_EPwm6Regs+3,#0      ; [CPU_] |1182| 
	.dwpsn	file "../APP/Initial.c",line 1183,column 2,is_stmt
        MOV       @_EPwm6Regs+4,#0      ; [CPU_] |1183| 
	.dwpsn	file "../APP/Initial.c",line 1184,column 2,is_stmt
        AND       *+XAR4[0],#0xe3ff     ; [CPU_] |1184| 
	.dwpsn	file "../APP/Initial.c",line 1185,column 2,is_stmt
        AND       *+XAR4[0],#0xfc7f     ; [CPU_] |1185| 
	.dwpsn	file "../APP/Initial.c",line 1186,column 2,is_stmt
        AND       *+XAR4[0],#0xfffc     ; [CPU_] |1186| 
	.dwpsn	file "../APP/Initial.c",line 1187,column 2,is_stmt
        AND       *+XAR4[0],#0xfffb     ; [CPU_] |1187| 
	.dwpsn	file "../APP/Initial.c",line 1188,column 2,is_stmt
        AND       *+XAR4[0],#0xfff7     ; [CPU_] |1188| 
	.dwpsn	file "../APP/Initial.c",line 1190,column 2,is_stmt
        OR        *+XAR4[0],#0x0030     ; [CPU_] |1190| 
	.dwpsn	file "../APP/Initial.c",line 1193,column 2,is_stmt
        AND       *+XAR4[7],#0xffef     ; [CPU_] |1193| 
	.dwpsn	file "../APP/Initial.c",line 1194,column 2,is_stmt
        AND       @_EPwm6Regs+7,#0xffbf ; [CPU_] |1194| 
	.dwpsn	file "../APP/Initial.c",line 1195,column 2,is_stmt
        AND       @_EPwm6Regs+7,#0xfffc ; [CPU_] |1195| 
	.dwpsn	file "../APP/Initial.c",line 1196,column 2,is_stmt
        AND       @_EPwm6Regs+7,#0xfff3 ; [CPU_] |1196| 
	.dwpsn	file "../APP/Initial.c",line 1199,column 2,is_stmt
        MOV       @_EPwm6Regs+11,#1365  ; [CPU_] |1199| 
	.dwpsn	file "../APP/Initial.c",line 1200,column 2,is_stmt
        MOV       @_EPwm6Regs+12,#1365  ; [CPU_] |1200| 
	.dwpsn	file "../APP/Initial.c",line 1201,column 2,is_stmt
        MOV       @_EPwm6Regs+9,#65535  ; [CPU_] |1201| 
	.dwpsn	file "../APP/Initial.c",line 1202,column 2,is_stmt
        MOV       @_EPwm6Regs+10,#44999 ; [CPU_] |1202| 
	.dwpsn	file "../APP/Initial.c",line 1203,column 2,is_stmt
        AND       *+XAR5[0],#0xfffc     ; [CPU_] |1203| 
	.dwpsn	file "../APP/Initial.c",line 1205,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1205| 
        ADDB      XAR5,#26              ; [CPU_U] |1205| 
        AND       *+XAR5[0],#0xfff3     ; [CPU_] |1205| 
	.dwpsn	file "../APP/Initial.c",line 1206,column 2,is_stmt
        AND       AL,@_EPwm6Regs+26,#0xfffc ; [CPU_] |1206| 
;** 1207	-----------------------    *((volatile struct ETSEL_BITS *)C$3+25L) |= 0x8u;
;** 1208	-----------------------    *(&EPwm6Regs+25L) = *(&EPwm6Regs+25L)&0xfff8u|2u;
;** 1209	-----------------------    *((volatile struct ETCLR_BITS *)C$3+28L) |= 1u;
;** 1218	-----------------------    asm(" EALLOW");
;** 1219	-----------------------    *(&EPwm7Regs+20L) = *((C$2 = &EPwm7Regs)+20L)&0xfffeu|2u;
;** 1220	-----------------------    *(&EPwm7Regs+20L) = *(&EPwm7Regs+20L)&0xfffbu|0x8u;
;** 1221	-----------------------    *((volatile struct AQSFRC_BITS *)C$2+13L) &= 0xff3fu;
;** 1222	-----------------------    asm(" EDIS");
;** 1223	-----------------------    EPwm7Regs.TBPRD = 2344u;
;** 1224	-----------------------    EPwm7Regs.TBPHS.half.TBPHS = 0u;
;** 1225	-----------------------    EPwm7Regs.TBCTR = 0u;
;** 1226	-----------------------    *(volatile unsigned *)C$2 &= 0xe3ffu;
;** 1227	-----------------------    *(volatile unsigned *)C$2 &= 0xfc7fu;
;** 1228	-----------------------    *(volatile unsigned *)C$2 = *(volatile unsigned *)C$2&0xfffeu|2u;
;** 1229	-----------------------    *(volatile unsigned *)C$2 &= 0xfffbu;
;** 1230	-----------------------    *(volatile unsigned *)C$2 &= 0xfff7u;
;** 1231	-----------------------    *(volatile unsigned *)C$2 |= 0x30u;
;** 1233	-----------------------    *((volatile struct CMPCTL_BITS *)C$2+7L) &= 0xffefu;
;** 1234	-----------------------    *(&EPwm7Regs+7L) &= 0xfffcu;
;** 1235	-----------------------    *(&EPwm7Regs+7L) &= 0xffbfu;
;** 1236	-----------------------    *(&EPwm7Regs+7L) &= 0xfff3u;
;** 1238	-----------------------    EPwm7Regs.AQCTLA.all = 1365u;
;** 1239	-----------------------    EPwm7Regs.AQCTLB.all = 1365u;
;** 1240	-----------------------    EPwm7Regs.CMPA.half.CMPA = 0xffffu;
;** 1241	-----------------------    EPwm7Regs.CMPB = 0xffffu;
;** 1242	-----------------------    *((volatile struct DBCTL_BITS *)C$2+15L) &= 0xfffcu;
;** 1243	-----------------------    *(&EPwm7Regs+15L) = *(&EPwm7Regs+15L)&0xfffbu|0x8u;
;** 1244	-----------------------    EPwm7Regs.DBFED = 333u;
;** 1245	-----------------------    EPwm7Regs.DBRED = 333u;
;** 1247	-----------------------    *((volatile struct ETPS_BITS *)C$2+26L) &= 0xfff3u;
;** 1249	-----------------------    *(&EPwm7Regs+26L) = *(&EPwm7Regs+26L)&0xfffcu|1u;
;** 1250	-----------------------    *((volatile struct ETSEL_BITS *)C$2+25L) &= 0xfff7u;
;** 1252	-----------------------    *(&EPwm7Regs+25L) = *(&EPwm7Regs+25L)&0xfff8u|1u;
;** 1253	-----------------------    *((volatile struct ETCLR_BITS *)C$2+28L) |= 1u;
;** 1256	-----------------------    asm(" EALLOW");
;** 1257	-----------------------    *(&EPwm8Regs+20L) = *((C$1 = &EPwm8Regs)+20L)&0xfffeu|2u;
;** 1258	-----------------------    *(&EPwm8Regs+20L) = *(&EPwm8Regs+20L)&0xfffbu|0x8u;
;** 1259	-----------------------    *((volatile struct AQSFRC_BITS *)C$1+13L) &= 0xff3fu;
;** 1261	-----------------------    asm(" EDIS");
;** 1262	-----------------------    EPwm8Regs.TBPRD = 1097u;
;** 1263	-----------------------    EPwm8Regs.TBPHS.half.TBPHS = 0u;
;** 1264	-----------------------    EPwm8Regs.TBCTR = 0u;
;** 1265	-----------------------    *(volatile unsigned *)C$1 &= 0xe3ffu;
;** 1266	-----------------------    *(volatile unsigned *)C$1 &= 0xfc7fu;
;** 1267	-----------------------    *(volatile unsigned *)C$1 = *(volatile unsigned *)C$1&0xfffeu|2u;
;** 1268	-----------------------    *(volatile unsigned *)C$1 &= 0xfffbu;
;** 1269	-----------------------    *(volatile unsigned *)C$1 &= 0xfff7u;
;** 1270	-----------------------    *(volatile unsigned *)C$1 |= 0x30u;
;** 1272	-----------------------    *((volatile struct CMPCTL_BITS *)C$1+7L) &= 0xffefu;
;** 1273	-----------------------    *(&EPwm8Regs+7L) &= 0xfffcu;
;** 1274	-----------------------    *(&EPwm8Regs+7L) &= 0xffbfu;
;** 1275	-----------------------    *(&EPwm8Regs+7L) = *(&EPwm8Regs+7L)&0xfff7u|4u;
;** 1277	-----------------------    EPwm8Regs.AQCTLA.all = 1365u;
;** 1278	-----------------------    EPwm8Regs.AQCTLB.all = 1365u;
;** 1279	-----------------------    EPwm8Regs.CMPA.half.CMPA = 0xffffu;
;** 1280	-----------------------    EPwm8Regs.CMPB = 0xffffu;
;** 1281	-----------------------    *((volatile struct DBCTL_BITS *)C$1+15L) &= 0xfffcu;
;** 1282	-----------------------    *(&EPwm8Regs+15L) = *(&EPwm8Regs+15L)&0xfffbu|0x8u;
;** 1283	-----------------------    EPwm8Regs.DBFED = 333u;
;** 1284	-----------------------    EPwm8Regs.DBRED = 333u;
;** 1286	-----------------------    *((volatile struct ETPS_BITS *)C$1+26L) &= 0xfff3u;
;** 1288	-----------------------    *(&EPwm8Regs+26L) = *(&EPwm8Regs+26L)&0xfffcu|1u;
;** 1289	-----------------------    *((volatile struct ETSEL_BITS *)C$1+25L) &= 0xfff7u;
;** 1291	-----------------------    *(&EPwm8Regs+25L) = *(&EPwm8Regs+25L)&0xfff8u|1u;
;** 1292	-----------------------    *((volatile struct ETCLR_BITS *)C$1+28L) |= 1u;
;** 1294	-----------------------    EPwm8Regs.AQCTLA.all = 0u;
;** 1295	-----------------------    *(&EPwm8Regs+11L) = *((volatile struct AQCTL_BITS *)C$1+11L)&0xffdfu|0x10u;
;** 1296	-----------------------    *(&EPwm8Regs+11L) = *(&EPwm8Regs+11L)&0xff7fu|0x40u;
;** 1297	-----------------------    EPwm8Regs.CMPA.half.CMPA = 1097u;
;** 1298	-----------------------    EPwm8Regs.AQCTLB.all = 0u;
;** 1299	-----------------------    *(&EPwm8Regs+12L) = *((volatile struct AQCTL_BITS *)C$1+12L)&0xfdffu|0x100u;
;** 1300	-----------------------    *(&EPwm8Regs+12L) = *(&EPwm8Regs+12L)&0xf7ffu|0x400u;
;** 1301	-----------------------    EPwm8Regs.CMPB = 0u;
;** 1303	-----------------------    asm(" EALLOW");
;** 1304	-----------------------    *(&SysCtrlRegs+12L) |= 4u;
;** 1305	-----------------------    asm(" EDIS");
;***  	-----------------------    return;
        ORB       AL,#0x01              ; [CPU_] |1206| 
	.dwpsn	file "../APP/Initial.c",line 1207,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1207| 
	.dwpsn	file "../APP/Initial.c",line 1206,column 2,is_stmt
        MOV       @_EPwm6Regs+26,AL     ; [CPU_] |1206| 
	.dwpsn	file "../APP/Initial.c",line 1209,column 2,is_stmt
        ADDB      XAR4,#28              ; [CPU_U] |1209| 
	.dwpsn	file "../APP/Initial.c",line 1207,column 2,is_stmt
        ADDB      XAR5,#25              ; [CPU_U] |1207| 
        OR        *+XAR5[0],#0x0008     ; [CPU_] |1207| 
	.dwpsn	file "../APP/Initial.c",line 1208,column 2,is_stmt
        AND       AL,@_EPwm6Regs+25,#0xfff8 ; [CPU_] |1208| 
        ORB       AL,#0x02              ; [CPU_] |1208| 
        MOV       @_EPwm6Regs+25,AL     ; [CPU_] |1208| 
	.dwpsn	file "../APP/Initial.c",line 1209,column 2,is_stmt
        OR        *+XAR4[0],#0x0001     ; [CPU_] |1209| 
 EALLOW
	.dwpsn	file "../APP/Initial.c",line 1219,column 2,is_stmt
        MOVB      XAR0,#20              ; [CPU_] |1219| 
        MOVL      XAR4,#_EPwm7Regs      ; [CPU_U] |1219| 
        MOVW      DP,#_EPwm7Regs+20     ; [CPU_U] 
	.dwpsn	file "../APP/Initial.c",line 1221,column 2,is_stmt
        MOVL      XAR5,XAR4             ; [CPU_] |1221| 
	.dwpsn	file "../APP/Initial.c",line 1219,column 2,is_stmt
        AND       AL,*+XAR4[AR0],#0xfffe ; [CPU_] |1219| 
	.dwpsn	file "../APP/Initial.c",line 1221,column 2,is_stmt
        ADDB      XAR5,#13              ; [CPU_U] |1221| 
	.dwpsn	file "../APP/Initial.c",line 1219,column 2,is_stmt
        ORB       AL,#0x02              ; [CPU_] |1219| 
        MOV       @_EPwm7Regs+20,AL     ; [CPU_] |1219| 
	.dwpsn	file "../APP/Initial.c",line 1220,column 2,is_stmt
        AND       AL,@_EPwm7Regs+20,#0xfffb ; [CPU_] |1220| 
        ORB       AL,#0x08              ; [CPU_] |1220| 
        MOV       @_EPwm7Regs+20,AL     ; [CPU_] |1220| 
	.dwpsn	file "../APP/Initial.c",line 1221,column 2,is_stmt
        AND       *+XAR5[0],#0xff3f     ; [CPU_] |1221| 
 EDIS
...
$C$DW$135	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$126, DW_AT_TI_end_line(0x51b)
...
$C$DW$136	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitECAP")
	...
	.dwattr $C$DW$136, DW_AT_TI_begin_line(0x521)
	.dwattr $C$DW$136, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$136, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 1314,column 1,is_stmt,address _sInitECAP
...
;***************************************************************
_sInitECAP:
;** 1315	-----------------------    ECap1Regs.ECEINT.all = 0u;
;** 1316	-----------------------    ECap1Regs.ECCLR.all = 0xffffu;
;** 1317	-----------------------    *((C$2 = &ECap1Regs)+20L) &= 0xfeffu;
;** 1318	-----------------------    *((volatile struct ECCTL2_BITS *)C$2+21L) &= 0xffefu;
;** 1319	-----------------------    *(&ECap1Regs+21L) &= 0xfdffu;
;** 1320	-----------------------    *(&ECap1Regs+21L) |= 1u;
;** 1321	-----------------------    *(&ECap1Regs+21L) |= 0xc0u;
;** 1322	-----------------------    *(&ECap1Regs+21L) &= 0xffdfu;
;** 1323	-----------------------    *(&ECap1Regs+21L) &= 0xfff9u;
;** 1324	-----------------------    *(&ECap1Regs+20L) |= 1u;
;** 1325	-----------------------    *(&ECap1Regs+20L) &= 0xfffdu;
;** 1326	-----------------------    *(&ECap1Regs+20L) &= 0xc1ffu;
;** 1328	-----------------------    ECap2Regs.ECEINT.all = 0u;
;** 1329	-----------------------    ECap2Regs.ECCLR.all = 0xffffu;
;** 1330	-----------------------    *((C$1 = &ECap2Regs)+20L) &= 0xfeffu;
;** 1331	-----------------------    *((volatile struct ECCTL2_BITS *)C$1+21L) &= 0xffefu;
;** 1332	-----------------------    *(&ECap2Regs+21L) &= 0xfdffu;
;** 1333	-----------------------    *(&ECap2Regs+21L) |= 1u;
;** 1334	-----------------------    *(&ECap2Regs+21L) |= 0xc0u;
;** 1335	-----------------------    *(&ECap2Regs+21L) &= 0xffdfu;
;** 1336	-----------------------    *(&ECap2Regs+21L) &= 0xfff9u;
;** 1337	-----------------------    *(&ECap2Regs+20L) |= 1u;
;** 1338	-----------------------    *(&ECap2Regs+20L) &= 0xfffdu;
;** 1339	-----------------------    *(&ECap2Regs+20L) &= 0xc1ffu;
;** 1369	-----------------------    *(&ECap1Regs+21L) |= 0x8u;
;** 1370	-----------------------    *(&ECap1Regs+20L) |= 0x100u;
;** 1371	-----------------------    *((volatile struct ECEINT_BITS *)C$2+22L) |= 2u;
;** 1373	-----------------------    *(&ECap2Regs+21L) |= 0x8u;
;** 1374	-----------------------    *(&ECap2Regs+20L) |= 0x100u;
;** 1375	-----------------------    *((volatile struct ECEINT_BITS *)C$1+22L) |= 2u;
;** 1382	-----------------------    *(&ECap1Regs+21L) |= 0x10u;
;** 1383	-----------------------    *(&ECap2Regs+21L) |= 0x10u;
;** 1384	-----------------------    *(&ECap3Regs+21L) |= 0x10u;
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$139	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$136, DW_AT_TI_end_line(0x573)
...
$C$DW$140	.dwtag  DW_TAG_subprogram, DW_AT_name("DelayUs")
	...
	.dwattr $C$DW$140, DW_AT_TI_begin_line(0x5a5)
	.dwattr $C$DW$140, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$140, DW_AT_TI_max_frame_size(-4)
	.dwpsn	file "../APP/Initial.c",line 1446,column 1,is_stmt,address _DelayUs
...
$C$DW$143	.dwtag  DW_TAG_variable, DW_AT_name("Usec")
	...
	.dwattr $C$DW$143, DW_AT_location[DW_OP_breg20 -1]
        MOV       *-SP[1],AL            ; [CPU_] |1446| 
	.dwpsn	file "../APP/Initial.c",line 1447,column 5,is_stmt
        DEC       *-SP[1]               ; [CPU_] |1447| 
        B         $C$L9,UNC             ; [CPU_] |1447| 
        ; branch occurs ; [] |1447| 
$C$L8:    
$C$DW$L$_DelayUs$2$B:
;***	-----------------------g2:
;** 1449	-----------------------    asm(" RPT #100 || NOP");
;** 1450	-----------------------    Usec = Usec-1u;
 RPT #100 || NOP
...
$C$DW$L$_DelayUs$3$B:
;***	-----------------------g3:
;** 1450	-----------------------    if ( Usec != 0xffffu ) goto g2;
;***  	-----------------------    return;
	.dwpsn	file "../APP/Initial.c",line 1450,column 2,is_stmt
        CMP       *-SP[1],#65535        ; [CPU_] |1450| 
        BF        $C$L8,NEQ             ; [CPU_] |1450| 
...
$C$DW$145	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$145, DW_AT_name("D:\Project Program\Current Program\IVEM3024\28066\IVEM3024_28066_V3.05\IVEM3024\Debug\Initial.asm:$C$L9:1:1693195374")
	.dwattr $C$DW$145, DW_AT_TI_begin_file("../APP/Initial.c")
	.dwattr $C$DW$145, DW_AT_TI_begin_line(0x5a7)
	.dwattr $C$DW$145, DW_AT_TI_end_line(0x5aa)
...
$C$DW$147	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$140, DW_AT_TI_end_line(0x5ac)
...
;*** 769	-----------------------    *(&GpioCtrlRegs+13L) &= 0xfbffu;
;*** 770	-----------------------    *(&GpioDataRegs+3L) |= 0x400u;
;*** 771	-----------------------    *(&GpioCtrlRegs+9L) &= 0xffcfu;
;*** 772	-----------------------    *(&GpioCtrlRegs+11L) |= 0x400u;
;*** 774	-----------------------    *(&GpioCtrlRegs+13L) &= 0xf7ffu;
;*** 775	-----------------------    *(&GpioDataRegs+5L) |= 0x800u;
;*** 776	-----------------------    *(&GpioCtrlRegs+9L) &= 0xff3fu;
;*** 777	-----------------------    *(&GpioCtrlRegs+11L) |= 0x800u;
;*** 780	-----------------------    *(&GpioCtrlRegs+13L) &= 0xefffu;
;*** 781	-----------------------    *(&GpioCtrlRegs+5L) |= 0x300u;
;*** 782	-----------------------    *(&GpioCtrlRegs+9L) = *(&GpioCtrlRegs+9L)&0xfdffu|0x100u;
;*** 783	-----------------------    *(&GpioCtrlRegs+13L) &= 0xdfffu;
;*** 784	-----------------------    *(&GpioCtrlRegs+9L) = *(&GpioCtrlRegs+9L)&0xf7ffu|0x400u;
;*** 786	-----------------------    *(&GpioCtrlRegs+13L) &= 0x7fffu;
;*** 787	-----------------------    *(&GpioCtrlRegs+9L) = *(&GpioCtrlRegs+9L)&0x3fffu|0x4000u;
;*** 788	-----------------------    *(&GpioCtrlRegs+13L) &= 0xbfffu;
;*** 789	-----------------------    *(&GpioCtrlRegs+5L) |= 0x3000u;
;*** 790	-----------------------    *(&GpioCtrlRegs+9L) = *(&GpioCtrlRegs+9L)&0xdfffu|0x1000u;
;*** 792	-----------------------    *((volatile struct GPBDAT_BITS *)C$1+28L) &= 0xfffeu;
;*** 793	-----------------------    *((volatile struct GPBDAT_BITS *)C$2+10L) |= 1u;
;*** 794	-----------------------    *((volatile struct GPB1_BITS *)C$1+22L) &= 0xfffcu;
;*** 795	-----------------------    *((volatile struct GPBDAT_BITS *)C$1+26L) |= 1u;
;*** 797	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfffdu;
;*** 798	-----------------------    *(&GpioDataRegs+10L) |= 2u;
;*** 799	-----------------------    *(&GpioCtrlRegs+22L) &= 0xfff3u;
;*** 800	-----------------------    *(&GpioCtrlRegs+26L) |= 2u;
;*** 802	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfffbu;
;*** 803	-----------------------    *(&GpioDataRegs+10L) |= 4u;
;*** 804	-----------------------    *(&GpioCtrlRegs+22L) &= 0xffcfu;
;*** 805	-----------------------    *(&GpioCtrlRegs+26L) |= 4u;
;*** 807	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfff7u;
;*** 808	-----------------------    *((volatile struct GPBDAT_BITS *)C$2+12L) |= 0x8u;
;*** 809	-----------------------    *(&GpioCtrlRegs+22L) &= 0xff3fu;
;*** 810	-----------------------    *(&GpioCtrlRegs+26L) &= 0xfff7u;
;*** 812	-----------------------    *(&GpioCtrlRegs+28L) &= 0xffefu;
;*** 813	-----------------------    *(&GpioDataRegs+12L) |= 0x10u;
;*** 814	-----------------------    *(&GpioCtrlRegs+22L) &= 0xfcffu;
;*** 815	-----------------------    *(&GpioCtrlRegs+26L) &= 0xffefu;
;*** 817	-----------------------    *(&GpioCtrlRegs+28L) &= 0xffdfu;
;*** 818	-----------------------    *(&GpioDataRegs+10L) |= 0x20u;
;*** 819	-----------------------    *(&GpioCtrlRegs+22L) &= 0xf3ffu;
;*** 820	-----------------------    *(&GpioCtrlRegs+26L) |= 0x20u;
;*** 822	-----------------------    *(&GpioCtrlRegs+28L) &= 0xffbfu;
;*** 823	-----------------------    *(&GpioDataRegs+12L) |= 0x40u;
;*** 824	-----------------------    *(&GpioCtrlRegs+22L) &= 0xcfffu;
;*** 825	-----------------------    *(&GpioCtrlRegs+26L) &= 0xffbfu;
;*** 827	-----------------------    *(&GpioCtrlRegs+28L) |= 0x80u;
;*** 828	-----------------------    *(&GpioDataRegs+12L) |= 0x80u;
;*** 829	-----------------------    *(&GpioCtrlRegs+22L) &= 0x3fffu;
;*** 830	-----------------------    *(&GpioCtrlRegs+26L) |= 0x80u;
;*** 832	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfeffu;
;*** 833	-----------------------    *(&GpioCtrlRegs+23L) = *((volatile struct GPB1_BITS *)C$1+23L)&0xfffcu|1u;
;*** 835	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfdffu;
;*** 836	-----------------------    *(&GpioCtrlRegs+23L) = *(&GpioCtrlRegs+23L)&0xfff7u|4u;
;*** 838	-----------------------    *(&GpioCtrlRegs+28L) &= 0xfbffu;
;*** 839	-----------------------    *(&GpioCtrlRegs+23L) = *(&GpioCtrlRegs+23L)&0xffdfu|0x10u;
;*** 841	-----------------------    *(&GpioCtrlRegs+28L) &= 0xf7ffu;
;*** 842	-----------------------    *(&GpioCtrlRegs+23L) = *(&GpioCtrlRegs+23L)&0xff7fu|0x40u;
;*** 844	-----------------------    *(&GpioCtrlRegs+28L) &= 0xefffu;
;*** 845	-----------------------    *(&GpioDataRegs+12L) |= 0x1000u;
;*** 846	-----------------------    *(&GpioCtrlRegs+23L) &= 0xfcffu;
;*** 847	-----------------------    *(&GpioCtrlRegs+26L) |= 0x1000u;
;*** 849	-----------------------    *((volatile struct GPBDAT_BITS *)C$1+29L) &= 0xfffbu;
;*** 850	-----------------------    *((volatile struct GPBDAT_BITS *)C$2+13L) |= 4u;
;*** 851	-----------------------    *((volatile struct GPB2_BITS *)C$1+24L) &= 0xffcfu;
;*** 852	-----------------------    *((volatile struct GPBDAT_BITS *)C$1+27L) &= 0xfffbu;
;*** 854	-----------------------    *(&GpioCtrlRegs+29L) &= 0xfff7u;
;*** 855	-----------------------    *(&GpioDataRegs+13L) |= 0x8u;
;*** 856	-----------------------    *(&GpioCtrlRegs+24L) &= 0xff3fu;
;*** 857	-----------------------    *(&GpioCtrlRegs+27L) |= 0x8u;
;*** 859	-----------------------    *(&GpioCtrlRegs+29L) &= 0xffefu;
;*** 860	-----------------------    *(&GpioDataRegs+13L) |= 0x10u;
;*** 861	-----------------------    *(&GpioCtrlRegs+24L) &= 0xfcffu;
;*** 862	-----------------------    *(&GpioCtrlRegs+27L) |= 0x10u;
;*** 864	-----------------------    *(&GpioCtrlRegs+29L) &= 0xffdfu;
;*** 865	-----------------------    *(&GpioDataRegs+13L) |= 0x20u;
;*** 866	-----------------------    *(&GpioCtrlRegs+24L) &= 0xf3ffu;
;*** 867	-----------------------    *(&GpioCtrlRegs+27L) &= 0xffdfu;
;*** 869	-----------------------    *(&GpioCtrlRegs+29L) &= 0xffbfu;
;*** 870	-----------------------    *(&GpioDataRegs+13L) |= 0x40u;
;*** 871	-----------------------    *(&GpioCtrlRegs+24L) &= 0xcfffu;
;*** 872	-----------------------    *(&GpioCtrlRegs+27L) |= 0x40u;
;*** 874	-----------------------    *(&GpioCtrlRegs+29L) &= 0xff7fu;
;*** 875	-----------------------    *(&GpioDataRegs+13L) |= 0x80u;
;*** 876	-----------------------    *(&GpioCtrlRegs+24L) &= 0x3fffu;
;*** 877	-----------------------    *(&GpioCtrlRegs+27L) |= 0x80u;
;*** 879	-----------------------    *(&GpioCtrlRegs+29L) &= 0xfeffu;
;*** 880	-----------------------    *(&GpioDataRegs+13L) |= 0x100u;
;*** 881	-----------------------    *((volatile struct GPB2_BITS *)C$1+25L) &= 0xfffcu;
;*** 882	-----------------------    *(&GpioCtrlRegs+27L) |= 0x100u;
;*** 884	-----------------------    *(&GpioCtrlRegs+29L) |= 0x200u;
;*** 885	-----------------------    *(&GpioDataRegs+13L) |= 0x200u;
;*** 886	-----------------------    *(&GpioCtrlRegs+25L) &= 0xfff3u;
;*** 887	-----------------------    *(&GpioCtrlRegs+27L) |= 0x200u;
;*** 889	-----------------------    *(&GpioCtrlRegs+29L) |= 0x400u;
;*** 890	-----------------------    *(&GpioDataRegs+13L) |= 0x400u;
;*** 891	-----------------------    *(&GpioCtrlRegs+25L) &= 0xffcfu;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
;* AR4   assigned to $O$C1
...
$C$DW$156	.dwtag  DW_TAG_variable, DW_AT_name("$O$C2")
 ...
 EALLOW
	...
	.dwpsn	file "../APP/Initial.c",line 686,column 2,is_stmt
        OR        @_GpioDataRegs+4,#0x0200 ; [CPU_] |686| 
        MOVW      DP,#_GpioCtrlRegs+10  ; [CPU_U] 
...
$C$DW$157	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$154, DW_AT_TI_end_line(0x380)
...
$C$DW$158	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitSCI")
	...
	.dwattr $C$DW$158, DW_AT_TI_begin_line(0x574)
	.dwattr $C$DW$158, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$158, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/Initial.c",line 1397,column 1,is_stmt,address _sInitSCI
...
;***************************************************************
_sInitSCI:
;** 1399	-----------------------    SciaRegs.SCICCR.all = 7u;
;** 1401	-----------------------    SciaRegs.SCICTL1.all = 3u;
;** 1403	-----------------------    SciaRegs.SCIHBAUD = 0u;
;** 1404	-----------------------    SciaRegs.SCILBAUD = 145u;
;** 1410	-----------------------    SciaRegs.SCICTL2.all = 3u;
;** 1411	-----------------------    SciaRegs.SCICTL1.all = 35u;
;** 1414	-----------------------    ScibRegs.SCICCR.all = 7u;
;** 1416	-----------------------    ScibRegs.SCICTL1.all = 3u;
;** 1422	-----------------------    ScibRegs.SCIHBAUD = 2u;
;** 1423	-----------------------    ScibRegs.SCILBAUD = 73u;
;** 1426	-----------------------    ScibRegs.SCICTL2.all = 3u;
;** 1427	-----------------------    ScibRegs.SCICTL1.all = 35u;
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$159	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$158, DW_AT_TI_end_line(0x594)
