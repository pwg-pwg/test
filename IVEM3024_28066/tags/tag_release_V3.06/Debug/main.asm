...
;* Date/Time created: Mon Aug 28 12:03:04 2023                 *
;***************************************************************
...
$C$DW$2	.dwtag  DW_TAG_subprogram, DW_AT_name("sFBINVPFCInitial")
	.dwattr $C$DW$2, DW_AT_TI_symbol_name("_sFBINVPFCInitial")
	.dwattr $C$DW$2, DW_AT_declaration
	.dwattr $C$DW$2, DW_AT_external

$C$DW$3	.dwtag  DW_TAG_subprogram, DW_AT_name("sSciTask")
	.dwattr $C$DW$3, DW_AT_TI_symbol_name("_sSciTask")
	.dwattr $C$DW$3, DW_AT_declaration
	.dwattr $C$DW$3, DW_AT_external

$C$DW$4	.dwtag  DW_TAG_subprogram, DW_AT_name("sDisplayTask")
	.dwattr $C$DW$4, DW_AT_TI_symbol_name("_sDisplayTask")
	.dwattr $C$DW$4, DW_AT_declaration
	.dwattr $C$DW$4, DW_AT_external

$C$DW$5	.dwtag  DW_TAG_subprogram, DW_AT_name("sInitBoostParams")
	.dwattr $C$DW$5, DW_AT_TI_symbol_name("_sInitBoostParams")
...
$C$DW$10	.dwtag  DW_TAG_subprogram, DW_AT_name("sSuperTask")
	.dwattr $C$DW$10, DW_AT_TI_symbol_name("_sSuperTask")
	.dwattr $C$DW$10, DW_AT_declaration
	.dwattr $C$DW$10, DW_AT_external

$C$DW$11	.dwtag  DW_TAG_subprogram, DW_AT_name("OSInit")
	.dwattr $C$DW$11, DW_AT_TI_symbol_name("_OSInit")
	.dwattr $C$DW$11, DW_AT_declaration
	.dwattr $C$DW$11, DW_AT_external

$C$DW$12	.dwtag  DW_TAG_subprogram, DW_AT_name("OSStart")
	.dwattr $C$DW$12, DW_AT_TI_symbol_name("_OSStart")
	.dwattr $C$DW$12, DW_AT_declaration
	.dwattr $C$DW$12, DW_AT_external

$C$DW$13	.dwtag  DW_TAG_subprogram, DW_AT_name("sGridTask")
...
$C$DW$15	.dwtag  DW_TAG_subprogram, DW_AT_name("sParallelTask")
	.dwattr $C$DW$15, DW_AT_TI_symbol_name("_sParallelTask")
...
;	D:\Program Application\CCS6.1.1\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\zhang\\AppData\\Local\\Temp\\177322 C:\\Users\\zhang\\AppData\\Local\\Temp\\177324 
;	D:\Program Application\CCS6.1.1\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\zhang\\AppData\\Local\\Temp\\1773212 
	.sect	".text"
...
$C$DW$18	.dwtag  DW_TAG_subprogram, DW_AT_name("sOSTimerStop")
	...
	.dwattr $C$DW$18, DW_AT_TI_begin_line(0x3b)
	.dwattr $C$DW$18, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$18, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/main.c",line 60,column 1,is_stmt,address _sOSTimerStop
...
_sOSTimerStop:
;*** 61	-----------------------    asm("\tSETC\tINTM");
;*** 63	-----------------------    *((C$1 = &((unsigned *)OSTCBTbl)[0])+8L) = 0u;
;*** 64	-----------------------    C$1[14] = 0u;
;*** 65	-----------------------    C$1[20] = 0u;
;*** 66	-----------------------    C$1[32] = 0u;
;*** 68	-----------------------    C$1[38] = 0u;
...
$C$DW$21	.dwtag  DW_TAG_subprogram, DW_AT_name("sOSTimerStart")
	...
	.dwattr $C$DW$21, DW_AT_TI_begin_line(0x48)
	.dwattr $C$DW$21, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$21, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../APP/main.c",line 73,column 1,is_stmt,address _sOSTimerStart
...
_sOSTimerStart:
;*** 74	-----------------------    asm("\tSETC\tINTM");
;*** 76	-----------------------    *((C$1 = &((unsigned *)OSTCBTbl)[0])+9L) = 1u;
;*** 76	-----------------------    C$1[8] = 20u;
;*** 77	-----------------------    C$1[15] = 3u;
;*** 77	-----------------------    C$1[14] = 40u;
;*** 78	-----------------------    C$1[21] = 7u;
...
$C$DW$22	.dwtag  DW_TAG_variable, DW_AT_name("$O$C1")
	...
	SETC	INTM
	.dwpsn	file "../APP/main.c",line 76,column 2,is_stmt
        MOVL      XAR4,#_OSTCBTbl       ; [CPU_U] |76| 
        MOVB      XAR0,#9               ; [CPU_] |76| 
        MOVB      *+XAR4[AR0],#1,UNC    ; [CPU_] |76| 
        MOVB      XAR0,#8               ; [CPU_] |76| 
        MOVB      *+XAR4[AR0],#20,UNC   ; [CPU_] |76| 
	.dwpsn	file "../APP/main.c",line 77,column 2,is_stmt
        MOVB      XAR0,#15              ; [CPU_] |77| 
        MOVB      *+XAR4[AR0],#3,UNC    ; [CPU_] |77| 
        MOVB      XAR0,#14              ; [CPU_] |77| 
        MOVB      *+XAR4[AR0],#40,UNC   ; [CPU_] |77| 
	.dwpsn	file "../APP/main.c",line 78,column 2,is_stmt
        MOVB      XAR0,#21              ; [CPU_] |78| 
        MOVB      *+XAR4[AR0],#7,UNC    ; [CPU_] |78| 
        MOVB      XAR0,#20              ; [CPU_] |78| 
        MOVB      *+XAR4[AR0],#40,UNC   ; [CPU_] |78| 
	.dwpsn	file "../APP/main.c",line 79,column 2,is_stmt
        MOVB      XAR0,#33              ; [CPU_] |79| 
        MOVB      *+XAR4[AR0],#11,UNC   ; [CPU_] |79| 
        MOVB      XAR0,#32              ; [CPU_] |79| 
        MOVB      *+XAR4[AR0],#100,UNC  ; [CPU_] |79| 
	.dwpsn	file "../APP/main.c",line 81,column 2,is_stmt
        MOVB      XAR0,#39              ; [CPU_] |81| 
        MOVB      *+XAR4[AR0],#15,UNC   ; [CPU_] |81| 
        MOVB      XAR0,#38              ; [CPU_] |81| 
        MOVB      *+XAR4[AR0],#200,UNC  ; [CPU_] |81| 
	CLRC	INTM
        SPM       #0                    ; [CPU_] 
...
$C$DW$24	.dwtag  DW_TAG_subprogram, DW_AT_name("main")
	...
	.dwattr $C$DW$24, DW_AT_TI_begin_line(0x14)
	.dwattr $C$DW$24, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$24, DW_AT_TI_max_frame_size(-4)
	.dwpsn	file "../APP/main.c",line 21,column 1,is_stmt,address _main
...
;*** 53	-----------------------    OSTaskCreate(&sDisplayTask, 300u, 6u);
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
        MOVL      *SP++,XAR1            ; [CPU_] 
...
$C$DW$25	.dwtag  DW_TAG_variable, DW_AT_name("$O$C1")
	...
	.dwpsn	file "../APP/main.c",line 24,column 2,is_stmt
$C$DW$26	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$26, DW_AT_low_pc(0x00)
	.dwattr $C$DW$26, DW_AT_name("_sInitialDSP")
	.dwattr $C$DW$26, DW_AT_TI_call
        LCR       #_sInitialDSP         ; [CPU_] |24| 
        ; call occurs [#_sInitialDSP] ; [] |24| 
	.dwpsn	file "../APP/main.c",line 26,column 2,is_stmt
$C$DW$27	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$27, DW_AT_low_pc(0x00)
	.dwattr $C$DW$27, DW_AT_name("_sFBINVPFCInitial")
	.dwattr $C$DW$27, DW_AT_TI_call
        LCR       #_sFBINVPFCInitial    ; [CPU_] |26| 
        ; call occurs [#_sFBINVPFCInitial] ; [] |26| 
	.dwpsn	file "../APP/main.c",line 27,column 2,is_stmt
$C$DW$28	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$28, DW_AT_low_pc(0x00)
	.dwattr $C$DW$28, DW_AT_name("_sInitBoostParams")
	.dwattr $C$DW$28, DW_AT_TI_call
        LCR       #_sInitBoostParams    ; [CPU_] |27| 
        ; call occurs [#_sInitBoostParams] ; [] |27| 
...
$C$DW$35	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../APP/main.c",line 53,column 2,is_stmt
        MOVB      AH,#6                 ; [CPU_] |53| 
        MOV       AL,#300               ; [CPU_] |53| 
        MOVL      XAR4,#_sDisplayTask   ; [CPU_U] |53| 
	.dwpsn	file "../APP/main.c",line 51,column 2,is_stmt
...
$C$DW$36	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$36, DW_AT_TI_call
        LCR       #_OSTaskCreate        ; [CPU_] |53| 
        ; call occurs [#_OSTaskCreate] ; [] |53| 
;*** 54	-----------------------    *((unsigned *)C$1+39L) = 15u;
;*** 54	-----------------------    *((unsigned *)C$1+38L) = 200u;
;*** 56	-----------------------    OSStart();
;***  	-----------------------    return;
	.dwpsn	file "../APP/main.c",line 54,column 2,is_stmt
        MOVB      XAR0,#39              ; [CPU_] |54| 
        MOVB      *+XAR1[AR0],#15,UNC   ; [CPU_] |54| 
        MOVB      XAR0,#38              ; [CPU_] |54| 
        MOVB      *+XAR1[AR0],#200,UNC  ; [CPU_] |54| 
	.dwpsn	file "../APP/main.c",line 56,column 2,is_stmt
$C$DW$37	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$37, DW_AT_low_pc(0x00)
	.dwattr $C$DW$37, DW_AT_name("_OSStart")
...
$C$DW$39	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$39, DW_AT_name("OSTCBStkPtr")
	.dwattr $C$DW$39, DW_AT_TI_symbol_name("_OSTCBStkPtr")
	.dwattr $C$DW$39, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr $C$DW$39, DW_AT_accessibility(DW_ACCESS_public)
$C$DW$40	.dwtag  DW_TAG_member
	.dwattr $C$DW$40, DW_AT_type(*$C$DW$T$11)
	.dwattr $C$DW$40, DW_AT_name("TimerPeriod")
	.dwattr $C$DW$40, DW_AT_TI_symbol_name("_TimerPeriod")
	.dwattr $C$DW$40, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr $C$DW$40, DW_AT_accessibility(DW_ACCESS_public)
$C$DW$41	.dwtag  DW_TAG_member
	.dwattr $C$DW$41, DW_AT_type(*$C$DW$T$11)
	.dwattr $C$DW$41, DW_AT_name("TimerCnt")
	.dwattr $C$DW$41, DW_AT_TI_symbol_name("_TimerCnt")
	.dwattr $C$DW$41, DW_AT_data_member_location[DW_OP_plus_uconst 0x3]
	.dwattr $C$DW$41, DW_AT_accessibility(DW_ACCESS_public)
$C$DW$42	.dwtag  DW_TAG_member
	.dwattr $C$DW$42, DW_AT_type(*$C$DW$T$11)
	.dwattr $C$DW$42, DW_AT_name("OSEvent")
	.dwattr $C$DW$42, DW_AT_TI_symbol_name("_OSEvent")
	.dwattr $C$DW$42, DW_AT_data_member_location[DW_OP_plus_uconst 0x4]
	.dwattr $C$DW$42, DW_AT_accessibility(DW_ACCESS_public)
$C$DW$43	.dwtag  DW_TAG_member
	.dwattr $C$DW$43, DW_AT_type(*$C$DW$T$11)
	.dwattr $C$DW$43, DW_AT_name("OSEventBitMask")
	.dwattr $C$DW$43, DW_AT_TI_symbol_name("_OSEventBitMask")
...
$C$DW$44	.dwtag  DW_TAG_subrange_type
	.dwattr $C$DW$44, DW_AT_upper_bound(0x06)
	.dwendtag $C$DW$T$22
