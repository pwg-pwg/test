...
;* Date/Time created: Thu Apr 03 14:39:47 2025                 *
;***************************************************************
...
;	D:\ccs software\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\Lin\\AppData\\Local\\Temp\\338802 C:\\Users\\Lin\\AppData\\Local\\Temp\\338804 
;	D:\ccs software\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\Lin\\AppData\\Local\\Temp\\3388012 
	.sect	".text"
...
$C$DW$4	.dwtag  DW_TAG_subprogram, DW_AT_name("ubGetSciRxError")
	...
	.dwattr $C$DW$4, DW_AT_TI_begin_line(0xf2)
	.dwattr $C$DW$4, DW_AT_TI_begin_column(0x07)
	.dwattr $C$DW$4, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 243,column 1,is_stmt,address _ubGetSciRxError
...
;***************************************************************
_ubGetSciRxError:
;*** 250	-----------------------    return sciid ? *(&ScibRegs+5L)>>7&1u : *(&SciaRegs+5L)>>7&1u;
	.dwcfi	cfa_offset, -2
...
$C$DW$6	.dwtag  DW_TAG_variable, DW_AT_name("sciid")
	...
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 250,column 3,is_stmt
        CMPB      AL,#0                 ; [CPU_] |250| 
        BF        $C$L1,EQ              ; [CPU_] |250| 
        ; branchcc occurs ; [] |250| 
        MOVW      DP,#_ScibRegs+5       ; [CPU_U] 
        AND       AL,@_ScibRegs+5,#0x0080 ; [CPU_] |250| 
        B         $C$L2,UNC             ; [CPU_] |250| 
        ; branch occurs ; [] |250| 
$C$L1:    
        MOVW      DP,#_SciaRegs+5       ; [CPU_U] 
        AND       AL,@_SciaRegs+5,#0x0080 ; [CPU_] |250| 
$C$L2:    
        LSR       AL,7                  ; [CPU_] |250| 
$C$DW$7	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$4, DW_AT_TI_end_line(0xfc)
...
$C$DW$20	.dwtag  DW_TAG_subprogram, DW_AT_name("sSetSciSWReset")
	...
	.dwattr $C$DW$20, DW_AT_TI_begin_line(0xfe)
	.dwattr $C$DW$20, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$20, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 255,column 1,is_stmt,address _sSetSciSWReset
...
$C$DW$24	.dwtag  DW_TAG_variable, DW_AT_name("sciid")
	...
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 256,column 2,is_stmt
        CMPB      AL,#0                 ; [CPU_] |256| 
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 255,column 1,is_stmt
        MOVZ      AR6,AH                ; [CPU_] |255| 
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 256,column 2,is_stmt
        BF        $C$L3,EQ              ; [CPU_] |256| 
        ; branchcc occurs ; [] |256| 
;*** 260	-----------------------    if ( sciid != 1u ) goto g5;
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 260,column 7,is_stmt
        CMPB      AL,#1                 ; [CPU_] |260| 
        BF        $C$L4,NEQ             ; [CPU_] |260| 
        ; branchcc occurs ; [] |260| 
;*** 262	-----------------------    *(&ScibRegs+1L) = *(&ScibRegs+1L)&0xffdfu|(ubValue&1u)<<5;
;*** 262	-----------------------    goto g5;
        MOVW      DP,#_ScibRegs+1       ; [CPU_U] 
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 262,column 3,is_stmt
        AND       AL,AR6,#0x0001        ; [CPU_] |262| 
        AND       AH,@_ScibRegs+1,#0xffdf ; [CPU_] |262| 
        LSL       AL,5                  ; [CPU_] |262| 
        OR        AL,AH                 ; [CPU_] |262| 
        MOV       @_ScibRegs+1,AL       ; [CPU_] |262| 
...
$C$L3:    
;***	-----------------------g4:
;*** 258	-----------------------    *(&SciaRegs+1L) = *(&SciaRegs+1L)&0xffdfu|(ubValue&1u)<<5;
;***	-----------------------g5:
;***  	-----------------------    return;
        MOVW      DP,#_SciaRegs+1       ; [CPU_U] 
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 258,column 3,is_stmt
        AND       AL,AR6,#0x0001        ; [CPU_] |258| 
        AND       AH,@_SciaRegs+1,#0xffdf ; [CPU_] |258| 
        LSL       AL,5                  ; [CPU_] |258| 
        OR        AL,AH                 ; [CPU_] |258| 
        MOV       @_SciaRegs+1,AL       ; [CPU_] |258| 
$C$L4:    
$C$DW$26	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$20, DW_AT_TI_end_line(0x108)
...
;*** 168	-----------------------    *(&ScibRegs+4L) |= 1u;
        MOVW      DP,#_ScibRegs+4       ; [CPU_U] 
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 168,column 3,is_stmt
...
$C$DW$55	.dwtag  DW_TAG_subprogram, DW_AT_name("sSciChangeBaudRateB")
	...
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 220,column 1,is_stmt,address _sSciChangeBaudRateB
...
;*** 222	-----------------------    ScibRegs.SCICCR.all = 7u;
;*** 224	-----------------------    ScibRegs.SCICTL1.all = 3u;
;*** 226	-----------------------    if ( baudrate == 2u ) goto g4;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$57	.dwtag  DW_TAG_variable, DW_AT_name("baudrate")
	...
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 226,column 5,is_stmt
        CMPB      AL,#2                 ; [CPU_] |226| 
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 222,column 2,is_stmt
        MOVB      @_ScibRegs,#7,UNC     ; [CPU_] |222| 
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 224,column 2,is_stmt
        MOVB      @_ScibRegs+1,#3,UNC   ; [CPU_] |224| 
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 226,column 5,is_stmt
        BF        $C$L6,EQ              ; [CPU_] |226| 
        ; branchcc occurs ; [] |226| 
;*** 231	-----------------------    if ( baudrate != 4u ) goto g5;
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 231,column 7,is_stmt
        CMPB      AL,#4                 ; [CPU_] |231| 
        BF        $C$L7,NEQ             ; [CPU_] |231| 
        ; branchcc occurs ; [] |231| 
;*** 233	-----------------------    ScibRegs.SCIHBAUD = 0u;
;*** 234	-----------------------    ScibRegs.SCILBAUD = 145u;
;*** 234	-----------------------    goto g5;
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 233,column 3,is_stmt
        MOV       @_ScibRegs+2,#0       ; [CPU_] |233| 
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 234,column 3,is_stmt
        MOVB      @_ScibRegs+3,#145,UNC ; [CPU_] |234| 
        B         $C$L7,UNC             ; [CPU_] |234| 
        ; branch occurs ; [] |234| 
$C$L6:    
;***	-----------------------g4:
;*** 228	-----------------------    ScibRegs.SCIHBAUD = 2u;
;*** 229	-----------------------    ScibRegs.SCILBAUD = 73u;
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 228,column 6,is_stmt
        MOVB      @_ScibRegs+2,#2,UNC   ; [CPU_] |228| 
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 229,column 6,is_stmt
        MOVB      @_ScibRegs+3,#73,UNC  ; [CPU_] |229| 
$C$L7:    
;***	-----------------------g5:
;*** 238	-----------------------    ScibRegs.SCICTL2.all = 3u;
;*** 239	-----------------------    ScibRegs.SCICTL1.all = 35u;
;***  	-----------------------    return;
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 238,column 2,is_stmt
        MOVB      @_ScibRegs+4,#3,UNC   ; [CPU_] |238| 
	.dwpsn	file "../DRIVER/SCI/ports/SciFunLst.c",line 239,column 2,is_stmt
        MOVB      @_ScibRegs+1,#35,UNC  ; [CPU_] |239| 
