...
void sLEDDisplay(void)
{
	...
	else
	{
		...
		if((g_uwWorkMode == cFaultMode)||(ubInverterWarningLEDFlash && (wLEDDispalyCnt > 4)))
		{
			hoFAULTLEDOn;
		}
		else
...
{ 
	...
	sSendBitToVram(cBIT_IVEM3024, DISPLAY_ON, cALWAYS_LIGHT);
...
//		}
		...
		{
			if(!fBMSConnectFlg && g_uwBatType == cBatSocType && g_ubBMSFirstCommDone)
			{
