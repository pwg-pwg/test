...
{
	swGetSolarVolt1Sample,	swGetSolarCurr1Sample,		swGetSolarCurrAvg1Sample,				// 2
	swGetBatVoltSample,		swGetConvertVoltSample,		swGetPDCDCCurrSample,					// 5
	swGetPDCDCAvgCurrSample,swGetPBusVoltSample,		swGetRInvVoltSample,					// 8
	swGetRInvCurrSample,	swGetROPVoltSample,			swGetROPCurrSample,						// 11
	swGetROPShareCurrSample,swGetRLineVoltSample,		swGetRLineVoltSample,					// 14
	swGetSolarBSTTempSample,swGetConvertTempSample,		swGetInvTempSample,						// 17
	swGetInnelTempSample,	swGetModelSample,			swGetRInvDCVoltSample,					// 20	
	swGetRInvCurr1Sample,	swGetRInvCurr2Sample,		swReturnNull,							// 23
	swReturnNull,			swReturnNull,				swReturnNull,							// 26
	
	swGetSolarVolt1Real,	swGetSolarCurr1Real,		swGetSolarCurrAvg1Real,					// 29
	swGetBatVoltReal,		swGetConvertVoltReal,		swGetPDCDCCurrReal,						// 32
	swGetPDCDCAvgCurrReal,	swGetPBusVoltReal,			swGetRInvVoltReal,						// 35
	swGetRInvCurrReal,		swGetROPVoltReal,			swGetROPCurrReal,						// 38
	swGetROPShareCurrReal,	swGetRLineVoltReal,			swGetRLineVoltReal,						// 41
	swGetRInvDCVoltReal,	swGetRInvCurr1Real,			swGetRInvCurr2Real,						// 44
	//PV
	swGetVm_P,				swGetImo_P1,				swGetR_Is_P1,							// 47
	swGetBoost_PWM,			swGetVerr_P1,				(pFunc1)suwGetBoost1CtrlSts,			// 50
	swReturnNull,			swReturnNull,				swReturnNull,							// 53
	swReturnNull,			swReturnNull,				swReturnNull,							// 56
	//并网
	swGetInvBusVoltRef,		swGetFBVm_P,				swGetRFBVm_P,							// 59
	swGetFBImo_P,			swGetFBR_Is_P,				swGetRFBPWM,							// 62
	swGetFBPWM,				swReturnNull,				swReturnNull,							// 65
	swReturnNull,			swReturnNull,				swReturnNull,							// 68
	//离网
	swGetVref,				swGetKpwm,					swGetRInvVoltCntl,						// 71
	swGetRInvCurrCntl,		swGetRInvDCVoltCtrl,		swGetRLoadCurrCntl,						// 74
	swGetInvVoltError,		swGetVBeforeSaturation,		swGetVoltLimit,							// 77
	swGetLoopOutput,		swGetInvStep,				swReturnNull,							// 80
	//dcdc
	swGetPBusVoltErr,		swGetBatVoltErr,			swGetBusVoltErr,						// 83
	swGetBusVmo,			swGetPDCDCImo,				swGetPDCDCIErr,							// 86
	swGetPDCDCPWM,			swGetFBPWM,					swReturnNull,							// 89
	swReturnNull,			swReturnNull,				swReturnNull,							// 92
	
	swGetUserData1,			swGetUserData2,				swGetUserData3,							// 95
	swGetUserData4,			swGetUserData5,				swGetUserData6,							// 98
	swGetUserData7																				// 99
};
	...
	while(1)
	{
		...
		if(event&(1<<eInterfaceTimer))
		{
			...
			else
			{
			    ...
			    //sSciRxDebugCommand(0);	//for RS232
				...
				if(g_uwBatType == cBatSocType)
				{
					...
					{
						sPylonBMSCmdProc(0,g_ubUserDataBuf0[0],cBMSCmdRollTime); //2s		50ms/1
					}
					else
					{
			...
			{
				if(++g_wIOTDataGetCnt > 3000)//2.5min
				{
...
//	wSciLength += 4;
	...
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + hoOPSCR;
	g_ubUserDataBuf0[sciid][wSciLength++] = cChar_Space;
	...
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + g_uwLiBatActStep;
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + g_ubRTCOKFlg;
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + g_uwWorkMode;	
	g_ubUserDataBuf0[sciid][wSciLength++] = cChar_Space;
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + subGetBatWeakSts();//1		
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + subGetBatUnderSts();	//0		
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + subGetParaBatUnderSts();	//0
	g_ubUserDataBuf0[sciid][wSciLength++] = cChar_Space;
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + subGetBatPowerDownSts();//1
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + subGetParaBatPowerDownSts();//1
...
void sQ2Command(INT8U sciid)
{
	...
	wSciLength += 3;
	g_ubUserDataBuf0[sciid][wSciLength++] = cChar_Space;
	sNumToASCII(g_wConvertTemp, 3, 0, &g_ubUserDataBuf0[sciid][wSciLength]);
	wSciLength += 3;
	g_ubUserDataBuf0[sciid][wSciLength++] = cChar_Space;
	...
	wSciLength += 2;
	g_ubUserDataBuf0[sciid][wSciLength++] = cChar_Space;
	sNumToASCII(g_wBusRealVoltLowFlgCnt, 2, 0,&g_ubUserDataBuf0[sciid][wSciLength]);
	wSciLength+=2;
...
void sTestCommand(INT8U sciid)
{
	...
	if((g_ubCommandBuffer[sciid][1] == 'S') && (g_ubCommandBuffer[sciid][2] == 'T'))
	{
			...
			&& (g_ubCommandBuffer[sciid][7] == 'E') && (g_ubCommandBuffer[sciid][8] == 'F'))
		{
			...
			&& (g_ubCommandBuffer[sciid][5] == 'P') && (g_ubCommandBuffer[sciid][6] == 'T'))
		{
			...
			&& (g_ubCommandBuffer[sciid][5] == 'V') && (g_ubCommandBuffer[sciid][6] == 'D')
			&& (g_ubCommandBuffer[sciid][7] == 'C'))
		{
			...
			&& (g_ubCommandBuffer[sciid][8] == 'K') && (g_ubCommandBuffer[sciid][9] == 'P'))
		{
			...
			&& (g_ubCommandBuffer[sciid][5] == 'B') && (g_ubCommandBuffer[sciid][6] == 'S') && (g_ubCommandBuffer[sciid][7] == 'T')
			&& (g_ubCommandBuffer[sciid][8] == 'K') && (g_ubCommandBuffer[sciid][9] == 'I'))
		{
			if(g_ubCommandBuffer[sciid][10] == '?')
			{
				g_ubUserDataBuf0[sciid][0] = '(';
			...
			&& (g_ubCommandBuffer[sciid][7] == 'K') && (g_ubCommandBuffer[sciid][8] == 'I'))
		{
			if(g_ubCommandBuffer[sciid][9] == '?')
			{
				g_ubUserDataBuf0[sciid][0] = '(';
			...
			&& (g_ubCommandBuffer[sciid][5] == 'D') && (g_ubCommandBuffer[sciid][6] == 'C')
			&& (g_ubCommandBuffer[sciid][7] == 'K') && (g_ubCommandBuffer[sciid][8] == 'P'))
		{
			if(g_ubCommandBuffer[sciid][9] == '?')
			{
				g_ubUserDataBuf0[sciid][0] = '(';
...
//		}
//		else if((g_ubCommandBuffer[sciid][3] == 'B') && (g_ubCommandBuffer[sciid][4] == 'A')
//			&& (g_ubCommandBuffer[sciid][5] == 'T') && (g_ubCommandBuffer[sciid][6] == 'O')
//			&& (g_ubCommandBuffer[sciid][7] == 'N'))
//		{
//			if(g_ubCommandBuffer[sciid][8] == '1')
//			{
//				hoBATONOn;
...
//			sACK(sciid);
//		}
//		else if((g_ubCommandBuffer[sciid][3] == '3') && (g_ubCommandBuffer[sciid][4] == '5')
//			&& (g_ubCommandBuffer[sciid][5] == '2') && (g_ubCommandBuffer[sciid][6] == '5'))
//		{
//			if(g_ubCommandBuffer[sciid][7] == '1')
//			{
//				if(!mChkDCDCLLCOn())
...
//			&& (g_ubCommandBuffer[sciid][7] == 'W') && (g_ubCommandBuffer[sciid][8] == 'M'))
//		{
//			if(g_ubCommandBuffer[sciid][9] == '?')
//			{
//				g_ubUserDataBuf0[sciid][0] = '(';
...
//		{
//			if((g_ubCommandBuffer[sciid][5] == 'S') && (g_ubCommandBuffer[sciid][6] == 'C')
//			&& (g_ubCommandBuffer[sciid][7] == 'R'))
//			{
//				if(g_ubCommandBuffer[sciid][8] == '1')
//				{
...
//				}				
//			}
//			else if((g_ubCommandBuffer[sciid][5] == '1'))
//			{
//				hoOPRLYOn;			
//			}
...
//			sACK(sciid);
//		}
//		else if((g_ubCommandBuffer[sciid][3] == 'P') && (g_ubCommandBuffer[sciid][4] == 'A')
//			&& (g_ubCommandBuffer[sciid][5] == 'R') && (g_ubCommandBuffer[sciid][6] == 'A'))
//		{
//			if((g_ubCommandBuffer[sciid][7] == '1'))
//			{
//				hoPARRLYOn;			
...
//			&& (g_ubCommandBuffer[sciid][6] == 'W') && (g_ubCommandBuffer[sciid][7] == 'M'))
//		{
//			if(g_ubCommandBuffer[sciid][8] == '?')
//			{
//				g_ubUserDataBuf0[sciid][0] = '(';
...
//					OS_ENTER_CRITICAL();
//					g_uwBoostPWM = wTemp;
//					EPwm2Regs.CMPB = cPWMCntlPeriod50Hz - (INT16S)((INT32S)g_uwBoostPWM * cPWMCntlPeriod50Hz / 100);
//					OS_EXIT_CRITICAL();
//					sACK(sciid);
//				}
//				else
...
//					EPwm2Regs.CMPB = cPWMCntlPeriod50Hz;
//					OS_EXIT_CRITICAL();
//				}
//			}
//			else
...
//		else if((g_ubCommandBuffer[sciid][3] == 'D') && (g_ubCommandBuffer[sciid][4] == 'C')
//			&& (g_ubCommandBuffer[sciid][5] == 'B') && (g_ubCommandBuffer[sciid][6] == 'S') && (g_ubCommandBuffer[sciid][7] == 'T')
//			&& (g_ubCommandBuffer[sciid][8] == 'P') && (g_ubCommandBuffer[sciid][9] == 'W') && (g_ubCommandBuffer[sciid][10] == 'M'))
//		{
...
//		}
			...
			&& (g_ubCommandBuffer[sciid][8] == 'G'))
		{
			sSetConfigButton();
			sACK(sciid);
		}
		else if((g_ubCommandBuffer[sciid][3] == 'E') && (g_ubCommandBuffer[sciid][4] == 'N')
			&& (g_ubCommandBuffer[sciid][5] == 'T') && (g_ubCommandBuffer[sciid][6] == 'E') && (g_ubCommandBuffer[sciid][7] == 'R'))
		{
			sSetEnterButton();
			sACK(sciid);
		}
