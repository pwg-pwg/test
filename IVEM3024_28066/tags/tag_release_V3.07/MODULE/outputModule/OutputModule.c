...
void sOPPercentCal(void)
{
	...
	if(	mChkGridRlyOn())//市电带载
	{
		...
		//if(g_uwRInvCurr > 0)	g_wGridCurrPercent = (INT16S)((INT32S)(g_uwROPCurr - g_uwRInvCurr) * 100 / cGridRateCurr);
		//else					g_wGridCurrPercent = (INT16S)((INT32S)g_uwROPCurr * 100 / cGridRateCurr);
	}
	else
	{
