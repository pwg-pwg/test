...
;* Date/Time created: Wed Jun 29 14:31:53 2022                 *
;***************************************************************
...
;	C:\Work\Software\CCS5.4\ccsv5\tools\compiler\c2000_6.1.3\bin\opt2000.exe C:\\Users\\Daily\\AppData\\Local\\Temp\\037923 C:\\Users\\Daily\\AppData\\Local\\Temp\\037925 
;	C:\Work\Software\CCS5.4\ccsv5\tools\compiler\c2000_6.1.3\bin\ac2000.exe -@C:\\Users\\Daily\\AppData\\Local\\Temp\\0379213 
	.sect	".text"
	.global	_swMPPTTrack
...
;** 1176	-----------------------    dwSolarPower2Limit = 40000L;
...
;** 1199	-----------------------    if ( dwSolarPower1Limit <= 40000L ) goto g27;
...
$C$L62:    
;***	-----------------------g25:
;** 1199	-----------------------    dwSolarPower1Limit = 40000L;
;** 1199	-----------------------    goto g27;
...
;** 1201	-----------------------    if ( dwSolarPower2Limit <= 40000L ) goto g32;
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 1201,column 9,is_stmt
        MOVL      XAR4,#40000           ; [CPU_U] |1201| 
...
$C$L66:    
;***	-----------------------g31:
;** 1207	-----------------------    dwSolarPower1Limit = __lmin(40000L, dwSolarPowerMax);
;** 1213	-----------------------    dwSolarPower2Limit = 4000L;
        CLRC      SXM                   ; [CPU_] 
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 1207,column 5,is_stmt
        MOV       ACC,#40000            ; [CPU_] |1207| 
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 1213,column 4,is_stmt
        MOVL      XAR4,#4000            ; [CPU_U] |1213| 
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 1207,column 5,is_stmt
...
;** 1251	-----------------------    ((long)g_uwSolarPower1Avg > U$120+500L) ? (wSolarLimitCurrTemp = wSolarLimitCurrTemp-10) : (wSolarLimitCurrTemp = ((long)g_uwSolarPower1Avg > U$120+300L) ? wSolarLimitCurrTemp-5 : ((long)g_uwSolarPower1Avg > U$120+200L) ? wSolarLimitCurrTemp-2 : ((long)g_uwSolarPower1Avg > U$120 || g_uwSolarCurr1Avg > 1500u) ? wSolarLimitCurrTemp-1 : wSolarLimitCurrTemp+1);
        MOVW      DP,#_g_wPv1CurrLimit  ; [CPU_U] 
...
$C$L73:    
        ...
        ; branchcc occurs ; [] |1251| 
        CMP       @_g_uwSolarCurr1Avg,#1500 ; [CPU_] |1251| 
...
;** 1294	-----------------------    U$154 = dwSolarPower2Limit/10L;
;** 1296	-----------------------    ((long)g_uwSolarPower2Avg > U$154+500L) ? (wSolarLimitCurrTemp = wSolarLimitCurrTemp-10) : (wSolarLimitCurrTemp = ((long)g_uwSolarPower2Avg > U$154+300L) ? wSolarLimitCurrTemp-5 : ((long)g_uwSolarPower2Avg > U$154+200L) ? wSolarLimitCurrTemp-2 : ((long)g_uwSolarPower2Avg > U$154 || g_uwSolarCurr2Avg > 1500u) ? wSolarLimitCurrTemp-1 : wSolarLimitCurrTemp+1);
	SETC	INTM
        MOVW      DP,#_g_wPv1CurrLimit  ; [CPU_U] 
...
$C$L83:    
        ...
        ; branchcc occurs ; [] |1296| 
        CMP       @_g_uwSolarCurr2Avg,#1500 ; [CPU_] |1296| 
...
;** 1338	-----------------------    g_wSolarPower2Limit = U$154;
;***  	-----------------------    return;
	SETC	INTM
...
$C$L121:    
;***	-----------------------g6:
;*** 955	-----------------------    y$14 = (int)((long)g_wBusVoltVerr*15L>>3);
...
;*** 958	-----------------------    if ( C$7 > 300 ) goto g9;
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 955,column 3,is_stmt
        MPY       ACC,@_g_wBusVoltVerr,#15 ; [CPU_] |955| 
        SFR       ACC,3                 ; [CPU_] |955| 
