...
;* Date/Time created: Fri May 20 14:26:46 2022                 *
;***************************************************************
...
;	C:\CCS5.4_install\ccsv5\tools\compiler\c2000_6.1.3\bin\opt2000.exe C:\\Users\\CM\\AppData\\Local\\Temp\\019722 C:\\Users\\CM\\AppData\\Local\\Temp\\019724 
;	C:\CCS5.4_install\ccsv5\tools\compiler\c2000_6.1.3\bin\ac2000.exe -@C:\\Users\\CM\\AppData\\Local\\Temp\\0197212 
	.sect	".text"
	.global	_sDelay4us
...
$C$DW$7	.dwtag  DW_TAG_subprogram, DW_AT_name("sDelay4us")
	...
	.dwattr $C$DW$7, DW_AT_TI_begin_file("Z:/VMVare Map File/IVPS1512/IVPS1512/Driver\Eeprom\ports\i2chdports.h")
	.dwattr $C$DW$7, DW_AT_TI_begin_line(0x1b)
	.dwattr $C$DW$7, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$7, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "Z:/VMVare Map File/IVPS1512/IVPS1512/Driver\Eeprom\ports\i2chdports.h",line 28,column 1,is_stmt,address _sDelay4us
...
;***  	-----------------------    return;
 NOP 
	.dwpsn	file "Z:/VMVare Map File/IVPS1512/IVPS1512/Driver\Eeprom\ports\i2chdports.h",line 31,column 13,is_stmt
...
$C$DW$9	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$9, DW_AT_name("Z:\VMVare Map File\IVPS1512\IVPS1512\Debug\EEPromdriver.asm:$C$L1:1:1653028006")
	.dwattr $C$DW$9, DW_AT_TI_begin_file("Z:/VMVare Map File/IVPS1512/IVPS1512/Driver\Eeprom\ports\i2chdports.h")
...
$C$DW$10	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$7, DW_AT_TI_end_file("Z:/VMVare Map File/IVPS1512/IVPS1512/Driver\Eeprom\ports\i2chdports.h")
...
$C$DW$26	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$26, DW_AT_name("Z:\VMVare Map File\IVPS1512\IVPS1512\Debug\EEPromdriver.asm:$C$L4:1:1653028006")
...
$C$DW$39	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$39, DW_AT_name("Z:\VMVare Map File\IVPS1512\IVPS1512\Debug\EEPromdriver.asm:$C$L5:1:1653028006")
...
$C$DW$59	.dwtag  DW_TAG_subprogram, DW_AT_name("sEepromWrite")
	...
	.dwattr $C$DW$59, DW_AT_TI_max_frame_size(-12)
...
$C$DW$79	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$79, DW_AT_name("Z:\VMVare Map File\IVPS1512\IVPS1512\Debug\EEPromdriver.asm:$C$L11:1:1653028006")
...
$C$DW$82	.dwtag  DW_TAG_subprogram, DW_AT_name("sEepromSoftwareReset")
	...
	.dwattr $C$DW$82, DW_AT_TI_begin_line(0x195)
	.dwattr $C$DW$82, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$82, DW_AT_TI_max_frame_size(-4)
	.dwpsn	file "../DRIVER/eeprom/source/EEPromdriver.c",line 406,column 1,is_stmt,address _sEepromSoftwareReset
...
$C$DW$84	.dwtag  DW_TAG_variable, DW_AT_name("wdata")
	...
	.dwpsn	file "../DRIVER/eeprom/source/EEPromdriver.c",line 408,column 9,is_stmt
        MOVB      XAR7,#0               ; [CPU_] |408| 
	.dwpsn	file "../DRIVER/eeprom/source/EEPromdriver.c",line 410,column 8,is_stmt
        MOV       PL,#1                 ; [CPU_] |410| 
$C$L15:    
...
$C$DW$85	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$85, DW_AT_TI_call
        LCR       #_sI2CBitIn           ; [CPU_] |415| 
        ; call occurs [#_sI2CBitIn] ; [] |415| 
        MOV       AH,AR7                ; [CPU_] |415| 
        ADD       AH,AL                 ; [CPU_] |415| 
        MOVZ      AR7,AH                ; [CPU_] |415| 
	.dwpsn	file "../DRIVER/eeprom/source/EEPromdriver.c",line 412,column 11,is_stmt
        BANZ      $C$L16,AR2--          ; [CPU_] |412| 
        ; branchcc occurs ; [] |412| 
$C$DW$L$_sEepromSoftwareReset$3$E:
$C$DW$L$_sEepromSoftwareReset$4$B:
;*** 419	-----------------------    if ( wdata == 511u ) goto g6;
	.dwpsn	file "../DRIVER/eeprom/source/EEPromdriver.c",line 419,column 4,is_stmt
        CMP       AR7,#511              ; [CPU_] |419| 
        BF        $C$L17,EQ             ; [CPU_] |419| 
        ; branchcc occurs ; [] |419| 
...
;***	-----------------------g6:
;***  	-----------------------    return;
	.dwpsn	file "../DRIVER/eeprom/source/EEPromdriver.c",line 421,column 4,is_stmt
        MOV       AL,PL                 ; [CPU_] |421| 
        MOV       PL,#1                 ; [CPU_] |421| 
        MOVB      XAR7,#0               ; [CPU_] |421| 
        ADD       PL,AL                 ; [CPU_] |421| 
        CMPB      AL,#5                 ; [CPU_] |421| 
        B         $C$L15,LO             ; [CPU_] |421| 
        ; branchcc occurs ; [] |421| 
...
$C$DW$87	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$87, DW_AT_name("Z:\VMVare Map File\IVPS1512\IVPS1512\Debug\EEPromdriver.asm:$C$L15:1:1653028006")
	.dwattr $C$DW$87, DW_AT_TI_begin_file("../DRIVER/eeprom/source/EEPromdriver.c")
	.dwattr $C$DW$87, DW_AT_TI_begin_line(0x19a)
	.dwattr $C$DW$87, DW_AT_TI_end_line(0x1a6)
...
$C$DW$91	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$91, DW_AT_name("Z:\VMVare Map File\IVPS1512\IVPS1512\Debug\EEPromdriver.asm:$C$L16:2:1653028006")
	.dwattr $C$DW$91, DW_AT_TI_begin_file("../DRIVER/eeprom/source/EEPromdriver.c")
	.dwattr $C$DW$91, DW_AT_TI_begin_line(0x19c)
	.dwattr $C$DW$91, DW_AT_TI_end_line(0x1a0)
$C$DW$92	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$82, DW_AT_TI_end_line(0x1a7)
...
$C$DW$117	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$117, DW_AT_name("Z:\VMVare Map File\IVPS1512\IVPS1512\Debug\EEPromdriver.asm:$C$L22:1:1653028006")
...
$C$DW$145	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$145, DW_AT_name("Z:\VMVare Map File\IVPS1512\IVPS1512\Debug\EEPromdriver.asm:$C$L33:1:1653028006")
...
$C$DW$147	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$147, DW_AT_name("Z:\VMVare Map File\IVPS1512\IVPS1512\Debug\EEPromdriver.asm:$C$L29:1:1653028006")
