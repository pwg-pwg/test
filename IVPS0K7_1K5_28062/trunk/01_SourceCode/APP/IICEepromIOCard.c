...
void sEEpromDataRangeChk(void)
{
	...
	if(sbGetEepromMaxACChgCur() != 0
		&& sbGetEepromMaxACChgCur() != 3 
		&& sbGetEepromMaxACChgCur() != 6
		&& sbGetEepromMaxACChgCur() != 9
		&& sbGetEepromMaxACChgCur() != 12
		&& sbGetEepromMaxACChgCur() != 15
		&& sbGetEepromMaxACChgCur() != 18)
	{
		sSetEepromMaxACChgCur(9);
		bUserChangeFlag = 1;
	}

	 if(g_wAcChgCurrMax == cIdc18A)
	{
		if(sbGetEepromMaxACChgCur() > cIdc18A)
		{
			sSetEepromMaxACChgCur(9);
			bUserChangeFlag = 1;
		}
	...
	{
		if(sbGetEepromMaxACChgCur() > cIdc15A)
		{
			sSetEepromMaxACChgCur(9);
			bUserChangeFlag = 1;
		}
	...
	if(swGetBatteryPcs() == cbBatt48VType)
	{
		...
		else
		{
			...
			{
				if(swGetEEBatteryVoltUnder() != cBat48v8)
				{
					sSetEEBatteryVoltUnder(cBat48v8);
					bUserChangeFlag = 1;
				}
			}
		}
	...
	else if(swGetBatteryPcs()==cbBatt24VType)
	{
		...
		else
		{
			...
			{
				if(swGetEEBatteryVoltUnder() != cBat24v4)
				{
					sSetEEBatteryVoltUnder(cBat24v4);
					bUserChangeFlag = 1;
				}
			}
		}
	...
	else //cbBatt12VType
	{
		...
		else
		{
			...
			{
				if(swGetEEBatteryVoltUnder() != cBat12v2)
				{
					sSetEEBatteryVoltUnder(cBat12v2);
					bUserChangeFlag = 1;
				}
			}
		}
	...
	{
		sSetEepromMenuRtnDftPageEn(1);////Enabled
		bUserChangeFlag = 1;
	}
...
INT8U   sbGetEepromMenuRtnDftPageEn(void) 
{
   return (uEepromCfg2.EepromStructCfg2.wMenuRtnDftPageEn); 
}

void    sSetEepromMenuRtnDftPageEn(INT8U bBoolean) 
{
    uEepromCfg2.EepromStructCfg2.wMenuRtnDftPageEn = bBoolean;
}
