...
//#define	cFwVersion		103//204	// 正式版本程序V201
#define	cFwVersion		104	// 20220520 正式版本程序
...
{ 
    ...
    MAX_AC_CHG_50A_ID,  
    MAX_AC_CHG_60A_ID,
    MAX_AC_CHG_CUR_ID,//1512\0712电流设置范围
    MAX_AC_CHG_70A_ID,
    MAX_AC_CHG_80A_ID,
    MAX_AC_CHG_2A_ID
};
...
extern INT8U sbGetHeavyloadCnt(void);
extern void sSetHeavyloadCnt(INT8U bValue);
...
extern INT8U   sbGetEepromMenuRtnDftPageEn(void) ;
extern void    sSetEepromMenuRtnDftPageEn(INT8U bBoolean);
...
extern INT16U suwGetInvVoltSoftStepVolt(void);
extern void sSetInvVoltSoftStepVolt(INT16U uwValue);
