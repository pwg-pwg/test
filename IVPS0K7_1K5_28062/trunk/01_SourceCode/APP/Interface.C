...
#define	cCancleCRCComIndexMppt		5//8
...
void	sBDR96Command(INT8U sciid);
...
void	sSetTestFanCommand(INT8U sciid);//ForTest Chandler20201111
...
extern INT16S swR_Vcmp_P(void);
//extern INT16S swLineVoltCntlQ5(void);
...
extern INT8U wGraphDataBuff[3][500];
...
//	6,				//	"\r",  	sQPI99Command   	//MPPT
//	6,				//  "\r",   sQPI98Command 	//SCC
//	4,				//	"\r",	sQRICommand  	//SCC
//	50,				//	"*\r",	sQGSCommand	//SCC   //*6   48 
//	8,				// 	"*\r",	sCCSCommand	//SCC   //*6   7
//	15,				//	"*\r",	sVERFWCommand  	//SCC    //*6    14
//	5,				//	"(\r"   sNAKCommand  //SCC
//	5,				//	"(\r"   sACKCommand   //SCC	
...
//	3,				//	"\r",	sQ2Command
//	3,				//	"\r",	sQ7Command//Q7
	5, 			    // 	"\r",	sPVA0Command//PVA0	  	
	11, 			// 	"*\r",	sPVA1Command	PVA1
	5,				// 	"\r",	sBTA0Command// BAT0       
	11,				// 	"*\r",  sBTA1Command   //*6  
	11,				// 	"*\r",  sBTA2Command   //*6  
//	7,				//	"*\r",	sBTACommand
//	6,				//	"\r",	sPSAVECommand//TSAVE
//	4,				//	"\r",sQDICommand//PDI
//	4,				//	"\r",sQPICommand//PPI
	4,				//	"\r",sQIDCommand//PID
	5,				//	"\r",sQSIDCommand//PSID
	5,				//	"\r",sQVFWCommand//PVFW
	6,				//	"\r",sQVFW2Command//PVFW2
//	6,				//	"\r",sQFLAGCommand//PFLAG
	//5,			//	"\r",sQMODCommand//PMOD
	//4,			//	"\r",	sQWSCommand
	4,				//	"*\r",  sPECommand     //*1  TE*
	4,				//	"*\r",  sPDCommand    //*1   
	3,				//	"\r",	sPFCommand	//TF
	17,				//	"*\r"    sIDCommand   //*14   ID*
	26,				//	"*\r"     sSIDCommand  //*22
	5,				//	"\r"	sREEPCommand//REEP
//	7,				//	"\r" 	sDELCRCCommand//DELCRC
//	4,				//	"\r", 	sQMNCommand//PMN
	4,				//	"\r",	sQFSCommand//PFS
	4,				//	"\r"	sSONCommand//SON
	6,				//	"*\r",//*2 	sPGRCommand// PGR
	4,				//	"\r"	sQGRCommand//QGR
	4,	            //  "\r",   sQBVCommand
	4,	            //  "\r",   sQBTCommand
	6,	            //  "*\r", sPBTCommand//*2 
	4,	            //  "\r",  sQBPCommand//QBP
	6,	            //  "*\r", sPBPCommand//*2  PBP*
	6,				//	"*\r",   sPOPCommand//*2  POP*
	6,				//	"*\r",  sPCPCommand //*2  PCP*
	4,	            //  "\r",  sQOPCommand//QOP
	4,	            //  "\r",   sQCPCommand//QCP
	6,				//	"\r",sQPIRICommand//PPIRI
	6,				//	"\r",sQPIGSCommand//PPIGS
	6,				// 	"\r",sQPIWSCommand//PPIWS
//	8,				//	"\r",sQMCHGCRCommand//PMCHGCR
//	9,				//	"\r",sQMUCHGCRCommand//PMUCHGCR
//	6,				// 	"\r",sQPIHFCommand//QPIHF
//	6,				// 	"\r",sQPICFCommand//QPICF
//	9,				//	"*\r",sMNCHGCCommand//*3  
//	10,//11,		//	"*\r", sMUCHGCCommand//*4  TNCHGC
//	4,				//	"\r",sF50Command		F50
//	4,				//	"\r",sF60Command		F60
//	5,				//	"Vr",sVCommand 	//*3  	V*
//	8,				//	"*\r",sBATLOWCommand//Reserved  BATLOW*
//	7,				//	"*\r",sBATUNCommand //Reserved  BATUN*
	9,				//	"*\r",sPBCVCommand //*4 //PBCV*
	9,				//	"*\r",sPCVVCommand //*4 //PCVV*
	5,				//	"\r", sQCVVCommand  //QCVV
	9,				//	"*\r",sPBFTCommand//*4  PBFT*  
	5,				//	"\r", sQBFTCommand //QBFT
	9,				//	"*\r",sPBVOCommand//*4  //TBVO*
	5,				//	"\r",  sQBVOCommand  PBVO
	6,				//	"\r",  sQBOOTCommand TBOOT
	8,				//	"*\r",sPOLBYCommand  //*2  TOLBY*
	6,				//	"\r",sQOLBYCommand	POLBY

//	11,				//	"*\r",sPUPSTYPECommand  	 //*2  PUPSTYPE
//	9,				//	"\r", sQUPSTYPECommand 	//QUPSTYPE
//	7,        		//	"*\r",sPLCDVCommand 	//TLCDV*
//	6,        		//	"\r",	sQLCDVCommand	//PLCDV
	//12, 			//	"*\r",	 //*2
	//10,			//	"\r",  
	8,				//	"*\r", sQBVTUCommand //*2 TBVTU*
	6,				//	"\r",sQBVTUCommand	//PBVTU
	6,				//	"*\r",sIVACommand	//IVA*
//	7,				//	"*\r",	//*2  POPM*
	5,				//	"\r",	POPM
	9,				//	"*\r"sPSDVCommand PSDV*
	9,				//	"*\r" sPBDVCommand PBDV*
//	8,				//	"*\r"sPPVOKCCommand PPVOKC*
//	6,				//	"*\r",sPSPBCommand PSPB*
//	9,				//	"*\r",sPOPVCommand POPV*

	7,				//	"*\r",sIIACommand	PIA*//sIIACommand
//	8,				//	"*\r",sOPIACommand	PPIA*//,
//	8,				//	"*\r",sOSIACommand	PSIA*//,PSIA
	5,				//	"\r",sQOPCCommand	POPC

//	7,				//	"*\r",
//	9,				//	"*\r",sSetEqEnaCommand
//	9,				//	"*\r",sSetEqTimeCommand
//	11,				//	"*\r",sSetEqPeriodCommand
//	10,				//	"*\r",sSetEqVoltCommand
//	6,				//	"\r",sSetEqOutTimeCommand
//	7,				//	"*\r",sQBEqICommand
//	10,				//	"*\",sSetEqActiveCommand
	12,				//	"*\",sSetELTimeCommand	TestFan
	
//	7,				//	"*\r",	sSetSearchEnaCommand
//	6,				//	"\r",	sQENF2Command
	115,			//	"*\r",	sQ1CommandAck
	59,				//	"*\r",sQCHGSSCommandAck
...
{
//	"PCCAC16\r",	//sSCCReflashCommand
//	"PCCAC48\r",	//sSCCReflashCommand
	"COMBIS\r",		//sBDR96Command
//	"PEST\r",		//sTESTCommand
	"PHECK\r",		//sCHECKCommand
	"Q3",			//sQ3Command
	
	"PSCIR\r",		//sQSCIRCommand
	"K",			//sTestCommand
...
//	"(ACK\r",		//SCC
	...
	"PFAULT\r",		//Has  CRCs   sQFAULTCommand
//	"PALCRC",		//sCALCRCCommand
	"P1\r",			//sQ1Command
//	"Q2\r",			//sQ2Command
//	"Q7\r",			//sQ7Command
	"PVA0\r",		//sPVA0Command	  
	...
	"BAT2*\r",		//sBTA2Command
//	"TTA*\r",		//sBTACommand
//	"TSAVE\r",		//sPSAVECommand
//	"PDI\r",  		//sQDICommand  
//	"PPI\r",		//sQPICommand
	"PID\r",		//sQIDCommand
	"PSID\r",		//sQSIDCommand
	"PVFW\r",		//sQVFWCommand
	"PVFW2\r",		//sQVFW2Command
//	"PFLAG\r",		//sQFLAGCommand
	//"PMOD\r",		//sQMODCommand
	//"PWS\r",		//sQWSCommand
	"TE*\r",		//sPECommand
	"TD*\r",		//sPDCommand
...
//	"PMN\r",		//sQMNCommand
	...
	"QOP\r",		//sQOPCommand
	"QCP\r",  		//sQCPCommand
	"PPIRI\r",		//sQPIRICommand
	"PPIGS\r",		//sQPIGSCommand
	"PPIWS\r",		//sQPIWSCommand
//	"PMCHGCR\r",	//sQMCHGCRCommand
//	"PMUCHGCR\r",	//sQMUCHGCRCommand
//	"QPIHF\r",		//sQPIHFCommand
//	"QPICF\r",		//sQPICFCommand
//	"TNCHGC*\r",	//sMNCHGCCommand
//	"TUCHGC*\r",	//sMUCHGCCommand
//	"F50\r",		//sF50Command
//	"F60\r",		//sF60Command
//	"V*\r",			//sVCommand
//	"BATLOW*\r",	//sBATLOWCommand
//	"BATUN*\r",		//sBATUNCommand
	"PBCV*\r",		//sPBCVCommand
	"PCVV*\r",		//sPCVVCommand
	"QCVV\r",		//sQCVVCommand
	"PBFT*\r",		//sPBFTCommand
	...
	"TBVO*\r",		//sPBVOCommand
	"PBVO\r",		//sQBVOCommand
	"TBOOT\r",		//sQBOOTCommand
	"TOLBY*\r",		//sPOLBYCommand
	"POLBY\r",		//sQOLBYCommand
//	"PUPSTYPE*\r",	//sPUPSTYPECommand,
//	"QUPSTYPE\r",	//sQUPSTYPECommand,	
//	"TLCDV*\r", 	//sPLCDVCommand,        
//	"PLCDV\r",		//sQLCDVCommand,
			
	"TBVTU*\r",		//sPBVTUCommand
	"PBVTU\r",		//sQBVTUCommand
	"IVA*\r",		//sIVACommand
//	"POPM*\r",		//sPOPMCommand
	"POPM\r",		//sQOPMCommand
	"PSDV*\r",		//sPSDVCommand
	"PBDV*\r",		//sPBDVCommand
//	"PPVOKC*\r",	//sPPVOKCCommand,
//	"PSPB*\r",		//sPSPBCommand,
//	"POPV*\r",		//sPOPVCommand,
...
//	"TBEQE*\r",		//sSetEqEnaCommand
//	"TBEQT*\r",		//sSetEqTimeCommand
//	"TBEQP*\r",		//sSetEqPeriodCommand
//	"TBEQV*\r",		//sSetEqVoltCommand
//	"TBEQOT*\r",	//sSetEqOutTimeCommand
//	"PBEQI\r",		//sQBEqICommand
//	"TBEQA*\r",		//sSetEqActiveCommand
//	"TBELT*\r",		//sSetELTimeCommand
	"TFANTEST*\r",	//sSetTestFanCommand
	
//	"PNF2B*\r",		//sSetSearchEnaCommand
//	"PENF2\r",	
	"(PV*\r",
	"(*\r",
...
pFunc1 GetDataSubArray[100] =
{
	...
	swReturnNull,				swGetRVref,					swGetRInvVoltError,		//40-42
	...
	swReturnNull,				swReturnNull,				swReturnNull,
	swReturnNull,				swReturnNull,				swReturnNull,
	swReturnNull,				swReturnNull,				swGetSCITouchFlag,
};

extern INT16U wFaultCode;
extern INT8U bBoot;
extern INT16U wBootVersion;
...
void sSciTask(void)
{
	...
	if(*PBoot == 0xAAAA && g_SecurityCodeErrorFlg == 0)
	{
		bBoot=1;	//1 ok
	}
	else
...
//	PBoot=(INT8U *)0x3F7F71;		//BootLoader version
//	if(*PBoot == 0xBBBB)
//	{
		wBootVersion=cNewBootLoader;
//	}
//	else
//	{
//		wBootVersion=cOldBootLoader;
//	}
	...
	while(1)
	{
		...
		if(event&(1<<eInterfaceTimer))
		{
			...
			if((cEnable == swGetEEMpptChg()) || (true == sbGetDetectMppt()))
			{
				bExtSccActive = true;
...
void sSciRxDebugCommand(INT8U sciid)
{
	...
	while(1)
	{
		...
		else if((sciid == 1) && (bCommandBuffer[sciid][0] == swGetEEModBusAddr()))	// ModBus
		{
			wCommandLength[sciid]++;
			pwCommandIn[sciid]++;
			
			if(swModBusRecved((INT16U *)&bCommandBuffer[sciid][0], wCommandLength[sciid]))
			{
...
void	sParsing(INT8U sciid)
{
	...
	{
		if( wComIndex >= bCancleCRCComIndex && wComIndex !=cCOMM_NUM -1)    //20120115 Amy //>=MPPT的8条命令时候需要进行CRC校验
		{
			bCRCChkFlg = 1;
		}
		else
...
//	}
//	pDataBuf=&bUserDataBuf0[sciid][bStrLen];
//	sbNumToXXXX(abs(wDCVoltI),pDataBuf);   
//	bStrLen += 4;	
//	bUserDataBuf0[sciid][bStrLen++]=CHAR_SPACE;
//
//	if(swGetInvDCVolt() < 0)
...
//	}	
//	pDataBuf=&bUserDataBuf0[sciid][bStrLen];
//	sbNumToXXXX(abs(swGetInvDCVolt()),pDataBuf);   
//	bStrLen += 4;
//	 
...
//	 bUserDataBuf0[sciid][bStrLen++]=CHAR_SPACE;
	...
	bUserDataBuf0[sciid][bStrLen++]=CHAR_SPACE; 
	 ...
	 pDataBuf=&bUserDataBuf0[sciid][bStrLen];
	sbNumToXXXX(g_uwAPL10SChgStartCnt,pDataBuf);
	bStrLen += 4;
	bUserDataBuf0[sciid][bStrLen++]=CHAR_SPACE; 
...
//	bUserDataBuf0[sciid][bStrLen++]=CHAR_SPACE;
//	bUserDataBuf0[sciid][bStrLen++]='p';
//	bUserDataBuf0[sciid][bStrLen++]=':';
//	pDataBuf=&bUserDataBuf0[sciid][bStrLen];
//	sbNumToXX(sWLiHardProtectCnt,pDataBuf);//硬件触发过流保护信号
//	bStrLen += 2;
//	bUserDataBuf0[sciid][bStrLen++]=CHAR_SPACE;
//
//	bUserDataBuf0[sciid][bStrLen++]='S';
//	bUserDataBuf0[sciid][bStrLen++]=':';
//	pDataBuf=&bUserDataBuf0[sciid][bStrLen];
//	sbNumToXX(wFBControlStatus,pDataBuf);//方波的控制状态
//	bStrLen += 2;
//	bUserDataBuf0[sciid][bStrLen++]=CHAR_SPACE;
//
//	bUserDataBuf0[sciid][bStrLen++]='f';
//	bUserDataBuf0[sciid][bStrLen++]=':';
//	pDataBuf=&bUserDataBuf0[sciid][bStrLen];
//	sbNumToXX(wInvChgStatus,pDataBuf);//
//	bStrLen += 2;
//	bUserDataBuf0[sciid][bStrLen++]=CHAR_SPACE;
//故障码
	bUserDataBuf0[sciid][bStrLen++]='f';//error
	bUserDataBuf0[sciid][bStrLen++]='t';
	bUserDataBuf0[sciid][bStrLen++]=':';
	wTemp = (INT8U)swGetFaultCode();;
	pDataBuf=&bUserDataBuf0[sciid][bStrLen];
	sbNumToXX(wTemp,pDataBuf);	 
	bStrLen += 2;
	bUserDataBuf0[sciid][bStrLen++]=CHAR_SPACE; 
//程序时间
	bUserDataBuf0[sciid][bStrLen++]='D';
...
INT16U wRelayActionPoint =96;
INT16U wRelayActionPoint2 =0;

void	sSetTestFanCommand(INT8U sciid)//ForTest Chandler20201111
{
	INT16U uwTemp =0;

	uwTemp =(bCommandBuffer[sciid][8]-'0')*100 +(bCommandBuffer[sciid][9]-'0')*10+(bCommandBuffer[sciid][10]-'0');
	
	if((uwTemp<384)&&(uwTemp>0))
	{
		wRelayActionPoint = uwTemp;
		sACK(sciid);
	}
	else if((uwTemp<768)&&(uwTemp>384))
	{
		wRelayActionPoint2 = uwTemp-384;
		sACK(sciid);
	}
	else
	{
	...
	/*uwTemp =(bCommandBuffer[sciid][8]-'0')*100 +(bCommandBuffer[sciid][9]-'0')*10;
	if((uwTemp<600)&&(uwTemp>100))
	{
		sSetRKi(uwTemp);
		sACK(sciid);
	}
...
*/
	...
	bUserDataBuf0[sciid][4] = '4';
	bUserDataBuf0[sciid][5] = '5';
	bUserDataBuf0[sciid][6] = 0x0D;
	
	wCRCChkFlg = true;
	sSciWrite(sciid,bUserDataBuf0[sciid],7);*/
/*
	if(bCommandBuffer[sciid][8]=='2')
	{
		TestFanSpeed =2;
		
	}
	else if(bCommandBuffer[sciid][8]=='1')
	{
		TestFanSpeed =1;
...
extern INT16U OPloopFlag;
extern INT16S wInvVoltBiasVaue;
...
void	sTestCommand(INT8U sciid)
{
	...
	{
		if((bCommandBuffer[sciid][3] == 'K') && (bCommandBuffer[sciid][4] == 'V')
...
////		else if((bCommandBuffer[sciid][3] == 'A') && (bCommandBuffer[sciid][4] == '?'))
////		{
////			bUserDataBuf0[sciid][0] = '(';
////			sbNumToXX(wKCurrentForwardAdj,&bUserDataBuf0[sciid][1]);	
////			bUserDataBuf0[sciid][3] = 0x0D;
////			sSciWrite(sciid,bUserDataBuf0[sciid],4);
////		}
////		else if(bCommandBuffer[sciid][3] == 'A')
////		{
////			wTemp =(bCommandBuffer[sciid][4] - '0') * 10 + (bCommandBuffer[sciid][5] - '0'); 
////		
////			if(wTemp >= 0 && wTemp <= 99)
////			{
////				wKCurrentForwardAdj = wTemp;
////				sACK(sciid);
////			}
////			else
////			{
...
////			}
////		}
////		else if((bCommandBuffer[sciid][3] == 'K') && (bCommandBuffer[sciid][4] == 'C') \
////			&&(bCommandBuffer[sciid][5] == '?'))
////		{
////			bUserDataBuf0[sciid][0] = '(';
////			sbNumToXXX(wKCurrentForward,&bUserDataBuf0[sciid][1]);	
////			bUserDataBuf0[sciid][4] = 0x0D;
////			sSciWrite(sciid,bUserDataBuf0[sciid],5);
////		}
////		else if((bCommandBuffer[sciid][3] == 'K')&&(bCommandBuffer[sciid][4] == 'C'))
...
////		}
		...
		else if((bCommandBuffer[sciid][3] == 'O') && (bCommandBuffer[sciid][4] == 'P'))//OP
		{
			wTemp = (bCommandBuffer[sciid][5] - '0');
			if(wTemp >= 0 && wTemp <= 20)
			{
				OPloopFlag =wTemp;
				sACK(sciid);
		...
		{
			bUserDataBuf0[sciid][0] = '(';
			if(wInvVoltBiasVaue<0)
			{
				bUserDataBuf0[sciid][0] = '-';
				wTemp = -wInvVoltBiasVaue;
			}
			else
			{
				bUserDataBuf0[sciid][0] = '+';
		...
		else if((bCommandBuffer[sciid][3] == 'B') && (bCommandBuffer[sciid][4] == 'V'))//OP
		{
			wTemp = (bCommandBuffer[sciid][5] - '0');
			if(wTemp == 0)
			{
				if(wInvVoltBiasVaue>=-100)
				{
					wInvVoltBiasVaue -= 5;
					gi_wInvVoltBias = wInvVoltBiasVaue;
				}
				sACK(sciid);
			}
			else if(wTemp == 1)
...
{
	bUserDataBuf0[sciid][0] = '(';
	sNumToASCII(bBoot, 1, 0, &bUserDataBuf0[sciid][1]);   //0  OK
...
//INT16U TestPICycleSet =0;
//INT16U TestPICycle =0;
//void	sOPIACommand(INT8U sciid)
//{
//		INT16U uwTemp =0;
//
//	uwTemp =(bCommandBuffer[sciid][4]-'0')*10 +(bCommandBuffer[sciid][5]-'0');
//	if((uwTemp<70)&&(uwTemp>10))
//	{
//		
//		TestPICycleSet =uwTemp;
//		TestPICycle =0;
//		sACK(sciid);
//	}
//	else
...
void	sPBTCommand(INT8U sciid)
{
	...
	else
	{
		...
		else if(wTemp==cLiBType)
		{
		    sSetEepromBatCVVolt(cBat14v4 * wTempBatPcs);
			sSetEepromBatFloatVolt(cBat14v4 * wTempBatPcs);
			sSetEEBatteryVoltUnder(cBat12v2 * wTempBatPcs);
			sSetEEEqEna(false);
		}
		OSEventSend(cPrioInterface, eEepromSaveUserSetData);
		sRSTTxCommand();
...
void	sBDR96Command(INT8U sciid)
{
	...
	wCRCChkFlg = false;
	bUserDataBuf0[sciid][0] = 'A';
	bUserDataBuf0[sciid][1] = 'K';
	bUserDataBuf0[sciid][2] = '0';
	bUserDataBuf0[sciid][3] = 0x0D;
	sSciWrite(sciid,bUserDataBuf0[sciid],4);	
	while(sSciGetTxStatus(sciid) != cSciTxRdy);
...
void	sPCVVCommand(INT8U sciid)
{
	INT16U wTemp;
	wTemp = swASCIIToNum(2, 1, &bCommandBuffer[sciid][4]);		
	if( (sbGetEepromBatteryType() != cUseType) || (wTemp < 120 * swGetBatteryPcs()) \
...
//b_FlagBit == 0/1
/*******************************************************************************
* Function Name  : sSCITouchOnOff
* Description	 : 配合串口助手使用，触发后捕捉信号
* Input 		 : INT8U b_FlagBit：触发信号置位，=true\false
* Output		 : None
* Date			 : 2021.02.28
* Author		 : CM
********************************************************************************/
