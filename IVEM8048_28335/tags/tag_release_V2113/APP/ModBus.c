...
//				}
		...
		case E2_OP2OnInACModeEn:
			if(WrData <= 1)
			{
				...
				{
				    g_uwParameterSetChange = true;
//					if(gi_wParallelEnable && g_uwParaMode == cMasterMode)  
//					{
//						g_uwOP2ParameterChangeFlg = true;
//					}
...
void sRealTimeDataUpdate(void)
{
	...
	uRealTimeData.Stru.wTxtTempC = g_wLLC_TXTemp/10;  //LLC变压器温度
	uRealTimeData.Stru.wInvTempC = g_wInvTemp/10;     //逆变器温度
