...
//		gi_wInvFeedCurrLimit = gi_wFeedChgPowerLimit;
		...
		if(g_uwForceCurrRefGain > 0 && gi_wBusVolt8CAvg >= (INT16S)((((INT32S)g_uwRLineVolt * 191) >> 7) + cBusVoltReal20V))
    ...
    if(g_wRFBVm_P < 0 && gi_wBusVolt8CAvg >= 2450) { g_wRFBVm_P = (INT16S)(((INT32S)g_wRFBVm_P * 150) >> 7); }
    //++++++++++++++++++++++++++++++++++++++++
