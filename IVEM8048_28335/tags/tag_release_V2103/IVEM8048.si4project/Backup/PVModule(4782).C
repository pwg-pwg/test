...
void sSolarPowerAbnormalChk(void)
{
	...
	{
	    if((g_uwSolarCurr1Avg > g_wPv1CurrLimit+100)&&(g_wR_Boost1_PWM == 1))//多1A且PWM达到极限
	    {
		    if(++s_uwSolar1PowerAbnormalChkCnt > 100)//2s
		    {
	...
	{
	    if((g_uwSolarCurr1Avg > g_wPv2CurrLimit+100)&&(g_wR_Boost2_PWM == 1))
	    {
		    if(++s_uwSolar2PowerAbnormalChkCnt > 100)
		    {
