...
/*******************hoADCSWITCH1 = 1 && hoADCSWITCH2 = 1 **********************/
	...
	gi_wSolarVolt2Sample    =   (ADCRESULT4 >> 4);
...
/*******************hoADCSWITCH1 = 1 && hoADCSWITCH2 = 1 **********************/
	...
	gi_wRInvCurr1Sample		= 	(ADCRESULT10 >> 4) - 2048 - gi_wRInvCurrSampleBias;
	gi_wROPShareCurrSample 	= 	(ADCRESULT11 >> 4) - 2048 + gi_wROPShareCurrSampleBias;
	gi_wROPCurr1Sample 		= 	(ADCRESULT12 >> 4) - 2048 - gi_wROPCurrSampleBias;
...
/************************hoADCSWITCH1 = 0 && hoADCSWITCH2 = 0****************************/
	...
	gi_wLLC_TXTempSample	=	(ADCRESULT5 >> 4);
