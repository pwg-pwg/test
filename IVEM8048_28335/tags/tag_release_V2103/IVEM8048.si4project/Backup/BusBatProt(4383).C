...
INT16S g_wCovertHOTPoint = 900;
INT16S g_wCovertHOTBackPoint = 750;
...
void sOverTempParaInit(void)
{
	...
	g_wCovertHOTPoint = 900;//950;
	g_wCovertHOTBackPoint = 750;//800;
	g_wInnelOTPoint = 950;
...
INT16S swGetBUCK_IGBTTj(void)
{
	return(swComponentTjCal(cBUCK_IGBTKt,abs(g_wPDCDCCurrAvg),g_wConvertHTemp,cNTCTempDelta20,10));
}
INT16S swGetINV_IGBTTj(void)
{
	return(swComponentTjCal(cINV_IGBTKt,g_uwRInvCurr,g_wInvTemp,cNTCTempDelta18,10));
}
INT16S swGetPV_BOOST_DiodeTj(INT16S swPVNumber)
{
