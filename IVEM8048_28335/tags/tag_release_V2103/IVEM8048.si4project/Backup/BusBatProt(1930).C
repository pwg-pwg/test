...
#define cOtherTjStarTempPoint			682		//61.3C
#define cOtherTjEndTempPoint			1226	//122.6C
#define cOtherTjTempRange				453		//61.3C    68.3~45.3=113.5
...
#define cLLC_MosTjProtectPoint			1130	//120C
...
//Temprature Derat
#define cLLC_MosTjDeratPoint			1050	//112.5C
...
INT16S g_wSolarBSTOTPoint = 700;//850;
INT16S g_wSolarBSTOTBackPoint = 550;//600;
...
void sOverTempParaInit(void)
{
	g_wSolarBSTOTPoint = 700;//850;
	g_wSolarBSTOTBackPoint = 550;//700;
...
INT16S swFanSpeedCal_TjCtr(void)
{
	...
	{
		wFanSpeedTemp2 = (INT16S)(((INT32S)wTjTemp*cFanControlPercentum/cOtherTjTempRange+5)/10-75);
	}
	else
	{
		wFanSpeedTemp2 = 0;
