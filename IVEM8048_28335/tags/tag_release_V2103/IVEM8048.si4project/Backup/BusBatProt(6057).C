...
INT16S g_wInvOTPoint = 860;
INT16S g_wInvOTBackPoint = 710;
...
void sOverTempParaInit(void)
{
	...
	g_wInvOTPoint = 860;//950;  20230509 LMF 修改风扇之后可以降低温度
	g_wInvOTBackPoint = 710;//800;
}
...
INT16S swGetINV_IGBTTj(void)
{
	return(swComponentTjCal(cINV_IGBTKt,g_uwRInvCurr,g_wInvTemp,cNTCTempDelta19,10));
}
INT16S swGetPV_BOOST_DiodeTj(INT16S swPVNumber)
{
