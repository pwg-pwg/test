...
//	if(((g_OP_TWINS_OutDuration != 0&&g_uwBatVoltAvg >= 520)
//		//||(g_OP_TWINS_OutDuration == 0xFFFF&&g_uwBatVoltAvg >= 520)
...
//		return true;
//	}
//	((g_OP_TWINS_OutStartTiming.ubHour > CurrentTime.ubHour
//				&&g_OP_TWINS_OutEndTiming.ubHour < CurrentTime.ubHour)
//				&&(g_OP_TWINS_OutStartTiming.ubMin<=CurrentTime.ubMin
//				&&g_OP_TWINS_OutEndTiming.ubMin >= CurrentTime.ubMin))
//	(CurrentTime.ubHour - g_OP_TWINS_OutStartTiming.ubHour)*60 + (CurrentTime.ubMin - g_OP_TWINS_OutStartTiming.ubMin)) < 0			||((CurrentTime.ubHour - g_OP_TWINS_OutEndTiming.ubHour)*60 + (CurrentTime.ubMin - g_OP_TWINS_OutEndTiming.ubMin)) > 0)
	if((0 < g_OP_TWINS_OutDuration&&0xFFFF>= g_OP_TWINS_OutDuration )&&g_uwBatVoltAvg >= 520&&false==gi_uwOP_TWINS_TimeFlag)
	{
