...
#define cFaultDisPWM		0x01
#define cSwitchDisPWM		0x02
extern INT16U g_uwInvDisPWMSts;

#define			mDisINVPWMOut(x)		g_uwInvDisPWMSts |= x;\
										EALLOW;\
										EPwm3Regs.TZFRC.bit.OST=1;\
										EPwm4Regs.TZFRC.bit.OST=1;\
										EDIS
																	
#define			mEnINVPWMOut(x)			g_uwInvDisPWMSts &=~x;\
										if(!g_uwInvDisPWMSts)\
										{\
											EALLOW;\
