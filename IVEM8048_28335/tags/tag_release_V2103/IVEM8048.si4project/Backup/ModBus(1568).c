...
//				}
		...
		case E2_DurationTime_OP2:
			...
			{
				if(swGetEEDurationTime_OP2() != WrData)
				{
					sSetEEDurationTime_OP2(WrData);
					OSEventSend(cPrioInterface, eI2CEEpromUserSave);
...
void sRealTimeDataUpdate(void)
{
	...
	uRealTimeData.Stru.wTxtTempC = g_wConvertLTemp/10;
...
//	uRealTimeData.Stru.wBMSFaultCode = mBMSFaultCode;
	...
	uRealTimeData.Stru.wPVEnergyTotalHH = 1;//(INT16U)((g_uldwPowerEnergyTotal >> 48) & 0xFFFF);
	uRealTimeData.Stru.wPVEnergyTotalHL = 2;//(INT16U)((g_uldwPowerEnergyTotal >> 32) & 0xFFFF);
	uRealTimeData.Stru.wPVEnergyTotalLH = 3;//(INT16U)((g_uldwPowerEnergyTotal >> 16) & 0xFFFF);
	uRealTimeData.Stru.wPVEnergyTotalLL = 4;//(INT16U)(g_uldwPowerEnergyTotal  & 0xFFFF);
	uRealTimeData.Stru.wPVEnergyThisYearH = 5;//(INT16U)((g_udwPowerEnergyYear >> 16) & 0xFFFF);
	uRealTimeData.Stru.wPVEnergyThisYearL = 6;//(INT16U)(g_udwPowerEnergyYear  & 0xFFFF);
	uRealTimeData.Stru.wPVEnergyThisMonthH = 7;//(INT16U)((g_udwPowerEnergyMonth >> 16) & 0xFFFF);
	uRealTimeData.Stru.wPVEnergyThisMonthL = 8;//(INT16U)(g_udwPowerEnergyMonth  & 0xFFFF);
	uRealTimeData.Stru.wPVEnergyThisDayH = 9;//(INT16U)((g_udwPowerEnergyToday >> 16) & 0xFFFF);
	uRealTimeData.Stru.wPVEnergyThisDayL = 10;//(INT16U)(g_udwPowerEnergyToday  & 0xFFFF);
	uRealTimeData.Stru.wPVEnergyYearH = 11;//(INT16U)((g_udwPowerEnergyChkYear >> 16) & 0xFFFF);
	uRealTimeData.Stru.wPVEnergyYearL = 12;//(INT16U)(g_udwPowerEnergyChkYear  & 0xFFFF);
	uRealTimeData.Stru.wPVEnergyMonthH = 13;//(INT16U)((g_udwPowerEnergyChkMonth >> 16) & 0xFFFF);
	uRealTimeData.Stru.wPVEnergyMonthL = 14;//(INT16U)(g_udwPowerEnergyChkMonth  & 0xFFFF);
	uRealTimeData.Stru.wPVEnergyDayH = 15;//(INT16U)((g_udwPowerEnergyChkDay >> 16) & 0xFFFF);
	uRealTimeData.Stru.wPVEnergyDayL = 16;//(INT16U)(g_udwPowerEnergyChkDay  & 0xFFFF);
	
	uRealTimeData.Stru.wLoadEnergyTotalHH = 1;//(INT16U)((g_uldwLoadEnergyTotal >> 48) & 0xFFFF);
	uRealTimeData.Stru.wLoadEnergyTotalHL = 2;//(INT16U)((g_uldwLoadEnergyTotal >> 32) & 0xFFFF);
	uRealTimeData.Stru.wLoadEnergyTotalLH = 3;//(INT16U)((g_uldwLoadEnergyTotal >> 16) & 0xFFFF);
	uRealTimeData.Stru.wLoadEnergyTotalLL = 4;//(INT16U)(g_uldwLoadEnergyTotal  & 0xFFFF);
	uRealTimeData.Stru.wLoadEnergyThisYearH = 5;//(INT16U)((g_udwLoadEnergyYear >> 16) & 0xFFFF);
	uRealTimeData.Stru.wLoadEnergyThisYearL = 6;//(INT16U)(g_udwLoadEnergyYear  & 0xFFFF);
	uRealTimeData.Stru.wLoadEnergyThisMonthH = 7;//(INT16U)((g_udwLoadEnergyMonth >> 16) & 0xFFFF);
	uRealTimeData.Stru.wLoadEnergyThisMonthL = 8;//(INT16U)(g_udwLoadEnergyMonth  & 0xFFFF);
	uRealTimeData.Stru.wLoadEnergyThisDayH = 9;//(INT16U)((g_udwLoadEnergyToday >> 16) & 0xFFFF);
	uRealTimeData.Stru.wLoadEnergyThisDayL = 10;//(INT16U)(g_udwLoadEnergyToday  & 0xFFFF);
	uRealTimeData.Stru.wLoadEnergyYearH = 11;//(INT16U)((g_udwLoadEnergyChkYear >> 16) & 0xFFFF);
	uRealTimeData.Stru.wLoadEnergyYearL = 12;//(INT16U)(g_udwLoadEnergyChkYear  & 0xFFFF);
	uRealTimeData.Stru.wLoadEnergyMonthH = 13;//(INT16U)((g_udwLoadEnergyChkMonth >> 16) & 0xFFFF);
	uRealTimeData.Stru.wLoadEnergyMonthL = 14;//(INT16U)(g_udwLoadEnergyChkMonth  & 0xFFFF);
	uRealTimeData.Stru.wLoadEnergyDayH = 15;//(INT16U)((g_udwLoadEnergyChkDay >> 16) & 0xFFFF);
	uRealTimeData.Stru.wLoadEnergyDayL = 16;//(INT16U)(g_udwLoadEnergyChkDay  & 0xFFFF);
