...
struct EepromStruct2
{
	...
	INT16S  wEESolarPowerBalanceEn;
	INT16S  wEETimingOP2StartTime;
	INT16S  wEETimingOP2EndTime;
	INT16S  wEEDurationTime_OP2;
	INT16S  wEEThresholdVoltMin_OP2;
	INT16S  wEEThresholdSOCMin_OP2;
	INT16S  dwReserver1;
	INT16U  wFlag;
	INT16U  wEECheckSum2;
};
...
extern void sSetEETimingOP2StartTime(INT16S wValue);
extern INT16S swGetEETimingOP2StartTime(void);
extern void sSetEETimingOP2EndTime(INT16S wValue);
extern INT16S swGetEETimingOP2EndTime(void);
extern void sSetEEDurationTime_OP2(INT16S wValue);
extern INT16S swGetEEDurationTime_OP2(void);
extern void sSetEEThresholdVoltMin_OP2(INT16S wValue);
extern INT16S swGetEEThresholdVoltMin_OP2(void);
extern void sSetEEThresholdSOCMin_OP2(INT16S wValue);
extern INT16S swGetEEThresholdSOCMin_OP2(void);
