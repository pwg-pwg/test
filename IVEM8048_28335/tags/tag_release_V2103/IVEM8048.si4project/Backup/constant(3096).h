...
#define cBusVoltUnder			2//不需要进入恢复
#define cBusSoftTimeOut			3//不需要进入恢复
#define cInvSoftTimeOut			4//不需要进入恢复
#define cInvCurrOver			5
#define cInvHWCurrOver			6//不需要进入恢复
#define cInvVoltLow				7
#define cInvVoltHigh			8
#define cInvShort				9
#define cOverLoad				10
#define cBatVoltOver			11
#define cDCDCCurrOver			12//不需要进入恢复
#define cPVVoltOver				13
#define cPVShort				14//无法恢复
