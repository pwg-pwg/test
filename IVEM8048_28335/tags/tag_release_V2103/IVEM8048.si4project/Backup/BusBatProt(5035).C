...
#define cLLC_TXTempProtectPoint			1420//1440	//144C
//Temprature Derat
...
#define cLLC_TXDeratPoint				1330//1350	//135C
...
INT16S swGetLLC_MosTj(void)
{
	return(swComponentTjCal(cLLC_MosKt,abs(g_wPDCDCCurrAvg),g_wConvertLTemp,cNTCTempDelta25,10));
}
INT16S swGetBUCK_IGBTTj(void)
{
...
INT16S swGetINV_IGBTTj(void)
{
	return(swComponentTjCal(cINV_IGBTKt,g_uwRInvCurr,g_wInvTemp,cNTCTempDelta25,10));
}
INT16S swGetPV_BOOST_DiodeTj(INT16S swPVNumber)
{
