...
//	uRealTimeData.Stru.wBMSFaultCode = mBMSFaultCode;
	...
	uRealTimeData.Stru.wLinePowerConvertionH=(INT16U)((g_dwLinePowerWattCversion >> 16) & 0xFFFF);
	uRealTimeData.Stru.wLinePowerConvertionL=(INT16U)(g_dwLinePowerWattCversion  & 0xFFFF);	
	uRealTimeData.Stru.wLoadPowerConvertionH=(INT16U)((g_dwLoadPowerConversion >> 16) & 0xFFFF);
	uRealTimeData.Stru.wLoadPowerConvertionL=(INT16U)(g_dwLoadPowerConversion  & 0xFFFF);	
...
{
    uBMSData.Stru.wBMSConnectFlg = g_ubBMSConnectTestFlg;
    uBMSData.Stru.wBMSForceChgFlg = g_ubBMSForceChgTestFlg;
    uBMSData.Stru.wBMSStopChgFlg = g_ubBMSStopChgTestFlg;
    uBMSData.Stru.wBMSStopDischgFlg = g_ubBMSStopDischgTestFlg;
    uBMSData.Stru.wBMSCVVolt = g_wBMSTestCVVolt;
    uBMSData.Stru.wBMSFloatVolt = g_wBMSTestFloatVolt;
    uBMSData.Stru.wBMSCutoffVolt = g_wBMSTestCutOffVolt;
    uBMSData.Stru.wBMSChgCurr = g_wBMSTestChgCurr;
    uBMSData.Stru.wBMSDischgCurr = g_wBMSTestDischgCurr;
    uBMSData.Stru.wBMSDataSoc = g_wBMSTestSoc;
}
