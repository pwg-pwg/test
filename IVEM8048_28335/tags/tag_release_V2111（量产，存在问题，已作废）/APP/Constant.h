...
#define	cCntl_InvCurrLimit			2560	//80*32
#define	cCntl_FPCurrLimit			5656	//40A*1.414*100
#define cCntl_InvVoltKv				76      //48  优化带水泵输出电压震荡
#define cCntl_InvVoltKi				350     //300 优化带水泵输出电压震荡
#define cCntl_DCDCBusKpFast			1200
#define cCntl_DCDCBusKiFast			50
#define cCntl_DCDCBusKpSlow			260
#define cCntl_DCDCBusKiSlow			5
...
#define cDSPVersion		((1000*mModel) + 111)  
//#define	cTestCmd		                   
...
#define	cOPCurrRatio			727//732				//146.34AMax	2^10 * 10		0.1A << 10	1.5Vbias  20230511  薷 为145.45
