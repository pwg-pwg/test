...
extern INT16S	g_wBatLowSoc;
extern INT16S	g_wBatLowBackSoc;
extern INT16S	g_wBatUnderSoc;
extern INT16S	g_wBatWeakSoc;
extern INT16S	g_wBatWeakBackSoc;
extern INT16U	g_uwBatType;
extern INT16U	g_uwBatTypePre;
...
extern INT8U subGetBatPowerDownSts(void);
...
extern void sBMSSOCEmptyChk(INT16U uwFilter);
extern INT8U subGetBatLowSts(void);
extern INT8U subGetBatWeakSts(void);
extern INT8U subGetParaBatUnderSts(void);
extern INT8U subGetParaBatPowerDownSts(void);
extern INT8U subGetParaBatOpenSts(void);
extern INT8U subGetParaBatWeakSts(void);
extern INT8U subGetBatVoltFastLowSts(void);
extern void  subClrBatVoltFastLowSts(void);
extern void  sBatChrgDisChrgStateChk(void);
extern INT8U subGetBatChrgEnable(void);
extern INT8U subGetBatDischrgEnable(void);
