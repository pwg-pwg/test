...
;* Date/Time created: Fri Jun 07 11:42:46 2024                 *
;***************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	...
	.dwattr $C$DW$CU, DW_AT_comp_dir("Z:\CCS_Code\IVEM8048 V1\IVEM8048_II_28335-V0008\IVEM8048_II\Driver\RlyDriver")
;**************************************************************
;* CINIT RECORDS                                              *
;**************************************************************
	.sect	".cinit"
...
$C$DW$7	.dwtag  DW_TAG_variable, DW_AT_name("OSRdyMap")
	...
	.dwattr $C$DW$7, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/kernel\kernel.h")
...
$C$DW$14	.dwtag  DW_TAG_variable, DW_AT_name("OSTCBTbl")
	...
	.dwattr $C$DW$14, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/kernel\kernel.h")
	.dwattr $C$DW$14, DW_AT_decl_line(0x63)
	.dwattr $C$DW$14, DW_AT_decl_column(0x10)
;	C:\CCStudio_v3.3PLA\C2000\cgtools\bin\ac2000.exe -@C:\Users\Qijue\AppData\Local\Temp\0213212 
	.sect	".text"
...
;----------------------------------------------------------------------
;  20 | void sSetRlyPointer(unsigned char relaytype, unsigned int pointer, unsi
;     | gned char event, unsigned char prio)                                   
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
;  89 | wRlyActionPointerTemp = wRlyActionPointerTemp % gi_wSinePointMax;      
;----------------------------------------------------------------------
        SPM       #0
        MOVW      DP,#_gi_wSinePointMax
        MOV       AL,*-SP[5]            ; |89| 
...
;----------------------------------------------------------------------
;  94 | wRlyActionPointerTemp = pointer;                                       
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; |94| 
        MOV       *-SP[5],AL            ; |94| 
$C$L4:    
...
;----------------------------------------------------------------------
; 177 | sSetRlyPointer(relaytype, pointer, event, prio); //(RLY_CROSSZERO,cSFTR
;     | lySCRDelayTime,eSuperSelectPoint,cPrioSuper);                          
;----------------------------------------------------------------------
        MOVZ      AR5,*-SP[4]           ; |177| 
        MOVZ      AR4,*-SP[3]           ; |177| 
        MOV       AH,*-SP[2]            ; |177| 
...
$C$DW$47	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$47, DW_AT_name("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/ASM/RlyDriver.asm:$C$L9:1:1717731766")
...
$C$DW$49	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$49, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/kernel\kernel.h")
...
$C$DW$50	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$50, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/kernel\kernel.h")
...
$C$DW$51	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$51, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/kernel\kernel.h")
...
$C$DW$52	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$52, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/kernel\kernel.h")
...
$C$DW$53	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$53, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/kernel\kernel.h")
