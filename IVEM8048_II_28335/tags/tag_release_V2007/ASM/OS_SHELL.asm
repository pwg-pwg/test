...
;* Date/Time created: Fri Jun 07 11:42:57 2024                 *
;***************************************************************
...
$C$DW$8	.dwtag  DW_TAG_subprogram, DW_AT_name("OSFindHighPrio")
	...
	.dwattr $C$DW$8, DW_AT_decl_line(0x35)
...
$C$DW$10	.dwtag  DW_TAG_variable, DW_AT_name("OSTCBHighRdy")
	...
	.dwattr $C$DW$10, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/Kernel\kernel.h")
...
$C$DW$11	.dwtag  DW_TAG_variable, DW_AT_name("OSTCBCur")
	...
	.dwattr $C$DW$11, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/Kernel\kernel.h")
...
$C$DW$15	.dwtag  DW_TAG_variable, DW_AT_name("OSStkPtr")
	...
	.dwattr $C$DW$15, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/Kernel\kernel.h")
...
$C$DW$16	.dwtag  DW_TAG_variable, DW_AT_name("OSTCBTbl")
	...
	.dwattr $C$DW$16, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/Kernel\kernel.h")
	.dwattr $C$DW$16, DW_AT_decl_line(0x63)
	.dwattr $C$DW$16, DW_AT_decl_column(0x10)
;	C:\CCStudio_v3.3PLA\C2000\cgtools\bin\ac2000.exe -@C:\Users\Qijue\AppData\Local\Temp\0258812 
	.sect	".text"
	.global	_OSInit
...
_OSStart:
	...
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
	.dwpsn	file "OS_SHELL.c",line 53,column 2,is_stmt
;----------------------------------------------------------------------
;  53 | OSPrioHighRdy = OSFindHighPrio();                                      
;----------------------------------------------------------------------
$C$DW$23	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$23, DW_AT_low_pc(0x00)
	.dwattr $C$DW$23, DW_AT_name("_OSFindHighPrio")
	.dwattr $C$DW$23, DW_AT_TI_call
        LCR       #_OSFindHighPrio      ; |53| 
        ; call occurs [#_OSFindHighPrio] ; |53| 
        MOVW      DP,#_OSPrioHighRdy
        MOV       @_OSPrioHighRdy,AL    ; |53| 
	.dwpsn	file "OS_SHELL.c",line 54,column 2,is_stmt
;----------------------------------------------------------------------
;  54 | OSPrioCur     = OSPrioHighRdy;                                         
;----------------------------------------------------------------------
        MOV       @_OSPrioCur,AL        ; |54| 
	.dwpsn	file "OS_SHELL.c",line 55,column 2,is_stmt
;----------------------------------------------------------------------
;  55 | OSTCBHighRdy  = &OSTCBTbl[OSPrioHighRdy]; /* Point to highest pri task
;     | ready to run     */                                                    
;----------------------------------------------------------------------
        MOV       T,#6                  ; |55| 
        MOVL      XAR4,#_OSTCBTbl       ; |55| 
        MPYXU     ACC,T,@_OSPrioHighRdy ; |55| 
        ADDL      XAR4,ACC
        MOVL      @_OSTCBHighRdy,XAR4   ; |55| 
	.dwpsn	file "OS_SHELL.c",line 56,column 2,is_stmt
;----------------------------------------------------------------------
;  56 | OSTCBCur      = OSTCBHighRdy;                                          
;----------------------------------------------------------------------
        MOVL      ACC,@_OSTCBHighRdy    ; |56| 
        MOVL      @_OSTCBCur,ACC        ; |56| 
	.dwpsn	file "OS_SHELL.c",line 57,column 2,is_stmt
;----------------------------------------------------------------------
;  57 | OSStartHighRdy();                         /* Execute target  code to st
;     | art task         */                                                    
;----------------------------------------------------------------------
$C$DW$24	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$24, DW_AT_TI_call
        LCR       #_OSStartHighRdy      ; |57| 
        ; call occurs [#_OSStartHighRdy] ; |57| 
	.dwpsn	file "OS_SHELL.c",line 58,column 1,is_stmt
...
$C$DW$26	.dwtag  DW_TAG_subprogram, DW_AT_name("OSTaskCreate")
	...
	.dwattr $C$DW$26, DW_AT_decl_line(0x4f)
	.dwattr $C$DW$26, DW_AT_decl_column(0x08)
	.dwattr $C$DW$26, DW_AT_TI_max_frame_size(-12)
	.dwpsn	file "OS_SHELL.c",line 80,column 1,is_stmt,address _OSTaskCreate
...
;----------------------------------------------------------------------
;  79 | void    OSTaskCreate (void (*task)(void), INTOS stksize, INTOS prio)   
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
        ...
        MOV       *-SP[3],AL            ; |80| 
        MOVL      *-SP[2],XAR4          ; |80| 
	.dwpsn	file "OS_SHELL.c",line 86,column 2,is_stmt
;----------------------------------------------------------------------
;  86 | ptos=OSStkPtr;                                                         
;  88 | #if     OS_STK_CHK_EN>0                                                
;  89 | OSTCBTbl[prio].OSTCBStkBot=ptos;                                       
;  90 | OSTCBTbl[prio].OSTCBStkSize=stksize;                                   
;  91 | #endif                                                                 
;  93 | #if     OS_STK_GROWTH_UP>0                                             
;----------------------------------------------------------------------
        MOVW      DP,#_OSStkPtr
        MOVL      ACC,@_OSStkPtr        ; |86| 
        MOVL      *-SP[10],ACC          ; |86| 
	.dwpsn	file "OS_SHELL.c",line 94,column 2,is_stmt
;----------------------------------------------------------------------
;  94 | OSStkPtr+=stksize;                                                     
;  95 | #else                                                                  
;  96 | OSStkPtr-=stksize;                                                     
...
;----------------------------------------------------------------------
        MOVU      ACC,*-SP[3]
        ADDL      @_OSStkPtr,ACC        ; |94| 
	.dwpsn	file "OS_SHELL.c",line 99,column 2,is_stmt
;----------------------------------------------------------------------
;  99 | psp = OSTaskStkInit (task, ptos);                                      
;----------------------------------------------------------------------
        MOVL      XAR5,*-SP[10]         ; |99| 
        MOVL      XAR4,*-SP[2]          ; |99| 
$C$DW$36	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$36, DW_AT_TI_call
        LCR       #_OSTaskStkInit       ; |99| 
        ; call occurs [#_OSTaskStkInit] ; |99| 
        MOVL      *-SP[8],XAR4          ; |99| 
	.dwpsn	file "OS_SHELL.c",line 101,column 2,is_stmt
;----------------------------------------------------------------------
; 101 | ptcb=&OSTCBTbl[prio];                                                  
;----------------------------------------------------------------------
        MOV       T,#6                  ; |101| 
        MOVL      XAR4,#_OSTCBTbl       ; |101| 
        MPYXU     ACC,T,*-SP[4]         ; |101| 
        ADDL      XAR4,ACC
        MOVL      *-SP[6],XAR4          ; |101| 
	.dwpsn	file "OS_SHELL.c",line 103,column 2,is_stmt
;----------------------------------------------------------------------
; 103 | ptcb->OSTCBStkPtr=psp;                                                 
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; |103| 
        MOVL      ACC,*-SP[8]           ; |103| 
        MOVL      *+XAR4[0],ACC         ; |103| 
	.dwpsn	file "OS_SHELL.c",line 105,column 2,is_stmt
;----------------------------------------------------------------------
; 105 | ptcb->TimerPeriod=0;                                                   
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; |105| 
        MOV       *+XAR4[2],#0          ; |105| 
	.dwpsn	file "OS_SHELL.c",line 107,column 2,is_stmt
;----------------------------------------------------------------------
; 107 | ptcb->TimerCnt=0;                                                      
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; |107| 
        MOV       *+XAR4[3],#0          ; |107| 
	.dwpsn	file "OS_SHELL.c",line 109,column 2,is_stmt
;----------------------------------------------------------------------
; 109 | ptcb->OSEvent=0;                                                       
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; |109| 
        MOV       *+XAR4[4],#0          ; |109| 
	.dwpsn	file "OS_SHELL.c",line 111,column 2,is_stmt
;----------------------------------------------------------------------
; 111 | OSTaskRdy(prio);                                                       
;----------------------------------------------------------------------
        MOVW      DP,#_OSRdyMap
        ...
        LSL       AL,T                  ; |111| 
        OR        @_OSRdyMap,AL         ; |111| 
	.dwpsn	file "OS_SHELL.c",line 113,column 1,is_stmt
        SUBB      SP,#10
	.dwcfi	cfa_offset, -2
...
$C$DW$38	.dwtag  DW_TAG_subprogram, DW_AT_name("OSIntExit")
	...
	.dwattr $C$DW$38, DW_AT_TI_begin_line(0x80)
	...
	.dwpsn	file "OS_SHELL.c",line 129,column 1,is_stmt,address _OSIntExit

	.dwfde $C$DW$CIE, _OSIntExit
;----------------------------------------------------------------------
; 128 | void  OSIntExit (void)                                                 
;----------------------------------------------------------------------
...
_OSIntExit:
	...
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
	.dwpsn	file "OS_SHELL.c",line 131,column 9,is_stmt
;----------------------------------------------------------------------
; 131 | OSPrioHighRdy =OSFindHighPrio();                                       
;----------------------------------------------------------------------
$C$DW$39	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$39, DW_AT_low_pc(0x00)
	.dwattr $C$DW$39, DW_AT_name("_OSFindHighPrio")
	.dwattr $C$DW$39, DW_AT_TI_call
        LCR       #_OSFindHighPrio      ; |131| 
        ; call occurs [#_OSFindHighPrio] ; |131| 
        MOVW      DP,#_OSPrioHighRdy
        MOV       @_OSPrioHighRdy,AL    ; |131| 
	.dwpsn	file "OS_SHELL.c",line 132,column 9,is_stmt
;----------------------------------------------------------------------
; 132 | if (OSPrioHighRdy != OSPrioCur)                                        
;----------------------------------------------------------------------
        MOV       AL,@_OSPrioCur        ; |132| 
        CMP       AL,@_OSPrioHighRdy    ; |132| 
        BF        $C$L1,EQ              ; |132| 
        ; branchcc occurs ; |132| 
	.dwpsn	file "OS_SHELL.c",line 134,column 10,is_stmt
;----------------------------------------------------------------------
; 134 | OSPrioCur=OSPrioHighRdy;                                               
;----------------------------------------------------------------------
        MOV       AL,@_OSPrioHighRdy    ; |134| 
        MOV       @_OSPrioCur,AL        ; |134| 
	.dwpsn	file "OS_SHELL.c",line 135,column 17,is_stmt
;----------------------------------------------------------------------
; 135 | OSTCBHighRdy=&OSTCBTbl[OSPrioHighRdy];                                 
;----------------------------------------------------------------------
        MOV       T,#6                  ; |135| 
        MOVL      XAR4,#_OSTCBTbl       ; |135| 
        MPYXU     ACC,T,@_OSPrioHighRdy ; |135| 
        ADDL      XAR4,ACC
        MOVL      @_OSTCBHighRdy,XAR4   ; |135| 
	.dwpsn	file "OS_SHELL.c",line 136,column 17,is_stmt
;----------------------------------------------------------------------
; 136 | OSIntCtxSw();                           /* Perform interrupt level ctx
;     | switch  */                                                             
;----------------------------------------------------------------------
$C$DW$40	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$40, DW_AT_TI_call
        LCR       #_OSIntCtxSw          ; |136| 
        ; call occurs [#_OSIntCtxSw] ; |136| 
	.dwpsn	file "OS_SHELL.c",line 139,column 1,is_stmt
$C$L1:    
$C$DW$41	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$38, DW_AT_TI_end_line(0x8b)
...
$C$DW$42	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$42, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/Kernel\kernel.h")
...
$C$DW$43	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$43, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/Kernel\kernel.h")
...
$C$DW$44	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$44, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/Kernel\kernel.h")
...
$C$DW$45	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$45, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/Kernel\kernel.h")
...
$C$DW$46	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$46, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/Kernel\kernel.h")
...
$C$DW$T$28	.dwtag  DW_TAG_typedef, DW_AT_name("OS_TCB")
	...
	.dwattr $C$DW$T$28, DW_AT_decl_file("Z:/CCS_Code/IVEM8048 V1/IVEM8048_II_28335-V0008/IVEM8048_II/Kernel\kernel.h")
