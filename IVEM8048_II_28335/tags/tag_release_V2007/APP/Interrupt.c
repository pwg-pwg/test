...
hoTEST2SIGOn;
	...
	if(swGetEESmartPortType() == cOutPort)
	{
		...
		gi_dwRSmartOPVoltSample2SumTemp += (INT32S)gi_wRGenVoltSample * gi_wRGenVoltSample;
...
//		s_wGRIDSCRDelay = 40;
	...
	//========================  Smart_Port_L_RLY Control 和 Smart_Port_SCR  ==========================//
	//------ Smart_port 为复用端口，可以为发电机输入 或 第二输出 ------//
	...
	// {
	// 	hoSMART_PORT_RLY_On;// hoOP_TWINS_RLYOn;
	// }else
	// {
	// 	hoSMART_PORT_RLY_Off;// hoOP_TWINS_RLYOff;
	// }
