...
extern INT32S  g_uwGenPowerConversion;
extern INT32S  g_dwSmartOPPowerConversion;
...
void sRealTimeDataUpdate(void)
{
	...
	uRealTimeData.Stru.wRLoadWatt = (g_dwOPWatt+g_dwSmartOPWatt);//g_dwOPWatt;	
...
*/
	...
	uRealTimeData.Stru.wGenPowerConvertionH = (INT16S)((g_uwGenPowerConversion >> 16) & 0xFFFF);
	uRealTimeData.Stru.wGenPowerConvertionL = (INT16S)(g_uwGenPowerConversion & 0xFFFF);
	uRealTimeData.Stru.wSmartLoadPowerConvertionH = (INT16S)((g_dwSmartOPPowerConversion >> 16) & 0xFFFF);
	uRealTimeData.Stru.wSmartLoadPowerConvertionL = (INT16S)(g_dwSmartOPPowerConversion & 0xFFFF);
...
#define cFaultListLength  5  			//故障列表长度
