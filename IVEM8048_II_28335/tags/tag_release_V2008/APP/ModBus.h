...
#define SETTING_REG_BASE_ADDR	0x2100				// 实时数据BMS寄存器长度
#define SETTING_REG_BASE_LEN	E1_Len+E2_Len		// 实时数据BMS寄存器长度
...
#define INFO_REG_LEN			cInfoDataLen		// 系统信息数据起始地址
...
extern INT8U  sFaultBufferRecord(void);
