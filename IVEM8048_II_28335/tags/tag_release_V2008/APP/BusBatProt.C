...
#define cLLC_MosTjProtectPoint			970		//97C
#define cOtherTjProtectPoint			1310	//140C 		//cBUCK_IGBTKt\cINV_IGBTKt\cPV_BOOST_DiodeKt
...
#define cOtherTjDeratPoint				1220	//131.2C 	//cBUCK_IGBTKt\cINV_IGBTKt\cPV_BOOST_DiodeKt
#define cInnelTempDeratPoint			g_wInnelOTBackPoint	//60C
#define cLLC_TXDeratPoint				1290	//1350		//135C

//cOtherTjDeratPercent应该是1111,1136比较大，理论上不影响工作，这里不做修改
#define cLLC_MosTjDeratPercent			1111	//11.11%
...
extern INT16U g_uwSolar2BypassFlag;
...
//========================================================================
// 并网且非自放电 或 PV充电模式 或 BMS禁止放电且非待机态 --》禁止DCDC放电，否则允许放电
