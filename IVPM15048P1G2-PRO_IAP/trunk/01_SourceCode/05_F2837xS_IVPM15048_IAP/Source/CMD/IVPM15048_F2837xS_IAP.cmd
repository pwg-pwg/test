...
PAGE 0 :  /* Program Memory */
   ...
   RAMLS0_5          	: origin = 0x008000, length = 0x004800
...
GROUP {      /* GROUP memory ranges for crc/checksum of entire flash */
   ...
   //BEGIN           	: origin = 0x080000, length = 0x000002
	/* Flash sectors */
   BEGIN           	: origin = 0x080000, length = 0x00002
   FLASH_IAP_VER1	: origin = 0x080002, length = 0x00001, fill = 0x4256	// BV // BOOT版本	// BV01
   FLASH_IAP_VER2	: origin = 0x080003, length = 0x00001, fill = 0x3031	// 01
   ...
   FLASH_BOOT		: origin = 0x080006, length = 0x03FFA  	 /* on-chip Flash */ //   16KW BootLoad flash

   APP_BEGIN           	: origin = 0x084000, length = 0x00002
...
UNION run = PIEVECTTABLE
{
   ...
   .cinit              : > FLASH_BOOT      PAGE = 0, ALIGN(8)
   .pinit              : > FLASH_BOOT,     PAGE = 0, ALIGN(8)
   .text               : >> FLASH_BOOT     PAGE = 0, ALIGN(8)
   codestart           : > BEGIN       PAGE = 0, ALIGN(8)

   .stack              : > RAMLS0_5

   OSStack          : > RAMLS0_5, ALIGN(8)
   ...
   .stack              : > RAMM1        PAGE = 0
   .ebss               : >> RAMLS0_5       PAGE = 0
   .esysmem            : > RAMLS0_5       PAGE = 0

   /* Initalized sections go in Flash */
   .econst             : >> FLASH_BOOT      PAGE = 0, ALIGN(8)
   .switch             : > FLASH_BOOT      PAGE = 0, ALIGN(8)
   ...
   BufferDataSection : > RAMD1, PAGE = 0, ALIGN(8)
