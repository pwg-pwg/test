...
enum EE_ID
{
	...
	eATEGridVoltAdj		,// 135 市电电压校准系数
	eATEGridCurrAdj		,// 136 市电电流校准系数
	eATEGenVoltAdj 	,// 137 Gen电压校准系数
	eATEGenCurrAdj 	,// 138 Gen电流校准系数
	eATEOutL1VoltAdj		,// 139 输出L1电压校准系数
	eATEInvL2CurrAdj		,// 140 逆变电感电流2校准系数
	eEEPVPBusVoltAdj 	,// 141 预留141
	eATEGridL2CurrAdj 	,// 142 市电L2电流校准系数
	eATEGenL2CurrAdj 	,// 143 GenL2电流校准系数
	...
	eSetN_PEConnectEn 	,// 210 零地继电器使能
	eSetAFCIEn 			,// 211 AFCI模块使能
	eSetRSDEn 			,// 212 RSD模块使能
	eSetClearARCFault 	,// 213 清除ARC故障
	eSetRsvd214 	,// 214 预留214
	eSetECO_TimeOfUse 		,// 215 经济模式使能
	eSetECO_EffectiveWeek 	,// 216 生效星期
	eSetECO1_GridChargeEnable 	,// 217 规则1电网充电使能
	eSetECO1_GenChargeEnable 	,// 218 规则1油机充电使能
	eSetECO1_StartTime 			,// 219 规则1起始时间
	eSetECO1_StopTime 			,// 220 规则1结束时间
	eSetECO1_Volt 				,// 221 规则1目标电压
	eSetECO1_SOC 				,// 222 规则1目标SOC（BMS连接采用）
	eSetECO1_Power 				,// 223 规则1放电功率
	eSetECO1_Enable 			,// 224 规则1生效使能位
	eSetECO2_GridChargeEnable 	,// 225 规则2电网充电使能
	eSetECO2_GenChargeEnable 	,// 226 规则2油机充电使能
	eSetECO2_StartTime 			,// 227 规则2起始时间
	eSetECO2_StopTime 			,// 228 规则2结束时间
	eSetECO2_Volt 				,// 229 规则2目标电压
	eSetECO2_SOC 				,// 230 规则2目标SOC（BMS连接采用）
	eSetECO2_Power 				,// 231 规则2放电功率
	eSetECO2_Enable 			,// 232 规则2生效 使能位
	eSetECO3_GridChargeEnable 	,// 233 规则3电网充电使能
	eSetECO3_GenChargeEnable 	,// 234 规则3油机充电使能
	eSetECO3_StartTime 			,// 235 规则3起始时间
	eSetECO3_StopTime 			,// 236 规则3结束时间
	eSetECO3_Volt 				,// 237 规则3目标电压
	eSetECO3_SOC 				,// 238 规则3目标SOC（BMS连接采用）
	eSetECO3_Power 				,// 239 规则3放电功率
	eSetECO3_Enable 			,// 240 规则3生效 使能位
	eSetECO4_GridChargeEnable 	,// 241 规则4电网充电使能
	eSetECO4_GenChargeEnable 	,// 242 规则4油机充电使能
	eSetECO4_StartTime 			,// 243 规则4起始时间
	eSetECO4_StopTime 			,// 244 规则4结束时间
	eSetECO4_Volt 				,// 245 规则4目标电压
	eSetECO4_SOC 				,// 246 规则4目标SOC（BMS连接采用）
	eSetECO4_Power 				,// 247 规则4放电功率
	eSetECO4_Enable 			,// 248 规则4生效 使能位
	eSetECO5_GridChargeEnable 	,// 249 规则5电网充电使能
	eSetECO5_GenChargeEnable 	,// 250 规则5油机充电使能
	eSetECO5_StartTime 			,// 251 规则5起始时间
	eSetECO5_StopTime 			,// 252 规则5结束时间
	eSetECO5_Volt 				,// 253 规则5目标电压
	eSetECO5_SOC 				,// 254 规则5目标SOC（BMS连接采用）
	eSetECO5_Power 				,// 255 规则5放电功率
	eSetECO5_Enable 			,// 256 规则5生效 使能位
	eSetECO6_GridChargeEnable 	,// 257 规则6电网充电使能
	eSetECO6_GenChargeEnable 	,// 258 规则6油机充电使能
	eSetECO6_StartTime 			,// 259 规则6起始时间
	eSetECO6_StopTime 			,// 260 规则6结束时间
	eSetECO6_Volt 				,// 261 规则6目标电压
	eSetECO6_SOC 				,// 262 规则6目标SOC（BMS连接采用）
	eSetECO6_Power 				,// 263 规则6放电功率
	eSetECO6_Enable 			,// 264 规则6生效 使能位
	eSetECO7_GridChargeEnable 	,// 265 规则7电网充电使能
	eSetECO7_GenChargeEnable 	,// 266 规则7油机充电使能
	eSetECO7_StartTime 			,// 267 规则7起始时间
	eSetECO7_StopTime 			,// 268 规则7结束时间
	eSetECO7_Volt 				,// 269 规则7目标电压
	eSetECO7_SOC 				,// 270 规则7目标SOC（BMS连接采用）
	eSetECO7_Power 				,// 271 规则7放电功率
	eSetECO7_Enable 			,// 272 规则7生效 使能位
	eSetECO8_GridChargeEnable 	,// 273 规则8电网充电使能
	eSetECO8_GenChargeEnable 	,// 274 规则8油机充电使能
	eSetECO8_StartTime 			,// 275 规则8起始时间
	eSetECO8_StopTime 			,// 276 规则8结束时间
	eSetECO8_Volt 				,// 277 规则8目标电压
	eSetECO8_SOC 				,// 278 规则8目标SOC（BMS连接采用）
	eSetECO8_Power 				,// 279 规则8放电功率
	eSetECO8_Enable 			,// 280 规则8生效 使能位
	eSetRsvd281 				,// 281 预留278
	eSetRsvd282 				,// 282 预留279
	eSetRsvd283 				,// 283 预留280
	eCheckSum,
	eAddrEnd,
...
enum ATE_ID
{
	...
	eATEInvL2CurrAdj0		,// 117	逆变L2电流校准阶段0
	eATEInvL2CurrAdj1		,// 118	逆变L2电流校准阶段1
	eATEInvL2CurrAdj2		,// 119	逆变L2电流校准阶段2
	eATELineL2CurrAdj0       ,// 120 市电L2电流校准阶段0
	eATELineL2CurrAdj1       ,// 121 市电L2电流校准阶段1
	eATELineL2CurrAdj2       ,// 122 市电L2电流校准阶段2
	eATEGenL2CurrAdj0        ,// 123 GenL2电流校准阶段0
	eATEGenL2CurrAdj1        ,// 124 GenL2电流校准阶段1
	eATEGenL2CurrAdj2        ,// 125 GenL2电流校准阶段2
	eATEOutL1VoltAdj0		,// 126	输出L1电压校准阶段0
	eATEOutL1VoltAdj1		,// 127 输出L1电压校准阶段1
	eATEOutL1VoltAdj2		,// 128 输出L1电压校准阶段2
	eATELineL1VoltAdj0       ,// 129 市电L1电压校准阶段0
	eATELineL1VoltAdj1       ,// 130 市电L1电压校准阶段1
	eATELineL1VoltAdj2       ,// 131 市电L1电压校准阶段2
...
{	
	...
	INT16S	eAnalogRsvd101		;// 101 预留101
	...
	INT16S	eAnalogLoadL1Volt	;// 399 L1负载电压
	INT16S	eAnalogLoadL1Curr	;// 400 L1负载电流
	INT16S	eAnalogLoadL1Freq	;// 401 L1负载频率
	INT16S	eAnalogLoadL1Watt	;// 402 L1负载有功功率
	INT16S	eAnalogLoadL1VA 	;// 403 L1负载视在功率
	INT16U	eAnalogLoadL1Persent;// 404 L1负载百分比
	INT16S	eAnalogRsvd405	;// 405 预留405
	INT16U	eAnalogRsvd406	;// 406 预留406
	INT16S	eAnalogLoadL2Volt	;// 407 L2负载电压
	INT16S	eAnalogLoadL2Curr	;// 408 L2负载电流
	INT16S	eAnalogLoadL2Freq	;// 409 L2负载频率
	INT16S	eAnalogLoadL2Watt	;// 410 L2负载有功功率
	INT16S	eAnalogLoadL2VA 	;// 411 L2负载视在功率
	INT16U	eAnalogLoadL2Persent;// 412 L2负载百分比
	INT16U	eAnalogRsvd413	;// 413 预留413
	INT16U	eAnalogRsvd414	;// 414 预留414
	INT16S	eAnalogGridL1Volt	;// 415 电网L1电压
	INT16S	eAnalogGridL1Curr	;// 416 电网L1电流
	INT16S	eAnalogGridL1Freq	;// 417 电网L1频率
	INT16S	eAnalogGridL1Watt	;// 418 电网L1有功功率
	INT16S	eAnalogGridL1VA 	;// 419 电网L1视在功率
	INT16S	eAnalogGridL1PF 	;// 420 电网L1功率因数(0.01)
	INT16S	eAnalogGridL1DCI	;// 421 电网L1电流直流分量
	INT16U	eAnalogRsvd422	;// 422 预留;//
	INT16U	eAnalogRsvd423	;// 423 预留;//
	INT16U	eAnalogRsvd424	;// 424 预留;//
	INT16S	eAnalogGridL2Volt	;// 425 电网L2电压
	INT16S	eAnalogGridL2Curr	;// 426 电网L2电流
	INT16S	eAnalogGridL2Freq	;// 427 电网L2频率
	INT16S	eAnalogGridL2Watt	;// 428 电网L2有功功率
	INT16S	eAnalogGridL2VA 	;// 429 电网L2视在功率
	INT16S	eAnalogGridL2PF 	;// 430 电网L2功率因数(0.01)
	INT16S	eAnalogGridL2DCI	;// 431 电网L2电流直流分量
	INT16S	eAnalogRsvd432	;// 432 预留;//
	INT16S	eAnalogRsvd433	;// 433 预留;//
	INT16U	eAnalogRsvd434	;// 434 预留;//
	INT16S	eAnalogGenL1Volt	;// 435 油机L1电压
	INT16S	eAnalogGenL1Curr	;// 436 油机L1电流
	INT16S	eAnalogGenL1Freq	;// 437 油机L1频率
	INT16S	eAnalogGenL1Watt	;// 438 油机L1有功功率
	INT16S	eAnalogGenL1VA 	;// 439 油机L1视在功率
	INT16S	eAnalogGenL1PF 	;// 440 油机L1功率因数(0.01)
	INT16S	eAnalogGenL1DCI	;// 441 油机L1电流直流分量
	INT16U	eAnalogRsvd442	;// 442 预留;//
	INT16U	eAnalogRsvd443	;// 443 预留;//
	INT16U	eAnalogRsvd444	;// 444 预留;//
	INT16S	eAnalogGenL2Volt	;// 445 油机L2电压
	INT16S	eAnalogGenL2Curr	;// 446 油机L2电流
	INT16S	eAnalogGenL2Freq	;// 447 油机L2频率
	INT16S	eAnalogGenL2Watt	;// 448 油机L2有功功率
	INT16S	eAnalogGenL2VA 	;// 449 油机L2视在功率
	INT16S	eAnalogGenL2PF 	;// 450 油机L2功率因数(0.01)
	INT16S	eAnalogGenL2DCI	;// 451 油机L2电流直流分量
	INT16U	eAnalogRsvd452	;// 452 预留;//
	INT16U	eAnalogRsvd453	;// 453 预留;//
	INT16U	eAnalogRsvd454	;// 454 预留;//
	INT16S	eAnalogSLoadL1Volt	;// 455 智能负载L1电压
	INT16S	eAnalogSLoadL1Curr	;// 456 智能负载L1电流
	INT16S	eAnalogSLoadL1Freq	;// 457 智能负载L1频率
	INT16S	eAnalogSLoadL1Watt	;// 458 智能负载L1有功功率
	INT16S	eAnalogSLoadL1VA 	;// 459 智能负载L1视在功率
	INT16S	eAnalogSLoadL1DCV 	;// 460 智能负载L1功率因数(0.01)
	INT16U	eAnalogRsvd461	;// 461 预留;//
	INT16U	eAnalogRsvd462	;// 462 预留;//
	INT16U	eAnalogRsvd463	;// 463 预留;//
	INT16S	eAnalogSLoadL2Volt	;// 464 智能负载L2电压
	INT16S	eAnalogSLoadL2Curr	;// 465 智能负载L2电流
	INT16S	eAnalogSLoadL2Freq	;// 466 智能负载L2频率
	INT16S	eAnalogSLoadL2Watt	;// 467 智能负载L2有功功率
	INT16S	eAnalogSLoadL2VA 	;// 468 智能负载L2视在功率
	INT16S	eAnalogSLoadL2DCV	;// 469 智能负载L2电压直流分量
	INT16U	eAnalogRsvd470	;// 470 预留;//
	INT16U	eAnalogRsvd471	;// 471 预留;//
	INT16U	eAnalogRsvd472	;// 472 预留;//
	INT16U	eAnalogLoadL1TotalCostEnergyH 	;// 473 负载L1总耗电量高位(0.1KWh)
	INT16U	eAnalogLoadL1TotalCostEnergyL 	;// 474 负载L1总耗电量低位
	INT16U	eAnalogLoadL2TotalCostEnergyH 	;// 475 负载L2总耗电量高位(0.1KWh)
	INT16U	eAnalogLoadL2TotalCostEnergyL 	;// 476 负载L2总耗电量低位
	INT16U	eAnalogGridL1TotalCostEnergyH 	;// 477 电网L1总取电量高位(0.1KWh)
	INT16U	eAnalogGridL1TotalCostEnergyL 	;// 478 电网L1总取电量低位
	INT16U	eAnalogGridL2TotalCostEnergyH 	;// 479 电网L2总取电量高位(0.1KWh)
	INT16U	eAnalogGridL2TotalCostEnergyL 	;// 480 电网L2总取电量低位
	INT16U	eAnalogGenL1TotalCostEnergyH 	;// 481 油机L1总取电量高位(0.1KWh)
	INT16U	eAnalogGenL1TotalCostEnergyL 	;// 482 油机L1总取电量低位
	INT16U	eAnalogGenL2TotalCostEnergyH 	;// 483 油机L2总取电量高位(0.1KWh)
	INT16U	eAnalogGenL2TotalCostEnergyL 	;// 484 油机L2总取电量低位
	INT16U	eAnalogSmartLoadL1TotalCostEnergyH 	;// 485 智能负载L1总耗电量高位(0.1KWh)
	INT16U	eAnalogSmartLoadL1TotalCostEnergyL 	;// 486 智能负载L1总耗电量低位
	INT16U	eAnalogSmartLoadL2TotalCostEnergyH 	;// 487 智能负载L2总耗电量高位(0.1KWh)
	INT16U	eAnalogSmartLoadL2TotalCostEnergyL 	;// 488 智能负载L2总耗电量低位
	INT16U	eAnalogRsvd489	;// 489 预留;//
	INT16U	eAnalogRsvd490	;// 490 预留;//
	INT16U	eAnaLoadL1DayCostEnergy		;// 491 LoadL1日耗电量(0.1KWh)
	INT16U	eAnaLoadL1MonthCostEnergyH	;// 492 LoadL1月耗电量高位(0.1KWh)
	INT16U	eAnaLoadL1MonthCostEnergyL	;// 493 LoadL1月耗电量低位(0.1KWh)
	INT16U	eAnaLoadL1YearCostEnergyH	;// 494 LoadL1年耗电量高位(0.1KWh)
	INT16U	eAnaLoadL1YearCostEnergyL	;// 495 LoadL1年耗电量低位(0.1KWh)
	INT16U	eAnaLoadL2DayCostEnergy		;// 496 LoadL2日耗电量(0.1KWh)
	INT16U	eAnaLoadL2MonthCostEnergyH	;// 497 LoadL2月耗电量高位(0.1KWh)
	INT16U	eAnaLoadL2MonthCostEnergyL	;// 498 LoadL2月耗电量低位(0.1KWh)
	INT16U	eAnaLoadL2YearCostEnergyH	;// 499 LoadL2年耗电量高位(0.1KWh)
	INT16U	eAnaLoadL2YearCostEnergyL	;// 500 LoadL2年耗电量低位(0.1KWh)
	INT16U	eAnaGridL1DayCostEnergy		;// 501 GridL1日取电量(0.1KWh)
	INT16U	eAnaGridL1MonthCostEnergyH	;// 502 GridL1月取电量高位(0.1KWh)
	INT16U	eAnaGridL1MonthCostEnergyL	;// 503 GridL1月取电量低位(0.1KWh)
	INT16U	eAnaGridL1YearCostEnergyH	;// 504 GridL1年取电量高位(0.1KWh)
	INT16U	eAnaGridL1YearCostEnergyL	;// 505 GridL1年取电量低位(0.1KWh)
	INT16U	eAnaGridL2DayCostEnergy		;// 506 GridL2日取电量(0.1KWh)
	INT16U	eAnaGridL2MonthCostEnergyH	;// 507 GridL2月取电量高位(0.1KWh)
	INT16U	eAnaGridL2MonthCostEnergyL	;// 508 GridL2月取电量低位(0.1KWh)
	INT16U	eAnaGridL2YearCostEnergyH	;// 509 GridL2年取电量高位(0.1KWh)
	INT16U	eAnaGridL2YearCostEnergyL	;// 510 GridL2年取电量低位(0.1KWh)
	INT16U	eAnaGenL1DayCostEnergy		;// 511 GenL1日取电量(0.1KWh)
	INT16U	eAnaGenL1MonthCostEnergyH	;// 512 GenL1月取电量高位(0.1KWh)
	INT16U	eAnaGenL1MonthCostEnergyL	;// 513 GenL1月取电量低位(0.1KWh)
	INT16U	eAnaGenL1YearCostEnergyH	;// 514 GenL1年取电量高位(0.1KWh)
	INT16U	eAnaGenL1YearCostEnergyL	;// 515 GenL1年取电量低位(0.1KWh)
	INT16U	eAnaGenL2DayCostEnergy		;// 516 GenL2日取电量(0.1KWh)
	INT16U	eAnaGenL2MonthCostEnergyH	;// 517 GenL2月取电量高位(0.1KWh)
	INT16U	eAnaGenL2MonthCostEnergyL	;// 518 GenL2月取电量低位(0.1KWh)
	INT16U	eAnaGenL2YearCostEnergyH	;// 519 GenL2年取电量高位(0.1KWh)
	INT16U	eAnaGenL2YearCostEnergyL	;// 520 GenL2年取电量低位(0.1KWh)
	INT16U	eAnaSmartLoadL1DayCostEnergy		;// 521 智能负载L1日耗电量(0.1KWh)
	INT16U	eAnaSmartLoadL1MonthCostEnergyH	;// 522 智能负载L1月耗电量高位(0.1KWh)
	INT16U	eAnaSmartLoadL1MonthCostEnergyL	;// 523 智能负载L1月耗电量低位(0.1KWh)
	INT16U	eAnaSmartLoadL1YearCostEnergyH	;// 524 智能负载L1年耗电量高位(0.1KWh)
	INT16U	eAnaSmartLoadL1YearCostEnergyL	;// 525 智能负载L1年耗电量低位(0.1KWh)
	INT16U	eAnaSmartLoadL2DayCostEnergy		;// 526 智能负载L2日耗电量(0.1KWh)
	INT16U	eAnaSmartLoadL2MonthCostEnergyH	;// 527 智能负载L2月耗电量高位(0.1KWh)
	INT16U	eAnaSmartLoadL2MonthCostEnergyL	;// 528 智能负载L2月耗电量低位(0.1KWh)
	INT16U	eAnaSmartLoadL2YearCostEnergyH	;// 529 智能负载L2年耗电量高位(0.1KWh)
	INT16U	eAnaSmartLoadL2YearCostEnergyL	;// 530 智能负载L2年耗电量低位(0.1KWh)
	INT16S	eAnalogRsvd531	;// 531 预留;//
	INT16S	eAnalogRsvd532	;// 532 预留;//
	INT16S	eAnalogRsvd533	;// 533 预留;//
	INT16S	eAnalogRsvd534	;// 534 预留;//
	INT16S	eAnalogRsvd535	;// 535 预留;//
	INT16U	eAnaLoadL1HistoryDayCostEnergy		;// 536 LoadL1日耗电量(0.1KWh)
	INT16U	eAnaLoadL1HistoryMonthCostEnergyH	;// 537 LoadL1月耗电量高位(0.1KWh)
	INT16U	eAnaLoadL1HistoryMonthCostEnergyL	;// 538 LoadL1月耗电量低位(0.1KWh)
	INT16U	eAnaLoadL1HistoryYearCostEnergyH	;// 539 LoadL1年耗电量高位(0.1KWh)
	INT16U	eAnaLoadL1HistoryYearCostEnergyL	;// 540 LoadL1年耗电量低位(0.1KWh)
	INT16U	eAnaLoadL2HistoryDayCostEnergy		;// 541 LoadL2日耗电量(0.1KWh)
	INT16U	eAnaLoadL2HistoryMonthCostEnergyH	;// 542 LoadL2月耗电量高位(0.1KWh)
	INT16U	eAnaLoadL2HistoryMonthCostEnergyL	;// 543 LoadL2月耗电量低位(0.1KWh)
	INT16U	eAnaLoadL2HistoryYearCostEnergyH	;// 544 LoadL2年耗电量高位(0.1KWh)
	INT16U	eAnaLoadL2HistoryYearCostEnergyL	;// 545 LoadL2年耗电量低位(0.1KWh)
	INT16U	eAnaGridL1HistoryDayCostEnergy		;// 546 GridL1日取电量(0.1KWh)
	INT16U	eAnaGridL1HistoryMonthCostEnergyH	;// 547 GridL1月取电量高位(0.1KWh)
	INT16U	eAnaGridL1HistoryMonthCostEnergyL	;// 548 GridL1月取电量低位(0.1KWh)
	INT16U	eAnaGridL1HistoryYearCostEnergyH	;// 549 GridL1年取电量高位(0.1KWh)
	INT16U	eAnaGridL1HistoryYearCostEnergyL	;// 550 GridL1年取电量低位(0.1KWh)
	INT16U	eAnaGridL2HistoryDayCostEnergy		;// 551 GridL2日取电量(0.1KWh)
	INT16U	eAnaGridL2HistoryMonthCostEnergyH	;// 552 GridL2月取电量高位(0.1KWh)
	INT16U	eAnaGridL2HistoryMonthCostEnergyL	;// 553 GridL2月取电量低位(0.1KWh)
	INT16U	eAnaGridL2HistoryYearCostEnergyH	;// 554 GridL2年取电量高位(0.1KWh)
	INT16U	eAnaGridL2HistoryYearCostEnergyL	;// 555 GridL2年取电量低位(0.1KWh)
	INT16U	eAnaGenL1HistoryDayCostEnergy		;// 556 GenL1日取电量(0.1KWh)
	INT16U	eAnaGenL1HistoryMonthCostEnergyH	;// 557 GenL1月取电量高位(0.1KWh)
	INT16U	eAnaGenL1HistoryMonthCostEnergyL	;// 558 GenL1月取电量低位(0.1KWh)
	INT16U	eAnaGenL1HistoryYearCostEnergyH		;// 559 GenL1年取电量高位(0.1KWh)
	INT16U	eAnaGenL1HistoryYearCostEnergyL		;// 560 GenL1年取电量低位(0.1KWh)
	INT16U	eAnaGenL2HistoryDayCostEnergy		;// 561 GenL2日取电量(0.1KWh)
	INT16U	eAnaGenL2HistoryMonthCostEnergyH	;// 562 GenL2月取电量高位(0.1KWh)
	INT16U	eAnaGenL2HistoryMonthCostEnergyL	;// 563 GenL2月取电量低位(0.1KWh)
	INT16U	eAnaGenL2HistoryYearCostEnergyH		;// 564 GenL2年取电量高位(0.1KWh)
	INT16U	eAnaGenL2HistoryYearCostEnergyL		;// 565 GenL2年取电量低位(0.1KWh)
	INT16U	eAnaSmartLoadL1HistoryDayCostEnergy		;// 566 智能负载L1日耗电量(0.1KWh)
	INT16U	eAnaSmartLoadL1HistoryMonthCostEnergyH	;// 567 智能负载L1月耗电量高位(0.1KWh)
	INT16U	eAnaSmartLoadL1HistoryMonthCostEnergyL	;// 568 智能负载L1月耗电量低位(0.1KWh)
	INT16U	eAnaSmartLoadL1HistoryYearCostEnergyH	;// 569 智能负载L1年耗电量高位(0.1KWh)
	INT16U	eAnaSmartLoadL1HistoryYearCostEnergyL	;// 570 智能负载L1年耗电量低位(0.1KWh)
	INT16U	eAnaSmartLoadL2HistoryDayCostEnergy		;// 571 智能负载L2日耗电量(0.1KWh)
	INT16U	eAnaSmartLoadL2HistoryMonthCostEnergyH	;// 572 智能负载L2月耗电量高位(0.1KWh)
	INT16U	eAnaSmartLoadL2HistoryMonthCostEnergyL	;// 573 智能负载L2月耗电量低位(0.1KWh)
	INT16U	eAnaSmartLoadL2HistoryYearCostEnergyH	;// 574 智能负载L2年耗电量高位(0.1KWh)
	INT16U	eAnaSmartLoadL2HistoryYearCostEnergyL	;// 575 智能负载L2年耗电量低位(0.1KWh)
	INT16S	eAnalogRsvd576	;// 576 预留;//
	INT16S	eAnalogRsvd577	;// 577 预留;//
	INT16S	eAnalogRsvd578	;// 578 预留;//
	INT16S	eAnalogRsvd579	;// 579 预留;//
	INT16S	eAnalogRsvd580	;// 580 预留;//
...
struct EepromStruct
{
	...
	INT16U	eATE_GridCurrAdj		;// 136 市电L1电流校准系数
	INT16U	eATE_GenVoltAdj 	;// 137 Gen电压校准系数
	INT16U	eATE_GenCurrAdj 	;// 138 GenL1电流校准系数
	INT16U	eATE_OutL1VoltAdj		;// 139 输出L1电压校准系数
	INT16U	eATE_InvL2CurrAdj		;// 140 逆变电流L2校准系数
	INT16U	eEEPVPBusVoltAdj	;// 141 PVBus电压校准系数
	INT16U	eATE_GridL2CurrAdj	;// 142 市电L2电流校准系数
	INT16U	eATE_GenL2CurrAdj 	;// 143 GenL2电流校准系数
	INT16U	eATELineL1VoltAdj 	;// 144 市电L1电压校准系数
	...
	INT16U	eSetN_PEConnectEn 	;// 210 零地继电器使能
	INT16U	eSetAFCIEn 			;// 211 AFCI模块使能
	INT16U	eSetRSDEn 			;// 212 RSD模块使能
	INT16U	eSetClearARCFault 	;// 213 清除ARC故障
	INT16U	eSetRsvd214 	;// 214 预留214
	INT16U	eSetECO_TimeOfUse 		;// 215 经济模式使能
	INT16U	eSetECO_EffectiveWeek 	;// 216 生效星期
	INT16U	eSetECO1_GridChargeEnable 	;// 217 规则1电网充电使能
	INT16U	eSetECO1_GenChargeEnable 	;// 218 规则1油机充电使能
	INT16U	eSetECO1_StartTime 			;// 219 规则1起始时间
	INT16U	eSetECO1_StopTime 			;// 220 规则1结束时间
	INT16U	eSetECO1_Volt 				;// 221 规则1目标电压
	INT16U	eSetECO1_SOC 				;// 222 规则1目标SOC（BMS连接采用）
	INT16U	eSetECO1_Power 				;// 223 规则1放电功率
	INT16U	eSetECO1_Enable 			;// 224 规则1生效使能位
	INT16U	eSetECO2_GridChargeEnable 	;// 225 规则2电网充电使能
	INT16U	eSetECO2_GenChargeEnable 	;// 226 规则2油机充电使能
	INT16U	eSetECO2_StartTime 			;// 227 规则2起始时间
	INT16U	eSetECO2_StopTime 			;// 228 规则2结束时间
	INT16U	eSetECO2_Volt 				;// 229 规则2目标电压
	INT16U	eSetECO2_SOC 				;// 230 规则2目标SOC（BMS连接采用）
	INT16U	eSetECO2_Power 				;// 231 规则2放电功率
	INT16U	eSetECO2_Enable 			;// 232 规则2生效使能位
	INT16U	eSetECO3_GridChargeEnable 	;// 233 规则3电网充电使能
	INT16U	eSetECO3_GenChargeEnable 	;// 234 规则3油机充电使能
	INT16U	eSetECO3_StartTime 			;// 235 规则3起始时间
	INT16U	eSetECO3_StopTime 			;// 236 规则3结束时间
	INT16U	eSetECO3_Volt 				;// 237 规则3目标电压
	INT16U	eSetECO3_SOC 				;// 238 规则3目标SOC（BMS连接采用）
	INT16U	eSetECO3_Power 				;// 239 规则3放电功率
	INT16U	eSetECO3_Enable 			;// 240 规则3生效使能位
	INT16U	eSetECO4_GridChargeEnable 	;// 241 规则4电网充电使能
	INT16U	eSetECO4_GenChargeEnable 	;// 242 规则4油机充电使能
	INT16U	eSetECO4_StartTime 			;// 243 规则4起始时间
	INT16U	eSetECO4_StopTime 			;// 244 规则4结束时间
	INT16U	eSetECO4_Volt 				;// 245 规则4目标电压
	INT16U	eSetECO4_SOC 				;// 246 规则4目标SOC（BMS连接采用）
	INT16U	eSetECO4_Power 				;// 247 规则4放电功率
	INT16U	eSetECO4_Enable 			;// 248 规则4生效使能位
	INT16U	eSetECO5_GridChargeEnable 	;// 249 规则5电网充电使能
	INT16U	eSetECO5_GenChargeEnable 	;// 250 规则5油机充电使能
	INT16U	eSetECO5_StartTime 			;// 251 规则5起始时间
	INT16U	eSetECO5_StopTime 			;// 252 规则5结束时间
	INT16U	eSetECO5_Volt 				;// 253 规则5目标电压
	INT16U	eSetECO5_SOC 				;// 254 规则5目标SOC（BMS连接采用）
	INT16U	eSetECO5_Power 				;// 255 规则5放电功率
	INT16U	eSetECO5_Enable 			;// 256 规则5生效使能位
	INT16U	eSetECO6_GridChargeEnable 	;// 257 规则6电网充电使能
	INT16U	eSetECO6_GenChargeEnable 	;// 258 规则6油机充电使能
	INT16U	eSetECO6_StartTime 			;// 259 规则6起始时间
	INT16U	eSetECO6_StopTime 			;// 260 规则6结束时间
	INT16U	eSetECO6_Volt 				;// 261 规则6目标电压
	INT16U	eSetECO6_SOC 				;// 262 规则6目标SOC（BMS连接采用）
	INT16U	eSetECO6_Power 				;// 263 规则6放电功率
	INT16U	eSetECO6_Enable 			;// 264 规则6生效使能位
	INT16U	eSetECO7_GridChargeEnable 	;// 265 规则7电网充电使能
	INT16U	eSetECO7_GenChargeEnable 	;// 266 规则7油机充电使能
	INT16U	eSetECO7_StartTime 			;// 267 规则7起始时间
	INT16U	eSetECO7_StopTime 			;// 268 规则7结束时间
	INT16U	eSetECO7_Volt 				;// 269 规则7目标电压
	INT16U	eSetECO7_SOC 				;// 270 规则7目标SOC（BMS连接采用）
	INT16U	eSetECO7_Power 				;// 271 规则7放电功率
	INT16U	eSetECO7_Enable 			;// 272 规则7生效使能位
	INT16U	eSetECO8_GridChargeEnable 	;// 273 规则8电网充电使能
	INT16U	eSetECO8_GenChargeEnable 	;// 274 规则8油机充电使能
	INT16U	eSetECO8_StartTime 			;// 275 规则8起始时间
	INT16U	eSetECO8_StopTime 			;// 276 规则8结束时间
	INT16U	eSetECO8_Volt 				;// 277 规则8目标电压
	INT16U	eSetECO8_SOC 				;// 278 规则8目标SOC（BMS连接采用）
	INT16U	eSetECO8_Power 				;// 279 规则8放电功率
	INT16U	eSetECO8_Enable 			;// 280 规则8生效使能位
	INT16U	eSetRsvd281 				;// 281 预留281
	INT16U	eSetRsvd282 				;// 282 预留282
	INT16U	eSetRsvd283 				;// 283 预留283
	INT16U  wFlag;
	INT16U  wEECheckSum;
};
...
struct ATEDataStruct
{
	...
	INT16U eComAFCIStatus;//16
	INT16U eComRSDFlag;//17
	...
	INT16U eATE_InvL2CurrAdj0;//117
	INT16U eATE_InvL2CurrAdj1;//118
	INT16U eATE_InvL2CurrAdj2;//119
	INT16U eATELineL2CurrAdj0;//120
	INT16U eATELineL2CurrAdj1;//121
	INT16U eATELineL2CurrAdj2;//122
	INT16U eATEGenL2CurrAdj0;//123
	INT16U eATEGenL2CurrAdj1;//124
	INT16U eATEGenL2CurrAdj2;//125
	INT16U eATEOutL1VoltAdj0;//126
	INT16U eATEOutL1VoltAdj1;//127
	INT16U eATEOutL1VoltAdj2;//128
	INT16U eATELineL1VoltAdj0;//129
	INT16U eATELineL1VoltAdj1;//130
	INT16U eATELineL1VoltAdj2;//131
...
#define FAULT_REG_BASE_ADDR		0x1800				// 故障数据寄存器起始地址
...
MODBUS_EXT STRBMSCtrlInfo g_strBMSCtrlInfo;
MODBUS_EXT STRBMSCtrlInfo g_strSysBMSCtrlInfo;
MODBUS_EXT STRBMSCtrlLogicInfo g_strBMSCtrlLogicInfo;

//ModBus.c
MODBUS_EXT INT16U wModBusFaultId;
MODBUS_EXT INT16S wBMSConnectFlag;
MODBUS_EXT INT16U g_wBMSBaseVolt;
MODBUS_EXT INT16U wTOUGridChargeEnFlg; //TOU使能电网充电
MODBUS_EXT INT16U wTOUGenChargeEnFlg;  //TOU使能油机充电
MODBUS_EXT INT16U wTOUChargeVolt;	   //TOU目标充电电压
MODBUS_EXT INT16U wTOUChargeSOC;	   //TOU目标充电SOC
MODBUS_EXT INT16U wTOUDisChargePower;  //TOU充放电功率
MODBUS_EXT INT16U wTOUEffectiveWeekFlg;//TOU当日工作日生效执行
MODBUS_EXT INT16U wTOUECOEnFlg;        //TOU规则执行
MODBUS_EXT INT16U wCommunicationFaultRecCnt;
...
MODBUS_EXT void swTouDataUpdate(void);
MODBUS_EXT void swTouTimeAdj(void);
