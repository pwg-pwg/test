...
IICEEPROM_IOCARD INT8U 		*sGet8KDefaultTable(void);
IICEEPROM_IOCARD INT8U 		*sGet12KDefaultTable(void);
IICEEPROM_IOCARD INT8U 		*sGet10KDefaultTable(void);
...
IICEEPROM_IOCARD void sSetEepromInvL2CurrAdj(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromInvL2CurrAdj(void);
IICEEPROM_IOCARD void sSetEepromOPVoltAdj(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromOPVoltAdj(void);
IICEEPROM_IOCARD void sSetEepromOPL1VoltAdj(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromOPL1VoltAdj(void);
...
IICEEPROM_IOCARD void sSetEepromGridCurrAdj(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromGridCurrAdj(void);
IICEEPROM_IOCARD void sSetEepromGridL2CurrAdj(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromGridL2CurrAdj(void);
...
IICEEPROM_IOCARD void sSetEepromGenL2CurrAdj(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromGenL2CurrAdj(void);
IICEEPROM_IOCARD void sSetEepromPVPBusVoltAdj(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromPVPBusVoltAdj(void);
IICEEPROM_IOCARD void sSetEepromLineL1VoltAdj(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromLineL1VoltAdj(void);
...
IICEEPROM_IOCARD void sSetEepromeN_PEConnect(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromN_PEConnect(void);
IICEEPROM_IOCARD void sSetEepromeAFCIEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromAFCIEn(void);
IICEEPROM_IOCARD void sSetEepromeRSDEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromRSDEn(void);
IICEEPROM_IOCARD void sSetEepromeClearARCFault(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromClearARCFault(void);

IICEEPROM_IOCARD void sSetEepromeECO_TOUEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO_TOUEn(void);
IICEEPROM_IOCARD void sSetEepromeECO_EffectiveWeek(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO_EffectiveWeek(void);

IICEEPROM_IOCARD void sSetEepromeECO1_GridChargeEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO1_GridChargeEn(void);
IICEEPROM_IOCARD void sSetEepromeECO1_GenChargeEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO1_GenChargeEn(void);
IICEEPROM_IOCARD void sSetEepromeECO1_StartTime(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO1_StartTime(void);
IICEEPROM_IOCARD void sSetEepromeECO1_StopTime(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO1_StopTime(void);
IICEEPROM_IOCARD void sSetEepromeECO1_Volt(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO1_Volt(void);
IICEEPROM_IOCARD void sSetEepromeECO1_SOC(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO1_SOC(void);
IICEEPROM_IOCARD void sSetEepromeECO1_Power(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO1_Power(void);
IICEEPROM_IOCARD void sSetEepromeECO1_En(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO1_En(void);

IICEEPROM_IOCARD void sSetEepromeECO2_GridChargeEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO2_GridChargeEn(void);
IICEEPROM_IOCARD void sSetEepromeECO2_GenChargeEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO2_GenChargeEn(void);
IICEEPROM_IOCARD void sSetEepromeECO2_StartTime(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO2_StartTime(void);
IICEEPROM_IOCARD void sSetEepromeECO2_StopTime(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO2_StopTime(void);
IICEEPROM_IOCARD void sSetEepromeECO2_Volt(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO2_Volt(void);
IICEEPROM_IOCARD void sSetEepromeECO2_SOC(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO2_SOC(void);
IICEEPROM_IOCARD void sSetEepromeECO2_Power(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO2_Power(void);
IICEEPROM_IOCARD void sSetEepromeECO2_En(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO2_En(void);

IICEEPROM_IOCARD void sSetEepromeECO3_GridChargeEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO3_GridChargeEn(void);
IICEEPROM_IOCARD void sSetEepromeECO3_GenChargeEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO3_GenChargeEn(void);
IICEEPROM_IOCARD void sSetEepromeECO3_StartTime(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO3_StartTime(void);
IICEEPROM_IOCARD void sSetEepromeECO3_StopTime(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO3_StopTime(void);
IICEEPROM_IOCARD void sSetEepromeECO3_Volt(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO3_Volt(void);
IICEEPROM_IOCARD void sSetEepromeECO3_SOC(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO3_SOC(void);
IICEEPROM_IOCARD void sSetEepromeECO3_Power(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO3_Power(void);
IICEEPROM_IOCARD void sSetEepromeECO3_En(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO3_En(void);

IICEEPROM_IOCARD void sSetEepromeECO4_GridChargeEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO4_GridChargeEn(void);
IICEEPROM_IOCARD void sSetEepromeECO4_GenChargeEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO4_GenChargeEn(void);
IICEEPROM_IOCARD void sSetEepromeECO4_StartTime(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO4_StartTime(void);
IICEEPROM_IOCARD void sSetEepromeECO4_StopTime(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO4_StopTime(void);
IICEEPROM_IOCARD void sSetEepromeECO4_Volt(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO4_Volt(void);
IICEEPROM_IOCARD void sSetEepromeECO4_SOC(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO4_SOC(void);
IICEEPROM_IOCARD void sSetEepromeECO4_Power(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO4_Power(void);
IICEEPROM_IOCARD void sSetEepromeECO4_En(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO4_En(void);

IICEEPROM_IOCARD void sSetEepromeECO5_GridChargeEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO5_GridChargeEn(void);
IICEEPROM_IOCARD void sSetEepromeECO5_GenChargeEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO5_GenChargeEn(void);
IICEEPROM_IOCARD void sSetEepromeECO5_StartTime(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO5_StartTime(void);
IICEEPROM_IOCARD void sSetEepromeECO5_StopTime(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO5_StopTime(void);
IICEEPROM_IOCARD void sSetEepromeECO5_Volt(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO5_Volt(void);
IICEEPROM_IOCARD void sSetEepromeECO5_SOC(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO5_SOC(void);
IICEEPROM_IOCARD void sSetEepromeECO5_Power(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO5_Power(void);
IICEEPROM_IOCARD void sSetEepromeECO5_En(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO5_En(void);

IICEEPROM_IOCARD void sSetEepromeECO6_GridChargeEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO6_GridChargeEn(void);
IICEEPROM_IOCARD void sSetEepromeECO6_GenChargeEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO6_GenChargeEn(void);
IICEEPROM_IOCARD void sSetEepromeECO6_StartTime(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO6_StartTime(void);
IICEEPROM_IOCARD void sSetEepromeECO6_StopTime(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO6_StopTime(void);
IICEEPROM_IOCARD void sSetEepromeECO6_Volt(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO6_Volt(void);
IICEEPROM_IOCARD void sSetEepromeECO6_SOC(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO6_SOC(void);
IICEEPROM_IOCARD void sSetEepromeECO6_Power(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO6_Power(void);
IICEEPROM_IOCARD void sSetEepromeECO6_En(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO6_En(void);

IICEEPROM_IOCARD void sSetEepromeECO7_GridChargeEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO7_GridChargeEn(void);
IICEEPROM_IOCARD void sSetEepromeECO7_GenChargeEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO7_GenChargeEn(void);
IICEEPROM_IOCARD void sSetEepromeECO7_StartTime(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO7_StartTime(void);
IICEEPROM_IOCARD void sSetEepromeECO7_StopTime(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO7_StopTime(void);
IICEEPROM_IOCARD void sSetEepromeECO7_Volt(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO7_Volt(void);
IICEEPROM_IOCARD void sSetEepromeECO7_SOC(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO7_SOC(void);
IICEEPROM_IOCARD void sSetEepromeECO7_Power(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO7_Power(void);
IICEEPROM_IOCARD void sSetEepromeECO7_En(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO7_En(void);

IICEEPROM_IOCARD void sSetEepromeECO8_GridChargeEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO8_GridChargeEn(void);
IICEEPROM_IOCARD void sSetEepromeECO8_GenChargeEn(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO8_GenChargeEn(void);
IICEEPROM_IOCARD void sSetEepromeECO8_StartTime(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO8_StartTime(void);
IICEEPROM_IOCARD void sSetEepromeECO8_StopTime(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO8_StopTime(void);
IICEEPROM_IOCARD void sSetEepromeECO8_Volt(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO8_Volt(void);
IICEEPROM_IOCARD void sSetEepromeECO8_SOC(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO8_SOC(void);
IICEEPROM_IOCARD void sSetEepromeECO8_Power(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO8_Power(void);
IICEEPROM_IOCARD void sSetEepromeECO8_En(INT16U wValue);
IICEEPROM_IOCARD INT16U swGetEepromECO8_En(void);
/********************************************************************************
