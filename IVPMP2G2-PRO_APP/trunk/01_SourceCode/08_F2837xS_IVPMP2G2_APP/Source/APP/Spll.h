...
#define cPOWER_FILT_K1 0.99186f
#define cPOWER_FILT_K2 0.00407f
...
SPLL_EXT void Spll_LineVoltInit();
SPLL_EXT void Spll_GenVoltInit();
...
SPLL_EXT void SOGI_Power_Cal(SOGI_WATT *SogiInvPQ,F32 VoltAlpha,F32 VoltBelta,F32 CurrAlpha,F32 CurrBelta);
