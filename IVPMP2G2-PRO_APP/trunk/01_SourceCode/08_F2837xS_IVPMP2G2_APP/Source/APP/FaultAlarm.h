...
enum WARN_ID
{
	...
	ePara_InvPhaselossAlarm ,	//	Alarm Code 54	并机逆变缺相
};
...
FAULT_ALARM INT16U	swGetPara_InvPhaselossAlarm(void);						// 并机逆变缺相告警
...
FAULT_ALARM void 	swSetModelFault(INT16U uwTemp);							//机型识别故障
...
FAULT_ALARM void    swSetPara_InvPhaselossAlarm(INT16U uwTemp);							// 并机逆变缺相告警  
