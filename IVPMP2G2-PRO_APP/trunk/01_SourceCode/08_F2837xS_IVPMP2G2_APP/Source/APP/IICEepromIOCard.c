...
******************************************************************************/
const INT16U cEeprom8048DaultTable[cEepromTotalLength/2] =
{
	0		,// 0	输出模式
	0		,// 1	风机运行模式
	0xFFFF		,// 2	预留2
...
const INT16U cEeprom12048DaultTable[cEepromTotalLength/2] =
{
	0		,// 0	输出模式
	0		,// 1	风机运行模式
	0xFFFF		,// 2	预留2
...
//      INT8U bDelay = 0;
    ...
    for(i = 0;i < length;i ++)
    {
		...
		if((i%4) == 0)
		{
	        // gi_ubEepromPageWriteFlg = 1;
			gi_ubEepromPageWriteFlg = cWait500us;
...
//              }
//          }
        // gi_ubEepromPageWriteFlg = 2;
		gi_ubEepromPageWriteFlg = cWait1s;
        while(OSMaskEventPend(0xBFFF) == 0);
        return(cEepromSuccess);
    }
}
...
//	}
	...
	if(g_wVAType == cb10KVAModel)
	{
		...
		if(sbGetEepromPeakShavingCurr() > 420)
		{
			sSetEepromPeakShavingCurr(420);
			bUserChangeFlag = 1;
		}
	...
	else if(g_wVAType == cb12KVAModel)//12K
	{
		...
		if(sbGetEepromMaxDisChgCurr() > 280)
		{
			sSetEepromMaxDisChgCurr(240);
			bUserChangeFlag = 1;
		}
		...
		if(sbGetEepromMaxGridChgBatCurr() > 170)
		{
			sSetEepromMaxACChgCurr(170);
			bUserChangeFlag = 1;
		}
		if(swGetEepromGenMaxChargeCurr() > 170)
		{
			sSetEepromGenMaxChargeCurr(170);
			bUserChangeFlag = 1;
		}
		if(sbGetEepromPeakShavingCurr() > 500)
		{
			sSetEepromPeakShavingCurr(500);
			bUserChangeFlag = 1;
		}
		if(sbGetEepromGenInputMaxPower() > 60000)
		{
			sSetEepromGenInputMaxPower(12000);
			bUserChangeFlag = 1;
		}
	}
	else//8K
	{
		...
		// {
		// 	sSetEepromMaxChgCurr(100);
		// 	bUserChangeFlag = 1;
		// }
		if(sbGetEepromMaxChgCurr() > 150)//TEST
		{
			sSetEepromMaxChgCurr(100);
			bUserChangeFlag = 1;
		}

		if(sbGetEepromMaxDisChgCurr() > 180)
		{
			sSetEepromMaxDisChgCurr(150);
			bUserChangeFlag = 1;
		}

		if(sbGetEepromMaxSolarChgCurr() > 150 || sbGetEepromMaxSolarChgCurr() < 10)
		{
			sSetEepromMaxSolarChgCurr(150);
			bUserChangeFlag = 1;
		}

		if(sbGetEepromMaxGridChgBatCurr() > 120)
		{
			sSetEepromMaxACChgCurr(120);
			bUserChangeFlag = 1;
		}
		if(swGetEepromGenMaxChargeCurr() > 120)
		{
			sSetEepromGenMaxChargeCurr(120);
			bUserChangeFlag = 1;
		}
		if(sbGetEepromPeakShavingCurr() > 330)
		{
			sSetEepromPeakShavingCurr(330);
			bUserChangeFlag = 1;
		}
		if(sbGetEepromGenInputMaxPower() > 60000)
		{
			sSetEepromGenInputMaxPower(8000);
			bUserChangeFlag = 1;
		}
	}
	...
	if(swGetEepromOnGridBatAutoExitChargeVolt() > 600 || swGetEepromOnGridBatAutoExitChargeVolt() < 480)
	{
	...
	if(swGetEepromOnGenBatAutoExitChargeVolt() > 600 || swGetEepromOnGenBatAutoExitChargeVolt() < 480)
	{
...
//	}
	...
	if((swGetEepromLineWaitSec() > 300)||(swGetEepromLineWaitSec() < 30))
	{
...
//	}
	...
	if(swGetEepromInvL2CurrAdj() > 2548 || swGetEepromInvL2CurrAdj() < 1548)
	{
	...
	if(swGetEepromGridCurrAdj() > 2548 || swGetEepromGridCurrAdj() < 1548)
	{
		sSetEepromGridCurrAdj(2048);
		bUserChangeFlag = 1;
	}

	if(swGetEepromGridL2CurrAdj() > 2548 || swGetEepromGridL2CurrAdj() < 1548)
	{
	...
	if(swGetEepromGenL2CurrAdj() > 2548 || swGetEepromGenL2CurrAdj() < 1548)
	{
	...
	if(swGetEepromLineL1VoltAdj() > 2548 || swGetEepromLineL1VoltAdj() < 1548)
	{
...
//	}
	...
	if(swGetEepromLcdOffDelay() > 3600 || swGetEepromLcdOffDelay() < 30)
	{
		sSetEepromLcdOffDelay(600);
		bUserChangeFlag = 1;
	}
...
//    }
    ...
    if(mEEInvL1CurrAdj() < 1548 || mEEInvL1CurrAdj() > 2548)
    {
        OS_ENTER_CRITICAL();
        mEEInvL1CurrAdj() = 2048;
        OS_EXIT_CRITICAL();
        bFactoryChangFlag = 1;
    }
...
//    }
	...
	if(g_wVAType == cb10KVAModel)
	{
	    ...
	    {
	        sSetEepromMaxACChgCurr(cIdc150A);
	        bUserChangeFlag = 1;
	    }
	}
	else if(g_wVAType == cb12KVAModel)
	{
	    ...
	    if(sbGetEepromMaxGridChgBatCurr() > cIdc170A)
	    {
	        sSetEepromMaxACChgCurr(cIdc170A);
	        bUserChangeFlag = 1;
	    }
	}
	else //8K
	{
		// if(sbGetEepromMaxSolarChgCurr() > cIdc120A)
		// {
		// 	sSetEepromMaxSolarChgCurr(120);
		// 	bUserChangeFlag = 1;
		// }
		
	    if(sbGetEepromMaxGridChgBatCurr() > cIdc120A)
	    {
	        sSetEepromMaxACChgCurr(cIdc120A);
	        bUserChangeFlag = 1;
	    }
	}
    ...
    if((swGetEepromN_PEConnect()!=1)&&(swGetEepromN_PEConnect()!=0))
    {
        sSetEepromeN_PEConnect(0);
		bUserChangeFlag = 1;
	}

	if((swGetEepromAFCIEn()!=1)&&(swGetEepromAFCIEn()!=0))
    {
        sSetEepromeAFCIEn(0);
		bUserChangeFlag = 1;
	}
	if((swGetEepromRSDEn()!=1)&&(swGetEepromRSDEn()!=0))
    {
        sSetEepromeRSDEn(0);
		bUserChangeFlag = 1;
	}
	if((swGetEepromClearARCFault()!=1)&&(swGetEepromClearARCFault()!=0))
    {
        sSetEepromeClearARCFault(0);
		bUserChangeFlag = 1;
	}

    if(swGetEepromECO_TOUEn() > 1)
    {
        sSetEepromeECO_TOUEn(0);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO_EffectiveWeek() > 127)
    {
        sSetEepromeECO_EffectiveWeek(127);
        bUserChangeFlag = 1;
    }
	/*ECO1*/
	if(swGetEepromECO1_GridChargeEn() > 1)
    {
        sSetEepromeECO1_GridChargeEn(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO1_GenChargeEn() > 1)
    {
        sSetEepromeECO1_GenChargeEn(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO1_StartTime() > 5947)
    {
        sSetEepromeECO1_StartTime(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO1_StopTime() > 5947)
    {
        sSetEepromeECO1_StopTime(5947);
        bUserChangeFlag = 1;
    }
	if((swGetEepromECO1_Volt() < 400)||(swGetEepromECO1_Volt() > 600))
    {
        sSetEepromeECO1_Volt(500);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO1_SOC() > 100)
    {
        sSetEepromeECO1_SOC(50);
        bUserChangeFlag = 1;
    }
	if(g_wVAType == cb10KVAModel)
	{
		if(swGetEepromECO1_Power() > c10KVAMaxPower)
		{
			sSetEepromeECO1_Power(5000);
			bUserChangeFlag = 1;
		}
	}
	else if(g_wVAType == cb12KVAModel)
	{
		if(swGetEepromECO1_Power() > c12KVAMaxPower)
		{
			sSetEepromeECO1_Power(6000);
			bUserChangeFlag = 1;
		}
	}
	else //8K
	{
		if(swGetEepromECO1_Power() > c8KVAMaxPower)
		{
			sSetEepromeECO1_Power(4000);
			bUserChangeFlag = 1;
		}
	}
	if(swGetEepromECO1_En() > 1)
    {
        sSetEepromeECO1_En(0);
        bUserChangeFlag = 1;
    }
	/*ECO2*/
	if(swGetEepromECO2_GridChargeEn() > 1)
    {
        sSetEepromeECO2_GridChargeEn(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO2_GenChargeEn() > 1)
    {
        sSetEepromeECO2_GenChargeEn(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO2_StartTime() > 5947)
    {
        sSetEepromeECO2_StartTime(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO2_StopTime() > 5947)
    {
        sSetEepromeECO2_StopTime(5947);
        bUserChangeFlag = 1;
    }
	if((swGetEepromECO2_Volt() < 400)||(swGetEepromECO2_Volt() > 600))
    {
        sSetEepromeECO2_Volt(500);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO2_SOC() > 100)
    {
        sSetEepromeECO2_SOC(50);
        bUserChangeFlag = 1;
    }
	if(g_wVAType == cb10KVAModel)
	{
		if(swGetEepromECO2_Power() > c10KVAMaxPower)
		{
			sSetEepromeECO2_Power(5000);
			bUserChangeFlag = 1;
		}
	}
	else if(g_wVAType == cb12KVAModel)
	{
		if(swGetEepromECO2_Power() > c12KVAMaxPower)
		{
			sSetEepromeECO2_Power(6000);
			bUserChangeFlag = 1;
		}
	}
	else //8K
	{
		if(swGetEepromECO2_Power() > c8KVAMaxPower)
		{
			sSetEepromeECO2_Power(4000);
			bUserChangeFlag = 1;
		}
	}
	if(swGetEepromECO2_En() > 1)
    {
        sSetEepromeECO2_En(0);
        bUserChangeFlag = 1;
    }
	/*ECO3*/
	if(swGetEepromECO3_GridChargeEn() > 1)
    {
        sSetEepromeECO3_GridChargeEn(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO3_GenChargeEn() > 1)
    {
        sSetEepromeECO3_GenChargeEn(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO3_StartTime() > 5947)
    {
        sSetEepromeECO3_StartTime(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO3_StopTime() > 5947)
    {
        sSetEepromeECO3_StopTime(5947);
        bUserChangeFlag = 1;
    }
	if((swGetEepromECO3_Volt() < 400)||(swGetEepromECO3_Volt() > 600))
    {
        sSetEepromeECO3_Volt(500);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO3_SOC() > 100)
    {
        sSetEepromeECO3_SOC(50);
        bUserChangeFlag = 1;
    }
	if(g_wVAType == cb10KVAModel)
	{
		if(swGetEepromECO3_Power() > c10KVAMaxPower)
		{
			sSetEepromeECO3_Power(5000);
			bUserChangeFlag = 1;
		}
	}
	else if(g_wVAType == cb12KVAModel)
	{
		if(swGetEepromECO3_Power() > c12KVAMaxPower)
		{
			sSetEepromeECO3_Power(6000);
			bUserChangeFlag = 1;
		}
	}
	else //8K
	{
		if(swGetEepromECO3_Power() > c8KVAMaxPower)
		{
			sSetEepromeECO3_Power(4000);
			bUserChangeFlag = 1;
		}
	}
	if(swGetEepromECO3_En() > 1)
    {
        sSetEepromeECO3_En(0);
        bUserChangeFlag = 1;
    }
	/*ECO4*/
	if(swGetEepromECO4_GridChargeEn() > 1)
    {
        sSetEepromeECO4_GridChargeEn(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO4_GenChargeEn() > 1)
    {
        sSetEepromeECO4_GenChargeEn(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO4_StartTime() > 5947)
    {
        sSetEepromeECO4_StartTime(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO4_StopTime() > 5947)
    {
        sSetEepromeECO4_StopTime(5947);
        bUserChangeFlag = 1;
    }
	if((swGetEepromECO4_Volt() < 400)||(swGetEepromECO4_Volt() > 600))
    {
        sSetEepromeECO4_Volt(500);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO4_SOC() > 100)
    {
        sSetEepromeECO4_SOC(50);
        bUserChangeFlag = 1;
    }
	if(g_wVAType == cb10KVAModel)
	{
		if(swGetEepromECO4_Power() > c10KVAMaxPower)
		{
			sSetEepromeECO4_Power(5000);
			bUserChangeFlag = 1;
		}
	}
	else if(g_wVAType == cb12KVAModel)
	{
		if(swGetEepromECO4_Power() > c12KVAMaxPower)
		{
			sSetEepromeECO4_Power(6000);
			bUserChangeFlag = 1;
		}
	}
	else //8K
	{
		if(swGetEepromECO4_Power() > c8KVAMaxPower)
		{
			sSetEepromeECO4_Power(4000);
			bUserChangeFlag = 1;
		}
	}
	if(swGetEepromECO4_En() > 1)
    {
        sSetEepromeECO4_En(0);
        bUserChangeFlag = 1;
    }
	/*ECO5*/
	if(swGetEepromECO5_GridChargeEn() > 1)
    {
        sSetEepromeECO5_GridChargeEn(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO5_GenChargeEn() > 1)
    {
        sSetEepromeECO5_GenChargeEn(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO5_StartTime() > 5947)
    {
        sSetEepromeECO5_StartTime(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO5_StopTime() > 5947)
    {
        sSetEepromeECO5_StopTime(5947);
        bUserChangeFlag = 1;
    }
	if((swGetEepromECO5_Volt() < 400)||(swGetEepromECO5_Volt() > 600))
    {
        sSetEepromeECO5_Volt(500);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO5_SOC() > 100)
    {
        sSetEepromeECO5_SOC(50);
        bUserChangeFlag = 1;
    }
	if(g_wVAType == cb10KVAModel)
	{
		if(swGetEepromECO5_Power() > c10KVAMaxPower)
		{
			sSetEepromeECO5_Power(5000);
			bUserChangeFlag = 1;
		}
	}
	else if(g_wVAType == cb12KVAModel)
	{
		if(swGetEepromECO5_Power() > c12KVAMaxPower)
		{
			sSetEepromeECO5_Power(6000);
			bUserChangeFlag = 1;
		}
	}
	else //8K
	{
		if(swGetEepromECO5_Power() > c8KVAMaxPower)
		{
			sSetEepromeECO5_Power(4000);
			bUserChangeFlag = 1;
		}
	}
	if(swGetEepromECO5_En() > 1)
    {
        sSetEepromeECO5_En(0);
        bUserChangeFlag = 1;
    }
	/*ECO6*/
	if(swGetEepromECO6_GridChargeEn() > 1)
    {
        sSetEepromeECO6_GridChargeEn(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO6_GenChargeEn() > 1)
    {
        sSetEepromeECO6_GenChargeEn(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO6_StartTime() > 5947)
    {
        sSetEepromeECO6_StartTime(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO6_StopTime() > 5947)
    {
        sSetEepromeECO6_StopTime(5947);
        bUserChangeFlag = 1;
    }
	if((swGetEepromECO6_Volt() < 400)||(swGetEepromECO6_Volt() > 600))
    {
        sSetEepromeECO6_Volt(500);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO6_SOC() > 100)
    {
        sSetEepromeECO6_SOC(50);
        bUserChangeFlag = 1;
    }
	if(g_wVAType == cb10KVAModel)
	{
		if(swGetEepromECO6_Power() > c10KVAMaxPower)
		{
			sSetEepromeECO6_Power(5000);
			bUserChangeFlag = 1;
		}
	}
	else if(g_wVAType == cb12KVAModel)
	{
		if(swGetEepromECO6_Power() > c12KVAMaxPower)
		{
			sSetEepromeECO6_Power(6000);
			bUserChangeFlag = 1;
		}
	}
	else //8K
	{
		if(swGetEepromECO6_Power() > c8KVAMaxPower)
		{
			sSetEepromeECO6_Power(4000);
			bUserChangeFlag = 1;
		}
	}
	if(swGetEepromECO6_En() > 1)
    {
        sSetEepromeECO6_En(0);
        bUserChangeFlag = 1;
    }
	/*ECO7*/
	if(swGetEepromECO7_GridChargeEn() > 1)
    {
        sSetEepromeECO7_GridChargeEn(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO7_GenChargeEn() > 1)
    {
        sSetEepromeECO7_GenChargeEn(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO7_StartTime() > 5947)
    {
        sSetEepromeECO7_StartTime(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO7_StopTime() > 5947)
    {
        sSetEepromeECO7_StopTime(5947);
        bUserChangeFlag = 1;
    }
	if((swGetEepromECO7_Volt() < 400)||(swGetEepromECO7_Volt() > 600))
    {
        sSetEepromeECO7_Volt(500);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO7_SOC() > 100)
    {
        sSetEepromeECO7_SOC(50);
        bUserChangeFlag = 1;
    }
	if(g_wVAType == cb10KVAModel)
	{
		if(swGetEepromECO7_Power() > c10KVAMaxPower)
		{
			sSetEepromeECO7_Power(5000);
			bUserChangeFlag = 1;
		}
	}
	else if(g_wVAType == cb12KVAModel)
	{
		if(swGetEepromECO7_Power() > c12KVAMaxPower)
		{
			sSetEepromeECO7_Power(6000);
			bUserChangeFlag = 1;
		}
	}
	else //8K
	{
		if(swGetEepromECO7_Power() > c8KVAMaxPower)
		{
			sSetEepromeECO7_Power(4000);
			bUserChangeFlag = 1;
		}
	}
	if(swGetEepromECO7_En() > 1)
    {
        sSetEepromeECO7_En(0);
        bUserChangeFlag = 1;
    }
	/*ECO8*/
	if(swGetEepromECO8_GridChargeEn() > 1)
    {
        sSetEepromeECO8_GridChargeEn(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO8_GenChargeEn() > 1)
    {
        sSetEepromeECO8_GenChargeEn(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO8_StartTime() > 5947)
    {
        sSetEepromeECO8_StartTime(1);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO8_StopTime() > 5947)
    {
        sSetEepromeECO8_StopTime(5947);
        bUserChangeFlag = 1;
    }
	if((swGetEepromECO8_Volt() < 400)||(swGetEepromECO8_Volt() > 600))
    {
        sSetEepromeECO8_Volt(500);
        bUserChangeFlag = 1;
    }
	if(swGetEepromECO8_SOC() > 100)
    {
        sSetEepromeECO8_SOC(50);
        bUserChangeFlag = 1;
    }
	if(g_wVAType == cb10KVAModel)
	{
		if(swGetEepromECO8_Power() > c10KVAMaxPower)
		{
			sSetEepromeECO8_Power(5000);
			bUserChangeFlag = 1;
		}
	}
	else if(g_wVAType == cb12KVAModel)
	{
		if(swGetEepromECO8_Power() > c12KVAMaxPower)
		{
			sSetEepromeECO8_Power(6000);
			bUserChangeFlag = 1;
		}
	}
	else //8K
	{
		if(swGetEepromECO8_Power() > c8KVAMaxPower)
		{
			sSetEepromeECO8_Power(4000);
			bUserChangeFlag = 1;
		}
	}
	if(swGetEepromECO8_En() > 1)
    {
        sSetEepromeECO8_En(0);
        bUserChangeFlag = 1;
    }
...
void sSetEepromInvL2CurrAdj(INT16U wValue)
{
   uEepromCfg.EepromStructCfg.eATE_InvL2CurrAdj = wValue;
}
INT16U swGetEepromInvL2CurrAdj(void)
{
    return(uEepromCfg.EepromStructCfg.eATE_InvL2CurrAdj);
}
...
void sSetEepromOPL1VoltAdj(INT16U wValue)
{
   uEepromCfg.EepromStructCfg.eATE_OutL1VoltAdj = wValue;
}
INT16U swGetEepromOPL1VoltAdj(void)
{
    return(uEepromCfg.EepromStructCfg.eATE_OutL1VoltAdj);
}
...
void sSetEepromGridCurrAdj(INT16U wValue)
{
   uEepromCfg.EepromStructCfg.eATE_GridCurrAdj = wValue;
}
INT16U swGetEepromGridCurrAdj(void)
{
    return(uEepromCfg.EepromStructCfg.eATE_GridCurrAdj);
}
void sSetEepromGridL2CurrAdj(INT16U wValue)
{
   uEepromCfg.EepromStructCfg.eATE_GridL2CurrAdj = wValue;
}
INT16U swGetEepromGridL2CurrAdj(void)
{
    return(uEepromCfg.EepromStructCfg.eATE_GridL2CurrAdj);
}
...
void sSetEepromGenL2CurrAdj(INT16U wValue)
{
   uEepromCfg.EepromStructCfg.eATE_GenL2CurrAdj = wValue;
}
INT16U swGetEepromGenL2CurrAdj(void)
{
    return(uEepromCfg.EepromStructCfg.eATE_GenL2CurrAdj);
}
...
void sSetEepromLineL1VoltAdj(INT16U wValue)
{
   uEepromCfg.EepromStructCfg.eATELineL1VoltAdj = wValue;
}
INT16U swGetEepromLineL1VoltAdj(void)
{
    return(uEepromCfg.EepromStructCfg.eATELineL1VoltAdj);
}
...
void sSetEepromeN_PEConnect(INT16U wValue)
{
   uEepromCfg.EepromStructCfg.eSetN_PEConnectEn = wValue;
}
INT16U swGetEepromN_PEConnect(void)
{
    return(uEepromCfg.EepromStructCfg.eSetN_PEConnectEn);
}
void sSetEepromeAFCIEn(INT16U wValue)
{
   uEepromCfg.EepromStructCfg.eSetAFCIEn = wValue;
}
INT16U swGetEepromAFCIEn(void)
{
    return(uEepromCfg.EepromStructCfg.eSetAFCIEn);
}
void sSetEepromeRSDEn(INT16U wValue)
{
   uEepromCfg.EepromStructCfg.eSetRSDEn = wValue;
}
INT16U swGetEepromRSDEn(void)
{
    return(uEepromCfg.EepromStructCfg.eSetRSDEn);
}
void sSetEepromeClearARCFault(INT16U wValue)
{
   uEepromCfg.EepromStructCfg.eSetClearARCFault = wValue;
}
INT16U swGetEepromClearARCFault(void)
{
    return(uEepromCfg.EepromStructCfg.eSetClearARCFault);
}

void sSetEepromeECO_TOUEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO_TimeOfUse = wValue;
}
INT16U swGetEepromECO_TOUEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO_TimeOfUse);
}
void sSetEepromeECO_EffectiveWeek(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO_EffectiveWeek = wValue;
}
INT16U swGetEepromECO_EffectiveWeek(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO_EffectiveWeek);
}
/*1*/
void sSetEepromeECO1_GridChargeEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO1_GridChargeEnable = wValue;
}
INT16U swGetEepromECO1_GridChargeEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO1_GridChargeEnable);
}
void sSetEepromeECO1_GenChargeEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO1_GenChargeEnable = wValue;
}
INT16U swGetEepromECO1_GenChargeEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO1_GenChargeEnable);
}
void sSetEepromeECO1_StartTime(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO1_StartTime = wValue;
}
INT16U swGetEepromECO1_StartTime(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO1_StartTime);
}
void sSetEepromeECO1_StopTime(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO1_StopTime = wValue;
}
INT16U swGetEepromECO1_StopTime(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO1_StopTime);
}
void sSetEepromeECO1_Volt(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO1_Volt = wValue;
}
INT16U swGetEepromECO1_Volt(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO1_Volt);
}
void sSetEepromeECO1_SOC(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO1_SOC = wValue;
}
INT16U swGetEepromECO1_SOC(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO1_SOC);
}
void sSetEepromeECO1_Power(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO1_Power = wValue;
}
INT16U swGetEepromECO1_Power(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO1_Power);
}
void sSetEepromeECO1_En(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO1_Enable = wValue;
}
INT16U swGetEepromECO1_En(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO1_Enable);
}
/*1-end*/
void sSetEepromeECO2_GridChargeEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO2_GridChargeEnable = wValue;
}
INT16U swGetEepromECO2_GridChargeEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO2_GridChargeEnable);
}
void sSetEepromeECO2_GenChargeEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO2_GenChargeEnable = wValue;
}
INT16U swGetEepromECO2_GenChargeEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO2_GenChargeEnable);
}
void sSetEepromeECO2_StartTime(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO2_StartTime = wValue;
}
INT16U swGetEepromECO2_StartTime(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO2_StartTime);
}
void sSetEepromeECO2_StopTime(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO2_StopTime = wValue;
}
INT16U swGetEepromECO2_StopTime(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO2_StopTime);
}
void sSetEepromeECO2_Volt(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO2_Volt = wValue;
}
INT16U swGetEepromECO2_Volt(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO2_Volt);
}
void sSetEepromeECO2_SOC(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO2_SOC = wValue;
}
INT16U swGetEepromECO2_SOC(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO2_SOC);
}
void sSetEepromeECO2_Power(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO2_Power = wValue;
}
INT16U swGetEepromECO2_Power(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO2_Power);
}
void sSetEepromeECO2_En(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO2_Enable = wValue;
}
INT16U swGetEepromECO2_En(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO2_Enable);
}
/*2-end*/
void sSetEepromeECO3_GridChargeEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO3_GridChargeEnable = wValue;
}
INT16U swGetEepromECO3_GridChargeEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO3_GridChargeEnable);
}
void sSetEepromeECO3_GenChargeEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO3_GenChargeEnable = wValue;
}
INT16U swGetEepromECO3_GenChargeEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO3_GenChargeEnable);
}
void sSetEepromeECO3_StartTime(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO3_StartTime = wValue;
}
INT16U swGetEepromECO3_StartTime(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO3_StartTime);
}
void sSetEepromeECO3_StopTime(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO3_StopTime = wValue;
}
INT16U swGetEepromECO3_StopTime(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO3_StopTime);
}
void sSetEepromeECO3_Volt(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO3_Volt = wValue;
}
INT16U swGetEepromECO3_Volt(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO3_Volt);
}
void sSetEepromeECO3_SOC(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO3_SOC = wValue;
}
INT16U swGetEepromECO3_SOC(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO3_SOC);
}
void sSetEepromeECO3_Power(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO3_Power = wValue;
}
INT16U swGetEepromECO3_Power(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO3_Power);
}
void sSetEepromeECO3_En(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO3_Enable = wValue;
}
INT16U swGetEepromECO3_En(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO3_Enable);
}
/*3-end*/
void sSetEepromeECO4_GridChargeEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO4_GridChargeEnable = wValue;
}
INT16U swGetEepromECO4_GridChargeEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO4_GridChargeEnable);
}
void sSetEepromeECO4_GenChargeEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO4_GenChargeEnable = wValue;
}
INT16U swGetEepromECO4_GenChargeEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO4_GenChargeEnable);
}
void sSetEepromeECO4_StartTime(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO4_StartTime = wValue;
}
INT16U swGetEepromECO4_StartTime(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO4_StartTime);
}
void sSetEepromeECO4_StopTime(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO4_StopTime = wValue;
}
INT16U swGetEepromECO4_StopTime(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO4_StopTime);
}
void sSetEepromeECO4_Volt(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO4_Volt = wValue;
}
INT16U swGetEepromECO4_Volt(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO4_Volt);
}
void sSetEepromeECO4_SOC(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO4_SOC = wValue;
}
INT16U swGetEepromECO4_SOC(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO4_SOC);
}
void sSetEepromeECO4_Power(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO4_Power = wValue;
}
INT16U swGetEepromECO4_Power(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO4_Power);
}
void sSetEepromeECO4_En(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO4_Enable = wValue;
}
INT16U swGetEepromECO4_En(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO4_Enable);
}
/*4-end*/
void sSetEepromeECO5_GridChargeEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO5_GridChargeEnable = wValue;
}
INT16U swGetEepromECO5_GridChargeEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO5_GridChargeEnable);
}
void sSetEepromeECO5_GenChargeEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO5_GenChargeEnable = wValue;
}
INT16U swGetEepromECO5_GenChargeEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO5_GenChargeEnable);
}
void sSetEepromeECO5_StartTime(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO5_StartTime = wValue;
}
INT16U swGetEepromECO5_StartTime(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO5_StartTime);
}
void sSetEepromeECO5_StopTime(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO5_StopTime = wValue;
}
INT16U swGetEepromECO5_StopTime(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO5_StopTime);
}
void sSetEepromeECO5_Volt(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO5_Volt = wValue;
}
INT16U swGetEepromECO5_Volt(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO5_Volt);
}
void sSetEepromeECO5_SOC(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO5_SOC = wValue;
}
INT16U swGetEepromECO5_SOC(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO5_SOC);
}
void sSetEepromeECO5_Power(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO5_Power = wValue;
}
INT16U swGetEepromECO5_Power(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO5_Power);
}
void sSetEepromeECO5_En(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO5_Enable = wValue;
}
INT16U swGetEepromECO5_En(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO5_Enable);
}
/*5-end*/
void sSetEepromeECO6_GridChargeEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO6_GridChargeEnable = wValue;
}
INT16U swGetEepromECO6_GridChargeEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO6_GridChargeEnable);
}
void sSetEepromeECO6_GenChargeEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO6_GenChargeEnable = wValue;
}
INT16U swGetEepromECO6_GenChargeEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO6_GenChargeEnable);
}
void sSetEepromeECO6_StartTime(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO6_StartTime = wValue;
}
INT16U swGetEepromECO6_StartTime(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO6_StartTime);
}
void sSetEepromeECO6_StopTime(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO6_StopTime = wValue;
}
INT16U swGetEepromECO6_StopTime(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO6_StopTime);
}
void sSetEepromeECO6_Volt(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO6_Volt = wValue;
}
INT16U swGetEepromECO6_Volt(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO6_Volt);
}
void sSetEepromeECO6_SOC(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO6_SOC = wValue;
}
INT16U swGetEepromECO6_SOC(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO6_SOC);
}
void sSetEepromeECO6_Power(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO6_Power = wValue;
}
INT16U swGetEepromECO6_Power(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO6_Power);
}
void sSetEepromeECO6_En(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO6_Enable = wValue;
}
INT16U swGetEepromECO6_En(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO6_Enable);
}
/*6-end*/
void sSetEepromeECO7_GridChargeEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO7_GridChargeEnable = wValue;
}
INT16U swGetEepromECO7_GridChargeEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO7_GridChargeEnable);
}
void sSetEepromeECO7_GenChargeEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO7_GenChargeEnable = wValue;
}
INT16U swGetEepromECO7_GenChargeEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO7_GenChargeEnable);
}
void sSetEepromeECO7_StartTime(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO7_StartTime = wValue;
}
INT16U swGetEepromECO7_StartTime(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO7_StartTime);
}
void sSetEepromeECO7_StopTime(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO7_StopTime = wValue;
}
INT16U swGetEepromECO7_StopTime(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO7_StopTime);
}
void sSetEepromeECO7_Volt(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO7_Volt = wValue;
}
INT16U swGetEepromECO7_Volt(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO7_Volt);
}
void sSetEepromeECO7_SOC(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO7_SOC = wValue;
}
INT16U swGetEepromECO7_SOC(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO7_SOC);
}
void sSetEepromeECO7_Power(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO7_Power = wValue;
}
INT16U swGetEepromECO7_Power(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO7_Power);
}
void sSetEepromeECO7_En(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO7_Enable = wValue;
}
INT16U swGetEepromECO7_En(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO7_Enable);
}
/*7-end*/
void sSetEepromeECO8_GridChargeEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO8_GridChargeEnable = wValue;
}
INT16U swGetEepromECO8_GridChargeEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO8_GridChargeEnable);
}
void sSetEepromeECO8_GenChargeEn(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO8_GenChargeEnable = wValue;
}
INT16U swGetEepromECO8_GenChargeEn(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO8_GenChargeEnable);
}
void sSetEepromeECO8_StartTime(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO8_StartTime = wValue;
}
INT16U swGetEepromECO8_StartTime(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO8_StartTime);
}
void sSetEepromeECO8_StopTime(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO8_StopTime = wValue;
}
INT16U swGetEepromECO8_StopTime(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO8_StopTime);
}
void sSetEepromeECO8_Volt(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO8_Volt = wValue;
}
INT16U swGetEepromECO8_Volt(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO8_Volt);
}
void sSetEepromeECO8_SOC(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO8_SOC = wValue;
}
INT16U swGetEepromECO8_SOC(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO8_SOC);
}
void sSetEepromeECO8_Power(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO8_Power = wValue;
}
INT16U swGetEepromECO8_Power(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO8_Power);
}
void sSetEepromeECO8_En(INT16U wValue)
{
  uEepromCfg.EepromStructCfg.eSetECO8_Enable = wValue;
}
INT16U swGetEepromECO8_En(void)
{
   return(uEepromCfg.EepromStructCfg.eSetECO8_Enable);
}
/*8-end*/
INT8U *sGet8KDefaultTable(void)
{
    return((INT8U *)cEeprom8048DaultTable);
}

INT8U *sGet12KDefaultTable(void)
{
    return((INT8U *)cEeprom12048DaultTable);
}
