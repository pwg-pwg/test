...
INVERTER_MODULE  void    sInvL1CurrAdj(INT16U wInvCurrRMS);
INVERTER_MODULE  void    sInvL2CurrAdj(INT16U wInvCurrRMS);
...
INVERTER_MODULE INT16U swGetInvL2CurrNew(void);
...
INVERTER_MODULE INT16S sbGetInvL1CurrNew(void);
INVERTER_MODULE INT16S sbGetInvL2CurrNew(void);
