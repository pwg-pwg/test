...
ENERGYSAVED_EXT INT64U swGetGenL1DayEnergy(void);
ENERGYSAVED_EXT INT64U swGetGenL2DayEnergy(void);
ENERGYSAVED_EXT INT64U swGetGridDayEnergy(void);
ENERGYSAVED_EXT INT64U swGetGridL1DayEnergy(void);
ENERGYSAVED_EXT INT64U swGetGridL2DayEnergy(void);
ENERGYSAVED_EXT INT64U swGetSupplyGridDayEnergy(void);
ENERGYSAVED_EXT INT64U swGetLoadDayEnergy(void);
ENERGYSAVED_EXT INT64U swGetLoadL1DayEnergy(void);
ENERGYSAVED_EXT INT64U swGetLoadL2DayEnergy(void);
ENERGYSAVED_EXT INT64U swGetSmartLoadDayEnergy(void);
ENERGYSAVED_EXT INT64U swGetSmartLoadL1DayEnergy(void);
ENERGYSAVED_EXT INT64U swGetSmartLoadL2DayEnergy(void);
