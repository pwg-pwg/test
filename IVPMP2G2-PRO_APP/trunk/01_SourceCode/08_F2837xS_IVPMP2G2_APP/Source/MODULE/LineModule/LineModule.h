...
LINE_MODULE void            sRLineL1CurrAdj(INT16U wRLineRms);
LINE_MODULE void            sRLineL1CurrFilter(INT16U wFilter);
LINE_MODULE	void			sRLineL2CurrAdj(INT16U wRLineRms);
LINE_MODULE	void			sRLineL2CurrFilter(INT16U wFilter);
...
LINE_MODULE void sLineL1WattCal(INT32S dwLineWattNewTemp);
LINE_MODULE void sLineL1VACal(INT16U wRVoltRmsNew);
LINE_MODULE void sLineL2WattCal(INT32S dwLineWattNewTemp);
LINE_MODULE void sLineL2VACal(INT16U wRVoltRmsNew);
...
LINE_MODULE void sLineL1VoltAdj(INT16U wVoltRMS);
LINE_MODULE void sLineL2VoltAdj(INT16U wVoltRMS);
LINE_MODULE INT16U  swGetLineL1VoltNew(void);
LINE_MODULE INT16U  swGetLineL2VoltNew(void);
LINE_MODULE INT16U	swGetRLineCurr(void);
LINE_MODULE INT16U	swGetRLineL1Curr(void);
LINE_MODULE INT16U	swGetRLineL2Curr(void);
...
LINE_MODULE INT16U  swGetRLineL1CurrNew(void);
LINE_MODULE INT16U  swGetRLineL2CurrNew(void);
LINE_MODULE INT8U sbGetRLineLossState(void);
LINE_MODULE INT32S sbGetLineWatt(void);
LINE_MODULE INT32S sbGetLineVA(void);
LINE_MODULE INT32S sbGetLineL1Watt(void);
LINE_MODULE INT32S sbGetLineL1VA(void);
LINE_MODULE INT32S sbGetLineL2Watt(void);
LINE_MODULE INT32S sbGetLineL2VA(void);
