...
BUSBATPROT_JOB INT16U g_wBUSSoftVoltTop;
BUSBATPROT_JOB INT16U g_wBUSSoftVoltBotm;
...
BUSBATPROT_JOB INT16S gi_wInvDisChgCurrLimit;
BUSBATPROT_JOB INT16S gi_wInvChgCurrLimit;

BUSBATPROT_JOB SampFilt_TypeDef Pv1Watt;
BUSBATPROT_JOB SampFilt_TypeDef Pv2Watt;
