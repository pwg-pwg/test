...
#define ePowerSaveModePeriod                                    50//50个工频周期
#define ePowerSaveModePWMOnTime                                 20
#define ePowerSaveModeSoftTime                                  10
...
SUPER_JOB INT16U g_wInvNegPowerCnt;
SUPER_JOB INT16U g_uwPowerSaveModeFlag;
SUPER_JOB INT16U g_uwPowerSave1sCnt;
SUPER_JOB INT16U g_wBackupDealyCnt;
SUPER_JOB INT16U g_uwVoltBiasCalFlag;
SUPER_JOB INT16U g_uwGenChgConlFlag;
SUPER_JOB INT16U wGridVoltPeak;
SUPER_JOB INT16U wBatVoltAvg;
SUPER_JOB INT16U g_wInvVoltDcCompFlag;
SUPER_JOB INT16U wAFCIStatusFlag;
SUPER_JOB INT16U wRSDStatusFlag;
...
SUPER_JOB INT16U swGetInvNegPowerCnt(void);
...
SUPER_JOB void sSetInvNegPowerCnt(INT8U bValue);
SUPER_JOB INT16U swGetSineVoltPeak(void);
