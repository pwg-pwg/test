...
extern INT32S  sdwGetInvWattCalFilt(void);
...
{
    swReturnNull,
    swGetLine1VoltReal,      swGetLineVoltReal,     swGetLineCurrReal,     swGetLineL2CurrReal,             //4
    swGetInvVoltSample,       swGetInvVoltReal,      swGetInvLCurrReal,     swGetInvL2CurrReal,             //8
    swGetGenVoltSample,       swGetGenVoltReal,      swGetGenCurrReal,      swGetGenL2CurrReal,    		     //12
    swGetOPVoltReal,          swGetOPL1VoltReal,     swGetOPCurrReal,       swGetOPL2CurrReal,     			 //16
    ...
    swGetPVPBusVoltReal,      swGetBatCurr1Real,     swGetBatCurr2Real,       swGetLine2VoltReal,             //36
    ...
    (pFunc1)Spll_GetSinTheta,  Spll_GetCosTheta,          (pFunc1)swGetRNewSinAmp,   (pFunc1)Spll_GetTheta, //92
