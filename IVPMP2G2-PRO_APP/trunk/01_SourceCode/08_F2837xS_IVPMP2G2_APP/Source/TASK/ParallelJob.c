...
INT16U  swChkOverLoadStatus(void)
{
    ...
    static INT16S wInvLackPhaseRecCnt = 0;
...
//            && wOutputWork == true)
			...
			{
				if(swGetWorkMode() == cBatteryMode || swGetWorkMode() == cLineMode)
				{
					wInvLackPhaseCnt = 10;
				}
				...
				wInvLackPhaseRecCnt = 0;
			}
			else
			{
				if(++wInvLackPhaseRecCnt > 30)
				{
					wInvLackPhaseRecCnt = 0;
					g_uwParaInvLackPhaseFlag = 0;
				}
