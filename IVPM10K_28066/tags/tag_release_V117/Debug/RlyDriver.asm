...
;	C:\ti\ccs613\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\80783\\AppData\\Local\\Temp\\078202 C:\\Users\\80783\\AppData\\Local\\Temp\\078204 
;	C:\ti\ccs613\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\80783\\AppData\\Local\\Temp\\0782012 
	.sect	".text"
...
$C$DW$26	.dwtag  DW_TAG_variable, DW_AT_name("relaytype")
	...
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 24,column 2,is_stmt
        BF        $C$L4,EQ              ; [CPU_] |24| 
        ; branchcc occurs ; [] |24| 
;*** 31	-----------------------    if ( relaytype == 1u ) goto g8;
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 31,column 7,is_stmt
        CMPB      AL,#1                 ; [CPU_] |31| 
        BF        $C$L3,EQ              ; [CPU_] |31| 
        ; branchcc occurs ; [] |31| 
;*** 39	-----------------------    if ( relaytype == 2u ) goto g7;
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 39,column 7,is_stmt
        CMPB      AL,#2                 ; [CPU_] |39| 
        BF        $C$L2,EQ              ; [CPU_] |39| 
        ; branchcc occurs ; [] |39| 
;*** 48	-----------------------    if ( relaytype == 4u ) goto g6;
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 48,column 7,is_stmt
        CMPB      AL,#4                 ; [CPU_] |48| 
        BF        $C$L1,EQ              ; [CPU_] |48| 
        ; branchcc occurs ; [] |48| 
;*** 58	-----------------------    wRlyActionPointerTemp = pointer;
;*** 58	-----------------------    goto g10;
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 58,column 3,is_stmt
        MOV       AL,AH                 ; [CPU_] |58| 
        B         $C$L7,UNC             ; [CPU_] |58| 
        ; branch occurs ; [] |58| 
$C$L1:    
;***	-----------------------g6:
;*** 50	-----------------------    asm("\tSETC\tINTM");
;*** 51	-----------------------    wRlyActionPointerTemp = ((unsigned)((gi_wPLLCtrlPointer*2+gi_wPLLPointThreeSix+2)/gi_wPLLPointerMax*gi_wPLLPointThreeSix)+(gi_wPLLPointThreeSix>>1))%(unsigned)gi_wPLLPointerMax;
	SETC	INTM
        MOVW      DP,#_gi_wPLLCtrlPointer ; [CPU_U] 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 51,column 3,is_stmt
        MOV       ACC,@_gi_wPLLCtrlPointer << #1 ; [CPU_] |51| 
        SPM       #0                    ; [CPU_] 
        MOVW      DP,#_gi_wPLLPointThreeSix ; [CPU_U] 
        ADD       AL,@_gi_wPLLPointThreeSix ; [CPU_] |51| 
        MOVW      DP,#_gi_wPLLPointerMax ; [CPU_U] 
        ADDB      AL,#2                 ; [CPU_] |51| 
        MOV       AH,@_gi_wPLLPointerMax ; [CPU_] |51| 
$C$DW$27	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$27, DW_AT_low_pc(0x00)
	.dwattr $C$DW$27, DW_AT_name("I$$DIV")
	.dwattr $C$DW$27, DW_AT_TI_call
        FFC       XAR7,#I$$DIV          ; [CPU_] |51| 
        ; call occurs [#I$$DIV] ; [] |51| 
        MOVW      DP,#_gi_wPLLPointThreeSix ; [CPU_U] 
        MOV       T,AL                  ; [CPU_] |51| 
        MPY       P,T,@_gi_wPLLPointThreeSix ; [CPU_] |51| 
        MOV       AL,@_gi_wPLLPointThreeSix ; [CPU_] |51| 
        ASR       AL,1                  ; [CPU_] |51| 
        ADD       AL,PL                 ; [CPU_] |51| 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 55,column 2,is_stmt
        B         $C$L6,UNC             ; [CPU_] |55| 
        ; branch occurs ; [] |55| 
$C$L2:    
;***	-----------------------g7:
;*** 42	-----------------------    asm("\tSETC\tINTM");
;*** 43	-----------------------    C$1 = (unsigned)((unsigned long)pointer*4500uL/(unsigned long)wPwmPeriod);
;*** 43	-----------------------    wRlyActionPointerTemp = ((((unsigned)gi_wPLLCtrlPointer+C$1+2u)/(unsigned)gi_wPLLPointThreeSix+1u)*gi_wPLLPointThreeSix-C$1)%(unsigned)gi_wPLLPointerMax;
	SETC	INTM
        MOVW      DP,#_wPwmPeriod       ; [CPU_U] 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 43,column 3,is_stmt
        MOVX      TL,@_wPwmPeriod       ; [CPU_] |43| 
        MOVL      XAR6,XT               ; [CPU_] |43| 
        MOVW      DP,#_gi_wPLLCtrlPointer ; [CPU_U] 
        MOV       T,#4500               ; [CPU_] |43| 
        MPYXU     P,T,AH                ; [CPU_] |43| 
        MOVB      ACC,#0                ; [CPU_] |43| 
        RPT       #31
||     SUBCUL    ACC,XAR6              ; [CPU_] |43| 
        MOV       AL,@_gi_wPLLCtrlPointer ; [CPU_] |43| 
        MOVW      DP,#_gi_wPLLPointThreeSix ; [CPU_U] 
        ADD       AL,PL                 ; [CPU_] |43| 
        ADDB      AL,#2                 ; [CPU_] |43| 
        MOVU      ACC,AL                ; [CPU_] |43| 
        RPT       #15
||     SUBCU     ACC,@_gi_wPLLPointThreeSix ; [CPU_] |43| 
        ADDB      AL,#1                 ; [CPU_] |43| 
        MOV       T,AL                  ; [CPU_] |43| 
        MPY       ACC,T,@_gi_wPLLPointThreeSix ; [CPU_] |43| 
        SUB       AL,PL                 ; [CPU_] |43| 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 47,column 2,is_stmt
        B         $C$L5,UNC             ; [CPU_] |47| 
        ; branch occurs ; [] |47| 
$C$L3:    
;***	-----------------------g8:
;*** 35	-----------------------    asm("\tSETC\tINTM");
;*** 36	-----------------------    wRlyActionPointerTemp = ((unsigned)gi_wPLLPointerMax-(unsigned)((unsigned long)pointer*4500uL/(unsigned long)wPwmPeriod)%(unsigned)gi_wPLLPointerMax)%(unsigned)gi_wPLLPointerMax;
	SETC	INTM
        MOVW      DP,#_wPwmPeriod       ; [CPU_U] 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 36,column 3,is_stmt
        MOVX      TL,@_wPwmPeriod       ; [CPU_] |36| 
        SPM       #0                    ; [CPU_] 
        MOVL      XAR6,XT               ; [CPU_] |36| 
        MOVW      DP,#_gi_wPLLPointerMax ; [CPU_U] 
        MOV       T,#4500               ; [CPU_] |36| 
        MPYXU     P,T,AH                ; [CPU_] |36| 
        MOVB      ACC,#0                ; [CPU_] |36| 
        RPT       #31
||     SUBCUL    ACC,XAR6              ; [CPU_] |36| 
        MOV       AH,@_gi_wPLLPointerMax ; [CPU_] |36| 
        MOV       AL,PL                 ; [CPU_] |36| 
$C$DW$28	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$28, DW_AT_low_pc(0x00)
	.dwattr $C$DW$28, DW_AT_name("U$$MOD")
	.dwattr $C$DW$28, DW_AT_TI_call
        FFC       XAR7,#U$$MOD          ; [CPU_] |36| 
        ; call occurs [#U$$MOD] ; [] |36| 
        MOV       AH,AL                 ; [CPU_] |36| 
        MOV       AL,@_gi_wPLLPointerMax ; [CPU_] |36| 
        SUB       AL,AH                 ; [CPU_] |36| 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 38,column 2,is_stmt
        B         $C$L6,UNC             ; [CPU_] |38| 
        ; branch occurs ; [] |38| 
$C$L4:    
;***	-----------------------g9:
;*** 27	-----------------------    asm("\tSETC\tINTM");
;*** 28	-----------------------    wRlyActionPointerTemp = ((unsigned)gi_wPLLCtrlPointer+(unsigned)((unsigned long)pointer*4500uL/(unsigned long)wPwmPeriod)+1u)%(unsigned)gi_wPLLPointerMax;
	SETC	INTM
        MOVW      DP,#_wPwmPeriod       ; [CPU_U] 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 28,column 3,is_stmt
        MOVX      TL,@_wPwmPeriod       ; [CPU_] |28| 
        MOVL      XAR6,XT               ; [CPU_] |28| 
        MOVW      DP,#_gi_wPLLCtrlPointer ; [CPU_U] 
        MOV       T,#4500               ; [CPU_] |28| 
        MPYXU     P,T,AH                ; [CPU_] |28| 
        MOVB      ACC,#0                ; [CPU_] |28| 
        RPT       #31
||     SUBCUL    ACC,XAR6              ; [CPU_] |28| 
        MOV       AL,PL                 ; [CPU_] |28| 
        ADD       AL,@_gi_wPLLCtrlPointer ; [CPU_] |28| 
        ADDB      AL,#1                 ; [CPU_] |28| 
$C$L5:    
        SPM       #0                    ; [CPU_] 
$C$L6:    
;*** 29	-----------------------    asm("\tCLRC\tINTM");
        MOVW      DP,#_gi_wPLLPointerMax ; [CPU_U] 
        MOV       AH,@_gi_wPLLPointerMax ; [CPU_] |28| 
$C$DW$29	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$29, DW_AT_low_pc(0x00)
	.dwattr $C$DW$29, DW_AT_name("U$$MOD")
	.dwattr $C$DW$29, DW_AT_TI_call
        FFC       XAR7,#U$$MOD          ; [CPU_] |28| 
        ; call occurs [#U$$MOD] ; [] |28| 
	CLRC	INTM
$C$L7:    
;***	-----------------------g10:
;*** 60	-----------------------    if ( wRlyActionPointer == 0xffffu ) goto g14;
        MOVW      DP,#_wRlyActionPointer ; [CPU_U] 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 60,column 2,is_stmt
        CMP       @_wRlyActionPointer,#65535 ; [CPU_] |60| 
        BF        $C$L9,EQ              ; [CPU_] |60| 
        ; branchcc occurs ; [] |60| 
;*** 68	-----------------------    if ( wRlyActionPointer2 == 0xffffu ) goto g13;
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 68,column 7,is_stmt
        CMP       @_wRlyActionPointer2,#65535 ; [CPU_] |68| 
        BF        $C$L8,EQ              ; [CPU_] |68| 
        ; branchcc occurs ; [] |68| 
;*** 78	-----------------------    asm("\tSETC\tINTM");
;*** 79	-----------------------    wRlyActionPointer3 = wRlyActionPointerTemp;
;*** 80	-----------------------    bRlyActionEvent3 = event;
;*** 81	-----------------------    bRlyRelatedTask3 = prio;
	SETC	INTM
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 79,column 3,is_stmt
        MOV       @_wRlyActionPointer3,AL ; [CPU_] |79| 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 80,column 3,is_stmt
        MOV       @_bRlyActionEvent3,AR0 ; [CPU_] |80| 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 81,column 3,is_stmt
        MOV       @_bRlyRelatedTask3,AR2 ; [CPU_] |81| 
...
;***	-----------------------g13:
;*** 70	-----------------------    asm("\tSETC\tINTM");
;*** 71	-----------------------    wRlyActionPointer2 = wRlyActionPointerTemp;
;*** 72	-----------------------    bRlyActionEvent2 = event;
;*** 73	-----------------------    bRlyRelatedTask2 = prio;
	SETC	INTM
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 71,column 3,is_stmt
        MOV       @_wRlyActionPointer2,AL ; [CPU_] |71| 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 72,column 3,is_stmt
        MOV       @_bRlyActionEvent2,AR0 ; [CPU_] |72| 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 73,column 3,is_stmt
        MOV       @_bRlyRelatedTask2,AR2 ; [CPU_] |73| 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 75,column 2,is_stmt
        B         $C$L10,UNC            ; [CPU_] |75| 
        ; branch occurs ; [] |75| 
$C$L9:    
;***	-----------------------g14:
;*** 62	-----------------------    asm("\tSETC\tINTM");
;*** 63	-----------------------    wRlyActionPointer = wRlyActionPointerTemp;
;*** 64	-----------------------    bRlyActionEvent = event;
;*** 65	-----------------------    bRlyRelatedTask = prio;
	SETC	INTM
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 63,column 3,is_stmt
        MOV       @_wRlyActionPointer,AL ; [CPU_] |63| 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 64,column 3,is_stmt
        MOV       @_bRlyActionEvent,AR0 ; [CPU_] |64| 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 65,column 3,is_stmt
        MOV       @_bRlyRelatedTask,AR2 ; [CPU_] |65| 
$C$L10:    
;*** 66	-----------------------    asm("\tCLRC\tINTM");
;***	-----------------------g15:
;***  	-----------------------    return;
...
$C$DW$31	.dwtag  DW_TAG_subprogram, DW_AT_name("sRlyActionDriver")
	...
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 87,column 1,is_stmt,address _sRlyActionDriver
...
;***************************************************************
_sRlyActionDriver:
;*** 88	-----------------------    if ( wRlyActionPointer == 0xffffu || (wRlyActionPointer < pointer || wRlyActionPointer > pointer+1u) && (wRlyActionPointer < (unsigned)gi_wPLLPointerMax || pointer) ) goto g3;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$33	.dwtag  DW_TAG_variable, DW_AT_name("pointer")
	...
	.dwattr $C$DW$33, DW_AT_location[DW_OP_reg16]
        MOVW      DP,#_wRlyActionPointer ; [CPU_U] 
        MOVZ      AR6,AL                ; [CPU_] |87| 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 88,column 2,is_stmt
        CMP       @_wRlyActionPointer,#65535 ; [CPU_] |88| 
        BF        $C$L13,EQ             ; [CPU_] |88| 
        ; branchcc occurs ; [] |88| 
        CMP       AL,@_wRlyActionPointer ; [CPU_] |88| 
        B         $C$L11,HI             ; [CPU_] |88| 
        ; branchcc occurs ; [] |88| 
        MOV       AH,AR6                ; [CPU_] 
        ADDB      AH,#1                 ; [CPU_] |88| 
        CMP       AH,@_wRlyActionPointer ; [CPU_] |88| 
        B         $C$L12,HIS            ; [CPU_] |88| 
        ; branchcc occurs ; [] |88| 
$C$L11:    
        MOVW      DP,#_gi_wPLLPointerMax ; [CPU_U] 
        MOV       AH,@_gi_wPLLPointerMax ; [CPU_] |88| 
        MOVW      DP,#_wRlyActionPointer ; [CPU_U] 
        CMP       AH,@_wRlyActionPointer ; [CPU_] |88| 
        B         $C$L13,HI             ; [CPU_] |88| 
        ; branchcc occurs ; [] |88| 
        CMPB      AL,#0                 ; [CPU_] |88| 
        BF        $C$L13,NEQ            ; [CPU_] |88| 
        ; branchcc occurs ; [] |88| 
$C$L12:    
;*** 93	-----------------------    (OSTCBTbl[(long)bRlyRelatedTask]).OSEvent |= 1u<<bRlyActionEvent;
;*** 93	-----------------------    OSRdyMap |= 1u<<bRlyRelatedTask;
;*** 94	-----------------------    wRlyActionPointer = 0xffffu;
;*** 95	-----------------------    bRlyActionEvent = 255u;
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 93,column 4,is_stmt
        MOV       T,#6                  ; [CPU_] |93| 
        MPYXU     P,T,@_bRlyRelatedTask ; [CPU_] |93| 
        MOVL      XAR4,#_OSTCBTbl       ; [CPU_U] |93| 
        MOVL      ACC,P                 ; [CPU_] |93| 
        MOV       T,@_bRlyActionEvent   ; [CPU_] |93| 
        ADDL      XAR4,ACC              ; [CPU_] |93| 
        MOVB      AH,#1                 ; [CPU_] |93| 
        LSL       AH,T                  ; [CPU_] |93| 
        OR        *+XAR4[4],AH          ; [CPU_] |93| 
        MOVB      AH,#1                 ; [CPU_] |93| 
        MOV       T,@_bRlyRelatedTask   ; [CPU_] |93| 
        MOVW      DP,#_OSRdyMap         ; [CPU_U] 
        LSL       AH,T                  ; [CPU_] |93| 
        OR        @_OSRdyMap,AH         ; [CPU_] |93| 
        MOVW      DP,#_wRlyActionPointer ; [CPU_U] 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 94,column 4,is_stmt
        MOV       @_wRlyActionPointer,#65535 ; [CPU_] |94| 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 95,column 4,is_stmt
        MOVB      @_bRlyActionEvent,#255,UNC ; [CPU_] |95| 
$C$L13:    
;***	-----------------------g3:
;*** 98	-----------------------    if ( wRlyActionPointer2 == 0xffffu || (wRlyActionPointer2 < pointer || wRlyActionPointer2 > pointer+1u) && (wRlyActionPointer2 < (unsigned)gi_wPLLPointerMax || pointer) ) goto g5;
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 98,column 2,is_stmt
        CMP       @_wRlyActionPointer2,#65535 ; [CPU_] |98| 
        BF        $C$L16,EQ             ; [CPU_] |98| 
        ; branchcc occurs ; [] |98| 
        MOV       AL,AR6                ; [CPU_] 
        CMP       AL,@_wRlyActionPointer2 ; [CPU_] |98| 
        B         $C$L14,HI             ; [CPU_] |98| 
        ; branchcc occurs ; [] |98| 
        MOV       AH,AR6                ; [CPU_] 
        ADDB      AH,#1                 ; [CPU_] |98| 
        CMP       AH,@_wRlyActionPointer2 ; [CPU_] |98| 
        B         $C$L15,HIS            ; [CPU_] |98| 
        ; branchcc occurs ; [] |98| 
$C$L14:    
        MOVW      DP,#_gi_wPLLPointerMax ; [CPU_U] 
        MOV       AH,@_gi_wPLLPointerMax ; [CPU_] |98| 
        MOVW      DP,#_wRlyActionPointer2 ; [CPU_U] 
        CMP       AH,@_wRlyActionPointer2 ; [CPU_] |98| 
        B         $C$L16,HI             ; [CPU_] |98| 
        ; branchcc occurs ; [] |98| 
        CMPB      AL,#0                 ; [CPU_] |98| 
        BF        $C$L16,NEQ            ; [CPU_] |98| 
        ; branchcc occurs ; [] |98| 
$C$L15:    
;*** 103	-----------------------    (OSTCBTbl[(long)bRlyRelatedTask2]).OSEvent |= 1u<<bRlyActionEvent2;
;*** 103	-----------------------    OSRdyMap |= 1u<<bRlyRelatedTask2;
;*** 104	-----------------------    wRlyActionPointer2 = 0xffffu;
;*** 105	-----------------------    bRlyActionEvent2 = 255u;
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 103,column 4,is_stmt
        MOV       T,#6                  ; [CPU_] |103| 
        MPYXU     P,T,@_bRlyRelatedTask2 ; [CPU_] |103| 
        MOVL      XAR4,#_OSTCBTbl       ; [CPU_U] |103| 
        MOVL      ACC,P                 ; [CPU_] |103| 
        MOV       T,@_bRlyActionEvent2  ; [CPU_] |103| 
        ADDL      XAR4,ACC              ; [CPU_] |103| 
        MOVB      AH,#1                 ; [CPU_] |103| 
        LSL       AH,T                  ; [CPU_] |103| 
        OR        *+XAR4[4],AH          ; [CPU_] |103| 
        MOVB      AH,#1                 ; [CPU_] |103| 
        MOV       T,@_bRlyRelatedTask2  ; [CPU_] |103| 
        MOVW      DP,#_OSRdyMap         ; [CPU_U] 
        LSL       AH,T                  ; [CPU_] |103| 
        OR        @_OSRdyMap,AH         ; [CPU_] |103| 
        MOVW      DP,#_wRlyActionPointer2 ; [CPU_U] 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 104,column 4,is_stmt
        MOV       @_wRlyActionPointer2,#65535 ; [CPU_] |104| 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 105,column 4,is_stmt
        MOVB      @_bRlyActionEvent2,#255,UNC ; [CPU_] |105| 
$C$L16:    
;***	-----------------------g5:
;*** 108	-----------------------    if ( wRlyActionPointer3 == 0xffffu || (wRlyActionPointer3 < pointer || wRlyActionPointer3 > pointer+1u) && (wRlyActionPointer3 < (unsigned)gi_wPLLPointerMax || pointer) ) goto g7;
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 108,column 2,is_stmt
        CMP       @_wRlyActionPointer3,#65535 ; [CPU_] |108| 
        BF        $C$L19,EQ             ; [CPU_] |108| 
        ; branchcc occurs ; [] |108| 
        MOV       AL,AR6                ; [CPU_] 
        CMP       AL,@_wRlyActionPointer3 ; [CPU_] |108| 
        B         $C$L17,HI             ; [CPU_] |108| 
        ; branchcc occurs ; [] |108| 
        MOV       AH,AR6                ; [CPU_] 
        ADDB      AH,#1                 ; [CPU_] |108| 
        CMP       AH,@_wRlyActionPointer3 ; [CPU_] |108| 
        B         $C$L18,HIS            ; [CPU_] |108| 
        ; branchcc occurs ; [] |108| 
$C$L17:    
        MOVW      DP,#_gi_wPLLPointerMax ; [CPU_U] 
        MOV       AH,@_gi_wPLLPointerMax ; [CPU_] |108| 
        MOVW      DP,#_wRlyActionPointer3 ; [CPU_U] 
        CMP       AH,@_wRlyActionPointer3 ; [CPU_] |108| 
        B         $C$L19,HI             ; [CPU_] |108| 
        ; branchcc occurs ; [] |108| 
        CMPB      AL,#0                 ; [CPU_] |108| 
        BF        $C$L19,NEQ            ; [CPU_] |108| 
        ; branchcc occurs ; [] |108| 
$C$L18:    
;*** 113	-----------------------    (OSTCBTbl[(long)bRlyRelatedTask3]).OSEvent |= 1u<<bRlyActionEvent3;
;*** 113	-----------------------    OSRdyMap |= 1u<<bRlyRelatedTask3;
;*** 114	-----------------------    wRlyActionPointer3 = 0xffffu;
;*** 115	-----------------------    bRlyActionEvent3 = 255u;
;***	-----------------------g7:
;***  	-----------------------    return;
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 113,column 4,is_stmt
        MOV       T,#6                  ; [CPU_] |113| 
        MOVL      XAR4,#_OSTCBTbl       ; [CPU_U] |113| 
        MPYXU     ACC,T,@_bRlyRelatedTask3 ; [CPU_] |113| 
        MOV       T,@_bRlyActionEvent3  ; [CPU_] |113| 
        ADDL      XAR4,ACC              ; [CPU_] |113| 
        MOVB      AL,#1                 ; [CPU_] |113| 
        LSL       AL,T                  ; [CPU_] |113| 
        OR        *+XAR4[4],AL          ; [CPU_] |113| 
        MOVB      AL,#1                 ; [CPU_] |113| 
        MOV       T,@_bRlyRelatedTask3  ; [CPU_] |113| 
        MOVW      DP,#_OSRdyMap         ; [CPU_U] 
        LSL       AL,T                  ; [CPU_] |113| 
        OR        @_OSRdyMap,AL         ; [CPU_] |113| 
        MOVW      DP,#_wRlyActionPointer3 ; [CPU_U] 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 114,column 4,is_stmt
        MOV       @_wRlyActionPointer3,#65535 ; [CPU_] |114| 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 115,column 4,is_stmt
        MOVB      @_bRlyActionEvent3,#255,UNC ; [CPU_] |115| 
$C$L19:    
$C$DW$34	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$31, DW_AT_TI_end_line(0x76)
