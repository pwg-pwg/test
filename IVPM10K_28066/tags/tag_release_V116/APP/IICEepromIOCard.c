...
INT16U   swGetEERestartInvCnt(void)
{
    return(uEepromCfg2.EepromStructCfg2.wEERestartInvCnt);
}

void    sSetEERestartInvCnt(INT16U wValue)
{
   uEepromCfg2.EepromStructCfg2.wEERestartInvCnt = wValue;
}
