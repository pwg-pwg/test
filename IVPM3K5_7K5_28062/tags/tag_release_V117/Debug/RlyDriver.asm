...
;* Date/Time created: Sat Jul 27 09:07:40 2024                 *
;***************************************************************
...
;	C:\ti\ccs613\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\80783\\AppData\\Local\\Temp\\373362 C:\\Users\\80783\\AppData\\Local\\Temp\\373364 
;	C:\ti\ccs613\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\80783\\AppData\\Local\\Temp\\3733612 
	.sect	".text"
...
;***	-----------------------g6:
;*** 50	-----------------------    asm("\tSETC\tINTM");
;*** 51	-----------------------    wRlyActionPointerTemp = ((unsigned)((gi_wPLLPointer*2+gi_wPLLPointThreeSix+2)/gi_wPLLPointerMax*gi_wPLLPointThreeSix)+(gi_wPLLPointThreeSix>>1))%(unsigned)gi_wPLLPointerMax;
	SETC	INTM
        MOVW      DP,#_gi_wPLLPointer   ; [CPU_U] 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 51,column 3,is_stmt
        MOV       ACC,@_gi_wPLLPointer << #1 ; [CPU_] |51| 
        SPM       #0                    ; [CPU_] 
...
;*** 43	-----------------------    wRlyActionPointerTemp = ((((unsigned)gi_wPLLPointer+C$1+2u)/(unsigned)gi_wPLLPointThreeSix+1u)*gi_wPLLPointThreeSix-C$1)%(unsigned)gi_wPLLPointerMax;
	SETC	INTM
...
||     SUBCUL    ACC,XAR6              ; [CPU_] |43| 
        MOV       AL,@_gi_wPLLPointer   ; [CPU_] |43| 
        MOVW      DP,#_gi_wPLLPointThreeSix ; [CPU_U] 
        ADD       AL,PL                 ; [CPU_] |43| 
        ADDB      AL,#2                 ; [CPU_] |43| 
        MOVU      ACC,AL                ; [CPU_] |43| 
...
;***	-----------------------g9:
;*** 27	-----------------------    asm("\tSETC\tINTM");
;*** 28	-----------------------    wRlyActionPointerTemp = ((unsigned)gi_wPLLPointer+(unsigned)((unsigned long)pointer*4500uL/(unsigned long)wPwmPeriod)+1u)%(unsigned)gi_wPLLPointerMax;
	SETC	INTM
        MOVW      DP,#_wPwmPeriod       ; [CPU_U] 
...
||     SUBCUL    ACC,XAR6              ; [CPU_] |28| 
        MOV       AL,PL                 ; [CPU_] |28| 
        ADD       AL,@_gi_wPLLPointer   ; [CPU_] |28| 
        ADDB      AL,#1                 ; [CPU_] |28| 
$C$L5:    
        SPM       #0                    ; [CPU_] 
$C$L6:    
...
;***************************************************************
_sRlyActionDriver:
;*** 88	-----------------------    if ( wRlyActionPointer == 0xffffu || (wRlyActionPointer < pointer || wRlyActionPointer > pointer+2u) && (wRlyActionPointer < (unsigned)gi_wPLLPointerMax || pointer) ) goto g3;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$L13:    
;***	-----------------------g3:
;*** 98	-----------------------    if ( wRlyActionPointer2 == 0xffffu || (wRlyActionPointer2 < pointer || wRlyActionPointer2 > pointer+2u) && (wRlyActionPointer2 < (unsigned)gi_wPLLPointerMax || pointer) ) goto g5;
...
$C$L16:    
;***	-----------------------g5:
;*** 108	-----------------------    if ( wRlyActionPointer3 == 0xffffu || (wRlyActionPointer3 < pointer || wRlyActionPointer3 > pointer+2u) && (wRlyActionPointer3 < (unsigned)gi_wPLLPointerMax || pointer) ) goto g7;
