...
APP/BusBatProt.obj: ../APP/BusBatProt.C $(GEN_OPTS) $(GEN_HDRS)
	...
	"C:/ti/ccsv6/tools/compiler/ti-cgt-c2000_6.1.0/bin/cl2000" -v28 -ml -O2 -g --optimize_with_debug=on --include_path="C:/ti/ccsv6/tools/compiler/ti-cgt-c2000_6.1.0/include" --include_path="/packages/ti/xdais" --include_path="D:/new/save1/Update120/IVPM3K5_7K5-V118/FLS-GPINV-IVPM3.5-7.5K_V118" --define="_DEBUG" --define="LARGE_MODEL" --quiet --display_error_number --diag_wrap=off --src_interlist --output_all_syms --preproc_with_compile --preproc_dependency="APP/BusBatProt.d" --obj_directory="APP" $(GEN_OPTS__FLAG) "$<"
