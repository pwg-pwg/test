...
;* Date/Time created: Mon Sep 04 14:43:30 2023                 *
;***************************************************************
...
;	D:\ccs software\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\Lin\\AppData\\Local\\Temp\\184682 C:\\Users\\Lin\\AppData\\Local\\Temp\\184684 
;	D:\ccs software\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\Lin\\AppData\\Local\\Temp\\1846812 
	.sect	".text"
	.global	_swGetVref
...
$C$DW$287	.dwtag  DW_TAG_variable, DW_AT_name("$O$U186")
	.dwattr $C$DW$287, DW_AT_TI_symbol_name("$O$U186")
	.dwattr $C$DW$287, DW_AT_type(*$C$DW$T$10)
	.dwattr $C$DW$287, DW_AT_location[DW_OP_reg0]
;* AL    assigned to $O$U186
$C$DW$288	.dwtag  DW_TAG_variable, DW_AT_name("$O$U186")
	.dwattr $C$DW$288, DW_AT_TI_symbol_name("$O$U186")
...
;*** 307	-----------------------    if ( !(*(&GpioDataRegs+1)&0x800u) ) goto g14;
        ...
        ; branchcc occurs ; [] |307| 
;*** 309	-----------------------    gi_wROPShareCurrCntl = C$12 = (int)((((long)gi_wROPShareCurrSample*485L>>5)+5L)/10L);
...
;***  	-----------------------    return;
	...
	.dwpsn	file "../MODULE/InverterCntl/InvCntModule.C",line 830,column 2,is_stmt
        MOVB      @_g_wFBKCurrentForward,#20,UNC ; [CPU_] |830| 
...
$C$DW$324	.dwtag  DW_TAG_variable, DW_AT_name("$O$U194")
	.dwattr $C$DW$324, DW_AT_TI_symbol_name("$O$U194")
	.dwattr $C$DW$324, DW_AT_type(*$C$DW$T$10)
	.dwattr $C$DW$324, DW_AT_location[DW_OP_reg12]
;* AR5   assigned to $O$U197
$C$DW$325	.dwtag  DW_TAG_variable, DW_AT_name("$O$U197")
	.dwattr $C$DW$325, DW_AT_TI_symbol_name("$O$U197")
...
$C$L49:    
;***	-----------------------g25:
;*** 962	-----------------------    g_wFBR_Is_P = C$8 = -(int)((long)gi_wRInvCurrSample*2475L>>9);
...
;*** 977	-----------------------    if ( y$56 > 4086 ) goto g28;
	...
	.dwpsn	file "../MODULE/InverterCntl/InvCntModule.C",line 962,column 2,is_stmt
        MPY       ACC,@_gi_wRInvCurrSample,#2475 ; [CPU_] |962| 
        MOVW      DP,#_g_wFBR_Is_P      ; [CPU_U] 
        SFR       ACC,9                 ; [CPU_] |962| 
        NEG       AL                    ; [CPU_] |962| 
...
;*** 982	-----------------------    U$194 = g_wPwmPeriod-10;
;*** 982	-----------------------    if ( C$5 <= U$194 ) goto g31;
        MOVW      DP,#_g_wPwmPeriod     ; [CPU_U] 
...
;***	-----------------------g31:
;*** 983	-----------------------    U$197 = -U$194;
;*** 983	-----------------------    if ( g_wFBR_Duty >= U$197 ) goto g33;
        MOV       AL,AR4                ; [CPU_] 
        MOVW      DP,#_g_wFBR_Duty      ; [CPU_U] 
...
$C$L54:    
;***	-----------------------g35:
;*** 990	-----------------------    if ( g_wFBPWM >= U$197 ) goto g37;
        MOV       AL,AR5                ; [CPU_] 
...
;***************************************************************
_sBuckSoftProc:
;*** 779	-----------------------    wTemp = g_uwBatVoltAvg*7u+100u;
