...
;* Date/Time created: Wed Jun 08 14:38:18 2022                 *
;***************************************************************
...
;	C:\Work\Software\CCS5.4\ccsv5\tools\compiler\c2000_6.1.3\bin\opt2000.exe C:\\Users\\Daily\\AppData\\Local\\Temp\\029084 C:\\Users\\Daily\\AppData\\Local\\Temp\\029086 
;	C:\Work\Software\CCS5.4\ccsv5\tools\compiler\c2000_6.1.3\bin\ac2000.exe -@C:\\Users\\Daily\\AppData\\Local\\Temp\\0290814 
	.sect	".text"
...
;** 1537	-----------------------    return swPartFanSpeedCal((int)g_uwSolarPower1Avg, 30, 0, (int)g_uwSolarCurr1Avg, 90, 0, g_wSolarBSTTemp, 1000, (-485));
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
        ADDB      SP,#6                 ; [CPU_U] 
...
$C$DW$241	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$241, DW_AT_name("Z:\02_VmwareShare\Project\01_HFInverter\01_IVEM\01_IVEM5048\01_IVEM5048Ver28066\01_MainCode\trunk\IVEM5048\Debug\BusBatProt.asm:$C$L4:1:1654670298")
...
$C$DW$244	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$244, DW_AT_name("Z:\02_VmwareShare\Project\01_HFInverter\01_IVEM\01_IVEM5048\01_IVEM5048Ver28066\01_MainCode\trunk\IVEM5048\Debug\BusBatProt.asm:$C$L5:2:1654670298")
...
;** 1544	-----------------------    return swPartFanSpeedCal(ABS((int)g_dwInvWatt), 30, 0, (int)g_uwRInvCurr, 610, 0, g_wInvTemp, 1000, (-485));
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
        ADDB      SP,#6                 ; [CPU_U] 
...
$C$DW$264	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$264, DW_AT_name("Z:\02_VmwareShare\Project\01_HFInverter\01_IVEM\01_IVEM5048\01_IVEM5048Ver28066\01_MainCode\trunk\IVEM5048\Debug\BusBatProt.asm:$C$L13:1:1654670298")
...
$C$DW$267	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$267, DW_AT_name("Z:\02_VmwareShare\Project\01_HFInverter\01_IVEM\01_IVEM5048\01_IVEM5048Ver28066\01_MainCode\trunk\IVEM5048\Debug\BusBatProt.asm:$C$L14:2:1654670298")
...
;** 1551	-----------------------    return swPartFanSpeedCal(0, 0, 0, ABS(g_wDCDCCurrAvg), 145, 0, g_wConvertTemp, 1000, (-485));
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
        ADDB      SP,#6                 ; [CPU_U] 
	...
	.dwpsn	file "../APP/BusBatProt.C",line 1551,column 2,is_stmt
        ...
        MOV       *-SP[4],#1000         ; [CPU_] |1551| 
        ABS       ACC                   ; [CPU_] |1551| 
        MOVZ      AR5,AL                ; [CPU_] |1551| 
        MOVB      AH,#0                 ; [CPU_] |1551| 
        MOV       *-SP[5],#-485         ; [CPU_] |1551| 
        MOVB      AL,#0                 ; [CPU_] |1551| 
...
$C$DW$360	.dwtag  DW_TAG_variable, DW_AT_name("wDisChgCurLimit")
	...
	.dwpsn	file "../APP/BusBatProt.C",line 446,column 2,is_stmt
        MOV       @_g_wDischgCurrLimit,#2200 ; [CPU_] |446| 
	...
	.dwpsn	file "../APP/BusBatProt.C",line 448,column 2,is_stmt
        ...
        ; branchcc occurs ; [] |448| 
;*** 450	-----------------------    if ( (C$2 = g_wBatAgeDischgCurr*10) >= 2200 ) goto g4;
...
$C$L109:    
;***	-----------------------g6:
;*** 461	-----------------------    if ( (wDisChgCurLimit = (g_wDischgCurrLimit<<3)/7) <= 2400 ) goto g8;
        MOVW      DP,#_g_wDischgCurrLimit ; [CPU_U] 
	.dwpsn	file "../APP/BusBatProt.C",line 461,column 2,is_stmt
        MOV       ACC,@_g_wDischgCurrLimit << #3 ; [CPU_] |461| 
        MOVB      AH,#7                 ; [CPU_] |461| 
...
;***************************************************************
_sBatProtChgMode:
;** 1709	-----------------------    if ( g_uwLiBatActing || g_uwBatVoltAvg < (unsigned)g_wBatVoltRef+4u && g_wBatRealVoltOverFlg == 0 ) goto g12;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
        ADDB      SP,#2                 ; [CPU_U] 
...
;*** 413	-----------------------    C$3 = 500000L/s_dwBatVoltAvg;
...
;*** 427	-----------------------    if ( (wChgCurLimit = (g_wChgCurrLimit<<3)/7) <= 2400 ) goto g26;
        MOVW      DP,#_s_dwChgCurrDlt$2 ; [CPU_U] 
	...
	.dwpsn	file "../APP/BusBatProt.C",line 427,column 2,is_stmt
        MOV       ACC,@_g_wChgCurrLimit << #3 ; [CPU_] |427| 
        MOVB      AH,#7                 ; [CPU_] |427| 
...
$C$L153:    
;***	-----------------------g5:
;** 1033	-----------------------    if ( swGetEEBatUnderVolt() == 420u ) goto g7;
...
$C$L154:    
;***	-----------------------g7:
;** 1039	-----------------------    if ( swGetEEBatFloatVolt() == 540u ) goto g9;
...
;** 1046	-----------------------    if ( swGetEEBatCVVolt() == 564u ) goto g14;
...
;** 1054	-----------------------    if ( swGetEEBatCVVolt() != 584u ) goto g15;
...
$C$L162:    
;***	-----------------------g20:
;** 1080	-----------------------    g_wBatUnderVolt = (g_wOPPercent >= 50) ? 420 : 430;
	...
	.dwpsn	file "../APP/BusBatProt.C",line 1080,column 4,is_stmt
        ...
        MOV       AL,#420               ; [CPU_] |1080| 
        B         $C$L165,UNC           ; [CPU_] |1080| 
        ; branch occurs ; [] |1080| 
$C$L163:    
        MOV       AL,#430               ; [CPU_] |1080| 
...
;** 1114	-----------------------    y$375 = (C$1[1]&0xffu)+400;
;** 1114	-----------------------    g_wBatUnderVolt = y$375;
;** 1115	-----------------------    y$376 = (*&g_strSysBMSCtrlInfo&0xffu)+400;
;** 1115	-----------------------    g_wBatCVVolt = y$376;
;** 1116	-----------------------    y$377 = (*&g_strSysBMSCtrlInfo>>8)+400;
;** 1116	-----------------------    g_wBatFloatVolt = y$377;
;** 1117	-----------------------    if ( y$375 > 540 ) goto g26;
	.dwpsn	file "../APP/BusBatProt.C",line 1114,column 3,is_stmt
        MOV       AL,*+XAR4[1]          ; [CPU_] |1114| 
        MOVW      DP,#_g_wBatUnderVolt  ; [CPU_U] 
        ANDB      AL,#0xff              ; [CPU_] |1114| 
        ADD       AL,#400               ; [CPU_] |1114| 
        MOV       AH,AL                 ; [CPU_] |1114| 
...
;*** 843	-----------------------    if ( g_wBatChgStage != 2 ) goto g21;
	...
	.dwpsn	file "../APP/BusBatProt.C",line 843,column 9,is_stmt
        ...
        ; branchcc occurs ; [] |843| 
;*** 845	-----------------------    if ( g_uwBatVoltAvg >= (unsigned)g_wBatFloatVolt-40u || *&g_uniSysChgStatus&0x8000u ) goto g20;
        MOVW      DP,#_g_wBatFloatVolt  ; [CPU_U] 
...
$C$L188:    
;***	-----------------------g37:
;*** 925	-----------------------    wBatVoltRefTemp = __min(g_wBatFloatVolt, 480);
...
$C$DW$517	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$517, DW_AT_name("Z:\02_VmwareShare\Project\01_HFInverter\01_IVEM\01_IVEM5048\01_IVEM5048Ver28066\01_MainCode\trunk\IVEM5048\Debug\BusBatProt.asm:$C$L194:1:1654670298")
