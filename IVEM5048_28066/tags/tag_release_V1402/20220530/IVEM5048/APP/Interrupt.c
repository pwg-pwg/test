...
//	hoCHGLED^=1;
	...
	gi_wPDCDCCurr1Sample	=	ADCRESULT3	- 2048 + gi_wPDCDCCurrSampleBias;
	gi_wPDCDCAvgCurrSample	=	ADCRESULT4  - 2048 + gi_wPDCDCAvgCurrSampleBias;
	...
	gi_wConvertTempSample	=	ADCRESULT14;
	gi_wROPCurr1Sample 		= 	ADCRESULT15 - 2048 - gi_wROPCurrSampleBias;

	if(mChkADCSWITCH1On())
	{
		hoADCSWITCH1Off;
		gi_wFanClk1VoltSample	=	ADCRESULT11;
		gi_wFanClk2VoltSample	=	ADCRESULT12;
		gi_wSwitchOnVoltSample 	=	ADCRESULT13;
	}
	else
	{
		hoADCSWITCH1On;
		gi_wSolarBSTTempSample 	= 	ADCRESULT11;
		gi_wInvTempSample		=	ADCRESULT12;
		gi_wInnelTempSample		=	ADCRESULT13;
	}

//	if(++gi_wADSwitchDlyCnt > 2)
//	{
//		gi_wADSwitchDlyCnt = 0;
//		hoADCSWITCH1TOG;
//	}
