...
;* Date/Time created: Mon Sep 04 14:43:01 2023                 *
;***************************************************************
...
;	D:\ccs software\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\Lin\\AppData\\Local\\Temp\\205482 C:\\Users\\Lin\\AppData\\Local\\Temp\\205484 
;	D:\ccs software\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\Lin\\AppData\\Local\\Temp\\2054812 
	.sect	".text"
...
;** 1545	-----------------------    return swPartFanSpeedCal((int)g_uwSolarPower1Avg, 30, 0, (int)g_uwSolarCurr1Avg, 90, 0, g_wSolarBSTTemp, 1000, (-485));
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
        ADDB      SP,#6                 ; [CPU_U] 
...
$C$DW$243	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$243, DW_AT_name("D:\CCS_Code\Battery Fast Low\20230904 AddFunction\IVEM5048_28066_V13.06\IVEM5048\Debug\BusBatProt.asm:$C$L4:1:1693809781")
...
$C$DW$246	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$246, DW_AT_name("D:\CCS_Code\Battery Fast Low\20230904 AddFunction\IVEM5048_28066_V13.06\IVEM5048\Debug\BusBatProt.asm:$C$L5:2:1693809781")
...
;** 1552	-----------------------    return swPartFanSpeedCal(ABS((int)g_dwInvWatt), 30, 0, (int)g_uwRInvCurr, 610, 0, g_wInvTemp, 1000, (-485));
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
        ADDB      SP,#6                 ; [CPU_U] 
...
$C$DW$266	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$266, DW_AT_name("D:\CCS_Code\Battery Fast Low\20230904 AddFunction\IVEM5048_28066_V13.06\IVEM5048\Debug\BusBatProt.asm:$C$L13:1:1693809781")
...
$C$DW$269	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$269, DW_AT_name("D:\CCS_Code\Battery Fast Low\20230904 AddFunction\IVEM5048_28066_V13.06\IVEM5048\Debug\BusBatProt.asm:$C$L14:2:1693809781")
...
;** 1559	-----------------------    return swPartFanSpeedCal(0, 0, 0, ABS(g_wDCDCCurrAvg), 145, 0, g_wConvertTemp, 1000, (-485));
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
        ADDB      SP,#6                 ; [CPU_U] 
	...
	.dwpsn	file "../APP/BusBatProt.C",line 1559,column 2,is_stmt
        ...
        MOV       *-SP[4],#1000         ; [CPU_] |1559| 
        ABS       ACC                   ; [CPU_] |1559| 
        MOVZ      AR5,AL                ; [CPU_] |1559| 
        MOVB      AH,#0                 ; [CPU_] |1559| 
        MOV       *-SP[5],#-485         ; [CPU_] |1559| 
        MOVB      AL,#0                 ; [CPU_] |1559| 
...
$C$DW$367	.dwtag  DW_TAG_variable, DW_AT_name("wDisChgCurLimit")
	...
	.dwpsn	file "../APP/BusBatProt.C",line 451,column 2,is_stmt
        MOV       @_g_wDischgCurrLimit,#2200 ; [CPU_] |451| 
	...
	.dwpsn	file "../APP/BusBatProt.C",line 453,column 2,is_stmt
        ...
        ; branchcc occurs ; [] |453| 
;*** 455	-----------------------    if ( (C$2 = g_wBatAgeDischgCurr*10) >= 2200 ) goto g4;
...
$C$L110:    
;***	-----------------------g6:
;*** 466	-----------------------    if ( (wDisChgCurLimit = (g_wDischgCurrLimit<<3)/7) <= 2400 ) goto g8;
        MOVW      DP,#_g_wDischgCurrLimit ; [CPU_U] 
	.dwpsn	file "../APP/BusBatProt.C",line 466,column 2,is_stmt
        MOV       ACC,@_g_wDischgCurrLimit << #3 ; [CPU_] |466| 
        MOVB      AH,#7                 ; [CPU_] |466| 
...
;***************************************************************
_sBatProtChgMode:
;** 1717	-----------------------    if ( g_uwLiBatActing || g_uwBatVoltAvg < (unsigned)g_wBatVoltRef+4u && g_wBatRealVoltOverFlg == 0 ) goto g12;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
        ADDB      SP,#2                 ; [CPU_U] 
...
;*** 418	-----------------------    C$3 = 500000L/s_dwBatVoltAvg;
...
;*** 432	-----------------------    if ( (wChgCurLimit = (g_wChgCurrLimit<<3)/7) <= 2400 ) goto g26;
        MOVW      DP,#_s_dwChgCurrDlt$2 ; [CPU_U] 
	...
	.dwpsn	file "../APP/BusBatProt.C",line 432,column 2,is_stmt
        MOV       ACC,@_g_wChgCurrLimit << #3 ; [CPU_] |432| 
        MOVB      AH,#7                 ; [CPU_] |432| 
...
$C$L154:    
;***	-----------------------g5:
;** 1041	-----------------------    if ( swGetEEBatUnderVolt() == 420u ) goto g7;
...
$C$L155:    
;***	-----------------------g7:
;** 1047	-----------------------    if ( swGetEEBatFloatVolt() == 540u ) goto g9;
...
;** 1054	-----------------------    if ( swGetEEBatCVVolt() == 564u ) goto g14;
...
;** 1062	-----------------------    if ( swGetEEBatCVVolt() != 584u ) goto g15;
...
$C$L163:    
;***	-----------------------g20:
;** 1088	-----------------------    g_wBatUnderVolt = (g_wOPPercent >= 50) ? 420 : 430;
	...
	.dwpsn	file "../APP/BusBatProt.C",line 1088,column 4,is_stmt
        ...
        MOV       AL,#420               ; [CPU_] |1088| 
        B         $C$L166,UNC           ; [CPU_] |1088| 
        ; branch occurs ; [] |1088| 
$C$L164:    
        MOV       AL,#430               ; [CPU_] |1088| 
...
;*** 851	-----------------------    if ( g_wBatChgStage != 2 ) goto g21;
	...
	.dwpsn	file "../APP/BusBatProt.C",line 851,column 9,is_stmt
        ...
        ; branchcc occurs ; [] |851| 
;*** 853	-----------------------    if ( g_uwBatVoltAvg >= (unsigned)g_wBatFloatVolt-40u || *&g_uniSysChgStatus&0x8000u ) goto g20;
        MOVW      DP,#_g_wBatFloatVolt  ; [CPU_U] 
...
$C$L189:    
;***	-----------------------g37:
;*** 933	-----------------------    wBatVoltRefTemp = __min(g_wBatFloatVolt, 480);
...
$C$DW$526	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$526, DW_AT_name("D:\CCS_Code\Battery Fast Low\20230904 AddFunction\IVEM5048_28066_V13.06\IVEM5048\Debug\BusBatProt.asm:$C$L195:1:1693809781")
