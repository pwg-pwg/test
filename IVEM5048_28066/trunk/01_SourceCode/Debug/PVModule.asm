...
;* Date/Time created: Mon Sep 04 14:43:34 2023                 *
;***************************************************************
...
;	D:\ccs software\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\Lin\\AppData\\Local\\Temp\\184482 C:\\Users\\Lin\\AppData\\Local\\Temp\\184484 
;	D:\ccs software\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\Lin\\AppData\\Local\\Temp\\1844812 
	.sect	".text"
	.global	_swMPPTTrack
...
;** 1198	-----------------------    dwSolarPower1Limit = 6000L;
;** 1199	-----------------------    if ( dwSolarPowerMax > 60000L ) goto g29;
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 1198,column 4,is_stmt
        MOVL      XAR4,#6000            ; [CPU_U] |1198| 
...
;** 1157	-----------------------    dwSolarPower2Limit = 60000L;
...
;** 1180	-----------------------    if ( dwSolarPower1Limit <= 60000L ) goto g27;
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 1180,column 9,is_stmt
        MOVL      XAR4,#60000           ; [CPU_U] |1180| 
...
$C$L62:    
;***	-----------------------g25:
;** 1180	-----------------------    dwSolarPower1Limit = 60000L;
;** 1180	-----------------------    goto g27;
...
;** 1182	-----------------------    if ( dwSolarPower2Limit <= 60000L ) goto g32;
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 1182,column 9,is_stmt
        MOVL      XAR4,#60000           ; [CPU_U] |1182| 
...
$C$L66:    
;***	-----------------------g31:
;** 1188	-----------------------    dwSolarPower1Limit = __lmin(60000L, dwSolarPowerMax);
;** 1194	-----------------------    dwSolarPower2Limit = 6000L;
        CLRC      SXM                   ; [CPU_] 
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 1188,column 5,is_stmt
        MOV       ACC,#60000            ; [CPU_] |1188| 
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 1194,column 4,is_stmt
        MOVL      XAR4,#6000            ; [CPU_U] |1194| 
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 1188,column 5,is_stmt
...
;** 1232	-----------------------    ((long)g_uwSolarPower1Avg > U$120+500L) ? (wSolarLimitCurrTemp = wSolarLimitCurrTemp-10) : (wSolarLimitCurrTemp = ((long)g_uwSolarPower1Avg > U$120+300L) ? wSolarLimitCurrTemp-5 : ((long)g_uwSolarPower1Avg > U$120+200L) ? wSolarLimitCurrTemp-2 : ((long)g_uwSolarPower1Avg > U$120 || g_uwSolarCurr1Avg > 2000u) ? wSolarLimitCurrTemp-1 : wSolarLimitCurrTemp+1);
        MOVW      DP,#_g_wPv1CurrLimit  ; [CPU_U] 
...
$C$L73:    
        ...
        ; branchcc occurs ; [] |1232| 
        CMP       @_g_uwSolarCurr1Avg,#2000 ; [CPU_] |1232| 
...
;** 1275	-----------------------    U$155 = dwSolarPower2Limit/10L;
;** 1277	-----------------------    ((long)g_uwSolarPower2Avg > U$155+500L) ? (wSolarLimitCurrTemp = wSolarLimitCurrTemp-10) : (wSolarLimitCurrTemp = ((long)g_uwSolarPower2Avg > U$155+300L) ? wSolarLimitCurrTemp-5 : ((long)g_uwSolarPower2Avg > U$155+200L) ? wSolarLimitCurrTemp-2 : ((long)g_uwSolarPower2Avg > U$155 || g_uwSolarCurr2Avg > 2000u) ? wSolarLimitCurrTemp-1 : wSolarLimitCurrTemp+1);
	SETC	INTM
        MOVW      DP,#_g_wPv1CurrLimit  ; [CPU_U] 
...
$C$L83:    
        ...
        ; branchcc occurs ; [] |1277| 
        CMP       @_g_uwSolarCurr2Avg,#2000 ; [CPU_] |1277| 
...
;** 1319	-----------------------    g_wSolarPower2Limit = U$155;
;***  	-----------------------    return;
	SETC	INTM
...
$C$L121:    
;***	-----------------------g6:
;*** 949	-----------------------    y$14 = (int)((long)g_wBusVoltVerr*25L>>3);
...
;*** 952	-----------------------    if ( C$7 > 300 ) goto g9;
	.dwpsn	file "../MODULE/PVModule/PVModule.C",line 949,column 3,is_stmt
        MPY       ACC,@_g_wBusVoltVerr,#25 ; [CPU_] |949| 
        SFR       ACC,3                 ; [CPU_] |949| 
