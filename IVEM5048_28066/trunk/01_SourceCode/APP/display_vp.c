...
void sSettingPageBatUnderVolt(INT8U* pubOprtStep, INT16S* pwChangeValue)
{
	...
	//if(fBMSConnectFlg)
	//{
		//if(mBMSBatCutOffVolt < swGetEEBatUnderVolt())
		//{
			//wSettingValue = swGetEEBatUnderVolt();
		//}
		//else
		//{
			//wSettingValue = mBMSBatCutOffVolt;
		//}
	//}
			...
			if(*pubOprtStep > cSetStepTwo)
			{
				*pubOprtStep = cSetStepOne;
				if(*pwChangeValue != 0)
				{
					...
					//if((swGetEEBatUnderVolt() + (cBatVoltReal0V5 * cBatSerialPcs)) > (cBatVoltReal13V5 * cBatSerialPcs))
					//{
						//sSetEEBatWeakVolt(cBatVoltReal13V5 * cBatSerialPcs);
					//}
					//else if((swGetEEBatUnderVolt() + (cBatVoltReal0V5 * cBatSerialPcs)) > swGetEEBatWeakVolt())
					//{
						//sSetEEBatWeakVolt(swGetEEBatUnderVolt() + (cBatVoltReal0V5 * cBatSerialPcs));
					//}
