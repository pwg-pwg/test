...
//Temp test
  ...
  EALLOW;
  AdcRegs.ADCCTL2.bit.CLKDIV2EN = 0;//ADC clock = CPU clock/2
...
void sInitGpio(void)
{
  ...
  //GENERATOR.O
	...
	GpioDataRegs.GPBCLEAR.bit.GPIO42 = 1;  // Load output latch to   
		...
		if(swGetBatteryPcs() == cbBatt48VType)
	  	{
			...
			g_wInvLCurrLineLevel2 = 1034;	// 5048:40A    853;	// 5048:1.50倍额定电流=34A(继电器最大电流33A)
