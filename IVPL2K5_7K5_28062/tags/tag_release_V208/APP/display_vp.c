...
//							bUpFlag = 1;
					...
					else if(bMenuIndex == CF_BAT_CHG_CV_ID)
					{
						if((bBatTypeID == USER_ID) || (bBatTypeID == LIB_ID))
						{
							...
							{
							    if((swGetBatteryPcs()==cbBatt48VType)&&(wTemp > 130))// 151126 132->130
    							{
    								wTemp = 0;
    								wAdjustValue = (INT16S)cw_AdjustValue_MID + 0 - (INT16S)bBatChgCVID;
    							}
    							else if((swGetBatteryPcs()==cbBatt24VType)&&(wTemp > 65))//29.2V->30.6V
    							{
    								wTemp = 0;
    								wAdjustValue = (INT16S)cw_AdjustValue_MID + 0 - (INT16S)bBatChgCVID;
    							}
    							else if((swGetBatteryPcs()==cbBatt12VType)&&(wTemp > 33))//14.6V->15.3V
    							{ 
    								wTemp = 0;
    								wAdjustValue = (INT16S)cw_AdjustValue_MID + 0 - (INT16S)bBatChgCVID;
    							}
					...
					else if(bMenuIndex == CF_BAT_CHG_FLTV_ID)
					{
						if(bBatTypeID == USER_ID)
						{
							...
							{
    							if((swGetBatteryPcs()==cbBatt48VType)&&(wTemp > 130))//lory 151127 132->130
    							{
    								wTemp = 0;
    								wAdjustValue = (INT16S)cw_AdjustValue_MID + 0 - (INT16S)bBatChgFVID;
    							}
    							else if((swGetBatteryPcs()==cbBatt24VType)&&(wTemp > 65))//25V->31.5V
    							{
    								wTemp = 0;
    								wAdjustValue = (INT16S)cw_AdjustValue_MID + 0 - (INT16S)bBatChgFVID;
    							}
