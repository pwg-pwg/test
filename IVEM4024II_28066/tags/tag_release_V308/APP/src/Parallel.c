...
typedef union
{
    ...
    struct
    {
        ...
        INT16U  uwACRange:1;
        INT16U  uwOPMode:3;
        INT16U  uwReusePortType:1;
        INT16U  uwGenChargeEn:1;
    }BIT;
}STRParameterSet1;
...
typedef union
{
    ...
    struct
    {
        INT16U  uwBatEqVolt:8;
        INT16U  uwBatEqInterval:8;
    }BIT;
}STRParameterSetEq1;
...
typedef union
{
    ...
    struct
    {
        INT16U uwBatEqTime:8;
        INT16U uwBatEqTimeout:8;
    }BIT;
}STRParameterSetEq2;
...
typedef union
{
    ...
    struct
    {
        INT16U wGenAbnormal     :2; // 0=正常，1=其它异常，2=电压异常，3=频率异常
        INT16U wRecv            :14;
    }BIT;
}STRStatus2Info;
...
STRParameterSet7    g_strLocalParameterSet7;
STRParameterSetEq1  g_strLocalParameterSetEq1;
STRParameterSetEq2  g_strLocalParameterSetEq2;
...
STRParameterSet7    g_strLocalParameterSet7Temp;
STRParameterSetEq1  g_strLocalParameterSetEq1Temp;
STRParameterSetEq2  g_strLocalParameterSetEq2Temp;

STRBatVoltWorkMode  g_strLocalBatVoltWorkModeTemp;
STRInvVoltLoadPercent g_strLocalInvVoltLoadPercentTemp;

UNIChgStatus    g_unChgStatus;
UNIChgStatus    g_unChgStatusTemp;
UNIChgStatus    g_unSysChgStatus;

UNIChgStatus2   g_uniChgStatus2;
UNIChgStatus2   g_uniChgStatus2Temp;
UNIChgStatus2   g_uniSysChgStatus2;
...
UNIInputStatus g_unInputStatus;
UNIInputStatus g_unInputStatusTemp;
UNIInputStatus2 g_unInputStatus2;
UNIInputStatus2 g_unInputStatus2Temp;
UNIParaExistInfo g_strParaExistInfo;

STRStatus2Info g_strInvParaStatus2;
STRStatus2Info g_strLocalInvStatus2;
STRStatusInfo g_strInvParaStatus;
STRStatusInfo g_strLocalInvStatus;

CANFRAME g_strCanTxCom;
CANFRAME g_strCanTxEve;
CANFRAME g_strCanRxData;
...
INT16U  g_uwCommand;
INT16U  g_uwNewCanReceiveFlg;
INT16U  g_uwMasterCompeteFail;
INT16U  g_uwMasterInqCnt;
INT16U  g_uwSlaveModeWaitComCnt;
INT16U  g_uwMasterNewReceiveCnt;
INT16U  g_uwMasterSlaveReceiveCnt;
INT16U  g_uwMasterSlaveReceivePreCnt;
INT16U  g_uwSlavePhysicalLossCnt;
INT16U  g_uwSystemHaveSamPhysicalFlg;
INT16U  g_uwMasterToNewPrioLowFlg;
...
INT16U  g_uwParaBatWeakFlg;
INT16U  g_uwParaBatWeakChgFlg;
INT16U  g_uwParaLoadAbnormalFlg;
INT16U  g_uwNewPhysicalAssignFlg;
INT16U  g_uwIDAutoGenerateStep = cPrioSuper;
INT16U  g_uwIDHighTemp;
INT16U  g_uwIDLowTemp;
INT16U  g_uwParameterSetChange;
INT16U  g_uwParaNumMaxSize = cParaMaxSize;
INT16U  g_uwParaModeSwitchFlg;
INT16U  g_uwParaSlaveRecieveFlg;
INT16U  g_uwRsvMaster;

INT16U  g_uwSysChgCurrSum;
INT16U  g_uwChgStatus;
...
INT16U  g_uwExsitNum;
INT16U  g_uwComLossCnt;
Uint16  uwSysEqStatePre;
INT16U  g_uwMasterWorkMode;
INT16S  g_wPhaseMasterFlg;
INT16U  g_uwOPWaitOnChkCnt;

INT16U wSourceStatu2 = 0;
...
void    sCheckSynAction(void);
 ...
 void    sSystemSourceStatus2(void);
...
//----------------------------------Code ------------------------------------//
/******************************************************************************
Function Name       : sParallelParaInit
---------------------------------------------------
Function Descriptions   :全局变量初始值，与E2prom无关
Parameter Name list :
******************************************************************************/
void sParallelParaInit()
{
    g_uwParaMode           = cNewMode;
    g_uwIDAutoGenerateStep = cPrioSuper;
    g_uwParaNumMaxSize = cParaMaxSize;
    g_uwMasterWorkMode = cPowerOnMode;
}

/******************************************************************************
Function Name       : sParallelInit
---------------------------------------------------
Function Descriptions   :
Parameter Name list :  故障、主从切换等，初始化
******************************************************************************/
void sParallelInit(void)
{
...
/******************************************************************************
Function Name       : sToBeSlaveModule
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
...
/******************************************************************************
Function Name       : sToBeMasterModule
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
...
/******************************************************************************
Function Name       : sUpdateLocalData
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
void sUpdateLocalData(void)
{
    ...
    g_strLocalParameterSet1.BIT.uwReusePortType= swGetEESmartPortType();
    g_strLocalParameterSet1.BIT.uwGenChargeEn= swGetEEGenChargeEn();    
    ...
    g_strLocalParameterSet7.BIT.uwBatEqEn = swGetEEBatEqEn();
    g_strLocalParameterSet7.BIT.uwBatEqImd = swGetEEBatEqActImd();
    g_uwSystemData[g_uwPhysicalAddr][cParamerterSet7] = g_strLocalParameterSet7.wParameterValue;

    g_strLocalParameterSetEq1.BIT.uwBatEqVolt = swGetEEBatEqVolt() - (cBatVoltReal10V*cBatSerialPcs);
    g_strLocalParameterSetEq1.BIT.uwBatEqInterval = swGetEEBatEqInterval();
    g_uwSystemData[g_uwPhysicalAddr][cParameterSetEq1] = g_strLocalParameterSetEq1.wParameterValue;

    g_strLocalParameterSetEq2.BIT.uwBatEqTime = swGetEEBatEqTime()/5;
    g_strLocalParameterSetEq2.BIT.uwBatEqTimeout = swGetEEBatEqTimeout()/5;
    g_uwSystemData[g_uwPhysicalAddr][cParameterSetEq2] = g_strLocalParameterSetEq2.wParameterValue;
    ...
    //---------------- local gen status summy ----------------------//
    if(subGetGenLossStatus() == true && g_uwWorkMode != cPowerOnMode)
    {
        if(subGetGenVoltLossStatus() == false && subGetGenFreqLossStatus() == false)
        {
            g_strLocalInvStatus2.BIT.wGenAbnormal = 1;
        }
        else
        {
            g_strLocalInvStatus2.BIT.wGenAbnormal = 2;
        }
    }
    else
    {
        g_strLocalInvStatus2.BIT.wGenAbnormal = false;
    }

    //---------------- local Load status summy ----------------------//
    g_strLocalInvStatus.BIT.wLoadAbnormal = g_wOverLoadBypass;

    if((     (g_uwWorkMode == cLineMode || g_uwWorkMode == cBypassMode)
          &&  mChkOPRlyOn()
          && (   (g_uwLineModeJoinInWay == cLineModeJoinInByGrid && mChkGridRlyOn())
               ||(g_uwLineModeJoinInWay == cLineModeJoinInByGen && mChkSmart_Port_Rly_On()))
         )
    ...
    g_strLocalInvStatus.BIT.wBatWeak = g_ucBatWeak;
    ...
    g_uwSystemData[g_uwPhysicalAddr][cInvStatus2] = g_strLocalInvStatus2.wStatus;
    ...
    g_unChgStatus.uwChgStatus = 0;
    g_uniChgStatus2.uwChgStatus2 = 0;

    if(g_uwLiBatActStep == cLiBatActStart)
    {
        g_unChgStatus.BIT.uwLiBatAct = true;
    }
    else
    {
        g_unChgStatus.BIT.uwLiBatAct = false;
    }
    g_unChgStatus.BIT.uwChgerOn = g_wBatChgerOn;
    g_unChgStatus.BIT.uwChgCurrPercent = (INT16S)((INT32S)g_wChgCurrAvg * 100 / swGetEEBatChgCurrMax());
    g_unChgStatus.BIT.uwChgMode = g_wBatChgStage;
    ...
    {
        g_unChgStatus.BIT.uwChgCVToFloatVolt = true;
    }
    else
    {
        g_unChgStatus.BIT.uwChgCVToFloatVolt = false;
    }
    if(g_wBatProtChgMode)
    {
        g_unChgStatus.BIT.uwChgFloatToCVDis = true;
    }
    else
    {
        g_unChgStatus.BIT.uwChgFloatToCVDis = false;
    }
    g_unChgStatus.BIT.uwChgFloatStop = 0;
    g_unChgStatus.BIT.uwBMSConnected = g_strBMSCtrlLogicInfo.ubBMSConnect;
    g_uwSystemData[g_uwPhysicalAddr][cChgStatus] = g_unChgStatus.uwChgStatus;
    //充电状态
    g_uniChgStatus2.BIT.uwEqStatue = g_ubBatEqState;
    g_uwSystemData[g_uwPhysicalAddr][cChgStatus2] = g_uniChgStatus2.uwChgStatus2;

}

/******************************************************************************
Function Name       : sParaNewModeProc
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
void sParaNewModeProc(void)
{
    ...
    while(1)
    {
        if(!g_wParallelEnable && !g_wSPSSDProcFlg)
        {
            sToBeMasterModule();
            return;         
        }
...
/******************************************************************************
Function Name       : sParaSlaveModeProc
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
...
//  INT16U wCanOKCnt = 0;
    ...
    while(1)
    {
        ...
        if(g_uwParaEvent & (1 << eParallelTimer))
        {
            ...
            {
                wParaCnt = 0;
//                  if(g_wSYNLossFlg == false && mGetParaWarning(0xFFFF))
//                  {
//                      if(++wCanOKCnt > 250)  //1s
//                      {
//                          mSetParaWarning(0);
...
/******************************************************************************
Function Name       : sParaMasterModeProc
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
void sParaMasterModeProc(void)
{
    ...
    INT16U  wCanOKCnt = 0;
    INT16U  wIndex;
    INT16U  wModeSelectPre = g_wParallelEnable;
    hoHOSTTXDOn;
    sEncodeCanTxCom(g_strLocalID.BIT.wLocalIDHigh,cNullData,g_strLocalID.BIT.wLocalIDLow,
                    cToBeNew,cMasterSend,cNullData,
                    cNullData,cNullData,cNullData);
    sCanWrite9(&g_strCanTxCom);
    while(1)
    {
        if(g_uwParaMode != cMasterMode)
        {
        ...
        if(g_uwParaEvent & (1 << eParallelTimer))
        {
            ...
            wModeSelectPre = g_wParallelEnable;
...
/******************************************************************************
Function Name       : sCanParsingEvent
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
void sCanParsingEvent(void)
{
    ...
    {
        while(sCanRead(&g_strCanRxData) != cCanRxBufEmpty)
        {
            if(!g_wParallelEnable)
            {
                continue;
            ...
            g_uwSlaveModeWaitComCnt = 0;
            sDecodeCanRxFrame(g_strCanRxData);
                ...
                if(g_uwParaMode == cNewMode)
                {
                    ...
                    else if(g_uwCommand == cNewInquire)
                    {
                        ...
                        else
                        {
                            ...
                            if(g_uwWorkMode != cFaultMode)
                            {
                                sFaultRecord(cParaVersionDiff, 1, g_uwFaultCode);
                            }
                            sToBeNewModule();
                        }
                    }
...
//                      OSEventSend(cPrioSuper, eSuperToShutDown);
                ...
                else if(g_uwCommand == cSourceStatus)
                {
                    if(g_uwParaMode != cMasterMode)
                    {
                        g_unInputStatusTemp.uwInputStatus = g_strCanReceiveFrame.Data0;
                        g_unSysChgStatus.uwChgStatus = g_strCanReceiveFrame.Data1;
                        
                        g_strParaExistInfo.uwParaExistInfo = g_strCanReceiveFrame.Data2;
                        g_unInputStatus2Temp.BIT.uwGenAbnormal = g_strParaExistInfo.BIT.uwGenAbnormal;
                        
                        if(g_unInputStatus.BIT.uwLineAbnormal == false)
                        {
                            if(g_unInputStatusTemp.BIT.uwLineAbnormal == true)
                            {
                        ...
                        {
                            if(g_unInputStatus2.BIT.uwGenAbnormal == false && g_unInputStatus2Temp.BIT.uwGenAbnormal == true)
                            {
                                OSEventSend(cPrioSuper, eSuperGenLoss);
                            }
                        }
                        g_unInputStatus.uwInputStatus = g_unInputStatusTemp.uwInputStatus;
                        g_unInputStatus2.uwInputStatus2 = g_unInputStatus2Temp.uwInputStatus2;
                        /*
                        ...
                        */
                        g_wOPVoltFresh = 1;
                        //从机控制必然小于等于"额定电压"？
                        g_wOPVoltCntl = swGetEEOutputVolt() -  ((INT16S)10 * g_unInputStatusTemp.BIT.uwOPVoltDrtErr);
...
//                                  OSEventSend(cPrioSuper, eSuperFault);
                        ...
                        if(g_unSysChgStatus.BIT.uwBMSConnected == 0)
                        {
                ...
                else if(g_uwCommand == cSourceStatus2)
                {
                    if(g_uwParaMode != cMasterMode)
                    {
                        g_uniSysChgStatus2.uwChgStatus2 = g_strCanReceiveFrame.Data0;

                        if( g_uniSysChgStatus2.BIT.uwEqStatue == eEqState_EqFail && uwSysEqStatePre != eEqState_EqFail)
                        {
                            //失败后，延时7天后的日期(一周)
                        ...
                        if(  g_uniSysChgStatus2.BIT.uwEqStatue == eEqState_EqSucess &&  uwSysEqStatePre != eEqState_EqSucess)
                        {
                            sSetEEBatEqLastTime((INT16U)(g_strDateTime.ubYear << 9)|(g_strDateTime.ubMonth << 5)|(g_strDateTime.ubDay));
                            OSEventSend(cPrioInterface, eI2CEEpromUserSave);
                        }
                        uwSysEqStatePre  = g_uniSysChgStatus2.BIT.uwEqStatue;
                    }
                }
                ...
                else if(g_uwCommand == cBMSFlagInq)
                {
                    ...
                    else if(g_uwSourceComEve == cMasterSend)
                    {
                        if(g_strCanReceiveFrame.Data0 == g_uwPhysicalAddr)
                        {
                            g_strBMSCtrlInfo.uniBMSCutVoltSOC.BIT.uwBMSCutVolt = g_strBMSCtrlLogicInfo.wBMSBatCutOffVolt - (cBatVoltReal10V*cBatSerialPcs);
...
//                      sParameterSetSave();
                ...
                else if(g_uwCommand == cParameterSet3)
                {
                    if(g_uwParameterSetChange == false
                    || (g_strLocalParameterSet1Temp.BIT.wParameterChange == true))
                    {
                        g_strLocalParameterSet7Temp.wParameterValue = g_strCanReceiveFrame.Data0;
                        g_strLocalParameterSetEq1Temp.wParameterValue = g_strCanReceiveFrame.Data1;
                        g_strLocalParameterSetEq2Temp.wParameterValue = g_strCanReceiveFrame.Data2;
                        ...
                        g_strLocalParameterSet7Temp.wParameterValue = 0;
                        g_strLocalParameterSetEq1Temp.wParameterValue = 0;
                        g_strLocalParameterSetEq2Temp.wParameterValue = 0;
                    }
                }
                ...
                if((g_uwCommand == cBatToLine) || (g_uwCommand == cLineToBat) || (g_uwCommand == cToBypass))
                {
//                      OS_ENTER_CRITICAL();
//                      if(g_wParaSwitchModeRxFlg == true)
//                      {
//                          g_wParaSwitchModeRxFlg = false;
//                      }
//                      else
//                      {
//                          g_wParaSwitchModeRxFlg = 2;
//                          g_wParaSwitchCmdWaitCnt = 30;
//                      }
//                      OS_EXIT_CRITICAL();
                }
            }   
...
void sEncodeCanTxCom(INT16U ID0,INT16U ID1,INT16U ID2, 
                     ...
                     INT16U Word1,INT16U Word2,INT16U Word3)
{
    g_strCanTxCom.CanId.BIT.IDE = 1;
    g_strCanTxCom.CanId.BIT.AME = 0;
    g_strCanTxCom.CanId.BIT.AAM = 0;
    g_strCanTxCom.CanId.BIT.STDMSGID = (ID0 | 0x400);
    g_strCanTxCom.CanId.BIT.EXTMSGID_H = ID1;
    g_strCanTxCom.CanId.BIT.EXTMSGID_L = ID2;
    g_strCanTxCom.CanData0 = ((wCommandSend << 8) + \
                          (wSourceSend << 7) + wUPSNumSend) & 0x7fff;
    g_strCanTxCom.CanData1 = Word1;
    g_strCanTxCom.CanData2 = Word2;
    g_strCanTxCom.CanData3 = Word3;
}
/******************************************************************************
Function Name       : sEncodeCanTxEve
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
...
/******************************************************************************
Function Name       : sDecodeCanRxFrame
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
...
/******************************************************************************
Function Name       : sInquiryNewMachine
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
        ...
        if(g_uwParaEvent & (1 << eParallelTimer))
        {
            if(wParaCnt == 0)
            {
                sEncodeCanTxCom(g_strLocalID.BIT.wLocalIDHigh,cNullData,g_strLocalID.BIT.wLocalIDLow,\
                                ...
                                g_strLocalID.BIT.wLocalIDHigh,g_strLocalID.BIT.wLocalIDLow,cParaVersion);
                sCanWrite9(&g_strCanTxCom);
            }
...
/******************************************************************************
Function Name       : sInquirySlaveMachine
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
...
/******************************************************************************
Function Name       : sPhysicalAddrAssignChk
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
...
/******************************************************************************
Function Name       : sSlavePhysicalLossChk
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
...
/******************************************************************************
Function Name       : sInquiryLossSlaveAgain
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
...
/******************************************************************************
Function Name       : sCheckSystemConfig
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
...
/******************************************************************************
Function Name       : swMasterReleaseChk
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
INT16U swMasterReleaseChk(void)
{
    ...
    if(g_wParallelEnable > cOP_Parallel)
    {
        uwMasterReleaseChk = true;
        if(g_wParallelEnable == cOP_3P1)
        {
...
/******************************************************************************
Function Name       : sModeSwitchEvent
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
void sModeSwitchEvent(void)
{
    ...
    {
        if(g_uwParaMode == cMasterMode && g_wParallelEnable)
        {
            ...
            sOSTimerStart();
//              OS_ENTER_CRITICAL();
//              g_wParaSwitchModeTxFlg = true;
//              OS_EXIT_CRITICAL();
            sEncodeCanTxCom(g_strLocalID.BIT.wLocalIDHigh,cNullData,g_strLocalID.BIT.wLocalIDLow,
                            cBatToLine,cMasterSend,cNullData,
                            cNullData,cNullData,cNullData);
            sCanWrite7(&g_strCanTxCom); 
            OSEventSend(cPrioSuper, eSuperToLine);
        }
    }
...
/******************************************************************************
Function Name       : sChkSourceStatus
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
void    sChkSourceStatus(void)
{
    ...
    while(1)
    {
        ...
        if(g_uwParaEvent & (1 << eParallelTimer))
        {
            if(wSourceStatu2)
            {
                sSystemSourceStatus2();
                wSourceStatu2 = 0;
            }
            else
            {
                if(g_unSysChgStatus.BIT.uwBMSConnected)
                {
                    if(wCnt < 10)
                    {
...
/******************************************************************************
Function Name       : swChkOverLoadStatus
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
...
//  INT16S  wOutputWork = false;
    ...
    g_unSysChgStatus.uwChgStatus = 0;
    g_uniSysChgStatus2.uwChgStatus2 = 0;
    g_unInputStatus.uwInputStatus = 0;
    g_unInputStatus2.uwInputStatus2 = 0;
    ...
    for(wCnt = 0; wCnt < g_uwParaNumMaxSize; wCnt++)
    {
        if(g_uwSlaveExsitFlg[wCnt] == 1)
        {
            ...
            g_strInvParaStatus.wStatus = g_uwSystemData[wCnt][cInvStatus];
            g_strInvParaStatus2.wStatus = g_uwSystemData[wCnt][cInvStatus2];
            
            if(g_strInvParaStatus.BIT.wBatOpen == 1)
            {
                g_unInputStatus.BIT.uwBatOpen = 1;
            }

            if(g_strInvParaStatus.BIT.wBatUnder == 1)
            {
                g_unInputStatus.BIT.uwBatUnder = 1;
            }
            
            if(g_strInvParaStatus.BIT.wBatPowerDown == 1)
            {
                g_unInputStatus.BIT.uwBatPowerDown = 1;
            }

            //-------------- Grid Abnormal summy ------------------//
            if(g_strInvParaStatus.BIT.wLineAbnormal == 2)
            {
                g_unInputStatus.BIT.uwLineAbnormal = 2;
            }
            else if(g_strInvParaStatus.BIT.wLineAbnormal == 1 && g_unInputStatus.BIT.uwLineAbnormal != 2)
            {
                g_unInputStatus.BIT.uwLineAbnormal = 1;
            }
            //---------------------------------------------------

            //-------------- Gen Abnormal summy ------------------//
            if(g_strInvParaStatus2.BIT.wGenAbnormal == 2)
            {
                g_unInputStatus2.BIT.uwGenAbnormal = 2;
            }
            else if(g_strInvParaStatus2.BIT.wGenAbnormal == 1 && g_unInputStatus2.BIT.uwGenAbnormal != 2)
            {
                g_unInputStatus2.BIT.uwGenAbnormal = 1;
            }
            //---------------------------------------------------
            
            if(g_strInvParaStatus.BIT.wBatOverVolt)
            {
                g_unInputStatus.BIT.uwBatOver = true;
            }
            ...
            {
                g_unInputStatus.BIT.uwSysSCCOK = true;
            }
            /*
            ...
            */
            ...
            if(g_strInvParaStatus.BIT.wLoadAbnormal)
            {
                ...
                g_unInputStatus.BIT.uwLoadAbnormal = true;
            }       
...
//          }
    ...
    if( g_unSysChgStatus.BIT.uwChgerOn == true
    && g_wBatChgStage == cBatChgDoNothing && g_uwChgStatus != cBatChgDoNothing)
    {
        g_wBatChgStage = g_uwChgStatus;
    }
    
    g_unSysChgStatus.BIT.uwChgMode = g_wBatChgStage;
    //主机状态
    g_uniSysChgStatus2.BIT.uwEqStatue = g_ubBatEqState;

    g_unSysChgStatus.BIT.uwChgCurrPercent = g_uwSysChgCurrSum/g_uwExsitNum;
...
//              }
    ...
    g_uniInputStatus.BIT.uwBatWeak = g_fBatWeak; 
    */
    
    g_unInputStatus.BIT.uwBatWeak = uwParaBatWeakFlg;
...
/******************************************************************************
Function Name       : sSystemSourceStatus
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
...
{
    INT16S wTemp;
    //输出电压设置与实际控制电压作差--需要抬升电压范围(0——30V)
    wTemp = swGetEEOutputVolt() - g_wOPVoltCntl;
    if(wTemp > 300)     wTemp = 300;
    else if(wTemp < 0)  wTemp = 0;
    g_unInputStatus.BIT.uwOPVoltDrtErr = wTemp/10;
    sEncodeCanTxCom(g_strLocalID.BIT.wLocalIDHigh,cNullData,g_strLocalID.BIT.wLocalIDLow,\
                    cSourceStatus,cMasterSend,cNullData,\
                    g_unInputStatus.uwInputStatus,g_unSysChgStatus.uwChgStatus,\
                    g_strParaExistInfo.uwParaExistInfo);
    sCanWrite8(&g_strCanTxCom);
    g_wOPVoltFresh = 1;
}
/******************************************************************************
Function Name       : sSystemSourceStatus2
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
...
{
    sEncodeCanTxCom(g_strLocalID.BIT.wLocalIDHigh,cNullData,g_strLocalID.BIT.wLocalIDLow,\
                    cSourceStatus2,cMasterSend,cNullData,\
                    g_uniSysChgStatus2.uwChgStatus2,cNullData,\
                    cNullData);
    sCanWrite8(&g_strCanTxCom);
}

/******************************************************************************
Function Name       : sbParameterSetChk
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
INT8U sbParameterSetChk(void)
{
    ...
    for(wCnt = 0; wCnt < cParaMaxSize; wCnt++)
    {
        ...
        {           
            ...
            || g_uwSystemData[wCnt][cParamerterSet7] != g_uwSystemData[0][cParamerterSet7]
            || g_uwSystemData[wCnt][cParameterSetEq1] != g_uwSystemData[0][cParameterSetEq1]
            || g_uwSystemData[wCnt][cParameterSetEq2] != g_uwSystemData[0][cParameterSetEq2])
            {
                wParameterDiff = true;
            }
        }
...
//          sCan2Write9(&g_strCanTxCom2);   
        ...
        if(wCnt != 0)
        {
            ...
            g_strLocalParameterSet7Temp.wParameterValue = g_uwSystemData[wCnt][cParamerterSet7];
            g_strLocalParameterSetEq1Temp.wParameterValue = g_uwSystemData[wCnt][cParameterSetEq1];
            g_strLocalParameterSetEq2Temp.wParameterValue = g_uwSystemData[wCnt][cParameterSetEq2];
            sParameterSetSave();
        }
    }
        ...
        if(g_uwParaEvent & (1 << eParallelTimer))   
        {
            ...
            else if(bTemp == 1)
            {
                ...
                sEncodeCanTxCom(g_strLocalID.BIT.wLocalIDHigh,cNullData,g_strLocalID.BIT.wLocalIDLow,\
                                ...
                                g_uwSystemData[wCnt][cParamerterSet5],g_uwSystemData[wCnt][cParamerterSet6]);
                sCanWrite9(&g_strCanTxCom);
            }
            else if(bTemp == 2)
            {
                bTemp = 0;
                sEncodeCanTxCom(g_strLocalID.BIT.wLocalIDHigh,cNullData,g_strLocalID.BIT.wLocalIDLow,\
                                cParameterSet3,cMasterSend,cNullData,\
                                g_uwSystemData[wCnt][cParamerterSet7],\
                                g_uwSystemData[wCnt][cParameterSetEq1],g_uwSystemData[wCnt][cParameterSetEq2]);
                sCanWrite9(&g_strCanTxCom);
                return true;
            }
        }
...
/******************************************************************************
Function Name       : sParameterSetSave
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
...
//      sInitLineModuleParaUpdate();
    ...
    if(g_strLocalParameterSet1Temp.BIT.uwReusePortType != swGetEESmartPortType())
    {
        sSetEESmartPortType(g_strLocalParameterSet1Temp.BIT.uwReusePortType);
        bSaveFlag = 1;
    }   
    
    if(g_strLocalParameterSet1Temp.BIT.uwGenChargeEn != swGetEEGenChargeEn())
    {
        sSetEEGenChargeEn(g_strLocalParameterSet1Temp.BIT.uwGenChargeEn);
        bSaveFlag = 1;
    }   
    ...
    //EQ
    if(g_strLocalParameterSet7Temp.BIT.uwBatEqEn != swGetEEBatEqEn())
    {
        sSetEEBatEqEn(g_strLocalParameterSet7Temp.BIT.uwBatEqEn);
        bSaveFlag = 1;
    }
    if(g_strLocalParameterSet7Temp.BIT.uwBatEqImd != swGetEEBatEqActImd())
    {
        sSetEEBatEqActImd(g_strLocalParameterSet7Temp.BIT.uwBatEqImd);
        bSaveFlag = 1;
    }
    //
    if(g_strLocalParameterSetEq1Temp.BIT.uwBatEqVolt !=(swGetEEBatEqVolt() - (cBatVoltReal10V*cBatSerialPcs)) )
    {
        sSetEEBatEqVolt(g_strLocalParameterSetEq1Temp.BIT.uwBatEqVolt + (cBatVoltReal10V*cBatSerialPcs));
        bSaveFlag = 1;
    }
    if(g_strLocalParameterSetEq1Temp.BIT.uwBatEqInterval != swGetEEBatEqInterval())
    {
        sSetEEBatEqInterval(g_strLocalParameterSetEq1Temp.BIT.uwBatEqInterval);
        bSaveFlag = 1;
    }
    //
    if(g_strLocalParameterSetEq2Temp.BIT.uwBatEqTime != swGetEEBatEqTime()/5)
    {
        sSetEEBatEqTime(g_strLocalParameterSetEq2Temp.BIT.uwBatEqTime * 5);
        bSaveFlag = 1;
    }
    if(g_strLocalParameterSetEq2Temp.BIT.uwBatEqTimeout != swGetEEBatEqTimeout()/5)
    {
        sSetEEBatEqTimeout(g_strLocalParameterSetEq2Temp.BIT.uwBatEqTimeout * 5);
        bSaveFlag = 1;
    }
...
/******************************************************************************
Function Name       : sbWorkModeDiffChk
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
...
/******************************************************************************
Function Name       : sSysDataConsistentChk
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
...
void sChgStatusChk(INT16U uwIndex)
{
    g_unChgStatusTemp.uwChgStatus = g_uwSystemData[uwIndex][cChgStatus];
    g_uniChgStatus2Temp.uwChgStatus2 = g_uwSystemData[uwIndex][cChgStatus2];


    if(g_unChgStatusTemp.BIT.uwLiBatAct == true)
    {
        g_unSysChgStatus.BIT.uwLiBatAct = true;
    }

    if(g_unChgStatusTemp.BIT.uwChgerOn == true)
    {
        g_unSysChgStatus.BIT.uwChgerOn = true;
    }

    if(g_unChgStatusTemp.BIT.uwChgCVToFloatVolt == true)
    {
        g_unSysChgStatus.BIT.uwChgCVToFloatVolt = true;
    }

    if(g_unChgStatusTemp.BIT.uwChgFloatToCVDis == true)
    {
        g_unSysChgStatus.BIT.uwChgFloatToCVDis = true;
    }

    if(g_unChgStatusTemp.BIT.uwChgFloatStop == true)
    {
        g_unSysChgStatus.BIT.uwChgFloatStop = true;
    }

    g_uwSysChgCurrSum += g_unChgStatusTemp.BIT.uwChgCurrPercent;
    
    if(g_unChgStatusTemp.BIT.uwChgMode == cBatChgCVStage
    || g_uwChgStatus == cBatChgCVStage)
    {
        g_uwChgStatus = cBatChgCVStage;
    }
    else if(g_unChgStatusTemp.BIT.uwChgMode == cBatChgFloatStage
    || g_uwChgStatus == cBatChgFloatStage)
    {
        g_uwChgStatus = cBatChgFloatStage;
    }
    else if(g_unChgStatusTemp.BIT.uwChgMode == cBatChgEqStage
    || g_uwChgStatus == cBatChgEqStage)
    {
        g_uwChgStatus = cBatChgEqStage;
    }
    else
    ...
    if(g_unSysChgStatus.BIT.uwBMSConnected == false
    && g_unChgStatusTemp.BIT.uwBMSConnected == true)
    {
        g_unSysChgStatus.BIT.uwBMSConnected = true;
        g_uwBMSConnectAddr = uwIndex;
    }   
}
/******************************************************************************
Function Name       : sSetMasterWorkMode
---------------------------------------------------
Function Descriptions   :
Parameter Name list :
******************************************************************************/
