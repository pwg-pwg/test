...
void    sSLineVoltChk(INT8U bFilter)
{
    ...
    {
        if(sbInRangeChk(g_uwSLineVolt ,g_uwLineOverVoltBackLevel1,g_uwLineUnderVoltBackLevel2,bFilter,&s_ubSFeedLineVChkCnt) == true)
        {
...
void    sTLineVoltChk(INT8U bFilter)
{
    ...
    {
        if(sbInRangeChk(g_uwTLineVolt ,g_uwLineOverVoltBackLevel1,g_uwLineUnderVoltBackLevel2,bFilter,&s_ubTFeedLineVChkCnt) == true)
        {
