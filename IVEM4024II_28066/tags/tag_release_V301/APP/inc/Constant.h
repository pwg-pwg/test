...
#define cModbusSubType              0x0206      //电池节数<<8+(2+(P-2KW)/0.5KW) = 电池节数 << 8 + （2*power -2kw）
...
#define cCntl_InvVoltKi             620//300
...
#define cINVDutyLowLimit            130     //1.18us        1.1 * cSystemBusFreq /2 (Dead Time => + Value/2) 125/2344=5.3%
