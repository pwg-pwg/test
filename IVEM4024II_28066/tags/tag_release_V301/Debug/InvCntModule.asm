...
;* Date/Time created: Mon May 19 18:03:18 2025                 *
;***************************************************************
...
;	D:\Application\ProjectSoftware\ti\CCS7.2\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\zy\\AppData\\Local\\Temp\\358722 C:\\Users\\zy\\AppData\\Local\\Temp\\358724 
;	D:\Application\ProjectSoftware\ti\CCS7.2\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\zy\\AppData\\Local\\Temp\\3587212 
	.sect	".text"
...
;*** 329	-----------------------    if ( y$38 < 130 ) goto g18;
	...
	.dwpsn	file "../APP/src/InvCntModule.c",line 329,column 9,is_stmt
        CMPB      AH,#130               ; [CPU_] |329| 
        B         $C$L31,LT             ; [CPU_] |329| 
        ; branchcc occurs ; [] |329| 
;*** 330	-----------------------    if ( y$38 <= g_wPwmPeriod-130 ) goto g19;
        MOVW      DP,#_g_wPwmPeriod     ; [CPU_U] 
	.dwpsn	file "../APP/src/InvCntModule.c",line 330,column 14,is_stmt
        MOVB      XAR6,#130             ; [CPU_] |330| 
...
;*** 507	-----------------------    if ( C$3 < 130 ) goto g5;
	...
	.dwpsn	file "../APP/src/InvCntModule.c",line 507,column 9,is_stmt
        CMPB      AL,#130               ; [CPU_] |507| 
        B         $C$L37,LT             ; [CPU_] |507| 
        ; branchcc occurs ; [] |507| 
;*** 508	-----------------------    if ( C$3 <= g_wPwmPeriod-130 ) goto g6;
        MOVW      DP,#_g_wPwmPeriod     ; [CPU_U] 
	.dwpsn	file "../APP/src/InvCntModule.c",line 508,column 14,is_stmt
        MOVB      XAR6,#130             ; [CPU_] |508| 
...
;*** 485	-----------------------    if ( y$10 < 130 ) goto g12;
	...
	.dwpsn	file "../APP/src/InvCntModule.c",line 485,column 9,is_stmt
        CMPB      AH,#130               ; [CPU_] |485| 
        B         $C$L41,LT             ; [CPU_] |485| 
        ; branchcc occurs ; [] |485| 
;*** 486	-----------------------    if ( y$10 <= g_wPwmPeriod-130 ) goto g13;
        MOVW      DP,#_g_wPwmPeriod     ; [CPU_U] 
	.dwpsn	file "../APP/src/InvCntModule.c",line 486,column 14,is_stmt
        MOVB      XAR6,#130             ; [CPU_] |486| 
...
;*** 589	-----------------------    if ( C$4 < 130 ) goto g8;
	...
	.dwpsn	file "../APP/src/InvCntModule.c",line 589,column 9,is_stmt
        CMPB      AL,#130               ; [CPU_] |589| 
        B         $C$L54,LT             ; [CPU_] |589| 
        ; branchcc occurs ; [] |589| 
;*** 590	-----------------------    if ( C$4 <= g_wPwmPeriod-130 ) goto g9;
        MOVW      DP,#_g_wPwmPeriod     ; [CPU_U] 
	.dwpsn	file "../APP/src/InvCntModule.c",line 590,column 14,is_stmt
        MOVB      XAR6,#130             ; [CPU_] |590| 
...
;*** 571	-----------------------    if ( C$2 < 130 ) goto g15;
	...
	.dwpsn	file "../APP/src/InvCntModule.c",line 571,column 9,is_stmt
        CMPB      AL,#130               ; [CPU_] |571| 
        B         $C$L58,LT             ; [CPU_] |571| 
        ; branchcc occurs ; [] |571| 
;*** 572	-----------------------    if ( C$2 <= g_wPwmPeriod-130 ) goto g16;
        MOVW      DP,#_g_wPwmPeriod     ; [CPU_U] 
	.dwpsn	file "../APP/src/InvCntModule.c",line 572,column 14,is_stmt
        MOVB      XAR6,#130             ; [CPU_] |572| 
