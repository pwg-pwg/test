...
;* Date/Time created: Fri Jul 11 10:49:11 2025                 *
;***************************************************************
...
;	D:\Application\ProjectSoftware\ti\CCS7.2\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\zy\\AppData\\Local\\Temp\\327562 C:\\Users\\zy\\AppData\\Local\\Temp\\327564 
;	D:\Application\ProjectSoftware\ti\CCS7.2\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\zy\\AppData\\Local\\Temp\\3275612 
	.sect	"ramfuncs"
	.global	_OSTimerTick
...
$C$DW$3	.dwtag  DW_TAG_subprogram, DW_AT_name("OSTimerTick")
	...
	.dwpsn	file "../KERNEL/SOURCE/OS_TIMER.c",line 7,column 1,is_stmt,address _OSTimerTick
...
$C$DW$8	.dwtag  DW_TAG_variable, DW_AT_name("$O$U6")
	...
	.dwpsn	file "../KERNEL/SOURCE/OS_TIMER.c",line 25,column 2,is_stmt
        MOVL      XAR7,#_OSTCBTbl       ; [CPU_U] |25| 
        MOVL      ACC,XAR7              ; [CPU_] |25| 
	.dwpsn	file "../KERNEL/SOURCE/OS_TIMER.c",line 23,column 2,is_stmt
        MOVB      XAR4,#0               ; [CPU_] |23| 
	.dwpsn	file "../KERNEL/SOURCE/OS_TIMER.c",line 25,column 2,is_stmt
        MOVL      XAR5,XAR7             ; [CPU_] |25| 
        ADDB      ACC,#30               ; [CPU_U] 
	.dwpsn	file "../KERNEL/SOURCE/OS_TIMER.c",line 26,column 8,is_stmt
        SUBL      ACC,XAR5              ; [CPU_] |26| 
        ADDB      ACC,#6                ; [CPU_] |26| 
        MOVL      XAR6,ACC              ; [CPU_] |26| 
$C$L1:    
	.dwpsn	file "../KERNEL/SOURCE/OS_TIMER.c",line 23,column 2,is_stmt
$C$DW$L$_OSTimerTick$2$B:
;***	-----------------------g2:
;*** 28	-----------------------    if ( !(U$6 = (*ptcb).TimerPeriod) ) goto g5;
	.dwpsn	file "../KERNEL/SOURCE/OS_TIMER.c",line 28,column 3,is_stmt
        MOV       AL,*+XAR5[2]          ; [CPU_] |28| 
        BF        $C$L2,EQ              ; [CPU_] |28| 
        ; branchcc occurs ; [] |28| 
$C$DW$L$_OSTimerTick$2$E:
$C$DW$L$_OSTimerTick$3$B:
;*** 31	-----------------------    ++(*ptcb).TimerCnt;
;*** 32	-----------------------    if ( (*ptcb).TimerCnt < U$6 ) goto g5;
	.dwpsn	file "../KERNEL/SOURCE/OS_TIMER.c",line 31,column 4,is_stmt
        INC       *+XAR5[3]             ; [CPU_] |31| 
	.dwpsn	file "../KERNEL/SOURCE/OS_TIMER.c",line 32,column 4,is_stmt
        CMP       AL,*+XAR5[3]          ; [CPU_] |32| 
        B         $C$L2,HI              ; [CPU_] |32| 
        ; branchcc occurs ; [] |32| 
$C$DW$L$_OSTimerTick$3$E:
$C$DW$L$_OSTimerTick$4$B:
;*** 34	-----------------------    (*ptcb).TimerCnt = 0u;
;*** 37	-----------------------    (K$1[(long)prio]).OSEvent |= 1u;
;*** 37	-----------------------    OSRdyMap |= 1u<<prio;
	.dwpsn	file "../KERNEL/SOURCE/OS_TIMER.c",line 37,column 6,is_stmt
        MOVB      AL,#6                 ; [CPU_] |37| 
        MOV       T,AR4                 ; [CPU_] |37| 
	.dwpsn	file "../KERNEL/SOURCE/OS_TIMER.c",line 34,column 5,is_stmt
        MOV       *+XAR5[3],#0          ; [CPU_] |34| 
	.dwpsn	file "../KERNEL/SOURCE/OS_TIMER.c",line 37,column 6,is_stmt
        MPYU      P,T,AL                ; [CPU_] |37| 
        MOVW      DP,#_OSRdyMap         ; [CPU_U] 
        MOVL      ACC,XAR7              ; [CPU_] |37| 
        ADDL      ACC,P                 ; [CPU_] |37| 
        MOVL      XAR0,ACC              ; [CPU_] |37| 
        MOVB      AL,#1                 ; [CPU_] |37| 
        OR        *+XAR0[4],#0x0001     ; [CPU_] |37| 
        LSL       AL,T                  ; [CPU_] |37| 
        OR        @_OSRdyMap,AL         ; [CPU_] |37| 
...
;***  	-----------------------    return;
	.dwpsn	file "../KERNEL/SOURCE/OS_TIMER.c",line 26,column 8,is_stmt
        SUBB      XAR6,#6               ; [CPU_U] |26| 
        MOVB      ACC,#6                ; [CPU_] |26| 
	.dwpsn	file "../KERNEL/SOURCE/OS_TIMER.c",line 43,column 3,is_stmt
        ADDB      XAR4,#1               ; [CPU_U] |43| 
	.dwpsn	file "../KERNEL/SOURCE/OS_TIMER.c",line 26,column 8,is_stmt
        ADDB      XAR5,#6               ; [CPU_U] |26| 
        CMPL      ACC,XAR6              ; [CPU_] |26| 
        B         $C$L1,LOS             ; [CPU_] |26| 
        ; branchcc occurs ; [] |26| 
...
$C$DW$10	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$10, DW_AT_name("D:\Project Program\Current Program\IVEM\IVEM4024\RD3\IVEM4024_28066_V304\IVEM4024\Debug\OS_TIMER.asm:$C$L1:1:1752202151")
	.dwattr $C$DW$10, DW_AT_TI_begin_file("../KERNEL/SOURCE/OS_TIMER.c")
	.dwattr $C$DW$10, DW_AT_TI_begin_line(0x1a)
...
$C$DW$20	.dwtag  DW_TAG_subrange_type
	.dwattr $C$DW$20, DW_AT_upper_bound(0x05)
	.dwendtag $C$DW$T$22
