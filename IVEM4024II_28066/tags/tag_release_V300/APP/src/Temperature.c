...
void sOverTempChk(void)
{
    ...
    {
        if(sbUnderLevelChk(g_wSolarBSTTemp, wSolarBSTOTBackPoint, 500, &s_uwSolarBSTTempWRChkCnt))
        {
    ...
    {
        if(sbOverLevelChk(g_wSolarBSTTemp, wSolarBSTOTPoint, 50, &s_uwSolarBSTTempWRChkCnt)||\
    ...
    if(fInvTempOver)
    {
        if(sbUnderLevelChk(g_wInvTemp, wInvOTBackPoint, 500, &s_uwInvTempWRChkCnt))
        {
            fInvTempOver = false;
        }
    }
    ...
    {
        if(sbOverLevelChk(g_wInvTemp, wInvOTPoint, 50, &s_uwInvTempWRChkCnt)||\
    ...
    {
        if(sbUnderLevelChk(g_wConvertLTemp, wConvertLOTBackPoint, 500, &s_uwConvertLTempWRChkCnt))
        {
    ...
    {
        if(sbOverLevelChk(g_wConvertLTemp, wConvertLOTPoint, 50, &s_uwConvertLTempWRChkCnt)||\
    ...
    if(fInnelTempOver)
    {
      if(sbUnderLevelChk(g_wInnelTemp, wInnelOTBackPoint, 500, &s_uwInnelTempWRChkCnt))
      {
    ...
    {
      if(sbOverLevelChk(g_wInnelTemp, wInnelOTPoint, 50, &s_uwInnelTempWRChkCnt))
      {
          fInnelTempOver = true;
      }
    }
    ...
    if(fLLC_TXTempOver)
    {
        if(sbUnderLevelChk(g_wLLC_TXTemp, wLLC_TXOTBackPoint, 500, &s_uwLLC_TXTempWRChkCnt))
        {
    ...
    {
        if(sbOverLevelChk(g_wLLC_TXTemp, wLLC_TXOTPoint, 50, &s_uwLLC_TXTempWRChkCnt))
        {
