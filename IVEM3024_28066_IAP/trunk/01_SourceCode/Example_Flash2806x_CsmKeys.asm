...
_PRG_key4  .word 0x2021  ; PSWD bits 79-64
_PRG_key5  .word 0x1109  ; PSWD bits 95-80
_PRG_key6  .word 0x1117  ; PSWD bits 111-96
_PRG_key7  .word 0x3000  ; PSWD bits 127-112
