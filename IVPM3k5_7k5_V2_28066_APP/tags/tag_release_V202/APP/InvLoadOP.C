...
//	if(wParaMode == cMasterMode)
	if(bPVMode == cBatteryMode)
	{
		...
		if(++s_uwTempDeratCnt >= 8)
		{
			...
			else if((g_wOPVoltCntl + cVac20v) < wOutputVoltRated)// ½µµÍ20V
			{
		...
		else if((g_wHardPortOPVoltCntl + cVac20v) < wOutputVoltRated)// ½µµÍ20V
		{
		...
		else if((g_BatCurOPVoltCntl + cVac20v) < wOutputVoltRated)// ½µµÍ30V
		{
		...
		else if((g_wOPVoltRealCntl + cVac20v) < wOutputVoltRated)// ½µµÍ30V
		{
