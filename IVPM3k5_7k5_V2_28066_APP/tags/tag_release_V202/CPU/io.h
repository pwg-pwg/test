...
/*******************�¼̵�����·������IO��********************/
//GRIDL.RLY.12VDRV
#define hoGRIDL_12VRLY     GpioDataRegs.GPADAT.bit.GPIO4
#define hoGRIDL_12VRLYOn 	GpioDataRegs.GPASET.bit.GPIO4 = 1
#define hoGRIDL_12VRLYOff 	GpioDataRegs.GPACLEAR.bit.GPIO4 = 1

//GRIDN.RLY.12VDRV
#define hoGRIDN_12VRLY     GpioDataRegs.GPADAT.bit.GPIO8
#define hoGRIDN_12VRLYOn 	GpioDataRegs.GPASET.bit.GPIO8 = 1
#define hoGRIDN_12VRLYOff 	GpioDataRegs.GPACLEAR.bit.GPIO8 = 1


//����̵���  OP.RLY.12VDRV
#define hoOP1_12VRLY     GpioDataRegs.GPADAT.bit.GPIO5
#define hoOP1_12VRLYOn 	GpioDataRegs.GPASET.bit.GPIO5 = 1
#define hoOP1_12VRLYOff 	GpioDataRegs.GPACLEAR.bit.GPIO5 = 1

//����̵���  OP2.RLY.12VDRV  (Ԥ����IVPA)
#define hoOP2_12VRLY     GpioDataRegs.GPADAT.bit.GPIO9
#define hoOP2_12VRLYOn 	GpioDataRegs.GPASET.bit.GPIO9 = 1
#define hoOP2_12VRLYOff 	GpioDataRegs.GPACLEAR.bit.GPIO9 = 1
...
#define loBuzz    		GpioDataRegs.GPBDAT.bit.GPIO52    //����������Դ�����������ߵ�ƽ���У�
