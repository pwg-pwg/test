...
;* Date/Time created: Wed Apr 09 19:46:39 2025                 *
;***************************************************************
...
;	C:\ti\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\24454\\AppData\\Local\\Temp\\143162 C:\\Users\\24454\\AppData\\Local\\Temp\\143164 
;	C:\ti\ccsv6\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\24454\\AppData\\Local\\Temp\\1431612 
	.sect	".text"
...
$C$L21:    
;***	-----------------------g5:
;*** 326	-----------------------    wRNewSinAmp = wRNewSinAmpTemp;
;***  	-----------------------    return;
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 326,column 2,is_stmt
        MOV       AL,@_wRNewSinAmpTemp  ; [CPU_] |326| 
        MOV       @_wRNewSinAmp,AL      ; [CPU_] |326| 
$C$DW$268	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$263, DW_AT_TI_end_line(0x147)
...
$C$DW$269	.dwtag  DW_TAG_subprogram, DW_AT_name("sRVoltRegu")
	...
	.dwattr $C$DW$269, DW_AT_TI_begin_line(0x115)
	.dwattr $C$DW$269, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$269, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 278,column 1,is_stmt,address _sRVoltRegu
...
_sRVoltRegu:
;*** 283	-----------------------    y$4 = wRNewSinAmp;
;*** 285	-----------------------    if ( (wInvVoltError = (int)wRTrackVolt-(int)wRInverterVoltNew) >= 100 ) goto g4;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$277	.dwtag  DW_TAG_variable, DW_AT_name("wRKVoltrack1")
	...
	.dwattr $C$DW$277, DW_AT_location[DW_OP_reg1]
        MOVW      DP,#_wRNewSinAmp      ; [CPU_U] 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 285,column 2,is_stmt
        SUB       AL,@_wRInverterVoltNew ; [CPU_] |285| 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 283,column 2,is_stmt
        MOVZ      AR7,@_wRNewSinAmp     ; [CPU_] |283| 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 285,column 2,is_stmt
        MOVZ      AR6,AL                ; [CPU_] |285| 
        CMPB      AL,#100               ; [CPU_] |285| 
        B         $C$L22,GEQ            ; [CPU_] |285| 
        ; branchcc occurs ; [] |285| 
;*** 291	-----------------------    if ( wInvVoltError > (-100) ) goto g5;
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 291,column 7,is_stmt
        CMP       AR6,#-100             ; [CPU_] |291| 
        B         $C$L23,GT             ; [CPU_] |291| 
        ; branchcc occurs ; [] |291| 
;*** 293	-----------------------    wInvVoltError = (-100);
;*** 293	-----------------------    goto g5;
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 293,column 3,is_stmt
        MOVL      XAR6,#-100            ; [CPU_] |293| 
        B         $C$L23,UNC            ; [CPU_] |293| 
        ; branch occurs ; [] |293| 
$C$L22:    
;***	-----------------------g4:
;*** 289	-----------------------    wInvVoltError = 100;
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 289,column 3,is_stmt
        MOVB      XAR6,#100             ; [CPU_] |289| 
$C$L23:    
;***	-----------------------g5:
;*** 298	-----------------------    wRNewSinAmpTemp = wInvVoltError*wRKVoltrack1-wInvVoltError0*wRKVoltrack2+y$4;
;*** 300	-----------------------    wInvVoltError0 = wInvVoltError;
;*** 302	-----------------------    sRAmpLimit(13000u, 1u);
;***  	-----------------------    return;
        MOV       T,AR4                 ; [CPU_] 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 298,column 2,is_stmt
        MPY       P,T,@_wInvVoltError0$1 ; [CPU_] |298| 
        MOV       T,AH                  ; [CPU_] |298| 
        MPY       ACC,T,AR6             ; [CPU_] |298| 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 300,column 2,is_stmt
        MOV       @_wInvVoltError0$1,AR6 ; [CPU_] |300| 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 298,column 2,is_stmt
        SUB       AL,PL                 ; [CPU_] |298| 
        ADD       AL,AR7                ; [CPU_] |298| 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 302,column 2,is_stmt
        MOVB      AH,#1                 ; [CPU_] |302| 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 298,column 2,is_stmt
        MOV       @_wRNewSinAmpTemp,AL  ; [CPU_] |298| 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 302,column 2,is_stmt
        MOV       AL,#13000             ; [CPU_] |302| 
$C$DW$278	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$278, DW_AT_low_pc(0x00)
	.dwattr $C$DW$278, DW_AT_name("_sRAmpLimit")
	.dwattr $C$DW$278, DW_AT_TI_call
        LCR       #_sRAmpLimit          ; [CPU_] |302| 
        ; call occurs [#_sRAmpLimit] ; [] |302| 
$C$DW$279	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$269, DW_AT_TI_end_line(0x12f)
...
$C$DW$290	.dwtag  DW_TAG_subprogram, DW_AT_name("sRInverterVoltFilter")
	...
	.dwattr $C$DW$290, DW_AT_TI_begin_line(0xfb)
	.dwattr $C$DW$290, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$290, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 252,column 1,is_stmt,address _sRInverterVoltFilter
...
;*** 255	-----------------------    wRInverterVolt = ((unsigned)ABS((int)(wRInverterVoltNew-wRInverterVolt)) > wFilter) ? wRInverterVoltNew : wRInverterVoltNew+wRInverterVolt>>1;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$292	.dwtag  DW_TAG_variable, DW_AT_name("wFilter")
	...
	.dwattr $C$DW$292, DW_AT_location[DW_OP_reg16]
        ...
        MOVW      DP,#_wRInverterVoltNew ; [CPU_U] 
        SETC      SXM                   ; [CPU_] 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 255,column 3,is_stmt
        MOV       AL,@_wRInverterVoltNew ; [CPU_] |255| 
        SUB       AL,@_wRInverterVolt   ; [CPU_] |255| 
        MOV       ACC,AL                ; [CPU_] |255| 
        ABS       ACC                   ; [CPU_] |255| 
        MOV       AH,AR6                ; [CPU_] |255| 
        CMP       AH,AL                 ; [CPU_] |255| 
        B         $C$L29,HIS            ; [CPU_] |255| 
        ; branchcc occurs ; [] |255| 
        MOV       AL,@_wRInverterVoltNew ; [CPU_] |255| 
        B         $C$L30,UNC            ; [CPU_] |255| 
        ; branch occurs ; [] |255| 
$C$L29:    
        MOV       AL,@_wRInverterVolt   ; [CPU_] |255| 
        ADD       AL,@_wRInverterVoltNew ; [CPU_] |255| 
        LSR       AL,1                  ; [CPU_] |255| 
$C$L30:    
;***  	-----------------------    return;
        MOV       @_wRInverterVolt,AL   ; [CPU_] |255| 
$C$DW$293	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$290, DW_AT_TI_end_line(0x105)
...
$C$DW$294	.dwtag  DW_TAG_subprogram, DW_AT_name("sRInverterVoltAdj")
	...
	.dwattr $C$DW$294, DW_AT_TI_begin_line(0xda)
	.dwattr $C$DW$294, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$294, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 219,column 1,is_stmt,address _sRInverterVoltAdj
...
;***************************************************************
_sRInverterVoltAdj:
;*** 220	-----------------------    wRInverterVoltNew = (unsigned long)wRInverterVoltRMS*(unsigned long)wRInverterVoltAdj>>11;
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$296	.dwtag  DW_TAG_variable, DW_AT_name("wRInverterVoltRMS")
	...
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 220,column 2,is_stmt
        MPYU      ACC,T,@_wRInverterVoltAdj ; [CPU_] |220| 
        SFR       ACC,11                ; [CPU_] |220| 
        MOV       @_wRInverterVoltNew,AL ; [CPU_] |220| 
$C$DW$297	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$294, DW_AT_TI_end_line(0xdd)
...
$C$DW$298	.dwtag  DW_TAG_subprogram, DW_AT_name("sRInverterInvLCurrAdj")
	...
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 224,column 1,is_stmt,address _sRInverterInvLCurrAdj
...
;*** 225	-----------------------    wRInverterInvLCurrNew = (unsigned long)wRInverterInvLCurrRMS*(unsigned long)wRInverterOPCurrAdj>>11;
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$300	.dwtag  DW_TAG_variable, DW_AT_name("wRInverterInvLCurrRMS")
	...
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 225,column 2,is_stmt
        MPYU      ACC,T,@_wRInverterOPCurrAdj ; [CPU_] |225| 
        SFR       ACC,11                ; [CPU_] |225| 
        MOV       @_wRInverterInvLCurrNew,AL ; [CPU_] |225| 
...
$C$DW$317	.dwtag  DW_TAG_subprogram, DW_AT_name("sL1InverterVoltAdj")
	...
	.dwattr $C$DW$317, DW_AT_TI_begin_line(0xe5)
	.dwattr $C$DW$317, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$317, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 230,column 1,is_stmt,address _sL1InverterVoltAdj
...
;***************************************************************
_sL1InverterVoltAdj:
;*** 232	-----------------------    wL1InverterVoltNew = wRInverterVoltRMS;
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$319	.dwtag  DW_TAG_variable, DW_AT_name("wRInverterVoltRMS")
	...
	.dwattr $C$DW$319, DW_AT_location[DW_OP_reg0]
        MOVW      DP,#_wL1InverterVoltNew ; [CPU_U] 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 232,column 2,is_stmt
        MOV       @_wL1InverterVoltNew,AL ; [CPU_] |232| 
$C$DW$320	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$317, DW_AT_TI_end_line(0xe9)
...
$C$DW$321	.dwtag  DW_TAG_subprogram, DW_AT_name("sL1InverterInvLCurrAdj")
	...
	.dwattr $C$DW$321, DW_AT_TI_begin_line(0xeb)
	.dwattr $C$DW$321, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$321, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 236,column 1,is_stmt,address _sL1InverterInvLCurrAdj
...
;*** 237	-----------------------    wL1InverterInvLCurrNew = (unsigned long)wRInverterInvLCurrRMS*(unsigned long)wL1InverterOPCurrAdj>>11;
;***  	-----------------------    return;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$323	.dwtag  DW_TAG_variable, DW_AT_name("wRInverterInvLCurrRMS")
	...
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 237,column 2,is_stmt
        MPYU      ACC,T,@_wL1InverterOPCurrAdj ; [CPU_] |237| 
        SFR       ACC,11                ; [CPU_] |237| 
        MOV       @_wL1InverterInvLCurrNew,AL ; [CPU_] |237| 
$C$DW$324	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$321, DW_AT_TI_end_line(0xee)
...
$C$DW$351	.dwtag  DW_TAG_subprogram, DW_AT_name("sInverterModuleInit")
	...
	.dwattr $C$DW$351, DW_AT_TI_begin_line(0x8a)
	.dwattr $C$DW$351, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$351, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 139,column 1,is_stmt,address _sInverterModuleInit
...
;*** 140	-----------------------    wRInverterVoltAdj = 2048u;
;*** 141	-----------------------    wInverterPVoltShort = 500u;
;*** 142	-----------------------    wInverterPCurrShort = 100u;
;*** 144	-----------------------    wInverterVoltHigh = (unsigned)swGetEEOutputVolt()+200u;
;*** 146	-----------------------    wInverterVoltLow = 1600u;
;*** 148	-----------------------    wInverterVoltSet = 2300u;
;*** 150	-----------------------    if ( sbGetEepromOutputFreq() ) goto g3;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
        MOVW      DP,#_wRInverterVoltAdj ; [CPU_U] 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 140,column 2,is_stmt
        MOV       @_wRInverterVoltAdj,#2048 ; [CPU_] |140| 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 141,column 2,is_stmt
        MOV       @_wInverterPVoltShort,#500 ; [CPU_] |141| 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 142,column 2,is_stmt
        MOVB      @_wInverterPCurrShort,#100,UNC ; [CPU_] |142| 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 144,column 2,is_stmt
$C$DW$352	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$352, DW_AT_low_pc(0x00)
	.dwattr $C$DW$352, DW_AT_name("_swGetEEOutputVolt")
	.dwattr $C$DW$352, DW_AT_TI_call
        LCR       #_swGetEEOutputVolt   ; [CPU_] |144| 
        ; call occurs [#_swGetEEOutputVolt] ; [] |144| 
        MOVB      AH,#200               ; [CPU_] |144| 
        MOVW      DP,#_wInverterVoltHigh ; [CPU_U] 
        ADD       AH,AL                 ; [CPU_] |144| 
        MOV       @_wInverterVoltHigh,AH ; [CPU_] |144| 
        MOVW      DP,#_wInverterVoltLow ; [CPU_U] 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 146,column 2,is_stmt
        MOV       @_wInverterVoltLow,#1600 ; [CPU_] |146| 
	.dwpsn	file "../MODULE/InverterModule/invertermodule.c",line 148,column 2,is_stmt
        MOV       @_wInverterVoltSet,#2300 ; [CPU_] |148| 
...
$C$DW$354	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$351, DW_AT_TI_end_line(0xcc)
