...
// #define IVPA //IVPA7548\10048
#define SECIVPM // IVPM7548\5048\3524

//³ÌÐòÈÕÆÚ
#define Year 2024 / 4 / 30
#define Month 4
#define Date 30

// ³ö³§Ä¬ÈÏÅäÖÃ
#define ShutdownSPS
#define TESTMODE	// ÔÊÐíÍ¨¹ýIO¿Ú½øÈëµ¥°å²âÊÔÄ£Ê½
#define FANSLEEP	// ÔÊÐí¿ÕÔØ×´Ì¬ÏÂ·çÉÈ²»×ª
#define OVLD2BATT	// µ±ÊÐµçµôµçÊ±Èç¹û¸ºÔØ¹ýÔØÔÊÐí×ªµç³ØÄ£Ê½¶ø²»Á¢¼´±¨¹ýÔØ¹ÊÕÏ
// #define MCU_PIN_100	// 100PIN/80PINÐ¾Æ¬
...
//#define SCCLCD	// ï¿½ï¿½ï¿½ï¿½LCD U2ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ê¾PWMï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ï¢
//#define RUNLED	// ï¿½ï¿½ï¿½Ôµï¿½
#define IOVER	2	// IOï¿½Þ¸Ä°æ±¾(ï¿½Î¿ï¿½IOï¿½Äµï¿½)

// EEPROM°æ±¾
#define cEEPROM_VER_1	0x0001		// ÊÊÓÃ105/106/107°æ±¾³ÌÐò
#define cEEPROM_VER_2	0x0002		// ÊÊÓÃ108°æ±¾³ÌÐò,Ó²¼þÔö¼ÓÊä³ö¼ÌµçÆ÷
...
#define cUseType			2
#define cLiBType			3
#define cPylonBType			4 // LMZ add in 2024-4-19
...
#define cPwmOtherFault			90 //MPPT Fault
#define cPwmOtherAlarm			91 //MPPT Alarm
...
#define cSFTRlyDelayTime 60
#define cOPRlyOnDelayTime 110
#define cOPRlyOffDelayTime 130
...
//#define	cTxtTempStatusBase		100	// ï¿½ï¿½Ñ¹ï¿½ï¿½ï¿½Â¶ï¿½×´Ì¬:ï¿½ï¿½100=1,ï¿½ï¿½110=2,ï¿½ï¿½120=3,ï¿½ï¿½130=4,ï¿½ï¿½140=5,ï¿½ï¿½150=6
#define	cTxtTempStatusBase		95//ï¿½ï¿½Ñ¹ï¿½ï¿½ï¿½Â¶ï¿½×´Ì¬:<94=0,ï¿½ï¿½95=1,ï¿½ï¿½105=2,ï¿½ï¿½115=3,ï¿½ï¿½125=4,ï¿½ï¿½135=5,ï¿½ï¿½145=6   
...
// #define	cHsTempStatusBase		50	// É¢ï¿½ï¿½Æ¬ï¿½Â¶ï¿½×´Ì¬:ï¿½ï¿½50=1,ï¿½ï¿½60=2,ï¿½ï¿½70=3,ï¿½ï¿½80=4
#define	cHsTempStatusBase		45	// É¢ï¿½ï¿½Æ¬ï¿½Â¶ï¿½×´Ì¬:<54=0,ï¿½ï¿½55=1,ï¿½ï¿½65=2,ï¿½ï¿½75=3,ï¿½ï¿½85=4
...
#define     cBMSCommFail            0x00100000 // add in 20240926
...
#define cParaMaxSize 1

#define	cAgingDiable		0	// ½ûÖ¹ÀÏ»¯
#define	cAgingCCMode		1	// ÀÏ»¯Ê¹ÓÃºãÁ÷·½Ê½ÀÏ»¯
#define	cAgingCVCCMode		2	// ÀÏ»¯Ê¹ÓÃºãÑ¹ºãÁ÷·½Ê½ÀÏ»¯

// ¿ª¹Ø¼üÄ£Ê½:
#define cPKM_OP_OFF			0	// ¿ª¹Ø¼ü¹Ø»úÊ±ÎÞÊä³ö
#define cPKM_OP_ON			1	// ¿ª¹Ø¼ü¹Ø»úÊ±ÓÐÊä³ö

#define cBM_ACTIVE_DIS		0	// BM¹¦ÄÜÊ¹ÄÜ
#define cBM_ACTIVE_EN		1	// BM¹¦ÄÜ½ûÖ¹

#define cBM_INTERVAL_DEF	30	// BMÖÜÆÚÊ±¼äÄ¬ÈÏ30Ìì
#define cBM_INTERVAL_MAX	90	// BMÖÜÆÚÊ±¼ä×î´ó90Ìì

#define cBM_TIMEOUT_DEF		4	// BM³¬Ê±Ê±¼äÄ¬ÈÏ4Ð¡Ê±
#define cBM_TIMEOUT_MAX		12	// BM³¬Ê±Ê±¼ä×î´ó12Ð¡Ê±
...
#define cBatVoltSolpeSumHighLever 18 // Ð±ï¿½Ê±ï¿½ï¿½ï¿½1.8V
