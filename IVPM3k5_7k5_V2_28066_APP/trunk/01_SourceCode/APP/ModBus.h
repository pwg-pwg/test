...
enum ATE_ID
{
	...
	ATE_L2OpCurrAdj0,	//0x25
	ATE_L2OpCurrAdj1,	//0x26
	ATE_L2OpCurrAdj2,	//0x27
	ATE_AddrEnd,
...
struct RealTimeDataStruct
{
	...
	INT16U wBMSFaultCode; // ¹ÊÕÏÂë°´Î»ÉÏ´«£¬ËùÓÐµç³Ø°ü¹ÊÕÏÂë»ã×ÜºóÔÙÉÏ´«
	//----- BMS summy data end -----//
	//----- BMS private data start -----//
	INT16U wRT_CurrBMSAddr;
	INT16U wRT_BMSConnectStatus; // b0: ´ú±íÁ¬½Ó×´Ì¬, b1~b14: Í¨Ñ¶µØÖ·1~Í¨Ñ¶µØÖ·15
	INT16U wRT_BMSCharVoltLimit;
	INT16U wRT_BMSDischarVoltLimit;
	INT16U wRT_BMSCharCurrLimit;
	INT16U wRT_BMSDischarCurrLimit;
	INT16U wRT_BmsStatusHi;
	INT16U wRT_BmsStatusLo;
	INT16U wRT_BmsFaultFlagHi;
	INT16U wRT_BmsFaultFlagLo;
	INT16U wRT_BmsAlarmFlagHi;
	INT16U wRT_BmsAlarmFlagLo;
	INT16U wRT_BmsNoticeFlagHi;
	INT16U wRT_BmsNoticeFlagLo;
	INT16U wRT_BmsTotalCurr;
	INT16U wRT_BmsTotalVolt;
	INT16U wRT_BmsReservd1;
	INT16U wRT_BmsReservd2;
	INT16U wRT_BmsTotalSOC;
	INT16U wRT_BmsTotalSOH;
	INT16U wRT_BmsTotalCapaHigh;
	INT16U wRT_BmsTotalCapaLow;
	INT16U wRT_BmsParallelNumber;
	INT16U wRT_BmsParallelStatus;
	INT16U wRT_BmsReservd3;
	INT16U wRT_BmsReservd4;
	INT16U wRT_BmsMaxCellVoltNo;
	INT16U wRT_BmsMaxCellVolt;
	INT16U wRT_BmsMinCellVoltNo;
	INT16U wRT_BmsMinCellVolt;
	INT16U wRT_BmsMaxCellTempNo;
	INT16U wRT_BmsMaxCellTemp;
	INT16U wRT_BmsMinCellTempNo;
	INT16U wRT_BmsMinCellTemp;
	INT16U wRT_SN[5];
	...
	INT16U wL2OpVA;
	//----- IVPA data end-----//
	INT16U wRT_BMSCellVolt[16];
	INT16U wRT_BMSCellTemp[8];
    INT16U wRT_SccFault[2];
    INT16U wRT_SccAlarm[2];
};
...
/* ModBus Comms Register Map Define */
#define REALDATA_REG_BASE_ADDR	0x1100				// ʵʱ���ݼĴ�����ʼ��ַ
#define REALDATA_REG_BASE_LEN	cRealTimeDataLen	// ʵʱ���ݼĴ�������

#define SETTING_REG_BASE_ADDR	0x2100				// EEPROM���ݼĴ�����ʼ��ַ
#define SETTING_REG_BASE_LEN	E1_Len+E2_Len+E3_Len+E4_Len	// EEPROM���ݼĴ�������

#define ATE_REG_BASE_ADDR		0x3100				// ATE���ݼĴ�����ʼ��ַ
#define ATE_REG_BASE_LEN		ATE_Len				// ATE���ݼĴ�������

#define FAULT_REG_BASE_ADDR		0x4100				// �������ݼĴ�����ʼ��ַ
#define FAULT_REG_BASE_LEN		cFaultDataLen		// �������ݼĴ�������

#define INFO_REG_BASE_ADDR		0xF800				// ϵͳ��Ϣ������ʼ��ַ
#define INFO_REG_LEN			cInfoDataLen		// ϵͳ��Ϣ���ݳ���

#define BMS_INFO_REG_BASE_ADDR	0xF831				// ç³»ç»Ÿä¿¡æ¯æ•°æ®èµ·å§‹åœ°å€
#define BMS_INFO_REG_LEN		cBMSInfoDataLen		// ç³»ç»Ÿä¿¡æ¯æ•°æ®é•¿åº¦

#define RECORD_DATA_BASE_ADDR	0xD000				// å½•æ³¢å™¨æ•°æ®å¯„å­˜å™¨èµ·å§‹åœ°å€
#define RECORD_DATA_LEN			cRecordDataLen		// å½•æ³¢å™¨æ•°æ®å¯„å­˜å™¨é•¿åº¦

#define RECORD_CMD_BASE_ADDR	0xFD00				// ¼����������ʼ��ַ
#define RECORD_CMD_LEN			cRecordCmdLen		// ¼���������
...
extern void sSnatchGraph(void);
extern void sOscDataBuffProc(void);

extern INT16U g_uwWifiLossCnt;
extern INT16U g_uwWifiConnectCnt;
