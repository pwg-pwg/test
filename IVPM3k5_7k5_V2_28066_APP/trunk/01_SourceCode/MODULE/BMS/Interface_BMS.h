...
#define cBMSCmdNoOKRollGap	2//3		//Inquiry com ok BMS by this counter first, and then inquiry another one which com not ok.
...
// #define cBMSCmdRollTime			75  // 3.75S
...
typedef struct
{
	...
	INT16S wBMSCellVoltMax;
	INT16S wBMSCellVoltMaxNo;
	INT16S wBMSCellVoltMin;
	INT16S wBMSCellVoltMinNo;
	INT16S wBMSCellTempMax;
	INT16S wBMSCellTempMaxNo;
	INT16S wBMSCellTempMin;
	INT16S wBMSCellTempMinNo;
	INT16S wBMSRSVD1;
	INT16S wBMSRSVD2;
	INT16S wBMSCellVolt01;
	INT16S wBMSCellVolt02;
	INT16S wBMSCellVolt03;
	INT16S wBMSCellVolt04;
	INT16S wBMSCellVolt05;
	INT16S wBMSCellVolt06;
	INT16S wBMSCellVolt07;
	INT16S wBMSCellVolt08;
	INT16S wBMSCellVolt09;
	INT16S wBMSCellVolt10;
	INT16S wBMSCellVolt11;
	INT16S wBMSCellVolt12;
	INT16S wBMSCellVolt13;
	INT16S wBMSCellVolt14;
	INT16S wBMSCellVolt15;
	INT16S wBMSCellVolt16;
	INT16S wBMSCellTemp01;
	INT16S wBMSCellTemp02;
	INT16S wBMSCellTemp03;
	INT16S wBMSCellTemp04;
	INT16S wBMSCellTemp05;
	INT16S wBMSCellTemp06;
	INT16S wBMSCellTemp07;
	INT16S wBMSCellTemp08;
}STRBMSRTInfo;
