...
//    g_strInvCurrCtrlPara.wFBKvn_1 = 76037/10;
//    g_strInvCurrCtrlPara.wFBKvn_2 = 75644/10;
	g_strInvCurrCtrlPara.wFBKvd_1 = 15606;//14745;//15606;
	g_strInvCurrCtrlPara.wFBKvd_2 = 7414;//6553;//7414;
	...
	g_strInvCurrCtrlPara.wFBKcn_0 = 14000;//14000;//11321;
	g_strInvCurrCtrlPara.wFBKcn_1 = 1269;
	g_strInvCurrCtrlPara.wFBKcn_2 = 8000;//8000;//10051;
...
//++++++++++++++++++++++++++++++++++++++++
	...
	{
 		g_strInvCurrCtrlPara.wFBImo_P = (INT16S)(((INT32S)pSinTab[g_wRSinPointerTemp] * g_strInvCurrCtrlPara.wFBVmo)>> 14);
	}
	else
	{	
