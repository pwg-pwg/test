...
void sInitialDSP(void)
{
	...
	IER |= (M_INT2 | M_INT3 | M_INT4 | M_INT9);
...
void sInitGpio(void)
{
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO4 		= 0;    // Enable pullup on				//Reserved
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO7 		= 0;	// Enable pullup on GPIO7      	//LLC.CH_SD
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO10 		= 0;   	// Enable pullup on GPIO10    	//BUS.SPS.SD
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO11 		= 0;   	// Enable pullup on GPIO11     //Reserved
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO16 		= 1; 	// Disable pullup on		    //BB_IOVER↓
	GpioCtrlRegs.GPAMUX2.bit.GPIO16     = 0;	// GPIO12 = I/O
	GpioCtrlRegs.GPADIR.bit.GPIO16      = 0;    // GPIO16 = Input

	GpioCtrlRegs.GPAPUD.bit.GPIO17		= 0;	// Enable pullup on			   //I-LLC.OVER↓
	GpioCtrlRegs.GPAQSEL2.bit.GPIO17 	= 3;	// Asynch input
	GpioCtrlRegs.GPAMUX2.bit.GPIO17 	= 3;	// GPIO17 = TZ3

	GpioCtrlRegs.GPAPUD.bit.GPIO18 		= 0;   	// Enable pullup on GPIO18     //GEN.BUSSOFT
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO20 		= 0;   	// Enable pullup on GPIO20     //GEN.SCR
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO28 		= 0;	// Enable pullup on GPIO28     //Reserved
	GpioDataRegs.GPACLEAR.bit.GPIO28	= 1;	// Load output latch to Low
	GpioCtrlRegs.GPADIR.bit.GPIO28 	    = 0;	// GPIO28 = I/O
	GpioCtrlRegs.GPAMUX2.bit.GPIO28 	= 1;	// GPIO28 = OUTPUT
	
	GpioCtrlRegs.GPAPUD.bit.GPIO29 		= 0;	// Enable pullup on GPIO29     //Reserved
	GpioDataRegs.GPACLEAR.bit.GPIO29	= 1;	// Load output latch to Low
	GpioCtrlRegs.GPADIR.bit.GPIO29 	    = 0;	// GPIO29 = I/O
	GpioCtrlRegs.GPAMUX2.bit.GPIO29 	= 1;	// GPIO29 = OUTPUT
	...
	GpioCtrlRegs.GPBMUX1.bit.GPIO32 	= 0;	// GPIO32 = 0=GPIO,  1=I2C-SCL,  2=SYNCI,  3=ADCSOCA	XXX
	...
	GpioCtrlRegs.GPBMUX1.bit.GPIO33 	= 0;	// 0=GPIO,  1=I2C-SCL,  2=SYNCO,  3=ADCSOCB		xxx
	GpioCtrlRegs.GPBDIR.bit.GPIO33 		= 1;	// 1=OUTput,  0=INput

	GpioCtrlRegs.GPBPUD.bit.GPIO34 		= 0;	// Enable pullup on GPIO34      //Reserved
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO35 		= 0;	// Enable pullup on GPIO35      //Reserved
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO36 		= 0;	// Enable pullup on GPIO36      //Reserved
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO37 		= 0;	// Enable pullup on GPIO37      //Reserved
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO38 		= 0;	// Enable pullup on GPIO38      //Reserved
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO39 		= 1;	// Enable pullup on GPIO39      //BAT.SPS.SD
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO44 		= 0;	// Disable pullup on GPIO44     //BUSSOFT.ON	xxx 资源配置表未标,原理图有
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO50 		= 1;	// Enable pullup on GPIO50      //INVI.OVER_IO
	GpioCtrlRegs.GPBMUX2.bit.GPIO50 	= 0;	// GPIO50 = I/O
	GpioCtrlRegs.GPBDIR.bit.GPIO50 		= 0;	// GPIO50 = INPUT

	GpioCtrlRegs.GPBPUD.bit.GPIO51 		= 0;	// Enable pullup on GPIO51      //LLC.CL_SD
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO52 		= 1;	// Enable pullup on GPIO50      //BUS_V.OVER_IO
	GpioCtrlRegs.GPBMUX2.bit.GPIO52 	= 0;	// GPIO50 = I/O
	GpioCtrlRegs.GPBDIR.bit.GPIO52 		= 0;	// GPIO50 = INPUT
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO56 		= 0;	// Enable pullup on GPIO56  	//Reserved
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO57 		= 0;	// Enable pullup on GPIO57       //GEN.N RLY
...
//	EPwm5Regs.ETSEL.bit.INTSEL 		= ET_CTR_PRD; 	//Enable event time-base counter equal to period.
	...
	//ePWM7  DCDC
	EALLOW;
//	EPwm7Regs.TZSEL.bit.OSHT2   = 1;                    //Enable TZ2 as one shot trip sources
...
//	EPwm5Regs.ETSEL.bit.INTSEL 	= ET_CTR_PRD;		//Enable event time-base counter equal to period.
	...
	//ePWM8  LLC
	EALLOW;
	EPwm8Regs.TZSEL.bit.OSHT3   = 1;                    //Enable TZ2 as one shot trip sources
	EPwm8Regs.TZCTL.bit.TZA 	= TZ_NO_CHANGE;         //do nothing
	EPwm8Regs.TZCTL.bit.TZB 	= TZ_NO_CHANGE;         //do nothing
	EPwm8Regs.TZEINT.bit.OST    = 1;					//Enable TZ interrupt
