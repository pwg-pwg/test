...
void sEEpromDataRangeChk(void)
{
	...
	if(swGetEEBatEqVolt() < 480 || swGetEEBatEqVolt() > 610)
	{
	...
	// Feed Power Set
	if(swGetEEFeedPower() < 0 || swGetEEFeedPower() > 6000)
	{
		sSetEEFeedPower(6000);
		bUserChangeFlag = 1;
	}
