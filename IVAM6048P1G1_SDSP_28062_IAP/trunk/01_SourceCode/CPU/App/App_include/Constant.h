...
#define cDSPVersion     ((Uint16)1001) 	//加入BootLoad
#define cVerDate        ((Uint16)40809)
#define cMachineMode    ((Uint16)8048)
...
#define cPowerRated              (float)8000.0   // 额定功率8k
#define cPvPowerMax              (float)5500.0  // 单路Pv 最大5500k
...
#define cIPvRated                (float)13.75f  // Pv最大电流26A 13.75 = cPvPowerMax/cVPvRated
#define cIInvRated               (float)25.0
...
#define cPvCurrMax               (float)26.0f  // Pv最大电流26A 18.75 = cPvPowerMax/cVPvRated
