...
#define JumpToApp()      		asm(" LB #0x3F5FF6")//查看CMD中APPBEGIN
#define APP_FLAG_ADD1        	0x3F5F7A			//查看CMD中APPFlagW
#define APP_FLAG_ADD2        	0x3F5F7B			//查看CMD中APPFlagW
#define APP_FLAG_ADD3        	0x3F5F7C			//查看CMD中APPFlagW
#define APP_FLAG_ADD4        	0x3F5F7D			//查看CMD中APPFlagW

//不同型号DSP以下的开始结束地址有别，需匹配
//#define		DSPAppFlashBeginAddr				(Uint32)0x003E8000			//DPS应用程序FLASH开始地址
//#define		DSPAppFlashEndAddr					(Uint32)0x003F3FFF			//DPS应用程序FLASH结束地址
