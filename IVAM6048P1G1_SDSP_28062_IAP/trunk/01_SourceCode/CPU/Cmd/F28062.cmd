...
PAGE 0 :   /* Program Memory */
   ...
   IAPFlagW		: origin = 0x3F7F7C, length = 0x000004,fill = 0x8888     /*IAP标志位 0x8888,仅用来合并APP,检查看两个程序合并对不对*/
   ...
   APPFlagW		: origin = 0x3F5F7A, length = 0x000004,fill = 0xAAAA	    /*APP标志位 0xAAAA,升级成功后由Iap擦写*/
