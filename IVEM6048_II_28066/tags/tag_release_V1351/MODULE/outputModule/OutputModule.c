...
void sOPPercentCal(void)
{
	...
	if(	mChkGridRlyOn() || sGetGenRlyOn())//市电带载
	{
		...
		{
			g_wGridCurrPercent = (INT16S)((INT32S)(g_uwROPCurr + g_uwRSmartOPCurr) * 100 / cMaxACInputCurr);
		}
	...
	dwROPWatt = ((INT32S)(g_dwROPWatt+g_dwRSmartOPWatt) * g_wOPVoltTransferRatio) >> 10;
