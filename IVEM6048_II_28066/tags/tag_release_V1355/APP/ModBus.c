...
//	uRealTimeData.Stru.wFaultMsg = 0;
	...
	uRealTimeData.Stru.wRLineCurr = 0;//(INT16S)(g_dwLinePowerWattCversion*100/g_uwRLineVolt);
	uRealTimeData.Stru.wRLineFreq = g_uwLineFreq;
	uRealTimeData.Stru.wRLineDCI = 0;
	uRealTimeData.Stru.wRLineWatt = 0;//(INT16S)(g_dwLinePowerWattCversion & 0xFFFF);//(g_dwOPWatt + g_dwSmartOPWatt - g_dwInvWatt);
