...
extern INT16U g_uwINVLoadOnSts;
...
extern INT16U bGenLossTest;
extern INT16U bGenPeakVoltLoss;
...
extern INT16U  g_uwMasterInqCnt;
...
const pFunc1	GetDataSubArray[100] =
{
	...
	swGetRGenVoltSample,    swGetRGenCurrSample,	    swGetLLC_TXTempSample,					//18-20	
	swGetRInvDCVoltSample,  swGetRInvCurr1Sample,	    swGetRInvCurr2Sample,				 	//21-23
	...
	swGetRGenVoltReal,      swGetRGenCurrReal,	        swReturnNull,							//42-44
	swGetRInvDCVoltReal,    swGetRInvCurr1Real,		    swGetRInvCurr2Real,					    //45-47
	swGetILLCAvgCurrReal,	swReturnNull,				(pFunc1)suwGetBoost1CtrlSts,			//48-50
	//PV Loop
...
//	sReadEeprom4();
	...
	g_uwAPPLoadOnSts = true;
	g_uwINVLoadOnSts = false;
...
//	wSciLength += 4;
	...
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + subGetPalGenLossStatus();
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + subGetGenVoltLossStatus();  //电压异常
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + subGetGenFreqLossStatus();  //频率异常
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + subGetGenWaveLossStatus();  //波形异常
	g_ubUserDataBuf0[sciid][wSciLength++] = cChar_Space;
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + hoGEN_SOFT_RLY;      //SOFT RLY
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + hoSMART_PORT_SCR;    //SCR  RLY
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + hoSMART_PORT_RLY;    //L    RLY
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + hoSMART_PORT_N_RLY;  //N    RLY 
	...
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + g_ubTimeUpdateFlag;
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + g_uwMasterInqCnt;
	g_ubUserDataBuf0[sciid][wSciLength++] = 'P';
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + uniEnergyInfo.Bit.uwACChgEn;
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + uniEnergyInfo.Bit.uwFeedPowerEn;
	g_ubUserDataBuf0[sciid][wSciLength++] = '0' + uniEnergyInfo.Bit.uwGridModePVBatPowerLoadEn;
			...
			&& (g_ubCommandBuffer[sciid][7] == 'R') && (g_ubCommandBuffer[sciid][8] == 'D'))//TSTLLCPRD
		{
			...
			else//cDCDCConvertPeriod
			{
				...
				if(!mChkDCDCLLCOn() && wTemp >= 200 && wTemp <= 800 )
				{
					...
					wTemp = (INT16S)((INT32S)370*10000/wTemp * cDCDCConvertPeriod / 10000);//Frequency*10
...
void sSwitchOnButtonProc(void)
{
	...
	else
	{
		if(!mChkIfSwOn())
		{
			...
			{
				s_wLoadOnOffCnt = 0;
				g_uwINVLoadOnSts = true;
				g_uwAPPLoadOnSts = true;
				g_uwStayStandby = false;
			}
		}
		else
		{
	...
	if(g_uwINVLoadOnSts && g_uwAPPLoadOnSts)
	{
		g_uwLoadOnSts = true;
	}
	else
