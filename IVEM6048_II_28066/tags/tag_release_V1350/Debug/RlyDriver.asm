...
;* Date/Time created: Wed Dec 04 21:42:27 2024                 *
;***************************************************************
...
;	D:\ccs software\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\opt2000.exe C:\\Users\\Lin\\AppData\\Local\\Temp\\549602 C:\\Users\\Lin\\AppData\\Local\\Temp\\549604 
;	D:\ccs software\ccsv7\tools\compiler\ti-cgt-c2000_6.1.0\bin\ac2000.exe -@C:\\Users\\Lin\\AppData\\Local\\Temp\\5496012 
	.sect	".text"
...
;***	-----------------------g5:
;*** 42	-----------------------    asm("\tSETC\tINTM");
;*** 43	-----------------------    C$1 = (unsigned)((unsigned long)pointer*4500uL/(unsigned long)g_wPwmPeriod)%(unsigned)gi_wPLLPointThreeSix;
...
;***	-----------------------g6:
;*** 34	-----------------------    asm("\tSETC\tINTM");
;*** 35	-----------------------    wRlyActionPointerTemp = ((unsigned)gi_wPLLPointerMax-(unsigned)((unsigned long)pointer*4500uL/(unsigned long)g_wPwmPeriod)%(unsigned)gi_wPLLPointerMax)%(unsigned)gi_wPLLPointerMax;
	SETC	INTM
        MOVW      DP,#_g_wPwmPeriod     ; [CPU_U] 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 35,column 3,is_stmt
        MOVX      TL,@_g_wPwmPeriod     ; [CPU_] |35| 
        SPM       #0                    ; [CPU_] 
        MOVL      XAR6,XT               ; [CPU_] |35| 
        MOVW      DP,#_gi_wPLLPointerMax ; [CPU_U] 
        MOV       T,#4500               ; [CPU_] |35| 
        MPYXU     P,T,AH                ; [CPU_] |35| 
        MOVB      ACC,#0                ; [CPU_] |35| 
        RPT       #31
||     SUBCUL    ACC,XAR6              ; [CPU_] |35| 
        MOV       AH,@_gi_wPLLPointerMax ; [CPU_] |35| 
        MOV       AL,PL                 ; [CPU_] |35| 
$C$DW$27	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$27, DW_AT_low_pc(0x00)
	.dwattr $C$DW$27, DW_AT_name("U$$MOD")
	.dwattr $C$DW$27, DW_AT_TI_call
        FFC       XAR7,#U$$MOD          ; [CPU_] |35| 
        ; call occurs [#U$$MOD] ; [] |35| 
        MOV       AH,AL                 ; [CPU_] |35| 
        MOV       AL,@_gi_wPLLPointerMax ; [CPU_] |35| 
        SUB       AL,AH                 ; [CPU_] |35| 
...
;***	-----------------------g7:
;*** 26	-----------------------    asm("\tSETC\tINTM");
;*** 27	-----------------------    wRlyActionPointerTemp = ((unsigned)gi_wPLLCtrlPointer+(unsigned)((unsigned long)pointer*4500uL/(unsigned long)g_wPwmPeriod)+1u)%(unsigned)gi_wPLLPointerMax;
	SETC	INTM
        MOVW      DP,#_g_wPwmPeriod     ; [CPU_U] 
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 27,column 3,is_stmt
        MOVX      TL,@_g_wPwmPeriod     ; [CPU_] |27| 
        SPM       #0                    ; [CPU_] 
        MOVL      XAR6,XT               ; [CPU_] |27| 
        MOVW      DP,#_gi_wPLLCtrlPointer ; [CPU_U] 
        MOV       T,#4500               ; [CPU_] |27| 
        MPYXU     P,T,AH                ; [CPU_] |27| 
        MOVB      ACC,#0                ; [CPU_] |27| 
        RPT       #31
||     SUBCUL    ACC,XAR6              ; [CPU_] |27| 
        MOV       AL,PL                 ; [CPU_] |27| 
        ADD       AL,@_gi_wPLLCtrlPointer ; [CPU_] |27| 
        ADDB      AL,#1                 ; [CPU_] |27| 
$C$L4:    
;*** 28	-----------------------    asm("\tCLRC\tINTM");
        MOVW      DP,#_gi_wPLLPointerMax ; [CPU_U] 
        MOV       AH,@_gi_wPLLPointerMax ; [CPU_] |27| 
...
;*** 64	-----------------------    bRlyRelatedTask2 = prio;
	...
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 62,column 3,is_stmt
        MOV       @_wRlyActionPointer2,AL ; [CPU_] |62| 
...
;*** 56	-----------------------    bRlyRelatedTask = prio;
	...
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 54,column 3,is_stmt
        MOV       @_wRlyActionPointer,AL ; [CPU_] |54| 
...
$C$DW$40	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$40, DW_AT_name("D:\CCS_Code\IVEM6048 II\IVEM6048_28066 II 20241014\IVEM6048_28066 II 20240923\IVEM6048_28066 II\IVEM6048\Debug\RlyDriver.asm:$C$L8:1:1733319747")
	.dwattr $C$DW$40, DW_AT_TI_begin_file("../DRIVER/RlyDriver/RlyDriver.c")
	.dwattr $C$DW$40, DW_AT_TI_begin_line(0x5e)
	.dwattr $C$DW$40, DW_AT_TI_end_line(0x5e)
...
$C$DW$42	.dwtag  DW_TAG_subprogram, DW_AT_name("sRlyActionDriver")
	...
	.dwattr $C$DW$42, DW_AT_TI_begin_line(0x45)
...
;***************************************************************
_sRlyActionDriver:
;*** 71	-----------------------    if ( wRlyActionPointer == 0xffffu || wRlyActionPointer != pointer && (wRlyActionPointer < (unsigned)gi_wPLLPointerMax || pointer) ) goto g3;
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwcfi	save_reg_to_reg, 78, 26
...
$C$DW$44	.dwtag  DW_TAG_variable, DW_AT_name("pointer")
	...
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 71,column 2,is_stmt
        ...
        ; branchcc occurs ; [] |71| 
        MOVW      DP,#_gi_wPLLPointerMax ; [CPU_U] 
        MOV       AH,@_gi_wPLLPointerMax ; [CPU_] |71| 
        MOVW      DP,#_wRlyActionPointer ; [CPU_U] 
...
$C$L10:    
;***	-----------------------g3:
;*** 80	-----------------------    if ( wRlyActionPointer2 == 0xffffu || wRlyActionPointer2 != pointer && (wRlyActionPointer2 < (unsigned)gi_wPLLPointerMax || pointer) ) goto g5;
	.dwpsn	file "../DRIVER/RlyDriver/RlyDriver.c",line 80,column 2,is_stmt
        ...
        ; branchcc occurs ; [] |80| 
        MOVW      DP,#_gi_wPLLPointerMax ; [CPU_U] 
        MOV       AH,@_gi_wPLLPointerMax ; [CPU_] |80| 
...
$C$DW$51	.dwtag  DW_TAG_subrange_type
	.dwattr $C$DW$51, DW_AT_upper_bound(0x05)
	.dwendtag $C$DW$T$22
