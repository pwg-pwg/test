...
#define    mLLCFrequency	      EPwm8Regs.TBPRD
...
#define    mLLCHWOverCurr()       EPwm8Regs.TZFLG.bit.OST 

#define    mClrLLCOverCurrTzF()   EALLOW;\
...
extern interrupt void Epwm8_tzInterrupt(void);
...
extern INT16S swGetFanClk1VoltSample(void);
extern INT16S swGetFanClk2VoltSample(void);
extern INT16S swSwitchOnVoltSample(void);
...
extern INT16S	swGetBusVmo(void);//DCDCÍâ»·Êä³ö
extern INT16S	swGetPDCDCPWM(void);
extern INT16S	swGetPDCDCImo(void);
extern INT16S	swGetPDCDCImErr(void);
...
extern INT8U sBatEqNewDateReach(void);
