...
IICEEPROM_IOCARD INT8U 		*sGet16KDefaultTable(void);
...
IICEEPROM_IOCARD INT8U 		*sGet20KDefaultTable(void);
...
IICEEPROM_IOCARD void sSetEepromGridRelayOnDelayComp(INT16S bBoolean);
IICEEPROM_IOCARD INT16S sbGetEepromGridRelayOnDelayComp(void);
IICEEPROM_IOCARD void sSetEepromGenRelayOnDelayComp(INT16S bBoolean);
IICEEPROM_IOCARD INT16S sbGetEepromGenRelayOnDelayComp(void);
