...
******************************************************************************/
const INT16U cEeprom16048DaultTable[cEepromTotalLength/2] =
{
	0		,// 0	输出模式
	0		,// 1	风机运行模式
	0xFFFF		,// 2	预留2
...
const INT16U cEeprom20048DaultTable[cEepromTotalLength/2] =
{
	0		,// 0	输出模式
	0		,// 1	风机运行模式
	0xFFFF		,// 2	预留2
...
//	}
	...
	if(g_wVAType == cb10KVAModel)
	{
		...
		if(sbGetEepromGridPeakShavingPower() > 10000)
		{
			sSetEepromGridPeakShavingPower(10000);
			bUserChangeFlag = 1;
		}
	}
	else if(g_wVAType == cb16KVAModel)//15K
	{
		...
		if(sbGetEepromPeakShavingCurr() > 690)
		{
			sSetEepromPeakShavingCurr(690);
			bUserChangeFlag = 1;
		}
		if(sbGetEepromGenInputMaxPower() > 60000)
		{
		...
		if(sbGetEepromGridPeakShavingPower() > 16000)
		{
			sSetEepromGridPeakShavingPower(16000);
			bUserChangeFlag = 1;
		}
	}
	else if(g_wVAType == cb12KVAModel)
	{
		...
		if(sbGetEepromPeakShavingCurr() > 520)
		{
			sSetEepromPeakShavingCurr(520);
			bUserChangeFlag = 1;
		}
		if(sbGetEepromGenInputMaxPower() > 60000)
		{
		...
		if(sbGetEepromGridPeakShavingPower() > 12000)
		{
			sSetEepromGridPeakShavingPower(12000);
			bUserChangeFlag = 1;
		}
	}
	else//8K
	{
		if(sbGetEepromMaxChgCurr() > 150)
		{
			sSetEepromMaxChgCurr(128);
			bUserChangeFlag = 1;
		}
		...
		if(sbGetEepromPeakShavingCurr() > 350)
		{
			sSetEepromPeakShavingCurr(350);
			bUserChangeFlag = 1;
		}
		if(sbGetEepromGenInputMaxPower() > 60000)
		{
		...
		if(sbGetEepromGridPeakShavingPower() > 8000)
		{
			sSetEepromGridPeakShavingPower(8000);
			bUserChangeFlag = 1;
		}
	}
...
//    }
	...
	{
		if(sbGetEepromMaxSolarChgCurr() > cIdc150A)
		{
			sSetEepromMaxSolarChgCurr(150);
			bUserChangeFlag = 1;
		}
...
void sSetEepromGridRelayOnDelayComp(INT16S bBoolean)
{
    uEepromCfg.EepromStructCfg.eSetGridRelayOnDelayComp = bBoolean;
}
INT16S sbGetEepromGridRelayOnDelayComp(void)
{
   return (uEepromCfg.EepromStructCfg.eSetGridRelayOnDelayComp);
}

void sSetEepromGenRelayOnDelayComp(INT16S bBoolean)
{
    uEepromCfg.EepromStructCfg.eSetGenRelayOnDelayComp = bBoolean;
}
INT16S sbGetEepromGenRelayOnDelayComp(void)
{
   return (uEepromCfg.EepromStructCfg.eSetGenRelayOnDelayComp);
}
...
INT8U *sGet16KDefaultTable(void)
{
    return((INT8U *)cEeprom16048DaultTable);
}
...
INT8U *sGet20KDefaultTable(void)
{
    return((INT8U *)cEeprom20048DaultTable);
}
