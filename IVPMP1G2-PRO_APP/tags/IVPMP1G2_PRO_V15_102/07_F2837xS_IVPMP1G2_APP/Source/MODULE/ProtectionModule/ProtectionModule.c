...
//	wTxtTempDerateBack15KVA = (INT16S)cTxtTempDerateBack15KVA + (2300 - swGetEepromOutputVolt())/2;
	wTxtTempDerate15KVA = (INT16S)cTxtTempDerate15KVA + (2300 - swGetEepromOutputVolt())*7/10;
	wTxtTempDerateBack15KVA = (INT16S)cTxtTempDerateBack15KVA + (2300 - swGetEepromOutputVolt())*7/10;
...
//			}
			...
			{
				wTempDerateRangeTx = ((wTempDegreeTxTemp - wTxtTempDerate15KVA)/10*96)>>6;
			}
...
void sAvrPvTempDeratingChk(INT16U bFilter)
{
	...
	static INT16S wPvTempChgCurrDerateRange4 = 150;//PV输出电流降额
...
INT16S sAvrInvTempDeratingChk(INT16U bFilter)
{
	...
	INT16S wTempDerateRangeInv = 69;//散热器温度逆变电流降额
	INT16S wTempDerateRangeInv1 = 69;//内环境温度逆变电流降额
	INT16S wTempDerateRangeInv2 = 69;//变压器温度逆变电流降额
	if(g_wVAType == cb10KVAModel)
	{
	...
	{
		wTempDerateRangeInv = 52;//散热器温度逆变电流降额
		wTempDerateRangeInv1 = 52;//内环境温度逆变电流降额
		wTempDerateRangeInv2 = 52;//变压器温度逆变电流降额
	}
	else if(g_wVAType == cb8000VAModel)
	{
...
//		}
	...
	//	}
		if(g_wVAType == cb16KVAModel)
		{
	        ...
	        {
	            wTempDerateRangeInv = 69 - (wTempDegreeInv - cInvCurHSTempDerate15KVA) * 5;
	        ...
	        {
	            wTempDerateRangeInv = 69;
	        }
	        //内环境温度降额计算
	        if(wTempDegreeInternal > 660)
	        {
	            //wTempDerateRangeInv1 = 65 - (((wTempDegreeInternal - 620) * 26)>>6);
	            wTempDerateRangeInv1 = 69 - (wTempDegreeInternal - 660)*40/100;
	        ...
	        {
	            wTempDerateRangeInv1 = 69;
	        }
	        //变压器温度降额计算
	        if(wTempDegreeTx > 109)
	        {
	            wTempDerateRangeInv2 = 69 - (wTempDegreeTx - 109)*3;
		...
		else if(g_wVAType == cb12KVAModel)//12K
		{
	        ...
	        {
	            wTempDerateRangeInv = 52 - (wTempDegreeInv - cInvCurHSTempDerate12KVA) * 15/10;
				if(wTempDerateRangeInv < 0)
				{
					wTempDerateRangeInv = 1;
				}
	        ...
	        {
	            wTempDerateRangeInv = 52;
	        }
	        //内环境温度降额计算
	        if(wTempDegreeInternal > 670)
	        {
	            //wTempDerateRangeInv1 = 65 - (((wTempDegreeInternal - 620) * 26)>>6);
	            wTempDerateRangeInv1 = 52 - (wTempDegreeInternal - 670)*26/100;
				if(wTempDerateRangeInv1 < 0)
				{
					wTempDerateRangeInv1 = 1;
				}
	        ...
	        {
	            wTempDerateRangeInv1 = 52;
	        }
	        //变压器温度降额计算
	        if(wTempDegreeTx > 110)
	        {
	            wTempDerateRangeInv2 = 52 - ((wTempDegreeTx - 110) * 110>>6);//一度降1.73A
	            if(wTempDerateRangeInv2 < 0)
				{
					wTempDerateRangeInv2 = 1;
				}
		...
		else//8K
		{
	        ...
	        if(wTempDegreeTx > 110)
	        {
	            wTempDerateRangeInv2 = 33 - (wTempDegreeTx - 110);//一度降1A
	            if(wTempDerateRangeInv2 < 0)
				{
					wTempDerateRangeInv2 = 1;
				}
...
//
		if(g_wVAType == cb16KVAModel)
		{
	        ...
	        {
	            wTempDerateRangeInv = 69 - (wTempDegreeInv - (cInvCurHSTempDerate15KVA - 6)) * 5;
				if(wTempDerateRangeInv < 0)
				{
					wTempDerateRangeInv = 1;
				}
	        ...
	        //内环境温度降额计算
	        if(wTempDegreeInternal  > 600)
	        {
	            //wTempDerateRangeInv1 = 65 - ((wTempDegreeInternal - 520) * 26)>>6;
	            wTempDerateRangeInv1 = 69 - (wTempDegreeInternal - 600)*40/100;
				if(wTempDerateRangeInv1 < 0)
				{
					wTempDerateRangeInv1 = 1;
				}
	        ...
	        if(wTempDegreeTx > 99)
	        {
	            wTempDerateRangeInv2 = 69 - (wTempDegreeTx - 99)*3;
				if(wTempDerateRangeInv2 < 0)
				{
					wTempDerateRangeInv2 = 1;
				}
		...
		else if(g_wVAType == cb12KVAModel)
		{
	        ...
	        {
	            wTempDerateRangeInv = 52 - (wTempDegreeInv - (cInvCurHSTempDerate12KVA - 8)) * 15/10;
				if(wTempDerateRangeInv < 0)
				{
					wTempDerateRangeInv = 1;
				}
	        ...
	        {
	            //wTempDerateRangeInv1 = 65 - ((wTempDegreeInternal - 520) * 26)>>6;
	            wTempDerateRangeInv1 = 52 - (wTempDegreeInternal - 590)*26/100;
				if(wTempDerateRangeInv1 < 0)
				{
					wTempDerateRangeInv1 = 1;
				}
	        ...
	        {
	            wTempDerateRangeInv2 = 52 - ((wTempDegreeTx - 100) * 110>>6);
				if(wTempDerateRangeInv2 < 0)
				{
					wTempDerateRangeInv2 = 1;
				}
		...
		{
			//散热器降额计算
	        if(wTempDegreeInv > (cInvCurHSTempDerate8KVA - 8))
	        {
	            wTempDerateRangeInv = 33 - (wTempDegreeInv - (cInvCurHSTempDerate8KVA - 8));
				if(wTempDerateRangeInv < 0)
				{
					wTempDerateRangeInv = 1;
				}
	        ...
	        {
	            //wTempDerateRangeInv1 = 65 - ((wTempDegreeInternal - 520) * 26)>>6;
	            wTempDerateRangeInv1 = 33 - (wTempDegreeInternal - 590)*16/100;
				if(wTempDerateRangeInv1 < 0)
				{
					wTempDerateRangeInv1 = 1;
				}
	        ...
	        if(wTempDegreeTx > 100)
	        {
	            wTempDerateRangeInv2 = 33 - (wTempDegreeTx - 100);
				if(wTempDerateRangeInv2 < 0)
				{
					wTempDerateRangeInv2 = 1;
				}
	...
	if(g_wVAType == cb16KVAModel)
	{
		if(wTempDerateRangeInv > 69)
		{
			wTempDerateRangeInv = 69;
		}
		else if(wTempDerateRangeInv < 1)//最低降到1A
		{
			wTempDerateRangeInv = 1;
		}
		if(wTempDerateRangeInv < 69)
...
//	wTempDegreeTx = (INT16S)uEepromCfg.EepromStructCfg.eSetRsvd186;
	OS_EXIT_CRITICAL();
}
