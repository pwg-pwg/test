...
// #define SCCLCD	// 閸忎浇顔廘CD U2閻ｅ矂娼伴弰鍓с仛PWM閹貉冨煑閸ｃ劋淇婇幁?
//#define RUNLED	// 鐠嬪啳鐦悘?
#define IOVER	2	// IO娣囶喗鏁奸悧鍫熸拱(閸欏倽鈧儐O閺傚洦銆?)

// EEPROM版本
#define cEEPROM_VER_1	0x0001		// 适用105/106/107版本程序
#define cEEPROM_VER_2	0x0002		// 适用108版本程序,硬件增加输出继电??
...
#define cPwmSciLoss				81  //add
#define cPwmChgCurrReverse		82  //add
...
//#define	cTxtTempStatusBase		100	// 鍙樺帇鍣ㄦ俯搴︾姸锟??:锟??100=1,锟??110=2,锟??120=3,锟??130=4,锟??140=5,锟??150=6
#define	cTxtTempStatusBase		95//鍙樺帇鍣ㄦ俯搴︾姸锟??:<94=0,锟??95=1,锟??105=2,锟??115=3,锟??125=4,锟??135=5,锟??145=6   
...
// #define	cHsTempStatusBase		50	// 鏁ｇ儹鐗囨俯搴︾姸锟??:锟??50=1,锟??60=2,锟??70=3,锟??80=4
#define	cHsTempStatusBase		45	// 鏁ｇ儹鐗囨俯搴︾姸锟??:<54=0,锟??55=1,锟??65=2,锟??75=3,锟??85=4
