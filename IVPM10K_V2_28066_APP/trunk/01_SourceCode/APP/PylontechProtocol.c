...
union PYLON_BMS_STATUS_TABLE
{
	struct PYLON_BMS_STATUS_BIT_FEILD
	{
		...
		INT16U ChargeImmediately1:1;	// ǿ����?
		INT16U DischargeEnable:1;		// �ŵ�ʹ��
		INT16U ChargeEnable:1;			// ���ʹ��?
	} bits;
	INT8U data;
};
...
void sNumToAscii_16Hex(INT16U wNumber,INT8U *pbBuffer)
{
	...
	{
		if(sbDigitExtract_16Hex(wNumber, bIndex) != '0') // Ѱ������?
		{
			break;
		}
	}
...
//		else 
	...
	{
		if(!g_strPylonBMSComSts[g_uwPylonBMSCmdAddrID].fBMSComOK)//��ID��BMSͨ�Ų�����(��ǰҲδ���յ�)
		{
			//�����ID��������?
			...
			g_strPylonBMSComSts[g_uwPylonBMSCmdAddrID].fBMSCmdIndex = cPylonBMSCmd_Data1;
			g_strPylonBMSComSts[g_uwPylonBMSCmdAddrID].fBMSComTimeoutCnt = 0;
			g_uwPylonBMSCmdAddrID++;//��ѯ��һ��ID����Ϣ
		}
		else
		{
			//����ID��ǰ������Ϣ����ʱ��������������ѯ��
			//������5���ٴ���(ע��ʵ�ⵥ��BMS�飬ͨ�Ŵ����������ͼ���(2-4)�εģ����������е�1��1�ӣ�������һ��ID���߼�)
...
//	else
	{
		for(wCnt = 1; wCnt <= cPylonBMSAddrIDMax; wCnt++)
		{
			if(g_strPylonBMSComSts[wCnt].fBMSComOK)
			{
				...
				if(g_strBMSCtrlLogicInfo.wBMSFaultCode == 0)
				{
					...
					if(ucTemp1 != 0 || ucTemp2 != 0)
					{
						if(ucTemp2 !=0 )
						{
							if(ucTemp1 & 0x08)
							{
								g_strBMSCtrlLogicInfo.wBMSFaultCode = 14;//ϵͳ���ϱ���
							}
				...
				lBmsCurrSumTemp += strBmsRealTimeData[wCnt].wBattTotalCurr;
			}
...
//	static INT8U  wAddrIdCnt = 1;	//��ַ��1��ʼ��ѯ
	INT8U  wAddrIdCnt = 1;	//��ַ��1��ʼ��ѯ
