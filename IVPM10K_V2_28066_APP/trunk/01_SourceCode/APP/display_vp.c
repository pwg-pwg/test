...
//    {2, char0, char1}, 	//  CF_OP_VOLT_ID
	...
	// {2, char1, char6},		 //CF_BMS_SET_ID  ï¿½ï¿½ï¿½ï¿½16
...
{
    INT16U Temp;
    if(swGetEEMachineModelOnOFF()==1) //allow display machine model
    {
        ...
        // else if(14 == swGetEepromIDLength()) // the first grow IVPS SN is 14 Length
        // {
...
{ 
    ...
    switch(bPVMode) 
    {
        ...
        case cStandbyMode:
        case cFaultMode:
            if(hoGRID_L_RLY == 1 && mOPRLYChk()==cOPRLYOn)
            {
	...
	/*	ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ï·ï¿½ï¿½ï¿½ï¿½ï¿?(=3)ï¿½ï¿½WIFIï¿½ï¿½ï¿½ï¿½;
		ï¿½ï¿½ï¿½IOTï¿½è±¸Ã»ï¿½ï¿½ï¿½ï¿½MCUï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½(=0)ï¿½ï¿½WIFIï¿½ï¿½;
		ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ó´ï¿½ï¿½ï¿?(=1)ï¿½ï¿½WIFIï¿½ï¿½1ï¿½ë£¬ï¿½ï¿½2ï¿½ï¿½
		ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿?(=4)ï¿½ï¿½WIFIï¿½ï¿½1ï¿½ë£¬ï¿½ï¿½2ï¿½ï¿½;
		ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Â·ï¿½ï¿½ï¿½ï¿?(=2)ï¿½ï¿½WIFIï¿½ï¿½1ï¿½ë£¬ï¿½ï¿½1ï¿½ï¿½;
		ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½IOTï¿½è±¸ï¿½ï¿½ï¿½ï¿½(=5)ï¿½ï¿½WIFIï¿½ï¿½0.5ï¿½ë£¬ï¿½ï¿½0.5ï¿½ï¿½:  */
	...
	else
	{
		...
		{	
			...
			{  		  		  
				...
				if(bSlectIndex == SELECT_BAT_BMS_ID && !fBMSConnectFlg) //BMS not connect, dont display SOC and BMS num
				{
					bSlectIndex ++;
				}				
			...
			if(bIsAdjustVal == 1) 
			{
				...
				|| (cInvOnKeyPressBit == wKeyVal)) 
				{
					...
					else if(bMenuIndex == CF_BAT_TYPE_ID)  //5
					{
						...
						// if(bBatTypeIDTemp%MAX_BAT_TYPE_ID>=3){ //ï¿½Ì¶ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½9600ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
...
void  sSaveConfiguration(void) 
{
    ...
    */
    ...
    if(bBatTypeID != sbGetEepromBatteryType())
    {
		...
		else if(sbGetEepromBatteryType() == cLiBType)//ï¿½ï¿½ï¿½Ä£Ê½ï¿½ï¿½ÎªLIB
        {
			wVlaueTemp = cBat14v4 * swGetBatteryPcs();
        	sSetEepromBatCVVolt(wVlaueTemp);
            sSetEepromBatFloatVolt(wVlaueTemp);
		...
		//------ ï®µï¿½ï¿½ï¿½ï¿½ï¿½Í¶ï¿½ï¿½Ô¶ï¿½ï¿½ï¿½ï¿½?9600bpsï¿½ï¿½ï¿½ï¿½ï®µï¿½Ä¶ï¿½ï¿½Ô¶ï¿½ï¿½ï¿½ï¿½?2400bps ------//
		// if(sbGetEepromBatteryType() <= cUseType && sbGetEepromBMSSetEn())       { sSetEepromBMSOption(0); } //ï¿½Ì¶ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½9600ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
...
void sDisplayOPVol(void)
{
	...
	if(bPVMode == cBatteryMode)
	{
		...
		&& hoGRID_L_RLY == 1 && mOPRLYChk()==cOPRLYOn)
	{
		wTemp = (swGetRInverterVoltNew()+5)/10;
	}
...
void sDisplayU1Version(void)
{
	...
	else
	{
		...
		// wTemp1 = cDebugVersion;
		// sViewFigModule(cFIG_TYPE_7, FIG4_7SEG, charA, cALWAYS_LIGHT);
		// sFigGroupDisplayNum(FIG5_7SEG, 1, wTemp1, cALWAYS_LIGHT);
	}
}
...
INT8U sbDisplayWarning(void)
{
	...
	if(ubWarnCodeDisPlayFlag)
	{
		...
		if(   (sbGetEepromBatteryType() == cLiBType || sbGetEepromBatteryType() == cPylonBType)
		   && !fBMSConnectFlg
		   && ((g_uwBMSPollingNum > 3) || (g_uwPylonBMSPollingNum > 3)) )  // BMSÍ¨ÐÅ¶ªÊ§3´Î #80
		{
			ubWarnCodeTab[ubdisWarnCnt++] = WR_BMSConnect_Code;
			sSetWarningCode(cBMSCommFail);
			// if(sbGetLineLossStatus() == false) //ÊÐµçÕý³£²»½øÈë´ý»úÄ£Ê½
			// {
			// 	;
			// }
			// else if(bPVMode!=cLineMode)
			// {
			//     wBMSFailtoStanbyFlag = 1;
			// 	OSEventSend(cPrioSuper, eSuperToStandby); // Í¨ÐÅ¶ªÊ§3´ÎÂÖÑ¯£¬×ª´ý»ú
			// }
		}
		else
		{
			sClrWarningCode(cBMSCommFail);
			// wBMSFailtoStanbyFlag = 0;
		}
  ...
  {      
	...
	else
	{
	  ...
	  else if(bMenuIndex ==  CF_OP_VOLTADJ_ID)
      {
  	 ...
  	 {
  	 		sFigGroupDisplayLetter(FIG4_7SEG, (INT8U *)&cFactoryConfigNum[CF_MACHINE_MODEL_ID][0], bConfigItemFlashStatus);	 //ï¿½ï¿½Ê¾ï¿½Ëµï¿½Ò³ï¿½ï¿½ï¿½Ð¼ï¿½
			sFigGroupDisplayLetter(FIG1_7SEG, (INT8U *)&FactoryRemindTab[CF_MACHINE_MODEL_ID][0], bConfigItemFlashStatus);   //Òªï¿½ï¿½Ê¾ï¿½ï¿½ï¿½ï¿½Ä¿ FIG1  MOD 
			sFigGroupDisplayLetter(FIG6_7SEG, (INT8U *)&cEnaDisTAB[wMachineModelTemp][0], bConfigContentFlashStatus); //enableï¿½ï¿½disableï¿½ï¿½ 
  	 }	
			...
			{
				{
					if((cDownKeyPressBit == wKeyVal) || (cUpKeyPressBit == wKeyVal)) 
					{
						...
						{				   
							...
							{
								if(wInvVoltBiasVaue < 500)// if(wInvVoltBiasVaue <295)
								{
									wInvVoltBiasVaue += 5;
								}
						...
						else if(cDownKeyPressBit == wKeyVal) 
						{
							...
							{*/
								...
								{
									// wMachineModelTemp = ~wMachineModelTemp;
					...
					else if(cEnterKeyPressBit == wKeyVal) 
					{
						if(bFactoryIsAdjustVal ==1)
						{
							bFactoryIsAdjustVal = 2;
								...
								{
									wMachineModel = wMachineModelTemp; //ENTERï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Â£ï¿½È·ï¿½ï¿½Ê±ï¿½ï¿½ï¿½ï¿½ï¿½Ä±ï¿½ï¿½ï¿½Ð´ï¿½ï¿½
									bFactoryIsAdjustVal = 3;    //wMachineModelTempï¿½ï¿½Öµï¿½ï¿½Ê½ï¿½ï¿½Öµï¿½ï¿½wMachineModel
								} 
						}
						/*
						else
