...
INT16S wBatLinePeak;		// Î´Ê¹ï¿½ï¿½
INT16S wBatAvg8times;
INT16S wEstimateLinePeak;	// Î´Ê¹ï¿½ï¿½
INT16S wLinePeak;
...
void sGridTask(void)
{
    ...
    while(1)
    {
        ...
        if(event&(1<<eGridLineZero))
        {
            ...
            sRLineVoltChk(5);		 //  3
			sRLineVoltSPShutdown(5); //µ¥¶À¿ª»ú£¬ÊÐµçÉÏÏÞ290VAC¹Ø±ÕAC¸¨Ô´ÊäÈë¼ÌµçÆ÷£¬285VAC»Ö¸´
...
void sCalMaxCurAccept(void)
{
	static INT16S wAcAdjChgCurr = 0;	// ï¿½Ðµç¶¯Ì¬ï¿½ï¿½ï¿½Úµï¿½ï¿½ï¿½
	static INT16U wAcAdjChkCnt1 = 0;
	static INT16U wAcAdjChkCnt2 = 0;
	INT16U wLineVoltTemp;	// ï¿½Ðµï¿½ï¿½Ñ?
	INT16S wHsTempMax;		// É¢ï¿½ï¿½Æ¬ï¿½ï¿½ï¿½ï¿½Â¶ï¿?(ï¿½ï¿½ï¿½ï¿½ï¿?/PWMï¿½ï¿½ï¿½ï¿½ï¿½ï¿½)
	INT16S wAcChgCurrMax;	// ï¿½Ðµï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½:40A/50A/60A/80A
	INT16S wAcVoltChgCurr;	// ï¿½Ðµï¿½ï¿½Ñ¹ï¿½ï¿½ï¿½ï¿?
	INT16S wTxtTempChgCurr;	// ï¿½ï¿½Ñ¹ï¿½ï¿½ï¿½ï¿½ï¿½Â½ï¿½ï¿½ï¿½
	INT16S wInvTempChgCurr;	// É¢ï¿½ï¿½Æ¬ï¿½ï¿½ï¿½Â½ï¿½ï¿½ï¿½
	INT16S wSccAdjChgCurr;	// SCCï¿½ï¿½Ì¬ï¿½ï¿½ï¿½Úµï¿½ï¿½ï¿½
	INT16S wmBMSBatMaxChgCurr;
	INT16S wEepromMaxChgCur;
	
	// ï¿½ï¿½ï¿½Ý»ï¿½ï¿½ï¿½Ñ¡ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ðµï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
	if(g_wAcChgCurrMax == cIdc130A)
	{
		wAcChgCurrMax = cIdc130A;
	}
	...
	// ï¿½ï¿½ï¿½ï¿½SCCï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ÊµÊ±ï¿½ï¿½ï¿½ï¿½ï¿½Ðµï¿½ï¿½ï¿½ï¿½ï¿½ï¿?
	if(wSccChgCurr > 0)
	{
	...
	// ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿?/ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ÊµÊ±ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ð?
	...
	wMaxVmUpLimit =(INT16S)bMaxACChgCur*70;//
}

void sChgCurrHighUpdate(void)			// ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
{
