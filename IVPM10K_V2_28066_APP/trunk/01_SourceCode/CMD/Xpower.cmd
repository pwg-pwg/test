...
PAGE 0:    /* Program Memory */
   ...
   FLASHPVINV  : origin = 0x3D8000, length = 0x018000     /*pv inverter use*/
   FLASHA      : origin = 0x3F0000, length = 0x001000     /* on-chip FLASH */
   FLASHC      : origin = 0x3F1000, length = 0x001E00	  //0x001000     /* on-chip FLASH */
   FLASHB      : origin = 0x3F2E00, length = 0X0010FE	  //0x000FFD     /* on-chip FLASH */
   STARCODE	   : origin = 0x3F3EFE, length = 0x000100
   FLASHFLAG   : origin = 0x3F3FFE, length = 0x000001 
...
PAGE 1 :   /* Data Memory */
  ...
  /* RAMSYSSTK   : origin = 0x000000, length = 0x000200
   ...
   RAMH0       : origin = 0x00D000, length = 0x002000     /* on-chip RAM block H0 *///原为C0000开始地址
   ...
   RAML1       : origin = 0x00A000, length = 0x003000     /* on-chip RAM block L1 *///原为2000长
