...
struct RealTimeDataStruct
{
	...
	INT16S wSccHsTemp;
	INT16U wSccChgMode;
	INT16U wSccFaultMsg;   // 4397 0x112D
	INT16U wOPShareCurr;
	INT16U wMachineStatus; // 4399 0x112F
	//----- BMS summy data start -----//
	INT16U wBMSFlag; 	   // 4400 0x1130
	...
	INT16U wBMSFaultCode; // 锟斤拷锟斤拷锟诫按位锟较达拷锟斤拷锟斤拷锟叫碉拷匕锟斤拷锟斤拷锟斤拷锟斤拷锟杰猴拷锟斤拷锟较达拷
	//----- BMS summy data end -----//
	//----- BMS private data start -----//
	INT16U wRT_CurrBMSAddr;
	INT16U wRT_BMSConnectStatus; // b0: 锟斤拷锟斤拷锟斤拷锟斤拷状态, b1~b14: 通讯锟斤拷址1~通讯锟斤拷址15
...
#define SETTING_REG_BASE_LEN	E1_Len+E2_Len+E3_Len+E4_Len	// EEPROM数据寄存器长??
...
#define RECORD_CMD_LEN			cRecordCmdLen		// 录波器命令长??
