...
void	sLineChgTask(void)
{
	if(swGetGRIDChgDischgEnDisable()  && (swGetWorkMode() != cFaultMode))
	{
		if(swGRIDChgDischgSwitch() == uwGetLineChgCurr1())		// 一档充电
		{
			mCHGOFBITOn;
			mCHG10AOn;
			uwRLineChgCurrTemp = uwGetLineChgCurr1() * 1000;
		}
		else if(swGRIDChgDischgSwitch() == uwGetLineChgCurr2())	// 二档充电
		{
			mCHGOFBITOn;
			mCHG10AOff;
			uwRLineChgCurrTemp = uwGetLineChgCurr2() * 1000;
		}
		else			// 如果都不是设置的档位，关市电充电
		{
			mCHG10AOn;
			uwRLineChgCurrTemp = 0;
			mCHGOFBITOff;
		}
	}
	else	// 关充电
...
//	if(uwRLineChgCurr < uwRLineChgCurrTemp)
//	{
//		uwRLineChgCurr++;
//	}
//	else if(uwRLineChgCurr > uwRLineChgCurrTemp)
//	{
//		uwRLineChgCurr = uwRLineChgCurrTemp;
//	}
//	else
	{
		uwRLineChgCurr = uwRLineChgCurrTemp;
...
//	{
//		if(wRLineFreqNew > 6100)
//		{
//			wRLineFreqNew = 6100;
//		}
//		else if(wRLineFreqNew < 5900)
//		{
//			wRLineFreqNew = 5900;
//		}
//	}
...
//	{
//		if(wRLineFreqNew > 5100)
//		{
//			wRLineFreqNew = 5100;
//		}
//		else if(wRLineFreqNew < 4900)
//		{
//			wRLineFreqNew = 4900;
//		}
//	}
