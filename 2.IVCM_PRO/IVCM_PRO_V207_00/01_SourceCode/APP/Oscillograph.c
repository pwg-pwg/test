...
#define	cOSC_SRC_NUM_MAX		55//100
...
{
	swReturnNull,
	swGetAdcGridVoltReal,			swGetPllTheta,					swGetAdcInvVoltReal, 	//3
	swGetBatVoltFilter,				swGetAdcBatVoltReal, 			sGetLoopOutput,			//6
	swGetAdcInvCurrReal, 			swGetBatVoltNew,				swGetInvtCtrlVref,	//9
	swReturnNull,					swReturnNull,					swReturnNull,	//12
	swReturnNull,					swGetROpWattNew, 				swReturnNull,	//15
	swReturnNull,					swReturnNull, 					swReturnNull,	//18
	
	swReturnNull,					swReturnNull,					swReturnNull, 	//21
	swReturnNull,					swReturnNull, 					swReturnNull,	//24
	swReturnNull, 					swReturnNull,					swReturnNull,	//27
	swReturnNull,					swReturnNull,					swReturnNull,	//30
	swReturnNull,					swReturnNull, 					swReturnNull,	//33
	swReturnNull,					swReturnNull, 					swReturnNull,	//36
	
//	swReturnNull,					swReturnNull,					swReturnNull, 	//39
//	swReturnNull,					swReturnNull, 					swReturnNull,	//42
//	swReturnNull, 					swReturnNull,					swReturnNull,	//45
//	
//	swReturnNull,					swReturnNull,					swReturnNull,	//48
//	swReturnNull,					swReturnNull, 					swReturnNull,	//51
//	swReturnNull,					swReturnNull, 					swReturnNull,	//54
//	
//	swReturnNull,					swReturnNull,					swReturnNull, 	//57
//	swReturnNull,					swReturnNull, 					swReturnNull,	//60
//	swReturnNull, 					swReturnNull,					swReturnNull,	//63
//	swReturnNull,					swReturnNull,					swReturnNull,	//66
//	swReturnNull,					swReturnNull, 					swReturnNull,	//69
//	swReturnNull,					swReturnNull, 					swReturnNull,	//72
//	
//	swReturnNull,					swReturnNull,					swReturnNull,	//75
