...
//		EEPROM2
		...
		{
			if(uwGetModelVar() == cCtrlIVCM3024)
			{
		...
		{
			if((WrData <= 100) && (WrData < suwGetEEBatChgCutoffSOC()))
			{
...
extern INT16S wHsTempDeratROpVolt;				// 过温降额负载电压
extern INT16S wHsTarTempDeratROpVolt;			// 过温降额负载电压
extern INT16S wHsInvTempDeratROpVolt;			// 过温降额负载电压
extern INT16S wBatDeratROpVolt;					// BAT欠压降额负载电压
extern INT16S wWattDeratROpVolt;				// 功率降额负载电压
extern INT16S g_wPDCDCPWM;
extern INT16U g_uwBusVoltOpenAdj;
extern INT16S g_wPDCDCPWM_OPEN;

extern INT16U g_wPDCDCPWM_OPEN_Test;
extern INT16S g_wPDCDCPWM_OPEN_Test_2;
extern INT16U g_wPDCDCPWM_OPEN_Test_3;
extern INT16U uwBatSOCvalue;
...
INT16U	swTestCmdRead(INT16U RdAddr)
{
	...
	switch(RdAddr)
	{
		...
		break;
		case DBG_XXXXXXX10:
			wTemp = wHsTempDeratROpVolt;
		break;
		case DBG_XXXXXXX11:
			wTemp = wHsTarTempDeratROpVolt;
		break;
		case DBG_XXXXXXX12:
			wTemp = wHsInvTempDeratROpVolt;
		break;
		case DBG_XXXXXXX13:
			wTemp = wBatDeratROpVolt;
		break;
		case DBG_XXXXXXX14:
			wTemp = 14;
		break;
		case DBG_XXXXXXX15:
			wTemp = g_uwBusVoltOpenAdj;//0xFFFF
		break;
		case DBG_XXXXXXX16:
			wTemp = suwGetDCDCCtrlSts();//0
		break;
		case DBG_XXXXXXX17:
			wTemp = suwGetEEPDCDCOpenLoopEnable();//0
		break;
		case DBG_XXXXXXX18:
			wTemp = swGetAgingStatus();//0xFFFF
		break;
		case DBG_XXXXXXX19:
			wTemp = g_wPDCDCPWM;//0xFFFF
		break;
		case DBG_XXXXXXX1A:
			wTemp = g_wPDCDCPWM_OPEN_Test;
		break;
		case DBG_XXXXXXX1B:
			wTemp = g_wPDCDCPWM_OPEN_Test_2;
		break;
		case DBG_XXXXXXX1C:
			wTemp = g_wPDCDCPWM_OPEN_Test_3;
		break;
		case DBG_XXXXXXX1D:
			wTemp = uwBatSOCvalue;
		break;
...
INT8U	swTestCmdWrite(INT16U WrAddr, INT16U WrData)
{
	...
	switch(WrAddr)
	{
		...
		break;
		case DBG_XXXXXXX1A:
			g_wPDCDCPWM_OPEN_Test = WrData;
		break;
		case DBG_XXXXXXX1B:
			g_wPDCDCPWM_OPEN_Test_2 = WrData;
		break;
		case DBG_XXXXXXX1C:
			g_wPDCDCPWM_OPEN_Test_3 = WrData;
		break;
		case DBG_XXXXXXX1D:
			uwBatSOCvalue = WrData;
		break;
		case DBG_XXXXXXX1E:
			;
		break;
