...
#define cCtrlV207					207			//  
#define cDspCtrlVersion				cCtrlV207	// 当前编译版本

// 临时版本
#define cCtrlV00					0			// 初始版本
#define cCtrlV01					1 			// V206 给MPPT的CV电压改成用EEPROM的CV电压
#define cCtrlV02					2 			// V206 加SOC判断，修改LLC软起，逆变限流值
#define cCtrlV03					3 			// V206 LLC改为过零关
#define cCtrlV04					4			// 
#define cCtrlV05					5			// 
#define cCtrlV06					6			// 
#define cCtrlV07					7			// 
