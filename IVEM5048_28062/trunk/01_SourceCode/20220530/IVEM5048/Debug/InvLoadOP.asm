...
;* Date/Time created: Mon May 30 14:14:43 2022                 *
;***************************************************************
...
;	C:\Work\Software\CCS5.4\ccsv5\tools\compiler\c2000_6.1.3\bin\opt2000.exe C:\\Users\\Daily\\AppData\\Local\\Temp\\021804 C:\\Users\\Daily\\AppData\\Local\\Temp\\021806 
;	C:\Work\Software\CCS5.4\ccsv5\tools\compiler\c2000_6.1.3\bin\ac2000.exe -@C:\\Users\\Daily\\AppData\\Local\\Temp\\0218014 
	.sect	".text"
...
;***	-----------------------g20:
;*** 579	-----------------------    if ( g_dwInvChgLimit > 400L ) goto g23;
...
;*** 588	-----------------------    if ( !(*(&GpioDataRegs+1)&0x800u) ) goto g29;
	...
	.dwpsn	file "../APP/InvLoadOP.C",line 588,column 2,is_stmt
        ...
        ; branchcc occurs ; [] |588| 
;*** 590	-----------------------    g_dwBatChgLimit = C$9 = 400L-(long)g_uwROPCurr;
...
;*** 672	-----------------------    if ( y$691 > 4240L ) goto g47;
	...
	.dwpsn	file "../APP/InvLoadOP.C",line 672,column 2,is_stmt
        MOVL      ACC,XAR4              ; [CPU_] |672| 
        CMPL      ACC,XAR6              ; [CPU_] |672| 
        B         $C$L54,LT             ; [CPU_] |672| 
        ; branchcc occurs ; [] |672| 
;*** 676	-----------------------    if ( y$691 >= 20L ) goto g48;
;*** 678	-----------------------    g_dwPVFeedLoadLimit = 20L;
;*** 678	-----------------------    goto g48;
	.dwpsn	file "../APP/InvLoadOP.C",line 676,column 7,is_stmt
        MOVB      ACC,#20               ; [CPU_] |676| 
        CMPL      ACC,XAR6              ; [CPU_] |676| 
	.dwpsn	file "../APP/InvLoadOP.C",line 678,column 3,is_stmt
        MOVL      @_g_dwPVFeedLoadLimit,ACC,GT ; [CPU_] |678| 
        B         $C$L55,UNC            ; [CPU_] |678| 
        ; branch occurs ; [] |678| 
$C$L54:    
;***	-----------------------g47:
;*** 674	-----------------------    g_dwPVFeedLoadLimit = 4240L;
	.dwpsn	file "../APP/InvLoadOP.C",line 674,column 3,is_stmt
        MOVL      @_g_dwPVFeedLoadLimit,XAR4 ; [CPU_] |674| 
$C$L55:    
;***	-----------------------g48:
;*** 681	-----------------------    if ( y$692 > 4240L ) goto g51;
	.dwpsn	file "../APP/InvLoadOP.C",line 681,column 2,is_stmt
        MOVL      ACC,XAR4              ; [CPU_] |681| 
        CMPL      ACC,XAR7              ; [CPU_] |681| 
        B         $C$L56,LT             ; [CPU_] |681| 
        ; branchcc occurs ; [] |681| 
;*** 685	-----------------------    C$5 = -g_dwPVFeedLoadLimit;
;*** 685	-----------------------    if ( y$692 >= C$5 ) goto g52;
;*** 687	-----------------------    g_dwInvChgLimit = C$5;
;*** 687	-----------------------    goto g52;
	.dwpsn	file "../APP/InvLoadOP.C",line 685,column 7,is_stmt
        MOVL      ACC,@_g_dwPVFeedLoadLimit ; [CPU_] |685| 
        NEG       ACC                   ; [CPU_] |685| 
        CMPL      ACC,XAR7              ; [CPU_] |685| 
	.dwpsn	file "../APP/InvLoadOP.C",line 687,column 3,is_stmt
        MOVL      @_g_dwInvChgLimit,ACC,GT ; [CPU_] |687| 
        B         $C$L57,UNC            ; [CPU_] |687| 
        ; branch occurs ; [] |687| 
$C$L56:    
;***	-----------------------g51:
;*** 683	-----------------------    g_dwInvChgLimit = 4240L;
	.dwpsn	file "../APP/InvLoadOP.C",line 683,column 3,is_stmt
        MOVL      @_g_dwInvChgLimit,XAR4 ; [CPU_] |683| 
$C$L57:    
;***	-----------------------g52:
...
$C$DW$299	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$299, DW_AT_TI_call
        ...
        BF        $C$L65,NEQ            ; [CPU_] |692| 
        ; branchcc occurs ; [] |692| 
;*** 716	-----------------------    if ( gi_wInvChgCurrLimit < 4240 ) goto g56;
        MOVW      DP,#_gi_wInvChgCurrLimit ; [CPU_U] 
	.dwpsn	file "../APP/InvLoadOP.C",line 716,column 3,is_stmt
        CMP       @_gi_wInvChgCurrLimit,#4240 ; [CPU_] |716| 
        B         $C$L58,LT             ; [CPU_] |716| 
        ; branchcc occurs ; [] |716| 
;*** 722	-----------------------    gi_wInvChgCurrLimit = 4240;
;*** 722	-----------------------    goto g57;
	.dwpsn	file "../APP/InvLoadOP.C",line 722,column 4,is_stmt
        MOV       @_gi_wInvChgCurrLimit,#4240 ; [CPU_] |722| 
        B         $C$L59,UNC            ; [CPU_] |722| 
        ; branch occurs ; [] |722| 
$C$L58:    
;***	-----------------------g56:
;*** 718	-----------------------    ++gi_wInvChgCurrLimit;
	.dwpsn	file "../APP/InvLoadOP.C",line 718,column 4,is_stmt
        INC       @_gi_wInvChgCurrLimit ; [CPU_] |718| 
$C$L59:    
;***	-----------------------g57:
...
;** 1363	-----------------------    wDerateWatt = (wBatAvgVolt-420)*67/5+4000;
;** 1365	-----------------------    if ( wBatAvgVolt < 420 ) goto g11;
...
;** 1386	-----------------------    goto g21;
	.dwpsn	file "../APP/InvLoadOP.C",line 1385,column 7,is_stmt
        MOV       @_g_wOPVoltCntl,AR0   ; [CPU_] |1385| 
...
;** 1441	-----------------------    s_wBusVoltDrt = wOutputVoltRated;
	.dwpsn	file "../APP/InvLoadOP.C",line 1441,column 4,is_stmt
        MOV       @_s_wBusVoltDrt$1,AR0 ; [CPU_] |1441| 
$C$L105:    
;***	-----------------------g32:
...
$C$DW$328	.dwtag  DW_TAG_subprogram, DW_AT_name("sKpwmUpdate")
	...
	.dwattr $C$DW$328, DW_AT_TI_begin_line(0x106)
...
$C$DW$334	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$328, DW_AT_TI_end_line(0x119)
...
$C$DW$335	.dwtag  DW_TAG_subprogram, DW_AT_name("sFrePhaseLockProc")
	...
	.dwattr $C$DW$335, DW_AT_TI_begin_line(0x144)
...
$C$DW$355	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$335, DW_AT_TI_end_line(0x160)
...
$C$DW$356	.dwtag  DW_TAG_subprogram, DW_AT_name("sControllerRefUpdate")
	...
	.dwattr $C$DW$356, DW_AT_TI_begin_line(0x162)
...
$C$DW$374	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$356, DW_AT_TI_end_line(0x1f1)
...
$C$DW$375	.dwtag  DW_TAG_subprogram, DW_AT_name("ACInputPowerCal")
	...
	.dwattr $C$DW$375, DW_AT_TI_begin_line(0x4ea)
...
$C$DW$379	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$375, DW_AT_TI_end_line(0x503)
...
$C$DW$380	.dwtag  DW_TAG_subprogram, DW_AT_name("sACOutputVoltChgChk")
	...
	.dwattr $C$DW$380, DW_AT_TI_begin_line(0x135)
...
$C$DW$385	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$380, DW_AT_TI_end_line(0x142)
...
$C$DW$386	.dwtag  DW_TAG_subprogram, DW_AT_name("sEnergyInfoUpdate")
	...
	.dwattr $C$DW$386, DW_AT_TI_begin_line(0x505)
...
$C$DW$398	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$386, DW_AT_TI_end_line(0x530)
...
$C$DW$399	.dwtag  DW_TAG_subprogram, DW_AT_name("sInputOutputRvsChk")
	...
	.dwattr $C$DW$399, DW_AT_TI_begin_line(0x5b0)
...
$C$DW$406	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$399, DW_AT_TI_end_line(0x5c0)
...
$C$DW$407	.dwtag  DW_TAG_subprogram, DW_AT_name("sInvLoadOPTask")
	...
	.dwattr $C$DW$407, DW_AT_TI_begin_line(0x9a)
...
$C$DW$472	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$472, DW_AT_name("Z:\02_VmwareShare\Project\01_HFInverter\01_IVEM\01_IVEM5048\03_IVEM5048Ver28062\01_MainCode\trunk\IVEM5048\Debug\InvLoadOP.asm:$C$L158:1:1653891283")
	.dwattr $C$DW$472, DW_AT_TI_begin_file("../APP/InvLoadOP.C")
	.dwattr $C$DW$472, DW_AT_TI_begin_line(0xa4)
	.dwattr $C$DW$472, DW_AT_TI_end_line(0x103)
...
$C$DW$474	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$474, DW_AT_low_pc($C$DW$L$_sInvLoadOPTask$24$B)
	.dwattr $C$DW$474, DW_AT_high_pc($C$DW$L$_sInvLoadOPTask$24$E)
$C$DW$475	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$475, DW_AT_low_pc($C$DW$L$_sInvLoadOPTask$25$B)
	.dwattr $C$DW$475, DW_AT_high_pc($C$DW$L$_sInvLoadOPTask$25$E)
$C$DW$476	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$476, DW_AT_low_pc($C$DW$L$_sInvLoadOPTask$16$B)
	.dwattr $C$DW$476, DW_AT_high_pc($C$DW$L$_sInvLoadOPTask$16$E)
$C$DW$477	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$477, DW_AT_low_pc($C$DW$L$_sInvLoadOPTask$11$B)
	.dwattr $C$DW$477, DW_AT_high_pc($C$DW$L$_sInvLoadOPTask$11$E)
...
$C$DW$483	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$483, DW_AT_low_pc($C$DW$L$_sInvLoadOPTask$8$B)
	.dwattr $C$DW$483, DW_AT_high_pc($C$DW$L$_sInvLoadOPTask$8$E)
...
$C$DW$490	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$490, DW_AT_low_pc($C$DW$L$_sInvLoadOPTask$17$B)
	.dwattr $C$DW$490, DW_AT_high_pc($C$DW$L$_sInvLoadOPTask$17$E)
...
$C$DW$496	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$496, DW_AT_low_pc($C$DW$L$_sInvLoadOPTask$26$B)
	.dwattr $C$DW$496, DW_AT_high_pc($C$DW$L$_sInvLoadOPTask$26$E)
$C$DW$497	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$497, DW_AT_low_pc($C$DW$L$_sInvLoadOPTask$23$B)
	.dwattr $C$DW$497, DW_AT_high_pc($C$DW$L$_sInvLoadOPTask$23$E)
	.dwendtag $C$DW$472

	.dwattr $C$DW$407, DW_AT_TI_end_file("../APP/InvLoadOP.C")
	.dwattr $C$DW$407, DW_AT_TI_end_line(0x104)
...
$C$DW$509	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$509, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x02)
