...
INT32U gi_udwConvertTempSampleSumTemp;
INT32U gi_udwConvertTempSampleSum;
INT16U gi_uwConvertTempSampleSumCntTemp;
INT16U gi_uwConvertTempSampleSumCnt;
...
interrupt void INVInterrupt(void)
{
	...
	{
		wPhaseLockPoint = g_wRSinPointer;
	}
...
//	
//	g_dwSinAngleQ7 += g_uwInverterStep + swInverterStepCompensation(16384);	//Q14	22-8
//
//	if(g_dwSinAngleQ7 >= 46080)	//360*128
//	{ 
//		g_uwInverterStep= g_uwInverterStepTemp;
//		g_uwNewStepResidue = g_uwNewStepResidueTemp;
//
//		g_dwSinAngleQ7 -= 46080;
//
//		dwCapTemp = ECap3Regs.TSCTR;         //INV.V 
//		gi_udwSineZeroTimeNewTemp = dwCapTemp - (INT32U)((g_dwSinAngleQ7 * cPWMCntlPeriod50Hz)/g_uwInverterStep);
//		gi_uwSinePeriodNewTemp=(INT16U)((gi_udwSineZeroTimeNewTemp-gi_udwSineZeroTimeOld)/150);
//		gi_udwSineZeroTimeOld=gi_udwSineZeroTimeNewTemp;
//		gi_uwSinePeriodCntNew = gi_uwSinePeriodNewTemp;
//		gi_uwLinePeriodCntNew = gi_uwLinePeriodNew;//gi_uwLinePeriodNewTemp;
...
//		if(gi_wParallelEnable == cOP_3P2)
//		{
//			gi_wPhaseLockPoint = g_dwSinAngleQ7 + 15360;//120 degree	120<<7	//R phase
//		}
//		else if(gi_wParallelEnable == cOP_3P3)
//		{
//			gi_wPhaseLockPoint = g_dwSinAngleQ7 + 30720;//240 degree	240<<7	//R phase
//		}
//		else
//		{
//			gi_wPhaseLockPoint = g_dwSinAngleQ7;
//		}
//
//		if(gi_wPhaseLockPoint >= 46080)
//		{
//			gi_wPhaseLockPoint -= 46080;
//		}
//		
//		if(gi_wPhaseLockPoint < 23040)		//180 degree
//		{
//			hoSYNTXDOn;
//		}
//		else
...
//	if(gi_wParallelEnable == cOP_3P2)
//	{
//		g_dwSinAngleQ7Temp = gi_wPhaseLockPoint + 30720;//240 degree	240<<7
//	}
//	else if(gi_wParallelEnable == cOP_3P3)
//	{
//		g_dwSinAngleQ7Temp = gi_wPhaseLockPoint + 15360;//120 degree	120<<7
//	}
//	else
//	{
//		g_dwSinAngleQ7Temp = gi_wPhaseLockPoint;
//	}
//
//	g_dwSinAngleQ7Temp += g_wSinAngleQ7bias;
//
////	if(g_uwParaMode == cMasterMode)
////	{
////		g_dwSinAngleQ7Temp = g_dwSinAngleQ7 + g_wSinAngleQ7bias;
////	}
////	else
////	{
////		g_dwSinAngleQ7Temp = g_dwSinAngleQ7;
////	}
//	
//	if(g_dwSinAngleQ7Temp >= 46080)g_dwSinAngleQ7Temp -= 46080;
//
//	g_wSinAngle = (INT16S)(g_dwSinAngleQ7Temp >> 7);
//	g_wSinAngleResQ7 = g_dwSinAngleQ7Temp - ((INT32S)g_wSinAngle << 7);
//	if(g_wSinAngle >= 360) g_wSinAngle -= 360;	
//	g_wSinValueR = SinTab361[g_wSinAngle] + (INT16S)(((INT32S)g_wSinAngleResQ7 * (SinTab361[g_wSinAngle+1] - SinTab361[g_wSinAngle])) >> 7);
//
////	if(++g_wRSinPointer >= 1012)//gi_wSinePointMax)		38Hz, 2*26 per cycle
////	{
////		//g_wRSinPointer = 0; 
////		g_wRSinPointer = 1012;
////	}
//
//	g_wRSinPointer = (INT16S)(g_dwSinAngleQ7Temp / 120);	//g_dwSinAngleQ7 * 384 / 360 >> 7
//	if(g_wRSinPointer >= gi_wSinePointMax)
//	{
//		g_wRSinPointer = 0;
//	}
...
//	gi_wRInvCurr1Sample 	= 	(ADCRESULT0 >> 4) - 2048 - gi_wRInvCurrSampleBias;
////	gi_wSInvCurr1Sample 	= 	(ADCRESULT1 >> 4) - 2048 - gi_wSInvCurrSampleBias;
////	gi_wTInvCurr1Sample 	= 	(ADCRESULT2 >> 4) - 2048 - gi_wTInvCurrSampleBias;
//	gi_wRInvVoltSample 	= 	(ADCRESULT3 >> 4) - 2048;
////	gi_wSInvVoltSample 	= 	(ADCRESULT4 >> 4) - 2048;
////	gi_wTInvVoltSample 	= 	(ADCRESULT5 >> 4) - 2048;
//	gi_wROPCurrSample 	= 	(ADCRESULT6 >> 4) - 2048 - gi_wROPCurrSampleBias;
////	gi_wSOPCurrSample 	= 	(ADCRESULT7 >> 4) - 2048;
////	gi_wTOPCurrSample 	= 	(ADCRESULT8 >> 4) - 2048;
//	gi_wROPShareCurrSample 	= 	(ADCRESULT9 >> 4) - 2048 - gi_wROPShareCurrSampleBias;
////	gi_wSOPShareCurrSample 	= 	(ADCRESULT10 >> 4) - 2048;
////	gi_wTOPShareCurrSample 	= 	(ADCRESULT11 >> 4) - 2048;
//	gi_wRLineVoltSample 	= 	(ADCRESULT12 >> 4) - 2048;
////	gi_wSLineVoltSample 	= 	(ADCRESULT13 >> 4) - 2048;
////	gi_wTLineVoltSample 	= 	(ADCRESULT14 >> 4) - 2048;
////	gi_wGFCISample		=	(ADCRESULT15 >> 4) - 2048;

	gi_wSolarBSTTempSample 	= 	(ADCRESULT0 >> 4);
	gi_wROPShareCurrSample 	= 	(ADCRESULT1 >> 4) - 2048 + gi_wROPShareCurrSampleBias;
	gi_wRInvCurr1Sample		= 	(ADCRESULT2 >> 4) - 2048 - gi_wRInvCurrSampleBias;
	gi_wROPCurr1Sample 		= 	(ADCRESULT3 >> 4) - 2048 - gi_wROPCurrSampleBias;
	gi_wSolarCurr1Sample 	= 	(ADCRESULT4 >> 4);
	gi_wSolarVolt1Sample	=	(ADCRESULT5 >> 4);
	gi_wPBusVoltSample 		= 	(ADCRESULT6 >> 4);
	gi_wConvertTempSample	=	(ADCRESULT7 >> 4);
	gi_wPDCDCAvgCurrSample	=	(ADCRESULT8 >> 4)  - 2048 + gi_wPDCDCAvgCurrSampleBias;
	gi_wRInvDCVoltSample	=	(ADCRESULT9 >> 4)  - 2048 - gi_wRInvDCVoltSampleBiasSet;
	gi_wInnelTempSample		=	(ADCRESULT10 >> 4);
	gi_wInvTempSample		=	(ADCRESULT11 >> 4);
	gi_wRInvVoltSample		=	(ADCRESULT12 >> 4)	- 2048;
	gi_wPDCDCCurr1Sample	=	(ADCRESULT13 >> 4)	- 2048 + gi_wPDCDCCurrSampleBias;
	gi_wBatVoltSample		=	(ADCRESULT14 >> 4);
	gi_wROPVoltSample		=	(ADCRESULT15 >> 4)	- 2048;
...
//			OSISREventSend(cPrioSuper, eSuperFault);	
	...
	{
		if(wRInvOverCurrFlg || (g_wBusRealVoltHighFlg && g_uwFBInvCtrlSts == cFBInvCtrlBus))
		{
			if(gi_wInvPWMEn)
			{
				gi_wInvPWMEn = false;
	...
	if(g_uwFBInvCtrlSts == cFBWait || gi_wInvPWMEn == false || g_uwFaultCode != 0)
	{
		mDisINVPWMOut();
		hoINVPWMENOff;
		gi_wInvPWMDisCnt = 2;
...
//	}
	...
	gi_udwConvertTempSampleSumTemp += gi_wConvertTempSample;
	gi_uwConvertTempSampleSumCntTemp++;
...
//	gi_wPDCDCCurrSample 	= 	(ADCRESULT0 >> 4)  - 2048 - gi_wPDCDCCurrSampleBias;
////	gi_wNDCDCCurrSample 	= 	(ADCRESULT1 >> 4)  - 2048 - gi_wNDCDCCurrSampleBias;
//	gi_wPDCDCAvgCurrSample 	= 	(ADCRESULT2 >> 4)  - 2048 - gi_wPDCDCAvgCurrSampleBias;
////	gi_wNDCDCAvgCurrSample 	= 	(ADCRESULT3 >> 4)  - 2048 - gi_wNDCDCAvgCurrSampleBias;
//	gi_wBatVoltSample 		= 	(ADCRESULT4 >> 4);
////		gi_wROPVoltSample 		= 	(ADCRESULT5 >> 4)  - 2048;
////		gi_wSOPVoltSample 		= 	(ADCRESULT6 >> 4)  - 2048;
////		gi_wTOPVoltSample 		= 	(ADCRESULT7 >> 4)  - 2048;
//	gi_wRInvCurr2Sample 		= 	(ADCRESULT5 >> 4)  - 2048 - gi_wRInvCurrSampleBias;
////	gi_wSInvCurr2Sample 		= 	(ADCRESULT6 >> 4)  - 2048 - gi_wSInvCurrSampleBias;
////	gi_wTInvCurr2Sample 		= 	(ADCRESULT7 >> 4)  - 2048 - gi_wTInvCurrSampleBias;
//	gi_wPBusVoltSample 		= 	(ADCRESULT8 >> 4);
////	gi_wNBusVoltSample 		= 	(ADCRESULT9 >> 4);
////	gi_wRInvDCCurrSample 	= 	(ADCRESULT10 >> 4)  - 2048;
////	gi_wSInvDCCurrSample 	= 	(ADCRESULT11 >> 4)  - 2048;
////	gi_wTInvDCCurrSample 	= 	(ADCRESULT12 >> 4)  - 2048;
//	gi_wRInvDCVoltSample 	= 	(ADCRESULT13 >> 4)  - 2048;
////	gi_wSInvDCVoltSample 	= 	(ADCRESULT14 >> 4)  - 2048;
////	gi_wTInvDCVoltSample	=	(ADCRESULT15 >> 4)  - 2048;

	gi_wRLineVoltSample		=	(ADCRESULT0 >> 4) - 2048;
	gi_wRInvCurr2Sample		= 	(ADCRESULT2 >> 4) - 2048 - gi_wRInvCurrSampleBias;
	gi_wROPCurr2Sample 		= 	(ADCRESULT3 >> 4) - 2048 - gi_wROPCurrSampleBias;
	gi_wSolarCurrAvg1Sample	=	(ADCRESULT7 >> 4);
	gi_wConvertVoltSample	=	(ADCRESULT10 >> 4);
	gi_wModelSample			=	(ADCRESULT11 >> 4);
	gi_wPDCDCCurr2Sample	=	(ADCRESULT13 >> 4)	- 2048 + gi_wPDCDCCurrSampleBias;
...
//			gi_wDCDCConvPWMValue = cDCDCConvertDutyMax;
	...
	if((gi_wBatConnectFlg || mChkDCDCLLCOn()) && !g_wSPSSDProcFlg)
	{
		hoLVPWMEnOn;
	}
	else
...
//	}
	...
	if(gi_wParallelEnable && (mChkOPRlyOn() || mChkOPSCROn()))
	{
		hoPARRLYOn;
	}
	else
...
INT16U suwConvertTempAvgCal(void)
{
	INT16U uwTempAvg = 0;
	OS_ENTER_CRITICAL();
	gi_udwConvertTempSampleSum = gi_udwConvertTempSampleSumTemp;
	gi_udwConvertTempSampleSumTemp = 0;
	gi_uwConvertTempSampleSumCnt = gi_uwConvertTempSampleSumCntTemp;
	gi_uwConvertTempSampleSumCntTemp = 0;
	OS_EXIT_CRITICAL();
	if(gi_uwConvertTempSampleSumCnt > 0)
	{
		uwTempAvg = (INT16U)(gi_udwConvertTempSampleSum / gi_uwConvertTempSampleSumCnt);
		uwTempAvg = (INT16U)((INT32U)uwTempAvg * 30/33);	//3V->3.3V
	}
	return uwTempAvg;
}
...
INT16S swGetConvertTempSample(void)
{
	return(gi_wConvertTempSample);
}
