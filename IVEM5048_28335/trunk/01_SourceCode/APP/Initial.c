...
//	sApwmInit();
	...
	//PieVectTable.ECAP5_INT = &SYNZeroCrossInterrupt;
...
//	PieVectTable.SCITXINTA = &SCIATransmitInterrupt;
	...
	//PieCtrlRegs.PIEIER4.bit.INTx3 = 1;   		//INV Reserved   
...
void sInitGpio(void)
{
	...
	GpioCtrlRegs.GPAMUX1.bit.GPIO0 = 1;   // GPIO0 = PWM1A   FAN2.SPEED
//	GpioCtrlRegs.GPAMUX1.bit.GPIO1 = 1;   // GPIO1 = PWM1B   FAN1.SPEED
	//GpioCtrlRegs.GPAMUX1.bit.GPIO2 = 1;   // GPIO2 = PWM2A   3525.ON
	GpioCtrlRegs.GPAMUX1.bit.GPIO3 = 1;   // GPIO3 = PWM2B   PVBOOST.PWM
	...
	GpioCtrlRegs.GPAMUX1.bit.GPIO8 = 1;   // GPIO8 = PWM5A   DCDC.BOOST.PWM
  	...
  	GpioCtrlRegs.GPAMUX1.bit.GPIO10 = 1;  // GPIO10 = PWM6A  3525.PWM1
  	GpioCtrlRegs.GPAMUX1.bit.GPIO11 = 1;  // GPIO11 = PWM6B  3525.PWM2

	GpioCtrlRegs.GPAPUD.bit.GPIO1 = 0;  // Enable pullup on           SD2.ON
	GpioDataRegs.GPACLEAR.bit.GPIO1 = 1; // Load output latch to high
	GpioCtrlRegs.GPAMUX1.bit.GPIO1 = 0; // GPIO9 = I/O
	GpioCtrlRegs.GPADIR.bit.GPIO1 = 1;  // GPIO9 = Output

	GpioCtrlRegs.GPAPUD.bit.GPIO2 = 0;  // Enable pullup on           3525.ON
	GpioDataRegs.GPACLEAR.bit.GPIO2 = 1; // Load output latch to high
	GpioCtrlRegs.GPAMUX1.bit.GPIO2 = 0; // GPIO9 = I/O
	GpioCtrlRegs.GPADIR.bit.GPIO2 = 1;  // GPIO9 = Output

//	GpioCtrlRegs.GPAPUD.bit.GPIO9 = 0;  // Enable pullup on           EEP.WP
...
//	GpioCtrlRegs.GPADIR.bit.GPIO9 = 1;  // GPIO9 = Output
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO12 = 1;  // Enable pullup on          GHGI.OVER
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO27 = 0;  // Enable pullup on          BUZZ.ON
	GpioDataRegs.GPACLEAR.bit.GPIO27 = 1; // Load output latch to low
	GpioCtrlRegs.GPAMUX2.bit.GPIO27 = 0; // GPIO35 = I/O
	GpioCtrlRegs.GPADIR.bit.GPIO27 = 1;  // GPIO35 = output
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO29 = 0;  // Enable pullup on          EN.S0
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO31 = 0;  // Enable pullup on          SPS.ON
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO40 = 0;  // Enable pullup on          BAT.ON
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO42 = 0;  // Enable pullup on          OP.SCR
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO46 = 0;  // Enable pullup on          GRIDN.RLY
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO47 = 0;  // Enable pullup on          GRIDL.RLY
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO48 = 0;  // Enable pullup on          BUS.OVER  
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO49 = 0;  // Enable pullup on          INVI.OVER  
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO52 = 0;  // Enable pullup on          PARA1.TXD
	GpioDataRegs.GPBSET.bit.GPIO52 = 1; // Load output latch to HIGH
	GpioCtrlRegs.GPBMUX2.bit.GPIO52 = 0; // GPIO52 = I/O
	GpioCtrlRegs.GPBDIR.bit.GPIO52 = 1;  // GPIO52 = Output	

	GpioCtrlRegs.GPBPUD.bit.GPIO53 = 0;  // Enable pullup on          PARA1.RXD
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO60 = 0;  // Enable pullup on          CHG.LED
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO61 = 0;  // Enable pullup on          LINE.LED
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO65 = 0;  // Enable pullup on          LCD.CS
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO66 = 0;  // Enable pullup on          LCD.SID
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO67 = 0;  // Enable pullup on          LCD.SCLK
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO68 = 0;  // Enable pullup on          FAULT.LED
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO69 = 0;  // Enable pullup on          INV.LED
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO70 = 0;  // Enable pullup on          SW.DOWN
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO71 = 0;  // Enable pullup on          SW.UP
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO72 = 0;  // Enable pullup on          SW.ENT
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO73 = 0;  // Enable pullup on          SW.ESC
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO74 = 0;  // Enable pullup on          PARA0.RXD
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO75 = 0;  // Enable pullup on          PARA0.TXD
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO78 = 0;  // Enable pullup on          CAN.NET1.DET
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO79 = 0;  // Enable pullup on          CAN.NET2.DET
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO80 = 0;  // Enable pullup on          OP.RLY
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO81 = 0;  // Enable pullup on          INVPWM.EN
	...
	GpioCtrlRegs.GPCPUD.bit.GPIO82 = 0;  // Enable pullup on          AD.SWITCH
...
//	GpioCtrlRegs.GPAPUD.bit.GPIO27 = 0;   	//CHGPWM-D Pull up enable BUZ.PWM
//	GpioCtrlRegs.GPAQSEL2.bit.GPIO27 = 0;	//Synch to SYSCLKOUT, No Qualification
//	GpioCtrlRegs.GPAMUX2.bit.GPIO27 = 1;  	//Set to ECAP4	

	
//	GpioCtrlRegs.GPAPUD.bit.GPIO27 = 0;   // Enable pullup on GPIO27       
//	GpioCtrlRegs.GPAQSEL2.bit.GPIO27 = 0; // Synch to SYSCLOUT
//	GpioCtrlRegs.GPAMUX2.bit.GPIO27 = 1;  // GPIO27 = ECAP4		      RINV.ZERO

//	GpioCtrlRegs.GPBPUD.bit.GPIO48 = 0;   // Enable pullup on GPIO48       
//	GpioCtrlRegs.GPBQSEL2.bit.GPIO48 = 0; // Synch to SYSCLOUT
//	//GpioCtrlRegs.GPACTRL.bit.QUALPRD3=2; //two SYSCLOUT period
//	GpioCtrlRegs.GPBMUX2.bit.GPIO48 = 1;  // GPIO48 = ECAP5		      SYN.RXD
