...
#define cInt_InvCurrPrtPnt			cInv70A
...
#define cDSPVersion		((1000*mModel) + 208)
//#define	cTestCmd		
...
#define	cInvDCVoltRatio			115				//0.23VMax	2^10 * 1000		1mV << 10	1.5Vbias
...
#define	cDCDC35A			1906//(INT16S)((((INT32S)3000 << 10) /cDCDCCurrRatio + 5) /10)

#if mModel == cModel3024
#define	cInv45A				1516//(INT16S)((((INT32S)4500 << 10) /cInvCurrRatio + 5) /10)
#define	cInv48A				1617//(INT16S)((((INT32S)4800 << 10) /cInvCurrRatio + 5) /10)
#else
#define	cInv48A				1093//(INT16S)((((INT32S)4800 << 10) /cInvCurrRatio + 5) /10)
