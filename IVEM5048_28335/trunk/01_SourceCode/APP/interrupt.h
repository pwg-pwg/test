...
#define			mRPInvPWM				EPwm3Regs.CMPA.half.CMPA
#define			mRNInvPWM				EPwm4Regs.CMPA.half.CMPA
...
typedef union
{
	...
	struct
	{
		...
		INT16U uwBatOpen:1;
		INT16U uwBatUnder:1;
		INT16U uwSolarBSTTempOver:1;
		INT16U uwConvertTempOver:1;
		INT16U uwInnelTempOver:1;
		INT16U uwInvTempOver:1;
		INT16U uwSolarBSTTempSensorAbnormal:1;
		INT16U uwConvertTempSensorAbnormal:1;
		INT16U uwInvTempSensorAbnormal:1;
		INT16U uwFanLock:1;
		INT16U uwReserved:3;
	}BIT;
}UWarningInfo;
