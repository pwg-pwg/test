...
//	if(g_wR_Boost1_PWM > (g_wPwmPeriod-300))	g_wR_Boost1_PWM = (g_wPwmPeriod-300);
	...
	EPwm2Regs.CMPB = g_wPwmPeriod - g_wR_Boost1_PWM;
}
...
void sBoost2Control(INT16U wControlMode)
{
	...
	if(g_wR_Vcmp_P2 > 26208)   g_wR_Vcmp_P2 = 26208;
	if(g_wR_Vcmp_P2 < 0 )      g_wR_Vcmp_P2 = 0;
	g_wR_Vcmp_P2_2 = g_wR_Vcmp_P2;

	g_wR_PWMDuty_P2 = g_wR_Vcmp_P2;
	//pwm = duty/26208*wPwmPeriod
	dwTemp = (INT32S)g_wR_PWMDuty_P2 * 20485;
	dwTemp = (dwTemp >> 14);
	dwTemp *= cPWMCntlPeriod;
	g_wR_PWMDuty_P2 = (INT16S)(dwTemp >> 15);
	g_wR_Boost2_PWM = g_wR_PWMDuty_P2;
	if(g_wR_Boost2_PWM < 1)	g_wR_Boost2_PWM = 1;						
	if(g_wR_Boost2_PWM >= (cPWMCntlPeriod-300))	g_wR_Boost2_PWM = cPWMCntlPeriod-300;
	...
	EPwm2Regs.CMPA.half.CMPA = g_wR_Boost2_PWM;
}
